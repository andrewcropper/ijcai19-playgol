...
b81_1(A,B):-skip1(A,C),p656_1(C,B).
b38(A,B):-skip1(A,C),b38_1(C,B).
b38_1(A,B):-not_letter(A),skip1(A,B).
b38_1(A,B):-mk_uppercase(A,C),b38_1(C,B).
b246(A,B):-copy1(A,C),b246_1(C,B).
b246_1(A,B):-skip1(A,B),is_empty(B).
b246_1(A,B):-p19_1(A,C),b246_1(C,B).
...
b98_1(A,B):-skip1(A,C),p656_1(C,B).
%timeout
...
b48_1(A,B):-p201(A,C),p167_1(C,B).
%timeout
%timeout
b36(A,B):-copy1(A,C),b36_1(C,B).
b36_1(A,B):-skip1(A,C),b36_1(C,B).
b36_1(A,B):-p656_1(A,B),is_uppercase(B).
%timeout
%timeout
%timeout
%timeout
...
b108_1(A,B):-p19_1(A,C),b108_1(C,B).
%timeout
%timeout
%timeout
%timeout

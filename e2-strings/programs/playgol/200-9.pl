...
b227_1(A,B):-p165_1(A,C),b227_2(C,B).
b227_2(A,B):-skip1(A,B),is_empty(B).
b227_2(A,B):-p59(A,C),b227_2(C,B).
%timeout
%timeout
%timeout
%timeout
...
b247_1(A,B):-p2_2(A,C),b247_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b249_1(A,B):-p125_1(A,C),b249_2(C,B).
b249_2(A,B):-skip1(A,C),p145(C,B).
b249_2(A,B):-p125_1(A,C),p125_1(C,B).
%timeout
...
%timeout
%timeout
b134(A,B):-p2_2(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p3(A,C),b134_1(C,B).
%timeout
%timeout
%timeout
%timeout

...
b25(A,B):-p77(A,B),not_letter(B).
b25(A,B):-p1214(A,B),not_letter(B).
b25(A,B):-p1214_1(A,B),not_letter(B).
b37(A,B):-skip1(A,B),not_letter(B).
b37(A,B):-b37_1(A,C),b37(C,B).
b37_1(A,B):-p12(A,B),is_lowercase(B).
b189(A,B):-p1214_1(A,C),b189_1(C,B).
...
b92_2(A,B):-p97_1(A,C),skip1(C,B).
b246(A,B):-copy1(A,C),b246_1(C,B).
b246_1(A,B):-skip1(A,B),is_empty(B).
b246_1(A,B):-p37_1(A,C),b246_1(C,B).
%timeout
...
b108_1(A,B):-p37_1(A,C),b108_1(C,B).
%timeout
%timeout
%timeout
%timeout

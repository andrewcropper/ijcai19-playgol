...
b151_1(A,B):-p4_1(A,C),b151_1(C,B).
...
%timeout
b249(A,B):-p848(A,C),b249_1(C,B).
b249_1(A,B):-is_number(A),p848(A,B).
b249_1(A,B):-not_number(A),p116_1(A,B).
%timeout
%timeout
%timeout
...
%timeout
%timeout
b227(A,B):-p354_1(A,C),b227_1(C,B).
b227_1(A,B):-skip1(A,B),is_empty(B).
b227_1(A,B):-p5(A,C),b227_1(C,B).
%timeout
%timeout
%timeout
%timeout

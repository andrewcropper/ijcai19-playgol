...
b249_1(A,B):-p85_1(A,C),p100(C,B).
b249_1(A,B):-p100(A,C),p100(C,B).
%timeout
...
%timeout
%timeout
b25(A,B):-p416_1(A,B),not_letter(B).
b25(A,B):-p1318_1(A,B),not_letter(B).
...
b304(A,B):-p103(A,B),not_letter(B).
b304(A,B):-p93_1(A,C),b304(C,B).
%timeout
%timeout
%timeout
%timeout

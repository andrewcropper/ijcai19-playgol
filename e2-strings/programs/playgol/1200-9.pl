...
b94_1(A,B):-p120_1(A,C),b94_1(C,B).
...
%timeout
%timeout
b227(A,B):-p307_1(A,C),b227_1(C,B).
b227_1(A,B):-skip1(A,B),is_empty(B).
b227_1(A,B):-p21(A,C),b227_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b92(A,B):-copy1(A,C),p585_1(C,B).
b92(A,B):-b92_1(A,B),is_empty(B).
b92_1(A,B):-p93(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b246_1(A,B):-p120_1(A,C),b246_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b249_1(A,B):-p102_1(A,C),p156(C,B).
b249_1(A,B):-p156(A,C),p156(C,B).
...
b108_1(A,B):-p120_1(A,C),b108_1(C,B).
%timeout
%timeout
%timeout
...
%timeout
%timeout
b189(A,B):-p585_1(A,C),b189_1(C,B).
...
%timeout
%timeout
b134(A,B):-p637(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p93_1(A,C),b134_1(C,B).
%timeout
%timeout
%timeout
%timeout

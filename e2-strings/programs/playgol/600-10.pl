...
b132_1(A,B):-p85(A,C),p293(C,B).
b132_1(A,B):-p436(A,C),p593_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b189(A,B):-p410_1(A,C),b189_1(C,B).
b189_1(A,B):-skip1(A,B),is_space(B).
b189_1(A,B):-p120(A,C),b189_1(C,B).
...
b108_1(A,B):-p85_1(A,C),b108_1(C,B).
...
b246_1(A,B):-p85_1(A,C),b246_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b134(A,B):-p90(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p248_1(A,C),b134_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b123(A,B):-p120(A,C),b123_1(C,B).
b123_1(A,B):-skip1(A,B),is_empty(B).
b123_1(A,B):-p85_1(A,C),b123_1(C,B).
%timeout
%timeout
%timeout
%timeout

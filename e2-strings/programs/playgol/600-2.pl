...
b246_1(A,B):-p39_1(A,C),b246_1(C,B).
...
%timeout
b134(A,B):-p39(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p416_1(A,C),b134_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b108_1(A,B):-p39_1(A,C),b108_1(C,B).
%timeout
%timeout
%timeout

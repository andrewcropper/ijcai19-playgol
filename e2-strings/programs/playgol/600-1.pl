...
b249(A,B):-p288(A,C),b249_1(C,B).
b249_1(A,B):-not_number(A),p30_1(A,B).
b249_1(A,B):-is_number(A),p52(A,B).
%timeout
%timeout
%timeout
%timeout
...
b81(A,B):-p495_2(A,B),not_letter(B).
...
%timeout
%timeout
b111(A,B):-p495_2(A,C),b111_1(C,B).
b111_1(A,B):-mk_uppercase(A,B),is_empty(B).
b111_1(A,B):-mk_uppercase(A,C),b111_1(C,B).
%timeout
%timeout
%timeout
...
%timeout
%timeout
b92(A,B):-copy1(A,C),p28_2(C,B).
b92(A,B):-b92_1(A,B),is_empty(B).
b92_1(A,B):-p549(A,C),skip1(C,B).
...
%timeout
%timeout
b252(A,B):-b252_1(A,C),p591(C,B).
b252_1(A,B):-is_space(A),p288(A,B).
...
%timeout
%timeout
b56(A,B):-p28_2(A,C),b56_1(C,B).
b56_1(A,B):-skip1(A,B),is_empty(B).
b56_1(A,B):-p52(A,C),b56_1(C,B).
b38(A,B):-skip1(A,C),b38_1(C,B).
b38_1(A,B):-mk_uppercase(A,C),b38_1(C,B).
b38_1(A,B):-p212_1(A,B),not_letter(B).

...
%timeout
%timeout
b227(A,B):-p126_1(A,C),b227_1(C,B).
b227_1(A,B):-skip1(A,B),is_empty(B).
b227_1(A,B):-p22(A,C),b227_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b153(A,B):-p633_1(A,C),b153_1(C,B).
b153_1(A,B):-p418(A,C),p418(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b308(A,B):-p28_1(A,C),b308_1(C,B).
b308_1(A,B):-skip1(A,B),is_empty(B).
b308_1(A,B):-p594(A,C),b308_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b249_1(A,B):-p22(A,C),p418(C,B).
b249_1(A,B):-p28_1(A,C),p418(C,B).
...
%timeout
%timeout
b134(A,B):-p16(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p17_2(A,C),b134_1(C,B).
%timeout
%timeout
%timeout
%timeout

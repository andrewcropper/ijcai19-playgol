...
%timeout
%timeout
b48(A,B):-p68(A,C),p184_1(C,B).
b48(A,B):-b48_1(A,B),is_empty(B).
b48_1(A,B):-copy1(A,C),p369_1(C,B).
%timeout
...
%timeout
%timeout
b134(A,B):-p26(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p255_1(A,C),b134_1(C,B).
%timeout
%timeout
%timeout

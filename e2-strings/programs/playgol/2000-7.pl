...
b25(A,B):-p1632_1(A,B),not_letter(B).
%timeout
%timeout
%timeout
%timeout
...
b48(A,B):-p46(A,C),p25_1(C,B).
b48(A,B):-b48_1(A,B),is_empty(B).
b48_1(A,B):-p46(A,C),p505_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b189(A,B):-p1632_1(A,C),b189_1(C,B).

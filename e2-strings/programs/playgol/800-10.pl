...
%timeout
b92(A,B):-copy1(A,C),p547(C,B).
b92(A,B):-b92_1(A,B),is_empty(B).
b92_1(A,B):-p192(A,C),skip1(C,B).
...
%timeout
%timeout
b134(A,B):-p318(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p192_1(A,C),b134_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b123(A,B):-p60(A,C),b123_1(C,B).
b123_1(A,B):-skip1(A,B),is_empty(B).
b123_1(A,B):-p18_1(A,C),b123_1(C,B).
%timeout
%timeout
%timeout
%timeout

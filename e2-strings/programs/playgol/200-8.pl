...
b249_1(A,B):-p63_1(A,C),b249_2(C,B).
b249_2(A,B):-skip1(A,C),p63(C,B).
b249_2(A,B):-p63_1(A,C),p63_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b48_2(A,B):-p152(A,C),p51_1(C,B).
b48_2(A,B):-p152(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout
%timeout
b132(A,B):-b132_1(A,C),p27(C,B).
b132_1(A,B):-p56(A,C),p165(C,B).
b132_1(A,B):-p98(A,B),is_number(B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b4(A,B):-p152_1(A,C),b4_1(C,B).
b4_1(A,B):-skip1(A,B),is_empty(B).
b4_1(A,B):-p7(A,C),b4_1(C,B).
%timeout
%timeout
%timeout
%timeout

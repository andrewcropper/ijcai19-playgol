...
%timeout
%timeout
b227(A,B):-p731_1(A,C),b227_1(C,B).
b227_1(A,B):-skip1(A,B),is_empty(B).
b227_1(A,B):-p82(A,C),b227_1(C,B).
b56(A,B):-p298_2(A,C),b56_1(C,B).
...
b92(A,B):-copy1(A,C),p298_1(C,B).
b92(A,B):-b92_1(A,B),is_empty(B).
b92_1(A,B):-p724(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b246_1(A,B):-p57_1(A,C),b246_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b249_1(A,B):-p110_1(A,C),p819(C,B).
b249_1(A,B):-p819(A,C),p819(C,B).
...
b108_1(A,B):-p57_1(A,C),b108_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b189(A,B):-p298_1(A,C),b189_1(C,B).
b189_1(A,B):-skip1(A,B),is_space(B).
b189_1(A,B):-p82(A,C),b189_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b134(A,B):-p338(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p298_2(A,C),b134_1(C,B).
%timeout
%timeout
%timeout
%timeout

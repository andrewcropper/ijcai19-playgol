...
b23_1(A,B):-p762_1(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b48(A,B):-p235_1(A,C),p1252_1(C,B).
b48(A,B):-b48_1(A,B),is_empty(B).
b48_1(A,B):-p235_1(A,C),p1139_1(C,B).
%timeout
%timeout
...
%timeout
%timeout
b116(A,B):-b116_1(A,B),not_number(B).
b116_1(A,B):-p762_1(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b149_1(A,B):-p506_1(A,C),p176(C,B).
b149_1(A,B):-p506_1(A,C),p496(C,B).
%timeout
%timeout

...
% asserting p799/2
% depth 3
p5(A,B):-p76(A,C),p5_1(C,B).
p5_1(A,B):-p13(A,C),mk_lowercase(C,B).
...
p22_1(A,B):-p39(A,C),p175(C,B).
p30(A,B):-copy1(A,C),p318(C,B).
p31(A,B):-p201(A,C),p194(C,B).
...
p35(A,B):-p259(A,C),p35_1(C,B).
p35_1(A,B):-mk_uppercase(A,C),p259(C,B).
...
p59_1(A,B):-p284(A,C),p610(C,B).
p61(A,B):-skip1(A,C),p61_1(C,B).
p61_1(A,B):-skip1(A,C),p201(C,B).
p67(A,B):-skip1(A,C),p67_1(C,B).
p67_1(A,B):-p1(A,C),p56(C,B).
...
p86_1(A,B):-p39(A,C),p74(C,B).
p87(A,B):-copy1(A,C),p87_1(C,B).
p87_1(A,B):-p84(A,C),p85(C,B).
p91(A,B):-skip1(A,C),p91_1(C,B).
p91_1(A,B):-skip1(A,C),p91_2(C,B).
p91_2(A,B):-skip1(A,C),p131(C,B).
...
p107(A,B):-p135(A,C),p107_1(C,B).
p107_1(A,B):-p139(A,C),p101(C,B).
...
p184(A,B):-p317(A,C),p184_1(C,B).
p184_1(A,B):-is_uppercase(A),p39(A,B).
p184_1(A,B):-skip1(A,C),p184_1(C,B).
...
p195(A,B):-p194(A,C),p195_1(C,B).
p195_1(A,B):-p139(A,C),p1(C,B).
p196(A,B):-skip1(A,C),p196_1(C,B).
p196_1(A,B):-p491(A,C),p196_2(C,B).
p196_2(A,B):-p318(A,C),mk_lowercase(C,B).
p197(A,B):-p78(A,C),p197_1(C,B).
p197_1(A,B):-p135(A,C),p47(C,B).
p198(A,B):-p201(A,C),p106(C,B).
p206(A,B):-p533(A,C),p78(C,B).
...
p237_1(A,B):-skip1(A,C),p237_2(C,B).
p237_2(A,B):-p131(A,C),mk_uppercase(C,B).
p242(A,B):-p8(A,C),p344(C,B).
p247(A,B):-p269(A,C),p131(C,B).
p248(A,B):-p8(A,C),p248_1(C,B).
p248_1(A,B):-mk_lowercase(A,C),p74(C,B).
...
p383(A,B):-p105(A,C),p269(C,B).
p387(A,B):-p777(A,C),p387_1(C,B).
p387_1(A,B):-skip1(A,C),p78(C,B).
p390(A,B):-mk_lowercase(A,C),p390_1(C,B).
p390_1(A,B):-p174(A,C),p8(C,B).
p391(A,B):-p47(A,C),p391_1(C,B).
p391_1(A,B):-skip1(A,C),p8(C,B).
p394(A,B):-p400(A,C),p394_1(C,B).
p394_1(A,B):-skip1(A,C),p85(C,B).
...
p405_1(A,B):-p78(A,C),p3(C,B).
p408(A,B):-p692(A,C),p408_1(C,B).
p408_1(A,B):-p194(A,C),mk_lowercase(C,B).
...
p422_2(A,B):-p99(A,C),mk_uppercase(C,B).
...
p457(A,B):-p2(A,C),p72(C,B).
p457(A,B):-skip1(A,C),p457(C,B).
p459(A,B):-skip1(A,C),p459_1(C,B).
p459_1(A,B):-p380(A,C),p459_2(C,B).
p459_2(A,B):-skip1(A,C),p60(C,B).
p464(A,B):-mk_lowercase(A,C),p464_1(C,B).
p464_1(A,B):-p527(A,C),p13(C,B).
p465(A,B):-mk_lowercase(A,C),p465_1(C,B).
p465_1(A,B):-skip1(A,C),p465_2(C,B).
p465_2(A,B):-p60(A,C),p246(C,B).
...
p475(A,B):-p443(A,C),p1(C,B).
p478(A,B):-p60(A,C),p550(C,B).
p479(A,B):-p85(A,C),p479_1(C,B).
p479_1(A,B):-p14(A,C),p626(C,B).
p480(A,B):-p480_1(A,B),is_lowercase(B).
p480_1(A,B):-mk_uppercase(A,C),p47(C,B).
p480_1(A,B):-skip1(A,C),p480_1(C,B).
p482(A,B):-copy1(A,C),p42(C,B).
p484(A,B):-p193(A,C),p484_1(C,B).
p484_1(A,B):-p194(A,C),mk_uppercase(C,B).
...
p619(A,B):-p312(A,B),is_lowercase(B).
...
p650(A,B):-p194(A,C),p650_1(C,B).
p650_1(A,B):-mk_uppercase(A,C),p96(C,B).
...
p779(A,B):-p201(A,C),p779_1(C,B).
p779_1(A,B):-skip1(A,C),p1(C,B).
p780(A,B):-skip1(A,C),p780_1(C,B).
p780_1(A,B):-p60(A,C),p175(C,B).
...
p795_1(A,B):-p284(A,C),p795_2(C,B).
p795_2(A,B):-skip1(A,C),p39(C,B).
...
% asserting p800/2
% depth 4
p260(A,B):-p43(A,C),p260_1(C,B).
p260_1(A,B):-p759(A,C),mk_lowercase(C,B).
p329(A,B):-p276(A,C),mk_uppercase(C,B).
p349(A,B):-p30(A,C),p349_1(C,B).
p349_1(A,B):-mk_lowercase(A,C),p194(C,B).
p368(A,B):-p192(A,C),p1(C,B).
p442(A,B):-mk_lowercase(A,C),p442_1(C,B).
p442_1(A,B):-skip1(A,C),p442_2(C,B).
p442_2(A,B):-p194(A,C),p69(C,B).
p469(A,B):-p621(A,C),p469_1(C,B).
p469_1(A,B):-skip1(A,C),p194(C,B).
...
%timeout
%timeout
b36(A,B):-copy1(A,C),p43(C,B).
%timeout
b38(A,B):-skip1(A,C),b38_1(C,B).
b38_1(A,B):-mk_uppercase(A,C),b38_1(C,B).
b38_1(A,B):-p285(A,B),not_letter(B).
%timeout
%timeout
%timeout
%timeout
...
b37_1(A,B):-p60(A,B),is_lowercase(B).
%timeout
b4(A,B):-p23(A,C),b4_1(C,B).
b4_1(A,B):-skip1(A,B),is_empty(B).
b4_1(A,B):-p60(A,C),b4_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b249_1(A,B):-p1(A,C),p62(C,B).
%timeout
%timeout
b1(A,B):-skip1(A,B),is_empty(B).
b1(A,B):-p60(A,C),b1(C,B).
%timeout
b63(A,B):-skip1(A,C),b63_1(C,B).
b63_1(A,B):-p318(A,C),p62(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b252(A,B):-p43(A,C),b252_1(C,B).
b252_1(A,B):-p62(A,C),p62(C,B).
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p318(A,B),is_uppercase(B).
...
b247_1(A,B):-p318(A,C),b247_1(C,B).
b6(A,B):-p43(A,C),b6_1(C,B).
b6_1(A,B):-skip1(A,B),is_empty(B).
b6_1(A,B):-p60(A,C),b6_1(C,B).
%timeout
b327(A,B):-p1(A,C),p62(C,B).
b327(A,B):-b327_1(A,B),is_uppercase(B).
b327_1(A,B):-p337(A,C),p62(C,B).
%timeout
%timeout
%timeout
%timeout
...
b323_1(A,B):-p60(A,C),b323_1(C,B).
%timeout
%timeout
%timeout
b7(A,B):-copy1(A,C),b7_1(C,B).
b7_1(A,B):-p43(A,C),p43(C,B).
%timeout
%timeout
%timeout
%timeout

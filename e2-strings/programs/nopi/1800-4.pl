...
p4(A,B):-p619(A,C),p4_1(C,B).
p4_1(A,B):-p44(A,C),p55(C,B).
p5(A,B):-p58(A,C),p5_1(C,B).
p5_1(A,B):-skip1(A,C),p825(C,B).
p6(A,B):-p58(A,C),p730(C,B).
p10(A,B):-copy1(A,C),p10_1(C,B).
p10_1(A,B):-p313(A,C),p284(C,B).
...
p178(A,B):-p976(A,C),p663(C,B).
p180(A,B):-p43(A,C),p604(C,B).
p181(A,B):-p1659(A,C),p181_1(C,B).
p181_1(A,B):-p952(A,C),p85(C,B).
p182(A,B):-p22(A,C),p382(C,B).
p184(A,B):-skip1(A,C),p184_1(C,B).
p184_1(A,B):-p720(A,C),p35(C,B).
p186(A,B):-skip1(A,C),p471(C,B).
p191(A,B):-p57(A,C),p191_1(C,B).
p191_1(A,B):-skip1(A,C),p226(C,B).
p195(A,B):-skip1(A,C),p195_1(C,B).
p195_1(A,B):-p43(A,C),p1211(C,B).
p198(A,B):-p35(A,C),p198_1(C,B).
p198_1(A,B):-skip1(A,C),p198_2(C,B).
p198_2(A,B):-p414(A,C),p27(C,B).
p199(A,B):-skip1(A,C),p199_1(C,B).
p199_1(A,B):-p190(A,C),p199_2(C,B).
p199_2(A,B):-p785(A,C),mk_lowercase(C,B).
...
p328(A,B):-p190(A,C),p328_1(C,B).
p328_1(A,B):-p924(A,C),p870(C,B).
...
p375_1(A,B):-p35(A,C),p375_2(C,B).
p375_2(A,B):-p414(A,C),p133(C,B).
...
p398(A,B):-p35(A,C),p398_1(C,B).
p398_1(A,B):-p572(A,C),p35(C,B).
p406(A,B):-p1161(A,C),p406_1(C,B).
p406_1(A,B):-p285(A,C),mk_lowercase(C,B).
p408(A,B):-p1087(A,C),p408_1(C,B).
p408_1(A,B):-skip1(A,C),p141(C,B).
p410(A,B):-p190(A,C),p658(C,B).
p415(A,B):-p94(A,C),p542(C,B).
p419(A,B):-p302(A,C),p419_1(C,B).
p419_1(A,B):-skip1(A,C),p43(C,B).
p420(A,B):-p44(A,C),p813(C,B).
p422(A,B):-copy1(A,C),p542(C,B).
p424(A,B):-p1069(A,C),p1154(C,B).
p426(A,B):-p814(A,C),p284(C,B).
...
p450(A,B):-p94(A,C),p450_1(C,B).
p450_1(A,B):-skip1(A,C),p1171(C,B).
...
p549_1(A,B):-p711(A,C),p821(C,B).
p550(A,B):-skip1(A,C),p542(C,B).
p551(A,B):-p551_1(A,B),is_empty(B).
p551_1(A,B):-p748(A,C),skip1(C,B).
p551_1(A,B):-skip1(A,C),p551_1(C,B).
...
p597_1(A,B):-skip1(A,C),p382(C,B).
p599(A,B):-p85(A,C),p599_1(C,B).
p599_1(A,B):-p1293(A,C),p599_2(C,B).
p599_2(A,B):-p414(A,C),mk_uppercase(C,B).
p600(A,B):-mk_lowercase(A,C),p600_1(C,B).
p600_1(A,B):-skip1(A,C),p888(C,B).
p607(A,B):-p102(A,C),p85(C,B).
...
p628_1(A,B):-p190(A,C),p628_2(C,B).
p628_2(A,B):-p414(A,C),p44(C,B).
p629(A,B):-p1215(A,C),p730(C,B).
p632(A,B):-p1227(A,C),p35(C,B).
...
p645_1(A,B):-p304(A,C),p475(C,B).
p650(A,B):-p190(A,C),p752(C,B).
p651(A,B):-p284(A,C),p651_1(C,B).
p651_1(A,B):-p427(A,C),p952(C,B).
...
p706_1(A,B):-p254(A,C),p284(C,B).
p707(A,B):-copy1(A,C),p707_1(C,B).
p707_1(A,B):-skip1(A,C),p1199(C,B).
p709(A,B):-p45(A,C),p709_1(C,B).
p709_1(A,B):-p57(A,C),p952(C,B).
...
p734(A,B):-p190(A,C),p734_1(C,B).
p734_1(A,B):-p90(A,C),mk_uppercase(C,B).
p735(A,B):-p35(A,C),p1606(C,B).
p737(A,B):-p976(A,C),p562(C,B).
p738(A,B):-p77(A,C),p43(C,B).
p740(A,B):-p825(A,C),p304(C,B).
p741(A,B):-p35(A,C),p741_1(C,B).
p741_1(A,B):-p818(A,C),copy1(C,B).
...
p787(A,B):-p190(A,C),p602(C,B).
p788(A,B):-mk_lowercase(A,C),p1199(C,B).
p790(A,B):-p90(A,C),p790_1(C,B).
p790_1(A,B):-mk_lowercase(A,C),p190(C,B).
p793(A,B):-p346(A,C),p402(C,B).
p796(A,B):-p57(A,C),p591(C,B).
p797(A,B):-p57(A,C),p797_1(C,B).
p797_1(A,B):-skip1(A,C),p797_2(C,B).
p797_2(A,B):-p414(A,C),mk_uppercase(C,B).
p798(A,B):-skip1(A,C),p798_1(C,B).
p798_1(A,B):-p1659(A,C),p150(C,B).
p801(A,B):-p1134(A,C),p1069(C,B).
...
p817(A,B):-p284(A,C),p817_1(C,B).
p817_1(A,B):-p1162(A,C),p190(C,B).
p826(A,B):-p190(A,C),p414(C,B).
p827(A,B):-copy1(A,C),p827_1(C,B).
p827_1(A,B):-p285(A,C),p1012(C,B).
p829(A,B):-p86(A,C),p1199(C,B).
p830(A,B):-p16(A,C),p830_1(C,B).
p830_1(A,B):-p284(A,C),p190(C,B).
p832(A,B):-copy1(A,C),p832_1(C,B).
p832_1(A,B):-p414(A,C),p1087(C,B).
p835(A,B):-p58(A,C),p835_1(C,B).
p835_1(A,B):-p1447(A,C),mk_lowercase(C,B).
p836(A,B):-p825(A,C),p140(C,B).
...
p865(A,B):-p1630(A,C),p66(C,B).
p866(A,B):-p1616(A,C),copy1(C,B).
p874(A,B):-p1(A,C),p952(C,B).
p876(A,B):-p414(A,C),p1171(C,B).
p877(A,B):-p35(A,C),p877_1(C,B).
p877_1(A,B):-p1087(A,C),p785(C,B).
p880(A,B):-skip1(A,C),p880_1(C,B).
p880_1(A,B):-p315(A,C),p35(C,B).
p881(A,B):-p1028(A,C),p881_1(C,B).
p881_1(A,B):-mk_lowercase(A,C),p881_2(C,B).
p881_2(A,B):-p241(A,C),mk_lowercase(C,B).
p882(A,B):-p284(A,C),p882_1(C,B).
p882_1(A,B):-skip1(A,C),p167(C,B).
...
p894(A,B):-p241(A,C),p894_1(C,B).
p894_1(A,B):-p44(A,C),p976(C,B).
p897(A,B):-p1637(A,C),p460(C,B).
p901(A,B):-p952(A,C),p976(C,B).
...
p1011_1(A,B):-p24(A,C),p1011_2(C,B).
p1011_2(A,B):-skip1(A,C),p43(C,B).
p1013(A,B):-skip1(A,C),p1013_1(C,B).
p1013_1(A,B):-p394(A,C),mk_lowercase(C,B).
p1021(A,B):-p43(A,C),p1021_1(C,B).
p1021_1(A,B):-p1199(A,C),p85(C,B).
p1023(A,B):-p100(A,C),p542(C,B).
p1025(A,B):-p1(A,C),p602(C,B).
p1027(A,B):-p58(A,C),p1027_1(C,B).
p1027_1(A,B):-p315(A,C),p1027_2(C,B).
p1027_2(A,B):-skip1(A,C),p346(C,B).
...
p1060_1(A,B):-p427(A,C),p1134(C,B).
...
p1070_1(A,B):-p35(A,C),p414(C,B).
p1075(A,B):-p35(A,C),p351(C,B).
p1078(A,B):-p1161(A,C),p1078_1(C,B).
p1078_1(A,B):-skip1(A,C),p35(C,B).
p1079(A,B):-mk_uppercase(A,C),p1079_1(C,B).
p1079_1(A,B):-p1662(A,C),p58(C,B).
p1081(A,B):-p976(A,C),p542(C,B).
p1082(A,B):-p230(A,C),p102(C,B).
...
p1271(A,B):-p22(A,C),p1271_1(C,B).
p1271_1(A,B):-p57(A,C),p90(C,B).
p1272(A,B):-p542(A,C),p446(C,B).
p1276(A,B):-skip1(A,C),p1276_1(C,B).
p1276_1(A,B):-p952(A,C),p400(C,B).
...
p1304(A,B):-p44(A,C),p1304_1(C,B).
p1304_1(A,B):-p402(A,C),p58(C,B).
...
p1332(A,B):-p190(A,C),p1332_1(C,B).
p1332_1(A,B):-p313(A,C),p190(C,B).
p1333(A,B):-mk_lowercase(A,C),p1333_1(C,B).
p1333_1(A,B):-p284(A,C),p1616(C,B).
p1334(A,B):-p190(A,C),p1334_1(C,B).
p1334_1(A,B):-p1161(A,C),p1334_2(C,B).
p1334_2(A,B):-skip1(A,C),p35(C,B).
...
p1349_1(A,B):-p329(A,C),p1349_2(C,B).
p1349_2(A,B):-p85(A,C),p304(C,B).
...
p1358_1(A,B):-skip1(A,C),p226(C,B).
...
p1371(A,B):-p427(A,B),is_uppercase(B).
p1371(A,B):-skip1(A,C),p1371(C,B).
p1377(A,B):-p284(A,C),p1377_1(C,B).
p1377_1(A,B):-p475(A,C),p44(C,B).
...
p1405_1(A,B):-p785(A,C),p1405_2(C,B).
p1405_2(A,B):-skip1(A,C),p167(C,B).
p1406(A,B):-skip1(A,C),p1406_1(C,B).
p1406_1(A,B):-p587(A,C),p731(C,B).
...
p1420_1(A,B):-p619(A,C),mk_uppercase(C,B).
p1422(A,B):-p515(A,C),p888(C,B).
p1423(A,B):-p346(A,C),p1423_1(C,B).
p1423_1(A,B):-p284(A,C),p260(C,B).
p1425(A,B):-skip1(A,C),p1425_1(C,B).
p1425_1(A,B):-p226(A,C),p1154(C,B).
p1428(A,B):-p241(A,C),p86(C,B).
p1436(A,B):-p1589(A,C),p1719(C,B).
p1439(A,B):-mk_uppercase(A,C),p1439_1(C,B).
p1439_1(A,B):-p190(A,C),p472(C,B).
p1441(A,B):-copy1(A,C),p126(C,B).
p1442(A,B):-p1161(A,C),p1442_1(C,B).
p1442_1(A,B):-skip1(A,C),p57(C,B).
...
p1456_1(A,B):-p141(A,C),p190(C,B).
p1460(A,B):-copy1(A,C),p1460_1(C,B).
p1460_1(A,B):-p190(A,C),p402(C,B).
...
p1534(A,B):-p315(A,C),p1534_1(C,B).
p1534_1(A,B):-skip1(A,C),p306(C,B).
...
p1689(A,B):-p85(A,C),p1689_1(C,B).
p1689_1(A,B):-skip1(A,C),p625(C,B).
p1690(A,B):-p230(A,C),p357(C,B).
...
p1743(A,B):-p221(A,C),p1743_1(C,B).
p1743_1(A,B):-skip1(A,C),p346(C,B).
p1744(A,B):-p55(A,C),p1744_1(C,B).
p1744_1(A,B):-p407(A,C),p58(C,B).
...
p1767_1(A,B):-p230(A,C),p1767_2(C,B).
p1767_2(A,B):-p952(A,C),p35(C,B).
...
p1785_1(A,B):-skip1(A,C),p1456(C,B).
% asserting p19/2
% asserting p314/2
% asserting p444/2
% asserting p552/2
...
%timeout
%timeout
b326(A,B):-p344(A,C),p825(C,B).
b326(A,B):-b326_1(A,B),is_lowercase(B).
b326_1(A,B):-p1748(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b61(A,B):-p346(A,C),b61_1(C,B).
b61_1(A,B):-p825(A,C),p825(C,B).
%timeout
b56(A,B):-p1003(A,C),b56_1(C,B).
...
%timeout
b81(A,B):-p414(A,B),is_uppercase(B).

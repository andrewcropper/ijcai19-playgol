...
p18_2(A,B):-p43(A,C),p324(C,B).
p20(A,B):-p1192(A,C),p268(C,B).
p22(A,B):-p207(A,C),copy1(C,B).
p23(A,B):-skip1(A,C),p297(C,B).
p26(A,B):-p255(A,C),p26_1(C,B).
p26_1(A,B):-p398(A,C),p826(C,B).
p27(A,B):-p17(A,C),p112(C,B).
p30(A,B):-mk_lowercase(A,C),p30_1(C,B).
p30_1(A,B):-p521(A,C),p668(C,B).
...
p80(A,B):-p508(A,C),p34(C,B).
p83(A,B):-p135(A,C),p83_1(C,B).
p83_1(A,B):-skip1(A,C),p33(C,B).
...
p103(A,B):-p17(A,C),p103_1(C,B).
p103_1(A,B):-skip1(A,C),p9(C,B).
...
p118(A,B):-p1689(A,C),mk_lowercase(C,B).
p119(A,B):-p305(A,C),p670(C,B).
p121(A,B):-p17(A,C),p971(C,B).
p123(A,B):-p305(A,C),p210(C,B).
...
p240_1(A,B):-p1510(A,C),mk_lowercase(C,B).
p241(A,B):-copy1(A,C),p241_1(C,B).
p241_1(A,B):-p630(A,C),p40(C,B).
p242(A,B):-p486(A,C),p6(C,B).
p246(A,B):-p4(A,C),p972(C,B).
p247(A,B):-p1478(A,C),p247_1(C,B).
p247_1(A,B):-skip1(A,C),p122(C,B).
p248(A,B):-copy1(A,C),p248_1(C,B).
p248_1(A,B):-skip1(A,C),p248_2(C,B).
p248_2(A,B):-skip1(A,C),p9(C,B).
p249(A,B):-p17(A,C),p249_1(C,B).
p249_1(A,B):-skip1(A,C),p143(C,B).
p254(A,B):-p65(A,C),p254_1(C,B).
p254_1(A,B):-skip1(A,C),p185(C,B).
p264(A,B):-p33(A,C),p825(C,B).
p269(A,B):-p297(A,C),p305(C,B).
p271(A,B):-p85(A,C),p271_1(C,B).
p271_1(A,B):-p826(A,C),p90(C,B).
p273(A,B):-copy1(A,C),p297(C,B).
p279(A,B):-copy1(A,C),p279_1(C,B).
p279_1(A,B):-p544(A,C),p1535(C,B).
...
p347_1(A,B):-p85(A,C),mk_lowercase(C,B).
...
p408(A,B):-p268(A,C),p408_1(C,B).
p408_1(A,B):-p129(A,C),p55(C,B).
p412(A,B):-p73(A,C),p412_1(C,B).
p412_1(A,B):-p668(A,C),p298(C,B).
p419(A,B):-skip1(A,C),p419_1(C,B).
p419_1(A,B):-skip1(A,C),p323(C,B).
...
p445(A,B):-p965(A,C),p305(C,B).
p446(A,B):-p521(A,C),p152(C,B).
p447(A,B):-p464(A,C),p114(C,B).
...
p530(A,B):-p33(A,C),p530_1(C,B).
p530_1(A,B):-p577(A,C),p29(C,B).
p533(A,B):-p786(A,C),p533_1(C,B).
p533_1(A,B):-skip1(A,C),p122(C,B).
p534(A,B):-p33(A,C),p534_1(C,B).
p534_1(A,B):-p1733(A,C),p1148(C,B).
p537(A,B):-p129(A,C),p537_1(C,B).
p537_1(A,B):-p826(A,C),p521(C,B).
p540(A,B):-skip1(A,C),p251(C,B).
p541(A,B):-p9(A,C),p263(C,B).
p542(A,B):-copy1(A,C),p542_1(C,B).
p542_1(A,B):-p129(A,C),p725(C,B).
...
p620_1(A,B):-p129(A,C),p1478(C,B).
p621(A,B):-copy1(A,C),p486(C,B).
p624(A,B):-mk_lowercase(A,C),p624_1(C,B).
p624_1(A,B):-p298(A,C),p624_2(C,B).
p624_2(A,B):-p63(A,C),p423(C,B).
...
p712(A,B):-p65(A,C),p712_1(C,B).
p712_1(A,B):-skip1(A,C),p712_2(C,B).
p712_2(A,B):-p686(A,C),mk_lowercase(C,B).
...
p731_1(A,B):-p324(A,C),p153(C,B).
p734(A,B):-p971(A,C),p6(C,B).
p737(A,B):-copy1(A,C),p737_1(C,B).
p737_1(A,B):-p1840(A,C),p508(C,B).
p741(A,B):-copy1(A,C),p455(C,B).
p742(A,B):-p359(A,C),p1248(C,B).
p745(A,B):-p65(A,C),p152(C,B).
p750(A,B):-p65(A,C),p31(C,B).
p756(A,B):-p756_1(A,B),not_empty(B).
p756_1(A,B):-p1840(A,C),p756_2(C,B).
p756_2(A,B):-p398(A,C),mk_lowercase(C,B).
p757(A,B):-p63(A,C),p232(C,B).
p765(A,B):-p305(A,C),p210(C,B).
...
p836_1(A,B):-skip1(A,C),p1750(C,B).
...
p906_1(A,B):-p9(A,C),mk_uppercase(C,B).
p907(A,B):-copy1(A,C),p907_1(C,B).
p907_1(A,B):-p61(A,C),p305(C,B).
...
p917_1(A,B):-p17(A,C),p889(C,B).
p919(A,B):-p114(A,C),p152(C,B).
p920(A,B):-p929(A,C),p54(C,B).
...
p1003_1(A,B):-p210(A,C),p577(C,B).
p1004(A,B):-p1478(A,C),p55(C,B).
p1005(A,B):-mk_lowercase(A,C),p1005_1(C,B).
p1005_1(A,B):-p486(A,C),p1756(C,B).
p1006(A,B):-p85(A,C),p1006_1(C,B).
p1006_1(A,B):-mk_lowercase(A,C),p169(C,B).
...
p1047(A,B):-p464(A,C),p305(C,B).
p1048(A,B):-p63(A,C),p1048_1(C,B).
p1048_1(A,B):-p169(A,C),p61(C,B).
p1053(A,B):-skip1(A,C),p1053_1(C,B).
p1053_1(A,B):-p305(A,C),p965(C,B).
...
p1085_1(A,B):-p62(A,C),p521(C,B).
p1093(A,B):-is_number(A),p825(A,B).
p1093(A,B):-skip1(A,C),p1093(C,B).
p1095(A,B):-p1965(A,C),p15(C,B).
p1098(A,B):-p965(A,C),p129(C,B).
p1099(A,B):-p65(A,C),p1099_1(C,B).
p1099_1(A,B):-p203(A,C),mk_lowercase(C,B).
p1101(A,B):-p17(A,C),p1054(C,B).
p1103(A,B):-p359(A,C),p521(C,B).
p1105(A,B):-p63(A,C),p152(C,B).
p1106(A,B):-p268(A,C),p1106_1(C,B).
p1106_1(A,B):-p577(A,C),p458(C,B).
...
p1111_1(A,B):-p305(A,C),p391(C,B).
p1112(A,B):-p887(A,C),p129(C,B).
p1114(A,B):-p135(A,C),p129(C,B).
p1115(A,B):-p521(A,C),p634(C,B).
p1116(A,B):-copy1(A,C),p1116_1(C,B).
p1116_1(A,B):-p904(A,C),p509(C,B).
p1120(A,B):-p305(A,C),p1689(C,B).
...
p1166_1(A,B):-p574(A,C),p1166_2(C,B).
p1166_2(A,B):-mk_uppercase(A,C),p114(C,B).
...
p1305(A,B):-p577(A,C),p1305_1(C,B).
p1305_1(A,B):-p33(A,C),p556(C,B).
p1307(A,B):-p337(A,C),p40(C,B).
p1315(A,B):-p1478(A,C),p305(C,B).
p1321(A,B):-skip1(A,C),p1321_1(C,B).
p1321_1(A,B):-p129(A,C),p1321_2(C,B).
p1321_2(A,B):-skip1(A,C),p297(C,B).
p1322(A,B):-p65(A,C),p1322_1(C,B).
p1322_1(A,B):-skip1(A,C),p1322_2(C,B).
p1322_2(A,B):-skip1(A,C),p827(C,B).
...
p1392(A,B):-p65(A,C),p1392_1(C,B).
p1392_1(A,B):-p79(A,C),p65(C,B).
...
p1401(A,B):-p771(A,C),p1401_1(C,B).
p1401_1(A,B):-p455(A,C),mk_lowercase(C,B).
p1405(A,B):-p1756(A,C),p17(C,B).
p1409(A,B):-p54(A,C),p277(C,B).
p1412(A,B):-p210(A,C),p54(C,B).
p1414(A,B):-p305(A,C),p987(C,B).
p1415(A,B):-p965(A,C),p305(C,B).
...
p1442_1(A,B):-skip1(A,C),p1442_2(C,B).
p1442_2(A,B):-skip1(A,C),p44(C,B).
...
p1493(A,B):-p73(A,C),p1493_1(C,B).
p1493_1(A,B):-p536(A,C),p17(C,B).
...
p1574(A,B):-p135(A,C),p1574_1(C,B).
p1574_1(A,B):-skip1(A,C),p33(C,B).
...
p1591(A,B):-p65(A,C),p1591_1(C,B).
p1591_1(A,B):-skip1(A,C),p485(C,B).
p1593(A,B):-p1196(A,C),p129(C,B).
p1594(A,B):-p455(A,C),p1594_1(C,B).
p1594_1(A,B):-mk_lowercase(A,C),p904(C,B).
p1596(A,B):-mk_uppercase(A,C),p297(C,B).
p1597(A,B):-p7(A,C),p85(C,B).
p1603(A,B):-p297(A,C),p598(C,B).
p1605(A,B):-p843(A,C),p1605_1(C,B).
p1605_1(A,B):-skip1(A,C),p508(C,B).
...
p1628(A,B):-p152(A,C),p54(C,B).
p1630(A,B):-p1430(A,C),p577(C,B).
...
p1691_1(A,B):-skip1(A,C),p1691_2(C,B).
p1691_2(A,B):-skip1(A,C),p398(C,B).
p1695(A,B):-p455(A,C),p6(C,B).
p1698(A,B):-p129(A,C),p1698_1(C,B).
p1698_1(A,B):-p826(A,C),p263(C,B).
...
p1702_1(A,B):-p1149(A,C),p7(C,B).
p1703(A,B):-copy1(A,C),p1703_1(C,B).
p1703_1(A,B):-p274(A,C),p1403(C,B).
p1707(A,B):-p536(A,C),p398(C,B).
p1708(A,B):-p485(A,C),p169(C,B).
...
p1725(A,B):-p668(A,C),p1725_1(C,B).
p1725_1(A,B):-p33(A,C),p114(C,B).
p1726(A,B):-p844(A,C),mk_uppercase(C,B).
p1727(A,B):-p598(A,C),p869(C,B).
...
p1888_1(A,B):-p29(A,C),p15(C,B).
p1892(A,B):-p657(A,C),p965(C,B).
p1895(A,B):-p305(A,C),p359(C,B).
p1897(A,B):-p972(A,C),p889(C,B).
p1900(A,B):-p1613(A,C),p297(C,B).
p1902(A,B):-p1816(A,C),p1902_1(C,B).
p1902_1(A,B):-mk_uppercase(A,C),p15(C,B).
p1908(A,B):-p880(A,C),p63(C,B).
p1909(A,B):-p233(A,C),p657(C,B).
p1916(A,B):-copy1(A,C),p1406(C,B).
p1918(A,B):-p169(A,C),p700(C,B).
p1922(A,B):-p207(A,C),copy1(C,B).
p1923(A,B):-p458(A,C),p135(C,B).
p1928(A,B):-copy1(A,C),p1928_1(C,B).
p1928_1(A,B):-p129(A,C),p337(C,B).
p1931(A,B):-p54(A,C),p122(C,B).
p1932(A,B):-mk_lowercase(A,C),p61(C,B).
p1932(A,B):-p298(A,C),p1932(C,B).
...
p1957_1(A,B):-p63(A,C),p1793(C,B).
p1963(A,B):-p65(A,C),p1963_1(C,B).
p1963_1(A,B):-p111(A,C),p904(C,B).
p1966(A,B):-skip1(A,C),p1966_1(C,B).
p1966_1(A,B):-skip1(A,C),p122(C,B).
p1970(A,B):-mk_lowercase(A,C),p618(C,B).
p1971(A,B):-p869(A,C),p423(C,B).
p1973(A,B):-p65(A,C),p370(C,B).
p1974(A,B):-skip1(A,C),p1974_1(C,B).
p1974_1(A,B):-skip1(A,C),p786(C,B).
p1975(A,B):-mk_uppercase(A,C),p1975_1(C,B).
p1975_1(A,B):-skip1(A,C),p1975_2(C,B).
p1975_2(A,B):-p971(A,C),p65(C,B).
p1978(A,B):-p297(A,C),p1978_1(C,B).
p1978_1(A,B):-skip1(A,C),p703(C,B).
p1980(A,B):-p63(A,C),p1980_1(C,B).
p1980_1(A,B):-p129(A,C),p1980_2(C,B).
...
p1986(A,B):-p598(A,C),p1986_1(C,B).
p1986_1(A,B):-skip1(A,C),p1816(C,B).
p1990(A,B):-p65(A,C),p486(C,B).
p1994(A,B):-p17(A,C),p1994_1(C,B).
p1994_1(A,B):-p1122(A,C),p277(C,B).
% asserting p2/2
% asserting p5/2
% asserting p8/2
% asserting p10/2
...
p183_1(A,B):-p23(A,C),mk_lowercase(C,B).
p272(A,B):-p1365(A,C),p272_1(C,B).
p272_1(A,B):-mk_lowercase(A,C),p337(C,B).
p332(A,B):-mk_lowercase(A,C),p332_1(C,B).
p332_1(A,B):-p668(A,C),p332_2(C,B).
p332_2(A,B):-mk_uppercase(A,C),p364(C,B).
...
p558_2(A,B):-p23(A,C),copy1(C,B).
p753(A,B):-p1208(A,C),p753_1(C,B).
p753_1(A,B):-skip1(A,C),p458(C,B).
p773(A,B):-skip1(A,C),p773_1(C,B).
p773_1(A,B):-p33(A,C),p1207(C,B).
p846(A,B):-p65(A,C),p846_1(C,B).
p846_1(A,B):-p427(A,C),p65(C,B).
p877(A,B):-p17(A,C),p934(C,B).
p1271(A,B):-p802(A,C),p1271_1(C,B).
p1271_1(A,B):-skip1(A,C),p305(C,B).
p1448(A,B):-mk_lowercase(A,C),p1448_1(C,B).
p1448_1(A,B):-p704(A,C),p305(C,B).
p1483(A,B):-skip1(A,C),p1483_1(C,B).
p1483_1(A,B):-p33(A,C),p215(C,B).
p1569(A,B):-skip1(A,C),p1569_1(C,B).
p1569_1(A,B):-skip1(A,C),p23(C,B).
p1886(A,B):-mk_lowercase(A,C),p1886_1(C,B).
p1886_1(A,B):-p1756(A,C),p1886_2(C,B).
p1886_2(A,B):-skip1(A,C),p305(C,B).
p1985(A,B):-p273(A,C),p1985_1(C,B).
p1985_1(A,B):-p17(A,C),p771(C,B).
% asserting p183/2
% asserting p272/2
% asserting p332/2
% asserting p341/2

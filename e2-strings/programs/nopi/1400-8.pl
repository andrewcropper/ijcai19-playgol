...
p18(A,B):-p99(A,C),p18_1(C,B).
p18_1(A,B):-p91(A,C),p2(C,B).
...
p43_1(A,B):-p412(A,C),mk_uppercase(C,B).
p48(A,B):-p907(A,C),p49(C,B).
p50(A,B):-skip1(A,C),p50_1(C,B).
p50_1(A,B):-p186(A,C),p593(C,B).
p53(A,B):-p966(A,C),p53_1(C,B).
p53_1(A,B):-skip1(A,C),p1059(C,B).
...
p98_1(A,B):-p46(A,C),p49(C,B).
p104(A,B):-p137(A,C),p104_1(C,B).
p104_1(A,B):-p99(A,C),p104_2(C,B).
p104_2(A,B):-skip1(A,C),p12(C,B).
p106(A,B):-p75(A,C),p186(C,B).
p108(A,B):-p248(A,C),p195(C,B).
p112(A,B):-p114(A,C),p112_1(C,B).
p112_1(A,B):-p46(A,C),p64(C,B).
p127(A,B):-p42(A,C),p110(C,B).
p129(A,B):-copy1(A,C),p129_1(C,B).
p129_1(A,B):-p99(A,C),p907(C,B).
p132(A,B):-skip1(A,C),p132_1(C,B).
p132_1(A,B):-p27(A,C),p49(C,B).
...
p352(A,B):-p289(A,C),p352_1(C,B).
p352_1(A,B):-p456(A,C),p14(C,B).
...
p373(A,B):-p1040(A,C),p373_1(C,B).
p373_1(A,B):-p56(A,C),p99(C,B).
...
p405_1(A,B):-p99(A,C),p248(C,B).
p406(A,B):-skip1(A,C),p589(C,B).
p411(A,B):-p593(A,C),p454(C,B).
p420(A,B):-skip1(A,C),p420_1(C,B).
p420_1(A,B):-p27(A,C),p130(C,B).
p424(A,B):-p1235(A,C),p248(C,B).
p427(A,B):-mk_uppercase(A,C),p427_1(C,B).
p427_1(A,B):-p152(A,C),p290(C,B).
p428(A,B):-p75(A,C),p974(C,B).
p430(A,B):-p500(A,C),p430_1(C,B).
p430_1(A,B):-mk_uppercase(A,C),p752(C,B).
p431(A,B):-p27(A,C),p431_1(C,B).
p431_1(A,B):-p425(A,C),p990(C,B).
p432(A,B):-p494(A,C),p432_1(C,B).
p432_1(A,B):-p14(A,C),p99(C,B).
...
p444(A,B):-p315(A,C),p103(C,B).
p449(A,B):-p289(A,C),p449_1(C,B).
p449_1(A,B):-p974(A,C),mk_lowercase(C,B).
p452(A,B):-p152(A,C),p589(C,B).
p457(A,B):-p99(A,C),p457_1(C,B).
p457_1(A,B):-p46(A,C),p975(C,B).
p463(A,B):-p88(A,C),p463_1(C,B).
p463_1(A,B):-p494(A,C),p99(C,B).
p466(A,B):-p22(A,C),p32(C,B).
p467(A,B):-skip1(A,C),p467_1(C,B).
p467_1(A,B):-p27(A,C),p467_2(C,B).
p467_2(A,B):-p456(A,C),p288(C,B).
p469(A,B):-p162(A,C),p46(C,B).
...
p480_1(A,B):-p456(A,C),p480_2(C,B).
p480_2(A,B):-p932(A,C),p42(C,B).
...
p505(A,B):-p505_1(A,B),is_uppercase(B).
p505_1(A,B):-p88(A,C),p280(C,B).
p506(A,B):-skip1(A,C),p47(C,B).
p507(A,B):-p114(A,C),p589(C,B).
p511(A,B):-p103(A,C),p752(C,B).
...
p525_1(A,B):-p75(A,C),p557(C,B).
p528(A,B):-p97(A,C),p218(C,B).
p534(A,B):-skip1(A,C),p494(C,B).
p536(A,B):-p645(A,C),p966(C,B).
...
p551(A,B):-p296(A,C),p168(C,B).
p554(A,B):-mk_uppercase(A,C),p554_1(C,B).
p554_1(A,B):-p91(A,C),p554_2(C,B).
p554_2(A,B):-p14(A,C),p256(C,B).
...
p584_1(A,B):-skip1(A,C),p731(C,B).
p585(A,B):-p42(A,C),p585_1(C,B).
p585_1(A,B):-skip1(A,C),p731(C,B).
p591(A,B):-copy1(A,C),p591_1(C,B).
p591_1(A,B):-p113(A,C),p610(C,B).
p592(A,B):-p377(A,C),p592_1(C,B).
p592_1(A,B):-skip1(A,C),p795(C,B).
...
p632_1(A,B):-p27(A,C),p64(C,B).
p633(A,B):-mk_uppercase(A,C),p540(C,B).
p634(A,B):-p773(A,C),p1059(C,B).
...
p779_1(A,B):-p1153(A,C),copy1(C,B).
...
p911(A,B):-p401(A,C),p181(C,B).
p913(A,B):-p97(A,C),p913_1(C,B).
p913_1(A,B):-mk_lowercase(A,C),p731(C,B).
...
p936(A,B):-p256(A,C),p936_1(C,B).
p936_1(A,B):-p152(A,C),p49(C,B).
...
p1103(A,B):-p49(A,C),p1103_1(C,B).
p1103_1(A,B):-p64(A,C),p456(C,B).
p1105(A,B):-p91(A,C),p851(C,B).
...
p1140_1(A,B):-p183(A,C),p75(C,B).
p1141(A,B):-p137(A,C),p1141_1(C,B).
p1141_1(A,B):-p435(A,C),p114(C,B).
...
p1201_2(A,B):-p494(A,C),p168(C,B).
p1204(A,B):-copy1(A,C),p1204_1(C,B).
p1204_1(A,B):-p810(A,C),p289(C,B).
p1205(A,B):-p137(A,C),p1205_1(C,B).
p1205_1(A,B):-p1249(A,C),mk_lowercase(C,B).
...
p1215_1(A,B):-p274(A,C),p169(C,B).
p1216(A,B):-p248(A,C),p103(C,B).
p1218(A,B):-p500(A,C),p1218_1(C,B).
p1218_1(A,B):-p514(A,C),p1059(C,B).
...
p1286(A,B):-p14(A,C),p1286_1(C,B).
p1286_1(A,B):-p121(A,C),mk_uppercase(C,B).
p1291(A,B):-copy1(A,C),p1291_1(C,B).
p1291_1(A,B):-p99(A,C),p248(C,B).
p1293(A,B):-p1293_1(A,B),is_uppercase(B).
p1293_1(A,B):-p169(A,C),p1191(C,B).
...
p1305_1(A,B):-p14(A,C),p379(C,B).
p1306(A,B):-copy1(A,C),p1306_1(C,B).
p1306_1(A,B):-p401(A,C),p2(C,B).
...
p1334(A,B):-p583(A,C),p1334_1(C,B).
p1334_1(A,B):-skip1(A,C),p401(C,B).
...
p1343(A,B):-p121(A,C),p1343_1(C,B).
p1343_1(A,B):-mk_uppercase(A,C),p401(C,B).
p1344(A,B):-p97(A,C),p298(C,B).
p1345(A,B):-p114(A,C),p533(C,B).
p1346(A,B):-copy1(A,C),p1346_1(C,B).
p1346_1(A,B):-p1335(A,C),p77(C,B).
p1348(A,B):-p216(A,C),p1348_1(C,B).
p1348_1(A,B):-copy1(A,C),p111(C,B).
p1352(A,B):-skip1(A,C),p1352_1(C,B).
p1352_1(A,B):-p289(A,C),p599(C,B).
...
p410_2(A,B):-skip1(A,C),p995(C,B).
p413(A,B):-p1254(A,C),copy1(C,B).
p535(A,B):-p597(A,C),p1059(C,B).
p647(A,B):-p647_1(A,C),p190(C,B).
p647_1(A,B):-p851(A,C),skip1(C,B).
p647_1(A,B):-skip1(A,C),p647_1(C,B).
p656(A,B):-p42(A,C),p656_1(C,B).
p656_1(A,B):-p152(A,C),p656_2(C,B).
p656_2(A,B):-skip1(A,C),p574(C,B).
p748(A,B):-p636(A,C),p27(C,B).
p759(A,B):-skip1(A,C),p759_1(C,B).
p759_1(A,B):-skip1(A,C),p759_2(C,B).
p759_2(A,B):-skip1(A,C),p32(C,B).
...
%timeout
%timeout
b113(A,B):-p929(A,C),b113_1(C,B).
b113_1(A,B):-skip1(A,C),p12(C,B).
%timeout
%timeout
%timeout
...
%timeout
%timeout
b224(A,B):-p513(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout

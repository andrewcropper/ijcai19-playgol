...
p27_1(A,B):-p52(A,C),p1338(C,B).
p30(A,B):-p10(A,C),p30_1(C,B).
p30_1(A,B):-p307(A,C),mk_lowercase(C,B).
p34(A,B):-p52(A,C),p792(C,B).
p37(A,B):-p136(A,C),p1740(C,B).
p38(A,B):-skip1(A,C),p693(C,B).
p41(A,B):-copy1(A,C),p41_1(C,B).
p41_1(A,B):-p1525(A,C),mk_lowercase(C,B).
...
p50_1(A,B):-p15(A,C),p1299(C,B).
p51(A,B):-skip1(A,C),p51_1(C,B).
p51_1(A,B):-skip1(A,C),p1050(C,B).
p53(A,B):-p126(A,C),p137(C,B).
p54(A,B):-p668(A,C),p73(C,B).
p55(A,B):-p866(A,C),p55_1(C,B).
p55_1(A,B):-mk_lowercase(A,C),p67(C,B).
p56(A,B):-skip1(A,C),p184(C,B).
p58(A,B):-p60(A,C),p58_1(C,B).
p58_1(A,B):-mk_uppercase(A,C),p19(C,B).
p61(A,B):-p86(A,C),p61_1(C,B).
p61_1(A,B):-p137(A,C),p131(C,B).
p62(A,B):-p15(A,C),p707(C,B).
p63(A,B):-p287(A,C),p63_1(C,B).
p63_1(A,B):-skip1(A,C),p145(C,B).
p65(A,B):-p273(A,C),p1799(C,B).
p69(A,B):-p332(A,C),p136(C,B).
p75(A,B):-mk_uppercase(A,C),p75_1(C,B).
p75_1(A,B):-is_lowercase(A),p77(A,B).
p75_1(A,B):-skip1(A,C),p75_1(C,B).
p78(A,B):-p1071(A,C),p1376(C,B).
p82(A,B):-p102(A,C),p82_1(C,B).
p82_1(A,B):-skip1(A,C),p237(C,B).
p83(A,B):-copy1(A,C),p83_1(C,B).
p83_1(A,B):-p270(A,C),p15(C,B).
p91(A,B):-p148(A,C),p72(C,B).
p92(A,B):-copy1(A,C),p92_1(C,B).
p92_1(A,B):-p1676(A,C),p1050(C,B).
p95(A,B):-skip1(A,C),p95_1(C,B).
p95_1(A,B):-p1369(A,C),p359(C,B).
p97(A,B):-p145(A,C),p97_1(C,B).
p97_1(A,B):-p444(A,C),p1528(C,B).
p98(A,B):-p13(A,C),p98_1(C,B).
p98_1(A,B):-p131(A,C),p1346(C,B).
p99(A,B):-copy1(A,C),p99_1(C,B).
p99_1(A,B):-p96(A,C),p10(C,B).
p104(A,B):-skip1(A,C),p104_1(C,B).
p104_1(A,B):-skip1(A,C),p673(C,B).
p108(A,B):-copy1(A,C),p108_1(C,B).
p108_1(A,B):-skip1(A,C),p80(C,B).
...
p149(A,B):-p287(A,C),p720(C,B).
p149(A,B):-skip1(A,C),p149(C,B).
p151(A,B):-p1525(A,C),mk_lowercase(C,B).
...
p318_1(A,B):-p10(A,C),p318_2(C,B).
p318_2(A,B):-skip1(A,C),p1642(C,B).
...
p340_1(A,B):-p1716(A,C),p997(C,B).
p341(A,B):-copy1(A,C),p273(C,B).
p342(A,B):-p260(A,C),p342_1(C,B).
p342_1(A,B):-skip1(A,C),p1525(C,B).
p344(A,B):-p32(A,C),p136(C,B).
p345(A,B):-p52(A,C),p345_1(C,B).
p345_1(A,B):-p444(A,C),p428(C,B).
...
p463(A,B):-p1369(A,C),p131(C,B).
p463(A,B):-skip1(A,C),p463(C,B).
...
p534_1(A,B):-p447(A,C),copy1(C,B).
p537(A,B):-p10(A,C),p537_1(C,B).
p537_1(A,B):-p1565(A,C),p282(C,B).
p538(A,B):-p32(A,C),p19(C,B).
p539(A,B):-p131(A,C),p283(C,B).
p544(A,B):-copy1(A,C),p544_1(C,B).
p544_1(A,B):-p1110(A,C),p544_2(C,B).
p544_2(A,B):-skip1(A,C),p36(C,B).
...
p566_1(A,B):-p372(A,C),copy1(C,B).
p567(A,B):-p10(A,C),p659(C,B).
p572(A,B):-p1369(A,C),p282(C,B).
...
p602(A,B):-p23(A,C),p602_1(C,B).
p602_1(A,B):-p428(A,C),p9(C,B).
p606(A,B):-p96(A,C),p10(C,B).
p609(A,B):-p15(A,C),p283(C,B).
p612(A,B):-p32(A,C),p616(C,B).
p614(A,B):-p145(A,C),p614_1(C,B).
p614_1(A,B):-p15(A,C),p427(C,B).
p617(A,B):-p96(A,C),p617_1(C,B).
p617_1(A,B):-p145(A,C),p137(C,B).
p619(A,B):-copy1(A,C),p619_1(C,B).
p619_1(A,B):-p693(A,C),p136(C,B).
p622(A,B):-p110(A,C),p207(C,B).
p624(A,B):-skip1(A,C),p624_1(C,B).
p624_1(A,B):-skip1(A,C),p432(C,B).
p625(A,B):-p625_1(A,B),is_uppercase(B).
p625_1(A,B):-p694(A,C),p1622(C,B).
...
p641(A,B):-p350(A,C),p641_1(C,B).
p641_1(A,B):-p1369(A,C),p52(C,B).
...
p651(A,B):-p1676(A,C),p651_1(C,B).
p651_1(A,B):-p131(A,C),p48(C,B).
...
p664_1(A,B):-p282(A,C),p1530(C,B).
p665(A,B):-p623(A,C),p145(C,B).
p667(A,B):-p57(A,C),p475(C,B).
p670(A,B):-p376(A,C),p15(C,B).
...
p688_1(A,B):-p287(A,C),p688_2(C,B).
p688_2(A,B):-skip1(A,C),p133(C,B).
...
p700(A,B):-p658(A,C),p136(C,B).
p702(A,B):-p693(A,C),p404(C,B).
p704(A,B):-p10(A,C),p201(C,B).
p706(A,B):-copy1(A,C),p706_1(C,B).
p706_1(A,B):-p910(A,C),p910(C,B).
p709(A,B):-not_empty(A),p349(A,B).
p709(A,B):-skip1(A,C),p709(C,B).
p710(A,B):-p136(A,C),p1019(C,B).
p714(A,B):-p15(A,C),p714_1(C,B).
p714_1(A,B):-p287(A,C),p23(C,B).
p717(A,B):-p283(A,C),p1528(C,B).
p718(A,B):-p1047(A,C),p119(C,B).
p719(A,B):-copy1(A,C),p719_1(C,B).
p719_1(A,B):-p1065(A,C),p137(C,B).
p729(A,B):-p10(A,C),p729_1(C,B).
p729_1(A,B):-skip1(A,C),p635(C,B).
p732(A,B):-copy1(A,C),p732_1(C,B).
p732_1(A,B):-p136(A,C),p260(C,B).
...
p763_1(A,B):-p1(A,C),p131(C,B).
p764(A,B):-p1310(A,C),copy1(C,B).
p766(A,B):-p9(A,C),p766_1(C,B).
p766_1(A,B):-p102(A,C),p136(C,B).
...
p782(A,B):-p577(A,C),p501(C,B).
p784(A,B):-p527(A,C),p784_1(C,B).
p784_1(A,B):-copy1(A,C),p1110(C,B).
p785(A,B):-skip1(A,C),p785_1(C,B).
p785_1(A,B):-skip1(A,C),p635(C,B).
...
p819(A,B):-p219(A,C),p819_1(C,B).
p819_1(A,B):-skip1(A,C),p36(C,B).
...
p858_1(A,B):-p866(A,C),p15(C,B).
p860(A,B):-copy1(A,C),p860_1(C,B).
p860_1(A,B):-p1047(A,C),p860_2(C,B).
p860_2(A,B):-skip1(A,C),p39(C,B).
p863(A,B):-p119(A,C),p20(C,B).
p864(A,B):-p924(A,C),p707(C,B).
...
p906_1(A,B):-skip1(A,C),p1379(C,B).
...
p935(A,B):-p672(A,C),p1530(C,B).
p938(A,B):-p148(A,C),p350(C,B).
p939(A,B):-p13(A,C),p601(C,B).
p940(A,B):-p282(A,C),p940_1(C,B).
p940_1(A,B):-skip1(A,C),p438(C,B).
p942(A,B):-p136(A,C),p942_1(C,B).
p942_1(A,B):-p436(A,C),p167(C,B).
p943(A,B):-copy1(A,C),p943_1(C,B).
p943_1(A,B):-p15(A,C),p332(C,B).
...
p1063_1(A,B):-p1622(A,C),p581(C,B).
p1064(A,B):-p126(A,C),p1387(C,B).
p1068(A,B):-copy1(A,C),p1068_1(C,B).
p1068_1(A,B):-p60(A,C),p136(C,B).
p1070(A,B):-p136(A,C),p376(C,B).
p1072(A,B):-skip1(A,C),p1072_1(C,B).
p1072_1(A,B):-p126(A,C),p1376(C,B).
p1075(A,B):-p137(A,C),p1075_1(C,B).
p1075_1(A,B):-skip1(A,C),p287(C,B).
p1084(A,B):-p219(A,C),p1084_1(C,B).
p1084_1(A,B):-skip1(A,C),p1055(C,B).
p1085(A,B):-skip1(A,C),p57(C,B).
p1086(A,B):-p10(A,C),p1086_1(C,B).
p1086_1(A,B):-p997(A,C),p1086_2(C,B).
p1086_2(A,B):-mk_uppercase(A,C),p52(C,B).
p1090(A,B):-skip1(A,C),p406(C,B).
p1091(A,B):-p1676(A,C),p497(C,B).
p1095(A,B):-copy1(A,C),p1095_1(C,B).
p1095_1(A,B):-p136(A,C),p40(C,B).
p1096(A,B):-p10(A,C),p1096_1(C,B).
p1096_1(A,B):-skip1(A,C),p1379(C,B).
p1097(A,B):-p68(A,C),p1791(C,B).
p1101(A,B):-p376(A,C),p1550(C,B).
p1102(A,B):-p924(A,C),p36(C,B).
p1103(A,B):-p32(A,C),p1103_1(C,B).
p1103_1(A,B):-p110(A,C),p136(C,B).
p1107(A,B):-p145(A,C),p1107_1(C,B).
p1107_1(A,B):-p15(A,C),p1174(C,B).
...
p1129_1(A,B):-p332(A,C),p1129_2(C,B).
p1129_2(A,B):-p287(A,C),p145(C,B).
p1131(A,B):-p33(A,C),p1376(C,B).
p1132(A,B):-p136(A,C),p1132_1(C,B).
p1132_1(A,B):-p309(A,C),mk_uppercase(C,B).
p1135(A,B):-skip1(A,C),p1135_1(C,B).
p1135_1(A,B):-p282(A,C),p181(C,B).
...
p1171_1(A,B):-p668(A,C),p19(C,B).
p1172(A,B):-skip1(A,C),p1172_1(C,B).
p1172_1(A,B):-p52(A,C),p672(C,B).
...
p1190(A,B):-p1190_1(A,B),is_number(B).
p1190_1(A,B):-p658(A,C),p1622(C,B).
p1193(A,B):-p577(A,C),p1193_1(C,B).
p1193_1(A,B):-mk_lowercase(A,C),p350(C,B).
p1198(A,B):-p32(A,C),p1198_1(C,B).
p1198_1(A,B):-p694(A,C),copy1(C,B).
...
p1204(A,B):-p219(A,C),p1204_1(C,B).
p1204_1(A,B):-p1098(A,C),mk_uppercase(C,B).
p1206(A,B):-mk_uppercase(A,C),p1206_1(C,B).
p1206_1(A,B):-p527(A,C),copy1(C,B).
...
p1216_1(A,B):-p307(A,C),p52(C,B).
p1217(A,B):-p1413(A,C),p23(C,B).
p1218(A,B):-p1110(A,C),p270(C,B).
p1221(A,B):-p792(A,C),p185(C,B).
...
p1242(A,B):-p282(A,C),p1242_1(C,B).
p1242_1(A,B):-p39(A,C),p131(C,B).
p1246(A,B):-copy1(A,C),p924(C,B).
p1247(A,B):-p270(A,C),p1522(C,B).
p1251(A,B):-p698(A,C),p1251_1(C,B).
p1251_1(A,B):-p287(A,C),p9(C,B).
p1261(A,B):-p77(A,C),p217(C,B).
p1266(A,B):-p659(A,C),copy1(C,B).
p1269(A,B):-p1110(A,C),p1269_1(C,B).
p1269_1(A,B):-p52(A,C),p126(C,B).
p1272(A,B):-copy1(A,C),p1272_1(C,B).
p1272_1(A,B):-p15(A,C),p1272_2(C,B).
p1272_2(A,B):-skip1(A,C),p792(C,B).
...
p1327_1(A,B):-skip1(A,C),p501(C,B).
...
p1477(A,B):-p126(A,C),p1477_1(C,B).
p1477_1(A,B):-skip1(A,C),p611(C,B).
...
p1500_1(A,B):-p32(A,C),p668(C,B).
p1501(A,B):-p10(A,C),p1256(C,B).
p1502(A,B):-p136(A,C),p270(C,B).
p1504(A,B):-p23(A,C),p1310(C,B).
p1505(A,B):-mk_uppercase(A,C),p1505_1(C,B).
p1505_1(A,B):-p136(A,C),p32(C,B).
p1508(A,B):-p15(A,C),p1508_1(C,B).
p1508_1(A,B):-p783(A,C),mk_uppercase(C,B).
p1510(A,B):-p461(A,C),p1510_1(C,B).
p1510_1(A,B):-skip1(A,C),p1098(C,B).
p1512(A,B):-p198(A,C),p212(C,B).
p1514(A,B):-p15(A,C),p1514_1(C,B).
p1514_1(A,B):-skip1(A,C),p273(C,B).
...
p1543(A,B):-p72(A,C),p1110(C,B).
p1544(A,B):-copy1(A,C),p119(C,B).
p1545(A,B):-p287(A,C),p1530(C,B).
p1549(A,B):-p102(A,C),p1549_1(C,B).
p1549_1(A,B):-skip1(A,C),p672(C,B).
p1553(A,B):-skip1(A,C),p1553_1(C,B).
p1553_1(A,B):-p10(A,C),p321(C,B).
p1556(A,B):-copy1(A,C),p1556_1(C,B).
p1556_1(A,B):-is_space(A),p283(A,B).
p1556_1(A,B):-skip1(A,C),p1556_1(C,B).
...
p1589(A,B):-p1573(A,C),p66(C,B).
p1592(A,B):-p792(A,C),p1791(C,B).
p1593(A,B):-p10(A,C),p475(C,B).
p1596(A,B):-copy1(A,C),p1596_1(C,B).
p1596_1(A,B):-p137(A,C),p1596_2(C,B).
p1596_2(A,B):-p185(A,C),p10(C,B).
p1598(A,B):-skip1(A,C),p1598_1(C,B).
p1598_1(A,B):-p52(A,C),p461(C,B).
p1600(A,B):-copy1(A,C),p32(C,B).
p1601(A,B):-copy1(A,C),p1555(C,B).
p1602(A,B):-p260(A,C),p1602_1(C,B).
p1602_1(A,B):-p13(A,C),p36(C,B).
...
p1650_1(A,B):-p447(A,C),copy1(C,B).
p1652(A,B):-p131(A,C),p672(C,B).
p1653(A,B):-p32(A,C),p1653_1(C,B).
p1653_1(A,B):-skip1(A,C),p73(C,B).
...
p1729_1(A,B):-p72(A,C),p1729_2(C,B).
p1729_2(A,B):-skip1(A,C),p52(C,B).
...
p1748_1(A,B):-p1777(A,C),p1748_2(C,B).
p1748_2(A,B):-skip1(A,C),p10(C,B).
...
p1794(A,B):-p77(A,C),p13(C,B).
p1797(A,B):-copy1(A,C),p1797_1(C,B).
p1797_1(A,B):-p137(A,C),p1797_2(C,B).
p1797_2(A,B):-skip1(A,C),p36(C,B).
...
p165_1(A,B):-p799(A,C),p1174(C,B).
p296(A,B):-p1110(A,C),p296_1(C,B).
p296_1(A,B):-skip1(A,C),p191(C,B).
p304(A,B):-copy1(A,C),p304_1(C,B).
p304_1(A,B):-p22(A,C),p102(C,B).
p356(A,B):-p13(A,C),p1322(C,B).
p481(A,B):-p10(A,C),p481_1(C,B).
p481_1(A,B):-p699(A,C),mk_uppercase(C,B).
p494(A,B):-mk_lowercase(A,C),p494_1(C,B).
p494_1(A,B):-p191(A,C),copy1(C,B).
p521(A,B):-skip1(A,C),p42(C,B).
p536(A,B):-not_empty(A),p471(A,B).
p604(A,B):-skip1(A,C),p604_1(C,B).
p604_1(A,B):-p13(A,C),p476(C,B).
p742(A,B):-p38(A,C),p742_1(C,B).
p742_1(A,B):-p20(A,C),p136(C,B).
p777(A,B):-copy1(A,C),p777_1(C,B).
p777_1(A,B):-p114(A,C),p126(C,B).
p849(A,B):-mk_lowercase(A,C),p849_1(C,B).
p849_1(A,B):-p350(A,C),p587(C,B).
p921(A,B):-mk_lowercase(A,C),p921_1(C,B).
p921_1(A,B):-p587(A,C),copy1(C,B).
p926(A,B):-copy1(A,C),p926_1(C,B).
p926_1(A,B):-skip1(A,C),p69(C,B).
p1189(A,B):-p23(A,C),p1189_1(C,B).
p1189_1(A,B):-mk_uppercase(A,C),p1189_2(C,B).
p1189_2(A,B):-p191(A,C),mk_lowercase(C,B).
p1446(A,B):-mk_uppercase(A,C),p1446_1(C,B).
p1446_1(A,B):-p39(A,C),p1446_2(C,B).
p1446_2(A,B):-skip1(A,C),p1777(C,B).
p1450(A,B):-p1346(A,C),p1450_1(C,B).
p1450_1(A,B):-p587(A,C),copy1(C,B).
p1625(A,B):-copy1(A,C),p1625_1(C,B).
p1625_1(A,B):-p1208(A,C),copy1(C,B).
...
b323_1(A,B):-p1376(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p32(A,B),is_uppercase(B).

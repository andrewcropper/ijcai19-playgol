...
p38(A,B):-p746(A,C),p105(C,B).
p41(A,B):-p105(A,C),p41_1(C,B).
p41_1(A,B):-p53(A,C),mk_lowercase(C,B).
p42(A,B):-mk_uppercase(A,C),p705(C,B).
p43(A,B):-mk_uppercase(A,C),p303(C,B).
p46(A,B):-p204(A,C),p5(C,B).
p49(A,B):-p17(A,C),p49_1(C,B).
p49_1(A,B):-skip1(A,C),p49_2(C,B).
p49_2(A,B):-p264(A,C),mk_uppercase(C,B).
...
p69(A,B):-p552(A,C),p69_1(C,B).
p69_1(A,B):-mk_uppercase(A,C),p1330(C,B).
...
p154(A,B):-p665(A,C),p154_1(C,B).
p154_1(A,B):-p79(A,C),p208(C,B).
p155(A,B):-p1444(A,C),p155_1(C,B).
p155_1(A,B):-mk_uppercase(A,C),p264(C,B).
...
p290_1(A,B):-skip1(A,C),p963(C,B).
p292(A,B):-mk_lowercase(A,C),p292_1(C,B).
p292_1(A,B):-p333(A,C),p292_2(C,B).
p292_2(A,B):-skip1(A,C),p110(C,B).
p293(A,B):-p208(A,C),p665(C,B).
p305(A,B):-skip1(A,C),p441(C,B).
p307(A,B):-p208(A,C),p307_1(C,B).
p307_1(A,B):-p73(A,C),p334(C,B).
...
p315_1(A,B):-p110(A,C),p208(C,B).
p316(A,B):-skip1(A,C),p316_1(C,B).
p316_1(A,B):-p680(A,C),p1(C,B).
p317(A,B):-copy1(A,C),p317_1(C,B).
p317_1(A,B):-p483(A,C),p88(C,B).
p319(A,B):-p1284(A,C),p1(C,B).
p321(A,B):-copy1(A,C),p321_1(C,B).
p321_1(A,B):-p208(A,C),p673(C,B).
p322(A,B):-p656(A,C),p322_1(C,B).
p322_1(A,B):-copy1(A,C),p929(C,B).
...
p338(A,B):-p930(A,C),p338_1(C,B).
p338_1(A,B):-p1545(A,C),mk_uppercase(C,B).
...
p357(A,B):-p20(A,C),p357_1(C,B).
p357_1(A,B):-p26(A,C),p194(C,B).
...
p366_1(A,B):-p17(A,C),p52(C,B).
p371(A,B):-copy1(A,C),p371_1(C,B).
p371_1(A,B):-is_uppercase(A),p5(A,B).
p371_1(A,B):-skip1(A,C),p371_1(C,B).
p373(A,B):-skip1(A,C),p373_1(C,B).
p373_1(A,B):-skip1(A,C),p208(C,B).
p374(A,B):-p28(A,C),p374_1(C,B).
p374_1(A,B):-p107(A,C),p460(C,B).
p375(A,B):-mk_lowercase(A,C),p333(C,B).
p375(A,B):-skip1(A,C),p375(C,B).
p381(A,B):-p256(A,C),p705(C,B).
p382(A,B):-p1545(A,C),p382_1(C,B).
p382_1(A,B):-p28(A,C),p229(C,B).
p383(A,B):-p740(A,C),mk_lowercase(C,B).
p384(A,B):-p62(A,C),p194(C,B).
p386(A,B):-skip1(A,C),p386_1(C,B).
p386_1(A,B):-p110(A,C),p644(C,B).
p393(A,B):-p333(A,C),p393_1(C,B).
p393_1(A,B):-mk_uppercase(A,C),p393_2(C,B).
p393_2(A,B):-skip1(A,C),p110(C,B).
p396(A,B):-p1476(A,C),p225(C,B).
p397(A,B):-skip1(A,C),p397_1(C,B).
p397_1(A,B):-p28(A,C),p333(C,B).
p400(A,B):-p73(A,C),p400_1(C,B).
p400_1(A,B):-p1333(A,C),mk_uppercase(C,B).
...
p413_1(A,B):-p57(A,C),p1346(C,B).
p415(A,B):-copy1(A,C),p415_1(C,B).
p415_1(A,B):-p1444(A,C),p110(C,B).
p416(A,B):-p280(A,C),p208(C,B).
p417(A,B):-skip1(A,C),p417_1(C,B).
p417_1(A,B):-skip1(A,C),p250(C,B).
p419(A,B):-p602(A,C),mk_lowercase(C,B).
p423(A,B):-p110(A,C),p423_1(C,B).
p423_1(A,B):-p446(A,C),p5(C,B).
...
p482_1(A,B):-p656(A,C),p1451(C,B).
p488(A,B):-copy1(A,C),p740(C,B).
p491(A,B):-p208(A,C),p494(C,B).
p492(A,B):-copy1(A,C),p492_1(C,B).
p492_1(A,B):-skip1(A,C),p94(C,B).
...
p518_1(A,B):-p17(A,C),p185(C,B).
p519(A,B):-p73(A,C),p519_1(C,B).
p519_1(A,B):-mk_uppercase(A,C),p1(C,B).
p530(A,B):-copy1(A,C),p1346(C,B).
p533(A,B):-skip1(A,C),p533_1(C,B).
p533_1(A,B):-p1444(A,C),copy1(C,B).
p534(A,B):-copy1(A,C),p534_1(C,B).
p534_1(A,B):-p1(A,C),p460(C,B).
p535(A,B):-p28(A,C),p535_1(C,B).
p535_1(A,B):-p1285(A,C),p110(C,B).
p538(A,B):-mk_lowercase(A,C),p252(C,B).
p541(A,B):-p280(A,C),p541_1(C,B).
p541_1(A,B):-p73(A,C),mk_uppercase(C,B).
...
p698_1(A,B):-p1545(A,C),mk_uppercase(C,B).
...
p749(A,B):-p333(A,C),p749_1(C,B).
p749_1(A,B):-skip1(A,C),p110(C,B).
...
p798(A,B):-p440(A,C),copy1(C,B).
p799(A,B):-p53(A,C),p110(C,B).
p801(A,B):-skip1(A,C),p801_1(C,B).
p801_1(A,B):-p110(A,C),p208(C,B).
...
p807_1(A,B):-p460(A,C),p807_2(C,B).
p807_2(A,B):-p1444(A,C),copy1(C,B).
...
p957_1(A,B):-skip1(A,C),p1057(C,B).
...
p1010(A,B):-p602(A,C),mk_uppercase(C,B).
p1014(A,B):-p5(A,C),p680(C,B).
p1016(A,B):-mk_lowercase(A,C),p1016_1(C,B).
p1016_1(A,B):-p252(A,C),p174(C,B).
p1017(A,B):-copy1(A,C),p1017_1(C,B).
p1017_1(A,B):-p57(A,C),p857(C,B).
p1020(A,B):-p17(A,C),p385(C,B).
p1024(A,B):-skip1(A,C),p1024_1(C,B).
p1024_1(A,B):-p10(A,C),p325(C,B).
p1028(A,B):-p23(A,C),p1028_1(C,B).
p1028_1(A,B):-skip1(A,C),p170(C,B).
p1031(A,B):-p1031_1(A,B),not_empty(B).
p1031_1(A,B):-mk_uppercase(A,C),p71(C,B).
p1031_1(A,B):-skip1(A,C),p1031_1(C,B).
...
p1106(A,B):-p564(A,C),p110(C,B).
p1106(A,B):-p110(A,C),p1106(C,B).
p1107(A,B):-p73(A,C),p1107_1(C,B).
p1107_1(A,B):-p707(A,C),p39(C,B).
p1108(A,B):-p560(A,C),p1108_1(C,B).
p1108_1(A,B):-skip1(A,C),p1108_2(C,B).
p1108_2(A,B):-p1444(A,C),copy1(C,B).
...
p1123(A,B):-p178(A,C),p1123_1(C,B).
p1123_1(A,B):-skip1(A,C),p28(C,B).
...
p1153_1(A,B):-p194(A,C),p1110(C,B).
p1155(A,B):-p372(A,C),p1155_1(C,B).
p1155_1(A,B):-p141(A,C),p79(C,B).
...
p1190(A,B):-p110(A,C),p1190_1(C,B).
p1190_1(A,B):-p673(A,C),p256(C,B).
p1193(A,B):-skip1(A,C),p1193_1(C,B).
p1193_1(A,B):-p327(A,C),p225(C,B).
p1194(A,B):-p5(A,C),p1195(C,B).
p1196(A,B):-p1(A,C),p1196_1(C,B).
p1196_1(A,B):-p680(A,C),p325(C,B).
p1197(A,B):-p1545(A,C),p1197_1(C,B).
p1197_1(A,B):-copy1(A,C),p327(C,B).
p1198(A,B):-p677(A,C),p105(C,B).
p1199(A,B):-p17(A,C),p1199_1(C,B).
p1199_1(A,B):-p929(A,C),p673(C,B).
p1200(A,B):-p110(A,C),p1(C,B).
p1201(A,B):-p536(A,C),p1201_1(C,B).
p1201_1(A,B):-skip1(A,C),p208(C,B).
p1202(A,B):-p110(A,C),p208(C,B).
p1206(A,B):-p17(A,C),p1206_1(C,B).
p1206_1(A,B):-p656(A,C),copy1(C,B).
p1207(A,B):-mk_lowercase(A,C),p1207_1(C,B).
p1207_1(A,B):-p857(A,C),p1154(C,B).
p1209(A,B):-p26(A,C),p127(C,B).
p1211(A,B):-skip1(A,C),p1211_1(C,B).
p1211_1(A,B):-p17(A,C),p52(C,B).
p1213(A,B):-copy1(A,C),p62(C,B).
p1220(A,B):-skip1(A,C),p1220_1(C,B).
p1220_1(A,B):-p264(A,C),p256(C,B).
p1222(A,B):-skip1(A,C),p1222_1(C,B).
p1222_1(A,B):-p1346(A,C),mk_lowercase(C,B).
p1224(A,B):-p1224_1(A,B),not_empty(B).
p1224_1(A,B):-p5(A,C),mk_uppercase(C,B).
p1224_1(A,B):-p110(A,C),p1224_1(C,B).
p1226(A,B):-p1(A,C),p208(C,B).
p1227(A,B):-p123(A,C),p1227_1(C,B).
p1227_1(A,B):-p256(A,C),p705(C,B).
...
p1261(A,B):-p840(A,C),p57(C,B).
p1266(A,B):-p1390(A,C),p1266_1(C,B).
...
p1291_1(A,B):-p28(A,C),p1291_2(C,B).
p1291_2(A,B):-skip1(A,C),p440(C,B).
...
p1302_1(A,B):-p194(A,C),p963(C,B).
p1304(A,B):-skip1(A,C),p1304_1(C,B).
p1304_1(A,B):-p1476(A,C),p269(C,B).
p1305(A,B):-skip1(A,C),p1305_1(C,B).
p1305_1(A,B):-p857(A,C),p1305_2(C,B).
p1305_2(A,B):-mk_uppercase(A,C),p457(C,B).
...
p1313_1(A,B):-p1170(A,C),p369(C,B).
...
p1317(A,B):-p17(A,C),p1317_1(C,B).
p1317_1(A,B):-p20(A,C),p26(C,B).
p1322(A,B):-skip1(A,C),p1322_1(C,B).
p1322_1(A,B):-skip1(A,C),p705(C,B).
p1327(A,B):-p1346(A,C),p110(C,B).
...
p1373_1(A,B):-p1341(A,C),p1057(C,B).
p1374(A,B):-p174(A,C),p104(C,B).
p1376(A,B):-p849(A,C),p62(C,B).
p1378(A,B):-mk_uppercase(A,C),p1346(C,B).
p1379(A,B):-p436(A,C),p1379_1(C,B).
p1379_1(A,B):-mk_uppercase(A,C),p208(C,B).
p1382(A,B):-copy1(A,C),p1382_1(C,B).
p1382_1(A,B):-p857(A,C),p283(C,B).
p1383(A,B):-copy1(A,C),p208(C,B).
p1387(A,B):-copy1(A,C),p1387_1(C,B).
p1387_1(A,B):-p129(A,C),p1063(C,B).
p1391(A,B):-p510(A,C),p1391_1(C,B).
p1391_1(A,B):-p494(A,C),mk_uppercase(C,B).
p1392(A,B):-p325(A,C),p20(C,B).
p1394(A,B):-mk_lowercase(A,C),p1394_1(C,B).
p1394_1(A,B):-p83(A,C),p1394_2(C,B).
p1394_2(A,B):-p825(A,C),p116(C,B).
p1397(A,B):-p327(A,C),p1397_1(C,B).
p1397_1(A,B):-p110(A,C),p225(C,B).
...
p1469(A,B):-p857(A,C),p1469_1(C,B).
p1469_1(A,B):-p680(A,C),p372(C,B).
...
p1474_1(A,B):-p5(A,C),p129(C,B).
p1475(A,B):-p194(A,C),p1154(C,B).
p1477(A,B):-copy1(A,C),p1477_1(C,B).
p1477_1(A,B):-p57(A,C),p576(C,B).
p1479(A,B):-p208(A,C),p53(C,B).
...
p1494(A,B):-p1330(A,C),p1494_1(C,B).
p1494_1(A,B):-copy1(A,C),p208(C,B).
p1495(A,B):-p110(A,C),p1495_1(C,B).
p1495_1(A,B):-p773(A,C),p17(C,B).
...
p1550_1(A,B):-p17(A,C),p1550_2(C,B).
p1550_2(A,B):-skip1(A,C),p123(C,B).
...
p1559_1(A,B):-skip1(A,C),p440(C,B).
...
p727_1(A,B):-p28(A,C),p43(C,B).
p734(A,B):-copy1(A,C),p734_1(C,B).
p734_1(A,B):-p460(A,C),p734_2(C,B).
p734_2(A,B):-p1455(A,C),p83(C,B).
p877(A,B):-skip1(A,C),p877_1(C,B).
p877_1(A,B):-p1(A,C),p877_2(C,B).
p877_2(A,B):-p789(A,C),copy1(C,B).
p913(A,B):-p913_1(A,B),is_empty(B).
p913_1(A,B):-p277(A,C),mk_uppercase(C,B).
p913_1(A,B):-skip1(A,C),p913_1(C,B).
p914(A,B):-p83(A,C),p914_1(C,B).
p914_1(A,B):-p57(A,C),p914_2(C,B).
p914_2(A,B):-skip1(A,C),p929(C,B).
p1003(A,B):-p73(A,C),p273(C,B).
p1044(A,B):-skip1(A,C),p1044_1(C,B).
p1044_1(A,B):-p789(A,C),p256(C,B).
p1079(A,B):-copy1(A,C),p322(C,B).
p1093(A,B):-skip1(A,C),p1093_1(C,B).
p1093_1(A,B):-p17(A,C),p1103(C,B).
p1191(A,B):-mk_uppercase(A,C),p1191_1(C,B).
p1191_1(A,B):-p849(A,C),p132(C,B).
p1296(A,B):-p340(A,C),p73(C,B).
p1350(A,B):-p910(A,C),p256(C,B).
p1355(A,B):-skip1(A,C),p1355_1(C,B).
p1355_1(A,B):-skip1(A,C),p846(C,B).
p1461(A,B):-p1307(A,C),p1461_1(C,B).
p1461_1(A,B):-mk_uppercase(A,C),p334(C,B).
p1524(A,B):-skip1(A,C),p1524_1(C,B).
p1524_1(A,B):-p123(A,C),p1524_2(C,B).
p1524_2(A,B):-skip1(A,C),p747(C,B).
...
b36_1(A,B):-is_space(A),p110(A,B).
b36_1(A,B):-skip1(A,C),b36_1(C,B).
b48(A,B):-p5(A,C),p1179(C,B).
b48(A,B):-b48_1(A,B),is_empty(B).
b48_1(A,B):-p1264(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b113(A,B):-p1285(A,C),b113_1(C,B).
b113_1(A,B):-p552(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout

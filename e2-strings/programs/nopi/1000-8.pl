...
p26(A,B):-p21(A,C),p26_1(C,B).
p26_1(A,B):-p802(A,C),p29(C,B).
p28(A,B):-skip1(A,C),p28_1(C,B).
p28_1(A,B):-p535(A,C),p62(C,B).
p31(A,B):-p790(A,C),p31_1(C,B).
p31_1(A,B):-p972(A,C),p356(C,B).
p36(A,B):-copy1(A,C),p36_1(C,B).
p36_1(A,B):-p169(A,B),is_lowercase(B).
p36_1(A,B):-skip1(A,C),p36_1(C,B).
...
p52(A,B):-p382(A,C),p52_1(C,B).
p52_1(A,B):-p63(A,C),mk_lowercase(C,B).
...
p124_1(A,B):-mk_uppercase(A,C),p684(C,B).
...
p137_1(A,B):-skip1(A,C),p137_2(C,B).
p137_2(A,B):-skip1(A,C),p125(C,B).
p138(A,B):-p307(A,C),p32(C,B).
p145(A,B):-p63(A,C),p586(C,B).
p149(A,B):-p954(A,C),p134(C,B).
p150(A,B):-skip1(A,C),p150_1(C,B).
p150_1(A,B):-p134(A,C),p116(C,B).
...
p176_1(A,B):-p810(A,C),p757(C,B).
p177(A,B):-p434(A,C),p29(C,B).
...
p183_1(A,B):-p239(A,C),p307(C,B).
p184(A,B):-skip1(A,C),p184_1(C,B).
p184_1(A,B):-p32(A,C),p184_2(C,B).
p184_2(A,B):-mk_lowercase(A,C),p954(C,B).
...
p229_1(A,B):-p222(A,C),p229_2(C,B).
p229_2(A,B):-p49(A,C),p141(C,B).
p230(A,B):-p29(A,C),p230_1(C,B).
p230_1(A,B):-p277(A,C),p146(C,B).
p237(A,B):-p356(A,C),p237_1(C,B).
p237_1(A,B):-skip1(A,C),p307(C,B).
p238(A,B):-copy1(A,C),p238_1(C,B).
p238_1(A,B):-p810(A,C),p757(C,B).
p243(A,B):-p32(A,C),p307(C,B).
p245(A,B):-copy1(A,C),p245_1(C,B).
p245_1(A,B):-p666(A,C),p269(C,B).
p248(A,B):-p11(A,C),p248_1(C,B).
p248_1(A,B):-p90(A,C),mk_uppercase(C,B).
p251(A,B):-p681(A,C),p146(C,B).
p252(A,B):-p452(A,C),p252_1(C,B).
p252_1(A,B):-skip1(A,C),p32(C,B).
p254(A,B):-p141(A,C),p254_1(C,B).
p254_1(A,B):-p169(A,C),p557(C,B).
p267(A,B):-p790(A,C),p267_1(C,B).
p267_1(A,B):-mk_uppercase(A,C),p32(C,B).
...
p335_1(A,B):-p51(A,C),p164(C,B).
p339(A,B):-p29(A,C),p339_1(C,B).
p339_1(A,B):-p141(A,C),copy1(C,B).
...
p362(A,B):-p382(A,C),p81(C,B).
p364(A,B):-p364_1(A,C),copy1(C,B).
p364_1(A,B):-skip1(A,C),p141(C,B).
p364_1(A,B):-mk_lowercase(A,C),p364_1(C,B).
p365(A,B):-p125(A,C),p365_1(C,B).
p365_1(A,B):-p935(A,C),p62(C,B).
p369(A,B):-p239(A,C),p687(C,B).
p372(A,B):-p781(A,C),p9(C,B).
p376(A,B):-p156(A,C),p2(C,B).
p379(A,B):-p804(A,C),mk_uppercase(C,B).
p384(A,B):-p29(A,C),p384_1(C,B).
p384_1(A,B):-p277(A,C),p239(C,B).
...
p397(A,B):-p397_1(A,C),p397_1(C,B).
p397_1(A,B):-skip1(A,C),p397_1(C,B).
p397_1(A,B):-skip1(A,C),p125(C,B).
p399(A,B):-p452(A,C),p257(C,B).
p401(A,B):-copy1(A,C),p684(C,B).
p405(A,B):-p222(A,C),p405_1(C,B).
p405_1(A,B):-p239(A,C),p586(C,B).
...
p443(A,B):-p125(A,C),p443_1(C,B).
p443_1(A,B):-p239(A,C),p260(C,B).
p446(A,B):-mk_lowercase(A,C),p502(C,B).
p448(A,B):-is_space(A),p73(A,B).
p448(A,B):-skip1(A,C),p448(C,B).
p454(A,B):-mk_uppercase(A,C),p454_1(C,B).
p454_1(A,B):-p29(A,C),p277(C,B).
...
p478_2(A,B):-skip1(A,C),p525(C,B).
p481(A,B):-skip1(A,C),p481_1(C,B).
p481_1(A,B):-p834(A,C),mk_uppercase(C,B).
p483(A,B):-p29(A,C),p483_1(C,B).
p483_1(A,B):-skip1(A,C),p483_2(C,B).
p483_2(A,B):-skip1(A,C),p32(C,B).
p485(A,B):-p116(A,C),p485_1(C,B).
p485_1(A,B):-mk_uppercase(A,C),p356(C,B).
...
p541(A,B):-p116(A,C),p541_1(C,B).
p541_1(A,B):-mk_uppercase(A,C),p199(C,B).
p545(A,B):-p954(A,C),copy1(C,B).
p547(A,B):-skip1(A,C),p122(C,B).
p552(A,B):-p49(A,C),p696(C,B).
p552(A,B):-mk_lowercase(A,C),p552(C,B).
p556(A,B):-p687(A,C),mk_uppercase(C,B).
p559(A,B):-p807(A,C),p559_1(C,B).
p559_1(A,B):-skip1(A,C),p51(C,B).
p560(A,B):-p39(A,C),p807(C,B).
p561(A,B):-p257(A,C),p29(C,B).
p562(A,B):-p557(A,C),p562_1(C,B).
p562_1(A,B):-p536(A,C),p169(C,B).
p564(A,B):-copy1(A,C),p564_1(C,B).
p564_1(A,B):-p113(A,C),p213(C,B).
p565(A,B):-p68(A,C),p113(C,B).
p571(A,B):-p141(A,C),p81(C,B).
p572(A,B):-p222(A,C),p810(C,B).
...
p584_1(A,B):-skip1(A,C),p584_2(C,B).
p584_2(A,B):-p90(A,C),p164(C,B).
...
p604_1(A,B):-p3(A,C),p199(C,B).
p607(A,B):-skip1(A,C),p607_1(C,B).
p607_1(A,B):-skip1(A,C),p231(C,B).
p608(A,B):-p32(A,C),p608_1(C,B).
p608_1(A,B):-mk_lowercase(A,C),p307(C,B).
p609(A,B):-skip1(A,C),p609_1(C,B).
p609_1(A,B):-p535(A,C),mk_uppercase(C,B).
p610(A,B):-skip1(A,C),p610_1(C,B).
p610_1(A,B):-p277(A,C),p239(C,B).
...
p622_1(A,B):-skip1(A,C),p241(C,B).
p627(A,B):-p141(A,C),p627_1(C,B).
p627_1(A,B):-p269(A,C),p51(C,B).
p630(A,B):-p29(A,C),p630_1(C,B).
p630_1(A,B):-p513(A,C),p21(C,B).
p634(A,B):-p356(A,C),p634_1(C,B).
p634_1(A,B):-mk_lowercase(A,B),is_uppercase(B).
p634_1(A,B):-skip1(A,C),p634_1(C,B).
p635(A,B):-p21(A,C),p635_1(C,B).
p635_1(A,B):-p213(A,C),p63(C,B).
p638(A,B):-copy1(A,C),p638_1(C,B).
p638_1(A,B):-p239(A,C),p502(C,B).
p640(A,B):-p16(A,C),p525(C,B).
p646(A,B):-p11(A,C),p646_1(C,B).
p646_1(A,B):-mk_lowercase(A,C),p68(C,B).
p650(A,B):-p141(A,C),p650_1(C,B).
p650_1(A,B):-p3(A,C),p81(C,B).
p653(A,B):-copy1(A,C),p653_1(C,B).
p653_1(A,B):-p239(A,C),p525(C,B).
p654(A,B):-p62(A,C),p654_1(C,B).
p654_1(A,B):-skip1(A,C),p141(C,B).
p656(A,B):-p21(A,C),p656_1(C,B).
p656_1(A,B):-skip1(A,C),p122(C,B).
p659(A,B):-p269(A,C),p659_1(C,B).
p659_1(A,B):-p73(A,C),p146(C,B).
...
p766_1(A,B):-skip1(A,C),p502(C,B).
p767(A,B):-skip1(A,C),p767_1(C,B).
p767_1(A,B):-p164(A,C),p767_2(C,B).
p767_2(A,B):-skip1(A,C),p307(C,B).
p775(A,B):-p696(A,C),p222(C,B).
p776(A,B):-p317(A,C),p307(C,B).
p778(A,B):-p141(A,C),p804(C,B).
p780(A,B):-p21(A,C),p780_1(C,B).
p780_1(A,B):-p347(A,C),p780_2(C,B).
p780_2(A,B):-skip1(A,C),p21(C,B).
p782(A,B):-p134(A,C),p782_1(C,B).
p782_1(A,B):-mk_uppercase(A,C),p331(C,B).
p783(A,B):-copy1(A,C),p307(C,B).
p786(A,B):-mk_uppercase(A,C),p786_1(C,B).
p786_1(A,B):-p63(A,C),p125(C,B).
p787(A,B):-p63(A,C),p787_1(C,B).
p787_1(A,B):-skip1(A,C),p32(C,B).
p791(A,B):-p619(A,C),p81(C,B).
p792(A,B):-p29(A,C),p792_1(C,B).
p792_1(A,B):-p222(A,C),mk_uppercase(C,B).
p795(A,B):-p21(A,C),p795_1(C,B).
p795_1(A,B):-skip1(A,C),p795_2(C,B).
p795_2(A,B):-p20(A,C),p125(C,B).
p796(A,B):-copy1(A,C),p796_1(C,B).
p796_1(A,B):-p51(A,C),p796_2(C,B).
p796_2(A,B):-p16(A,C),p29(C,B).
p799(A,B):-p122(A,C),p807(C,B).
p803(A,B):-skip1(A,C),p803_1(C,B).
p803_1(A,B):-p51(A,C),p49(C,B).
p811(A,B):-p586(A,C),p811_1(C,B).
p811_1(A,B):-p49(A,C),mk_uppercase(C,B).
...
p839(A,B):-p793(A,C),p29(C,B).
p843(A,B):-p121(A,C),p11(C,B).
p844(A,B):-p3(A,C),p954(C,B).
p849(A,B):-skip1(A,C),p849_1(C,B).
p849_1(A,B):-p434(A,C),p21(C,B).
p850(A,B):-p68(A,C),p331(C,B).
p851(A,B):-p46(A,C),p851_1(C,B).
p851_1(A,B):-skip1(A,C),p32(C,B).
p853(A,B):-p122(A,C),p113(C,B).
p857(A,B):-p81(A,C),p857_1(C,B).
p857_1(A,B):-skip1(A,C),p802(C,B).
p858(A,B):-p356(A,C),p858_1(C,B).
p858_1(A,B):-p213(A,C),p63(C,B).
p860(A,B):-skip1(A,C),p860_1(C,B).
p860_1(A,B):-p73(A,C),p860_2(C,B).
p860_2(A,B):-skip1(A,C),p32(C,B).
...
p866_1(A,B):-p619(A,C),p866_2(C,B).
p866_2(A,B):-p32(A,C),p134(C,B).
...
p969_1(A,B):-p201(A,C),p969_2(C,B).
p969_2(A,B):-skip1(A,C),p356(C,B).
p973(A,B):-p98(A,B),is_uppercase(B).
p973(A,B):-skip1(A,C),p973(C,B).
p977(A,B):-p3(A,C),p331(C,B).
p979(A,B):-p222(A,C),p121(C,B).
...
p989(A,B):-p66(A,C),p213(C,B).
p992(A,B):-p807(A,C),p81(C,B).
p996(A,B):-p802(A,C),p233(C,B).
...
p175_1(A,B):-p790(A,C),p175_2(C,B).
p175_2(A,B):-p134(A,C),p356(C,B).
p227(A,B):-p134(A,C),p227_1(C,B).
p227_1(A,B):-p531(A,C),mk_lowercase(C,B).
...
p614_1(A,B):-p364(A,C),p29(C,B).
p648(A,B):-p164(A,C),p648_1(C,B).
p648_1(A,B):-p222(A,C),p154(C,B).
p655(A,B):-copy1(A,C),p655_1(C,B).
p655_1(A,B):-skip1(A,C),p899(C,B).
p664(A,B):-p29(A,C),p664_1(C,B).
p664_1(A,B):-is_number(A),p422(A,B).
p664_1(A,B):-skip1(A,C),p664_1(C,B).
p966(A,B):-p218(A,C),p966_1(C,B).
p966_1(A,B):-p125(A,C),p966_2(C,B).
p966_2(A,B):-skip1(A,C),p422(C,B).
p971(A,B):-copy1(A,C),p971_1(C,B).
p971_1(A,B):-p634(A,C),p971_2(C,B).
...
b307_1(A,B):-p21(A,C),skip1(C,B).
b238(A,B):-p146(A,C),b238_1(C,B).
...
%timeout
%timeout
b134(A,B):-p51(A,C),b134_1(C,B).
b134_1(A,B):-skip1(A,B),is_empty(B).
b134_1(A,B):-p531(A,C),b134_1(C,B).
%timeout
b188(A,B):-p241(A,C),p21(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p51(A,B),is_uppercase(B).
b81(A,B):-skip1(A,C),b81(C,B).
b37(A,B):-b37_1(A,B),not_letter(B).
b37_1(A,B):-is_lowercase(A),skip1(A,B).
b37_1(A,B):-p21(A,C),b37_1(C,B).
%timeout
%timeout
%timeout
%timeout
b78(A,B):-p954(A,B),is_uppercase(B).
b78(A,B):-p21(A,C),b78(C,B).
%timeout
%timeout
%timeout
%timeout
...
b63(A,B):-p531(A,C),b63_1(C,B).
b63_1(A,B):-skip1(A,C),p241(C,B).
%timeout
...
%timeout
%timeout
b309(A,B):-p241(A,C),b309_1(C,B).
b309_1(A,B):-skip1(A,C),p241(C,B).
%timeout
%timeout
%timeout
%timeout

...
% asserting p396/2
% depth 3
p2(A,B):-p189(A,C),p2_1(C,B).
p2_1(A,B):-p145(A,C),p68(C,B).
...
p14_1(A,B):-p212(A,C),p5(C,B).
p17(A,B):-skip1(A,C),p17_1(C,B).
p17_1(A,B):-p194(A,C),p168(C,B).
p19(A,B):-p195(A,C),p19_1(C,B).
p19_1(A,B):-p57(A,C),p1(C,B).
p20(A,B):-p311(A,C),p20_1(C,B).
p20_1(A,B):-mk_uppercase(A,C),p5(C,B).
p21(A,B):-copy1(A,C),p21_1(C,B).
p21_1(A,B):-p9(A,C),p145(C,B).
p24(A,B):-skip1(A,C),p24_1(C,B).
p24_1(A,B):-p5(A,C),p179(C,B).
p41(A,B):-copy1(A,C),p41_1(C,B).
p41_1(A,B):-skip1(A,C),p146(C,B).
p42(A,B):-skip1(A,C),p42_1(C,B).
p42_1(A,B):-p25(A,C),p262(C,B).
...
p88_1(A,B):-p296(A,C),p240(C,B).
p91(A,B):-p5(A,C),p91_1(C,B).
p91_1(A,B):-p154(A,C),p195(C,B).
p92(A,B):-p311(A,C),p92_1(C,B).
...
p99_2(A,B):-p263(A,C),p1(C,B).
p102(A,B):-p176(A,C),p1(C,B).
...
p129_1(A,B):-p55(A,C),copy1(C,B).
p131(A,B):-copy1(A,C),p131_1(C,B).
p131_1(A,B):-p1(A,C),p31(C,B).
...
p134(A,B):-skip1(A,C),p296(C,B).
p134(A,B):-p130(A,C),p134(C,B).
p134(A,B):-mk_uppercase(A,C),p134(C,B).
p135(A,B):-p4(A,C),p123(C,B).
p140(A,B):-p150(A,C),p31(C,B).
p141(A,B):-p154(A,C),p141_1(C,B).
p141_1(A,B):-skip1(A,C),p5(C,B).
...
p155_2(A,B):-p3(A,C),p33(C,B).
p156(A,B):-p240(A,C),p259(C,B).
p158(A,B):-mk_lowercase(A,C),p158_1(C,B).
p158_1(A,B):-p9(A,C),p33(C,B).
p160(A,B):-p5(A,C),p213(C,B).
p161(A,B):-skip1(A,C),p161_1(C,B).
p161_1(A,B):-p145(A,C),p161_2(C,B).
p161_2(A,B):-p127(A,C),copy1(C,B).
p162(A,B):-p145(A,C),p162_1(C,B).
p162_1(A,B):-p242(A,C),p25(C,B).
...
p210_1(A,B):-p145(A,C),p82(C,B).
p214(A,B):-p258(A,C),p214_1(C,B).
p214_1(A,B):-copy1(A,C),p214_2(C,B).
p214_2(A,B):-skip1(A,C),p6(C,B).
p215(A,B):-mk_uppercase(A,C),p215_1(C,B).
p215_1(A,B):-skip1(A,C),p215_2(C,B).
p215_2(A,B):-p5(A,C),p98(C,B).
p220(A,B):-p3(A,C),p220_1(C,B).
p220_1(A,B):-skip1(A,C),p300(C,B).
p223(A,B):-mk_uppercase(A,C),p223_1(C,B).
p223_1(A,B):-p3(A,C),p281(C,B).
p228(A,B):-p154(A,C),p228_1(C,B).
p228_1(A,B):-skip1(A,C),p296(C,B).
p229(A,B):-p325(A,C),mk_lowercase(C,B).
p230(A,B):-p25(A,C),p230_1(C,B).
p230_1(A,B):-p296(A,C),p145(C,B).
...
p252_1(A,B):-p154(A,C),p252_2(C,B).
p252_2(A,B):-skip1(A,C),p145(C,B).
p254(A,B):-mk_lowercase(A,C),p254_1(C,B).
p254_1(A,B):-skip1(A,C),p254_2(C,B).
p254_2(A,B):-p47(A,C),copy1(C,B).
p256(A,B):-p179(A,C),p296(C,B).
...
p306_1(A,B):-skip1(A,C),p306_2(C,B).
p306_2(A,B):-skip1(A,C),p274(C,B).
p307(A,B):-p33(A,C),p307_1(C,B).
p307_1(A,B):-p40(A,C),p1(C,B).
p312(A,B):-skip1(A,C),p312_1(C,B).
p312_1(A,B):-p68(A,C),p312_2(C,B).
p312_2(A,B):-p296(A,C),p40(C,B).
p316(A,B):-p1(A,C),p316_1(C,B).
p316_1(A,B):-p385(A,C),p1(C,B).
p317(A,B):-p25(A,C),p317_1(C,B).
p317_1(A,B):-p258(A,C),mk_uppercase(C,B).
p321(A,B):-p68(A,C),p300(C,B).
p326(A,B):-p150(A,C),p68(C,B).
p328(A,B):-p31(A,C),p1(C,B).
p335(A,B):-skip1(A,C),p335_1(C,B).
p335_1(A,B):-p33(A,C),p176(C,B).
...
p363(A,B):-p150(A,C),p363_1(C,B).
p363_1(A,B):-copy1(A,C),p68(C,B).
p364(A,B):-p48(A,C),p364_1(C,B).
p364_1(A,B):-copy1(A,C),p154(C,B).
p366(A,B):-skip1(A,C),p366_1(C,B).
p366_1(A,B):-p353(A,C),p366_2(C,B).
p366_2(A,B):-p130(A,C),p33(C,B).
p374(A,B):-skip1(A,C),p374_1(C,B).
p374_1(A,B):-p385(A,C),p31(C,B).
p377(A,B):-p296(A,C),p240(C,B).
p378(A,B):-p5(A,C),p378_1(C,B).
p378_1(A,B):-p4(A,C),p378_2(C,B).
p378_2(A,B):-skip1(A,C),p5(C,B).
p387(A,B):-p110(A,C),p82(C,B).
...
p399_1(A,B):-p31(A,C),p399_2(C,B).
p399_2(A,B):-p353(A,C),p189(C,B).
% asserting p2/2
% asserting p8/2
% asserting p11/2
% asserting p14/2
...
b113_1(A,B):-p47(A,C),b113_2(C,B).
b113_2(A,B):-skip1(A,C),p281(C,B).
%timeout
%timeout
%timeout
%timeout
...
b81(A,B):-p154(A,B),is_uppercase(B).
...
b132_1(A,B):-b132_2(A,C),p33(C,B).
b132_2(A,B):-p47(A,C),p274(C,B).
b132_2(A,B):-p209(A,C),p154(C,B).
%timeout
%timeout
%timeout
%timeout
...
b224(A,B):-p154(A,C),b224_1(C,B).
b224_1(A,B):-skip1(A,C),p281(C,B).
%timeout
%timeout
%timeout
%timeout

...
p1_1(A,B):-p123(A,C),p1_2(C,B).
p1_2(A,B):-skip1(A,C),p152(C,B).
p2(A,B):-copy1(A,C),p2_1(C,B).
p2_1(A,B):-p23(A,C),p23(C,B).
p8(A,B):-p229(A,C),p8_1(C,B).
p8_1(A,B):-mk_lowercase(A,C),p23(C,B).
p10(A,B):-p121(A,C),p98(C,B).
p11(A,B):-p11_1(A,B),is_space(B).
p11_1(A,B):-mk_lowercase(A,C),skip1(C,B).
p11_1(A,B):-skip1(A,C),p11_1(C,B).
p12(A,B):-p184(A,C),p302(C,B).
...
p27(A,B):-p23(A,C),p27_1(C,B).
p27_1(A,B):-skip1(A,C),p277(C,B).
p33(A,B):-copy1(A,C),p33_1(C,B).
p33_1(A,B):-p61(A,C),p186(C,B).
p33_1(A,B):-skip1(A,C),p33_1(C,B).
p34(A,B):-p28(A,C),p34_1(C,B).
p34_1(A,B):-p87(A,C),p121(C,B).
p35(A,B):-p123(A,C),p35_1(C,B).
p35_1(A,B):-p43(A,C),mk_uppercase(C,B).
p37(A,B):-p37_1(A,B),is_uppercase(B).
p37_1(A,B):-p229(A,C),copy1(C,B).
p37_1(A,B):-p28(A,C),p37_1(C,B).
p38(A,B):-copy1(A,C),p38_1(C,B).
p38_1(A,B):-p57(A,C),p38_2(C,B).
p38_2(A,B):-p23(A,C),p333(C,B).
...
p84_2(A,B):-skip1(A,C),p121(C,B).
p89(A,B):-p89_1(A,B),is_uppercase(B).
p89_1(A,B):-p123(A,C),p302(C,B).
p89_1(A,B):-skip1(A,C),p89_1(C,B).
...
p94(A,B):-p302(A,C),p94_1(C,B).
p94_1(A,B):-p23(A,C),p111(C,B).
...
p119_1(A,B):-p56(A,C),p119_2(C,B).
p119_2(A,B):-skip1(A,C),p302(C,B).
p120(A,B):-p120_1(A,C),p22(C,B).
p120_1(A,B):-p71(A,C),p57(C,B).
p120_1(A,B):-skip1(A,C),p120_1(C,B).
p126(A,B):-p14(A,C),p126_1(C,B).
p126_1(A,B):-p123(A,C),p126_2(C,B).
p126_2(A,B):-skip1(A,C),p157(C,B).
p127(A,B):-p276(A,C),p333(C,B).
p129(A,B):-copy1(A,C),p129_1(C,B).
p129_1(A,B):-p23(A,C),p129_2(C,B).
p129_2(A,B):-p23(A,C),p302(C,B).
p130(A,B):-p23(A,C),p130_1(C,B).
p130_1(A,B):-p92(A,C),p186(C,B).
...
p142_1(A,B):-mk_uppercase(A,C),p152(C,B).
p144(A,B):-copy1(A,C),p144_1(C,B).
p144_1(A,B):-skip1(A,C),p277(C,B).
p145(A,B):-p157(A,C),p145_1(C,B).
p145_1(A,B):-skip1(A,C),p145_2(C,B).
p145_2(A,B):-p28(A,C),p307(C,B).
p146(A,B):-copy1(A,C),p146_1(C,B).
p146_1(A,B):-skip1(A,C),p225(C,B).
...
p160_1(A,B):-p327(A,C),p22(C,B).
p163(A,B):-p25(A,C),p53(C,B).
p163(A,B):-skip1(A,C),p163(C,B).
p171(A,B):-p333(A,C),p171_1(C,B).
p171_1(A,B):-p258(A,C),p171_2(C,B).
p171_2(A,B):-mk_uppercase(A,C),mk_uppercase(C,B).
p172(A,B):-mk_uppercase(A,C),p172_1(C,B).
p172_1(A,B):-mk_lowercase(A,C),p158(C,B).
p172_1(A,B):-skip1(A,C),p172_1(C,B).
p174(A,B):-copy1(A,C),p174_1(C,B).
p174_1(A,B):-p14(A,C),p43(C,B).
p176(A,B):-p57(A,C),p229(C,B).
p179(A,B):-p98(A,C),p179_1(C,B).
p179_1(A,B):-mk_uppercase(A,C),p123(C,B).
p180(A,B):-copy1(A,C),p180_1(C,B).
p180_1(A,B):-p184(A,C),p31(C,B).
p182(A,B):-p92(A,C),p182_1(C,B).
p182_1(A,B):-skip1(A,C),p345(C,B).
p183(A,B):-p123(A,C),p183_1(C,B).
p183_1(A,B):-p302(A,C),p43(C,B).
p185(A,B):-mk_uppercase(A,C),p185_1(C,B).
p185_1(A,B):-skip1(A,C),p185_2(C,B).
p185_2(A,B):-skip1(A,C),p123(C,B).
p188(A,B):-p123(A,C),p188_1(C,B).
p188_1(A,B):-p61(A,C),mk_lowercase(C,B).
p192(A,B):-p152(A,C),p327(C,B).
p197(A,B):-p258(A,C),p197_1(C,B).
p197_1(A,B):-mk_lowercase(A,C),p123(C,B).
p200(A,B):-mk_lowercase(A,C),p200_1(C,B).
p200_1(A,B):-p28(A,C),p23(C,B).
p204(A,B):-copy1(A,C),p204_1(C,B).
p204_1(A,B):-p4(A,C),p123(C,B).
p205(A,B):-p23(A,C),p87(C,B).
p208(A,B):-p184(A,C),p208_1(C,B).
p208_1(A,B):-skip1(A,C),p368(C,B).
p209(A,B):-copy1(A,C),p209_1(C,B).
p209_1(A,B):-p23(A,C),p209_2(C,B).
p209_2(A,B):-skip1(A,C),p186(C,B).
p210(A,B):-skip1(A,C),p210_1(C,B).
p210_1(A,B):-p152(A,C),p75(C,B).
p218(A,B):-p23(A,C),p92(C,B).
p223(A,B):-copy1(A,C),p223_1(C,B).
p223_1(A,B):-p4(A,C),p123(C,B).
p231(A,B):-copy1(A,C),p231_1(C,B).
p231_1(A,B):-skip1(A,C),p231_2(C,B).
p231_2(A,B):-p229(A,C),p28(C,B).
p234(A,B):-p28(A,C),p234_1(C,B).
p234_1(A,B):-skip1(A,C),p229(C,B).
p236(A,B):-p366(A,C),p105(C,B).
p239(A,B):-skip1(A,C),p239_1(C,B).
p239_1(A,B):-p368(A,C),p239_2(C,B).
p239_2(A,B):-mk_uppercase(A,C),mk_uppercase(C,B).
p243(A,B):-skip1(A,C),p46(C,B).
p247(A,B):-p9(A,C),p123(C,B).
p249(A,B):-p43(A,C),p249_1(C,B).
p249_1(A,B):-skip1(A,C),p393(C,B).
p250(A,B):-p157(A,C),p250_1(C,B).
p250_1(A,B):-p302(A,C),p152(C,B).
p252(A,B):-copy1(A,C),p252_1(C,B).
p252_1(A,B):-p125(A,C),p345(C,B).
p259(A,B):-p41(A,C),mk_lowercase(C,B).
p260(A,B):-p258(A,C),p260_1(C,B).
p260_1(A,B):-skip1(A,C),p302(C,B).
p262(A,B):-skip1(A,C),p262_1(C,B).
p262_1(A,B):-p366(A,C),p96(C,B).
p264(A,B):-p123(A,C),p264_1(C,B).
p264_1(A,B):-skip1(A,C),p92(C,B).
p267(A,B):-mk_lowercase(A,C),p267_1(C,B).
p267_1(A,B):-p71(A,C),p23(C,B).
p268(A,B):-p123(A,C),p268_1(C,B).
p268_1(A,B):-skip1(A,C),p92(C,B).
p280(A,B):-p28(A,C),p280_1(C,B).
p280_1(A,B):-p25(A,C),p23(C,B).
p281(A,B):-p43(A,C),p281_1(C,B).
p281_1(A,B):-p87(A,C),mk_uppercase(C,B).
p286(A,B):-p96(A,C),p286_1(C,B).
p286_1(A,B):-skip1(A,C),p186(C,B).
p289(A,B):-p123(A,C),p9(C,B).
p295(A,B):-skip1(A,C),p295_1(C,B).
p295_1(A,B):-p31(A,C),p295_2(C,B).
p295_2(A,B):-mk_uppercase(A,C),p123(C,B).
p303(A,B):-p123(A,C),p303_1(C,B).
p303_1(A,B):-skip1(A,C),p277(C,B).
...
p309_2(A,B):-skip1(A,C),p366(C,B).
p312(A,B):-p92(A,C),p23(C,B).
p313(A,B):-skip1(A,C),p313_1(C,B).
p313_1(A,B):-p186(A,C),p23(C,B).
p317(A,B):-mk_lowercase(A,C),p317_1(C,B).
p317_1(A,B):-skip1(A,C),p298(C,B).
p318(A,B):-p96(A,C),p9(C,B).
p319(A,B):-p333(A,C),p368(C,B).
p323(A,B):-p28(A,C),p323_1(C,B).
p323_1(A,B):-p111(A,C),p28(C,B).
p324(A,B):-skip1(A,C),p324_1(C,B).
p324_1(A,B):-skip1(A,C),p158(C,B).
p328(A,B):-p302(A,C),p328_1(C,B).
p328_1(A,B):-p298(A,C),p43(C,B).
p331(A,B):-p92(A,C),mk_uppercase(C,B).
p332(A,B):-p152(A,C),p57(C,B).
p334(A,B):-p75(A,C),p186(C,B).
p339(A,B):-p19(A,C),p339_1(C,B).
p339_1(A,B):-p92(A,C),p339_2(C,B).
p339_2(A,B):-skip1(A,C),p28(C,B).
p340(A,B):-p28(A,C),p340_1(C,B).
p340_1(A,B):-p128(A,C),p276(C,B).
p341(A,B):-copy1(A,C),p341_1(C,B).
p341_1(A,B):-p283(A,C),mk_lowercase(C,B).
p344(A,B):-p184(A,C),p344_1(C,B).
p344_1(A,B):-p271(A,C),copy1(C,B).
p346(A,B):-p211(A,C),p346_1(C,B).
p346_1(A,B):-skip1(A,C),p346_2(C,B).
p346_2(A,B):-skip1(A,C),p302(C,B).
p350(A,B):-copy1(A,C),p350_1(C,B).
p350_1(A,B):-p92(A,C),mk_uppercase(C,B).
p357(A,B):-p327(A,C),p271(C,B).
p358(A,B):-p186(A,C),p307(C,B).
p359(A,B):-p152(A,C),p359_1(C,B).
p359_1(A,B):-skip1(A,C),p359_2(C,B).
p359_2(A,B):-skip1(A,C),p123(C,B).
p362(A,B):-mk_lowercase(A,C),p362_1(C,B).
p362_1(A,B):-p368(A,C),mk_uppercase(C,B).
p364(A,B):-p46(A,C),p364_1(C,B).
p364_1(A,B):-mk_uppercase(A,C),p123(C,B).
p365(A,B):-p277(A,C),p123(C,B).
p369(A,B):-p158(A,C),p123(C,B).
p373(A,B):-p23(A,C),p373_1(C,B).
p373_1(A,B):-p92(A,C),copy1(C,B).
p378(A,B):-p186(A,C),p378_1(C,B).
p378_1(A,B):-skip1(A,C),p378_2(C,B).
p378_2(A,B):-p345(A,C),p276(C,B).
...
p29_1(A,B):-p96(A,C),p29_2(C,B).
p29_2(A,B):-mk_uppercase(A,C),p29_3(C,B).
p29_3(A,B):-mk_uppercase(A,C),mk_uppercase(C,B).
p36(A,B):-p186(A,C),p36_1(C,B).
p36_1(A,B):-skip1(A,C),p72(C,B).
p66(A,B):-copy1(A,C),p66_1(C,B).
p66_1(A,B):-p327(A,C),p66_2(C,B).
p66_2(A,B):-p302(A,C),p43(C,B).
p80(A,B):-skip1(A,C),p80_1(C,B).
p80_1(A,B):-skip1(A,C),p182(C,B).
p170(A,B):-skip1(A,C),p170_1(C,B).
p170_1(A,B):-p186(A,C),p170_2(C,B).
p170_2(A,B):-skip1(A,C),p28(C,B).
p217(A,B):-mk_uppercase(A,C),p217_1(C,B).
p217_1(A,B):-p61(A,C),p217_2(C,B).
p217_2(A,B):-mk_lowercase(A,C),p302(C,B).
p292(A,B):-p369(A,C),p292_1(C,B).
p292_1(A,B):-skip1(A,C),p302(C,B).
...
b24_1(A,B):-p152(A,C),b24_2(C,B).
b24_2(A,B):-p125(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b249(A,B):-p125(A,C),b249_1(C,B).
b249_1(A,B):-skip1(A,C),p43(C,B).
b249_1(A,B):-is_number(A),p125(A,B).
%timeout
%timeout
%timeout
%timeout
...
b113_1(A,B):-p96(A,C),mk_uppercase(C,B).
b113_1(A,B):-skip1(A,C),b113_1(C,B).
...
b108_2(A,B):-skip1(A,C),p28(C,B).
b246(A,B):-copy1(A,C),b246_1(C,B).
b246_1(A,B):-skip1(A,B),is_empty(B).
b246_1(A,B):-b246_2(A,C),b246_1(C,B).
b246_2(A,B):-skip1(A,C),p28(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p152(A,B),is_uppercase(B).
...
b92_1(A,B):-skip1(A,C),p152(C,B).
%timeout
b4(A,B):-p327(A,C),b4_1(C,B).

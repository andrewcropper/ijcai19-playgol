...
p33_1(A,B):-p71(A,C),p33_2(C,B).
p33_2(A,B):-copy1(A,C),p75(C,B).
...
p51_1(A,B):-p3(A,C),mk_lowercase(C,B).
...
p57(A,B):-p57_1(A,B),is_number(B).
p57_1(A,B):-skip1(A,C),p71(C,B).
p57_1(A,B):-p115(A,C),p57_1(C,B).
...
p129_1(A,B):-p161(A,C),p129_2(C,B).
p129_2(A,B):-skip1(A,C),p152(C,B).
...
p200_1(A,B):-p37(A,C),p200_2(C,B).
p200_2(A,B):-skip1(A,C),p81(C,B).
% asserting p5/2
% asserting p8/2
% asserting p12/2
% asserting p16/2
...
% asserting p200/2
% depth 4
b188(A,B):-p9(A,C),b188_1(C,B).
b188_1(A,B):-skip1(A,C),p9(C,B).
...
b293_2(A,B):-is_lowercase(A),p2(A,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b249(A,B):-p2(A,C),b249_1(C,B).
b249_1(A,B):-b249_2(A,C),b249_2(C,B).
b249_2(A,B):-skip1(A,C),p9(C,B).
...
b80_1(A,B):-skip1(A,C),p9(C,B).
b94(A,B):-copy1(A,C),b94_1(C,B).
b94_1(A,B):-skip1(A,B),is_empty(B).
b94_1(A,B):-b94_2(A,C),b94_1(C,B).
b94_2(A,B):-skip1(A,C),p2(C,B).
%timeout
%timeout
%timeout
%timeout

...
p15(A,B):-p53(A,C),p15_1(C,B).
p15_1(A,B):-p17(A,C),p49(C,B).
p21(A,B):-copy1(A,C),p21_1(C,B).
p21_1(A,B):-skip1(A,C),p1274(C,B).
p22(A,B):-p251(A,C),p22_1(C,B).
p22_1(A,B):-p75(A,C),p801(C,B).
p24(A,B):-p181(A,C),p24_1(C,B).
p24_1(A,B):-copy1(A,C),p601(C,B).
p27(A,B):-p467(A,C),p53(C,B).
p31(A,B):-p108(A,C),p31_1(C,B).
p31_1(A,B):-p613(A,C),p75(C,B).
p32(A,B):-p193(A,C),p120(C,B).
p35(A,B):-p621(A,C),p117(C,B).
p36(A,B):-p613(A,C),p108(C,B).
p37(A,B):-copy1(A,C),p37_1(C,B).
p37_1(A,B):-p79(A,C),p37_2(C,B).
p37_2(A,B):-skip1(A,C),p34(C,B).
p40(A,B):-skip1(A,C),p481(C,B).
p42(A,B):-skip1(A,C),p42_1(C,B).
p42_1(A,B):-p188(A,C),p158(C,B).
...
p212_1(A,B):-p14(A,C),p14(C,B).
p213(A,B):-skip1(A,C),p213_1(C,B).
p213_1(A,B):-p1136(A,C),p278(C,B).
p214(A,B):-skip1(A,C),p214_1(C,B).
p214_1(A,B):-p14(A,C),p214_2(C,B).
p214_2(A,B):-skip1(A,C),p879(C,B).
p215(A,B):-p10(A,C),p215_1(C,B).
p215_1(A,B):-skip1(A,C),p120(C,B).
p217(A,B):-p193(A,C),p532(C,B).
...
p243_1(A,B):-p49(A,C),p243_2(C,B).
p243_2(A,B):-skip1(A,C),p901(C,B).
...
p373_1(A,B):-p75(A,C),p391(C,B).
p375(A,B):-p391(A,C),p9(C,B).
p377(A,B):-copy1(A,C),p901(C,B).
p378(A,B):-p158(A,C),p378_1(C,B).
p378_1(A,B):-p123(A,C),mk_lowercase(C,B).
...
p417(A,B):-p193(A,C),p193(C,B).
p418(A,B):-p122(A,C),p91(C,B).
p420(A,B):-copy1(A,C),p420_1(C,B).
p420_1(A,B):-p47(A,C),p79(C,B).
p423(A,B):-p278(A,C),p619(C,B).
...
p477_1(A,B):-skip1(A,C),p1272(C,B).
...
p489(A,B):-p4(A,C),p489_1(C,B).
p489_1(A,B):-p256(A,C),p425(C,B).
p490(A,B):-skip1(A,C),p490_1(C,B).
p490_1(A,B):-p122(A,C),p879(C,B).
...
p586_1(A,B):-p278(A,C),p91(C,B).
p587(A,B):-mk_lowercase(A,C),p587_1(C,B).
p587_1(A,B):-p90(A,C),p75(C,B).
...
p607(A,B):-p30(A,C),p10(C,B).
p608(A,B):-p28(A,C),p608_1(C,B).
p608_1(A,B):-p1095(A,C),mk_uppercase(C,B).
p609(A,B):-copy1(A,C),p609_1(C,B).
p609_1(A,B):-skip1(A,C),p609_2(C,B).
p609_2(A,B):-skip1(A,C),p55(C,B).
p615(A,B):-p744(A,C),p405(C,B).
p618(A,B):-p188(A,C),p1089(C,B).
p620(A,B):-skip1(A,C),p620_1(C,B).
p620_1(A,B):-p49(A,C),p123(C,B).
...
p632(A,B):-p17(A,C),p632_1(C,B).
p632_1(A,B):-skip1(A,C),p677(C,B).
p633(A,B):-copy1(A,C),p633_1(C,B).
p633_1(A,B):-p430(A,C),p9(C,B).
p634(A,B):-skip1(A,C),p634_1(C,B).
p634_1(A,B):-p295(A,C),p391(C,B).
p635(A,B):-p188(A,C),p635_1(C,B).
p635_1(A,B):-p17(A,C),p75(C,B).
...
p649_1(A,B):-p164(A,C),p649_2(C,B).
p649_2(A,B):-p9(A,C),p142(C,B).
p653(A,B):-p10(A,C),p175(C,B).
p660(A,B):-p419(A,C),p134(C,B).
p663(A,B):-p358(A,C),p663_1(C,B).
p663_1(A,B):-p86(A,C),copy1(C,B).
...
p696_1(A,B):-p30(A,C),p120(C,B).
p698(A,B):-mk_lowercase(A,C),p698_1(C,B).
p698_1(A,B):-p1026(A,C),p698_2(C,B).
p698_2(A,B):-skip1(A,C),p142(C,B).
...
p716_1(A,B):-p188(A,C),p91(C,B).
p717(A,B):-p92(A,C),p717_1(C,B).
p717_1(A,B):-p1293(A,C),p601(C,B).
p718(A,B):-p3(A,C),p718_1(C,B).
p718_1(A,B):-p86(A,C),copy1(C,B).
...
p731(A,B):-p193(A,C),p731_1(C,B).
p731_1(A,B):-p256(A,C),p49(C,B).
p732(A,B):-p4(A,C),p639(C,B).
p734(A,B):-p9(A,C),p734_1(C,B).
p734_1(A,B):-p683(A,C),p28(C,B).
p739(A,B):-p49(A,C),p739_1(C,B).
p739_1(A,B):-p250(A,C),p49(C,B).
p740(A,B):-skip1(A,C),p740_1(C,B).
p740_1(A,B):-skip1(A,C),p250(C,B).
p743(A,B):-p351(A,C),p743_1(C,B).
p743_1(A,B):-p14(A,C),p1333(C,B).
p746(A,B):-copy1(A,C),p746_1(C,B).
p746_1(A,B):-skip1(A,C),p1394(C,B).
p748(A,B):-p1333(A,C),p49(C,B).
...
p752(A,B):-p4(A,C),p752_1(C,B).
p752_1(A,B):-p467(A,C),p14(C,B).
p760(A,B):-p53(A,C),p295(C,B).
p762(A,B):-copy1(A,C),p762_1(C,B).
p762_1(A,B):-p524(A,C),p762_2(C,B).
p762_2(A,B):-skip1(A,C),p122(C,B).
p763(A,B):-p879(A,C),p108(C,B).
p766(A,B):-mk_lowercase(A,C),p766_1(C,B).
p766_1(A,B):-p9(A,C),p39(C,B).
p767(A,B):-p122(A,C),p193(C,B).
p769(A,B):-p86(A,C),p91(C,B).
p772(A,B):-p675(A,C),p79(C,B).
p778(A,B):-skip1(A,C),p778_1(C,B).
p778_1(A,B):-p931(A,C),p79(C,B).
p781(A,B):-p800(A,C),p75(C,B).
p785(A,B):-skip1(A,C),p785_1(C,B).
p785_1(A,B):-p142(A,C),p744(C,B).
p786(A,B):-skip1(A,C),p786_1(C,B).
p786_1(A,B):-p122(A,C),p141(C,B).
p787(A,B):-p278(A,C),p787_1(C,B).
p787_1(A,B):-p9(A,C),p193(C,B).
...
p802_1(A,B):-skip1(A,C),p744(C,B).
p804(A,B):-copy1(A,C),p804_1(C,B).
p804_1(A,B):-skip1(A,C),p955(C,B).
p805(A,B):-p14(A,C),p805_1(C,B).
p805_1(A,B):-p256(A,C),p49(C,B).
p806(A,B):-p75(A,C),p806_1(C,B).
p806_1(A,B):-p78(A,C),p49(C,B).
p812(A,B):-p606(A,C),p57(C,B).
p817(A,B):-p9(A,C),p158(C,B).
p818(A,B):-p53(A,C),p425(C,B).
p820(A,B):-skip1(A,C),p820_1(C,B).
p820_1(A,B):-p188(A,C),p820_2(C,B).
p820_2(A,B):-p96(A,C),p96(C,B).
p822(A,B):-p107(A,C),p3(C,B).
p824(A,B):-copy1(A,C),p824_1(C,B).
p824_1(A,B):-p789(A,C),p57(C,B).
...
p889_1(A,B):-p744(A,C),p889_2(C,B).
p889_2(A,B):-p53(A,C),mk_uppercase(C,B).
p890(A,B):-p193(A,C),p425(C,B).
p894(A,B):-p955(A,C),p159(C,B).
p895(A,B):-p75(A,C),p425(C,B).
p897(A,B):-p17(A,C),p79(C,B).
p903(A,B):-p188(A,C),p903_1(C,B).
p903_1(A,B):-p17(A,C),mk_uppercase(C,B).
p904(A,B):-p122(A,C),p904_1(C,B).
p904_1(A,B):-p1211(A,C),p75(C,B).
...
p970(A,B):-p117(A,C),p887(C,B).
p971(A,B):-p271(A,C),p53(C,B).
p972(A,B):-skip1(A,C),p972_1(C,B).
p972_1(A,B):-p524(A,C),p825(C,B).
p975(A,B):-mk_lowercase(A,C),p975_1(C,B).
p975_1(A,B):-p295(A,C),p975_2(C,B).
p975_2(A,B):-skip1(A,C),p327(C,B).
p976(A,B):-p197(A,C),p75(C,B).
...
p1010(A,B):-p1010_1(A,B),is_lowercase(B).
p1010_1(A,B):-p712(A,C),p30(C,B).
...
p1020(A,B):-p425(A,C),p1020_1(C,B).
p1020_1(A,B):-skip1(A,C),p9(C,B).
...
p1032(A,B):-p4(A,C),p1032_1(C,B).
p1032_1(A,B):-p256(A,C),p34(C,B).
...
p1053(A,B):-p49(A,C),p1053_1(C,B).
p1053_1(A,B):-p164(A,C),copy1(C,B).
p1054(A,B):-mk_lowercase(A,C),p1054_1(C,B).
p1054_1(A,B):-p53(A,C),p1400(C,B).
p1058(A,B):-skip1(A,C),p1058_1(C,B).
p1058_1(A,B):-p141(A,C),p1272(C,B).
p1060(A,B):-p49(A,C),p1125(C,B).
p1061(A,B):-p1069(A,C),p1006(C,B).
p1062(A,B):-p675(A,C),p79(C,B).
p1063(A,B):-p122(A,C),p1063_1(C,B).
p1063_1(A,B):-p621(A,C),p142(C,B).
...
p1118(A,B):-p188(A,C),p1118_1(C,B).
p1118_1(A,B):-p53(A,C),p755(C,B).
p1119(A,B):-p188(A,C),p1119_1(C,B).
p1119_1(A,B):-p910(A,C),p49(C,B).
p1120(A,B):-p1095(A,C),p1120_1(C,B).
p1120_1(A,B):-mk_uppercase(A,C),p197(C,B).
p1121(A,B):-mk_uppercase(A,C),p1121_1(C,B).
p1121_1(A,B):-p1293(A,C),p142(C,B).
p1122(A,B):-p4(A,C),p588(C,B).
p1128(A,B):-p49(A,C),p193(C,B).
p1129(A,B):-mk_lowercase(A,C),p141(C,B).
p1129(A,B):-skip1(A,C),p1129(C,B).
p1132(A,B):-p158(A,C),p1132_1(C,B).
p1132_1(A,B):-skip1(A,C),p141(C,B).
p1134(A,B):-p57(A,C),p1134_1(C,B).
p1134_1(A,B):-p619(A,C),p10(C,B).
p1135(A,B):-mk_uppercase(A,C),p1135_1(C,B).
p1135_1(A,B):-skip1(A,C),p257(C,B).
p1137(A,B):-p295(A,C),p1137_1(C,B).
p1137_1(A,B):-p53(A,C),p350(C,B).
p1138(A,B):-p879(A,C),p1138_1(C,B).
p1138_1(A,B):-skip1(A,C),p122(C,B).
p1141(A,B):-p49(A,C),p158(C,B).
p1142(A,B):-p175(A,C),p1125(C,B).
p1146(A,B):-p4(A,C),p1146_1(C,B).
p1146_1(A,B):-p1293(A,C),p142(C,B).
...
p1188_1(A,B):-p1125(A,C),mk_uppercase(C,B).
...
p1257_1(A,B):-skip1(A,C),p1387(C,B).
p1259(A,B):-p55(A,C),p1259_1(C,B).
p1259_1(A,B):-p53(A,C),mk_uppercase(C,B).
p1261(A,B):-p1274(A,C),p1261_1(C,B).
p1261_1(A,B):-skip1(A,C),p120(C,B).
p1262(A,B):-p117(A,C),p520(C,B).
p1264(A,B):-p17(A,C),p172(C,B).
p1266(A,B):-skip1(A,C),p1266_1(C,B).
p1266_1(A,B):-p1125(A,C),p1266_2(C,B).
p1266_2(A,B):-p181(A,C),copy1(C,B).
...
p1309(A,B):-p17(A,C),p1309_1(C,B).
p1309_1(A,B):-p49(A,C),p1094(C,B).
...
p1325(A,B):-p639(A,C),p86(C,B).
p1327(A,B):-p435(A,C),p1069(C,B).
p1329(A,B):-mk_uppercase(A,C),p1329_1(C,B).
p1329_1(A,B):-p425(A,C),p573(C,B).
p1335(A,B):-p30(A,C),p108(C,B).
p1338(A,B):-p193(A,C),p1338_1(C,B).
p1338_1(A,B):-p172(A,C),p619(C,B).
...
p1350_1(A,B):-skip1(A,C),p1350_2(C,B).
p1350_2(A,B):-skip1(A,C),p744(C,B).
p1352(A,B):-copy1(A,C),p1352_1(C,B).
p1352_1(A,B):-p256(A,C),p273(C,B).
p1353(A,B):-copy1(A,C),p19(C,B).
p1355(A,B):-p425(A,C),p1355_1(C,B).
p1355_1(A,B):-skip1(A,C),p707(C,B).
p1356(A,B):-p197(A,C),p9(C,B).
p1361(A,B):-p53(A,C),p1298(C,B).
p1366(A,B):-p351(A,C),p1366_1(C,B).
p1366_1(A,B):-p1095(A,C),p49(C,B).
p1369(A,B):-skip1(A,C),p1369_1(C,B).
p1369_1(A,B):-p9(A,C),p1394(C,B).
p1370(A,B):-skip1(A,C),p23(C,B).
p1373(A,B):-mk_uppercase(A,C),p1373_1(C,B).
p1373_1(A,B):-p597(A,C),p188(C,B).
p1375(A,B):-p197(A,C),p1375_1(C,B).
p1375_1(A,B):-p17(A,C),p142(C,B).
p1376(A,B):-p79(A,C),p1376_1(C,B).
p1376_1(A,B):-skip1(A,C),p524(C,B).
p1377(A,B):-p75(A,C),p1377_1(C,B).
p1377_1(A,B):-p945(A,C),mk_uppercase(C,B).
p1380(A,B):-copy1(A,C),p1380_1(C,B).
p1380_1(A,B):-skip1(A,C),p1380_2(C,B).
p1380_2(A,B):-skip1(A,C),p524(C,B).
p1381(A,B):-p49(A,C),p538(C,B).
p1382(A,B):-p675(A,C),p79(C,B).
p1383(A,B):-p53(A,C),p193(C,B).
p1386(A,B):-p9(A,C),p425(C,B).
p1388(A,B):-p193(A,C),p1388_1(C,B).
p1388_1(A,B):-p92(A,C),p123(C,B).
...
%timeout
%timeout
b81(A,B):-p278(A,B),is_uppercase(B).
...
%timeout
%timeout
b48(A,B):-p1288(A,C),p92(C,B).
b48(A,B):-b48_1(A,B),is_empty(B).
b48_1(A,B):-p1288(A,C),mk_uppercase(C,B).
...
%timeout
%timeout
b113(A,B):-p350(A,C),b113_1(C,B).
b113_1(A,B):-p225(A,C),mk_uppercase(C,B).
%timeout
%timeout

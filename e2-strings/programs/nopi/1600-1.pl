...
p4_1(A,B):-p29(A,C),p4_2(C,B).
p4_2(A,B):-skip1(A,C),p70(C,B).
...
p34(A,B):-p6(A,C),p34_1(C,B).
p34_1(A,B):-skip1(A,C),p648(C,B).
...
p342(A,B):-p326(A,C),p46(C,B).
p346(A,B):-p779(A,C),p346_1(C,B).
p346_1(A,B):-p660(A,C),p141(C,B).
p352(A,B):-p541(A,C),p2(C,B).
p353(A,B):-p32(A,C),p353_1(C,B).
p353_1(A,B):-skip1(A,C),p1126(C,B).
...
p378(A,B):-p226(A,C),p153(C,B).
p380(A,B):-p566(A,C),p380_1(C,B).
p380_1(A,B):-skip1(A,C),p139(C,B).
p381(A,B):-skip1(A,C),p381_1(C,B).
p381_1(A,B):-p743(A,C),p24(C,B).
p384(A,B):-p423(A,C),p384_1(C,B).
p384_1(A,B):-copy1(A,C),p206(C,B).
p387(A,B):-p112(A,C),p387_1(C,B).
p387_1(A,B):-copy1(A,C),p40(C,B).
p388(A,B):-p58(A,C),p70(C,B).
p389(A,B):-p32(A,C),p389_1(C,B).
p389_1(A,B):-p2(A,C),p141(C,B).
p390(A,B):-p550(A,C),p526(C,B).
p391(A,B):-p32(A,C),p399(C,B).
p395(A,B):-p97(A,C),p395_1(C,B).
p395_1(A,B):-skip1(A,C),p70(C,B).
p398(A,B):-p587(A,C),p398_1(C,B).
p398_1(A,B):-skip1(A,C),p2(C,B).
...
p472_1(A,B):-skip1(A,C),p840(C,B).
p475(A,B):-p31(A,C),p226(C,B).
p477(A,B):-p377(A,C),p477_1(C,B).
p477_1(A,B):-copy1(A,C),p100(C,B).
p482(A,B):-p566(A,C),p482_1(C,B).
p482_1(A,B):-p49(A,C),p6(C,B).
...
p629(A,B):-p58(A,C),p629_1(C,B).
p629_1(A,B):-skip1(A,C),p743(C,B).
p632(A,B):-p6(A,C),p632_1(C,B).
p632_1(A,B):-p373(A,C),p326(C,B).
p633(A,B):-copy1(A,C),p633_1(C,B).
p633_1(A,B):-skip1(A,C),p49(C,B).
p634(A,B):-p112(A,C),p226(C,B).
p635(A,B):-p32(A,C),p635_1(C,B).
p635_1(A,B):-skip1(A,C),p552(C,B).
p637(A,B):-p264(A,C),p46(C,B).
p640(A,B):-skip1(A,C),p327(C,B).
p641(A,B):-p111(A,C),p26(C,B).
p647(A,B):-p142(A,C),p647_1(C,B).
p647_1(A,B):-p26(A,C),p58(C,B).
p654(A,B):-p32(A,C),p654_1(C,B).
p654_1(A,B):-skip1(A,C),p487(C,B).
p658(A,B):-p29(A,C),p597(C,B).
p659(A,B):-p6(A,C),p70(C,B).
p661(A,B):-p35(A,C),p661_1(C,B).
p661_1(A,B):-skip1(A,C),p1358(C,B).
...
p708(A,B):-p1185(A,C),p394(C,B).
p711(A,B):-skip1(A,C),p711_1(C,B).
p711_1(A,B):-skip1(A,C),p683(C,B).
...
p786_1(A,B):-skip1(A,C),p463(C,B).
p787(A,B):-copy1(A,C),p327(C,B).
p788(A,B):-p392(A,C),p788_1(C,B).
p788_1(A,B):-p311(A,C),p742(C,B).
p792(A,B):-p6(A,C),p853(C,B).
p797(A,B):-p267(A,C),p1126(C,B).
p799(A,B):-skip1(A,C),p799_1(C,B).
p799_1(A,B):-p111(A,C),p799_2(C,B).
p799_2(A,B):-skip1(A,C),p6(C,B).
p804(A,B):-p29(A,C),p646(C,B).
p806(A,B):-p853(A,C),p566(C,B).
p808(A,B):-p156(A,C),p327(C,B).
p810(A,B):-p31(A,C),p810_1(C,B).
p810_1(A,B):-skip1(A,C),p840(C,B).
...
p831(A,B):-p566(A,C),p1249(C,B).
p832(A,B):-mk_uppercase(A,C),p541(C,B).
p833(A,B):-copy1(A,C),p833_1(C,B).
p833_1(A,B):-p1333(A,C),p6(C,B).
p836(A,B):-p311(A,C),p836_1(C,B).
p836_1(A,B):-p112(A,C),p6(C,B).
p837(A,B):-mk_uppercase(A,C),p70(C,B).
p838(A,B):-p187(A,C),p1071(C,B).
p839(A,B):-p327(A,C),p35(C,B).
p841(A,B):-p327(A,C),p1405(C,B).
p842(A,B):-p377(A,C),p842_1(C,B).
p842_1(A,B):-copy1(A,C),p487(C,B).
p846(A,B):-p141(A,C),p846_1(C,B).
p846_1(A,B):-p142(A,C),p311(C,B).
p847(A,B):-p141(A,C),p814(C,B).
p852(A,B):-copy1(A,C),p883(C,B).
p854(A,B):-p550(A,C),p903(C,B).
p856(A,B):-p111(A,C),p856_1(C,B).
p856_1(A,B):-p190(A,C),copy1(C,B).
...
p947(A,B):-p156(A,C),p1419(C,B).
p948(A,B):-skip1(A,C),p480(C,B).
p950(A,B):-p31(A,C),p950_1(C,B).
p950_1(A,B):-p564(A,C),mk_lowercase(C,B).
...
p986(A,B):-p141(A,C),p651(C,B).
p987(A,B):-p29(A,C),p1063(C,B).
p989(A,B):-p743(A,C),p989_1(C,B).
p989_1(A,B):-p896(A,C),copy1(C,B).
...
p999_1(A,B):-p113(A,C),p373(C,B).
p1002(A,B):-p423(A,C),p328(C,B).
p1003(A,B):-p6(A,C),p1003_1(C,B).
p1003_1(A,B):-p853(A,C),p97(C,B).
...
p1184(A,B):-p742(A,C),p1184_1(C,B).
p1184_1(A,B):-skip1(A,C),p423(C,B).
p1187(A,B):-mk_lowercase(A,C),p743(C,B).
p1190(A,B):-p32(A,C),p1190_1(C,B).
p1190_1(A,B):-p878(A,C),p32(C,B).
p1193(A,B):-p24(A,C),p1131(C,B).
p1194(A,B):-p165(A,C),p1194_1(C,B).
p1194_1(A,B):-p1346(A,C),p153(C,B).
p1198(A,B):-copy1(A,C),p394(C,B).
p1201(A,B):-p325(A,C),p1201_1(C,B).
p1201_1(A,B):-skip1(A,C),p311(C,B).
p1206(A,B):-copy1(A,C),p1206_1(C,B).
p1206_1(A,B):-p70(A,C),p233(C,B).
p1207(A,B):-p356(A,C),p1207_1(C,B).
p1207_1(A,B):-mk_uppercase(A,C),p311(C,B).
p1208(A,B):-skip1(A,C),p1208_1(C,B).
p1208_1(A,B):-p32(A,C),p896(C,B).
p1211(A,B):-p24(A,C),p1211_1(C,B).
p1211_1(A,B):-p37(A,C),p373(C,B).
...
p1220(A,B):-p29(A,C),p1220_1(C,B).
p1220_1(A,B):-p153(A,C),p58(C,B).
...
p1279(A,B):-p593(A,C),p1279_1(C,B).
p1279_1(A,B):-p29(A,C),p1071(C,B).
p1281(A,B):-is_number(A),p70(A,B).
p1281(A,B):-skip1(A,C),p1281(C,B).
p1282(A,B):-skip1(A,C),p1282_1(C,B).
p1282_1(A,B):-p550(A,C),p1282_2(C,B).
p1282_2(A,B):-mk_lowercase(A,C),p233(C,B).
p1283(A,B):-p6(A,C),p1283_1(C,B).
p1283_1(A,B):-skip1(A,C),p49(C,B).
p1284(A,B):-p111(A,C),p1284_1(C,B).
p1284_1(A,B):-p156(A,C),p1284_2(C,B).
p1284_2(A,B):-skip1(A,C),p376(C,B).
...
p1303_1(A,B):-p2(A,C),p1303_2(C,B).
p1303_2(A,B):-p188(A,C),copy1(C,B).
...
p1385_1(A,B):-p311(A,C),p564(C,B).
p1388(A,B):-p32(A,C),p1388_1(C,B).
p1388_1(A,B):-p58(A,C),p201(C,B).
p1389(A,B):-mk_uppercase(A,C),p1404(C,B).
p1393(A,B):-p58(A,C),p21(C,B).
p1394(A,B):-copy1(A,C),p541(C,B).
p1395(A,B):-skip1(A,C),p1395_1(C,B).
p1395_1(A,B):-p566(A,C),p526(C,B).
p1396(A,B):-mk_uppercase(A,C),p1396_1(C,B).
p1396_1(A,B):-p311(A,C),p1396_2(C,B).
p1396_2(A,B):-p153(A,C),p58(C,B).
p1406(A,B):-copy1(A,C),p1406_1(C,B).
p1406_1(A,B):-p95(A,C),p1406_2(C,B).
p1406_2(A,B):-p801(A,C),p6(C,B).
p1407(A,B):-p13(A,C),p1407_1(C,B).
p1407_1(A,B):-p376(A,C),p31(C,B).
p1408(A,B):-p24(A,C),p1338(C,B).
...
p1418(A,B):-p32(A,C),p1418_1(C,B).
p1418_1(A,B):-p206(A,C),copy1(C,B).
p1420(A,B):-p206(A,C),p690(C,B).
p1422(A,B):-copy1(A,C),p1422_1(C,B).
p1422_1(A,B):-skip1(A,C),p1422_2(C,B).
p1422_2(A,B):-p2(A,C),p394(C,B).
p1424(A,B):-mk_uppercase(A,C),p1424_1(C,B).
p1424_1(A,B):-p141(A,C),p1424_2(C,B).
p1424_2(A,B):-skip1(A,C),p356(C,B).
p1427(A,B):-p6(A,C),p1427_1(C,B).
p1427_1(A,B):-skip1(A,C),p487(C,B).
p1428(A,B):-p6(A,C),p1428_1(C,B).
p1428_1(A,B):-skip1(A,C),p1183(C,B).
p1429(A,B):-p423(A,C),p6(C,B).
p1430(A,B):-p264(A,C),p1430_1(C,B).
p1430_1(A,B):-skip1(A,C),p873(C,B).
p1431(A,B):-copy1(A,C),p1203(C,B).
p1435(A,B):-copy1(A,C),p1435_1(C,B).
p1435_1(A,B):-p373(A,C),p1435_2(C,B).
p1435_2(A,B):-p311(A,C),p311(C,B).
p1437(A,B):-skip1(A,C),p156(C,B).
p1439(A,B):-skip1(A,C),p1439_1(C,B).
p1439_1(A,B):-p753(A,C),p6(C,B).
p1442(A,B):-skip1(A,C),p1442_1(C,B).
p1442_1(A,B):-p311(A,C),p758(C,B).
p1446(A,B):-p1373(A,C),p142(C,B).
p1447(A,B):-p156(A,C),p1447_1(C,B).
p1447_1(A,B):-p58(A,C),p660(C,B).
p1450(A,B):-p37(A,C),p1450_1(C,B).
p1450_1(A,B):-p218(A,C),mk_lowercase(C,B).
p1452(A,B):-p218(A,C),p264(C,B).
p1453(A,B):-p487(A,C),p1453_1(C,B).
p1453_1(A,B):-mk_uppercase(A,C),p779(C,B).
...
p1471(A,B):-p29(A,C),p1471_1(C,B).
p1471_1(A,B):-p112(A,C),copy1(C,B).
p1475(A,B):-p169(A,C),p24(C,B).
p1476(A,B):-copy1(A,C),p394(C,B).
p1480(A,B):-skip1(A,C),p1480_1(C,B).
p1480_1(A,B):-p29(A,C),p1338(C,B).
...
p1505_1(A,B):-p153(A,C),p896(C,B).
p1506(A,B):-skip1(A,C),p17(C,B).
p1511(A,B):-p928(A,C),p29(C,B).
...
p1544(A,B):-p29(A,C),p1544_1(C,B).
p1544_1(A,B):-p156(A,C),p325(C,B).
p1545(A,B):-p550(A,C),p1545_1(C,B).
p1545_1(A,B):-p742(A,C),mk_uppercase(C,B).
...
p1558(A,B):-p311(A,C),p1558_1(C,B).
p1558_1(A,B):-p1445(A,C),p141(C,B).
p1559(A,B):-p58(A,C),p1559_1(C,B).
p1559_1(A,B):-p325(A,C),p550(C,B).
...
p43_1(A,B):-p97(A,C),p388(C,B).
p157(A,B):-mk_lowercase(A,C),p157_1(C,B).
p157_1(A,B):-p996(A,C),copy1(C,B).
p444(A,B):-p32(A,C),p810(C,B).
...
p602_1(A,B):-p37(A,C),p602_2(C,B).
p602_2(A,B):-skip1(A,C),p376(C,B).
p644(A,B):-p584(A,C),p644_1(C,B).
p644_1(A,B):-p742(A,C),p165(C,B).
p851(A,B):-mk_lowercase(A,C),p851_1(C,B).
p851_1(A,B):-p683(A,C),p851_2(C,B).
p851_2(A,B):-p779(A,C),p660(C,B).
p862(A,B):-copy1(A,C),p862_1(C,B).
p862_1(A,B):-p570(A,C),mk_uppercase(C,B).
p1165(A,B):-skip1(A,C),p1165_1(C,B).
p1165_1(A,B):-p111(A,C),p799(C,B).
p1400(A,B):-p1400_1(A,B),is_lowercase(B).
p1400_1(A,B):-not_letter(A),p1587(A,B).
p1400_1(A,B):-skip1(A,C),p1400_1(C,B).
p1562(A,B):-p882(A,C),p1562_1(C,B).
p1562_1(A,B):-p377(A,C),copy1(C,B).
% asserting p43/2
% asserting p157/2
% asserting p444/2
% asserting p514/2
...
%timeout
%timeout
b63(A,B):-p730(A,C),b63_1(C,B).
b63_1(A,B):-skip1(A,C),p29(C,B).
%timeout
%timeout
...
%timeout
%timeout
b113(A,B):-p165(A,C),b113_1(C,B).
b113_1(A,B):-p454(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout

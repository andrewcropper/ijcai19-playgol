...
p12_1(A,B):-p31(A,C),p1162(C,B).
p16(A,B):-p8(A,C),p1286(C,B).
p17(A,B):-p444(A,C),p313(C,B).
p18(A,B):-p570(A,C),p18_1(C,B).
p18_1(A,B):-skip1(A,C),p4(C,B).
p19(A,B):-p243(A,C),p372(C,B).
p21(A,B):-p1159(A,C),p22(C,B).
p24(A,B):-copy1(A,C),p24_1(C,B).
p24_1(A,B):-p1004(A,C),p1159(C,B).
p29(A,B):-p6(A,C),p29_1(C,B).
p29_1(A,B):-mk_uppercase(A,C),p626(C,B).
p30(A,B):-p91(A,C),p30_1(C,B).
p30_1(A,B):-p819(A,C),p23(C,B).
p33(A,B):-p1235(A,C),mk_uppercase(C,B).
p35(A,B):-p35_1(A,B),is_lowercase(B).
p35_1(A,B):-p168(A,C),copy1(C,B).
p35_1(A,B):-skip1(A,C),p35_1(C,B).
p36(A,B):-p74(A,C),p22(C,B).
p41(A,B):-p1807(A,C),p1071(C,B).
...
p52(A,B):-p52_1(A,B),is_lowercase(B).
p52_1(A,B):-p1159(A,C),p318(C,B).
p53(A,B):-p4(A,C),p1804(C,B).
p55(A,B):-p1571(A,C),p4(C,B).
p56(A,B):-p256(A,C),p441(C,B).
p58(A,B):-p511(A,C),p31(C,B).
...
p76(A,B):-p1807(A,C),p76_1(C,B).
p76_1(A,B):-p171(A,C),p243(C,B).
p81(A,B):-p79(A,C),p1203(C,B).
...
p107_1(A,B):-p31(A,C),p149(C,B).
p110(A,B):-p149(A,C),p8(C,B).
p112(A,B):-mk_lowercase(A,C),p112_1(C,B).
p112_1(A,B):-skip1(A,C),p112_2(C,B).
p112_2(A,B):-p316(A,C),p4(C,B).
...
p117(A,B):-p204(A,C),p117_1(C,B).
p117_1(A,B):-p20(A,C),p1198(C,B).
...
p174_1(A,B):-p31(A,C),p1804(C,B).
p175(A,B):-copy1(A,C),p175_1(C,B).
p175_1(A,B):-skip1(A,C),p372(C,B).
p177(A,B):-skip1(A,C),p177_1(C,B).
p177_1(A,B):-p305(A,C),p177_2(C,B).
p177_2(A,B):-skip1(A,C),p149(C,B).
...
p344_1(A,B):-p766(A,C),mk_uppercase(C,B).
p354(A,B):-p512(A,C),p101(C,B).
p355(A,B):-skip1(A,C),p355_1(C,B).
p355_1(A,B):-skip1(A,C),p999(C,B).
p359(A,B):-copy1(A,C),p359_1(C,B).
p359_1(A,B):-p649(A,C),p1442(C,B).
p362(A,B):-mk_lowercase(A,C),p661(C,B).
p366(A,B):-mk_uppercase(A,C),p366_1(C,B).
p366_1(A,B):-p423(A,C),p231(C,B).
p368(A,B):-p34(A,C),p368_1(C,B).
p368_1(A,B):-p22(A,C),p127(C,B).
...
p390_1(A,B):-p123(A,C),p4(C,B).
p396(A,B):-copy1(A,C),p1459(C,B).
p397(A,B):-p4(A,C),p397_1(C,B).
p397_1(A,B):-p434(A,C),p20(C,B).
p398(A,B):-copy1(A,C),p313(C,B).
p402(A,B):-p8(A,C),p402_1(C,B).
p402_1(A,B):-skip1(A,C),p730(C,B).
p403(A,B):-p123(A,C),p6(C,B).
p406(A,B):-skip1(A,C),p406_1(C,B).
p406_1(A,B):-p243(A,C),p406_2(C,B).
p406_2(A,B):-p87(A,C),p22(C,B).
...
p417_2(A,B):-skip1(A,C),p660(C,B).
p418(A,B):-p415(A,C),p418_1(C,B).
p418_1(A,B):-p316(A,C),p4(C,B).
p422(A,B):-p570(A,C),p422_1(C,B).
p422_1(A,B):-skip1(A,C),p1497(C,B).
p430(A,B):-p4(A,C),p430_1(C,B).
p430_1(A,B):-p624(A,C),p3(C,B).
p432(A,B):-mk_uppercase(A,C),p1582(C,B).
p433(A,B):-skip1(A,C),p433_1(C,B).
p433_1(A,B):-p574(A,C),p149(C,B).
...
p497(A,B):-p20(A,C),p497_1(C,B).
p497_1(A,B):-p40(A,C),p1967(C,B).
...
p529(A,B):-p243(A,C),p529_1(C,B).
p529_1(A,B):-skip1(A,C),p1709(C,B).
...
p556_1(A,B):-p436(A,C),mk_uppercase(C,B).
...
p632_1(A,B):-p171(A,C),p198(C,B).
p634(A,B):-copy1(A,C),p634_1(C,B).
p634_1(A,B):-skip1(A,C),p634_2(C,B).
p634_2(A,B):-skip1(A,C),p149(C,B).
p638(A,B):-p88(A,C),p638_1(C,B).
p638_1(A,B):-p40(A,C),p20(C,B).
p641(A,B):-skip1(A,C),p641_1(C,B).
p641_1(A,B):-p3(A,C),p641_2(C,B).
p641_2(A,B):-p101(A,C),p204(C,B).
...
p774(A,B):-p1203(A,C),p774_1(C,B).
p774_1(A,B):-p182(A,C),p204(C,B).
p776(A,B):-p1166(A,C),p1053(C,B).
p777(A,B):-p20(A,C),p1512(C,B).
p778(A,B):-p245(A,C),p105(C,B).
p785(A,B):-copy1(A,C),p785_1(C,B).
p785_1(A,B):-p510(A,C),p204(C,B).
p788(A,B):-p20(A,C),p788_1(C,B).
p788_1(A,B):-skip1(A,C),p812(C,B).
p790(A,B):-p4(A,C),p790_1(C,B).
p790_1(A,B):-is_lowercase(A),p1221(A,B).
p790_1(A,B):-skip1(A,C),p790_1(C,B).
p791(A,B):-p708(A,C),p689(C,B).
p797(A,B):-skip1(A,C),p797_1(C,B).
p797_1(A,B):-p245(A,C),p797_2(C,B).
p797_2(A,B):-skip1(A,C),p6(C,B).
p798(A,B):-p309(A,C),copy1(C,B).
...
p826_1(A,B):-p1042(A,C),copy1(C,B).
p832(A,B):-p313(A,C),p649(C,B).
...
p859_1(A,B):-p149(A,C),p1159(C,B).
p863(A,B):-copy1(A,C),p863_1(C,B).
p863_1(A,B):-skip1(A,C),p919(C,B).
p864(A,B):-p1042(A,C),p864_1(C,B).
p864_1(A,B):-p318(A,C),p31(C,B).
p869(A,B):-copy1(A,C),p869_1(C,B).
p869_1(A,B):-p94(A,C),p257(C,B).
p870(A,B):-p22(A,C),p870_1(C,B).
p870_1(A,B):-p1807(A,C),p64(C,B).
p874(A,B):-p162(A,C),p1709(C,B).
p875(A,B):-mk_lowercase(A,C),p875_1(C,B).
p875_1(A,B):-p1289(A,C),copy1(C,B).
p875_1(A,B):-skip1(A,C),p875_1(C,B).
p877(A,B):-skip1(A,C),p877_1(C,B).
p877_1(A,B):-skip1(A,C),p372(C,B).
p879(A,B):-skip1(A,C),p879_1(C,B).
p879_1(A,B):-p3(A,C),p879_2(C,B).
p879_2(A,B):-p6(A,C),mk_uppercase(C,B).
...
p883(A,B):-p883_1(A,B),is_uppercase(B).
p883_1(A,B):-p294(A,C),p1807(C,B).
p889(A,B):-p649(A,C),p889_1(C,B).
p889_1(A,B):-p570(A,C),mk_uppercase(C,B).
...
p933(A,B):-p697(A,C),p933_1(C,B).
p933_1(A,B):-skip1(A,C),p245(C,B).
p936(A,B):-p3(A,C),p54(C,B).
p939(A,B):-p149(A,C),p1062(C,B).
p940(A,B):-skip1(A,C),p940_1(C,B).
p940_1(A,B):-p999(A,C),p204(C,B).
p945(A,B):-skip1(A,C),p945_1(C,B).
p945_1(A,B):-p3(A,C),p945_2(C,B).
p945_2(A,B):-p1062(A,C),p31(C,B).
p949(A,B):-p622(A,C),p328(C,B).
p951(A,B):-p22(A,C),p951_1(C,B).
p951_1(A,B):-p1580(A,C),p1159(C,B).
...
p977(A,B):-p1203(A,C),p977_1(C,B).
p977_1(A,B):-skip1(A,C),p1709(C,B).
...
p992_1(A,B):-p1497(A,C),p1169(C,B).
...
p1005(A,B):-p1005_1(A,B),is_lowercase(B).
p1005_1(A,B):-p168(A,C),p1807(C,B).
p1007(A,B):-copy1(A,C),p511(C,B).
p1013(A,B):-p4(A,C),p1013_1(C,B).
p1013_1(A,B):-p1460(A,C),p31(C,B).
...
p1176_1(A,B):-p313(A,C),p88(C,B).
p1179(A,B):-p20(A,C),p1918(C,B).
p1180(A,B):-p919(A,C),p1180_1(C,B).
p1180_1(A,B):-skip1(A,C),p1568(C,B).
...
p1225(A,B):-p1221(A,C),p524(C,B).
p1230(A,B):-mk_lowercase(A,C),p1230_1(C,B).
p1230_1(A,B):-p88(A,C),p1159(C,B).
...
p1254_1(A,B):-skip1(A,C),p1721(C,B).
p1255(A,B):-p708(A,C),p123(C,B).
p1261(A,B):-skip1(A,C),p372(C,B).
p1262(A,B):-copy1(A,C),p1262_1(C,B).
p1262_1(A,B):-p31(A,C),p6(C,B).
...
p1281(A,B):-p1629(A,C),p730(C,B).
p1283(A,B):-mk_uppercase(A,C),p1283_1(C,B).
p1283_1(A,B):-skip1(A,C),p914(C,B).
p1284(A,B):-p2(A,C),p1284_1(C,B).
p1284_1(A,B):-p280(A,C),p34(C,B).
p1293(A,B):-p1810(A,C),p1293_1(C,B).
p1293_1(A,B):-skip1(A,C),p625(C,B).
...
p1314_1(A,B):-p1442(A,C),p149(C,B).
p1315(A,B):-p315(A,C),p57(C,B).
p1318(A,B):-p372(A,C),p444(C,B).
p1321(A,B):-p4(A,C),p1321_1(C,B).
p1321_1(A,B):-p1042(A,C),p149(C,B).
...
p1341_1(A,B):-p1512(A,C),p1341_2(C,B).
p1341_2(A,B):-skip1(A,C),p3(C,B).
p1343(A,B):-p23(A,C),p280(C,B).
p1344(A,B):-p141(A,C),p847(C,B).
...
p1361(A,B):-p524(A,C),p1361_1(C,B).
p1361_1(A,B):-skip1(A,C),p474(C,B).
p1363(A,B):-copy1(A,C),p1060(C,B).
p1364(A,B):-p316(A,C),p248(C,B).
p1365(A,B):-p245(A,C),p1365_1(C,B).
p1365_1(A,B):-p154(A,C),p1879(C,B).
...
p1406(A,B):-p1203(A,C),p1406_1(C,B).
p1406_1(A,B):-p22(A,C),p1368(C,B).
p1407(A,B):-p415(A,C),p194(C,B).
p1412(A,B):-p1235(A,C),p20(C,B).
p1414(A,B):-p243(A,C),p1414_1(C,B).
p1414_1(A,B):-skip1(A,C),p572(C,B).
...
p1424_1(A,B):-p1582(A,C),p88(C,B).
p1428(A,B):-copy1(A,C),p1996(C,B).
p1431(A,B):-skip1(A,C),p1431_1(C,B).
p1431_1(A,B):-skip1(A,C),p1431_2(C,B).
p1431_2(A,B):-p890(A,C),p3(C,B).
...
p1515_1(A,B):-p3(A,C),p1515_2(C,B).
p1515_2(A,B):-skip1(A,C),p372(C,B).
p1516(A,B):-p441(A,C),p1368(C,B).
...
p1600_1(A,B):-p327(A,C),p20(C,B).
p1605(A,B):-copy1(A,C),p1756(C,B).
p1607(A,B):-p3(A,C),p1716(C,B).
p1608(A,B):-p524(A,C),p1608_1(C,B).
p1608_1(A,B):-p4(A,C),p689(C,B).
p1610(A,B):-p528(A,C),p372(C,B).
p1612(A,B):-p248(A,C),p1612_1(C,B).
p1612_1(A,B):-skip1(A,C),p1721(C,B).
...
p1626(A,B):-p423(A,C),p339(C,B).
p1627(A,B):-mk_lowercase(A,C),p1627_1(C,B).
p1627_1(A,B):-p444(A,C),p552(C,B).
...
p1650(A,B):-p141(A,C),p1650_1(C,B).
p1650_1(A,B):-mk_uppercase(A,C),p88(C,B).
...
p1669(A,B):-p1807(A,C),p1669_1(C,B).
p1669_1(A,B):-p1807(A,C),p22(C,B).
...
p1690(A,B):-p318(A,C),p1690_1(C,B).
p1690_1(A,B):-p1203(A,C),p1690_2(C,B).
p1690_2(A,B):-skip1(A,C),p708(C,B).
p1691(A,B):-copy1(A,C),p510(C,B).
p1694(A,B):-skip1(A,C),p1694_1(C,B).
p1694_1(A,B):-p372(A,C),p434(C,B).
p1697(A,B):-p372(A,C),p1124(C,B).
p1699(A,B):-p3(A,C),p1699_1(C,B).
p1699_1(A,B):-skip1(A,C),p1080(C,B).
...
p1720(A,B):-p399(A,C),copy1(C,B).
p1722(A,B):-copy1(A,C),p1722_1(C,B).
p1722_1(A,B):-skip1(A,C),p1201(C,B).
...
p1739(A,B):-p248(A,C),p1739_1(C,B).
p1739_1(A,B):-skip1(A,C),p22(C,B).
p1741(A,B):-p372(A,C),p528(C,B).
p1745(A,B):-p141(A,C),p243(C,B).
p1747(A,B):-p441(A,C),p434(C,B).
p1751(A,B):-skip1(A,C),p277(C,B).
p1755(A,B):-p1450(A,C),p1201(C,B).
p1758(A,B):-p1060(A,C),p1758_1(C,B).
p1758_1(A,B):-copy1(A,C),p277(C,B).
...
p1809(A,B):-p1834(A,C),p1809_1(C,B).
p1809_1(A,B):-skip1(A,C),p766(C,B).
...
p1833_1(A,B):-p245(A,C),p105(C,B).
p1835(A,B):-p3(A,C),p373(C,B).
p1838(A,B):-p649(A,C),p1459(C,B).
p1842(A,B):-p1235(A,C),p1842_1(C,B).
p1842_1(A,B):-skip1(A,C),p524(C,B).
...
p1870(A,B):-p127(A,C),p1870_1(C,B).
p1870_1(A,B):-skip1(A,C),p1568(C,B).
p1873(A,B):-p22(A,C),p1873_1(C,B).
p1873_1(A,B):-skip1(A,C),p313(C,B).
p1874(A,B):-p6(A,C),p1450(C,B).
p1880(A,B):-skip1(A,C),p372(C,B).
p1883(A,B):-p3(A,C),p511(C,B).
p1888(A,B):-copy1(A,C),p1888_1(C,B).
p1888_1(A,B):-p625(A,C),p819(C,B).
...
p1917(A,B):-p415(A,C),p1917_1(C,B).
p1917_1(A,B):-p268(A,C),p198(C,B).
p1921(A,B):-p20(A,C),p1921_1(C,B).
p1921_1(A,B):-p40(A,C),p20(C,B).
p1929(A,B):-copy1(A,C),p1062(C,B).
p1932(A,B):-copy1(A,C),p1166(C,B).
p1934(A,B):-copy1(A,C),p873(C,B).
p1935(A,B):-p105(A,C),p1935_1(C,B).
p1935_1(A,B):-skip1(A,C),p1466(C,B).
p1938(A,B):-p79(A,C),p280(C,B).
p1945(A,B):-mk_uppercase(A,C),p1945_1(C,B).
p1945_1(A,B):-skip1(A,C),p1235(C,B).
...
% asserting p1998/2
% depth 4
p135(A,B):-p301(A,C),p135_1(C,B).
p135_1(A,B):-skip1(A,C),p3(C,B).
p333(A,B):-copy1(A,C),p333_1(C,B).
p333_1(A,B):-p901(A,C),mk_uppercase(C,B).
p435(A,B):-p204(A,C),p435_1(C,B).
p435_1(A,B):-p762(A,C),copy1(C,B).
p469(A,B):-copy1(A,C),p469_1(C,B).
p469_1(A,B):-skip1(A,C),p469_2(C,B).
p469_2(A,B):-skip1(A,C),p100(C,B).
p683(A,B):-skip1(A,C),p683_1(C,B).
p683_1(A,B):-p3(A,C),p207(C,B).
p684(A,B):-skip1(A,C),p44(C,B).
p733(A,B):-mk_lowercase(A,C),p733_1(C,B).
p733_1(A,B):-skip1(A,C),p733_2(C,B).
p733_2(A,B):-p22(A,C),p1593(C,B).
p742(A,B):-p91(A,C),p742_1(C,B).
p742_1(A,B):-skip1(A,C),p742_2(C,B).
p742_2(A,B):-p149(A,C),mk_uppercase(C,B).
p781(A,B):-p503(A,C),mk_uppercase(C,B).
p888(A,B):-copy1(A,C),p888_1(C,B).
p888_1(A,B):-p1855(A,C),p888_2(C,B).
p888_2(A,B):-skip1(A,C),p22(C,B).
p1026(A,B):-mk_uppercase(A,C),p1026_1(C,B).
p1026_1(A,B):-skip1(A,C),p100(C,B).
p1075(A,B):-p194(A,C),p121(C,B).
p1206(A,B):-p207(A,C),p1206_1(C,B).
p1206_1(A,B):-p149(A,C),mk_lowercase(C,B).
p1208(A,B):-copy1(A,C),p1208_1(C,B).
p1208_1(A,B):-p100(A,C),copy1(C,B).
p1291(A,B):-p318(A,C),p560(C,B).
p1306(A,B):-p3(A,C),p1306_1(C,B).
p1306_1(A,B):-skip1(A,C),p1209(C,B).
p1378(A,B):-p4(A,C),p1378_1(C,B).
p1378_1(A,B):-p409(A,C),mk_lowercase(C,B).
p1492(A,B):-copy1(A,C),p1492_1(C,B).
p1492_1(A,B):-p207(A,C),mk_uppercase(C,B).
p1931(A,B):-skip1(A,C),p1931_1(C,B).
p1931_1(A,B):-p4(A,C),p634(C,B).
% asserting p135/2
% asserting p333/2
% asserting p435/2
% asserting p469/2
...
%timeout
%timeout
b78(A,B):-p8(A,C),b78_1(C,B).
b78_1(A,B):-p8(A,C),p1169(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b63(A,B):-p207(A,C),b63_1(C,B).
b63_1(A,B):-skip1(A,C),p999(C,B).
%timeout
...
%timeout
%timeout
b113(A,B):-p565(A,C),b113_1(C,B).
b113_1(A,B):-skip1(A,C),p660(C,B).
%timeout

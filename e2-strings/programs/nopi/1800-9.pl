...
p138_1(A,B):-skip1(A,C),p1672(C,B).
...
p215_1(A,B):-p222(A,C),p737(C,B).
p216(A,B):-p89(A,C),p109(C,B).
p221(A,B):-skip1(A,C),p798(C,B).
p228(A,B):-p41(A,C),p1291(C,B).
p230(A,B):-p102(A,C),p89(C,B).
p231(A,B):-p109(A,C),p231_1(C,B).
p231_1(A,B):-p82(A,C),p310(C,B).
...
p242(A,B):-p1593(A,C),p89(C,B).
p245(A,B):-mk_uppercase(A,C),p245_1(C,B).
p245_1(A,B):-p633(A,C),p117(C,B).
...
p442_1(A,B):-p426(A,C),p409(C,B).
p443(A,B):-p169(A,C),mk_uppercase(C,B).
p445(A,B):-p5(A,C),p691(C,B).
p446(A,B):-p5(A,C),p1226(C,B).
p447(A,B):-p67(A,C),p1261(C,B).
p448(A,B):-copy1(A,C),p448_1(C,B).
p448_1(A,B):-p1507(A,C),p232(C,B).
p450(A,B):-p109(A,C),p201(C,B).
p451(A,B):-p310(A,C),p451_1(C,B).
p451_1(A,B):-p244(A,C),p310(C,B).
p452(A,B):-p87(A,C),p3(C,B).
p458(A,B):-p129(A,C),p110(C,B).
p460(A,B):-p507(A,C),p460_1(C,B).
p460_1(A,B):-skip1(A,C),p843(C,B).
p461(A,B):-is_uppercase(A),p1078(A,B).
p461(A,B):-skip1(A,C),p461(C,B).
...
p493_1(A,B):-p426(A,C),p1261(C,B).
p495(A,B):-copy1(A,C),p495_1(C,B).
p495_1(A,B):-p342(A,C),p1261(C,B).
p499(A,B):-p834(A,C),p499_1(C,B).
p499_1(A,B):-not_letter(A),p87(A,B).
p501(A,B):-p341(A,C),p1031(C,B).
p508(A,B):-p1056(A,C),p508_1(C,B).
p508_1(A,B):-skip1(A,C),p16(C,B).
...
p524_1(A,B):-p1056(A,C),mk_uppercase(C,B).
p525(A,B):-skip1(A,C),p525_1(C,B).
p525_1(A,B):-p109(A,C),p525_2(C,B).
p525_2(A,B):-p796(A,C),p199(C,B).
p528(A,B):-p87(A,C),p528_1(C,B).
p528_1(A,B):-skip1(A,C),p1078(C,B).
...
p634(A,B):-p1605(A,C),p634_1(C,B).
p634_1(A,B):-p29(A,C),p34(C,B).
p635(A,B):-p229(A,C),p5(C,B).
...
p653_1(A,B):-p426(A,C),p565(C,B).
p658(A,B):-skip1(A,C),p658_1(C,B).
p658_1(A,B):-p241(A,C),p1553(C,B).
...
p716_1(A,B):-p1749(A,C),p716_2(C,B).
p716_2(A,B):-skip1(A,C),p146(C,B).
p717(A,B):-p241(A,C),p507(C,B).
p718(A,B):-skip1(A,C),p718_1(C,B).
p718_1(A,B):-p5(A,C),p169(C,B).
p719(A,B):-p255(A,C),p654(C,B).
p720(A,B):-p1089(A,C),p798(C,B).
p721(A,B):-p834(A,C),p1672(C,B).
...
p754(A,B):-p66(A,C),p17(C,B).
p755(A,B):-p686(A,C),p311(C,B).
...
p822(A,B):-p342(A,C),p822_1(C,B).
p822_1(A,B):-p644(A,C),p553(C,B).
p823(A,B):-mk_uppercase(A,C),p427(C,B).
p823(A,B):-skip1(A,C),p823(C,B).
p826(A,B):-p1593(A,C),p232(C,B).
p827(A,B):-p89(A,C),p827_1(C,B).
p827_1(A,B):-skip1(A,C),p1257(C,B).
p828(A,B):-skip1(A,C),p828_1(C,B).
p828_1(A,B):-p42(A,C),p1261(C,B).
p830(A,B):-p1181(A,C),p830_1(C,B).
p830_1(A,B):-skip1(A,C),p789(C,B).
p831(A,B):-p199(A,C),p831_1(C,B).
p831_1(A,B):-skip1(A,C),p10(C,B).
...
p866_1(A,B):-p5(A,C),p651(C,B).
p869(A,B):-p1138(A,C),p869_1(C,B).
p869_1(A,B):-skip1(A,C),p789(C,B).
p876(A,B):-p5(A,C),p876_1(C,B).
p876_1(A,B):-p553(A,C),p1553(C,B).
p878(A,B):-copy1(A,C),p878_1(C,B).
p878_1(A,B):-p342(A,C),p38(C,B).
p879(A,B):-copy1(A,C),p879_1(C,B).
p879_1(A,B):-p66(A,C),p324(C,B).
p880(A,B):-p565(A,C),p66(C,B).
p886(A,B):-p229(A,C),p66(C,B).
p887(A,B):-p201(A,C),p383(C,B).
p891(A,B):-p426(A,C),p891_1(C,B).
p891_1(A,B):-skip1(A,C),p1263(C,B).
p892(A,B):-p1322(A,C),p67(C,B).
p893(A,B):-p72(A,C),p146(C,B).
p895(A,B):-p342(A,C),p409(C,B).
p898(A,B):-p66(A,C),p1014(C,B).
p902(A,B):-copy1(A,C),p392(C,B).
p905(A,B):-p229(A,C),p5(C,B).
p912(A,B):-skip1(A,C),p912_1(C,B).
p912_1(A,B):-skip1(A,C),p534(C,B).
p915(A,B):-skip1(A,C),p915_1(C,B).
p915_1(A,B):-p67(A,C),p1553(C,B).
...
p984(A,B):-p455(A,C),p42(C,B).
p985(A,B):-skip1(A,C),p985_1(C,B).
p985_1(A,B):-p1291(A,C),p324(C,B).
p987(A,B):-copy1(A,C),p154(C,B).
p988(A,B):-p1181(A,C),p988_1(C,B).
p988_1(A,B):-skip1(A,C),p1449(C,B).
...
p1002(A,B):-p1257(A,C),p1002_1(C,B).
p1002_1(A,B):-skip1(A,C),p232(C,B).
...
p1027(A,B):-p1261(A,C),p553(C,B).
p1028(A,B):-p310(A,C),p1028_1(C,B).
p1028_1(A,B):-p117(A,C),p162(C,B).
p1032(A,B):-copy1(A,C),p737(C,B).
p1034(A,B):-p201(A,C),p1449(C,B).
p1039(A,B):-skip1(A,C),p1039_1(C,B).
p1039_1(A,B):-skip1(A,C),p38(C,B).
p1041(A,B):-p110(A,C),p1041_1(C,B).
p1041_1(A,B):-p654(A,C),p146(C,B).
p1042(A,B):-p201(A,C),p1042_1(C,B).
p1042_1(A,B):-p565(A,C),p34(C,B).
p1043(A,B):-copy1(A,C),p1043_1(C,B).
p1043_1(A,B):-p553(A,C),p1205(C,B).
p1044(A,B):-mk_lowercase(A,C),p41(C,B).
p1048(A,B):-p109(A,C),p134(C,B).
p1050(A,B):-p5(A,C),p1050_1(C,B).
p1050_1(A,B):-skip1(A,C),p10(C,B).
...
p1215(A,B):-p248(A,C),p1215_1(C,B).
p1215_1(A,B):-p232(A,C),p111(C,B).
p1229(A,B):-p87(A,C),p1229_1(C,B).
p1229_1(A,B):-p768(A,C),p117(C,B).
p1230(A,B):-p530(A,C),p523(C,B).
p1231(A,B):-p5(A,C),p1231_1(C,B).
p1231_1(A,B):-p345(A,C),p99(C,B).
p1232(A,B):-copy1(A,C),p1232_1(C,B).
p1232_1(A,B):-skip1(A,C),p1449(C,B).
...
p1346(A,B):-p374(A,C),p1346_1(C,B).
p1346_1(A,B):-p310(A,C),p117(C,B).
p1349(A,B):-skip1(A,C),p41(C,B).
p1350(A,B):-copy1(A,C),p1350_1(C,B).
p1350_1(A,B):-p219(A,C),p711(C,B).
p1351(A,B):-skip1(A,C),p1351_1(C,B).
p1351_1(A,B):-skip1(A,C),p10(C,B).
...
p1390_1(A,B):-p33(A,C),p1219(C,B).
p1393(A,B):-mk_lowercase(A,C),p41(C,B).
p1396(A,B):-p169(A,C),p1396_1(C,B).
p1396_1(A,B):-copy1(A,C),p1238(C,B).
p1399(A,B):-p310(A,C),p1399_1(C,B).
p1399_1(A,B):-p1119(A,C),p341(C,B).
...
p1418_1(A,B):-skip1(A,C),p1418_2(C,B).
p1418_2(A,B):-skip1(A,C),p796(C,B).
...
p1432_1(A,B):-p5(A,C),p38(C,B).
p1438(A,B):-p110(A,C),p89(C,B).
...
p1509(A,B):-p737(A,C),p342(C,B).
p1510(A,B):-p169(A,C),p1510_1(C,B).
p1510_1(A,B):-mk_lowercase(A,C),p110(C,B).
...
p1535_1(A,B):-p232(A,C),p1261(C,B).
...
p1542_1(A,B):-p67(A,C),p109(C,B).
p1543(A,B):-p66(A,C),p383(C,B).
p1544(A,B):-copy1(A,C),p1544_1(C,B).
p1544_1(A,B):-skip1(A,C),p1672(C,B).
p1545(A,B):-p201(A,C),p1649(C,B).
p1549(A,B):-p523(A,C),p409(C,B).
p1560(A,B):-copy1(A,C),p1560_1(C,B).
p1560_1(A,B):-p66(A,C),p558(C,B).
...
p1578_1(A,B):-p558(A,C),p66(C,B).
p1582(A,B):-copy1(A,C),p1582_1(C,B).
p1582_1(A,B):-p16(A,C),p426(C,B).
p1586(A,B):-p110(A,C),p7(C,B).
p1587(A,B):-p342(A,C),p1376(C,B).
p1590(A,B):-p834(A,C),p1590_1(C,B).
p1590_1(A,B):-p1259(A,C),copy1(C,B).
p1592(A,B):-p1749(A,C),mk_uppercase(C,B).
p1592(A,B):-mk_uppercase(A,C),p1592(C,B).
p1594(A,B):-copy1(A,C),p737(C,B).
p1595(A,B):-p232(A,C),p1595_1(C,B).
p1595_1(A,B):-skip1(A,C),p901(C,B).
p1603(A,B):-p5(A,C),p1672(C,B).
p1604(A,B):-p967(A,C),p1604_1(C,B).
p1604_1(A,B):-p199(A,C),p87(C,B).
p1606(A,B):-p110(A,C),p565(C,B).
...
p1751_1(A,B):-p342(A,C),p1751_2(C,B).
p1751_2(A,B):-p681(A,C),p117(C,B).
p1753(A,B):-p102(A,C),p1695(C,B).
p1754(A,B):-p768(A,C),p82(C,B).
p1765(A,B):-p169(A,C),p131(C,B).
...
% asserting p1790/2
% depth 4
p83(A,B):-p320(A,C),p83_1(C,B).
p83_1(A,B):-mk_lowercase(A,C),p117(C,B).
p144(A,B):-skip1(A,C),p144_1(C,B).
p144_1(A,B):-skip1(A,C),p635(C,B).
p480(A,B):-p5(A,C),p1351(C,B).
p511(A,B):-mk_lowercase(A,C),p511_1(C,B).
p511_1(A,B):-mk_uppercase(A,B),is_lowercase(B).
p511_1(A,B):-skip1(A,C),p511_1(C,B).
...
p1143_1(A,B):-p1075(A,C),mk_lowercase(C,B).
...
%timeout
%timeout
b81(A,B):-p409(A,B),is_uppercase(B).
...
b63_1(A,B):-p409(A,C),p798(C,B).
%timeout
b24(A,B):-skip1(A,C),b24_1(C,B).
b24_1(A,B):-p409(A,C),p798(C,B).

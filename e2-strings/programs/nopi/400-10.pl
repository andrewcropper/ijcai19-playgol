...
p14_1(A,B):-p49(A,C),p315(C,B).
p15(A,B):-p46(A,C),p15_1(C,B).
p15_1(A,B):-p30(A,C),p303(C,B).
...
p19_1(A,B):-p91(A,C),p19_2(C,B).
p19_2(A,B):-p7(A,C),p24(C,B).
p22(A,B):-copy1(A,C),p22_1(C,B).
p22_1(A,B):-skip1(A,C),p348(C,B).
p23(A,B):-p68(A,C),p23_1(C,B).
p23_1(A,B):-p30(A,C),p23_2(C,B).
p23_2(A,B):-skip1(A,C),p68(C,B).
p27(A,B):-p35(A,C),p348(C,B).
p33(A,B):-p10(A,C),p163(C,B).
p38(A,B):-p24(A,C),p8(C,B).
p41(A,B):-p175(A,C),p41_1(C,B).
p41_1(A,B):-skip1(A,C),p41_2(C,B).
p41_2(A,B):-skip1(A,C),p169(C,B).
p42(A,B):-p175(A,C),p42_1(C,B).
p42_1(A,B):-p91(A,C),p113(C,B).
...
p65_1(A,B):-p220(A,C),p65_2(C,B).
p65_2(A,B):-p149(A,C),mk_lowercase(C,B).
...
p80(A,B):-p24(A,C),p80_1(C,B).
p80_1(A,B):-p68(A,C),p32(C,B).
...
p110(A,B):-p88(A,C),p149(C,B).
p112(A,B):-p211(A,C),p112_1(C,B).
p112_1(A,B):-p32(A,C),p32(C,B).
p114(A,B):-p32(A,C),p114_1(C,B).
p114_1(A,B):-p150(A,C),p114_2(C,B).
p114_2(A,B):-p150(A,C),mk_lowercase(C,B).
p121(A,B):-p54(A,C),p121_1(C,B).
p121_1(A,B):-p32(A,C),p113(C,B).
p122(A,B):-copy1(A,C),p122_1(C,B).
p122_1(A,B):-skip1(A,C),p122_2(C,B).
p122_2(A,B):-p36(A,C),p8(C,B).
p123(A,B):-p30(A,C),p123_1(C,B).
p123_1(A,B):-p10(A,C),p68(C,B).
...
p200_2(A,B):-skip1(A,C),p276(C,B).
p201(A,B):-p91(A,C),p201_1(C,B).
p201_1(A,B):-p5(A,C),mk_lowercase(C,B).
p202(A,B):-skip1(A,C),p202_1(C,B).
p202_1(A,B):-p169(A,C),p202_2(C,B).
p202_2(A,B):-mk_uppercase(A,C),mk_uppercase(C,B).
p208(A,B):-skip1(A,C),p208_1(C,B).
p208_1(A,B):-p188(A,C),p315(C,B).
p209(A,B):-p21(A,C),p209_1(C,B).
p209_1(A,B):-p126(A,C),p319(C,B).
...
p223_1(A,B):-p32(A,C),p223_2(C,B).
p223_2(A,B):-p175(A,C),p68(C,B).
p225(A,B):-mk_uppercase(A,C),p225_1(C,B).
p225_1(A,B):-p46(A,C),p315(C,B).
p226(A,B):-mk_lowercase(A,C),p226_1(C,B).
p226_1(A,B):-p91(A,C),p226_2(C,B).
p226_2(A,B):-p54(A,C),mk_uppercase(C,B).
p229(A,B):-p211(A,C),p229_1(C,B).
p229_1(A,B):-p204(A,C),copy1(C,B).
p231(A,B):-p68(A,C),p231_1(C,B).
p231_1(A,B):-p319(A,C),p24(C,B).
...
p253_1(A,B):-skip1(A,C),p253_2(C,B).
p253_2(A,B):-p175(A,C),p126(C,B).
p254(A,B):-p32(A,C),p254_1(C,B).
p254_1(A,B):-skip1(A,C),p348(C,B).
p256(A,B):-p169(A,C),p303(C,B).
...
p322_1(A,B):-p113(A,C),p322_2(C,B).
p322_2(A,B):-p91(A,C),p182(C,B).
p325(A,B):-p182(A,C),p325_1(C,B).
p325_1(A,B):-p113(A,C),p325_2(C,B).
p325_2(A,B):-mk_lowercase(A,C),p35(C,B).
...
p337_1(A,B):-mk_lowercase(A,C),p337_2(C,B).
p337_2(A,B):-p91(A,C),p182(C,B).
...
p389_1(A,B):-p347(A,C),copy1(C,B).
p391(A,B):-p150(A,C),p391_1(C,B).
p391_1(A,B):-mk_lowercase(A,C),p40(C,B).
p395(A,B):-p11(A,C),p369(C,B).
p396(A,B):-mk_lowercase(A,C),p396_1(C,B).
p396_1(A,B):-skip1(A,C),p396_2(C,B).
p396_2(A,B):-p242(A,C),p113(C,B).
p398(A,B):-p91(A,C),p398_1(C,B).
p398_1(A,B):-p281(A,C),copy1(C,B).
...
p197(A,B):-p197_1(A,B),is_lowercase(B).
p197_1(A,B):-p99(A,C),mk_uppercase(C,B).
p197_1(A,B):-skip1(A,C),p197_1(C,B).
p260(A,B):-p24(A,C),p370(C,B).
p300(A,B):-p24(A,C),p300_1(C,B).
p300_1(A,B):-skip1(A,C),p300_2(C,B).
p300_2(A,B):-p68(A,C),p242(C,B).
...
b113(A,B):-p310(A,C),mk_uppercase(C,B).

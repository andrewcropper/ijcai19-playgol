...
% asserting p791/2
% depth 3
p2(A,B):-p75(A,C),p2_1(C,B).
p2_1(A,B):-p276(A,C),p568(C,B).
p4(A,B):-p142(A,C),p4_1(C,B).
p4_1(A,B):-skip1(A,C),p4_2(C,B).
p4_2(A,B):-skip1(A,C),p692(C,B).
p7(A,B):-p309(A,C),p139(C,B).
p8(A,B):-p1(A,C),p219(C,B).
p9(A,B):-skip1(A,C),p9_1(C,B).
p9_1(A,B):-p296(A,C),p9_2(C,B).
p9_2(A,B):-mk_lowercase(A,C),p97(C,B).
p15(A,B):-p1(A,C),p15_1(C,B).
p15_1(A,B):-p83(A,C),p142(C,B).
p16(A,B):-mk_uppercase(A,C),p16_1(C,B).
p16_1(A,B):-skip1(A,C),p16_2(C,B).
p16_2(A,B):-p296(A,C),p88(C,B).
p19(A,B):-skip1(A,C),p19_1(C,B).
p19_1(A,B):-p296(A,C),p83(C,B).
...
p67_1(A,B):-p328(A,C),p67_2(C,B).
p67_2(A,B):-skip1(A,C),p17(C,B).
...
p182_1(A,B):-mk_lowercase(A,C),p182_2(C,B).
p182_2(A,B):-skip1(A,C),p306(C,B).
p183(A,B):-p411(A,C),p537(C,B).
p185(A,B):-copy1(A,C),p185_1(C,B).
p185_1(A,B):-mk_lowercase(A,C),p185_2(C,B).
p185_2(A,B):-p97(A,C),p447(C,B).
p187(A,B):-p447(A,C),p170(C,B).
p194(A,B):-p537(A,C),p167(C,B).
p197(A,B):-p139(A,C),p197_1(C,B).
p197_1(A,B):-mk_uppercase(A,C),p218(C,B).
...
p238(A,B):-p142(A,C),p238_1(C,B).
p238_1(A,B):-p219(A,C),p14(C,B).
p239(A,B):-p359(A,C),p239_1(C,B).
p239_1(A,B):-p731(A,C),mk_uppercase(C,B).
...
p423_1(A,B):-p381(A,C),p276(C,B).
p426(A,B):-p574(A,C),p426_1(C,B).
p426_1(A,B):-p97(A,C),p426_2(C,B).
...
p451(A,B):-p142(A,C),p451_1(C,B).
p451_1(A,B):-skip1(A,C),p402(C,B).
p463(A,B):-mk_lowercase(A,C),p463_1(C,B).
p463_1(A,B):-skip1(A,C),p774(C,B).
p465(A,B):-skip1(A,C),p465_1(C,B).
p465_1(A,B):-skip1(A,C),p81(C,B).
p466(A,B):-p99(A,C),p105(C,B).
p470(A,B):-p170(A,C),p229(C,B).
p475(A,B):-p96(A,C),p475_1(C,B).
p475_1(A,B):-p574(A,C),p359(C,B).
p476(A,B):-p120(A,C),p476_1(C,B).
p476_1(A,B):-p71(A,C),p5(C,B).
p478(A,B):-p509(A,C),mk_uppercase(C,B).
p481(A,B):-p5(A,C),p128(C,B).
p484(A,B):-skip1(A,C),p484_1(C,B).
p484_1(A,B):-p654(A,C),p484_2(C,B).
p484_2(A,B):-copy1(A,C),p229(C,B).
p488(A,B):-p488_1(A,C),p5(C,B).
p488_1(A,B):-p120(A,C),skip1(C,B).
p488_1(A,B):-p5(A,C),p488_1(C,B).
...
p502(A,B):-p296(A,C),p502_1(C,B).
p502_1(A,B):-p550(A,C),p5(C,B).
p504(A,B):-p169(A,C),p504_1(C,B).
p504_1(A,B):-skip1(A,C),p337(C,B).
p507(A,B):-copy1(A,C),p507_1(C,B).
p507_1(A,B):-p20(A,C),p335(C,B).
p508(A,B):-p167(A,C),p508_1(C,B).
p508_1(A,B):-mk_uppercase(A,C),p508_2(C,B).
p508_2(A,B):-mk_uppercase(A,C),p34(C,B).
...
p521_2(A,B):-p692(A,C),p97(C,B).
p523(A,B):-skip1(A,C),p523_1(C,B).
p523_1(A,B):-p296(A,C),p397(C,B).
p533(A,B):-mk_lowercase(A,C),p533_1(C,B).
p533_1(A,B):-p447(A,C),p229(C,B).
...
p546_1(A,B):-mk_uppercase(A,C),p546_1(C,B).
...
p567_1(A,B):-p357(A,C),p5(C,B).
p567_1(A,B):-mk_uppercase(A,C),p567_1(C,B).
...
p581(A,B):-p139(A,C),p581_1(C,B).
p581_1(A,B):-skip1(A,C),p37(C,B).
p582(A,B):-p35(A,C),p27(C,B).
p583(A,B):-p5(A,C),p583_1(C,B).
p583_1(A,B):-p306(A,C),p5(C,B).
...
p696(A,B):-p142(A,C),p696_1(C,B).
p696_1(A,B):-p306(A,C),p696_2(C,B).
p696_2(A,B):-p296(A,C),p17(C,B).
p700(A,B):-p648(A,C),p3(C,B).
p705(A,B):-copy1(A,C),p169(C,B).
p708(A,B):-p532(A,C),p235(C,B).
...
p718_1(A,B):-mk_lowercase(A,C),p791(C,B).
p723(A,B):-p142(A,C),p88(C,B).
p725(A,B):-copy1(A,C),p725_1(C,B).
p725_1(A,B):-p20(A,C),p725_2(C,B).
p725_2(A,B):-p146(A,C),p142(C,B).
...
p730_1(A,B):-p5(A,C),p730_2(C,B).
p730_2(A,B):-p35(A,C),mk_uppercase(C,B).
...
p796(A,B):-p648(A,C),p796_1(C,B).
p796_1(A,B):-skip1(A,C),p5(C,B).
...
b304_1(A,B):-not_empty(A),p96(A,B).
b304_1(A,B):-p218(A,C),b304_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b78(A,B):-p704(A,B),is_uppercase(B).
b78(A,B):-p5(A,C),b78(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b309(A,B):-p33(A,C),p5(C,B).
%timeout
b241(A,B):-p3(A,C),b241_1(C,B).
b241_1(A,B):-skip1(A,C),p3(C,B).
%timeout
...
%timeout
%timeout
b224(A,B):-p35(A,C),b224_1(C,B).
b224_1(A,B):-p96(A,C),mk_uppercase(C,B).
%timeout
...
%timeout
%timeout
b149(A,B):-p392(A,C),b149_1(C,B).
b149_1(A,B):-not_number(A),p5(A,B).
b149_1(A,B):-p5(A,C),b149_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p35(A,B),is_uppercase(B).

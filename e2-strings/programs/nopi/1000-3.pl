...
p26_1(A,B):-p417(A,C),p26_2(C,B).
p26_2(A,B):-skip1(A,C),p87(C,B).
...
p42(A,B):-p13(A,C),p42_1(C,B).
p42_1(A,B):-p768(A,C),p142(C,B).
p43(A,B):-p258(A,C),p113(C,B).
p44(A,B):-p768(A,C),p502(C,B).
p45(A,B):-copy1(A,C),p45_1(C,B).
p45_1(A,B):-p142(A,C),p122(C,B).
...
p54_1(A,B):-p86(A,C),p54_2(C,B).
p54_2(A,B):-p755(A,C),mk_uppercase(C,B).
p55(A,B):-copy1(A,C),p55_1(C,B).
p55_1(A,B):-p28(A,C),p140(C,B).
p56(A,B):-p29(A,C),p56_1(C,B).
p56_1(A,B):-p13(A,C),p140(C,B).
p59(A,B):-p443(A,C),p59_1(C,B).
p59_1(A,B):-skip1(A,C),p300(C,B).
p60(A,B):-p121(A,C),p509(C,B).
p62(A,B):-copy1(A,C),p62_1(C,B).
p62_1(A,B):-p559(A,C),p558(C,B).
p63(A,B):-mk_lowercase(A,C),p63_1(C,B).
p63_1(A,B):-p424(A,C),copy1(C,B).
p64(A,B):-mk_lowercase(A,C),p64_1(C,B).
p64_1(A,B):-p590(A,C),p64_2(C,B).
p64_2(A,B):-skip1(A,C),p116(C,B).
...
p160(A,B):-p133(A,C),p160_1(C,B).
p160_1(A,B):-p755(A,C),copy1(C,B).
...
p205_1(A,B):-p768(A,C),mk_uppercase(C,B).
p211(A,B):-skip1(A,C),p211_1(C,B).
p211_1(A,B):-p116(A,C),p295(C,B).
p213(A,B):-p13(A,C),p213_1(C,B).
p213_1(A,B):-p29(A,C),p213_2(C,B).
p213_2(A,B):-p510(A,C),p13(C,B).
...
p278(A,B):-p27(A,C),p278_1(C,B).
p278_1(A,B):-p22(A,C),p122(C,B).
...
p290(A,B):-p131(A,C),p290_1(C,B).
p290_1(A,B):-p128(A,C),p202(C,B).
p292(A,B):-p326(A,C),p326(C,B).
p293(A,B):-p166(A,C),p515(C,B).
p294(A,B):-copy1(A,C),p294_1(C,B).
p294_1(A,B):-p3(A,C),p867(C,B).
p299(A,B):-p202(A,C),p299_1(C,B).
p299_1(A,B):-skip1(A,C),p299_2(C,B).
p299_2(A,B):-p530(A,C),mk_uppercase(C,B).
p304(A,B):-p250(A,C),p304_1(C,B).
p304_1(A,B):-p10(A,C),p19(C,B).
p305(A,B):-p222(A,C),p116(C,B).
p306(A,B):-p987(A,C),mk_uppercase(C,B).
p307(A,B):-p651(A,C),p116(C,B).
...
p351_1(A,B):-skip1(A,C),p351_2(C,B).
p351_2(A,B):-p417(A,C),p66(C,B).
...
p444_1(A,B):-p629(A,C),p535(C,B).
p446(A,B):-copy1(A,C),p446_1(C,B).
p446_1(A,B):-p3(A,C),p609(C,B).
...
p456(A,B):-mk_lowercase(A,C),p456_1(C,B).
p456_1(A,B):-p859(A,C),p593(C,B).
...
p480_2(A,B):-p133(A,C),p535(C,B).
p481(A,B):-p867(A,C),p535(C,B).
...
p614_1(A,B):-p22(A,C),p614_2(C,B).
p614_2(A,B):-p609(A,C),p29(C,B).
...
p638(A,B):-p142(A,C),p638_1(C,B).
p638_1(A,B):-skip1(A,C),p87(C,B).
p639(A,B):-p97(A,C),p116(C,B).
p640(A,B):-p142(A,C),p640_1(C,B).
p640_1(A,B):-p214(A,C),p19(C,B).
p649(A,B):-skip1(A,C),p649_1(C,B).
p649_1(A,B):-p202(A,C),p232(C,B).
p650(A,B):-p29(A,C),p443(C,B).
p656(A,B):-p180(A,C),p133(C,B).
p658(A,B):-p35(A,C),p123(C,B).
p661(A,B):-p460(A,C),p1(C,B).
...
p684_1(A,B):-p3(A,C),p932(C,B).
p697(A,B):-p1(A,C),p697_1(C,B).
p697_1(A,B):-p222(A,C),p555(C,B).
...
p763(A,B):-p618(A,C),p763_1(C,B).
p763_1(A,B):-skip1(A,C),p116(C,B).
p765(A,B):-p38(A,C),p284(C,B).
p766(A,B):-mk_lowercase(A,C),p766_1(C,B).
p766_1(A,B):-p510(A,C),p766_2(C,B).
p766_2(A,B):-p66(A,C),p144(C,B).
p767(A,B):-skip1(A,C),p228(C,B).
p771(A,B):-mk_lowercase(A,C),p771_1(C,B).
p771_1(A,B):-p460(A,C),p1(C,B).
...
p801(A,B):-p142(A,C),p801_1(C,B).
p801_1(A,B):-p13(A,C),p122(C,B).
p802(A,B):-p1(A,C),p663(C,B).
p803(A,B):-p1(A,C),p872(C,B).
p806(A,B):-p517(A,C),p1(C,B).
...
p820(A,B):-p66(A,C),p820_1(C,B).
p820_1(A,B):-p202(A,C),p956(C,B).
...
p858_1(A,B):-p15(A,C),p651(C,B).
p864(A,B):-p29(A,C),p139(C,B).
p868(A,B):-skip1(A,C),p868_1(C,B).
p868_1(A,B):-p535(A,C),p101(C,B).
p869(A,B):-skip1(A,C),p869_1(C,B).
p869_1(A,B):-p178(A,C),p116(C,B).
p871(A,B):-skip1(A,C),p871_1(C,B).
p871_1(A,B):-p142(A,C),p187(C,B).
p873(A,B):-p66(A,C),p873_1(C,B).
p873_1(A,B):-skip1(A,C),p110(C,B).
...
p877_1(A,B):-p15(A,C),p651(C,B).
p879(A,B):-mk_lowercase(A,C),p879_1(C,B).
p879_1(A,B):-p34(A,C),p35(C,B).
p888(A,B):-p86(A,C),p888_1(C,B).
p888_1(A,B):-p365(A,C),mk_lowercase(C,B).
...
p898_1(A,B):-p13(A,C),p728(C,B).
p899(A,B):-p530(A,C),p22(C,B).
p905(A,B):-p66(A,C),p905_1(C,B).
p905_1(A,B):-p116(A,C),p10(C,B).
...
p923(A,B):-p652(A,C),p66(C,B).
p924(A,B):-skip1(A,C),p924_1(C,B).
p924_1(A,B):-p178(A,C),mk_lowercase(C,B).
...
p927_1(A,B):-p133(A,C),p927_2(C,B).
p927_2(A,B):-p535(A,C),p805(C,B).
...
p972_1(A,B):-p66(A,C),p510(C,B).
p977(A,B):-p35(A,C),p977_1(C,B).
p977_1(A,B):-p113(A,C),p66(C,B).
p978(A,B):-p139(A,C),p510(C,B).
p979(A,B):-p1(A,C),p979_1(C,B).
p979_1(A,B):-p182(A,C),p144(C,B).
p980(A,B):-p443(A,C),p142(C,B).
p984(A,B):-p142(A,C),p984_1(C,B).
p984_1(A,B):-p40(A,C),p15(C,B).
p985(A,B):-p295(A,C),p113(C,B).
p989(A,B):-skip1(A,C),p989_1(C,B).
p989_1(A,B):-p755(A,C),p133(C,B).
...
p31_2(A,B):-p122(A,C),mk_uppercase(C,B).
p339(A,B):-p301(A,C),p339_1(C,B).
p339_1(A,B):-p243(A,C),p339_2(C,B).
p339_2(A,B):-skip1(A,C),p38(C,B).
...
b63(A,B):-p779(A,C),b63_1(C,B).
b63_1(A,B):-skip1(A,C),p517(C,B).
%timeout

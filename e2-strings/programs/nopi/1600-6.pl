...
p6(A,B):-p430(A,C),p131(C,B).
p8(A,B):-copy1(A,C),p8_1(C,B).
p8_1(A,B):-p16(A,C),p3(C,B).
...
p76_1(A,B):-p9(A,C),mk_lowercase(C,B).
p80(A,B):-skip1(A,C),p80_1(C,B).
p80_1(A,B):-p16(A,C),p147(C,B).
...
p103_1(A,B):-p985(A,C),p702(C,B).
p105(A,B):-p653(A,C),p588(C,B).
p107(A,B):-mk_lowercase(A,C),p107_1(C,B).
p107_1(A,B):-p16(A,C),p717(C,B).
p108(A,B):-p992(A,C),p108_1(C,B).
p108_1(A,B):-p144(A,C),p149(C,B).
...
p130_1(A,B):-p44(A,C),p579(C,B).
p132(A,B):-copy1(A,C),p132_1(C,B).
p132_1(A,B):-p58(A,C),p74(C,B).
...
p152_1(A,B):-p662(A,C),p152_2(C,B).
p152_2(A,B):-skip1(A,C),p144(C,B).
...
p163_1(A,B):-p22(A,C),p992(C,B).
p169(A,B):-mk_lowercase(A,C),p169_1(C,B).
p169_1(A,B):-p842(A,C),p45(C,B).
...
p181_1(A,B):-p280(A,C),p342(C,B).
p184(A,B):-mk_lowercase(A,C),p184_1(C,B).
p184_1(A,B):-p992(A,C),p184_2(C,B).
p184_2(A,B):-skip1(A,C),p149(C,B).
...
p211_1(A,B):-p165(A,C),p740(C,B).
p215(A,B):-p112(A,C),p515(C,B).
p219(A,B):-skip1(A,C),p219_1(C,B).
p219_1(A,B):-p165(A,C),p149(C,B).
...
p324_1(A,B):-mk_lowercase(A,C),p985(C,B).
...
p365_1(A,B):-skip1(A,C),p372(C,B).
p367(A,B):-p1368(A,C),p45(C,B).
p376(A,B):-copy1(A,C),p376_1(C,B).
p376_1(A,B):-p514(A,C),p16(C,B).
...
p393(A,B):-mk_lowercase(A,C),p409(C,B).
p393(A,B):-p144(A,C),p393(C,B).
p394(A,B):-p58(A,C),p394_1(C,B).
p394_1(A,B):-p61(A,C),p950(C,B).
p396(A,B):-p9(A,C),p396_1(C,B).
p396_1(A,B):-p1451(A,C),p112(C,B).
...
p416(A,B):-p58(A,C),p416_1(C,B).
p416_1(A,B):-p1056(A,C),mk_uppercase(C,B).
...
p544(A,B):-p1278(A,C),p68(C,B).
p547(A,B):-p19(A,C),p900(C,B).
p549(A,B):-mk_uppercase(A,C),p549_1(C,B).
p549_1(A,B):-skip1(A,C),p947(C,B).
p550(A,B):-p515(A,C),p1133(C,B).
p553(A,B):-mk_lowercase(A,C),p553_1(C,B).
p553_1(A,B):-p208(A,C),p131(C,B).
p556(A,B):-mk_lowercase(A,C),p213(C,B).
p561(A,B):-p579(A,C),p702(C,B).
p562(A,B):-p165(A,C),p680(C,B).
p566(A,B):-p422(A,C),p43(C,B).
...
p576(A,B):-p55(A,C),p576_1(C,B).
p576_1(A,B):-p55(A,C),p171(C,B).
...
p592(A,B):-p252(A,C),p16(C,B).
p597(A,B):-p131(A,C),p842(C,B).
p598(A,B):-p16(A,C),p598_1(C,B).
p598_1(A,B):-p55(A,C),p136(C,B).
...
p603_1(A,B):-p947(A,C),mk_uppercase(C,B).
...
p634(A,B):-p192(A,C),p252(C,B).
p637(A,B):-p131(A,C),p1451(C,B).
p639(A,B):-p208(A,C),p639_1(C,B).
p639_1(A,B):-copy1(A,C),p58(C,B).
...
p872_2(A,B):-skip1(A,C),p514(C,B).
p874(A,B):-p165(A,C),p874_1(C,B).
p874_1(A,B):-p975(A,C),p283(C,B).
...
p892_1(A,B):-skip1(A,C),p476(C,B).
p893(A,B):-skip1(A,C),p237(C,B).
p894(A,B):-p16(A,C),p894_1(C,B).
p894_1(A,B):-skip1(A,C),p1374(C,B).
p896(A,B):-p1108(A,C),p55(C,B).
p897(A,B):-skip1(A,C),p897_1(C,B).
p897_1(A,B):-p44(A,C),p204(C,B).
p898(A,B):-p58(A,C),p267(C,B).
p899(A,B):-p192(A,C),p899_1(C,B).
p899_1(A,B):-p15(A,C),p2(C,B).
...
p911(A,B):-p19(A,C),p911_1(C,B).
p911_1(A,B):-p310(A,C),mk_uppercase(C,B).
p914(A,B):-copy1(A,C),p914_1(C,B).
p914_1(A,B):-p581(A,C),p204(C,B).
p919(A,B):-p27(A,C),p50(C,B).
...
p935(A,B):-p430(A,C),p476(C,B).
p941(A,B):-copy1(A,C),p941_1(C,B).
p941_1(A,B):-skip1(A,C),p202(C,B).
...
p958(A,B):-p212(A,C),p958_1(C,B).
p958_1(A,B):-p267(A,C),p131(C,B).
p961(A,B):-p895(A,C),p251(C,B).
p962(A,B):-p542(A,C),p457(C,B).
p964(A,B):-p19(A,C),p531(C,B).
p965(A,B):-p342(A,C),p567(C,B).
...
p993(A,B):-p730(A,C),p58(C,B).
p994(A,B):-p1043(A,C),p740(C,B).
p995(A,B):-p58(A,C),p995_1(C,B).
p995_1(A,B):-skip1(A,C),p1373(C,B).
p996(A,B):-p147(A,C),p996_1(C,B).
p996_1(A,B):-p703(A,C),p996_2(C,B).
p996_2(A,B):-skip1(A,C),p212(C,B).
p1001(A,B):-p1392(A,C),p579(C,B).
p1002(A,B):-p144(A,C),p149(C,B).
p1010(A,B):-skip1(A,C),p1010_1(C,B).
p1010_1(A,B):-p58(A,C),p514(C,B).
p1014(A,B):-skip1(A,C),p1014_1(C,B).
p1014_1(A,B):-p144(A,C),p1014_2(C,B).
p1014_2(A,B):-skip1(A,C),p567(C,B).
p1015(A,B):-p131(A,C),p1015_1(C,B).
p1015_1(A,B):-p702(A,C),p975(C,B).
p1017(A,B):-skip1(A,C),p12(C,B).
p1023(A,B):-skip1(A,C),p1023_1(C,B).
p1023_1(A,B):-p112(A,C),p171(C,B).
p1024(A,B):-skip1(A,C),p1024_1(C,B).
p1024_1(A,B):-p15(A,C),p1024_2(C,B).
p1024_2(A,B):-skip1(A,C),p374(C,B).
p1026(A,B):-p572(A,C),copy1(C,B).
p1033(A,B):-skip1(A,C),p1033_1(C,B).
p1033_1(A,B):-skip1(A,C),p241(C,B).
...
p1099(A,B):-p136(A,C),p1099_1(C,B).
p1099_1(A,B):-p16(A,C),p511(C,B).
p1100(A,B):-p192(A,C),p165(C,B).
p1103(A,B):-skip1(A,C),p1103_1(C,B).
p1103_1(A,B):-p176(A,C),p58(C,B).
p1104(A,B):-p563(A,C),p585(C,B).
p1107(A,B):-copy1(A,C),p1107_1(C,B).
p1107_1(A,B):-skip1(A,C),p567(C,B).
...
p1139(A,B):-p930(A,C),p1139_1(C,B).
p1139_1(A,B):-mk_lowercase(A,C),p515(C,B).
...
p1157(A,B):-p476(A,C),p1157_1(C,B).
p1157_1(A,B):-p572(A,C),p131(C,B).
p1159(A,B):-skip1(A,C),p1159_1(C,B).
p1159_1(A,B):-p45(A,C),p1118(C,B).
...
p1303_1(A,B):-p267(A,C),p1303_2(C,B).
p1303_2(A,B):-p131(A,C),p196(C,B).
...
p1342(A,B):-p167(A,C),p1342_1(C,B).
p1342_1(A,B):-copy1(A,C),p138(C,B).
p1344(A,B):-p313(A,C),mk_uppercase(C,B).
p1345(A,B):-mk_uppercase(A,C),p1345_1(C,B).
p1345_1(A,B):-is_lowercase(A),p1004(A,B).
p1345_1(A,B):-skip1(A,C),p1345_1(C,B).
p1346(A,B):-p515(A,C),p9(C,B).
p1348(A,B):-skip1(A,C),p1348_1(C,B).
p1348_1(A,B):-p112(A,C),p171(C,B).
...
p1358_1(A,B):-p991(A,C),p1358_2(C,B).
p1358_2(A,B):-skip1(A,C),p542(C,B).
...
p1369_1(A,B):-p476(A,C),p1369_2(C,B).
p1369_2(A,B):-p267(A,C),p55(C,B).
p1370(A,B):-p19(A,C),p196(C,B).
p1375(A,B):-p1169(A,C),p486(C,B).
...
p1406_1(A,B):-p401(A,C),mk_lowercase(C,B).
...
p1510(A,B):-p579(A,C),p950(C,B).
p1512(A,B):-p792(A,C),p662(C,B).
p1516(A,B):-p402(A,C),p1235(C,B).
p1517(A,B):-p422(A,C),p61(C,B).
p1518(A,B):-p1518_1(A,B),is_lowercase(B).
p1518_1(A,B):-p50(A,C),p1518_2(C,B).
p1518_2(A,B):-p267(A,C),p3(C,B).
p1522(A,B):-skip1(A,C),p1522_1(C,B).
p1522_1(A,B):-p16(A,C),p3(C,B).
...
p1533(A,B):-p1422(A,C),p1533_1(C,B).
p1533_1(A,B):-p55(A,C),p112(C,B).
p1534(A,B):-p251(A,C),p52(C,B).
p1538(A,B):-p58(A,C),p1538_1(C,B).
p1538_1(A,B):-skip1(A,C),p1538_2(C,B).
p1538_2(A,B):-skip1(A,C),p486(C,B).
p1540(A,B):-p131(A,C),p1540_1(C,B).
p1540_1(A,B):-p45(A,C),p1540_2(C,B).
...
p1566(A,B):-p267(A,C),p1566_1(C,B).
p1566_1(A,B):-p204(A,C),p55(C,B).
...
p1232_1(A,B):-p9(A,C),p158(C,B).
p1491(A,B):-p1491_1(A,B),is_uppercase(B).
p1491_1(A,B):-p267(A,C),p191(C,B).
p1529(A,B):-p191(A,C),p985(C,B).
p1539(A,B):-p80(A,C),copy1(C,B).
...
p1578_1(A,B):-p567(A,C),p1578_2(C,B).
p1578_2(A,B):-mk_lowercase(A,C),p58(C,B).
% asserting p83/2
% asserting p84/2
% asserting p140/2
% asserting p150/2
...
%timeout
%timeout
b249(A,B):-p947(A,C),b249_1(C,B).
b249_1(A,B):-skip1(A,C),p16(C,B).
b249_1(A,B):-is_number(A),p947(A,B).
%timeout
...
b186_1(A,B):-p1299(A,C),b186_2(C,B).
b186_2(A,B):-skip1(A,C),p16(C,B).
%timeout
%timeout
%timeout
%timeout
...
b120_1(A,B):-p1299(A,C),b120_2(C,B).
b120_2(A,B):-skip1(A,C),p16(C,B).
%timeout
%timeout
%timeout
%timeout

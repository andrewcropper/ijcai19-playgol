...
p183(A,B):-p552(A,C),p183_1(C,B).
p183_1(A,B):-p399(A,C),p472(C,B).
...
p204(A,B):-p969(A,C),p1(C,B).
p208(A,B):-p1(A,C),p611(C,B).
p215(A,B):-p71(A,C),p61(C,B).
...
p255_1(A,B):-p1729(A,C),p1187(C,B).
p256(A,B):-p1362(A,C),p399(C,B).
p258(A,B):-p49(A,C),p258_1(C,B).
p258_1(A,B):-p35(A,C),p472(C,B).
...
p338(A,B):-p513(A,C),p338_1(C,B).
p338_1(A,B):-p89(A,C),p481(C,B).
p339(A,B):-mk_lowercase(A,C),p339_1(C,B).
p339_1(A,B):-p1588(A,C),p167(C,B).
p341(A,B):-p135(A,C),p14(C,B).
p344(A,B):-p1(A,C),p1280(C,B).
p345(A,B):-mk_uppercase(A,C),p345_1(C,B).
p345_1(A,B):-p1009(A,C),p399(C,B).
p349(A,B):-p147(A,C),p51(C,B).
p350(A,B):-copy1(A,C),p350_1(C,B).
p350_1(A,B):-p552(A,C),p513(C,B).
p357(A,B):-p956(A,C),p614(C,B).
p358(A,B):-p771(A,C),p125(C,B).
p359(A,B):-skip1(A,C),p359_1(C,B).
p359_1(A,B):-p125(A,C),p359_2(C,B).
p359_2(A,B):-skip1(A,C),p509(C,B).
p360(A,B):-skip1(A,C),p31(C,B).
p362(A,B):-p187(A,C),p362_1(C,B).
p362_1(A,B):-p6(A,C),p546(C,B).
p363(A,B):-p125(A,C),p363_1(C,B).
p363_1(A,B):-skip1(A,C),p611(C,B).
p364(A,B):-mk_lowercase(A,C),p893(C,B).
p366(A,B):-skip1(A,C),p366_1(C,B).
p366_1(A,B):-skip1(A,C),p509(C,B).
p367(A,B):-p777(A,C),p367_1(C,B).
p367_1(A,B):-mk_lowercase(A,C),p116(C,B).
...
p381(A,B):-p100(A,C),p381_1(C,B).
p381_1(A,B):-p187(A,C),p2(C,B).
...
p607(A,B):-p1187(A,C),p607_1(C,B).
p607_1(A,B):-p1266(A,C),p83(C,B).
p609(A,B):-copy1(A,C),p609_1(C,B).
p609_1(A,B):-skip1(A,C),p734(C,B).
p610(A,B):-copy1(A,C),p610_1(C,B).
p610_1(A,B):-p1085(A,C),p5(C,B).
p618(A,B):-p618_1(A,B),is_empty(B).
p618_1(A,B):-p772(A,C),mk_uppercase(C,B).
p618_1(A,B):-p55(A,C),p618_1(C,B).
...
p651_1(A,B):-p772(A,C),p6(C,B).
p653(A,B):-skip1(A,C),p653_1(C,B).
p653_1(A,B):-p552(A,C),p125(C,B).
p655(A,B):-mk_lowercase(A,C),p655_1(C,B).
p655_1(A,B):-p163(A,C),p655_2(C,B).
p655_2(A,B):-p83(A,C),p557(C,B).
...
p743_1(A,B):-p252(A,C),p83(C,B).
p751(A,B):-p614(A,C),p1085(C,B).
p753(A,B):-p879(A,C),p343(C,B).
p754(A,B):-skip1(A,C),p754_1(C,B).
p754_1(A,B):-p6(A,C),p167(C,B).
p757(A,B):-p83(A,C),p757_1(C,B).
p757_1(A,B):-p557(A,C),p167(C,B).
...
p788(A,B):-p125(A,C),p788_1(C,B).
p788_1(A,B):-skip1(A,C),p5(C,B).
...
p796_1(A,B):-p187(A,C),p974(C,B).
p798(A,B):-p889(A,C),p49(C,B).
p801(A,B):-p1196(A,C),p399(C,B).
p805(A,B):-skip1(A,C),p805_1(C,B).
p805_1(A,B):-p272(A,C),p40(C,B).
p806(A,B):-mk_lowercase(A,C),p514(C,B).
p808(A,B):-mk_uppercase(A,C),p808_1(C,B).
p808_1(A,B):-skip1(A,C),p808_2(C,B).
p808_2(A,B):-p560(A,C),p187(C,B).
p818(A,B):-p125(A,C),p441(C,B).
p820(A,B):-p1(A,C),p820_1(C,B).
p820_1(A,B):-skip1(A,C),p820_2(C,B).
p820_2(A,B):-p5(A,C),p173(C,B).
p822(A,B):-skip1(A,C),p822_1(C,B).
p822_1(A,B):-p1(A,C),p135(C,B).
...
p844(A,B):-p2(A,C),p844_1(C,B).
p844_1(A,B):-skip1(A,C),p23(C,B).
...
p856(A,B):-p1266(A,C),p856_1(C,B).
p856_1(A,B):-p1(A,C),p233(C,B).
p863(A,B):-copy1(A,C),p863_1(C,B).
p863_1(A,B):-p1776(A,C),p274(C,B).
p864(A,B):-p71(A,C),p895(C,B).
p867(A,B):-p36(A,C),p867_1(C,B).
p867_1(A,B):-p624(A,C),mk_lowercase(C,B).
...
p931(A,B):-p125(A,C),p931_1(C,B).
p931_1(A,B):-skip1(A,C),p5(C,B).
p933(A,B):-p1(A,C),p1197(C,B).
p934(A,B):-p1429(A,C),p934_1(C,B).
p934_1(A,B):-mk_uppercase(A,C),p5(C,B).
p937(A,B):-skip1(A,C),p190(C,B).
p938(A,B):-p5(A,C),p1082(C,B).
p939(A,B):-mk_lowercase(A,C),p939_1(C,B).
p939_1(A,B):-p744(A,C),mk_uppercase(C,B).
...
p947_1(A,B):-p163(A,C),p83(C,B).
p949(A,B):-p83(A,C),p949_1(C,B).
p949_1(A,B):-skip1(A,C),p509(C,B).
p950(A,B):-p71(A,C),p135(C,B).
p952(A,B):-copy1(A,C),p952_1(C,B).
p952_1(A,B):-skip1(A,C),p952_2(C,B).
p952_2(A,B):-skip1(A,C),p930(C,B).
...
p966(A,B):-p514(A,C),p36(C,B).
p968(A,B):-skip1(A,C),p968_1(C,B).
p968_1(A,B):-p353(A,C),p149(C,B).
p970(A,B):-p970_1(A,B),not_empty(B).
p970_1(A,B):-p1386(A,C),p1425(C,B).
p972(A,B):-p41(A,C),p677(C,B).
p975(A,B):-p889(A,C),copy1(C,B).
p976(A,B):-skip1(A,C),p976_1(C,B).
p976_1(A,B):-skip1(A,C),p893(C,B).
p977(A,B):-p35(A,C),p572(C,B).
p980(A,B):-skip1(A,C),p980_1(C,B).
p980_1(A,B):-p1(A,C),p572(C,B).
...
p1016(A,B):-p513(A,C),p1016_1(C,B).
p1016_1(A,B):-p875(A,C),p125(C,B).
...
p1049_1(A,B):-p777(A,C),mk_uppercase(C,B).
p1049_1(A,B):-skip1(A,C),p1049_1(C,B).
...
p1063(A,B):-p442(A,C),p1063_1(C,B).
p1063_1(A,B):-p481(A,C),p29(C,B).
...
p1172_1(A,B):-p10(A,C),p873(C,B).
p1173(A,B):-p1003(A,C),p744(C,B).
p1175(A,B):-copy1(A,C),p1175_1(C,B).
p1175_1(A,B):-p125(A,C),p611(C,B).
p1180(A,B):-p272(A,C),p21(C,B).
p1182(A,B):-p441(A,C),p29(C,B).
p1185(A,B):-p472(A,C),p514(C,B).
p1188(A,B):-skip1(A,C),p1188_1(C,B).
p1188_1(A,B):-p1(A,C),p1776(C,B).
p1189(A,B):-skip1(A,C),p1189_1(C,B).
p1189_1(A,B):-p370(A,C),p677(C,B).
p1190(A,B):-p399(A,C),p1196(C,B).
p1191(A,B):-p1362(A,C),p1191_1(C,B).
p1191_1(A,B):-p514(A,C),mk_uppercase(C,B).
p1192(A,B):-p472(A,C),p1192_1(C,B).
p1192_1(A,B):-skip1(A,C),p135(C,B).
p1193(A,B):-p893(A,C),p1280(C,B).
p1198(A,B):-p1198_1(A,B),not_letter(B).
p1198_1(A,B):-p122(A,C),copy1(C,B).
p1198_1(A,B):-skip1(A,C),p1198_1(C,B).
...
p1245_1(A,B):-p1(A,C),p1729(C,B).
p1246(A,B):-p167(A,C),p1246_1(C,B).
p1246_1(A,B):-p10(A,C),p875(C,B).
p1250(A,B):-skip1(A,C),p1250_1(C,B).
p1250_1(A,B):-p29(A,C),p274(C,B).
p1253(A,B):-p83(A,C),p1253_1(C,B).
p1253_1(A,B):-p633(A,C),p5(C,B).
p1254(A,B):-mk_uppercase(A,C),p1254_1(C,B).
p1254_1(A,B):-p35(A,C),p178(C,B).
...
p1259(A,B):-p552(A,C),p125(C,B).
p1260(A,B):-p715(A,C),p771(C,B).
p1261(A,B):-p513(A,C),p337(C,B).
p1263(A,B):-p55(A,C),p1263_1(C,B).
p1263_1(A,B):-skip1(A,C),p794(C,B).
p1268(A,B):-p144(A,C),p135(C,B).
p1269(A,B):-skip1(A,C),p560(C,B).
p1271(A,B):-p83(A,C),p1646(C,B).
p1272(A,B):-p552(A,C),p1121(C,B).
...
p1421(A,B):-p49(A,C),p1421_1(C,B).
p1421_1(A,B):-p6(A,C),p5(C,B).
...
p1450(A,B):-p125(A,C),p1450_1(C,B).
p1450_1(A,B):-skip1(A,C),p5(C,B).
...
p1471(A,B):-p6(A,C),p1471_1(C,B).
p1471_1(A,B):-p1444(A,C),p125(C,B).
...
p1505(A,B):-p696(A,C),p21(C,B).
p1506(A,B):-p125(A,C),p611(C,B).
p1510(A,B):-p752(A,C),p125(C,B).
p1512(A,B):-skip1(A,C),p1512_1(C,B).
p1512_1(A,B):-p1(A,C),p21(C,B).
p1514(A,B):-copy1(A,C),p1514_1(C,B).
p1514_1(A,B):-p125(A,C),p178(C,B).
...
p1605(A,B):-p55(A,C),p1605_1(C,B).
p1605_1(A,B):-p163(A,C),p6(C,B).
p1609(A,B):-p272(A,C),p1609_1(C,B).
p1609_1(A,B):-p1109(A,C),mk_lowercase(C,B).
...
p1634_1(A,B):-p1529(A,C),p116(C,B).
p1636(A,B):-p1768(A,C),p54(C,B).
...
p1732_1(A,B):-skip1(A,C),p178(C,B).
p1735(A,B):-p274(A,C),p274(C,B).
p1738(A,B):-p135(A,C),p509(C,B).
p1741(A,B):-p89(A,C),p1741_1(C,B).
p1741_1(A,B):-skip1(A,C),p23(C,B).
p1742(A,B):-copy1(A,C),p42(C,B).
p1743(A,B):-p173(A,C),p926(C,B).
p1744(A,B):-copy1(A,C),p1744_1(C,B).
p1744_1(A,B):-p252(A,C),mk_lowercase(C,B).
p1747(A,B):-skip1(A,C),p1747_1(C,B).
p1747_1(A,B):-p1(A,C),p1539(C,B).
p1751(A,B):-p29(A,C),p771(C,B).
p1752(A,B):-skip1(A,C),p1752_1(C,B).
p1752_1(A,B):-skip1(A,C),p1105(C,B).
p1757(A,B):-p889(A,C),mk_lowercase(C,B).
p1759(A,B):-p40(A,C),p135(C,B).
p1760(A,B):-skip1(A,C),p1760_1(C,B).
p1760_1(A,B):-p5(A,C),p147(C,B).
...
p1774(A,B):-p443(A,C),mk_lowercase(C,B).
p1775(A,B):-p161(A,C),p167(C,B).
p1777(A,B):-p5(A,C),p1777_1(C,B).
p1777_1(A,B):-p135(A,C),p1530(C,B).
p1778(A,B):-p552(A,C),p29(C,B).
p1779(A,B):-p272(A,C),p1776(C,B).
...
p1789_1(A,B):-p135(A,C),p1280(C,B).
p1790(A,B):-p11(A,C),p1790_1(C,B).
p1790_1(A,B):-p149(A,C),p513(C,B).
p1791(A,B):-p570(A,C),p1121(C,B).
p1792(A,B):-p570(A,C),p1521(C,B).
...
b307_1(A,B):-p83(A,C),skip1(C,B).
b238(A,B):-p455(A,C),b238_1(C,B).
...
b98_1(A,B):-not_letter(A),p83(A,B).

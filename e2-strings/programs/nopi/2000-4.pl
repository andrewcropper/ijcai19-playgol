...
p175(A,B):-p79(A,C),p33(C,B).
p175(A,B):-skip1(A,C),p175(C,B).
...
p27(A,B):-p539(A,C),p40(C,B).
p28(A,B):-p140(A,C),p335(C,B).
p30(A,B):-p1805(A,C),copy1(C,B).
...
p58(A,B):-p114(A,C),p322(C,B).
p59(A,B):-copy1(A,C),p59_1(C,B).
p59_1(A,B):-p555(A,C),p426(C,B).
...
p77(A,B):-p12(A,C),p77_1(C,B).
p77_1(A,B):-p562(A,C),p1795(C,B).
...
p105_1(A,B):-p114(A,C),p49(C,B).
p106(A,B):-p335(A,C),p152(C,B).
...
p145(A,B):-p255(A,C),p145_1(C,B).
p145_1(A,B):-p114(A,C),p1051(C,B).
p148(A,B):-p97(A,C),p1057(C,B).
p150(A,B):-p1(A,C),p1051(C,B).
p154(A,B):-p606(A,C),p114(C,B).
...
p237(A,B):-p114(A,C),p252(C,B).
p238(A,B):-p15(A,C),p464(C,B).
p239(A,B):-p1222(A,C),p239_1(C,B).
p239_1(A,B):-skip1(A,C),p272(C,B).
p241(A,B):-copy1(A,C),p241_1(C,B).
p241_1(A,B):-p1115(A,C),p218(C,B).
p242(A,B):-p242_1(A,B),is_lowercase(B).
p242_1(A,B):-mk_uppercase(A,C),p242_2(C,B).
p242_2(A,B):-p18(A,C),p908(C,B).
p250(A,B):-skip1(A,C),p1535(C,B).
p251(A,B):-p19(A,C),p251_1(C,B).
p251_1(A,B):-p178(A,C),mk_uppercase(C,B).
...
p290_1(A,B):-p179(A,C),mk_uppercase(C,B).
...
p308(A,B):-p255(A,C),p308_1(C,B).
p308_1(A,B):-p79(A,C),p218(C,B).
...
p332(A,B):-p1805(A,C),p40(C,B).
p336(A,B):-is_number(A),p568(A,B).
...
p345(A,B):-p1979(A,C),p40(C,B).
p354(A,B):-skip1(A,C),p354_1(C,B).
p354_1(A,B):-p83(A,C),mk_lowercase(C,B).
p356(A,B):-skip1(A,C),p356_1(C,B).
p356_1(A,B):-p1018(A,C),copy1(C,B).
...
p376(A,B):-p51(A,C),p376_1(C,B).
p376_1(A,B):-p399(A,C),p1637(C,B).
p383(A,B):-p97(A,C),p383_1(C,B).
p383_1(A,B):-p255(A,C),p1719(C,B).
p384(A,B):-copy1(A,C),p1107(C,B).
p389(A,B):-p218(A,C),p389_1(C,B).
p389_1(A,B):-p152(A,C),p11(C,B).
p391(A,B):-p187(A,C),p1794(C,B).
p393(A,B):-p255(A,C),p393_1(C,B).
p393_1(A,B):-p426(A,C),p821(C,B).
...
p458_1(A,B):-mk_uppercase(A,C),p458_2(C,B).
p458_2(A,B):-p544(A,C),copy1(C,B).
...
p470_1(A,B):-p426(A,C),p85(C,B).
p483(A,B):-skip1(A,C),p483_1(C,B).
p483_1(A,B):-p1648(A,C),p483_2(C,B).
p483_2(A,B):-skip1(A,C),p525(C,B).
...
p549_1(A,B):-p81(A,C),mk_uppercase(C,B).
...
p572(A,B):-p136(A,C),p572_1(C,B).
p572_1(A,B):-p770(A,C),copy1(C,B).
...
p680(A,B):-p53(A,C),p734(C,B).
p681(A,B):-p908(A,C),p681_1(C,B).
p681_1(A,B):-p491(A,C),p399(C,B).
...
p710(A,B):-p40(A,C),p710_1(C,B).
p710_1(A,B):-p634(A,C),p426(C,B).
p712(A,B):-p92(A,C),p452(C,B).
p714(A,B):-p903(A,C),p1(C,B).
...
p735(A,B):-p426(A,C),p49(C,B).
p736(A,B):-p21(A,C),p121(C,B).
p745(A,B):-mk_uppercase(A,C),p745_1(C,B).
p745_1(A,B):-p555(A,C),p534(C,B).
p746(A,B):-p1811(A,C),p746_1(C,B).
p746_1(A,B):-p848(A,C),p525(C,B).
p747(A,B):-p57(A,C),p1805(C,B).
p748(A,B):-p485(A,C),p748_1(C,B).
p748_1(A,B):-mk_uppercase(A,C),p748_2(C,B).
...
p874(A,B):-p335(A,C),p253(C,B).
p875(A,B):-mk_lowercase(A,C),p875_1(C,B).
p875_1(A,B):-p399(A,C),p1493(C,B).
...
p926_1(A,B):-p187(A,C),p926_2(C,B).
p926_2(A,B):-skip1(A,C),p525(C,B).
...
p1017_1(A,B):-p1336(A,C),p114(C,B).
...
p1050(A,B):-p544(A,C),p1050_1(C,B).
p1050_1(A,B):-skip1(A,C),p525(C,B).
p1054(A,B):-p586(A,C),p1054_1(C,B).
p1054_1(A,B):-p21(A,C),p114(C,B).
...
p1190_1(A,B):-p1237(A,C),copy1(C,B).
p1191(A,B):-p114(A,C),p1191_1(C,B).
p1191_1(A,B):-p602(A,C),mk_uppercase(C,B).
p1194(A,B):-p340(A,C),p40(C,B).
p1198(A,B):-p491(A,C),p1198_1(C,B).
p1198_1(A,B):-p206(A,C),p14(C,B).
...
p1255_1(A,B):-p831(A,C),copy1(C,B).
...
p1292_1(A,B):-p114(A,C),p1295(C,B).
p1293(A,B):-p1057(A,C),p152(C,B).
p1294(A,B):-p1648(A,C),p1294_1(C,B).
p1294_1(A,B):-p525(A,C),p491(C,B).
...
p1337(A,B):-p114(A,C),p1337_1(C,B).
p1337_1(A,B):-p908(A,C),p40(C,B).
...
p1376_1(A,B):-skip1(A,C),p104(C,B).
p1379(A,B):-p102(A,C),p1379_1(C,B).
p1379_1(A,B):-skip1(A,C),p436(C,B).
p1381(A,B):-p57(A,C),p1267(C,B).
p1384(A,B):-p1075(A,C),copy1(C,B).
p1386(A,B):-p114(A,C),p1386_1(C,B).
p1386_1(A,B):-p1043(A,C),p54(C,B).
...
p1434_1(A,B):-p1702(A,C),p218(C,B).
...
p1463(A,B):-p272(A,C),p1463_1(C,B).
p1463_1(A,B):-skip1(A,C),p1795(C,B).
...
p1472_1(A,B):-p770(A,C),p1472_2(C,B).
p1472_2(A,B):-copy1(A,C),p335(C,B).
...
p1531(A,B):-p53(A,C),p1531_1(C,B).
p1531_1(A,B):-skip1(A,C),p1059(C,B).
p1532(A,B):-p92(A,C),p1267(C,B).
p1533(A,B):-mk_uppercase(A,C),p121(C,B).
p1534(A,B):-skip1(A,C),p2(C,B).
p1536(A,B):-p9(A,C),p882(C,B).
p1540(A,B):-p175(A,C),p1650(C,B).
p1544(A,B):-p525(A,C),p1544_1(C,B).
p1544_1(A,B):-p228(A,C),copy1(C,B).
p1546(A,B):-mk_lowercase(A,C),p1546_1(C,B).
p1546_1(A,B):-p534(A,C),p9(C,B).
...
p1555_1(A,B):-p114(A,C),p121(C,B).
p1556(A,B):-p247(A,C),p1556_1(C,B).
p1556_1(A,B):-skip1(A,C),p19(C,B).
p1557(A,B):-p12(A,C),p92(C,B).
p1558(A,B):-p187(A,C),p1558_1(C,B).
p1558_1(A,B):-p1537(A,C),copy1(C,B).
...
p1670(A,B):-p51(A,C),p1670_1(C,B).
p1670_1(A,B):-p140(A,C),p19(C,B).
p1671(A,B):-p85(A,C),p121(C,B).
p1674(A,B):-p53(A,C),p1336(C,B).
p1675(A,B):-skip1(A,C),p1675_1(C,B).
p1675_1(A,B):-skip1(A,C),p219(C,B).
...
p1707(A,B):-mk_uppercase(A,C),p1707_1(C,B).
p1707_1(A,B):-p1648(A,C),p40(C,B).
p1710(A,B):-p544(A,C),p525(C,B).
p1711(A,B):-p40(A,C),p1428(C,B).
p1714(A,B):-copy1(A,C),p1714_1(C,B).
p1714_1(A,B):-p809(A,C),p1028(C,B).
p1720(A,B):-copy1(A,C),p219(C,B).
p1721(A,B):-p1940(A,C),p1721_1(C,B).
p1721_1(A,B):-p562(A,C),p491(C,B).
...
p1796(A,B):-p33(A,C),p1796_1(C,B).
p1796_1(A,B):-p809(A,C),p1903(C,B).
...
p1806(A,B):-p15(A,C),p1806_1(C,B).
p1806_1(A,B):-skip1(A,C),p179(C,B).
...
p1813(A,B):-p33(A,C),p1813_1(C,B).
p1813_1(A,B):-p17(A,C),p54(C,B).
p1816(A,B):-p335(A,C),p1816_1(C,B).
p1816_1(A,B):-mk_uppercase(A,C),p85(C,B).
p1817(A,B):-p53(A,C),p568(C,B).
p1819(A,B):-p114(A,C),p1819_1(C,B).
p1819_1(A,B):-p696(A,C),p426(C,B).
p1822(A,B):-p482(A,C),p534(C,B).
p1825(A,B):-p525(A,C),p1825_1(C,B).
p1825_1(A,B):-p1944(A,C),p187(C,B).
...
p1917(A,B):-p1(A,C),p1917_1(C,B).
p1917_1(A,B):-skip1(A,C),p1455(C,B).
...
p1959_1(A,B):-skip1(A,C),p1959_2(C,B).
p1959_2(A,B):-skip1(A,C),p975(C,B).
...
p1980(A,B):-p54(A,C),p1980_1(C,B).
p1980_1(A,B):-skip1(A,C),p49(C,B).
...
p1990(A,B):-p114(A,C),p1990_1(C,B).
p1990_1(A,B):-p1853(A,C),mk_uppercase(C,B).
...
p2000_1(A,B):-skip1(A,C),p1059(C,B).
% asserting p5/2
% asserting p7/2
% asserting p8/2
% asserting p13/2
...
p542_1(A,B):-skip1(A,C),p542_2(C,B).
p542_2(A,B):-skip1(A,C),p304(C,B).
...
p1362(A,B):-copy1(A,C),p1407(C,B).
p1491(A,B):-skip1(A,C),p1491_1(C,B).
p1491_1(A,B):-p1034(A,C),mk_uppercase(C,B).
% asserting p45/2
% asserting p288/2
% asserting p536/2
% asserting p542/2
...
%timeout
%timeout
b326(A,B):-p1573(A,C),p9(C,B).
b326(A,B):-b326_1(A,B),is_lowercase(B).
b326_1(A,B):-p1573(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout

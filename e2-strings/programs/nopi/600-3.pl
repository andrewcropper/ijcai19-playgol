...
p28_1(A,B):-p22(A,C),p75(C,B).
p32(A,B):-p22(A,C),p32_1(C,B).
p32_1(A,B):-p558(A,C),p32_2(C,B).
p32_2(A,B):-mk_uppercase(A,C),p15(C,B).
...
p97_1(A,B):-p153(A,C),p97_2(C,B).
p97_2(A,B):-p42(A,C),p63(C,B).
...
p170_1(A,B):-p351(A,C),p170_2(C,B).
p170_2(A,B):-skip1(A,C),p13(C,B).
p173(A,B):-p160(A,C),p15(C,B).
p176(A,B):-p39(A,C),p176_1(C,B).
p176_1(A,B):-mk_lowercase(A,C),p316(C,B).
p177(A,B):-p329(A,C),mk_uppercase(C,B).
p177(A,B):-skip1(A,C),p177(C,B).
p178(A,B):-copy1(A,C),p178_1(C,B).
p178_1(A,B):-p124(A,C),p178_2(C,B).
p178_2(A,B):-mk_lowercase(A,C),p12(C,B).
p179(A,B):-p13(A,C),p179_1(C,B).
p179_1(A,B):-p153(A,C),p179_2(C,B).
p179_2(A,B):-p111(A,C),p189(C,B).
p180(A,B):-copy1(A,C),p7(C,B).
p181(A,B):-copy1(A,C),p181_1(C,B).
p181_1(A,B):-p22(A,C),p570(C,B).
...
p236_1(A,B):-p63(A,C),p236_2(C,B).
p236_2(A,B):-skip1(A,C),p47(C,B).
p238(A,B):-mk_uppercase(A,C),p376(C,B).
p245(A,B):-skip1(A,C),p245_1(C,B).
p245_1(A,B):-p15(A,C),p245_2(C,B).
p245_2(A,B):-p225(A,C),p580(C,B).
p247(A,B):-skip1(A,C),p247_1(C,B).
p247_1(A,B):-p7(A,C),p15(C,B).
p249(A,B):-p316(A,C),p63(C,B).
p252(A,B):-p15(A,C),p252_1(C,B).
p252_1(A,B):-p378(A,C),p252_2(C,B).
p252_2(A,B):-skip1(A,C),p13(C,B).
p255(A,B):-skip1(A,C),p255_1(C,B).
p255_1(A,B):-p15(A,C),p63(C,B).
...
p312_1(A,B):-p2(A,C),p153(C,B).
p315(A,B):-copy1(A,C),p315_1(C,B).
p315_1(A,B):-p580(A,C),copy1(C,B).
p320(A,B):-p47(A,C),p316(C,B).
p323(A,B):-copy1(A,C),p323_1(C,B).
p323_1(A,B):-p122(A,C),p323_2(C,B).
p323_2(A,B):-p4(A,C),p22(C,B).
p324(A,B):-p129(A,C),p119(C,B).
p325(A,B):-p225(A,C),p325_1(C,B).
p325_1(A,B):-skip1(A,C),p325_2(C,B).
p325_2(A,B):-p15(A,C),p218(C,B).
p326(A,B):-p15(A,C),p295(C,B).
p328(A,B):-p376(A,C),p362(C,B).
p330(A,B):-p376(A,C),p119(C,B).
p331(A,B):-skip1(A,C),p331_1(C,B).
p331_1(A,B):-p240(A,C),p15(C,B).
p335(A,B):-p335_1(A,C),mk_uppercase(C,B).
p335_1(A,B):-mk_lowercase(A,C),p38(C,B).
...
p381_1(A,B):-p153(A,C),p259(C,B).
p388(A,B):-p63(A,C),p388_1(C,B).
p388_1(A,B):-skip1(A,C),p165(C,B).
...
p455_1(A,B):-p153(A,C),p455_2(C,B).
p455_2(A,B):-p160(A,C),p15(C,B).
...
p492_1(A,B):-skip1(A,C),p492_2(C,B).
p492_2(A,B):-p44(A,C),p22(C,B).
p495(A,B):-p204(A,C),p410(C,B).
p496(A,B):-p13(A,C),p496_1(C,B).
p496_1(A,B):-skip1(A,C),p496_2(C,B).
p496_2(A,B):-p13(A,C),p45(C,B).
...
p511_1(A,B):-p471(A,C),p511_2(C,B).
p511_2(A,B):-copy1(A,C),p21(C,B).
p515(A,B):-p82(A,C),p515_1(C,B).
p515_1(A,B):-p153(A,C),p220(C,B).
p516(A,B):-p47(A,C),p516_1(C,B).
p516_1(A,B):-p345(A,C),p41(C,B).
p518(A,B):-p39(A,C),p518_1(C,B).
p518_1(A,B):-skip1(A,C),p518_2(C,B).
p518_2(A,B):-skip1(A,C),p47(C,B).
...
p535_1(A,B):-p153(A,C),p279(C,B).
p536(A,B):-mk_lowercase(A,C),p536_1(C,B).
p536_1(A,B):-p42(A,C),p165(C,B).
p540(A,B):-p21(A,C),p430(C,B).
p542(A,B):-skip1(A,C),p542_1(C,B).
p542_1(A,B):-p153(A,C),p58(C,B).
p543(A,B):-p242(A,C),p204(C,B).
p548(A,B):-p189(A,C),p548_1(C,B).
p548_1(A,B):-p153(A,C),p362(C,B).
p551(A,B):-p15(A,C),p551_1(C,B).
p551_1(A,B):-p225(A,C),p160(C,B).
p556(A,B):-p22(A,C),p556_1(C,B).
p556_1(A,B):-p594(A,C),mk_lowercase(C,B).
...
p573(A,B):-p4(A,C),p573_1(C,B).
p573_1(A,B):-p22(A,C),p573_2(C,B).
p573_2(A,B):-p58(A,C),mk_uppercase(C,B).
p577(A,B):-copy1(A,C),p577_1(C,B).
p577_1(A,B):-p430(A,C),p22(C,B).
...
p585_2(A,B):-p165(A,C),p153(C,B).
p588(A,B):-copy1(A,C),p588_1(C,B).
p588_1(A,B):-p7(A,C),p588_2(C,B).
p588_2(A,B):-skip1(A,C),p54(C,B).
p591(A,B):-p42(A,C),p502(C,B).
p593(A,B):-skip1(A,C),p593_1(C,B).
p593_1(A,B):-p13(A,C),p220(C,B).
p595(A,B):-p21(A,C),p595_1(C,B).
p595_1(A,B):-skip1(A,C),p595_2(C,B).
p595_2(A,B):-skip1(A,C),p119(C,B).
p598(A,B):-p39(A,C),p598_1(C,B).
p598_1(A,B):-skip1(A,C),p182(C,B).
% asserting p1/2
% asserting p9/2
% asserting p14/2
% asserting p19/2
...
p133_1(A,B):-skip1(A,C),p133_2(C,B).
p133_2(A,B):-p153(A,C),p591(C,B).
p188(A,B):-p132(A,C),p188_1(C,B).
p188_1(A,B):-copy1(A,C),p188_2(C,B).
p188_2(A,B):-skip1(A,C),p47(C,B).
p413(A,B):-p247(A,C),p21(C,B).
p425(A,B):-copy1(A,C),p425_1(C,B).
p425_1(A,B):-skip1(A,C),p425_2(C,B).
p425_2(A,B):-p153(A,C),p13(C,B).
p505(A,B):-not_empty(A),p196(A,B).
p553(A,B):-not_empty(A),p463(A,B).
p600(A,B):-p42(A,C),p600_1(C,B).
p600_1(A,B):-p15(A,C),p473(C,B).
% asserting p70/2
% asserting p109/2
% asserting p133/2
% asserting p188/2

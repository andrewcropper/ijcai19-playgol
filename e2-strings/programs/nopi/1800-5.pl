...
p33(A,B):-p643(A,C),p33_1(C,B).
p33_1(A,B):-p1131(A,C),copy1(C,B).
...
p139_1(A,B):-p34(A,C),p139_2(C,B).
p139_2(A,B):-p240(A,C),p1(C,B).
...
p203(A,B):-p839(A,C),p90(C,B).
p208(A,B):-mk_uppercase(A,C),p208_1(C,B).
p208_1(A,B):-skip1(A,C),p1499(C,B).
...
p257(A,B):-p526(A,C),p257_1(C,B).
p257_1(A,B):-skip1(A,C),p29(C,B).
p258(A,B):-skip1(A,C),p258_1(C,B).
p258_1(A,B):-p355(A,C),p727(C,B).
p259(A,B):-p202(A,C),p295(C,B).
p260(A,B):-p87(A,C),p183(C,B).
p262(A,B):-copy1(A,C),p1143(C,B).
p263(A,B):-p250(A,C),p676(C,B).
p264(A,B):-p411(A,C),p526(C,B).
p265(A,B):-skip1(A,C),p106(C,B).
p267(A,B):-p247(A,C),p267_1(C,B).
p267_1(A,B):-p468(A,C),p240(C,B).
p268(A,B):-p287(A,C),p268_1(C,B).
p268_1(A,B):-skip1(A,C),p1737(C,B).
p269(A,B):-p87(A,C),p20(C,B).
p270(A,B):-p87(A,C),p1243(C,B).
p275(A,B):-copy1(A,C),p275_1(C,B).
p275_1(A,B):-p240(A,C),p275_2(C,B).
p275_2(A,B):-p407(A,C),p766(C,B).
...
p341(A,B):-p4(A,C),p341_1(C,B).
p341_1(A,B):-skip1(A,C),p455(C,B).
...
p381(A,B):-p76(A,C),p355(C,B).
p386(A,B):-skip1(A,C),p386_1(C,B).
p386_1(A,B):-skip1(A,C),p47(C,B).
p387(A,B):-copy1(A,C),p387_1(C,B).
p387_1(A,B):-skip1(A,C),p29(C,B).
p393(A,B):-p411(A,C),p22(C,B).
p394(A,B):-p87(A,C),p394_1(C,B).
p394_1(A,B):-skip1(A,C),p76(C,B).
p396(A,B):-p3(A,C),p396_1(C,B).
p396_1(A,B):-p112(A,C),p90(C,B).
...
p453(A,B):-p1(A,C),p453_1(C,B).
p453_1(A,B):-p38(A,C),p318(C,B).
...
p469_1(A,B):-p34(A,C),p859(C,B).
p471(A,B):-p250(A,C),p231(C,B).
p472(A,B):-skip1(A,C),p472_1(C,B).
p472_1(A,B):-p50(A,C),p804(C,B).
p473(A,B):-p355(A,C),p20(C,B).
p478(A,B):-p69(A,C),p112(C,B).
p479(A,B):-p3(A,C),p479_1(C,B).
p479_1(A,B):-p240(A,C),mk_uppercase(C,B).
...
p620(A,B):-p87(A,C),p620_1(C,B).
p620_1(A,B):-p20(A,C),p971(C,B).
p621(A,B):-p1258(A,C),p309(C,B).
p623(A,B):-p250(A,C),p1121(C,B).
...
p642(A,B):-p87(A,C),p642_1(C,B).
p642_1(A,B):-p250(A,C),p3(C,B).
p647(A,B):-mk_uppercase(A,C),p647_1(C,B).
p647_1(A,B):-p1246(A,C),p925(C,B).
p653(A,B):-p156(A,C),p643(C,B).
p654(A,B):-p4(A,C),p1648(C,B).
p656(A,B):-p340(A,C),p189(C,B).
p658(A,B):-copy1(A,C),p658_1(C,B).
p658_1(A,B):-p649(A,C),p1151(C,B).
p662(A,B):-skip1(A,C),p662_1(C,B).
p662_1(A,B):-skip1(A,C),p209(C,B).
p663(A,B):-p3(A,C),p69(C,B).
p665(A,B):-p1(A,C),p665_1(C,B).
p665_1(A,B):-skip1(A,C),p1042(C,B).
...
p745(A,B):-p766(A,C),p194(C,B).
p747(A,B):-p747_1(A,B),is_lowercase(B).
p747_1(A,B):-p160(A,C),p747_2(C,B).
p747_2(A,B):-p52(A,C),p90(C,B).
...
p786(A,B):-p832(A,C),p786_1(C,B).
p786_1(A,B):-skip1(A,C),p248(C,B).
p787(A,B):-copy1(A,C),p787_1(C,B).
p787_1(A,B):-p1183(A,C),p680(C,B).
p789(A,B):-p20(A,C),p355(C,B).
p790(A,B):-p299(A,C),p726(C,B).
p793(A,B):-p160(A,C),p691(C,B).
p794(A,B):-copy1(A,C),p794_1(C,B).
p794_1(A,B):-p832(A,C),p1042(C,B).
p795(A,B):-p40(A,C),p795_1(C,B).
p795_1(A,B):-p5(A,C),p40(C,B).
...
p848_2(A,B):-p248(A,C),p40(C,B).
p851(A,B):-skip1(A,C),p851_1(C,B).
p851_1(A,B):-p971(A,C),p1104(C,B).
...
p880_1(A,B):-p76(A,C),p407(C,B).
p883(A,B):-p248(A,C),p68(C,B).
p888(A,B):-p646(A,C),p702(C,B).
...
p896(A,B):-p470(A,C),p31(C,B).
p898(A,B):-copy1(A,C),p898_1(C,B).
p898_1(A,B):-p735(A,C),mk_uppercase(C,B).
p899(A,B):-p156(A,C),p971(C,B).
...
p908_1(A,B):-p859(A,C),p202(C,B).
p910(A,B):-skip1(A,C),p388(C,B).
p912(A,B):-p1546(A,C),p299(C,B).
...
p926_1(A,B):-p389(A,C),p926_2(C,B).
p926_2(A,B):-p28(A,C),p483(C,B).
p927(A,B):-mk_uppercase(A,C),p927_1(C,B).
p927_1(A,B):-skip1(A,C),p726(C,B).
p929(A,B):-p87(A,C),p929_1(C,B).
p929_1(A,B):-p250(A,C),p3(C,B).
p932(A,B):-p128(A,C),p248(C,B).
p935(A,B):-p80(A,C),p749(C,B).
p941(A,B):-p248(A,C),p941_1(C,B).
p941_1(A,B):-p54(A,C),p3(C,B).
...
p949_1(A,B):-p34(A,C),p824(C,B).
p952(A,B):-skip1(A,C),p462(C,B).
p954(A,B):-p87(A,C),p954_1(C,B).
p954_1(A,B):-skip1(A,C),p278(C,B).
...
p997(A,B):-p68(A,C),p250(C,B).
p1000(A,B):-p40(A,C),p133(C,B).
p1002(A,B):-p649(A,C),p231(C,B).
p1004(A,B):-p1004_1(A,B),is_uppercase(B).
p1004_1(A,B):-p202(A,C),p1004_2(C,B).
p1004_2(A,B):-p413(A,C),p389(C,B).
...
p1031_1(A,B):-p411(A,C),p99(C,B).
p1038(A,B):-p87(A,C),p1038_1(C,B).
p1038_1(A,B):-p766(A,C),p379(C,B).
...
p1064(A,B):-p1145(A,C),mk_lowercase(C,B).
...
p1073_1(A,B):-p1546(A,C),mk_uppercase(C,B).
p1081(A,B):-mk_lowercase(A,C),p1081_1(C,B).
p1081_1(A,B):-p643(A,C),p709(C,B).
p1084(A,B):-p90(A,C),p1084_1(C,B).
p1084_1(A,B):-p643(A,C),p34(C,B).
p1086(A,B):-p160(A,C),p54(C,B).
p1088(A,B):-skip1(A,C),p1088_1(C,B).
p1088_1(A,B):-p69(A,C),p248(C,B).
p1089(A,B):-mk_lowercase(A,C),p1089_1(C,B).
p1089_1(A,B):-p1381(A,C),p52(C,B).
p1090(A,B):-copy1(A,C),p1090_1(C,B).
p1090_1(A,B):-p250(A,C),p254(C,B).
p1093(A,B):-p593(A,C),p189(C,B).
p1095(A,B):-p1095_1(A,B),not_number(B).
p1095_1(A,B):-is_lowercase(A),p295(A,B).
p1095_1(A,B):-skip1(A,C),p1095_1(C,B).
p1098(A,B):-copy1(A,C),p1098_1(C,B).
p1098_1(A,B):-p1099(A,C),p248(C,B).
...
p1207(A,B):-p69(A,C),p1207_1(C,B).
p1207_1(A,B):-p40(A,C),p5(C,B).
p1210(A,B):-mk_lowercase(A,C),p1210_1(C,B).
p1210_1(A,B):-p40(A,C),p68(C,B).
p1215(A,B):-p299(A,C),p1215_1(C,B).
p1215_1(A,B):-p714(A,C),p40(C,B).
...
p1263_1(A,B):-p182(A,C),p5(C,B).
p1264(A,B):-copy1(A,C),p106(C,B).
p1271(A,B):-skip1(A,C),p1271_1(C,B).
p1271_1(A,B):-p355(A,C),p47(C,B).
p1278(A,B):-p470(A,C),p1325(C,B).
p1280(A,B):-p90(A,C),p1280_1(C,B).
p1280_1(A,B):-p194(A,C),mk_uppercase(C,B).
p1281(A,B):-p90(A,C),p758(C,B).
p1284(A,B):-p829(A,C),p1284_1(C,B).
p1284_1(A,B):-p407(A,C),p133(C,B).
p1286(A,B):-p350(A,C),p442(C,B).
p1288(A,B):-p48(A,B),is_number(B).
p1288(A,B):-skip1(A,C),p1288(C,B).
p1289(A,B):-p87(A,C),p1289_1(C,B).
p1289_1(A,B):-skip1(A,C),p76(C,B).
p1290(A,B):-copy1(A,C),p1290_1(C,B).
p1290_1(A,B):-p379(A,C),p109(C,B).
p1291(A,B):-p247(A,C),p34(C,B).
p1293(A,B):-p40(A,C),p1293_1(C,B).
p1293_1(A,B):-p47(A,C),p189(C,B).
p1294(A,B):-p227(A,C),p1294_1(C,B).
p1294_1(A,B):-skip1(A,C),p1042(C,B).
p1295(A,B):-copy1(A,C),p1295_1(C,B).
p1295_1(A,B):-p22(A,C),p1295_2(C,B).
p1295_2(A,B):-mk_uppercase(A,C),p202(C,B).
p1299(A,B):-copy1(A,C),p350(C,B).
p1300(A,B):-p1381(A,C),p1300_1(C,B).
p1300_1(A,B):-p248(A,C),p202(C,B).
...
p1312_1(A,B):-skip1(A,C),p687(C,B).
...
p1340(A,B):-p1393(A,C),p52(C,B).
p1345(A,B):-copy1(A,C),p1345_1(C,B).
p1345_1(A,B):-p462(A,C),p1338(C,B).
p1346(A,B):-p340(A,C),p189(C,B).
...
p1357(A,B):-p1114(A,C),p1121(C,B).
p1364(A,B):-copy1(A,C),p69(C,B).
p1365(A,B):-p1365_1(A,B),not_empty(B).
p1365_1(A,B):-p156(A,C),p1365_2(C,B).
p1365_2(A,B):-p238(A,C),mk_uppercase(C,B).
p1371(A,B):-p87(A,C),p687(C,B).
p1374(A,B):-p247(A,C),p370(C,B).
p1375(A,B):-copy1(A,C),p462(C,B).
p1376(A,B):-skip1(A,C),p1376_1(C,B).
p1376_1(A,B):-p40(A,C),p709(C,B).
...
p1391(A,B):-p87(A,C),p1391_1(C,B).
p1391_1(A,B):-p766(A,C),p462(C,B).
...
p1458(A,B):-p350(A,C),p1458_1(C,B).
p1458_1(A,B):-skip1(A,C),p1(C,B).
...
p1506(A,B):-p1042(A,C),p468(C,B).
p1507(A,B):-copy1(A,C),p1507_1(C,B).
p1507_1(A,B):-p1170(A,C),p348(C,B).
p1511(A,B):-p646(A,C),p69(C,B).
p1512(A,B):-p1512_1(A,B),is_lowercase(B).
p1512_1(A,B):-p156(A,C),p1268(C,B).
p1514(A,B):-copy1(A,C),p1514_1(C,B).
p1514_1(A,B):-p40(A,C),p340(C,B).
...
p1524_1(A,B):-p1099(A,C),p407(C,B).
p1527(A,B):-p398(A,C),p766(C,B).
...
p1579(A,B):-p87(A,C),p1579_1(C,B).
p1579_1(A,B):-skip1(A,C),p340(C,B).
p1584(A,B):-p87(A,C),p1143(C,B).
p1585(A,B):-p128(A,C),p411(C,B).
p1586(A,B):-p413(A,C),p1586_1(C,B).
p1586_1(A,B):-p1092(A,C),copy1(C,B).
p1587(A,B):-p839(A,C),copy1(C,B).
p1592(A,B):-copy1(A,C),p462(C,B).
p1595(A,B):-p299(A,C),p470(C,B).
...
p1606(A,B):-p1606_1(A,B),is_lowercase(B).
p1606_1(A,B):-p590(A,C),p1325(C,B).
p1608(A,B):-p69(A,C),p1608_1(C,B).
p1608_1(A,B):-skip1(A,C),p804(C,B).
p1612(A,B):-p87(A,C),p1612_1(C,B).
p1612_1(A,B):-p709(A,C),p1499(C,B).
p1617(A,B):-p273(A,C),p1325(C,B).
p1619(A,B):-p52(A,C),p355(C,B).
p1620(A,B):-p340(A,C),p248(C,B).
...
p1661_1(A,B):-skip1(A,C),p1028(C,B).
p1662(A,B):-p497(A,C),p355(C,B).
p1663(A,B):-p1018(A,C),p526(C,B).
p1664(A,B):-skip1(A,C),p1664_1(C,B).
p1664_1(A,B):-p69(A,C),p1664_2(C,B).
p1664_2(A,B):-p240(A,C),p87(C,B).
p1666(A,B):-p31(A,C),p1157(C,B).
p1667(A,B):-p52(A,C),p1104(C,B).
p1668(A,B):-p183(A,C),p468(C,B).
p1670(A,B):-p411(A,C),p29(C,B).
p1674(A,B):-p3(A,C),p1674_1(C,B).
p1674_1(A,B):-p389(A,C),p202(C,B).
p1681(A,B):-copy1(A,C),p1681_1(C,B).
p1681_1(A,B):-p20(A,C),p1266(C,B).
p1684(A,B):-p240(A,C),p1684_1(C,B).
p1684_1(A,B):-p55(A,C),p1338(C,B).
...
p1706(A,B):-mk_lowercase(A,C),p1706_1(C,B).
p1706_1(A,B):-p40(A,C),p247(C,B).
...
p1738(A,B):-p1071(A,C),p1738_1(C,B).
p1738_1(A,B):-p189(A,C),p766(C,B).
p1740(A,B):-skip1(A,C),p1740_1(C,B).
p1740_1(A,B):-p413(A,C),p643(C,B).
p1745(A,B):-p816(A,C),p1(C,B).
p1746(A,B):-p1746_1(A,B),is_number(B).
p1746_1(A,B):-p590(A,C),p69(C,B).
...
p1322(A,B):-p663(A,C),p1322_1(C,B).
p1322_1(A,B):-skip1(A,C),p248(C,B).
% asserting p217/2
% asserting p707/2
% asserting p819/2
% asserting p917/2
...
%timeout
%timeout
b224(A,B):-p69(A,C),b224_1(C,B).
b224_1(A,B):-skip1(A,C),p28(C,B).
%timeout
%timeout
%timeout
%timeout

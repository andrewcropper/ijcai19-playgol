...
p15_1(A,B):-p105(A,C),p15_2(C,B).
p15_2(A,B):-p23(A,C),p148(C,B).
...
p40_1(A,B):-p35(A,C),p1(C,B).
p44(A,B):-p44_1(A,B),is_lowercase(B).
p44_1(A,B):-p109(A,C),p299(C,B).
p51(A,B):-p94(A,C),copy1(C,B).
p55(A,B):-mk_lowercase(A,C),p55_1(C,B).
p55_1(A,B):-skip1(A,C),p55_2(C,B).
p55_2(A,B):-p381(A,C),p9(C,B).
p58(A,B):-copy1(A,C),p58_1(C,B).
p58_1(A,B):-skip1(A,C),p58_2(C,B).
p58_2(A,B):-p7(A,C),p351(C,B).
p59(A,B):-p110(A,C),p59_1(C,B).
p59_1(A,B):-mk_lowercase(A,C),p345(C,B).
p61(A,B):-p254(A,C),p61_1(C,B).
p61_1(A,B):-mk_lowercase(A,C),p351(C,B).
p63(A,B):-skip1(A,C),p63_1(C,B).
p63_1(A,B):-p10(A,C),p334(C,B).
p68(A,B):-p23(A,C),p68_1(C,B).
p68_1(A,B):-skip1(A,C),p369(C,B).
p77(A,B):-p42(A,C),p77_1(C,B).
p77_1(A,B):-p96(A,C),copy1(C,B).
...
p104_1(A,B):-p78(A,C),copy1(C,B).
p113(A,B):-p369(A,C),p113_1(C,B).
p113_1(A,B):-p173(A,C),mk_uppercase(C,B).
p115(A,B):-p9(A,C),p115_1(C,B).
p115_1(A,B):-p334(A,C),p54(C,B).
p124(A,B):-p174(A,C),p124_1(C,B).
p124_1(A,B):-mk_uppercase(A,C),p277(C,B).
p131(A,B):-mk_uppercase(A,C),p131_1(C,B).
p131_1(A,B):-p14(A,C),p1(C,B).
p135(A,B):-p67(A,C),p135_1(C,B).
p135_1(A,B):-p23(A,C),p173(C,B).
...
p166_1(A,B):-p23(A,C),p166_2(C,B).
p166_2(A,B):-skip1(A,C),p7(C,B).
p169(A,B):-p24(A,C),p169_1(C,B).
p169_1(A,B):-p16(A,C),p362(C,B).
p171(A,B):-p116(A,C),p171_1(C,B).
p171_1(A,B):-skip1(A,C),p369(C,B).
p183(A,B):-p24(A,C),p183_1(C,B).
p183_1(A,B):-p185(A,C),p91(C,B).
...
p235_1(A,B):-p8(A,C),p235_2(C,B).
p235_2(A,B):-p23(A,C),p203(C,B).
...
p249_1(A,B):-p80(A,C),p369(C,B).
p269(A,B):-skip1(A,C),p269_1(C,B).
p269_1(A,B):-skip1(A,C),p5(C,B).
...
p373(A,B):-p80(A,C),p373_1(C,B).
p373_1(A,B):-p23(A,C),p272(C,B).
p374(A,B):-skip1(A,C),p374_1(C,B).
p374_1(A,B):-p23(A,C),p374_2(C,B).
p374_2(A,B):-p35(A,C),p22(C,B).
...
% asserting p400/2
% depth 4
p19(A,B):-not_empty(A),p302(A,B).
p72(A,B):-p222(A,C),p72_1(C,B).
p72_1(A,B):-mk_uppercase(A,C),p42(C,B).
p86(A,B):-p5(A,C),p86_1(C,B).
p86_1(A,B):-p302(A,C),mk_lowercase(C,B).
p177(A,B):-p9(A,C),p58(C,B).
p178(A,B):-p8(A,C),p178_1(C,B).
p178_1(A,B):-p23(A,C),p178_2(C,B).
p178_2(A,B):-p5(A,C),mk_lowercase(C,B).
p211(A,B):-copy1(A,C),p211_1(C,B).
p211_1(A,B):-p302(A,C),p211_2(C,B).
p211_2(A,B):-skip1(A,C),p10(C,B).
p232(A,B):-copy1(A,C),p32(C,B).
p263(A,B):-p24(A,C),p263_1(C,B).
p263_1(A,B):-p16(A,C),p263_2(C,B).
p263_2(A,B):-p87(A,C),p23(C,B).
p271(A,B):-p116(A,C),p271_1(C,B).
p271_1(A,B):-p32(A,C),mk_uppercase(C,B).
p286(A,B):-p351(A,C),p302(C,B).
p336(A,B):-p222(A,C),p336_1(C,B).
p336_1(A,B):-copy1(A,C),p96(C,B).
p338(A,B):-p203(A,C),p302(C,B).
...
p389_1(A,B):-p96(A,C),p389_2(C,B).
p389_2(A,B):-copy1(A,C),p16(C,B).
% asserting p19/2
% asserting p72/2
% asserting p86/2
% asserting p177/2
...
b227_1(A,B):-p40(A,C),b227_2(C,B).
b227_2(A,B):-skip1(A,B),is_empty(B).
b227_2(A,B):-p10(A,C),b227_2(C,B).
%timeout
%timeout
%timeout
%timeout

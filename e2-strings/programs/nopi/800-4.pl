...
p14_1(A,B):-p77(A,C),p1(C,B).
p16(A,B):-p418(A,C),p597(C,B).
p23(A,B):-p254(A,C),p502(C,B).
p27(A,B):-p252(A,C),p27_1(C,B).
p27_1(A,B):-copy1(A,C),p231(C,B).
p30(A,B):-p21(A,C),p30_1(C,B).
p30_1(A,B):-p114(A,C),p72(C,B).
p38(A,B):-p522(A,C),p325(C,B).
p39(A,B):-copy1(A,C),p39_1(C,B).
p39_1(A,B):-p692(A,C),p18(C,B).
p40(A,B):-p120(A,C),p190(C,B).
p40(A,B):-skip1(A,C),p40(C,B).
p42(A,B):-mk_uppercase(A,C),p42_1(C,B).
p42_1(A,B):-p224(A,C),p540(C,B).
...
p69(A,B):-p104(A,C),p102(C,B).
p70(A,B):-p1(A,C),p35(C,B).
p71(A,B):-p17(A,C),p43(C,B).
p79(A,B):-p9(A,C),p244(C,B).
p82(A,B):-p18(A,C),p483(C,B).
p84(A,B):-p18(A,C),p84_1(C,B).
p84_1(A,B):-p522(A,C),p325(C,B).
p89(A,B):-p9(A,C),p588(C,B).
p93(A,B):-p520(A,C),p642(C,B).
p95(A,B):-skip1(A,C),p95_1(C,B).
p95_1(A,B):-p133(A,C),p95_2(C,B).
p95_2(A,B):-skip1(A,C),p540(C,B).
p106(A,B):-p147(A,C),p106_1(C,B).
p106_1(A,B):-p540(A,C),p104(C,B).
...
p122_1(A,B):-p251(A,C),copy1(C,B).
p123(A,B):-p153(A,C),p654(C,B).
p136(A,B):-mk_lowercase(A,C),p136_1(C,B).
p136_1(A,B):-p72(A,C),p136_2(C,B).
p136_2(A,B):-p94(A,C),p502(C,B).
p137(A,B):-p120(A,C),p137_1(C,B).
p137_1(A,B):-p697(A,C),p43(C,B).
p142(A,B):-p759(A,C),p190(C,B).
p149(A,B):-p553(A,C),p294(C,B).
p150(A,B):-p102(A,C),p115(C,B).
p151(A,B):-p18(A,C),p151_1(C,B).
p151_1(A,B):-p139(A,C),mk_uppercase(C,B).
p156(A,B):-p68(A,C),p315(C,B).
p161(A,B):-copy1(A,C),p161_1(C,B).
p161_1(A,B):-p139(A,C),p163(C,B).
p165(A,B):-mk_uppercase(A,C),p12(C,B).
p167(A,B):-skip1(A,C),p167_1(C,B).
p167_1(A,B):-skip1(A,C),p96(C,B).
p169(A,B):-p2(A,C),p540(C,B).
p170(A,B):-p12(A,C),p94(C,B).
p175(A,B):-p654(A,C),p175_1(C,B).
p175_1(A,B):-skip1(A,C),p642(C,B).
p180(A,B):-copy1(A,C),p180_1(C,B).
p180_1(A,B):-p745(A,C),mk_lowercase(C,B).
p183(A,B):-skip1(A,C),p183_1(C,B).
p183_1(A,B):-p9(A,C),p2(C,B).
p184(A,B):-copy1(A,C),p184_1(C,B).
p184_1(A,B):-skip1(A,C),p184_2(C,B).
p184_2(A,B):-skip1(A,C),p336(C,B).
p185(A,B):-p251(A,C),p381(C,B).
p187(A,B):-copy1(A,C),p152(C,B).
p189(A,B):-p133(A,C),p189_1(C,B).
p189_1(A,B):-p502(A,C),p72(C,B).
p194(A,B):-copy1(A,C),p194_1(C,B).
p194_1(A,B):-p1(A,C),p692(C,B).
p200(A,B):-p104(A,C),p9(C,B).
p202(A,B):-p407(A,C),p57(C,B).
p205(A,B):-copy1(A,C),p205_1(C,B).
p205_1(A,B):-p144(A,C),p72(C,B).
p209(A,B):-p100(A,C),p209_1(C,B).
p209_1(A,B):-skip1(A,C),p522(C,B).
p211(A,B):-p739(A,C),p211_1(C,B).
p211_1(A,B):-p661(A,C),copy1(C,B).
p213(A,B):-p227(A,C),p213_1(C,B).
p213_1(A,B):-p540(A,C),mk_lowercase(C,B).
p214(A,B):-skip1(A,C),p214_1(C,B).
p214_1(A,B):-skip1(A,C),p317(C,B).
p215(A,B):-skip1(A,C),p215_1(C,B).
p215_1(A,B):-p311(A,C),p215_2(C,B).
p215_2(A,B):-mk_lowercase(A,C),p58(C,B).
...
p238(A,B):-p363(A,C),p238_1(C,B).
p238_1(A,B):-mk_uppercase(A,C),p238_2(C,B).
...
p411_1(A,B):-p315(A,C),p87(C,B).
p412(A,B):-p120(A,C),p412_1(C,B).
p412_1(A,B):-p33(A,C),p522(C,B).
p413(A,B):-mk_lowercase(A,C),p102(C,B).
p414(A,B):-p540(A,C),p414_1(C,B).
p414_1(A,B):-p483(A,C),p72(C,B).
p416(A,B):-p416_1(A,B),is_lowercase(B).
p416_1(A,B):-p72(A,C),p540(C,B).
p416_1(A,B):-skip1(A,C),p416_1(C,B).
p417(A,B):-p729(A,C),p115(C,B).
p419(A,B):-p58(A,C),p655(C,B).
p421(A,B):-p12(A,C),p421_1(C,B).
p421_1(A,B):-mk_lowercase(A,C),p604(C,B).
p422(A,B):-copy1(A,C),p422_1(C,B).
p422_1(A,B):-skip1(A,C),p12(C,B).
p423(A,B):-p13(A,C),p423_1(C,B).
p423_1(A,B):-skip1(A,C),p254(C,B).
p431(A,B):-p502(A,C),p431_1(C,B).
p431_1(A,B):-p72(A,C),p68(C,B).
p434(A,B):-p583(A,C),p140(C,B).
p438(A,B):-skip1(A,C),p438_1(C,B).
p438_1(A,B):-p9(A,C),p133(C,B).
...
p442_1(A,B):-p190(A,C),p442_2(C,B).
p442_2(A,B):-p522(A,C),p12(C,B).
...
p464_1(A,B):-skip1(A,C),p520(C,B).
p467(A,B):-mk_lowercase(A,C),p467_1(C,B).
p467_1(A,B):-p154(A,C),p502(C,B).
...
p473_1(A,B):-mk_lowercase(A,C),p473_2(C,B).
p473_2(A,B):-p104(A,C),p1(C,B).
p474(A,B):-p315(A,C),p474_1(C,B).
p474_1(A,B):-p499(A,C),p147(C,B).
...
p491_1(A,B):-not_empty(A),p163(A,B).
...
p503_1(A,B):-p315(A,C),p503_2(C,B).
p503_2(A,B):-p300(A,C),mk_uppercase(C,B).
p505(A,B):-p157(A,C),p12(C,B).
p507(A,B):-copy1(A,C),p507_1(C,B).
p507_1(A,B):-skip1(A,C),p252(C,B).
...
p606_1(A,B):-p760(A,C),p100(C,B).
p607(A,B):-p18(A,C),p607_1(C,B).
p607_1(A,B):-p536(A,C),mk_lowercase(C,B).
p608(A,B):-p254(A,C),p739(C,B).
p609(A,B):-p35(A,C),p114(C,B).
p614(A,B):-p190(A,C),p614_1(C,B).
p614_1(A,B):-p642(A,C),p642(C,B).
...
p624_1(A,B):-skip1(A,C),p624_2(C,B).
p624_2(A,B):-skip1(A,C),p654(C,B).
p626(A,B):-p9(A,C),p3(C,B).
p629(A,B):-copy1(A,C),p629_1(C,B).
p629_1(A,B):-p485(A,C),p100(C,B).
p630(A,B):-p9(A,C),p102(C,B).
p637(A,B):-p18(A,C),p637_1(C,B).
p637_1(A,B):-p522(A,C),p756(C,B).
p638(A,B):-p739(A,C),p63(C,B).
p641(A,B):-copy1(A,C),p641_1(C,B).
p641_1(A,B):-p1(A,C),p115(C,B).
p643(A,B):-p654(A,C),p643_1(C,B).
p643_1(A,B):-p147(A,C),p21(C,B).
p645(A,B):-p58(A,C),p645_1(C,B).
p645_1(A,B):-p451(A,C),p9(C,B).
p646(A,B):-skip1(A,C),p646_1(C,B).
p646_1(A,B):-skip1(A,C),p646_2(C,B).
p646_2(A,B):-p72(A,C),p8(C,B).
...
p657_1(A,B):-skip1(A,C),p317(C,B).
p659(A,B):-p58(A,C),p104(C,B).
p667(A,B):-p147(A,C),p667_1(C,B).
p667_1(A,B):-p173(A,C),p100(C,B).
p668(A,B):-p96(A,C),p72(C,B).
p668(A,B):-skip1(A,C),p668(C,B).
p670(A,B):-p190(A,C),p751(C,B).
p671(A,B):-p315(A,C),p76(C,B).
p672(A,B):-skip1(A,C),p672_1(C,B).
p672_1(A,B):-p12(A,C),p775(C,B).
p674(A,B):-p18(A,C),p674_1(C,B).
p674_1(A,B):-p8(A,C),mk_lowercase(C,B).
p677(A,B):-p104(A,C),p381(C,B).
p678(A,B):-skip1(A,C),p678_1(C,B).
p678_1(A,B):-p506(A,C),p176(C,B).
...
p696_1(A,B):-skip1(A,C),p654(C,B).
p698(A,B):-p654(A,C),mk_lowercase(C,B).
p703(A,B):-p147(A,C),p703_1(C,B).
p703_1(A,B):-p522(A,C),p729(C,B).
p706(A,B):-skip1(A,C),p706_1(C,B).
p706_1(A,B):-p483(A,C),p254(C,B).
p708(A,B):-p13(A,C),p92(C,B).
p709(A,B):-p120(A,C),p709_1(C,B).
p709_1(A,B):-p502(A,C),p190(C,B).
p711(A,B):-skip1(A,C),p711_1(C,B).
p711_1(A,B):-p21(A,C),p745(C,B).
p712(A,B):-p32(A,C),p21(C,B).
p716(A,B):-p642(A,C),p716_1(C,B).
p716_1(A,B):-p57(A,C),p190(C,B).
...
p762_1(A,B):-p254(A,C),p315(C,B).
p769(A,B):-p178(A,C),p35(C,B).
p769(A,B):-skip1(A,C),p769(C,B).
p770(A,B):-p1(A,C),p63(C,B).
p774(A,B):-skip1(A,C),p774_1(C,B).
p774_1(A,B):-p661(A,C),copy1(C,B).
p779(A,B):-p294(A,C),p779_1(C,B).
p779_1(A,B):-mk_lowercase(A,C),p315(C,B).
...
p796(A,B):-p502(A,C),p796_1(C,B).
p796_1(A,B):-p72(A,C),p104(C,B).
...
% asserting p798/2
% depth 4
p31(A,B):-p422(A,C),p31_1(C,B).
p31_1(A,B):-mk_lowercase(A,C),p31_2(C,B).
p31_2(A,B):-mk_lowercase(A,C),mk_lowercase(C,B).
p217(A,B):-p250(A,C),p217_1(C,B).
p217_1(A,B):-p9(A,C),p522(C,B).
p221(A,B):-skip1(A,C),p221_1(C,B).
p221_1(A,B):-p18(A,C),p221_2(C,B).
p221_2(A,B):-p53(A,C),mk_lowercase(C,B).
p424(A,B):-p57(A,C),p424_1(C,B).
p424_1(A,B):-p355(A,C),mk_lowercase(C,B).
p497(A,B):-p48(A,C),p497_1(C,B).
p497_1(A,B):-skip1(A,C),p553(C,B).
p541(A,B):-p422(A,C),p104(C,B).
p686(A,B):-skip1(A,C),p686_1(C,B).
p686_1(A,B):-p9(A,C),p48(C,B).
% asserting p31/2
% asserting p217/2
% asserting p221/2
% asserting p424/2
...
b113_1(A,B):-p104(A,C),b113_2(C,B).
b113_2(A,B):-skip1(A,C),p120(C,B).

...
p9_1(A,B):-p16(A,C),p9_2(C,B).
p9_2(A,B):-skip1(A,C),p69(C,B).
...
p41_1(A,B):-p360(A,C),p41_2(C,B).
p41_2(A,B):-skip1(A,C),p288(C,B).
p44(A,B):-p288(A,C),p44_1(C,B).
p44_1(A,B):-p251(A,C),mk_uppercase(C,B).
p45(A,B):-p568(A,C),copy1(C,B).
p50(A,B):-mk_lowercase(A,C),p50_1(C,B).
p50_1(A,B):-p76(A,C),p36(C,B).
p52(A,B):-p31(A,C),p52_1(C,B).
p52_1(A,B):-p24(A,C),p52_2(C,B).
p52_2(A,B):-copy1(A,C),p25(C,B).
p55(A,B):-p16(A,C),p55_1(C,B).
p55_1(A,B):-p320(A,C),p76(C,B).
p56(A,B):-p205(A,C),p56_1(C,B).
p56_1(A,B):-skip1(A,C),p298(C,B).
...
p64(A,B):-p236(A,C),p64_1(C,B).
p64_1(A,B):-p46(A,C),p64_2(C,B).
p64_2(A,B):-skip1(A,C),p69(C,B).
p68(A,B):-p94(A,C),p100(C,B).
p71(A,B):-p16(A,C),p71_1(C,B).
p71_1(A,B):-p291(A,C),copy1(C,B).
p73(A,B):-p563(A,C),p73_1(C,B).
p73_1(A,B):-p46(A,C),p205(C,B).
p75(A,B):-mk_uppercase(A,C),p75_1(C,B).
p75_1(A,B):-p375(A,C),mk_lowercase(C,B).
p78(A,B):-p76(A,C),p78_1(C,B).
p78_1(A,B):-p563(A,C),p465(C,B).
p79(A,B):-p46(A,C),p61(C,B).
p83(A,B):-p16(A,C),p468(C,B).
p85(A,B):-p2(A,C),p85_1(C,B).
p85_1(A,B):-skip1(A,C),p61(C,B).
p86(A,B):-p184(A,C),p179(C,B).
...
p88_2(A,B):-p69(A,C),p76(C,B).
p89(A,B):-p23(A,C),p89_1(C,B).
p89_1(A,B):-mk_uppercase(A,C),p18(C,B).
p90(A,B):-p46(A,C),p90_1(C,B).
p90_1(A,B):-skip1(A,C),p563(C,B).
p97(A,B):-p23(A,C),p97_1(C,B).
p97_1(A,B):-p291(A,C),copy1(C,B).
p97_1(A,B):-skip1(A,C),p97_1(C,B).
p103(A,B):-p130(A,C),p184(C,B).
p105(A,B):-copy1(A,C),p105_1(C,B).
p105_1(A,B):-p345(A,C),p236(C,B).
p106(A,B):-p76(A,C),p277(C,B).
p110(A,B):-mk_lowercase(A,C),p110_1(C,B).
p110_1(A,B):-p76(A,C),p110_2(C,B).
p110_2(A,B):-skip1(A,C),p377(C,B).
p111(A,B):-skip1(A,C),p111_1(C,B).
p111_1(A,B):-p46(A,C),p406(C,B).
p115(A,B):-p288(A,C),p139(C,B).
p115(A,B):-skip1(A,C),p115(C,B).
...
p127_2(A,B):-p465(A,C),mk_uppercase(C,B).
p128(A,B):-p23(A,C),p128_1(C,B).
p128_1(A,B):-mk_uppercase(A,C),p288(C,B).
p132(A,B):-skip1(A,C),p186(C,B).
p134(A,B):-p291(A,C),p126(C,B).
p137(A,B):-p69(A,C),p137_1(C,B).
p137_1(A,B):-p7(A,C),p205(C,B).
...
p175_1(A,B):-p69(A,C),p76(C,B).
p178(A,B):-p10(A,C),p178_1(C,B).
p178_1(A,B):-p51(A,C),copy1(C,B).
p180(A,B):-p375(A,C),p10(C,B).
p192(A,B):-p46(A,C),p192_1(C,B).
p192_1(A,B):-p191(A,C),copy1(C,B).
p197(A,B):-p76(A,C),p184(C,B).
p199(A,B):-p66(A,C),p199_1(C,B).
p199_1(A,B):-p247(A,C),p46(C,B).
...
p213(A,B):-p213_1(A,B),is_lowercase(B).
p213_1(A,B):-p288(A,C),p342(C,B).
p213_1(A,B):-skip1(A,C),p213_1(C,B).
...
p258(A,B):-p100(A,C),p102(C,B).
p260(A,B):-p16(A,C),p260_1(C,B).
p260_1(A,B):-p24(A,C),mk_uppercase(C,B).
p261(A,B):-p46(A,C),p261_1(C,B).
p261_1(A,B):-skip1(A,C),p261_2(C,B).
p261_2(A,B):-p69(A,C),p76(C,B).
p264(A,B):-copy1(A,C),p264_1(C,B).
p264_1(A,B):-p40(A,C),p345(C,B).
...
p309(A,B):-p291(A,C),p309_1(C,B).
p309_1(A,B):-p205(A,C),p10(C,B).
p310(A,B):-mk_uppercase(A,C),p310_1(C,B).
p310_1(A,B):-p320(A,C),p76(C,B).
...
p362(A,B):-p46(A,C),p362_1(C,B).
p362_1(A,B):-p205(A,C),p162(C,B).
p366(A,B):-p205(A,C),p366_1(C,B).
p366_1(A,B):-p31(A,C),p406(C,B).
...
p407_1(A,B):-p100(A,C),p69(C,B).
p409(A,B):-copy1(A,C),p409_1(C,B).
p409_1(A,B):-p345(A,C),p409_2(C,B).
p409_2(A,B):-p476(A,C),p24(C,B).
p410(A,B):-p46(A,C),p278(C,B).
p411(A,B):-p288(A,C),p36(C,B).
p411(A,B):-mk_lowercase(A,C),p411(C,B).
...
p433_1(A,B):-p360(A,C),p288(C,B).
p438(A,B):-p100(A,C),p438_1(C,B).
p438_1(A,B):-skip1(A,C),p69(C,B).
p441(A,B):-copy1(A,C),p441_1(C,B).
p441_1(A,B):-skip1(A,C),p441_2(C,B).
p441_2(A,B):-skip1(A,C),p377(C,B).
...
p457_1(A,B):-p207(A,C),mk_uppercase(C,B).
p460(A,B):-copy1(A,C),p460_1(C,B).
p460_1(A,B):-p23(A,C),p114(C,B).
p462(A,B):-skip1(A,C),p504(C,B).
p463(A,B):-copy1(A,C),p61(C,B).
p469(A,B):-p179(A,C),p469_1(C,B).
p469_1(A,B):-p291(A,C),copy1(C,B).
p470(A,B):-p215(A,C),p563(C,B).
p471(A,B):-copy1(A,C),p471_1(C,B).
p471_1(A,B):-p24(A,C),p150(C,B).
...
p495(A,B):-p100(A,C),p495_1(C,B).
p495_1(A,B):-skip1(A,C),p84(C,B).
p499(A,B):-p282(A,C),p46(C,B).
...
p565_1(A,B):-skip1(A,C),p61(C,B).
p569(A,B):-p23(A,C),p569_1(C,B).
p569_1(A,B):-mk_uppercase(A,C),p473(C,B).
p573(A,B):-p82(A,C),p179(C,B).
...
p196_1(A,B):-p16(A,C),p196_2(C,B).
p196_2(A,B):-skip1(A,C),p294(C,B).
p384(A,B):-p288(A,C),p384_1(C,B).
p384_1(A,B):-p368(A,C),mk_uppercase(C,B).
...
b113_2(A,B):-p51(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p563(A,B),is_uppercase(B).
...
b48_1(A,B):-p473(A,C),b48_2(C,B).
b48_2(A,B):-mk_uppercase(A,C),p473(C,B).
b48_2(A,B):-p345(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout

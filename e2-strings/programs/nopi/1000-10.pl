...
p5(A,B):-p337(A,C),p5_1(C,B).
p5_1(A,B):-skip1(A,C),p18(C,B).
p12(A,B):-p116(A,C),p12_1(C,B).
p12_1(A,B):-copy1(A,C),p421(C,B).
p13(A,B):-copy1(A,C),p13_1(C,B).
p13_1(A,B):-p83(A,C),p13_2(C,B).
p13_2(A,B):-p23(A,C),p872(C,B).
p14(A,B):-mk_lowercase(A,C),p14_1(C,B).
p14_1(A,B):-skip1(A,C),p14_2(C,B).
p14_2(A,B):-skip1(A,C),p727(C,B).
p16(A,B):-skip1(A,C),p16_1(C,B).
p16_1(A,B):-p80(A,C),p69(C,B).
...
p30_1(A,B):-p23(A,C),p911(C,B).
p33(A,B):-p981(A,C),p735(C,B).
p35(A,B):-p11(A,C),p146(C,B).
p36(A,B):-p548(A,C),p102(C,B).
...
p46_1(A,B):-p18(A,C),p46_2(C,B).
p46_2(A,B):-skip1(A,C),p19(C,B).
p47(A,B):-p244(A,C),p173(C,B).
p49(A,B):-p357(A,C),p49_1(C,B).
p49_1(A,B):-p486(A,C),p381(C,B).
p50(A,B):-p357(A,C),p80(C,B).
...
p145(A,B):-p89(A,C),p145_1(C,B).
p145_1(A,B):-p467(A,C),p37(C,B).
p147(A,B):-p342(A,C),p147_1(C,B).
p147_1(A,B):-p236(A,C),mk_uppercase(C,B).
p150(A,B):-p236(A,C),p150_1(C,B).
p150_1(A,B):-p298(A,C),copy1(C,B).
p155(A,B):-copy1(A,C),p155_1(C,B).
p155_1(A,B):-p389(A,C),p470(C,B).
p161(A,B):-skip1(A,C),p161_1(C,B).
p161_1(A,B):-p7(A,C),p161_2(C,B).
p161_2(A,B):-skip1(A,C),p17(C,B).
p164(A,B):-p154(A,C),p164_1(C,B).
p164_1(A,B):-mk_uppercase(A,C),mk_lowercase(C,B).
p168(A,B):-p490(A,C),p28(C,B).
p171(A,B):-mk_uppercase(A,C),p171_1(C,B).
p171_1(A,B):-skip1(A,C),p89(C,B).
p175(A,B):-p486(A,C),p504(C,B).
p176(A,B):-skip1(A,C),p176_1(C,B).
p176_1(A,B):-p3(A,C),p18(C,B).
...
p257_1(A,B):-skip1(A,C),p222(C,B).
p259(A,B):-skip1(A,C),p259_1(C,B).
p259_1(A,B):-p7(A,C),p259_2(C,B).
p259_2(A,B):-p544(A,C),copy1(C,B).
p260(A,B):-p83(A,C),p260_1(C,B).
p260_1(A,B):-skip1(A,C),p260_2(C,B).
p260_2(A,B):-p490(A,C),p7(C,B).
p261(A,B):-p80(A,C),p261_1(C,B).
p261_1(A,B):-skip1(A,C),p105(C,B).
p263(A,B):-p7(A,C),p8(C,B).
p264(A,B):-skip1(A,C),p264_1(C,B).
p264_1(A,B):-skip1(A,C),p84(C,B).
...
p304(A,B):-p83(A,C),p304_1(C,B).
p304_1(A,B):-skip1(A,C),p438(C,B).
...
p359_1(A,B):-p314(A,C),p413(C,B).
p361(A,B):-p352(A,C),p80(C,B).
p363(A,B):-p333(A,C),p342(C,B).
p364(A,B):-p236(A,C),p28(C,B).
p365(A,B):-p11(A,C),p365_1(C,B).
p365_1(A,B):-p201(A,C),p32(C,B).
p366(A,B):-p11(A,C),p366_1(C,B).
p366_1(A,B):-p15(A,C),p366_2(C,B).
p366_2(A,B):-skip1(A,C),p20(C,B).
...
p406(A,B):-p44(A,C),mk_lowercase(C,B).
...
p595(A,B):-p216(A,C),p595_1(C,B).
p595_1(A,B):-p438(A,C),mk_lowercase(C,B).
p598(A,B):-p342(A,C),p43(C,B).
p602(A,B):-skip1(A,C),p602_1(C,B).
p602_1(A,B):-p222(A,C),p7(C,B).
p605(A,B):-skip1(A,C),p605_1(C,B).
p605_1(A,B):-p7(A,C),p85(C,B).
p606(A,B):-p80(A,C),p126(C,B).
p610(A,B):-p11(A,C),p610_1(C,B).
p610_1(A,B):-skip1(A,C),p759(C,B).
p612(A,B):-p342(A,C),p223(C,B).
p613(A,B):-skip1(A,C),p613_1(C,B).
p613_1(A,B):-p23(A,C),p107(C,B).
p617(A,B):-p8(A,C),p15(C,B).
p617(A,B):-skip1(A,C),p617(C,B).
p621(A,B):-p381(A,C),p621_1(C,B).
p621_1(A,B):-skip1(A,C),p20(C,B).
p623(A,B):-copy1(A,C),p623_1(C,B).
p623_1(A,B):-p434(A,C),copy1(C,B).
p624(A,B):-p470(A,C),p624_1(C,B).
p624_1(A,B):-skip1(A,C),p228(C,B).
...
p631(A,B):-p357(A,C),p631_1(C,B).
p631_1(A,B):-p80(A,C),p11(C,B).
p632(A,B):-p486(A,C),p632_1(C,B).
p632_1(A,B):-p69(A,C),mk_lowercase(C,B).
p634(A,B):-copy1(A,C),p634_1(C,B).
p634_1(A,B):-p319(A,C),p7(C,B).
p636(A,B):-p636_1(A,B),is_uppercase(B).
p636_1(A,B):-skip1(A,C),p636_2(C,B).
p636_2(A,B):-p23(A,C),p135(C,B).
p641(A,B):-p8(A,C),p954(C,B).
p644(A,B):-p32(A,C),p644_1(C,B).
p644_1(A,B):-p103(A,C),p415(C,B).
p645(A,B):-p6(A,C),p43(C,B).
p648(A,B):-p105(A,C),p648_1(C,B).
p648_1(A,B):-skip1(A,C),p360(C,B).
p651(A,B):-skip1(A,C),p651_1(C,B).
p651_1(A,B):-p7(A,C),p238(C,B).
...
p692_1(A,B):-p438(A,C),p15(C,B).
p694(A,B):-p152(A,C),p421(C,B).
p695(A,B):-p105(A,C),p695_1(C,B).
p695_1(A,B):-p18(A,C),p470(C,B).
p696(A,B):-copy1(A,C),p696_1(C,B).
p696_1(A,B):-p80(A,C),p413(C,B).
p698(A,B):-mk_lowercase(A,C),p698_1(C,B).
p698_1(A,B):-skip1(A,C),p698_2(C,B).
p698_2(A,B):-p32(A,C),p17(C,B).
...
p712_1(A,B):-p28(A,C),p48(C,B).
p722(A,B):-skip1(A,C),p722_1(C,B).
p722_1(A,B):-p18(A,C),p722_2(C,B).
p722_2(A,B):-skip1(A,C),p89(C,B).
...
p768_1(A,B):-skip1(A,C),p768_2(C,B).
p768_2(A,B):-skip1(A,C),p17(C,B).
...
p775_1(A,B):-p28(A,C),p342(C,B).
p776(A,B):-p980(A,C),p776_1(C,B).
p776_1(A,B):-copy1(A,C),p244(C,B).
p779(A,B):-p607(A,C),p102(C,B).
...
p809(A,B):-p352(A,C),p23(C,B).
p813(A,B):-skip1(A,C),p813_1(C,B).
p813_1(A,B):-skip1(A,C),p813_2(C,B).
p813_2(A,B):-p438(A,C),p173(C,B).
p814(A,B):-p222(A,C),p152(C,B).
p816(A,B):-p758(A,C),p7(C,B).
p817(A,B):-p32(A,C),p817_1(C,B).
p817_1(A,B):-p85(A,C),p179(C,B).
...
p856_1(A,B):-p548(A,C),p856_2(C,B).
p856_2(A,B):-skip1(A,C),p723(C,B).
p858(A,B):-p438(A,C),p858_1(C,B).
p858_1(A,B):-mk_uppercase(A,C),p20(C,B).
...
p877(A,B):-p360(A,C),p877_1(C,B).
p877_1(A,B):-p311(A,C),copy1(C,B).
...
p889_1(A,B):-p173(A,C),p28(C,B).
p891(A,B):-p80(A,C),p733(C,B).
p892(A,B):-copy1(A,C),p892_1(C,B).
p892_1(A,B):-p116(A,C),p32(C,B).
p894(A,B):-p7(A,C),p563(C,B).
p895(A,B):-skip1(A,C),p342(C,B).
p900(A,B):-p758(A,C),p882(C,B).
p908(A,B):-p438(A,C),p17(C,B).
p909(A,B):-p11(A,C),p909_1(C,B).
p909_1(A,B):-skip1(A,C),p909_2(C,B).
p909_2(A,B):-p222(A,C),p236(C,B).
p910(A,B):-p32(A,C),p910_1(C,B).
p910_1(A,B):-p298(A,C),p7(C,B).
p912(A,B):-copy1(A,C),p912_1(C,B).
p912_1(A,B):-p17(A,C),p23(C,B).
p914(A,B):-p216(A,C),p914_1(C,B).
p914_1(A,B):-p470(A,C),p109(C,B).
...
p979(A,B):-p116(A,C),p979_1(C,B).
p979_1(A,B):-copy1(A,C),p979_2(C,B).
p979_2(A,B):-p83(A,C),mk_lowercase(C,B).
p988(A,B):-skip1(A,C),p454(C,B).
p991(A,B):-p20(A,C),p991_1(C,B).
p991_1(A,B):-p228(A,C),p23(C,B).
p995(A,B):-p342(A,C),p78(C,B).
p996(A,B):-p179(A,C),p102(C,B).
p997(A,B):-p341(A,C),p997_1(C,B).
p997_1(A,B):-p20(A,C),p80(C,B).
...
p258_2(A,B):-p263(A,C),mk_lowercase(C,B).
...
p863(A,B):-p43(A,C),p863_1(C,B).
p863_1(A,B):-p333(A,C),p863_2(C,B).
p863_2(A,B):-skip1(A,C),p470(C,B).
% asserting p258/2
% asserting p416/2
% asserting p435/2
% asserting p633/2
...
b113_1(A,B):-p470(A,C),b113_2(C,B).
b113_2(A,B):-p154(A,C),mk_uppercase(C,B).
...
%timeout
%timeout
b81(A,B):-p15(A,B),is_uppercase(B).
...
%timeout
%timeout
b224(A,B):-p137(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout

...
p21(A,B):-p155(A,C),p21_1(C,B).
p21_1(A,B):-p39(A,C),p59(C,B).
...
p122_1(A,B):-p25(A,C),p18(C,B).
p126(A,B):-mk_uppercase(A,C),p126_1(C,B).
p126_1(A,B):-skip1(A,C),p126_2(C,B).
p126_2(A,B):-skip1(A,C),p34(C,B).
...
p174_1(A,B):-p66(A,C),p174_2(C,B).
p174_2(A,B):-skip1(A,C),p60(C,B).
...
p183(A,B):-p94(A,C),p183_1(C,B).
p183_1(A,B):-skip1(A,C),p62(C,B).
p186(A,B):-p11(A,C),p186_1(C,B).
p186_1(A,B):-p12(A,C),mk_uppercase(C,B).
p187(A,B):-p132(A,C),p187_1(C,B).
p187_1(A,B):-p15(A,C),copy1(C,B).
p190(A,B):-p18(A,C),p135(C,B).
...
p99_1(A,B):-p43(A,C),p99_2(C,B).
p99_2(A,B):-skip1(A,C),p14(C,B).
% asserting p99/2
...
%timeout
%timeout
b78(A,B):-p164(A,B),is_uppercase(B).
b78(A,B):-p81(A,C),b78(C,B).
%timeout
%timeout
%timeout
%timeout

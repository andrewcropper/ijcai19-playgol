...
p42(A,B):-p379(A,C),p42_1(C,B).
p42_1(A,B):-p99(A,C),p82(C,B).
...
p48_2(A,B):-p379(A,C),p29(C,B).
p49(A,B):-p117(A,C),p1296(C,B).
p52(A,B):-p1126(A,C),p558(C,B).
p53(A,B):-skip1(A,C),p53_1(C,B).
p53_1(A,B):-p70(A,C),p117(C,B).
p55(A,B):-p407(A,C),p55_1(C,B).
p55_1(A,B):-skip1(A,C),p111(C,B).
...
p73(A,B):-p117(A,C),p73_1(C,B).
p73_1(A,B):-p155(A,C),p82(C,B).
...
p120_1(A,B):-p99(A,C),mk_lowercase(C,B).
...
p133_1(A,B):-p1114(A,C),p765(C,B).
p135(A,B):-p1176(A,C),p135_1(C,B).
p135_1(A,B):-p29(A,C),p1540(C,B).
p136(A,B):-skip1(A,C),p136_1(C,B).
p136_1(A,B):-p30(A,C),p496(C,B).
...
p240(A,B):-p1332(A,C),copy1(C,B).
p241(A,B):-p963(A,C),p344(C,B).
p242(A,B):-skip1(A,C),p242_1(C,B).
p242_1(A,B):-p309(A,C),p976(C,B).
p244(A,B):-copy1(A,C),p244_1(C,B).
p244_1(A,B):-skip1(A,C),p117(C,B).
p246(A,B):-p168(A,C),p29(C,B).
p248(A,B):-p70(A,C),p248_1(C,B).
p248_1(A,B):-skip1(A,C),p1126(C,B).
...
p259(A,B):-p6(A,C),p259_1(C,B).
p259_1(A,B):-p308(A,C),p393(C,B).
p261(A,B):-p1296(A,C),p70(C,B).
p265(A,B):-p351(A,C),p265_1(C,B).
p265_1(A,B):-copy1(A,C),p2(C,B).
p267(A,B):-p9(A,C),p30(C,B).
p272(A,B):-copy1(A,C),p272_1(C,B).
p272_1(A,B):-p222(A,C),p117(C,B).
p274(A,B):-p333(A,C),p30(C,B).
p275(A,B):-p82(A,C),p1383(C,B).
p276(A,B):-skip1(A,C),p129(C,B).
p277(A,B):-p2(A,C),p1114(C,B).
p278(A,B):-copy1(A,C),p278_1(C,B).
p278_1(A,B):-p309(A,C),p1383(C,B).
p280(A,B):-p79(A,C),p280_1(C,B).
p280_1(A,B):-skip1(A,C),p236(C,B).
p281(A,B):-skip1(A,C),p281_1(C,B).
p281_1(A,B):-skip1(A,C),p823(C,B).
p283(A,B):-p2(A,C),p142(C,B).
p286(A,B):-p1383(A,C),p286_1(C,B).
p286_1(A,B):-skip1(A,C),p70(C,B).
p288(A,B):-p13(A,C),p288_1(C,B).
p288_1(A,B):-p379(A,C),p29(C,B).
p290(A,B):-p374(A,C),p290_1(C,B).
p290_1(A,B):-p351(A,C),copy1(C,B).
p295(A,B):-p389(A,C),p70(C,B).
p296(A,B):-p82(A,C),p296_1(C,B).
p296_1(A,B):-p1005(A,C),p405(C,B).
p297(A,B):-p1380(A,C),p2(C,B).
p301(A,B):-copy1(A,C),p337(C,B).
p303(A,B):-p795(A,C),p70(C,B).
p304(A,B):-skip1(A,C),p304_1(C,B).
p304_1(A,B):-p1103(A,C),p1296(C,B).
...
p316(A,B):-p496(A,C),p309(C,B).
p318(A,B):-p99(A,C),p236(C,B).
p319(A,B):-p302(A,C),p321(C,B).
p322(A,B):-p2(A,C),p322_1(C,B).
p322_1(A,B):-p29(A,C),p322_2(C,B).
p322_2(A,B):-p222(A,C),mk_lowercase(C,B).
p324(A,B):-p1026(A,C),p29(C,B).
p325(A,B):-copy1(A,C),p325_1(C,B).
p325_1(A,B):-p30(A,C),p393(C,B).
p326(A,B):-copy1(A,C),p326_1(C,B).
p326_1(A,B):-p34(A,C),p96(C,B).
...
p338(A,B):-p633(A,C),mk_lowercase(C,B).
...
p371_1(A,B):-p309(A,C),p587(C,B).
p376(A,B):-copy1(A,C),p376_1(C,B).
p376_1(A,B):-p30(A,C),p211(C,B).
...
p411(A,B):-p496(A,C),mk_uppercase(C,B).
p412(A,B):-mk_lowercase(A,C),p412_1(C,B).
p412_1(A,B):-skip1(A,C),p1165(C,B).
...
p481_1(A,B):-p786(A,C),p393(C,B).
p482(A,B):-p1046(A,C),p482_1(C,B).
p482_1(A,B):-p82(A,C),p309(C,B).
p483(A,B):-copy1(A,C),p483_1(C,B).
p483_1(A,B):-p391(A,C),p483_2(C,B).
p483_2(A,B):-p6(A,C),p1005(C,B).
...
p494(A,B):-p795(A,C),copy1(C,B).
p494(A,B):-skip1(A,C),p494(C,B).
...
p506(A,B):-p222(A,C),p506_1(C,B).
p506_1(A,B):-p308(A,C),p1112(C,B).
p509(A,B):-p168(A,C),p6(C,B).
p512(A,B):-p1214(A,C),p512_1(C,B).
p512_1(A,B):-p610(A,C),copy1(C,B).
p515(A,B):-copy1(A,C),p558(C,B).
p520(A,B):-p1182(A,C),p88(C,B).
p521(A,B):-p879(A,C),p88(C,B).
p525(A,B):-copy1(A,C),p525_1(C,B).
p525_1(A,B):-p407(A,C),p525_2(C,B).
p525_2(A,B):-skip1(A,C),p155(C,B).
...
p537_1(A,B):-p79(A,C),p823(C,B).
p538(A,B):-skip1(A,C),p538_1(C,B).
p538_1(A,B):-p187(A,C),p64(C,B).
p541(A,B):-skip1(A,C),p1026(C,B).
p548(A,B):-mk_lowercase(A,C),p548_1(C,B).
p548_1(A,B):-skip1(A,C),p548_2(C,B).
p548_2(A,B):-p899(A,C),p187(C,B).
p550(A,B):-skip1(A,C),p550_1(C,B).
p550_1(A,B):-p21(A,C),p550_2(C,B).
p550_2(A,B):-p9(A,C),p28(C,B).
...
p571(A,B):-p64(A,C),p571_1(C,B).
p571_1(A,B):-mk_uppercase(A,C),p1112(C,B).
...
p646(A,B):-p369(A,C),p646_1(C,B).
p646_1(A,B):-p146(A,C),p309(C,B).
p647(A,B):-skip1(A,C),p647_1(C,B).
p647_1(A,B):-p309(A,C),p599(C,B).
p649(A,B):-p117(A,C),p649_1(C,B).
p649_1(A,B):-skip1(A,C),p117(C,B).
p650(A,B):-p333(A,C),p650_1(C,B).
p650_1(A,B):-p825(A,C),copy1(C,B).
...
p755(A,B):-p211(A,C),p1017(C,B).
p759(A,B):-p582(A,C),mk_lowercase(C,B).
p760(A,B):-mk_lowercase(A,C),p1491(C,B).
p764(A,B):-p69(A,C),p764_1(C,B).
p764_1(A,B):-skip1(A,C),p529(C,B).
p769(A,B):-skip1(A,C),p117(C,B).
p771(A,B):-skip1(A,C),p771_1(C,B).
p771_1(A,B):-p155(A,C),p1559(C,B).
p774(A,B):-p99(A,C),p774_1(C,B).
p774_1(A,B):-p166(A,C),copy1(C,B).
p778(A,B):-skip1(A,C),p778_1(C,B).
p778_1(A,B):-p111(A,C),p528(C,B).
...
p810_1(A,B):-skip1(A,C),p810_2(C,B).
p810_2(A,B):-skip1(A,C),p633(C,B).
...
p813_1(A,B):-p1296(A,C),p813_2(C,B).
p813_2(A,B):-skip1(A,C),p70(C,B).
...
p845(A,B):-p496(A,C),p13(C,B).
p846(A,B):-p29(A,C),p846_1(C,B).
p846_1(A,B):-p963(A,C),p309(C,B).
p849(A,B):-copy1(A,C),p599(C,B).
p851(A,B):-p29(A,C),p851_1(C,B).
p851_1(A,B):-p187(A,C),p391(C,B).
p855(A,B):-p38(A,C),p855_1(C,B).
p855_1(A,B):-skip1(A,C),p855_2(C,B).
p855_2(A,B):-skip1(A,C),p1296(C,B).
p857(A,B):-p168(A,C),p13(C,B).
...
p865_2(A,B):-p99(A,C),mk_lowercase(C,B).
p866(A,B):-p679(A,C),p236(C,B).
p874(A,B):-p29(A,C),p64(C,B).
p875(A,B):-p29(A,C),p496(C,B).
p876(A,B):-skip1(A,C),p876_1(C,B).
p876_1(A,B):-p79(A,C),p843(C,B).
p877(A,B):-p333(A,C),p877_1(C,B).
p877_1(A,B):-skip1(A,C),p787(C,B).
...
p968_1(A,B):-p1165(A,C),p968_2(C,B).
p968_2(A,B):-p222(A,C),mk_lowercase(C,B).
...
p1129(A,B):-p6(A,C),p1129_1(C,B).
p1129_1(A,B):-skip1(A,C),p787(C,B).
p1132(A,B):-p30(A,C),p961(C,B).
p1133(A,B):-p843(A,C),p77(C,B).
p1134(A,B):-p333(A,C),p117(C,B).
p1138(A,B):-skip1(A,C),p1138_1(C,B).
p1138_1(A,B):-p2(A,C),p1138_2(C,B).
p1138_2(A,B):-skip1(A,C),p9(C,B).
p1142(A,B):-p369(A,C),p1142_1(C,B).
p1142_1(A,B):-skip1(A,C),p222(C,B).
p1144(A,B):-copy1(A,C),p1144_1(C,B).
p1144_1(A,B):-p187(A,C),p558(C,B).
...
p1200_1(A,B):-p1126(A,C),copy1(C,B).
...
p1223(A,B):-p2(A,C),p1223_1(C,B).
p1223_1(A,B):-p671(A,C),p331(C,B).
p1224(A,B):-p374(A,C),p201(C,B).
p1229(A,B):-p201(A,C),p117(C,B).
p1236(A,B):-copy1(A,C),p1236_1(C,B).
p1236_1(A,B):-skip1(A,C),p1363(C,B).
...
p1329_1(A,B):-p692(A,C),p1005(C,B).
...
p1373_1(A,B):-p425(A,C),p308(C,B).
p1376(A,B):-p38(A,C),p177(C,B).
p1377(A,B):-copy1(A,C),p1377_1(C,B).
p1377_1(A,B):-p823(A,C),p28(C,B).
p1386(A,B):-p330(A,C),p1386_1(C,B).
p1386_1(A,B):-p1046(A,C),p70(C,B).
p1392(A,B):-p6(A,C),p1392_1(C,B).
p1392_1(A,B):-p624(A,C),p187(C,B).
p1395(A,B):-skip1(A,C),p1395_1(C,B).
p1395_1(A,B):-p111(A,C),p166(C,B).
...
p1430_1(A,B):-p70(A,C),p1430_2(C,B).
p1430_2(A,B):-skip1(A,C),p117(C,B).
...
p1468(A,B):-p391(A,C),p1468_1(C,B).
p1468_1(A,B):-p6(A,C),p1005(C,B).
p1469(A,B):-mk_uppercase(A,C),p1469_1(C,B).
p1469_1(A,B):-p79(A,C),p1469_2(C,B).
p1469_2(A,B):-p82(A,C),p99(C,B).
p1474(A,B):-p330(A,C),p641(C,B).
p1480(A,B):-p1349(A,C),p88(C,B).
p1482(A,B):-copy1(A,C),p153(C,B).
p1484(A,B):-p142(A,C),p374(C,B).
p1487(A,B):-copy1(A,C),p1487_1(C,B).
p1487_1(A,B):-skip1(A,C),p599(C,B).
...
p864_1(A,B):-p1112(A,C),p864_2(C,B).
p864_2(A,B):-p6(A,C),p309(C,B).
...
b307_1(A,B):-p70(A,C),skip1(C,B).
b238(A,B):-p407(A,C),b238_1(C,B).
...
%timeout
%timeout
b249(A,B):-p633(A,C),b249_1(C,B).
b249_1(A,B):-skip1(A,C),p2(C,B).
b249_1(A,B):-is_number(A),p633(A,B).

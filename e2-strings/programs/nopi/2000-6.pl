...
p62_1(A,B):-skip1(A,C),p611(C,B).
p64(A,B):-p16(A,C),p887(C,B).
p65(A,B):-p124(A,C),p65_1(C,B).
p65_1(A,B):-p190(A,C),p947(C,B).
p66(A,B):-p1908(A,C),p11(C,B).
p68(A,B):-p35(A,C),p107(C,B).
p68(A,B):-skip1(A,C),p68(C,B).
p70(A,B):-skip1(A,C),p70_1(C,B).
p70_1(A,B):-p1591(A,C),p35(C,B).
p73(A,B):-p867(A,C),p164(C,B).
p76(A,B):-p16(A,C),p1069(C,B).
p77(A,B):-p152(A,C),p77_1(C,B).
p77_1(A,B):-p248(A,C),p493(C,B).
...
p87(A,B):-p24(A,C),p87_1(C,B).
p87_1(A,B):-p365(A,C),p58(C,B).
...
p95_1(A,B):-skip1(A,C),p1337(C,B).
p96(A,B):-p44(A,C),p96_1(C,B).
p96_1(A,B):-skip1(A,C),p21(C,B).
p99(A,B):-p200(A,C),p99_1(C,B).
p99_1(A,B):-skip1(A,C),p122(C,B).
p100(A,B):-p848(A,C),p911(C,B).
p104(A,B):-p63(A,C),p1067(C,B).
p105(A,B):-p11(A,C),p105_1(C,B).
p105_1(A,B):-p40(A,C),p367(C,B).
p110(A,B):-skip1(A,C),p110_1(C,B).
p110_1(A,B):-p44(A,C),p94(C,B).
...
p118(A,B):-p226(A,C),p118_1(C,B).
p118_1(A,B):-skip1(A,C),p1409(C,B).
...
p176(A,B):-p714(A,C),p176_1(C,B).
p176_1(A,B):-skip1(A,C),p493(C,B).
p180(A,B):-skip1(A,C),p22(C,B).
p185(A,B):-p1381(A,C),p35(C,B).
p188(A,B):-p40(A,C),p503(C,B).
p189(A,B):-p30(A,C),p584(C,B).
p193(A,B):-p970(A,C),p193_1(C,B).
p193_1(A,B):-p534(A,C),p46(C,B).
...
p266_1(A,B):-p570(A,C),p211(C,B).
p268(A,B):-p44(A,C),p268_1(C,B).
p268_1(A,B):-skip1(A,C),p22(C,B).
p273(A,B):-p273_1(A,B),is_uppercase(B).
p273_1(A,B):-p1771(A,C),p249(C,B).
...
p331(A,B):-p1771(A,C),p947(C,B).
p333(A,B):-skip1(A,C),p333_1(C,B).
p333_1(A,B):-p312(A,C),p11(C,B).
p337(A,B):-skip1(A,C),p337_1(C,B).
p337_1(A,B):-p143(A,C),p337_2(C,B).
p337_2(A,B):-skip1(A,C),p200(C,B).
p341(A,B):-mk_lowercase(A,C),p341_1(C,B).
p341_1(A,B):-p143(A,C),p1220(C,B).
p343(A,B):-copy1(A,C),p982(C,B).
p348(A,B):-p154(A,C),p348_1(C,B).
p348_1(A,B):-p570(A,C),p143(C,B).
p349(A,B):-copy1(A,C),p22(C,B).
p354(A,B):-p384(A,C),p143(C,B).
p357(A,B):-p40(A,C),p357_1(C,B).
p357_1(A,B):-skip1(A,C),p357_2(C,B).
p357_2(A,B):-p83(A,C),p295(C,B).
p361(A,B):-skip1(A,C),p361_1(C,B).
p361_1(A,B):-p295(A,C),p361_2(C,B).
p361_2(A,B):-p78(A,C),p59(C,B).
...
p456(A,B):-p365(A,C),p456_1(C,B).
p456_1(A,B):-skip1(A,C),p1495(C,B).
...
p483(A,B):-p483_1(A,B),is_uppercase(B).
p483_1(A,B):-p1869(A,C),p663(C,B).
p484(A,B):-mk_lowercase(A,C),p484_1(C,B).
p484_1(A,B):-p1087(A,C),p58(C,B).
p487(A,B):-p11(A,C),p487_1(C,B).
p487_1(A,B):-p40(A,C),p487_2(C,B).
p487_2(A,B):-skip1(A,C),p89(C,B).
p492(A,B):-p970(A,C),p35(C,B).
p496(A,B):-skip1(A,C),p168(C,B).
p497(A,B):-p211(A,C),p497_1(C,B).
p497_1(A,B):-p154(A,C),p996(C,B).
p498(A,B):-p143(A,C),p320(C,B).
...
p514(A,B):-p613(A,C),p410(C,B).
p515(A,B):-copy1(A,C),p515_1(C,B).
p515_1(A,B):-p832(A,C),p113(C,B).
p517(A,B):-p69(A,C),p517_1(C,B).
p517_1(A,B):-skip1(A,C),p1070(C,B).
p519(A,B):-copy1(A,C),p613(C,B).
p521(A,B):-p35(A,C),p521_1(C,B).
p521_1(A,B):-p352(A,C),p241(C,B).
p524(A,B):-p40(A,C),p524_1(C,B).
p524_1(A,B):-p863(A,C),p16(C,B).
p525(A,B):-p384(A,C),p30(C,B).
...
p608(A,B):-p1621(A,C),p58(C,B).
p610(A,B):-p40(A,C),p231(C,B).
p616(A,B):-copy1(A,C),p616_1(C,B).
p616_1(A,B):-p222(A,C),p753(C,B).
p617(A,B):-p107(A,C),p617_1(C,B).
p617_1(A,B):-p124(A,C),p154(C,B).
p619(A,B):-skip1(A,C),p22(C,B).
p621(A,B):-p1567(A,C),p257(C,B).
p622(A,B):-p502(A,C),p46(C,B).
p625(A,B):-skip1(A,C),p625_1(C,B).
p625_1(A,B):-p35(A,C),p1509(C,B).
...
p635_1(A,B):-p485(A,C),p154(C,B).
p636(A,B):-p811(A,C),p320(C,B).
p637(A,B):-p911(A,C),p637_1(C,B).
p637_1(A,B):-skip1(A,C),p807(C,B).
p639(A,B):-p11(A,C),p613(C,B).
p641(A,B):-p365(A,C),p791(C,B).
p643(A,B):-p381(A,C),p528(C,B).
p644(A,B):-p1475(A,C),p644_1(C,B).
p644_1(A,B):-mk_lowercase(A,C),p365(C,B).
...
p870(A,B):-p143(A,C),p1205(C,B).
p871(A,B):-p78(A,C),p871_1(C,B).
p871_1(A,B):-skip1(A,C),p863(C,B).
...
p1061(A,B):-p345(A,C),p30(C,B).
p1062(A,B):-copy1(A,C),p752(C,B).
p1071(A,B):-mk_lowercase(A,C),p1071_1(C,B).
p1071_1(A,B):-skip1(A,C),p1071_2(C,B).
p1071_2(A,B):-skip1(A,C),p753(C,B).
p1074(A,B):-p78(A,C),p419(C,B).
p1075(A,B):-p143(A,C),p1075_1(C,B).
p1075_1(A,B):-p599(A,C),p338(C,B).
...
p1130(A,B):-p200(A,C),p1130_1(C,B).
p1130_1(A,B):-skip1(A,C),p48(C,B).
...
p1142_1(A,B):-skip1(A,C),p848(C,B).
p1148(A,B):-p152(A,C),p1381(C,B).
p1149(A,B):-skip1(A,C),p1149_1(C,B).
p1149_1(A,B):-p435(A,C),p30(C,B).
p1150(A,B):-p570(A,C),p613(C,B).
p1153(A,B):-copy1(A,C),p1153_1(C,B).
p1153_1(A,B):-p1409(A,C),p1153_2(C,B).
p1153_2(A,B):-p35(A,C),p154(C,B).
...
p1166(A,B):-p148(A,C),p58(C,B).
p1168(A,B):-p200(A,C),p985(C,B).
p1173(A,B):-p16(A,C),p1162(C,B).
p1179(A,B):-skip1(A,C),p1179_1(C,B).
p1179_1(A,B):-p1067(A,C),p996(C,B).
p1183(A,B):-p16(A,C),p1183_1(C,B).
p1183_1(A,B):-p338(A,C),p1347(C,B).
p1185(A,B):-p11(A,C),p1185_1(C,B).
p1185_1(A,B):-p1024(A,C),p753(C,B).
p1186(A,B):-p335(A,C),p58(C,B).
...
p1206_1(A,B):-p1024(A,C),p1206_2(C,B).
p1206_2(A,B):-p59(A,C),p162(C,B).
...
p1224_1(A,B):-skip1(A,C),p137(C,B).
...
p1238(A,B):-p16(A,C),p1238_1(C,B).
p1238_1(A,B):-skip1(A,C),p137(C,B).
p1240(A,B):-p143(A,C),p384(C,B).
p1242(A,B):-p94(A,C),p1242_1(C,B).
p1242_1(A,B):-p1087(A,C),p29(C,B).
p1247(A,B):-mk_uppercase(A,C),p1247_1(C,B).
p1247_1(A,B):-skip1(A,C),p320(C,B).
...
p1267(A,B):-p44(A,C),p1267_1(C,B).
p1267_1(A,B):-p59(A,C),p970(C,B).
p1268(A,B):-p1845(A,C),p445(C,B).
p1270(A,B):-p16(A,C),p1940(C,B).
p1271(A,B):-copy1(A,C),p1271_1(C,B).
p1271_1(A,B):-p1337(A,C),mk_uppercase(C,B).
p1274(A,B):-p867(A,C),p503(C,B).
p1278(A,B):-mk_uppercase(A,C),p1278_1(C,B).
p1278_1(A,B):-skip1(A,C),p137(C,B).
p1280(A,B):-copy1(A,C),p1280_1(C,B).
p1280_1(A,B):-p1409(A,C),p485(C,B).
p1281(A,B):-copy1(A,C),p1028(C,B).
p1282(A,B):-p365(A,C),p1282_1(C,B).
p1282_1(A,B):-skip1(A,C),p384(C,B).
p1285(A,B):-p1162(A,C),p985(C,B).
p1290(A,B):-skip1(A,C),p1290_1(C,B).
p1290_1(A,B):-p124(A,C),p728(C,B).
p1294(A,B):-p445(A,C),p235(C,B).
p1298(A,B):-p16(A,C),p1298_1(C,B).
p1298_1(A,B):-p350(A,C),p22(C,B).
p1301(A,B):-p277(A,C),p1301_1(C,B).
p1301_1(A,B):-p241(A,C),p143(C,B).
p1302(A,B):-p384(A,C),p44(C,B).
p1303(A,B):-p248(A,C),p60(C,B).
p1305(A,B):-p59(A,C),p1305_1(C,B).
p1305_1(A,B):-p270(A,C),p124(C,B).
p1307(A,B):-p350(A,C),p40(C,B).
p1314(A,B):-copy1(A,C),p1314_1(C,B).
p1314_1(A,B):-p570(A,C),p148(C,B).
p1315(A,B):-p11(A,C),p970(C,B).
p1317(A,B):-mk_uppercase(A,C),p1317_1(C,B).
p1317_1(A,B):-p53(A,C),p1738(C,B).
p1323(A,B):-p295(A,C),p1323_1(C,B).
p1323_1(A,B):-p753(A,C),p143(C,B).
p1326(A,B):-p1069(A,C),p1326_1(C,B).
p1326_1(A,B):-copy1(A,C),p60(C,B).
p1327(A,B):-mk_lowercase(A,C),p970(C,B).
p1331(A,B):-p148(A,C),p1991(C,B).
p1333(A,B):-p381(A,C),p1490(C,B).
p1336(A,B):-p40(A,C),p1336_1(C,B).
p1336_1(A,B):-p257(A,C),p534(C,B).
p1338(A,B):-p52(A,C),p30(C,B).
p1342(A,B):-p295(A,C),p1342_1(C,B).
p1342_1(A,B):-p154(A,C),p1337(C,B).
p1343(A,B):-p143(A,C),p147(C,B).
...
p1351(A,B):-p384(A,C),p44(C,B).
p1353(A,B):-p107(A,C),p152(C,B).
...
p1412_1(A,B):-p811(A,C),p48(C,B).
p1413(A,B):-copy1(A,C),p1413_1(C,B).
p1413_1(A,B):-p53(A,C),copy1(C,B).
p1414(A,B):-p295(A,C),p384(C,B).
p1415(A,B):-p124(A,C),p1415_1(C,B).
p1415_1(A,B):-p235(A,C),mk_lowercase(C,B).
...
p1438_1(A,B):-p350(A,C),p78(C,B).
p1439(A,B):-copy1(A,C),p200(C,B).
p1442(A,B):-mk_uppercase(A,C),p1442_1(C,B).
p1442_1(A,B):-p162(A,C),p248(C,B).
p1445(A,B):-p384(A,C),p40(C,B).
p1446(A,B):-p416(A,C),p985(C,B).
p1447(A,B):-p745(A,C),p22(C,B).
p1449(A,B):-p39(A,C),p1449_1(C,B).
p1449_1(A,B):-p1069(A,C),copy1(C,B).
...
p1454_1(A,B):-skip1(A,C),p807(C,B).
p1456(A,B):-skip1(A,C),p1456_1(C,B).
p1456_1(A,B):-p350(A,C),p887(C,B).
...
p1568(A,B):-p485(A,C),p1568_1(C,B).
p1568_1(A,B):-mk_lowercase(A,C),p551(C,B).
p1573(A,B):-p211(A,C),p791(C,B).
p1574(A,B):-skip1(A,C),p1574_1(C,B).
p1574_1(A,B):-p289(A,C),p89(C,B).
p1576(A,B):-p148(A,C),p350(C,B).
p1578(A,B):-p122(A,C),p1578_1(C,B).
p1578_1(A,B):-p350(A,C),mk_uppercase(C,B).
p1580(A,B):-p1205(A,C),p58(C,B).
p1583(A,B):-p200(A,C),p410(C,B).
p1585(A,B):-copy1(A,C),p1067(C,B).
p1590(A,B):-p1177(A,C),p485(C,B).
...
p1663_1(A,B):-skip1(A,C),p137(C,B).
...
p1685(A,B):-p11(A,C),p1685_1(C,B).
p1685_1(A,B):-p122(A,C),p89(C,B).
...
p1713(A,B):-p59(A,C),p1713_1(C,B).
p1713_1(A,B):-skip1(A,C),p1713_2(C,B).
p1713_2(A,B):-p435(A,C),copy1(C,B).
p1714(A,B):-p485(A,C),p381(C,B).
p1715(A,B):-p611(A,C),p83(C,B).
p1717(A,B):-copy1(A,C),p1717_1(C,B).
p1717_1(A,B):-p60(A,C),p143(C,B).
p1718(A,B):-p134(A,C),p11(C,B).
...
p1736(A,B):-p791(A,C),p44(C,B).
p1744(A,B):-p381(A,C),p584(C,B).
p1746(A,B):-p1495(A,C),p29(C,B).
...
p1772_1(A,B):-p1711(A,B),is_space(B).
p1772_1(A,B):-skip1(A,C),p1772_1(C,B).
p1773(A,B):-p152(A,C),p1773_1(C,B).
p1773_1(A,B):-p1771(A,C),p485(C,B).
p1780(A,B):-mk_lowercase(A,C),p1780_1(C,B).
p1780_1(A,B):-p106(A,C),p124(C,B).
p1781(A,B):-copy1(A,C),p1781_1(C,B).
p1781_1(A,B):-skip1(A,C),p83(C,B).
p1782(A,B):-p295(A,C),p848(C,B).
p1783(A,B):-p1409(A,C),p124(C,B).
p1783(A,B):-skip1(A,C),p1783(C,B).
p1788(A,B):-p753(A,C),p1162(C,B).
p1788(A,B):-skip1(A,C),p1788(C,B).
p1790(A,B):-skip1(A,C),p1790_1(C,B).
p1790_1(A,B):-p372(A,C),p40(C,B).
p1793(A,B):-copy1(A,C),p1793_1(C,B).
p1793_1(A,B):-p143(A,C),p200(C,B).
...
p1822(A,B):-p200(A,C),p1822_1(C,B).
p1822_1(A,B):-p58(A,C),p1822_2(C,B).
p1822_2(A,B):-p58(A,C),p295(C,B).
p1824(A,B):-p335(A,C),copy1(C,B).
p1825(A,B):-p24(A,C),p365(C,B).
p1828(A,B):-copy1(A,C),p1828_1(C,B).
p1828_1(A,B):-p309(A,C),p40(C,B).
p1829(A,B):-p1771(A,C),p1227(C,B).
p1830(A,B):-copy1(A,C),p1830_1(C,B).
p1830_1(A,B):-p40(A,C),p568(C,B).
p1832(A,B):-copy1(A,C),p22(C,B).
p1835(A,B):-copy1(A,C),p1835_1(C,B).
p1835_1(A,B):-p570(A,C),p200(C,B).
p1846(A,B):-copy1(A,C),p1846_1(C,B).
p1846_1(A,B):-p306(A,C),p40(C,B).
...
p1858(A,B):-p1069(A,C),p1858_1(C,B).
p1858_1(A,B):-mk_uppercase(A,C),p365(C,B).
...
p1891(A,B):-p16(A,C),p1891_1(C,B).
p1891_1(A,B):-skip1(A,C),p287(C,B).
p1894(A,B):-skip1(A,C),p1894_1(C,B).
p1894_1(A,B):-p807(A,C),p58(C,B).
...
p1917(A,B):-p16(A,C),p1917_1(C,B).
p1917_1(A,B):-p338(A,C),p148(C,B).
p1926(A,B):-p147(A,C),p35(C,B).
p1929(A,B):-p1673(A,C),p11(C,B).
...
p1948(A,B):-p863(A,C),p1948_1(C,B).
p1948_1(A,B):-p350(A,C),p16(C,B).
p1954(A,B):-skip1(A,C),p200(C,B).
p1957(A,B):-p502(A,C),p1452(C,B).
p1959(A,B):-p381(A,C),p1959_1(C,B).
p1959_1(A,B):-p350(A,C),mk_uppercase(C,B).
p1960(A,B):-skip1(A,C),p60(C,B).
p1961(A,B):-p148(A,C),p248(C,B).
p1967(A,B):-p94(A,C),p486(C,B).
p1969(A,B):-p842(A,C),p13(C,B).
p1974(A,B):-p248(A,C),p1974_1(C,B).
p1974_1(A,B):-skip1(A,C),p551(C,B).
p1976(A,B):-copy1(A,C),p848(C,B).
p1978(A,B):-p1067(A,C),p234(C,B).
p1983(A,B):-p148(A,C),p410(C,B).
p1984(A,B):-p58(A,C),p1984_1(C,B).
p1984_1(A,B):-p40(A,C),p970(C,B).
...
% asserting p1998/2
% depth 4
p38(A,B):-p190(A,C),p38_1(C,B).
p38_1(A,B):-p766(A,C),copy1(C,B).
p203(A,B):-p190(A,C),p203_1(C,B).
p203_1(A,B):-p903(A,C),p295(C,B).
p233(A,B):-p44(A,C),p233_1(C,B).
p233_1(A,B):-p35(A,C),p155(C,B).
...
p583(A,B):-p1413(A,C),p75(C,B).
p661(A,B):-p143(A,C),p1071(C,B).
p977(A,B):-p977_1(A,B),is_uppercase(B).
p977_1(A,B):-p410(A,C),skip1(C,B).
p977_1(A,B):-skip1(A,C),p977_1(C,B).
p1036(A,B):-p154(A,C),p903(C,B).
p1354(A,B):-p16(A,C),p1354_1(C,B).
p1354_1(A,B):-p350(A,C),p155(C,B).
p1494(A,B):-p478(A,C),copy1(C,B).
...
%timeout
%timeout
b81(A,B):-p22(A,B),is_uppercase(B).

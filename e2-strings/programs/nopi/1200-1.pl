...
p14_1(A,B):-p37(A,C),p413(C,B).
p20(A,B):-p118(A,C),p661(C,B).
p22(A,B):-copy1(A,C),p22_1(C,B).
p22_1(A,B):-p469(A,C),p69(C,B).
p26(A,B):-p189(A,C),p26_1(C,B).
p26_1(A,B):-p118(A,C),p165(C,B).
...
p50_1(A,B):-p508(A,C),mk_uppercase(C,B).
...
p59(A,B):-p69(A,C),p59_1(C,B).
p59_1(A,B):-p416(A,C),p800(C,B).
p62(A,B):-p529(A,C),p537(C,B).
p66(A,B):-mk_uppercase(A,C),p66_1(C,B).
p66_1(A,B):-p658(A,C),mk_uppercase(C,B).
p67(A,B):-p37(A,C),p614(C,B).
p68(A,B):-p161(A,C),p775(C,B).
p79(A,B):-p151(A,C),p1081(C,B).
p81(A,B):-skip1(A,C),p81_1(C,B).
p81_1(A,B):-p977(A,C),p106(C,B).
p83(A,B):-skip1(A,C),p83_1(C,B).
p83_1(A,B):-p1054(A,C),copy1(C,B).
p86(A,B):-p4(A,C),p86_1(C,B).
p86_1(A,B):-skip1(A,C),p530(C,B).
p92(A,B):-p978(A,C),p256(C,B).
...
p107_1(A,B):-p33(A,C),mk_lowercase(C,B).
...
p158_1(A,B):-p213(A,C),p158_2(C,B).
p158_2(A,B):-p417(A,C),p346(C,B).
p160(A,B):-p95(A,C),p978(C,B).
p166(A,B):-p80(A,C),p166_1(C,B).
p166_1(A,B):-skip1(A,C),p530(C,B).
p167(A,B):-p415(A,C),p446(C,B).
...
p174_1(A,B):-p37(A,C),p174_2(C,B).
p174_2(A,B):-p977(A,C),copy1(C,B).
p177(A,B):-p508(A,C),p177_1(C,B).
p177_1(A,B):-mk_uppercase(A,C),p165(C,B).
p179(A,B):-mk_lowercase(A,C),p179_1(C,B).
p179_1(A,B):-p642(A,C),p27(C,B).
p181(A,B):-p163(A,C),p37(C,B).
p182(A,B):-copy1(A,C),p182_1(C,B).
p182_1(A,B):-p69(A,C),p182_2(C,B).
p182_2(A,B):-p977(A,C),p189(C,B).
p184(A,B):-mk_uppercase(A,C),p184_1(C,B).
p184_1(A,B):-p495(A,C),mk_lowercase(C,B).
p185(A,B):-p413(A,C),p1054(C,B).
p186(A,B):-p301(A,C),p249(C,B).
p190(A,B):-p4(A,C),p530(C,B).
p193(A,B):-mk_uppercase(A,C),p193_1(C,B).
p193_1(A,B):-p150(A,C),p346(C,B).
p198(A,B):-p69(A,C),p198_1(C,B).
p198_1(A,B):-p346(A,C),p80(C,B).
p199(A,B):-p476(A,C),p150(C,B).
p202(A,B):-p80(A,C),p202_1(C,B).
p202_1(A,B):-p642(A,C),p4(C,B).
...
p223(A,B):-p529(A,C),mk_lowercase(C,B).
p223(A,B):-skip1(A,C),p223(C,B).
...
p328(A,B):-p304(A,C),p328_1(C,B).
p328_1(A,B):-p142(A,C),p69(C,B).
p330(A,B):-skip1(A,C),p330_1(C,B).
p330_1(A,B):-p312(A,C),p129(C,B).
p335(A,B):-p4(A,C),p335_1(C,B).
p335_1(A,B):-p997(A,C),p213(C,B).
...
p606_1(A,B):-skip1(A,C),p449(C,B).
p607(A,B):-p37(A,C),p607_1(C,B).
p607_1(A,B):-p977(A,C),copy1(C,B).
p610(A,B):-p1054(A,C),p413(C,B).
p612(A,B):-p977(A,C),p612_1(C,B).
p612_1(A,B):-copy1(A,C),p612_2(C,B).
p612_2(A,B):-p346(A,C),p256(C,B).
p618(A,B):-p123(A,C),p551(C,B).
p619(A,B):-p1071(A,C),p619_1(C,B).
p619_1(A,B):-p375(A,C),p69(C,B).
p622(A,B):-p978(A,C),p1152(C,B).
p630(A,B):-mk_uppercase(A,C),p978(C,B).
p632(A,B):-copy1(A,C),p632_1(C,B).
p632_1(A,B):-skip1(A,C),p1196(C,B).
p633(A,B):-skip1(A,C),p633_1(C,B).
p633_1(A,B):-p1054(A,C),p633_2(C,B).
p633_2(A,B):-p129(A,C),p106(C,B).
...
p664(A,B):-p417(A,C),p664_1(C,B).
p664_1(A,B):-p536(A,C),p69(C,B).
...
p760(A,B):-p551(A,C),p760_1(C,B).
p760_1(A,B):-p375(A,C),p103(C,B).
p764(A,B):-p290(A,C),p13(C,B).
p765(A,B):-p875(A,C),p417(C,B).
p766(A,B):-p648(A,C),p766_1(C,B).
p766_1(A,B):-skip1(A,C),p363(C,B).
p767(A,B):-p54(A,C),p767_1(C,B).
p767_1(A,B):-p417(A,C),p69(C,B).
...
p772(A,B):-p123(A,C),p69(C,B).
p773(A,B):-p1000(A,C),p773_1(C,B).
p773_1(A,B):-p52(A,C),mk_uppercase(C,B).
p777(A,B):-p332(A,C),p146(C,B).
p781(A,B):-p508(A,C),p29(C,B).
...
p909(A,B):-p6(A,C),p909_1(C,B).
p909_1(A,B):-p189(A,C),p793(C,B).
p911(A,B):-copy1(A,C),p535(C,B).
p913(A,B):-p80(A,C),p150(C,B).
p916(A,B):-p489(A,C),p106(C,B).
p917(A,B):-p165(A,C),p917_1(C,B).
p917_1(A,B):-p417(A,C),p304(C,B).
p920(A,B):-p4(A,C),p978(C,B).
p926(A,B):-p627(A,C),p80(C,B).
...
p937(A,B):-p413(A,C),p1152(C,B).
p940(A,B):-copy1(A,C),p530(C,B).
p942(A,B):-p246(A,C),p288(C,B).
p949(A,B):-p112(A,C),p417(C,B).
p952(A,B):-p991(A,C),p346(C,B).
p955(A,B):-p118(A,C),p256(C,B).
p958(A,B):-skip1(A,C),p958_1(C,B).
p958_1(A,B):-p4(A,C),p385(C,B).
p959(A,B):-p151(A,C),p69(C,B).
...
p968_1(A,B):-p165(A,C),p672(C,B).
p973(A,B):-p973_1(A,B),is_lowercase(B).
p973_1(A,B):-p346(A,C),p973_2(C,B).
p973_2(A,B):-p379(A,C),p775(C,B).
p974(A,B):-p213(A,C),p974_1(C,B).
p974_1(A,B):-p417(A,C),p80(C,B).
p975(A,B):-p213(A,C),p975_1(C,B).
p975_1(A,B):-p551(A,C),p256(C,B).
p979(A,B):-p1071(A,C),p112(C,B).
p985(A,B):-p80(A,C),p985_1(C,B).
p985_1(A,B):-p977(A,C),p985_2(C,B).
p985_2(A,B):-skip1(A,C),p4(C,B).
...
p1048_1(A,B):-p37(A,C),p614(C,B).
p1049(A,B):-mk_uppercase(A,C),p1049_1(C,B).
p1049_1(A,B):-p579(A,C),p770(C,B).
p1051(A,B):-p69(A,C),p1051_1(C,B).
p1051_1(A,B):-p978(A,C),p775(C,B).
p1053(A,B):-p69(A,C),p1163(C,B).
...
p1068(A,B):-p118(A,C),p628(C,B).
p1069(A,B):-p129(A,C),p1069_1(C,B).
p1069_1(A,B):-skip1(A,C),p614(C,B).
...
p1119(A,B):-p4(A,C),p1119_1(C,B).
p1119_1(A,B):-skip1(A,C),p530(C,B).
p1120(A,B):-p1191(A,C),p418(C,B).
p1124(A,B):-p189(A,C),p1124_1(C,B).
p1124_1(A,B):-p129(A,C),p978(C,B).
p1137(A,B):-copy1(A,C),p1137_1(C,B).
p1137_1(A,B):-skip1(A,C),p89(C,B).
p1140(A,B):-copy1(A,C),p1140_1(C,B).
p1140_1(A,B):-p28(A,C),mk_uppercase(C,B).
p1141(A,B):-skip1(A,C),p111(C,B).
p1150(A,B):-p628(A,C),p476(C,B).
...
p1162_1(A,B):-p413(A,C),p89(C,B).
p1165(A,B):-skip1(A,C),p1165_1(C,B).
p1165_1(A,B):-p65(A,C),p165(C,B).
p1166(A,B):-p93(A,C),p1166_1(C,B).
p1166_1(A,B):-p529(A,C),copy1(C,B).
p1169(A,B):-p508(A,C),p1169_1(C,B).
p1169_1(A,B):-mk_lowercase(A,C),p642(C,B).
...
p703_1(A,B):-skip1(A,C),p703_2(C,B).
p703_2(A,B):-p37(A,C),p394(C,B).
p809(A,B):-p249(A,C),p809_1(C,B).
p809_1(A,B):-skip1(A,C),p809_2(C,B).
p809_2(A,B):-p819(A,C),copy1(C,B).
...
b81(A,B):-p413(A,B),is_uppercase(B).
...
%timeout
%timeout
b4(A,B):-p417(A,C),b4_1(C,B).
b4_1(A,B):-skip1(A,B),is_empty(B).
b4_1(A,B):-p37(A,C),b4_1(C,B).
%timeout
%timeout
%timeout
%timeout

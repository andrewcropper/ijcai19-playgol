...
p28(A,B):-p293(A,C),p28_1(C,B).
p28_1(A,B):-p64(A,C),p242(C,B).
p30(A,B):-p64(A,C),p30_1(C,B).
p30_1(A,B):-p293(A,C),p69(C,B).
p31(A,B):-p399(A,C),p31_1(C,B).
p31_1(A,B):-p13(A,C),p94(C,B).
p33(A,B):-p656(A,C),p64(C,B).
...
p49_1(A,B):-p364(A,C),p49_2(C,B).
p49_2(A,B):-p746(A,C),copy1(C,B).
...
p111(A,B):-p94(A,C),p111_1(C,B).
p111_1(A,B):-p13(A,C),p127(C,B).
...
p122(A,B):-p69(A,C),p122_1(C,B).
p122_1(A,B):-p13(A,C),p115(C,B).
p124(A,B):-p272(A,C),p314(C,B).
p134(A,B):-p64(A,C),p134_1(C,B).
p134_1(A,B):-p29(A,C),p211(C,B).
p136(A,B):-p167(A,C),p211(C,B).
p139(A,B):-p40(A,C),p139_1(C,B).
p139_1(A,B):-p194(A,C),p69(C,B).
p143(A,B):-mk_lowercase(A,C),p143_1(C,B).
p143_1(A,B):-skip1(A,C),p73(C,B).
p144(A,B):-p73(A,C),p69(C,B).
p146(A,B):-skip1(A,C),p289(C,B).
p152(A,B):-mk_lowercase(A,C),p152_1(C,B).
p152_1(A,B):-p100(A,C),p83(C,B).
p153(A,B):-p69(A,C),p153_1(C,B).
p153_1(A,B):-skip1(A,C),p153_2(C,B).
p153_2(A,B):-p758(A,C),mk_lowercase(C,B).
p155(A,B):-p54(A,C),p155_1(C,B).
p155_1(A,B):-p57(A,C),p204(C,B).
p156(A,B):-p100(A,C),p5(C,B).
p161(A,B):-p89(A,C),p138(C,B).
p170(A,B):-p94(A,C),p170_1(C,B).
p170_1(A,B):-p204(A,C),p734(C,B).
p171(A,B):-copy1(A,C),p171_1(C,B).
p171_1(A,B):-skip1(A,C),p527(C,B).
p173(A,B):-p150(A,C),p173_1(C,B).
p173_1(A,B):-mk_uppercase(A,C),p275(C,B).
...
p190(A,B):-p25(A,C),p190_1(C,B).
p190_1(A,B):-p45(A,C),p204(C,B).
...
p226_1(A,B):-p204(A,C),p211(C,B).
p228(A,B):-p89(A,C),p627(C,B).
p232(A,B):-p105(A,C),p232_1(C,B).
p232_1(A,B):-p79(A,C),copy1(C,B).
p234(A,B):-p399(A,C),p349(C,B).
...
p243_1(A,B):-p39(A,C),p54(C,B).
p244(A,B):-p167(A,C),p244_1(C,B).
p244_1(A,B):-p242(A,C),p204(C,B).
p245(A,B):-p227(A,C),p245_1(C,B).
p245_1(A,B):-p69(A,C),p12(C,B).
...
p462(A,B):-p650(A,C),p462_1(C,B).
p462_1(A,B):-p219(A,C),mk_lowercase(C,B).
...
p468(A,B):-p272(A,C),p515(C,B).
p471(A,B):-p227(A,C),p471_1(C,B).
p471_1(A,B):-skip1(A,C),p364(C,B).
p475(A,B):-p57(A,C),p83(C,B).
p480(A,B):-p5(A,C),p627(C,B).
p481(A,B):-mk_lowercase(A,C),p481_1(C,B).
p481_1(A,B):-skip1(A,C),p165(C,B).
p484(A,B):-p305(A,C),p169(C,B).
p492(A,B):-skip1(A,C),p89(C,B).
p493(A,B):-p132(A,C),p493_1(C,B).
p493_1(A,B):-p69(A,C),p44(C,B).
p496(A,B):-p207(A,C),p496_1(C,B).
p496_1(A,B):-p54(A,C),mk_uppercase(C,B).
p499(A,B):-p753(A,C),p499_1(C,B).
p499_1(A,B):-p79(A,C),copy1(C,B).
p500(A,B):-p364(A,C),p500_1(C,B).
p500_1(A,B):-p349(A,C),p25(C,B).
p505(A,B):-p349(A,C),p505_1(C,B).
p505_1(A,B):-skip1(A,C),p477(C,B).
p512(A,B):-skip1(A,C),p512_1(C,B).
p512_1(A,B):-p40(A,C),p211(C,B).
...
p528(A,B):-p219(A,C),p528_1(C,B).
p528_1(A,B):-skip1(A,C),p175(C,B).
p530(A,B):-p64(A,C),p530_1(C,B).
p530_1(A,B):-p405(A,C),p530_2(C,B).
p530_2(A,B):-skip1(A,C),p29(C,B).
p531(A,B):-p527(A,C),p175(C,B).
p532(A,B):-p2(A,C),p94(C,B).
p533(A,B):-copy1(A,C),p533_1(C,B).
p533_1(A,B):-p314(A,C),p242(C,B).
p534(A,B):-mk_lowercase(A,C),p534_1(C,B).
p534_1(A,B):-skip1(A,C),p534_2(C,B).
p534_2(A,B):-skip1(A,C),p5(C,B).
p536(A,B):-skip1(A,C),p536_1(C,B).
p536_1(A,B):-p272(A,C),p167(C,B).
p537(A,B):-p515(A,C),p211(C,B).
p539(A,B):-p288(A,C),p539_1(C,B).
p539_1(A,B):-mk_uppercase(A,C),p527(C,B).
...
p571_1(A,B):-p194(A,C),p69(C,B).
p572(A,B):-skip1(A,C),p572_1(C,B).
p572_1(A,B):-p44(A,C),p399(C,B).
...
p600(A,B):-p25(A,C),p600_1(C,B).
p600_1(A,B):-p12(A,C),p680(C,B).
p606(A,B):-p219(A,C),p606_1(C,B).
p606_1(A,B):-p39(A,C),p606_2(C,B).
p606_2(A,B):-skip1(A,C),p64(C,B).
p607(A,B):-p25(A,C),p17(C,B).
p608(A,B):-p138(A,C),p242(C,B).
p610(A,B):-copy1(A,C),p89(C,B).
p611(A,B):-p527(A,C),p94(C,B).
p612(A,B):-p628(A,C),p54(C,B).
p614(A,B):-copy1(A,C),p614_1(C,B).
p614_1(A,B):-p293(A,C),p614_2(C,B).
p614_2(A,B):-p64(A,C),p150(C,B).
p616(A,B):-skip1(A,C),p616_1(C,B).
p616_1(A,B):-p81(A,C),p527(C,B).
p618(A,B):-p206(A,C),p204(C,B).
p619(A,B):-p54(A,C),p619_1(C,B).
p619_1(A,B):-mk_uppercase(A,C),p619_2(C,B).
p619_2(A,B):-skip1(A,C),p64(C,B).
p620(A,B):-p242(A,C),p620_1(C,B).
p620_1(A,B):-skip1(A,C),p64(C,B).
p624(A,B):-p13(A,C),p624_1(C,B).
p624_1(A,B):-skip1(A,C),p238(C,B).
p626(A,B):-p29(A,C),p407(C,B).
p634(A,B):-copy1(A,C),p634_1(C,B).
p634_1(A,B):-p204(A,C),p214(C,B).
...
p644(A,B):-p89(A,C),p169(C,B).
p648(A,B):-p40(A,C),p648_1(C,B).
p648_1(A,B):-skip1(A,C),p64(C,B).
...
p669_1(A,B):-p242(A,C),p89(C,B).
p670(A,B):-p293(A,C),p670_1(C,B).
p670_1(A,B):-skip1(A,C),p81(C,B).
p671(A,B):-p44(A,C),p671_1(C,B).
p671_1(A,B):-p64(A,C),p561(C,B).
p674(A,B):-skip1(A,C),p674_1(C,B).
p674_1(A,B):-skip1(A,C),p24(C,B).
p678(A,B):-p527(A,C),p678_1(C,B).
p678_1(A,B):-p81(A,C),p204(C,B).
p682(A,B):-p69(A,C),p379(C,B).
p684(A,B):-p73(A,C),p684_1(C,B).
p684_1(A,B):-p242(A,C),p684_2(C,B).
p684_2(A,B):-skip1(A,C),p64(C,B).
p685(A,B):-p65(A,C),p685_1(C,B).
p685_1(A,B):-p54(A,C),p44(C,B).
p687(A,B):-p411(A,C),p79(C,B).
p688(A,B):-mk_uppercase(A,C),p688_1(C,B).
p688_1(A,B):-p753(A,C),p64(C,B).
p689(A,B):-skip1(A,C),p689_1(C,B).
p689_1(A,B):-p347(A,C),p13(C,B).
...
p703(A,B):-p89(A,C),p40(C,B).
p705(A,B):-p138(A,C),p204(C,B).
p707(A,B):-mk_uppercase(A,C),p707_1(C,B).
p707_1(A,B):-p293(A,C),p165(C,B).
p711(A,B):-mk_lowercase(A,C),p711_1(C,B).
p711_1(A,B):-p21(A,C),copy1(C,B).
p712(A,B):-p527(A,C),p25(C,B).
p717(A,B):-p44(A,C),p717_1(C,B).
p717_1(A,B):-mk_lowercase(A,C),p753(C,B).
...
p726_1(A,B):-p219(A,C),p5(C,B).
p732(A,B):-mk_lowercase(A,C),p732_1(C,B).
p732_1(A,B):-p100(A,C),mk_uppercase(C,B).
p733(A,B):-p82(A,C),p733_1(C,B).
p733_1(A,B):-p356(A,C),mk_lowercase(C,B).
p739(A,B):-copy1(A,C),p739_1(C,B).
p739_1(A,B):-p12(A,C),p656(C,B).
p740(A,B):-p138(A,C),p498(C,B).
p741(A,B):-p741_1(A,B),is_number(B).
p741_1(A,B):-p81(A,C),p764(C,B).
p741_1(A,B):-skip1(A,C),p741_1(C,B).
p749(A,B):-p50(A,C),p64(C,B).
p752(A,B):-p25(A,C),p752_1(C,B).
p752_1(A,B):-skip1(A,C),p5(C,B).
...
p765_1(A,B):-mk_uppercase(A,C),p765_2(C,B).
p765_2(A,B):-skip1(A,C),p29(C,B).
p766(A,B):-p5(A,C),p766_1(C,B).
p766_1(A,B):-p668(A,C),p150(C,B).
p769(A,B):-p511(A,C),p167(C,B).
p777(A,B):-mk_uppercase(A,C),p777_1(C,B).
p777_1(A,B):-p206(A,C),p777_2(C,B).
p777_2(A,B):-skip1(A,C),p141(C,B).
...
p327_2(A,B):-p701(A,C),p64(C,B).
p391(A,B):-not_empty(A),p183(A,B).
p397(A,B):-p434(A,C),p397_1(C,B).
p397_1(A,B):-copy1(A,C),p29(C,B).
p409(A,B):-p280(A,C),copy1(C,B).
p449(A,B):-p619(A,C),p64(C,B).
p497(A,B):-p434(A,C),p497_1(C,B).
p497_1(A,B):-p64(A,C),p668(C,B).
...
%timeout
%timeout
b249(A,B):-p43(A,C),b249_1(C,B).
b249_1(A,B):-skip1(A,C),p54(C,B).
b249_1(A,B):-is_number(A),p43(A,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p527(A,B),is_uppercase(B).

...
p1_2(A,B):-skip1(A,C),p995(C,B).
p6(A,B):-p413(A,C),p6_1(C,B).
p6_1(A,B):-mk_uppercase(A,C),p688(C,B).
p11(A,B):-skip1(A,C),p11_1(C,B).
p11_1(A,B):-p413(A,C),p995(C,B).
p12(A,B):-skip1(A,C),p12_1(C,B).
p12_1(A,B):-p153(A,C),p5(C,B).
...
p42(A,B):-p114(A,C),p42_1(C,B).
p42_1(A,B):-p89(A,C),p5(C,B).
...
p62(A,B):-p98(A,C),p62_1(C,B).
p62_1(A,B):-copy1(A,C),p137(C,B).
...
p83_1(A,B):-p177(A,C),p530(C,B).
p84(A,B):-p114(A,C),p191(C,B).
p85(A,B):-skip1(A,C),p85_1(C,B).
p85_1(A,B):-p7(A,C),p5(C,B).
p106(A,B):-p16(A,C),p106_1(C,B).
p106_1(A,B):-p8(A,C),p962(C,B).
p112(A,B):-skip1(A,C),p61(C,B).
p116(A,B):-skip1(A,C),p116_1(C,B).
p116_1(A,B):-p681(A,C),mk_uppercase(C,B).
p118(A,B):-copy1(A,C),p962(C,B).
p119(A,B):-p176(A,C),p119_1(C,B).
p119_1(A,B):-p3(A,C),p800(C,B).
p122(A,B):-skip1(A,C),p122_1(C,B).
p122_1(A,B):-p343(A,C),p122_2(C,B).
p122_2(A,B):-p343(A,C),p23(C,B).
p126(A,B):-p5(A,C),p205(C,B).
p140(A,B):-skip1(A,C),p121(C,B).
p145(A,B):-copy1(A,C),p145_1(C,B).
p145_1(A,B):-p101(A,C),p773(C,B).
p147(A,B):-p30(A,C),p147_1(C,B).
p147_1(A,B):-p995(A,C),p114(C,B).
p150(A,B):-p114(A,C),p590(C,B).
p151(A,B):-p101(A,C),p5(C,B).
...
p169_1(A,B):-p559(A,C),p169_2(C,B).
p169_2(A,B):-p127(A,C),p96(C,B).
p173(A,B):-copy1(A,C),p127(C,B).
p180(A,B):-skip1(A,C),p800(C,B).
p188(A,B):-skip1(A,C),p188_1(C,B).
p188_1(A,B):-p103(A,C),p188_2(C,B).
p188_2(A,B):-p121(A,C),p559(C,B).
p189(A,B):-p177(A,C),p189_1(C,B).
p189_1(A,B):-p503(A,C),p343(C,B).
...
p218(A,B):-p127(A,C),p218_1(C,B).
p218_1(A,B):-p200(A,C),p16(C,B).
p219(A,B):-copy1(A,C),p212(C,B).
p223(A,B):-skip1(A,C),p993(C,B).
p225(A,B):-p89(A,C),p497(C,B).
p226(A,B):-p226_1(A,C),p226_2(C,B).
p226_1(A,B):-p226_2(A,C),p868(C,B).
p226_2(A,B):-skip1(A,C),p5(C,B).
...
p365(A,B):-p607(A,C),p16(C,B).
p367(A,B):-skip1(A,C),p367_1(C,B).
p367_1(A,B):-p36(A,C),p566(C,B).
p368(A,B):-p16(A,C),p368_1(C,B).
p368_1(A,B):-p924(A,C),mk_lowercase(C,B).
p369(A,B):-copy1(A,C),p369_1(C,B).
p369_1(A,B):-p191(A,C),p718(C,B).
...
p427_1(A,B):-p201(A,C),p75(C,B).
p438(A,B):-p662(A,C),p637(C,B).
p440(A,B):-mk_uppercase(A,C),p440_1(C,B).
p440_1(A,B):-p662(A,C),mk_lowercase(C,B).
...
p454(A,B):-p217(A,C),p454_1(C,B).
p454_1(A,B):-skip1(A,C),p16(C,B).
p456(A,B):-skip1(A,C),p205(C,B).
p459(A,B):-p114(A,C),p200(C,B).
p460(A,B):-copy1(A,C),p460_1(C,B).
p460_1(A,B):-skip1(A,C),p460_2(C,B).
p460_2(A,B):-skip1(A,C),p631(C,B).
p465(A,B):-copy1(A,C),p465_1(C,B).
p465_1(A,B):-p217(A,C),p465_2(C,B).
p465_2(A,B):-p16(A,C),p30(C,B).
...
p487_1(A,B):-p103(A,C),p566(C,B).
p488(A,B):-p467(A,C),p488_1(C,B).
p488_1(A,B):-mk_lowercase(A,C),p146(C,B).
...
p601_1(A,B):-p661(A,C),p114(C,B).
p603(A,B):-p176(A,C),p603_1(C,B).
p603_1(A,B):-p5(A,C),p130(C,B).
p604(A,B):-skip1(A,C),p604_1(C,B).
p604_1(A,B):-skip1(A,C),p604_2(C,B).
p604_2(A,B):-p497(A,C),p30(C,B).
p610(A,B):-copy1(A,C),p610_1(C,B).
p610_1(A,B):-skip1(A,C),p66(C,B).
p610_1(A,B):-p343(A,C),p610_1(C,B).
p614(A,B):-p208(A,C),p34(C,B).
p622(A,B):-p349(A,C),p5(C,B).
...
p638(A,B):-p545(A,C),p638_1(C,B).
p638_1(A,B):-mk_lowercase(A,C),p114(C,B).
...
p677_1(A,B):-skip1(A,C),p343(C,B).
p678(A,B):-p121(A,C),p413(C,B).
p679(A,B):-p176(A,C),p679_1(C,B).
p679_1(A,B):-p773(A,C),p745(C,B).
...
p692_1(A,B):-p220(A,C),p692_2(C,B).
p692_2(A,B):-p16(A,C),p8(C,B).
p693(A,B):-p66(A,C),p121(C,B).
p694(A,B):-p30(A,C),p607(C,B).
p698(A,B):-p497(A,C),p698_1(C,B).
p698_1(A,B):-mk_lowercase(A,C),p200(C,B).
p702(A,B):-copy1(A,C),p702_1(C,B).
p702_1(A,B):-p962(A,C),copy1(C,B).
p704(A,B):-copy1(A,C),p356(C,B).
p705(A,B):-copy1(A,C),p705_1(C,B).
p705_1(A,B):-p439(A,C),p176(C,B).
p706(A,B):-p688(A,C),p3(C,B).
...
p761_1(A,B):-p590(A,C),p761_2(C,B).
p761_2(A,B):-p68(A,C),p5(C,B).
p772(A,B):-skip1(A,C),p772_1(C,B).
p772_1(A,B):-p418(A,C),p127(C,B).
p776(A,B):-p631(A,C),p343(C,B).
...
p786_1(A,B):-p962(A,C),p617(C,B).
p787(A,B):-p34(A,C),p191(C,B).
p788(A,B):-skip1(A,C),p661(C,B).
p789(A,B):-p661(A,C),p176(C,B).
p790(A,B):-p101(A,C),p16(C,B).
p791(A,B):-p114(A,C),p617(C,B).
p792(A,B):-copy1(A,C),p792_1(C,B).
p792_1(A,B):-p205(A,C),p792_2(C,B).
p792_2(A,B):-skip1(A,C),p418(C,B).
p794(A,B):-copy1(A,C),p139(C,B).
p797(A,B):-p387(A,C),p8(C,B).
...
p871_1(A,B):-skip1(A,C),p26(C,B).
p874(A,B):-p995(A,C),p835(C,B).
p878(A,B):-p114(A,C),p878_1(C,B).
p878_1(A,B):-p205(A,C),p168(C,B).
p882(A,B):-p467(A,C),p882_1(C,B).
p882_1(A,B):-p149(A,C),mk_uppercase(C,B).
p884(A,B):-p736(A,C),p884_1(C,B).
p884_1(A,B):-skip1(A,C),p467(C,B).
p885(A,B):-p61(A,C),p205(C,B).
p888(A,B):-skip1(A,C),p888_1(C,B).
p888_1(A,B):-p744(A,C),mk_lowercase(C,B).
p889(A,B):-skip1(A,C),p889_1(C,B).
p889_1(A,B):-p16(A,C),p868(C,B).
...
p898(A,B):-p912(A,C),p418(C,B).
p899(A,B):-p33(A,C),copy1(C,B).
p901(A,B):-p127(A,C),p16(C,B).
p904(A,B):-copy1(A,C),p823(C,B).
p905(A,B):-p176(A,C),p905_1(C,B).
p905_1(A,B):-p503(A,C),p343(C,B).
p907(A,B):-p30(A,C),p907_1(C,B).
p907_1(A,B):-p101(A,C),p177(C,B).
p908(A,B):-copy1(A,C),p908_1(C,B).
p908_1(A,B):-p467(A,C),p908_2(C,B).
p908_2(A,B):-p724(A,C),p5(C,B).
...
p946_1(A,B):-p5(A,C),p139(C,B).
p947(A,B):-p121(A,C),p287(C,B).
...
p997(A,B):-p640(A,C),p208(C,B).
p998(A,B):-skip1(A,C),p998_1(C,B).
p998_1(A,B):-p5(A,C),p800(C,B).
% asserting p1/2
% asserting p6/2
% asserting p11/2
% asserting p12/2
...
p13_1(A,B):-p631(A,C),p13_2(C,B).
p13_2(A,B):-p5(A,C),p262(C,B).
p51(A,B):-p51_1(A,B),is_number(B).
p51_1(A,B):-p173(A,C),p199(C,B).
p355(A,B):-p921(A,C),p355_1(C,B).
p355_1(A,B):-mk_lowercase(A,C),p355_2(C,B).
p355_2(A,B):-skip1(A,C),p343(C,B).
p540(A,B):-skip1(A,C),p540_1(C,B).
p540_1(A,B):-p217(A,C),p474(C,B).
% asserting p13/2
% asserting p51/2
% asserting p355/2
% asserting p540/2
...
b81(A,B):-p127(A,B),is_uppercase(B).

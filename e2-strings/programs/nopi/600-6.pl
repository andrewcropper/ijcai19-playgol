...
p3_2(A,B):-p537(A,C),p57(C,B).
p6(A,B):-p142(A,C),p6_1(C,B).
p6_1(A,B):-p49(A,C),p113(C,B).
p12(A,B):-skip1(A,C),p12_1(C,B).
p12_1(A,B):-skip1(A,C),p232(C,B).
p14(A,B):-p113(A,C),p14_1(C,B).
p14_1(A,B):-p143(A,C),p60(C,B).
p18(A,B):-p10(A,C),p18_1(C,B).
p18_1(A,B):-p85(A,C),mk_lowercase(C,B).
p23(A,B):-p20(A,C),p299(C,B).
p25(A,B):-p65(A,C),p25_1(C,B).
p25_1(A,B):-p28(A,C),p1(C,B).
p32(A,B):-skip1(A,C),p32_1(C,B).
p32_1(A,B):-p57(A,C),p16(C,B).
...
p204_1(A,B):-skip1(A,C),p204_2(C,B).
p204_2(A,B):-skip1(A,C),p234(C,B).
p209(A,B):-skip1(A,C),p93(C,B).
p211(A,B):-copy1(A,C),p211_1(C,B).
p211_1(A,B):-p275(A,C),p60(C,B).
...
p225_1(A,B):-p111(A,C),p225_2(C,B).
p225_2(A,B):-p65(A,C),p131(C,B).
p226(A,B):-copy1(A,C),p226_1(C,B).
p226_1(A,B):-p474(A,C),p17(C,B).
p227(A,B):-p17(A,C),p227_1(C,B).
p227_1(A,B):-p65(A,C),p17(C,B).
p229(A,B):-p56(A,C),p235(C,B).
...
p287(A,B):-mk_uppercase(A,C),p83(C,B).
p287(A,B):-skip1(A,C),p287(C,B).
p289(A,B):-p303(A,C),p289_1(C,B).
p289_1(A,B):-p65(A,C),p289_2(C,B).
p289_2(A,B):-skip1(A,C),p1(C,B).
...
p524(A,B):-p56(A,C),p17(C,B).
p525(A,B):-p28(A,C),p525_1(C,B).
p525_1(A,B):-p1(A,C),p62(C,B).
...
p559_1(A,B):-p79(A,C),p559_2(C,B).
p559_2(A,B):-skip1(A,C),p5(C,B).
p560(A,B):-p560_1(A,C),p350(C,B).
p560_1(A,B):-is_number(A),p234(A,B).
p560_1(A,B):-skip1(A,C),p560_1(C,B).
p563(A,B):-p235(A,C),p53(C,B).
p564(A,B):-mk_uppercase(A,C),p564_1(C,B).
p564_1(A,B):-p186(A,C),p350(C,B).
p573(A,B):-p113(A,C),p20(C,B).
p576(A,B):-p234(A,C),p576_1(C,B).
p576_1(A,B):-p537(A,C),copy1(C,B).
p577(A,B):-skip1(A,C),p577_1(C,B).
p577_1(A,B):-p36(A,C),p21(C,B).
p581(A,B):-p1(A,C),p581_1(C,B).
p581_1(A,B):-skip1(A,C),p116(C,B).
...
p588(A,B):-p88(A,C),p234(C,B).
p589(A,B):-p28(A,C),p310(C,B).
p590(A,B):-skip1(A,C),p93(C,B).
p591(A,B):-p546(A,C),p591_1(C,B).
p591_1(A,B):-skip1(A,C),p62(C,B).
p592(A,B):-skip1(A,C),p592_1(C,B).
p592_1(A,B):-p85(A,C),p592_2(C,B).
p592_2(A,B):-mk_lowercase(A,C),p10(C,B).
p595(A,B):-mk_uppercase(A,C),p595_1(C,B).
p595_1(A,B):-p235(A,C),p595_2(C,B).
p595_2(A,B):-p1(A,C),p85(C,B).
p597(A,B):-p31(A,C),p13(C,B).
...
p188_1(A,B):-p247(A,C),p188_2(C,B).
p188_2(A,B):-p209(A,C),p71(C,B).
p431(A,B):-p1(A,C),p431_1(C,B).
p431_1(A,B):-p209(A,C),p431_2(C,B).
p431_2(A,B):-skip1(A,C),p1(C,B).
...
%timeout
%timeout
b188(A,B):-p4(A,C),b188_1(C,B).
b188_1(A,B):-skip1(A,C),p4(C,B).
%timeout
%timeout
%timeout
%timeout

...
p8_1(A,B):-p184(A,C),mk_uppercase(C,B).
...
p11_2(A,B):-p133(A,C),mk_uppercase(C,B).
...
p57_2(A,B):-p133(A,C),copy1(C,B).
p63(A,B):-p21(A,C),p63_1(C,B).
p63_1(A,B):-mk_lowercase(A,C),copy1(C,B).
p68(A,B):-copy1(A,C),p68_1(C,B).
p68_1(A,B):-copy1(A,C),p69(C,B).
p70(A,B):-skip1(A,C),p70_1(C,B).
p70_1(A,B):-p30(A,C),p70_2(C,B).
p70_2(A,B):-p3(A,C),mk_uppercase(C,B).
...
p86_1(A,B):-p30(A,C),p52(C,B).
p87(A,B):-p73(A,C),p87_1(C,B).
p87_1(A,B):-p140(A,C),copy1(C,B).
...
p110(A,B):-p73(A,C),p110_1(C,B).
p110_1(A,B):-p25(A,C),p133(C,B).
p115(A,B):-p34(A,C),p115_1(C,B).
p115_1(A,B):-p188(A,C),copy1(C,B).
p117(A,B):-p34(A,C),p117_1(C,B).
p117_1(A,B):-p40(A,C),p3(C,B).
p119(A,B):-mk_lowercase(A,C),p119_1(C,B).
p119_1(A,B):-skip1(A,C),p78(C,B).
p123(A,B):-p137(A,C),p34(C,B).
...
p181_1(A,B):-p30(A,C),p181_2(C,B).
p181_2(A,B):-p52(A,C),p85(C,B).
p183(A,B):-p52(A,C),p183_1(C,B).
p183_1(A,B):-p3(A,C),mk_uppercase(C,B).
p186(A,B):-p137(A,C),p30(C,B).
...
p191_1(A,B):-mk_uppercase(A,C),p191_2(C,B).
p191_2(A,B):-p30(A,C),p30(C,B).
p193(A,B):-p73(A,C),p193_1(C,B).
p193_1(A,B):-p40(A,C),p192(C,B).
p198(A,B):-p150(A,C),p198_1(C,B).
p198_1(A,B):-skip1(A,C),p3(C,B).
p199(A,B):-p52(A,C),p199_1(C,B).
p199_1(A,B):-p76(A,C),p199_2(C,B).
p199_2(A,B):-p43(A,C),p30(C,B).
...
b327(A,B):-copy1(A,C),b327_1(C,B).
b327_1(A,B):-skip1(A,B),is_number(B).
b327_1(A,B):-b327_2(A,C),b327_1(C,B).
b327_2(A,B):-p34(A,B),not_number(B).
%timeout
%timeout
%timeout
%timeout
...
b293_2(A,B):-is_lowercase(A),p34(A,B).
%timeout
%timeout
%timeout
%timeout
...
b113_1(A,B):-p69(A,C),b113_2(C,B).
b113_2(A,B):-skip1(A,C),p98(C,B).
%timeout
%timeout
%timeout
%timeout

...
p3(A,B):-p37(A,C),p3_1(C,B).
p3_1(A,B):-skip1(A,C),p150(C,B).
p4(A,B):-p2(A,C),p4_1(C,B).
p4_1(A,B):-skip1(A,C),p420(C,B).
p6(A,B):-p74(A,C),p6_1(C,B).
p6_1(A,B):-p616(A,C),mk_uppercase(C,B).
...
p109_1(A,B):-p153(A,B),is_lowercase(B).
...
p221_1(A,B):-p7(A,C),p1188(C,B).
p222(A,B):-p1079(A,C),p23(C,B).
p223(A,B):-copy1(A,C),p223_1(C,B).
p223_1(A,B):-p145(A,C),p1021(C,B).
...
p288_1(A,B):-p118(A,C),p288_2(C,B).
p288_2(A,B):-p63(A,C),p8(C,B).
...
p339_1(A,B):-p346(A,C),copy1(C,B).
p340(A,B):-mk_uppercase(A,C),p340_1(C,B).
p340_1(A,B):-p160(A,C),p889(C,B).
...
p356_1(A,B):-skip1(A,C),p942(C,B).
p359(A,B):-p127(A,C),p359_1(C,B).
p359_1(A,B):-skip1(A,C),p1275(C,B).
p360(A,B):-p1273(A,C),p17(C,B).
p372(A,B):-skip1(A,C),p372_1(C,B).
p372_1(A,B):-p1521(A,C),p616(C,B).
p374(A,B):-skip1(A,C),p381(C,B).
p374(A,B):-p2(A,C),p374(C,B).
p375(A,B):-p7(A,C),p662(C,B).
p379(A,B):-skip1(A,C),p379_1(C,B).
p379_1(A,B):-p439(A,C),p1255(C,B).
p380(A,B):-skip1(A,C),p380_1(C,B).
p380_1(A,B):-p841(A,C),p40(C,B).
p382(A,B):-p428(A,C),p127(C,B).
p383(A,B):-p31(A,C),p383_1(C,B).
p383_1(A,B):-p78(A,C),mk_lowercase(C,B).
...
p452(A,B):-p8(A,C),p452_1(C,B).
p452_1(A,B):-p446(A,C),p14(C,B).
...
p455_1(A,B):-p848(A,C),p1012(C,B).
p456(A,B):-p889(A,C),copy1(C,B).
p457(A,B):-copy1(A,C),p1275(C,B).
p459(A,B):-p8(A,C),p168(C,B).
p465(A,B):-p802(A,C),p465_1(C,B).
p465_1(A,B):-p1059(A,C),p127(C,B).
...
p476(A,B):-p118(A,C),p476_1(C,B).
p476_1(A,B):-p40(A,C),mk_lowercase(C,B).
p478(A,B):-p17(A,C),p478_1(C,B).
p478_1(A,B):-skip1(A,C),p1323(C,B).
p484(A,B):-p21(A,C),p503(C,B).
p486(A,B):-p548(A,C),p486_1(C,B).
p486_1(A,B):-p116(A,C),mk_lowercase(C,B).
p488(A,B):-p178(A,C),p27(C,B).
p492(A,B):-mk_lowercase(A,C),p492_1(C,B).
p492_1(A,B):-p802(A,C),p820(C,B).
...
p509(A,B):-p7(A,C),p327(C,B).
p509(A,B):-skip1(A,C),p509(C,B).
p511(A,B):-p914(A,C),p511_1(C,B).
p511_1(A,B):-p90(A,C),p14(C,B).
p512(A,B):-p23(A,C),p1567(C,B).
p513(A,B):-p458(A,C),mk_uppercase(C,B).
...
p526(A,B):-p2(A,C),p526_1(C,B).
p526_1(A,B):-p7(A,C),p1445(C,B).
p528(A,B):-p8(A,C),p528_1(C,B).
p528_1(A,B):-p548(A,C),p17(C,B).
p529(A,B):-skip1(A,C),p420(C,B).
p532(A,B):-p914(A,C),p428(C,B).
p533(A,B):-p144(A,C),p7(C,B).
p535(A,B):-p27(A,C),p1273(C,B).
p539(A,B):-p428(A,C),p539_1(C,B).
p539_1(A,B):-skip1(A,C),p327(C,B).
p540(A,B):-p178(A,C),p540_1(C,B).
p540_1(A,B):-p768(A,C),copy1(C,B).
p542(A,B):-mk_uppercase(A,C),p542_1(C,B).
p542_1(A,B):-p41(A,C),p616(C,B).
...
p572_1(A,B):-p268(A,C),p918(C,B).
p573(A,B):-p17(A,C),p573_1(C,B).
p573_1(A,B):-p40(A,C),p2(C,B).
p577(A,B):-p1211(A,C),p577_1(C,B).
p577_1(A,B):-skip1(A,C),p298(C,B).
p583(A,B):-p1230(A,C),p636(C,B).
p589(A,B):-p127(A,C),p449(C,B).
p591(A,B):-p428(A,C),p106(C,B).
p594(A,B):-skip1(A,C),p594_1(C,B).
p594_1(A,B):-p636(A,C),p14(C,B).
p602(A,B):-p208(A,C),p1695(C,B).
p604(A,B):-p203(A,C),p74(C,B).
p606(A,B):-p249(A,C),p606_1(C,B).
p606_1(A,B):-p168(A,C),p40(C,B).
p608(A,B):-p848(A,C),p63(C,B).
p612(A,B):-copy1(A,C),p612_1(C,B).
p612_1(A,B):-p145(A,C),p609(C,B).
p613(A,B):-copy1(A,C),p863(C,B).
p615(A,B):-p241(A,C),p96(C,B).
p617(A,B):-p90(A,C),p617_1(C,B).
p617_1(A,B):-p875(A,C),mk_lowercase(C,B).
p619(A,B):-p119(A,C),p2(C,B).
p621(A,B):-p79(A,C),p871(C,B).
...
p668_1(A,B):-p1329(A,C),p668_2(C,B).
p668_2(A,B):-skip1(A,C),p14(C,B).
p669(A,B):-p145(A,C),p669_1(C,B).
p669_1(A,B):-p839(A,C),p14(C,B).
p670(A,B):-skip1(A,C),p498(C,B).
p671(A,B):-p17(A,C),p113(C,B).
p672(A,B):-p7(A,C),p672_1(C,B).
p672_1(A,B):-skip1(A,C),p458(C,B).
p675(A,B):-p90(A,C),p675_1(C,B).
p675_1(A,B):-p7(A,C),p1421(C,B).
...
p694(A,B):-p21(A,C),p694_1(C,B).
p694_1(A,B):-p145(A,C),p691(C,B).
p699(A,B):-skip1(A,C),p699_1(C,B).
p699_1(A,B):-skip1(A,C),p57(C,B).
p701(A,B):-p168(A,C),p23(C,B).
p708(A,B):-p327(A,C),p708_1(C,B).
p708_1(A,B):-p44(A,C),p446(C,B).
p709(A,B):-skip1(A,C),p709_1(C,B).
p709_1(A,B):-p118(A,C),p420(C,B).
p711(A,B):-p2(A,C),p208(C,B).
p715(A,B):-p215(A,C),p127(C,B).
p716(A,B):-p106(A,C),p716_1(C,B).
p716_1(A,B):-mk_lowercase(A,C),p63(C,B).
p720(A,B):-p420(A,C),p720_1(C,B).
p720_1(A,B):-skip1(A,C),p586(C,B).
p721(A,B):-p7(A,C),p432(C,B).
p722(A,B):-copy1(A,C),p722_1(C,B).
p722_1(A,B):-p1850(A,C),mk_lowercase(C,B).
p724(A,B):-p875(A,C),p2(C,B).
p726(A,B):-p2(A,C),p168(C,B).
p727(A,B):-p31(A,C),p727_1(C,B).
p727_1(A,B):-p616(A,C),p63(C,B).
p733(A,B):-p215(A,C),p127(C,B).
...
p744(A,B):-p178(A,C),p744_1(C,B).
p744_1(A,B):-mk_lowercase(A,C),p168(C,B).
...
p767_1(A,B):-p839(A,C),mk_lowercase(C,B).
p772(A,B):-p428(A,C),p7(C,B).
p773(A,B):-p99(A,C),p773_1(C,B).
p773_1(A,B):-skip1(A,C),p773_2(C,B).
p773_2(A,B):-skip1(A,C),p214(C,B).
p779(A,B):-p63(A,C),p779_1(C,B).
p779_1(A,B):-p74(A,C),p789(C,B).
p780(A,B):-p8(A,C),p970(C,B).
p781(A,B):-p357(A,C),p781_1(C,B).
p781_1(A,B):-p21(A,C),p957(C,B).
...
p823(A,B):-p7(A,C),p823_1(C,B).
p823_1(A,B):-p8(A,C),p420(C,B).
...
p851(A,B):-p851_1(A,B),not_letter(B).
p851_1(A,B):-p839(A,C),p1992(C,B).
p852(A,B):-copy1(A,C),p1066(C,B).
p853(A,B):-p1176(A,C),p31(C,B).
p854(A,B):-copy1(A,C),p854_1(C,B).
p854_1(A,B):-p1661(A,C),p118(C,B).
p855(A,B):-p875(A,C),mk_uppercase(C,B).
...
p867_1(A,B):-p1255(A,C),p2(C,B).
p868(A,B):-p914(A,C),p63(C,B).
p870(A,B):-p844(A,C),p127(C,B).
...
p956_1(A,B):-p247(A,C),mk_lowercase(C,B).
p960(A,B):-copy1(A,C),p960_1(C,B).
p960_1(A,B):-p268(A,C),p802(C,B).
...
p1026_1(A,B):-p900(A,C),p79(C,B).
p1029(A,B):-mk_lowercase(A,C),p1029_1(C,B).
p1029_1(A,B):-p684(A,C),p268(C,B).
p1031(A,B):-p2(A,C),p1031_1(C,B).
p1031_1(A,B):-p1570(A,C),p2(C,B).
...
p1049_1(A,B):-p1445(A,C),p460(C,B).
p1056(A,B):-p118(A,C),p1056_1(C,B).
p1056_1(A,B):-p327(A,C),p598(C,B).
...
p1068(A,B):-p1296(A,C),p616(C,B).
p1076(A,B):-skip1(A,C),p1076_1(C,B).
p1076_1(A,B):-p497(A,C),p8(C,B).
p1083(A,B):-p31(A,C),p1083_1(C,B).
p1083_1(A,B):-p305(A,C),p2(C,B).
...
p1139_1(A,B):-p548(A,C),p1188(C,B).
p1145(A,B):-p1296(A,C),p127(C,B).
...
p1191(A,B):-p362(A,C),p802(C,B).
p1192(A,B):-p241(A,C),p127(C,B).
p1199(A,B):-skip1(A,C),p1199_1(C,B).
p1199_1(A,B):-skip1(A,C),p863(C,B).
p1201(A,B):-p844(A,C),p168(C,B).
p1206(A,B):-p23(A,C),p1206_1(C,B).
p1206_1(A,B):-p718(A,C),mk_lowercase(C,B).
p1208(A,B):-p439(A,C),p40(C,B).
p1209(A,B):-p1329(A,C),p1443(C,B).
p1212(A,B):-skip1(A,C),p1212_1(C,B).
p1212_1(A,B):-p249(A,C),p863(C,B).
p1213(A,B):-mk_lowercase(A,C),p1213_1(C,B).
p1213_1(A,B):-p127(A,C),p1213_2(C,B).
p1213_2(A,B):-skip1(A,C),p875(C,B).
p1215(A,B):-p14(A,C),p1215_1(C,B).
p1215_1(A,B):-skip1(A,C),p210(C,B).
...
p1245_1(A,B):-skip1(A,C),p1245_2(C,B).
p1245_2(A,B):-p57(A,C),p7(C,B).
p1249(A,B):-skip1(A,C),p1170(C,B).
p1249(A,B):-skip1(A,C),p1249(C,B).
p1253(A,B):-p432(A,C),p127(C,B).
...
p1266_1(A,B):-p848(A,C),p458(C,B).
p1267(A,B):-p116(A,C),p127(C,B).
p1268(A,B):-p428(A,C),p1268_1(C,B).
p1268_1(A,B):-skip1(A,C),p446(C,B).
p1270(A,B):-p2(A,C),p1270_1(C,B).
p1270_1(A,B):-p875(A,C),p2(C,B).
p1271(A,B):-p8(A,C),p1570(C,B).
p1276(A,B):-p8(A,C),p1276_1(C,B).
p1276_1(A,B):-skip1(A,C),p29(C,B).
p1277(A,B):-copy1(A,C),p168(C,B).
p1283(A,B):-p1176(A,C),p27(C,B).
p1285(A,B):-p2(A,C),p1285_1(C,B).
p1285_1(A,B):-skip1(A,C),p463(C,B).
...
p1311(A,B):-p8(A,C),p1311_1(C,B).
p1311_1(A,B):-p170(A,C),p17(C,B).
...
p1321(A,B):-p357(A,C),p1321_1(C,B).
p1321_1(A,B):-p268(A,C),p768(C,B).
p1324(A,B):-copy1(A,C),p1324_1(C,B).
p1324_1(A,B):-p106(A,C),mk_lowercase(C,B).
p1327(A,B):-p1970(A,C),mk_lowercase(C,B).
...
p1351_1(A,B):-p261(A,C),p17(C,B).
p1352(A,B):-p249(A,C),p1027(C,B).
p1353(A,B):-p357(A,C),p1353_1(C,B).
p1353_1(A,B):-p933(A,B),is_number(B).
p1353_1(A,B):-skip1(A,C),p1353_1(C,B).
p1354(A,B):-p31(A,C),p1354_1(C,B).
p1354_1(A,B):-p14(A,C),p362(C,B).
...
p1415(A,B):-p1296(A,C),p90(C,B).
p1417(A,B):-copy1(A,C),p1417_1(C,B).
p1417_1(A,B):-p616(A,C),p1417_2(C,B).
p1417_2(A,B):-skip1(A,C),p96(C,B).
...
p1469_1(A,B):-skip1(A,C),p45(C,B).
p1473(A,B):-copy1(A,C),p1473_1(C,B).
p1473_1(A,B):-p1255(A,C),p214(C,B).
p1475(A,B):-mk_lowercase(A,C),p1475_1(C,B).
p1475_1(A,B):-p127(A,C),p624(C,B).
p1476(A,B):-skip1(A,C),p1476_1(C,B).
p1476_1(A,B):-p8(A,C),p99(C,B).
p1478(A,B):-skip1(A,C),p1478_1(C,B).
p1478_1(A,B):-skip1(A,C),p1478_2(C,B).
p1478_2(A,B):-skip1(A,C),p420(C,B).
...
p1550(A,B):-p1211(A,C),p1550_1(C,B).
...
p1578_1(A,B):-p1255(A,C),p1578_2(C,B).
p1578_2(A,B):-skip1(A,C),p289(C,B).
...
p1595(A,B):-p118(A,C),p210(C,B).
p1596(A,B):-p802(A,C),p933(C,B).
p1600(A,B):-p1170(A,C),p1600_1(C,B).
p1600_1(A,B):-skip1(A,C),p802(C,B).
p1603(A,B):-mk_uppercase(A,C),p160(C,B).
p1610(A,B):-p1329(A,C),p458(C,B).
p1611(A,B):-p1474(A,C),p127(C,B).
...
p1665_1(A,B):-p548(A,C),p160(C,B).
p1668(A,B):-skip1(A,C),p1668_1(C,B).
p1668_1(A,B):-p7(A,C),p106(C,B).
p1671(A,B):-p2(A,C),p1671_1(C,B).
p1671_1(A,B):-p327(A,C),p289(C,B).
p1674(A,B):-p682(A,C),p357(C,B).
...
p1689_1(A,B):-skip1(A,C),p45(C,B).
p1690(A,B):-p1460(A,C),p37(C,B).
...
p1744(A,B):-p802(A,C),p1965(C,B).
p1746(A,B):-skip1(A,C),p1181(C,B).
p1747(A,B):-p23(A,C),p1445(C,B).
p1750(A,B):-p1409(A,C),p1409(C,B).
...
p1790(A,B):-p118(A,C),p718(C,B).
p1791(A,B):-p2(A,C),p1791_1(C,B).
p1791_1(A,B):-p679(A,C),p2(C,B).
p1794(A,B):-skip1(A,C),p1794_1(C,B).
p1794_1(A,B):-p249(A,C),p1794_2(C,B).
p1794_2(A,B):-p691(A,C),p127(C,B).
p1797(A,B):-p449(A,C),p2(C,B).
p1798(A,B):-copy1(A,C),p1798_1(C,B).
p1798_1(A,B):-p1247(A,C),p178(C,B).
p1800(A,B):-p718(A,C),p208(C,B).
p1805(A,B):-p839(A,C),p830(C,B).
p1809(A,B):-p458(A,C),p1809_1(C,B).
p1809_1(A,B):-skip1(A,C),p1255(C,B).
p1810(A,B):-copy1(A,C),p498(C,B).
p1811(A,B):-p118(A,C),p1296(C,B).
p1814(A,B):-p178(A,C),p106(C,B).
p1820(A,B):-p637(A,C),p1820_1(C,B).
p1820_1(A,B):-p616(A,C),mk_lowercase(C,B).
p1827(A,B):-mk_uppercase(A,C),p420(C,B).
p1833(A,B):-skip1(A,C),p1833_1(C,B).
p1833_1(A,B):-p327(A,C),p458(C,B).
p1837(A,B):-p616(A,C),p710(C,B).
p1838(A,B):-p629(A,C),p662(C,B).
p1843(A,B):-p8(A,C),p1843_1(C,B).
p1843_1(A,B):-p430(A,C),p214(C,B).
p1847(A,B):-p118(A,C),p1847_1(C,B).
p1847_1(A,B):-p14(A,C),p875(C,B).
p1860(A,B):-p21(A,C),p203(C,B).
p1862(A,B):-copy1(A,C),p1862_1(C,B).
p1862_1(A,B):-p434(A,C),copy1(C,B).
...
p1898(A,B):-p1445(A,C),p1898_1(C,B).
p1898_1(A,B):-p718(A,C),mk_lowercase(C,B).
p1901(A,B):-mk_uppercase(A,C),p168(C,B).
p1905(A,B):-p178(A,C),p419(C,B).
p1908(A,B):-p23(A,C),p863(C,B).
p1910(A,B):-copy1(A,C),p1910_1(C,B).
p1910_1(A,B):-p127(A,C),p1910_2(C,B).
p1910_2(A,B):-p889(A,C),mk_uppercase(C,B).
...
p1927(A,B):-p268(A,C),p548(C,B).
p1932(A,B):-p1275(A,B),is_uppercase(B).
p1932(A,B):-skip1(A,C),p1932(C,B).
...
p211_1(A,B):-p14(A,C),p211_2(C,B).
p211_2(A,B):-p1224(A,C),mk_lowercase(C,B).
p336(A,B):-copy1(A,C),p336_1(C,B).
p336_1(A,B):-skip1(A,C),p1641(C,B).
p368(A,B):-skip1(A,C),p368_1(C,B).
p368_1(A,B):-skip1(A,C),p1689(C,B).
p653(A,B):-p1455(A,C),p616(C,B).
p993(A,B):-skip1(A,C),p993_1(C,B).
p993_1(A,B):-p17(A,C),p1689(C,B).
p1035(A,B):-skip1(A,C),p1035_1(C,B).
p1035_1(A,B):-p459(A,C),p1445(C,B).
p1140(A,B):-p1140_1(A,C),mk_lowercase(C,B).
p1140_1(A,B):-p214(A,C),p7(C,B).
p1140_1(A,B):-skip1(A,C),p1140_1(C,B).
p1262(A,B):-copy1(A,C),p1478(C,B).
p1491(A,B):-p2(A,C),p1491_1(C,B).
p1491_1(A,B):-skip1(A,C),p1235(C,B).
p1929(A,B):-p8(A,C),p1929_1(C,B).
p1929_1(A,B):-p1132(A,C),mk_lowercase(C,B).
p1969(A,B):-skip1(A,C),p1969_1(C,B).
p1969_1(A,B):-skip1(A,C),p1969_2(C,B).
p1969_2(A,B):-p298(A,C),p14(C,B).
% asserting p211/2
% asserting p336/2
% asserting p368/2
% asserting p653/2
...
%timeout
%timeout
b309(A,B):-p458(A,C),b309_1(C,B).
b309_1(A,B):-skip1(A,C),p458(C,B).
%timeout
%timeout
%timeout
%timeout
...
b63_1(A,B):-p1765(A,C),p2(C,B).
%timeout
%timeout
%timeout
b113(A,B):-mk_uppercase(A,C),b113_1(C,B).
b113_1(A,B):-p214(A,C),b113_2(C,B).
b113_2(A,B):-skip1(A,C),p430(C,B).
%timeout
...
b136_1(A,B):-p1239(A,C),b136_2(C,B).
b136_2(A,B):-p2(A,C),skip1(C,B).
%timeout
%timeout
%timeout
%timeout

...
p51(A,B):-p104(A,C),p51_1(C,B).
p51_1(A,B):-skip1(A,C),p334(C,B).
p54(A,B):-p15(A,C),p54_1(C,B).
p54_1(A,B):-p106(A,C),p110(C,B).
p58(A,B):-copy1(A,C),p58_1(C,B).
p58_1(A,B):-p421(A,C),p58_2(C,B).
p58_2(A,B):-p248(A,C),p40(C,B).
p59(A,B):-p354(A,C),p59_1(C,B).
p59_1(A,B):-mk_lowercase(A,C),p570(C,B).
...
p76(A,B):-p15(A,C),p76_1(C,B).
p76_1(A,B):-p232(A,C),p256(C,B).
p78(A,B):-mk_lowercase(A,C),p78_1(C,B).
p78_1(A,B):-p177(A,C),p157(C,B).
...
p128(A,B):-p264(A,C),p128_1(C,B).
p128_1(A,B):-p40(A,C),p300(C,B).
p131(A,B):-p131_1(A,C),p462(C,B).
p131_1(A,B):-p107(A,C),p97(C,B).
p131_1(A,B):-skip1(A,C),p131_1(C,B).
p133(A,B):-skip1(A,C),p817(C,B).
p135(A,B):-skip1(A,C),p135_1(C,B).
p135_1(A,B):-p92(A,C),p334(C,B).
p137(A,B):-p562(A,C),p137_1(C,B).
p137_1(A,B):-mk_uppercase(A,C),p15(C,B).
p142(A,B):-skip1(A,C),p142_1(C,B).
p142_1(A,B):-p97(A,C),p648(C,B).
p143(A,B):-p420(A,C),p62(C,B).
p144(A,B):-copy1(A,C),p144_1(C,B).
p144_1(A,B):-p398(A,C),p18(C,B).
p145(A,B):-copy1(A,C),p145_1(C,B).
p145_1(A,B):-p205(A,C),p40(C,B).
...
p210(A,B):-p106(A,C),p210_1(C,B).
p210_1(A,B):-mk_uppercase(A,C),p15(C,B).
p211(A,B):-p15(A,C),p211_1(C,B).
p211_1(A,B):-p886(A,C),copy1(C,B).
p214(A,B):-copy1(A,C),p648(C,B).
p216(A,B):-copy1(A,C),p216_1(C,B).
p216_1(A,B):-p65(A,C),p608(C,B).
...
p224_1(A,B):-skip1(A,C),p87(C,B).
p230(A,B):-mk_lowercase(A,C),p230_1(C,B).
p230_1(A,B):-skip1(A,C),p675(C,B).
...
p339_2(A,B):-p104(A,C),p248(C,B).
p341(A,B):-is_uppercase(A),p182(A,B).
p341(A,B):-skip1(A,C),p341(C,B).
p346(A,B):-copy1(A,C),p805(C,B).
p347(A,B):-p493(A,C),p347_1(C,B).
p347_1(A,B):-p490(A,C),p125(C,B).
...
p391(A,B):-p15(A,C),p391_1(C,B).
p391_1(A,B):-p16(A,C),p529(C,B).
p392(A,B):-mk_lowercase(A,C),p392_1(C,B).
p392_1(A,B):-p570(A,C),p223(C,B).
...
p403_1(A,B):-p421(A,C),p231(C,B).
p408(A,B):-p223(A,C),p187(C,B).
p409(A,B):-p62(A,C),p886(C,B).
p410(A,B):-p775(A,C),p410_1(C,B).
p410_1(A,B):-p162(A,C),copy1(C,B).
p424(A,B):-mk_uppercase(A,C),p996(C,B).
p425(A,B):-p505(A,C),mk_uppercase(C,B).
...
p470(A,B):-p368(A,C),p97(C,B).
p470(A,B):-skip1(A,C),p470(C,B).
p472(A,B):-p193(A,C),p472_1(C,B).
p472_1(A,B):-p368(A,C),p15(C,B).
p473(A,B):-p248(A,C),p473_1(C,B).
p473_1(A,B):-skip1(A,C),p516(C,B).
p476(A,B):-p613(A,C),p231(C,B).
...
p483_1(A,B):-p223(A,C),p157(C,B).
p484(A,B):-p27(A,C),p986(C,B).
p486(A,B):-p97(A,C),p486_1(C,B).
p486_1(A,B):-p104(A,C),p486_2(C,B).
p486_2(A,B):-p65(A,C),p193(C,B).
...
p507_1(A,B):-p62(A,C),p312(C,B).
p511(A,B):-p14(A,C),p511_1(C,B).
p511_1(A,B):-skip1(A,C),p163(C,B).
...
p677_2(A,B):-p351(A,C),p878(C,B).
p678(A,B):-mk_lowercase(A,C),p516(C,B).
p680(A,B):-p232(A,C),p680_1(C,B).
p680_1(A,B):-skip1(A,C),p527(C,B).
...
p758(A,B):-p334(A,C),p758_1(C,B).
p758_1(A,B):-p15(A,C),p281(C,B).
p763(A,B):-mk_uppercase(A,C),p763_1(C,B).
p763_1(A,B):-skip1(A,C),p763_2(C,B).
p763_2(A,B):-p351(A,C),p186(C,B).
...
p771(A,B):-p15(A,C),p771_1(C,B).
p771_1(A,B):-p177(A,C),p15(C,B).
...
p807_1(A,B):-p264(A,C),p468(C,B).
p811(A,B):-p32(A,C),p811_1(C,B).
p811_1(A,B):-mk_uppercase(A,C),p18(C,B).
p812(A,B):-p97(A,C),p368(C,B).
p816(A,B):-p334(A,C),p816_1(C,B).
p816_1(A,B):-skip1(A,C),p343(C,B).
...
p827_2(A,B):-p104(A,C),mk_uppercase(C,B).
p828(A,B):-p15(A,C),p516(C,B).
p829(A,B):-p562(A,C),p193(C,B).
p830(A,B):-p991(A,C),p16(C,B).
p831(A,B):-p205(A,C),p516(C,B).
p835(A,B):-copy1(A,C),p835_1(C,B).
p835_1(A,B):-p92(A,C),p835_2(C,B).
p835_2(A,B):-p106(A,C),p248(C,B).
p837(A,B):-p837_1(A,B),is_number(B).
p837_1(A,B):-copy1(A,C),p877(C,B).
p839(A,B):-p775(A,C),p862(C,B).
p841(A,B):-p103(A,C),p841_1(C,B).
p841_1(A,B):-p223(A,C),p841_2(C,B).
p841_2(A,B):-p648(A,C),p15(C,B).
p844(A,B):-copy1(A,C),p844_1(C,B).
p844_1(A,B):-p16(A,C),p343(C,B).
p847(A,B):-p334(A,C),p847_1(C,B).
p847_1(A,B):-p163(A,C),mk_uppercase(C,B).
p849(A,B):-p468(A,C),p849_1(C,B).
p849_1(A,B):-skip1(A,C),p125(C,B).
p853(A,B):-skip1(A,C),p853_1(C,B).
p853_1(A,B):-p862(A,C),p16(C,B).
p854(A,B):-p104(A,C),p16(C,B).
p856(A,B):-p648(A,C),p27(C,B).
...
p868(A,B):-p281(A,C),p334(C,B).
p870(A,B):-p819(A,C),p870_1(C,B).
p870_1(A,B):-skip1(A,C),p493(C,B).
p872(A,B):-mk_lowercase(A,C),p903(C,B).
p881(A,B):-p886(A,C),p40(C,B).
p887(A,B):-p887_1(A,B),is_number(B).
p887_1(A,B):-p182(A,C),p887_2(C,B).
p887_2(A,B):-p103(A,C),p421(C,B).
p888(A,B):-p312(A,C),p300(C,B).
p891(A,B):-p16(A,C),p891_1(C,B).
p891_1(A,B):-p106(A,C),p398(C,B).
p892(A,B):-p892_1(A,B),is_lowercase(B).
p892_1(A,B):-p281(A,C),p223(C,B).
...
p905_1(A,B):-p231(A,C),p65(C,B).
p907(A,B):-p27(A,C),p907_1(C,B).
p907_1(A,B):-skip1(A,C),p991(C,B).
p908(A,B):-p14(A,C),p908_1(C,B).
p908_1(A,B):-p462(A,C),p256(C,B).
p911(A,B):-p16(A,C),p911_1(C,B).
p911_1(A,B):-p862(A,C),p334(C,B).
p914(A,B):-mk_lowercase(A,C),p516(C,B).
p921(A,B):-p40(A,C),p921_1(C,B).
p921_1(A,B):-p177(A,C),p15(C,B).
p922(A,B):-p256(A,C),p123(C,B).
p925(A,B):-p106(A,C),p925_1(C,B).
p925_1(A,B):-skip1(A,C),p62(C,B).
p928(A,B):-p505(A,C),p468(C,B).
p935(A,B):-p205(A,C),p407(C,B).
p936(A,B):-p186(A,C),p13(C,B).
p938(A,B):-p464(A,C),p938_1(C,B).
p938_1(A,B):-skip1(A,C),p938_2(C,B).
p938_2(A,B):-p464(A,C),p256(C,B).
p939(A,B):-p367(A,C),p939_1(C,B).
p939_1(A,B):-p14(A,C),p727(C,B).
p940(A,B):-p516(A,C),p16(C,B).
p942(A,B):-p15(A,C),p783(C,B).
p943(A,B):-p187(A,C),p15(C,B).
p947(A,B):-p334(A,C),p15(C,B).
p947(A,B):-p248(A,C),p947(C,B).
p950(A,B):-copy1(A,C),p290(C,B).
p953(A,B):-skip1(A,C),p953_1(C,B).
p953_1(A,B):-p162(A,C),p903(C,B).
p954(A,B):-copy1(A,C),p954_1(C,B).
p954_1(A,B):-p256(A,C),p516(C,B).
p955(A,B):-p97(A,C),p110(C,B).
p956(A,B):-p256(A,C),p956_1(C,B).
p956_1(A,B):-skip1(A,C),p334(C,B).
p957(A,B):-copy1(A,C),p957_1(C,B).
p957_1(A,B):-p300(A,C),p231(C,B).
p958(A,B):-p205(A,C),p62(C,B).
p959(A,B):-skip1(A,C),p959_1(C,B).
p959_1(A,B):-p351(A,C),p27(C,B).
p960(A,B):-p17(A,C),p205(C,B).
p963(A,B):-p256(A,C),p963_1(C,B).
p963_1(A,B):-skip1(A,C),p202(C,B).
...
b113_1(A,B):-p193(A,C),b113_2(C,B).
b113_2(A,B):-p529(A,C),mk_uppercase(C,B).
...
b215_1(A,B):-is_uppercase(A),p72(A,B).
b215_1(A,B):-skip1(A,C),b215_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b56(A,B):-p170(A,C),b56_1(C,B).
b56_1(A,B):-skip1(A,B),is_empty(B).
b56_1(A,B):-p97(A,C),b56_1(C,B).
%timeout
%timeout
%timeout
b78(A,B):-p562(A,B),is_uppercase(B).
b78(A,B):-p97(A,C),b78(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b309(A,B):-p72(A,C),b309_1(C,B).
b309_1(A,B):-skip1(A,C),p72(C,B).
%timeout
b241(A,B):-p72(A,C),p97(C,B).
%timeout
%timeout
%timeout
%timeout
...
b224_1(A,B):-p529(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b48(A,B):-p16(A,C),b48_1(C,B).
b48_1(A,B):-p334(A,C),p193(C,B).
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p516(A,B),is_uppercase(B).
...
b249_1(A,B):-p16(A,C),b249_2(C,B).
b249_2(A,B):-skip1(A,C),p72(C,B).
%timeout
%timeout
%timeout

...
p2_1(A,B):-p280(A,C),p2_2(C,B).
p2_2(A,B):-p237(A,C),p12(C,B).
...
p16_1(A,B):-p231(A,C),p248(C,B).
p17(A,B):-skip1(A,C),p17_1(C,B).
p17_1(A,B):-p12(A,C),p444(C,B).
p18(A,B):-p48(A,C),p18_1(C,B).
p18_1(A,B):-p565(A,C),p5(C,B).
p23(A,B):-p231(A,C),p23_1(C,B).
p23_1(A,B):-p603(A,C),copy1(C,B).
p25(A,B):-copy1(A,C),p25_1(C,B).
p25_1(A,B):-p544(A,C),p3(C,B).
p26(A,B):-p718(A,C),p12(C,B).
...
p101_1(A,B):-p115(A,C),p101_2(C,B).
p101_2(A,B):-skip1(A,C),p12(C,B).
...
p118_1(A,B):-p62(A,C),p118_2(C,B).
p118_2(A,B):-p76(A,C),mk_uppercase(C,B).
p119(A,B):-mk_uppercase(A,C),p227(C,B).
p120(A,B):-skip1(A,C),p120_1(C,B).
p120_1(A,B):-p27(A,C),p565(C,B).
p125(A,B):-copy1(A,C),p125_1(C,B).
p125_1(A,B):-p544(A,C),p339(C,B).
...
p157_1(A,B):-p1139(A,C),p157_2(C,B).
p157_2(A,B):-skip1(A,C),p284(C,B).
...
p300_1(A,B):-p681(A,C),p227(C,B).
p304(A,B):-skip1(A,C),p304_1(C,B).
p304_1(A,B):-p269(A,C),p22(C,B).
...
p311_1(A,B):-p38(A,C),p765(C,B).
p314(A,B):-copy1(A,C),p314_1(C,B).
p314_1(A,B):-skip1(A,C),p333(C,B).
p319(A,B):-p887(A,C),mk_uppercase(C,B).
p320(A,B):-p22(A,C),p320_1(C,B).
p320_1(A,B):-p504(A,C),p22(C,B).
p321(A,B):-p102(A,C),p321_1(C,B).
p321_1(A,B):-p875(A,C),p248(C,B).
p323(A,B):-p851(A,C),p411(C,B).
p331(A,B):-p279(A,C),p4(C,B).
p337(A,B):-p5(A,C),p231(C,B).
p340(A,B):-copy1(A,C),p340_1(C,B).
p340_1(A,B):-p71(A,C),p70(C,B).
p341(A,B):-p137(A,C),p78(C,B).
p343(A,B):-copy1(A,C),p343_1(C,B).
p343_1(A,B):-p565(A,C),p22(C,B).
p351(A,B):-p48(A,C),p56(C,B).
p352(A,B):-copy1(A,C),p352_1(C,B).
p352_1(A,B):-p851(A,C),p115(C,B).
p353(A,B):-skip1(A,C),p353_1(C,B).
p353_1(A,B):-p22(A,C),p235(C,B).
p362(A,B):-skip1(A,C),p362_1(C,B).
p362_1(A,B):-skip1(A,C),p411(C,B).
p363(A,B):-p6(A,C),p279(C,B).
p366(A,B):-p1106(A,C),p366_1(C,B).
p366_1(A,B):-p69(A,C),p366_2(C,B).
...
p391_1(A,B):-p80(A,C),p799(C,B).
p392(A,B):-p269(A,C),p635(C,B).
p394(A,B):-p620(A,C),p12(C,B).
p398(A,B):-copy1(A,C),p398_1(C,B).
p398_1(A,B):-p237(A,C),p78(C,B).
...
p446(A,B):-p465(A,C),p446_1(C,B).
p446_1(A,B):-skip1(A,C),p374(C,B).
p448(A,B):-copy1(A,C),p603(C,B).
p456(A,B):-p62(A,C),p12(C,B).
p462(A,B):-p237(A,C),p462_1(C,B).
p462_1(A,B):-p22(A,C),p840(C,B).
p463(A,B):-p48(A,C),p611(C,B).
p470(A,B):-p106(A,C),p1071(C,B).
p472(A,B):-skip1(A,C),p336(C,B).
p474(A,B):-p76(A,C),p474_1(C,B).
p474_1(A,B):-mk_uppercase(A,C),p857(C,B).
p478(A,B):-p248(A,C),p478_1(C,B).
p478_1(A,B):-skip1(A,C),p401(C,B).
p482(A,B):-skip1(A,C),p55(C,B).
p483(A,B):-skip1(A,C),p483_1(C,B).
p483_1(A,B):-p27(A,C),p799(C,B).
...
p495_1(A,B):-p22(A,C),p495_2(C,B).
p495_2(A,B):-p1106(A,C),p69(C,B).
...
p545_1(A,B):-p12(A,C),p545_2(C,B).
p545_2(A,B):-p799(A,C),p182(C,B).
...
p567_1(A,B):-mk_uppercase(A,C),p48(C,B).
p570(A,B):-p201(A,C),p570_1(C,B).
p570_1(A,B):-p765(A,C),p19(C,B).
p573(A,B):-copy1(A,C),p573_1(C,B).
p573_1(A,B):-p76(A,C),p182(C,B).
p575(A,B):-p24(A,C),p55(C,B).
p580(A,B):-mk_uppercase(A,C),p580_1(C,B).
p580_1(A,B):-p673(A,C),p78(C,B).
p581(A,B):-p231(A,C),p6(C,B).
p582(A,B):-p565(A,C),p582_1(C,B).
p582_1(A,B):-mk_uppercase(A,C),p76(C,B).
...
p696(A,B):-p585(A,C),p696_1(C,B).
p696_1(A,B):-p69(A,C),p115(C,B).
p697(A,B):-p27(A,C),p697_1(C,B).
p697_1(A,B):-p6(A,C),mk_uppercase(C,B).
p703(A,B):-p71(A,C),p703_1(C,B).
p703_1(A,B):-skip1(A,C),p24(C,B).
p709(A,B):-p339(A,C),p493(C,B).
...
p717_1(A,B):-p667(A,C),mk_uppercase(C,B).
p719(A,B):-p6(A,C),p719_1(C,B).
p719_1(A,B):-p69(A,C),p231(C,B).
p721(A,B):-mk_lowercase(A,C),p721_1(C,B).
p721_1(A,B):-p69(A,C),p829(C,B).
p723(A,B):-p48(A,C),p923(C,B).
p724(A,B):-p19(A,C),p76(C,B).
p725(A,B):-p12(A,C),p725_1(C,B).
p725_1(A,B):-p586(A,C),p62(C,B).
...
p739_1(A,B):-p863(A,C),p12(C,B).
p740(A,B):-p492(A,C),p102(C,B).
...
p756_1(A,B):-p231(A,C),p756_2(C,B).
p756_2(A,B):-p225(A,C),p102(C,B).
p757(A,B):-copy1(A,C),p757_1(C,B).
p757_1(A,B):-skip1(A,C),p432(C,B).
...
p830(A,B):-p24(A,C),p830_1(C,B).
p830_1(A,B):-mk_lowercase(A,C),p799(C,B).
p832(A,B):-p179(A,C),p799(C,B).
p839(A,B):-p70(A,C),p1106(C,B).
p843(A,B):-skip1(A,C),p137(C,B).
p845(A,B):-mk_uppercase(A,C),p776(C,B).
p848(A,B):-p271(A,C),p848_1(C,B).
p848_1(A,B):-p76(A,C),mk_uppercase(C,B).
...
p883(A,B):-p603(A,C),p48(C,B).
p890(A,B):-skip1(A,C),p890_1(C,B).
p890_1(A,B):-p69(A,C),p890_2(C,B).
p890_2(A,B):-skip1(A,C),p565(C,B).
...
p904_1(A,B):-p237(A,C),p904_2(C,B).
p904_2(A,B):-p374(A,C),p115(C,B).
p906(A,B):-skip1(A,C),p235(C,B).
p912(A,B):-p336(A,C),p1071(C,B).
p913(A,B):-p27(A,C),p493(C,B).
p915(A,B):-p620(A,C),copy1(C,B).
...
p950(A,B):-p1130(A,C),mk_uppercase(C,B).
...
p954(A,B):-p78(A,C),p954_1(C,B).
p954_1(A,B):-p231(A,C),p13(C,B).
p955(A,B):-copy1(A,C),p231(C,B).
p959(A,B):-copy1(A,C),p959_1(C,B).
p959_1(A,B):-p78(A,C),p794(C,B).
p960(A,B):-p78(A,C),p271(C,B).
p963(A,B):-p12(A,C),p963_1(C,B).
p963_1(A,B):-skip1(A,C),p158(C,B).
p964(A,B):-p76(A,C),p887(C,B).
p968(A,B):-copy1(A,C),p439(C,B).
p971(A,B):-p401(A,B),is_uppercase(B).
p971(A,B):-skip1(A,C),p971(C,B).
p976(A,B):-copy1(A,C),p976_1(C,B).
p976_1(A,B):-p80(A,C),p1059(C,B).
p978(A,B):-copy1(A,C),p978_1(C,B).
p978_1(A,B):-skip1(A,C),p776(C,B).
p979(A,B):-mk_uppercase(A,C),p979_1(C,B).
p979_1(A,B):-p237(A,C),p979_2(C,B).
p979_2(A,B):-p12(A,C),p225(C,B).
...
p986(A,B):-p169(A,C),p986_1(C,B).
p986_1(A,B):-p24(A,C),mk_lowercase(C,B).
...
p996_1(A,B):-p22(A,C),p333(C,B).
p998(A,B):-p586(A,C),p94(C,B).
p1001(A,B):-p48(A,C),p1153(C,B).
p1004(A,B):-p384(A,C),p78(C,B).
p1006(A,B):-p365(A,C),p1006_1(C,B).
p1006_1(A,B):-p374(A,C),p5(C,B).
...
p1015_1(A,B):-p620(A,C),p225(C,B).
p1016(A,B):-p12(A,C),p493(C,B).
p1018(A,B):-copy1(A,C),p1018_1(C,B).
p1018_1(A,B):-p13(A,C),p231(C,B).
...
p1022_1(A,B):-skip1(A,C),p735(C,B).
p1023(A,B):-skip1(A,C),p1023_1(C,B).
p1023_1(A,B):-p231(A,C),p1084(C,B).
p1025(A,B):-p38(A,C),p19(C,B).
p1027(A,B):-p13(A,C),p1027_1(C,B).
p1027_1(A,B):-skip1(A,C),p12(C,B).
p1028(A,B):-copy1(A,C),p1028_1(C,B).
p1028_1(A,B):-p36(A,C),p681(C,B).
p1029(A,B):-skip1(A,C),p1029_1(C,B).
p1029_1(A,B):-p374(A,C),p1029_2(C,B).
p1029_2(A,B):-skip1(A,C),p339(C,B).
...
p267(A,B):-p400(A,C),p681(C,B).
p354(A,B):-mk_lowercase(A,C),p354_1(C,B).
p354_1(A,B):-p379(A,C),p354_2(C,B).
p354_2(A,B):-mk_lowercase(A,C),p78(C,B).
p525(A,B):-p78(A,C),p525_1(C,B).
p525_1(A,B):-skip1(A,C),p785(C,B).
p554(A,B):-skip1(A,C),p554_1(C,B).
p554_1(A,B):-p635(A,C),p554_2(C,B).
p554_2(A,B):-p269(A,C),copy1(C,B).
p571(A,B):-mk_lowercase(A,C),p571_1(C,B).
p571_1(A,B):-skip1(A,C),p571_2(C,B).
p571_2(A,B):-p106(A,C),p48(C,B).
p622(A,B):-p248(A,C),p622_1(C,B).
p622_1(A,B):-p127(A,C),mk_uppercase(C,B).
p644(A,B):-p426(A,C),p644_1(C,B).
p644_1(A,B):-skip1(A,C),p71(C,B).
p706(A,B):-p148(A,C),p706_1(C,B).
p706_1(A,B):-p233(A,C),copy1(C,B).
p733(A,B):-skip1(A,C),p733_1(C,B).
p733_1(A,B):-p48(A,C),p733_2(C,B).
p733_2(A,B):-p875(A,C),copy1(C,B).
p817(A,B):-p69(A,C),p343(C,B).
...
p1065_1(A,B):-skip1(A,C),p415(C,B).

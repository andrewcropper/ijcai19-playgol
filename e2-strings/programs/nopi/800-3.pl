...
p66(A,B):-p333(A,C),p66_1(C,B).
p66_1(A,B):-p128(A,C),p65(C,B).
...
p78_1(A,B):-p196(A,C),p78_2(C,B).
p78_2(A,B):-mk_lowercase(A,C),p289(C,B).
...
p88(A,B):-p265(A,C),p88_1(C,B).
p88_1(A,B):-p608(A,C),p330(C,B).
...
p91_1(A,B):-p409(A,C),p91_2(C,B).
p91_2(A,B):-p196(A,C),copy1(C,B).
p96(A,B):-p370(A,C),p176(C,B).
p97(A,B):-p48(A,C),p409(C,B).
p99(A,B):-skip1(A,C),p99_1(C,B).
p99_1(A,B):-skip1(A,C),p126(C,B).
p100(A,B):-p48(A,C),p100_1(C,B).
p100_1(A,B):-skip1(A,C),p317(C,B).
...
p202_1(A,B):-p107(A,C),p202_2(C,B).
p202_2(A,B):-skip1(A,C),p265(C,B).
p203(A,B):-p330(A,C),p203_1(C,B).
p203_1(A,B):-p29(A,C),p55(C,B).
p204(A,B):-skip1(A,C),p204_1(C,B).
p204_1(A,B):-p196(A,C),p176(C,B).
...
p212_1(A,B):-p37(A,C),p355(C,B).
p216(A,B):-p48(A,C),p113(C,B).
p218(A,B):-p37(A,C),p265(C,B).
p222(A,B):-p570(A,C),p222_1(C,B).
p222_1(A,B):-mk_lowercase(A,C),p330(C,B).
...
p320(A,B):-p320_1(A,B),is_uppercase(B).
p320_1(A,B):-p65(A,C),skip1(C,B).
...
p325_1(A,B):-skip1(A,C),p325_2(C,B).
p325_2(A,B):-p630(A,C),mk_uppercase(C,B).
p327(A,B):-p435(A,C),p697(C,B).
p328(A,B):-p353(A,C),p328_1(C,B).
p328_1(A,B):-p105(A,C),mk_uppercase(C,B).
p334(A,B):-p265(A,C),p37(C,B).
p335(A,B):-p128(A,C),p750(C,B).
p336(A,B):-p379(A,C),p336_1(C,B).
p336_1(A,B):-mk_lowercase(A,C),p632(C,B).
p337(A,B):-copy1(A,C),p337_1(C,B).
p337_1(A,B):-p606(A,C),p107(C,B).
p339(A,B):-p244(A,C),p173(C,B).
p340(A,B):-p315(A,C),copy1(C,B).
p343(A,B):-p133(A,C),p705(C,B).
p344(A,B):-copy1(A,C),p344_1(C,B).
p344_1(A,B):-p107(A,C),p312(C,B).
...
p455(A,B):-p294(A,C),p455_1(C,B).
p455_1(A,B):-skip1(A,C),p229(C,B).
p457(A,B):-p196(A,C),p457_1(C,B).
p457_1(A,B):-p173(A,C),p330(C,B).
p459(A,B):-p80(A,C),p459_1(C,B).
p459_1(A,B):-skip1(A,C),p292(C,B).
...
p470_1(A,B):-p562(A,C),p48(C,B).
p471(A,B):-p37(A,C),p471_1(C,B).
p471_1(A,B):-skip1(A,C),p105(C,B).
p473(A,B):-skip1(A,C),p473_1(C,B).
p473_1(A,B):-p676(A,C),p107(C,B).
...
p483_1(A,B):-p244(A,C),p382(C,B).
p485(A,B):-p485_1(A,B),is_uppercase(B).
p485_1(A,B):-p160(A,C),copy1(C,B).
p485_1(A,B):-skip1(A,C),p485_1(C,B).
...
p499_1(A,B):-p126(A,C),p499_2(C,B).
p499_2(A,B):-skip1(A,C),p406(C,B).
p500(A,B):-p126(A,C),p102(C,B).
p501(A,B):-mk_lowercase(A,C),p501_1(C,B).
p501_1(A,B):-p27(A,C),mk_uppercase(C,B).
p503(A,B):-skip1(A,C),p503_1(C,B).
p503_1(A,B):-p571(A,C),p503_2(C,B).
p503_2(A,B):-skip1(A,C),p86(C,B).
p505(A,B):-p562(A,C),p505_1(C,B).
p505_1(A,B):-skip1(A,C),p250(C,B).
p506(A,B):-mk_lowercase(A,C),p62(C,B).
p507(A,B):-p133(A,C),p507_1(C,B).
p507_1(A,B):-p160(A,C),p507_2(C,B).
p507_2(A,B):-copy1(A,C),p219(C,B).
p508(A,B):-p422(A,C),p94(C,B).
p509(A,B):-p330(A,C),p509_1(C,B).
p509_1(A,B):-p511(A,C),p294(C,B).
p510(A,B):-copy1(A,C),p265(C,B).
p515(A,B):-skip1(A,C),p515_1(C,B).
p515_1(A,B):-p289(A,C),p393(C,B).
p516(A,B):-copy1(A,C),p516_1(C,B).
p516_1(A,B):-p370(A,C),p1(C,B).
...
p601_1(A,B):-p387(A,C),p601_2(C,B).
p601_2(A,B):-p219(A,C),mk_uppercase(C,B).
...
p617_1(A,B):-p544(A,C),mk_uppercase(C,B).
...
p704_1(A,B):-p160(A,C),p704_2(C,B).
p704_2(A,B):-p1(A,C),p608(C,B).
...
p731_1(A,B):-p126(A,C),p107(C,B).
p732(A,B):-skip1(A,C),p732_1(C,B).
p732_1(A,B):-p721(A,C),copy1(C,B).
p735(A,B):-mk_uppercase(A,C),p126(C,B).
p739(A,B):-p160(A,C),copy1(C,B).
p739(A,B):-p219(A,C),p739(C,B).
...
p764_1(A,B):-skip1(A,C),p764_2(C,B).
p764_2(A,B):-p315(A,C),copy1(C,B).
p765(A,B):-p265(A,C),p219(C,B).
p766(A,B):-p196(A,C),p766_1(C,B).
p766_1(A,B):-p688(A,C),p353(C,B).
p767(A,B):-skip1(A,C),p767_1(C,B).
p767_1(A,B):-p86(A,C),p767_2(C,B).
p767_2(A,B):-p294(A,C),p94(C,B).
...
p772(A,B):-p265(A,C),p772_1(C,B).
p772_1(A,B):-skip1(A,C),p317(C,B).
p774(A,B):-skip1(A,C),p774_1(C,B).
p774_1(A,B):-p133(A,C),p126(C,B).
p775(A,B):-skip1(A,C),p775_1(C,B).
p775_1(A,B):-skip1(A,C),p775_2(C,B).
p775_2(A,B):-skip1(A,C),p169(C,B).
p777(A,B):-p243(A,C),p571(C,B).
p780(A,B):-p219(A,C),p780_1(C,B).
p780_1(A,B):-p292(A,C),copy1(C,B).
p785(A,B):-p196(A,C),p785_1(C,B).
p785_1(A,B):-p48(A,C),p142(C,B).
p790(A,B):-mk_uppercase(A,C),p790_1(C,B).
p790_1(A,B):-p246(A,C),p86(C,B).
...
p799_1(A,B):-p608(A,C),p799_2(C,B).
p799_2(A,B):-p1(A,C),p460(C,B).
% asserting p4/2
% asserting p7/2
% asserting p8/2
% asserting p9/2
...
p394(A,B):-skip1(A,C),p112(C,B).
p530(A,B):-p8(A,C),p530_1(C,B).
p530_1(A,B):-mk_uppercase(A,C),p278(C,B).
...
%timeout
%timeout
b113(A,B):-p101(A,C),mk_uppercase(C,B).

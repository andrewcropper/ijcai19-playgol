...
p2_2(A,B):-p314(A,C),p48(C,B).
p3(A,B):-p49(A,C),p8(C,B).
p4(A,B):-p441(A,C),p4_1(C,B).
p4_1(A,B):-skip1(A,C),p26(C,B).
p11(A,B):-p62(A,C),p209(C,B).
p13(A,B):-p13_1(A,C),p13_2(C,B).
p13_1(A,B):-p13_2(A,C),p460(C,B).
p13_2(A,B):-skip1(A,C),p8(C,B).
p15(A,B):-p270(A,C),p478(C,B).
...
p21_1(A,B):-p441(A,C),copy1(C,B).
p22(A,B):-copy1(A,C),p22_1(C,B).
p22_1(A,B):-p122(A,C),p167(C,B).
...
p58_1(A,B):-p169(A,C),p119(C,B).
p68(A,B):-p193(A,C),p447(C,B).
p71(A,B):-skip1(A,C),p71_1(C,B).
p71_1(A,B):-p8(A,C),p71_2(C,B).
p71_2(A,B):-p252(A,C),p12(C,B).
p73(A,B):-p12(A,C),p513(C,B).
p79(A,B):-p26(A,C),p449(C,B).
p80(A,B):-p80_1(A,B),is_lowercase(B).
p80_1(A,B):-p252(A,C),p120(C,B).
...
p176(A,B):-p447(A,C),p176_1(C,B).
p176_1(A,B):-mk_lowercase(A,C),p8(C,B).
p180(A,B):-copy1(A,C),p180_1(C,B).
p180_1(A,B):-p48(A,C),p25(C,B).
p184(A,B):-mk_lowercase(A,C),p184_1(C,B).
p184_1(A,B):-p107(A,C),p184_2(C,B).
p184_2(A,B):-skip1(A,C),p8(C,B).
p186(A,B):-mk_lowercase(A,C),p352(C,B).
p188(A,B):-copy1(A,C),p188_1(C,B).
p188_1(A,B):-skip1(A,C),p105(C,B).
p189(A,B):-p189_1(A,B),is_lowercase(B).
p189_1(A,B):-p229(A,C),p107(C,B).
p190(A,B):-p190_1(A,B),not_empty(B).
p190_1(A,B):-p25(A,C),p229(C,B).
p191(A,B):-copy1(A,C),p195(C,B).
p199(A,B):-copy1(A,C),p199_1(C,B).
p199_1(A,B):-p513(A,C),p169(C,B).
p203(A,B):-p447(A,C),p120(C,B).
...
p207(A,B):-p441(A,C),p207_1(C,B).
p207_1(A,B):-p441(A,C),copy1(C,B).
...
p238_1(A,B):-p81(A,C),p238_2(C,B).
p238_2(A,B):-skip1(A,C),p49(C,B).
...
p329_2(A,B):-p36(A,C),p119(C,B).
p331(A,B):-p42(A,C),p39(C,B).
p332(A,B):-p443(A,C),p171(C,B).
p335(A,B):-p335_1(A,C),p120(C,B).
p335_1(A,B):-p233(A,C),skip1(C,B).
p335_1(A,B):-skip1(A,C),p335_1(C,B).
p337(A,B):-p314(A,C),p62(C,B).
...
p355_1(A,B):-p99(A,C),copy1(C,B).
p357(A,B):-skip1(A,C),p346(C,B).
p360(A,B):-copy1(A,C),p360_1(C,B).
p360_1(A,B):-p171(A,C),p360_2(C,B).
p360_2(A,B):-p35(A,C),p36(C,B).
p362(A,B):-p169(A,C),p362_1(C,B).
p362_1(A,B):-p124(A,C),mk_uppercase(C,B).
p367(A,B):-mk_uppercase(A,C),p367_1(C,B).
p367_1(A,B):-p166(A,C),p99(C,B).
p368(A,B):-p39(A,C),p368_1(C,B).
p368_1(A,B):-p441(A,C),copy1(C,B).
...
p389_1(A,B):-p107(A,C),p389_2(C,B).
p389_2(A,B):-skip1(A,C),p443(C,B).
p392(A,B):-skip1(A,C),p392_1(C,B).
p392_1(A,B):-p35(A,C),p521(C,B).
...
p411(A,B):-p513(A,C),p478(C,B).
p415(A,B):-p120(A,C),p415_1(C,B).
p415_1(A,B):-p47(A,C),p415_2(C,B).
p415_2(A,B):-mk_uppercase(A,C),p39(C,B).
p418(A,B):-p447(A,C),p39(C,B).
p420(A,B):-p235(A,C),p36(C,B).
p421(A,B):-p419(A,C),copy1(C,B).
p430(A,B):-copy1(A,C),p430_1(C,B).
p430_1(A,B):-p423(A,C),p26(C,B).
p433(A,B):-p120(A,C),p155(C,B).
p436(A,B):-p123(A,C),p436_1(C,B).
p436_1(A,B):-copy1(A,C),p47(C,B).
...
p477_1(A,B):-p35(A,C),p477_2(C,B).
p477_2(A,B):-p31(A,C),p34(C,B).
...
p549_1(A,B):-skip1(A,C),p469(C,B).
p551(A,B):-p229(A,C),p264(C,B).
p552(A,B):-p62(A,C),p216(C,B).
p555(A,B):-p124(A,C),p166(C,B).
p557(A,B):-mk_lowercase(A,C),p557_1(C,B).
p557_1(A,B):-p39(A,C),p26(C,B).
p558(A,B):-skip1(A,C),p558_1(C,B).
p558_1(A,B):-p151(A,C),p8(C,B).
p561(A,B):-p561_1(A,B),not_letter(B).
p561_1(A,B):-p229(A,C),p561_2(C,B).
p561_2(A,B):-copy1(A,C),skip1(C,B).
p563(A,B):-p171(A,C),p563_1(C,B).
p563_1(A,B):-mk_uppercase(A,C),p288(C,B).
p566(A,B):-mk_lowercase(A,C),p566_1(C,B).
p566_1(A,B):-p377(A,C),p566_2(C,B).
p566_2(A,B):-skip1(A,C),p8(C,B).
p569(A,B):-p62(A,C),p569_1(C,B).
p569_1(A,B):-p521(A,C),p8(C,B).
p570(A,B):-skip1(A,C),p570_1(C,B).
p570_1(A,B):-p281(A,C),p8(C,B).
p571(A,B):-p571_1(A,B),is_number(B).
p571_1(A,B):-p65(A,C),p229(C,B).
p575(A,B):-skip1(A,C),p575_1(C,B).
p575_1(A,B):-skip1(A,C),p449(C,B).
p576(A,B):-p8(A,C),p154(C,B).
p577(A,B):-p39(A,C),p577_1(C,B).
p577_1(A,B):-p169(A,C),p233(C,B).
...
p18_1(A,B):-p574(A,C),p18_2(C,B).
p18_2(A,B):-mk_uppercase(A,C),p7(C,B).
p95(A,B):-mk_uppercase(A,C),p95_1(C,B).
p95_1(A,B):-p600(A,C),p561(C,B).
p146(A,B):-skip1(A,C),p146_1(C,B).
p146_1(A,B):-p40(A,C),mk_lowercase(C,B).
p152(A,B):-copy1(A,C),p152_1(C,B).
p152_1(A,B):-p381(A,C),p152_2(C,B).
p152_2(A,B):-mk_lowercase(A,C),p107(C,B).
p246(A,B):-p8(A,C),p246_1(C,B).
p246_1(A,B):-p407(A,C),p62(C,B).
% asserting p18/2
% asserting p95/2
% asserting p146/2
% asserting p152/2
...
b47(A,B):-p39(A,C),b47_1(C,B).
b47_1(A,B):-p264(A,C),p39(C,B).
b47_1(A,B):-p35(A,C),p561(C,B).
...
%timeout
%timeout
b81(A,B):-p25(A,B),is_uppercase(B).

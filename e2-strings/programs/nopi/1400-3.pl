...
p3(A,B):-p95(A,C),p3_1(C,B).
p3_1(A,B):-p1017(A,C),p121(C,B).
...
p84(A,B):-p169(A,C),p84_1(C,B).
p84_1(A,B):-p993(A,C),copy1(C,B).
...
p100(A,B):-p61(A,C),p353(C,B).
p101(A,B):-p829(A,C),p95(C,B).
p103(A,B):-p27(A,C),p253(C,B).
p107(A,B):-p404(A,C),p261(C,B).
p111(A,B):-p102(A,C),p111_1(C,B).
p111_1(A,B):-p993(A,C),copy1(C,B).
p112(A,B):-p91(A,C),p590(C,B).
p118(A,B):-p6(A,C),p118_1(C,B).
p118_1(A,B):-mk_uppercase(A,C),p364(C,B).
...
p131_1(A,B):-p1168(A,C),p982(C,B).
p135(A,B):-p335(A,C),p36(C,B).
p137(A,B):-p557(A,C),p946(C,B).
p138(A,B):-p324(A,C),p124(C,B).
p139(A,B):-p76(A,C),p139_1(C,B).
p139_1(A,B):-p272(A,C),p364(C,B).
p141(A,B):-p1017(A,C),p141_1(C,B).
p141_1(A,B):-p51(A,C),p419(C,B).
...
p258(A,B):-p27(A,C),p258_1(C,B).
p258_1(A,B):-skip1(A,C),p323(C,B).
p260(A,B):-p102(A,C),p711(C,B).
p262(A,B):-p272(A,C),p364(C,B).
...
p285(A,B):-p993(A,C),p285_1(C,B).
p285_1(A,B):-p27(A,C),p726(C,B).
p287(A,B):-p67(A,C),p287_1(C,B).
p287_1(A,B):-p1165(A,C),p192(C,B).
p290(A,B):-p801(A,C),p236(C,B).
p291(A,B):-p395(A,C),p291_1(C,B).
p291_1(A,B):-p102(A,C),p1165(C,B).
...
p342_1(A,B):-p469(A,C),p342_2(C,B).
p342_2(A,B):-skip1(A,C),p73(C,B).
p343(A,B):-p1234(A,C),p343_1(C,B).
p343_1(A,B):-skip1(A,C),p419(C,B).
p344(A,B):-p27(A,C),p323(C,B).
p347(A,B):-skip1(A,C),p347_1(C,B).
p347_1(A,B):-p946(A,C),mk_uppercase(C,B).
...
p374(A,B):-p721(A,C),p374_1(C,B).
p374_1(A,B):-p169(A,C),p721(C,B).
...
p462(A,B):-p1268(A,C),p462_1(C,B).
p462_1(A,B):-skip1(A,C),p469(C,B).
p475(A,B):-copy1(A,C),p475_1(C,B).
p475_1(A,B):-skip1(A,C),p1161(C,B).
p480(A,B):-p6(A,C),p480_1(C,B).
p480_1(A,B):-p17(A,C),mk_uppercase(C,B).
...
p495(A,B):-p995(A,C),p611(C,B).
p501(A,B):-skip1(A,C),p501_1(C,B).
p501_1(A,B):-p121(A,C),p767(C,B).
...
p517(A,B):-p61(A,C),p517_1(C,B).
p517_1(A,B):-p592(A,C),p67(C,B).
p518(A,B):-p70(A,C),p988(C,B).
...
p579_1(A,B):-p124(A,C),p579_2(C,B).
p579_2(A,B):-p36(A,C),p102(C,B).
p581(A,B):-mk_uppercase(A,C),p581_1(C,B).
p581_1(A,B):-p1168(A,C),p6(C,B).
p582(A,B):-skip1(A,C),p124(C,B).
p587(A,B):-p11(A,C),p404(C,B).
p595(A,B):-skip1(A,C),p595_1(C,B).
p595_1(A,B):-p419(A,C),p235(C,B).
p596(A,B):-p596_1(A,B),is_number(B).
p596_1(A,B):-is_uppercase(A),p149(A,B).
p596_1(A,B):-skip1(A,C),p596_1(C,B).
p598(A,B):-skip1(A,C),p479(C,B).
p603(A,B):-p11(A,C),p603_1(C,B).
p603_1(A,B):-p70(A,C),p102(C,B).
p604(A,B):-p48(A,C),p604_1(C,B).
p604_1(A,B):-p1017(A,C),p169(C,B).
p605(A,B):-p474(A,C),p605_1(C,B).
p605_1(A,B):-p407(A,C),p86(C,B).
p606(A,B):-p70(A,C),p1017(C,B).
p612(A,B):-p129(A,C),p612_1(C,B).
p612_1(A,B):-p5(A,C),p1356(C,B).
p614(A,B):-p592(A,C),mk_lowercase(C,B).
...
p625(A,B):-p27(A,C),p625_1(C,B).
p625_1(A,B):-p590(A,C),p102(C,B).
p626(A,B):-p364(A,C),p124(C,B).
p630(A,B):-skip1(A,C),p630_1(C,B).
p630_1(A,B):-p102(A,C),p364(C,B).
...
p666_1(A,B):-p236(A,C),p121(C,B).
p669(A,B):-p257(A,C),p1234(C,B).
p671(A,B):-p671_1(A,B),not_letter(B).
p671_1(A,B):-p21(A,C),p895(C,B).
p678(A,B):-copy1(A,C),p678_1(C,B).
p678_1(A,B):-p162(A,C),p27(C,B).
p679(A,B):-p102(A,C),p739(C,B).
p680(A,B):-p36(A,C),p1093(C,B).
p682(A,B):-copy1(A,C),p682_1(C,B).
p682_1(A,B):-p817(A,C),p407(C,B).
p685(A,B):-p1144(A,C),p685_1(C,B).
p685_1(A,B):-mk_lowercase(A,C),p335(C,B).
p688(A,B):-mk_lowercase(A,C),p323(C,B).
p691(A,B):-p27(A,C),p691_1(C,B).
p691_1(A,B):-p563(A,C),p169(C,B).
...
p705_1(A,B):-p566(A,C),p705_2(C,B).
p705_2(A,B):-p124(A,C),p48(C,B).
p709(A,B):-p27(A,C),p709_1(C,B).
p709_1(A,B):-p95(A,C),p709_2(C,B).
p709_2(A,B):-skip1(A,C),p5(C,B).
p716(A,B):-copy1(A,C),p470(C,B).
p720(A,B):-p407(A,C),p162(C,B).
p728(A,B):-p253(A,C),p353(C,B).
p729(A,B):-p6(A,C),p995(C,B).
p730(A,B):-mk_lowercase(A,C),p730_1(C,B).
p730_1(A,B):-p1268(A,C),p27(C,B).
p733(A,B):-skip1(A,C),p779(C,B).
p736(A,B):-p149(A,C),p27(C,B).
p740(A,B):-p36(A,C),p988(C,B).
p741(A,B):-p701(A,C),p741_1(C,B).
p741_1(A,B):-p470(A,C),p61(C,B).
p742(A,B):-skip1(A,C),p742_1(C,B).
p742_1(A,B):-p36(A,C),p310(C,B).
p744(A,B):-p1017(A,C),p744_1(C,B).
p744_1(A,B):-p121(A,C),p469(C,B).
p746(A,B):-p169(A,C),p329(C,B).
p747(A,B):-copy1(A,C),p747_1(C,B).
p747_1(A,B):-p236(A,C),p323(C,B).
p748(A,B):-p353(A,C),p162(C,B).
p752(A,B):-p27(A,C),p752_1(C,B).
p752_1(A,B):-skip1(A,C),p752_2(C,B).
p752_2(A,B):-skip1(A,C),p735(C,B).
p753(A,B):-p61(A,C),p144(C,B).
p760(A,B):-skip1(A,C),p711(C,B).
p762(A,B):-p404(A,C),p566(C,B).
p765(A,B):-p765_1(A,B),is_lowercase(B).
p765_1(A,B):-p340(A,C),p765_2(C,B).
p765_2(A,B):-skip1(A,C),p149(C,B).
...
p788(A,B):-p21(A,C),p1168(C,B).
p789(A,B):-p5(A,C),p1093(C,B).
p795(A,B):-p129(A,C),p795_1(C,B).
p795_1(A,B):-p263(A,C),mk_lowercase(C,B).
p803(A,B):-p108(A,C),p236(C,B).
p804(A,B):-p253(A,C),p804_1(C,B).
p804_1(A,B):-p407(A,C),p196(C,B).
...
p865(A,B):-p21(A,C),p865_1(C,B).
p865_1(A,B):-p102(A,C),p335(C,B).
...
p877_1(A,B):-p27(A,C),p1098(C,B).
p878(A,B):-p421(A,C),p5(C,B).
p881(A,B):-p335(A,C),p102(C,B).
p884(A,B):-mk_uppercase(A,C),p884_1(C,B).
p884_1(A,B):-p391(A,C),p67(C,B).
p885(A,B):-p885_1(A,B),is_uppercase(B).
p885_1(A,B):-p25(A,C),p39(C,B).
p886(A,B):-p36(A,C),p151(C,B).
p889(A,B):-skip1(A,C),p889_1(C,B).
p889_1(A,B):-p1203(A,C),p701(C,B).
p890(A,B):-p121(A,C),p890_1(C,B).
p890_1(A,B):-p592(A,C),p169(C,B).
p893(A,B):-p893_1(A,B),not_letter(B).
p893_1(A,B):-p779(A,C),p895(C,B).
...
p916(A,B):-p323(A,C),p711(C,B).
p917(A,B):-p5(A,C),p387(C,B).
p923(A,B):-p102(A,C),p364(C,B).
p926(A,B):-p430(A,C),copy1(C,B).
p932(A,B):-p386(A,C),p640(C,B).
p934(A,B):-p61(A,C),p18(C,B).
p935(A,B):-skip1(A,C),p935_1(C,B).
p935_1(A,B):-p94(A,C),p323(C,B).
...
p948_1(A,B):-skip1(A,C),p18(C,B).
p952(A,B):-p27(A,C),p592(C,B).
p953(A,B):-p27(A,C),p953_1(C,B).
p953_1(A,B):-p236(A,C),p310(C,B).
p956(A,B):-p27(A,C),p735(C,B).
p957(A,B):-p151(A,C),p353(C,B).
p964(A,B):-copy1(A,C),p964_1(C,B).
p964_1(A,B):-p611(A,C),p1229(C,B).
p967(A,B):-p1017(A,C),p967_1(C,B).
p967_1(A,B):-p169(A,C),p701(C,B).
p975(A,B):-p407(A,C),p71(C,B).
p976(A,B):-p129(A,C),p976_1(C,B).
p976_1(A,B):-mk_uppercase(A,C),p61(C,B).
...
p994_1(A,B):-p48(A,C),p1165(C,B).
p996(A,B):-p27(A,C),p59(C,B).
p997(A,B):-p335(A,C),p18(C,B).
...
p1019(A,B):-p27(A,C),p1019_1(C,B).
p1019_1(A,B):-skip1(A,C),p1161(C,B).
...
p1030_1(A,B):-p27(A,C),p391(C,B).
p1032(A,B):-p95(A,C),p257(C,B).
...
p1042_1(A,B):-p95(A,C),p895(C,B).
p1045(A,B):-p1393(A,C),p535(C,B).
p1049(A,B):-p5(A,C),p640(C,B).
p1051(A,B):-skip1(A,C),p1051_1(C,B).
p1051_1(A,B):-p5(A,C),p1165(C,B).
p1052(A,B):-mk_uppercase(A,C),p1052_1(C,B).
p1052_1(A,B):-p329(A,C),p1052_2(C,B).
p1052_2(A,B):-skip1(A,C),p5(C,B).
p1057(A,B):-p5(A,C),p162(C,B).
p1059(A,B):-skip1(A,C),p1059_1(C,B).
p1059_1(A,B):-p70(A,C),p91(C,B).
p1065(A,B):-p470(A,C),p5(C,B).
p1067(A,B):-p767(A,C),p91(C,B).
p1068(A,B):-p411(A,C),p636(C,B).
p1070(A,B):-p215(A,C),p129(C,B).
...
p1088(A,B):-p469(A,C),p1088_1(C,B).
p1088_1(A,B):-skip1(A,C),p5(C,B).
p1089(A,B):-p261(A,C),p767(C,B).
p1090(A,B):-p95(A,C),p1090_1(C,B).
p1090_1(A,B):-skip1(A,C),p5(C,B).
p1092(A,B):-p701(A,C),p129(C,B).
p1092(A,B):-p48(A,C),p1092(C,B).
p1095(A,B):-copy1(A,C),p820(C,B).
p1096(A,B):-p725(A,C),p1096_1(C,B).
p1096_1(A,B):-skip1(A,C),p319(C,B).
...
p1113_1(A,B):-p850(A,C),p989(C,B).
p1116(A,B):-skip1(A,C),p1116_1(C,B).
p1116_1(A,B):-p61(A,C),p215(C,B).
...
p1236_1(A,B):-p745(A,C),p984(C,B).
p1238(A,B):-p5(A,C),p1238_1(C,B).
p1238_1(A,B):-p204(A,C),p39(C,B).
p1239(A,B):-p169(A,C),p1239_1(C,B).
p1239_1(A,B):-p70(A,C),p121(C,B).
p1242(A,B):-copy1(A,C),p1242_1(C,B).
p1242_1(A,B):-p115(A,C),p419(C,B).
p1248(A,B):-p989(A,C),p1248_1(C,B).
p1248_1(A,B):-skip1(A,C),p674(C,B).
...
p1260_1(A,B):-p76(A,C),p215(C,B).
p1262(A,B):-p36(A,C),p76(C,B).
p1271(A,B):-p6(A,C),p1271_1(C,B).
p1271_1(A,B):-skip1(A,C),p236(C,B).
p1275(A,B):-p129(A,C),p1275_1(C,B).
p1275_1(A,B):-p5(A,C),p983(C,B).
...
p1289_1(A,B):-p36(A,C),p215(C,B).
p1291(A,B):-copy1(A,C),p1291_1(C,B).
p1291_1(A,B):-p817(A,C),p48(C,B).
p1293(A,B):-p104(A,C),p1293_1(C,B).
p1293_1(A,B):-p407(A,C),p108(C,B).
...
p1318_1(A,B):-p70(A,C),p1318_2(C,B).
p1318_2(A,B):-skip1(A,C),p121(C,B).
p1323(A,B):-p67(A,C),p1323_1(C,B).
p1323_1(A,B):-skip1(A,C),p1161(C,B).
p1326(A,B):-p36(A,C),p1326_1(C,B).
p1326_1(A,B):-skip1(A,C),p993(C,B).
...
p1332(A,B):-p433(A,C),p1332_1(C,B).
p1332_1(A,B):-p310(A,C),mk_lowercase(C,B).
...
p1344(A,B):-p767(A,C),p982(C,B).
p1349(A,B):-mk_uppercase(A,C),p1349_1(C,B).
p1349_1(A,B):-p995(A,C),p253(C,B).
p1351(A,B):-p386(A,C),p1351_1(C,B).
...
p1366(A,B):-p592(A,C),p995(C,B).
p1367(A,B):-p1337(A,C),p335(C,B).
p1369(A,B):-p67(A,C),p1369_1(C,B).
p1369_1(A,B):-p1337(A,C),p61(C,B).
p1373(A,B):-p701(A,C),p1373_1(C,B).
p1373_1(A,B):-skip1(A,C),p124(C,B).
p1375(A,B):-skip1(A,C),p1375_1(C,B).
p1375_1(A,B):-p121(A,C),p1375_2(C,B).
p1375_2(A,B):-p124(A,C),p48(C,B).
p1377(A,B):-copy1(A,C),p1377_1(C,B).
p1377_1(A,B):-p124(A,C),p1377_2(C,B).
p1377_2(A,B):-skip1(A,C),p310(C,B).
...
b113_1(A,B):-p881(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p124(A,B),is_uppercase(B).

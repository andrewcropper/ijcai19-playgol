...
p39(A,B):-p45(A,C),p17(C,B).
p40(A,B):-p189(A,C),p471(C,B).
p44(A,B):-p63(A,C),p44_1(C,B).
p44_1(A,B):-p181(A,C),p284(C,B).
...
p60_1(A,B):-p882(A,C),p635(C,B).
p62(A,B):-p63(A,C),p62_1(C,B).
p62_1(A,B):-p46(A,C),copy1(C,B).
...
p93_1(A,B):-p247(A,C),mk_uppercase(C,B).
...
p131(A,B):-p277(A,C),p131_1(C,B).
p131_1(A,B):-skip1(A,C),p7(C,B).
...
p146_1(A,B):-p46(A,C),p45(C,B).
p147(A,B):-p964(A,C),p147_1(C,B).
p147_1(A,B):-skip1(A,C),p568(C,B).
p148(A,B):-p267(A,C),mk_lowercase(C,B).
p148(A,B):-skip1(A,C),p148(C,B).
p152(A,B):-p408(A,C),p18(C,B).
p153(A,B):-copy1(A,C),p153_1(C,B).
p153_1(A,B):-p46(A,C),p672(C,B).
p155(A,B):-p175(A,C),p194(C,B).
p160(A,B):-p235(A,C),p160_1(C,B).
p160_1(A,B):-p596(A,C),p46(C,B).
p161(A,B):-copy1(A,C),p161_1(C,B).
p161_1(A,B):-p988(A,C),p207(C,B).
p162(A,B):-p534(A,C),p589(C,B).
p163(A,B):-p63(A,C),p163_1(C,B).
p163_1(A,B):-p241(A,C),p14(C,B).
p165(A,B):-mk_lowercase(A,C),p165_1(C,B).
p165_1(A,B):-p845(A,C),p104(C,B).
...
p170_1(A,B):-p235(A,C),p215(C,B).
p178(A,B):-p235(A,C),p232(C,B).
p184(A,B):-p919(A,C),p184_1(C,B).
p184_1(A,B):-skip1(A,C),p598(C,B).
...
p206(A,B):-p659(A,C),mk_uppercase(C,B).
p208(A,B):-p134(A,C),p964(C,B).
p209(A,B):-skip1(A,C),p209_1(C,B).
p209_1(A,B):-p291(A,C),p635(C,B).
...
p282(A,B):-p284(A,C),p282_1(C,B).
p282_1(A,B):-skip1(A,C),p37(C,B).
...
p306(A,B):-p919(A,C),p306_1(C,B).
p306_1(A,B):-skip1(A,C),p15(C,B).
...
p314_1(A,B):-p207(A,C),p635(C,B).
p317(A,B):-p187(A,C),p317_1(C,B).
p317_1(A,B):-p621(A,C),mk_uppercase(C,B).
p319(A,B):-copy1(A,C),p319_1(C,B).
p319_1(A,B):-p18(A,C),p534(C,B).
p321(A,B):-p678(A,C),p321_1(C,B).
p321_1(A,B):-skip1(A,C),p50(C,B).
p322(A,B):-p175(A,C),p277(C,B).
p323(A,B):-p241(A,C),p323_1(C,B).
p323_1(A,B):-skip1(A,C),p323_2(C,B).
p323_2(A,B):-p988(A,C),copy1(C,B).
...
p473(A,B):-p559(A,C),p342(C,B).
p473(A,B):-p1(A,C),p473(C,B).
...
p507_1(A,B):-p899(A,C),p507_2(C,B).
p507_2(A,B):-p1(A,C),p1(C,B).
p508(A,B):-p27(A,C),p46(C,B).
p511(A,B):-skip1(A,C),p511_1(C,B).
p511_1(A,B):-p568(A,C),p678(C,B).
p512(A,B):-p175(A,C),p512_1(C,B).
p512_1(A,B):-skip1(A,C),p568(C,B).
...
p523_1(A,B):-p32(A,C),p523_2(C,B).
p523_2(A,B):-skip1(A,C),p48(C,B).
p525(A,B):-skip1(A,C),p525_1(C,B).
p525_1(A,B):-p635(A,C),p749(C,B).
p530(A,B):-p201(A,C),p530_1(C,B).
p530_1(A,B):-copy1(A,C),p241(C,B).
p531(A,B):-p235(A,B),is_space(B).
p531(A,B):-skip1(A,C),p531(C,B).
p533(A,B):-copy1(A,C),p241(C,B).
p535(A,B):-mk_lowercase(A,C),p535_1(C,B).
p535_1(A,B):-skip1(A,C),p194(C,B).
p536(A,B):-p284(A,C),p509(C,B).
p538(A,B):-p20(A,C),p115(C,B).
p539(A,B):-p49(A,C),p771(C,B).
p540(A,B):-p49(A,C),p540_1(C,B).
p540_1(A,B):-p339(A,C),p63(C,B).
p541(A,B):-skip1(A,C),p541_1(C,B).
p541_1(A,B):-p31(A,C),p541_2(C,B).
p541_2(A,B):-p568(A,C),p559(C,B).
p543(A,B):-mk_uppercase(A,C),p543_1(C,B).
p543_1(A,B):-p18(A,C),p619(C,B).
p545(A,B):-p63(A,C),p568(C,B).
p547(A,B):-p14(A,C),p292(C,B).
p548(A,B):-p241(A,C),p548_1(C,B).
p548_1(A,B):-p20(A,C),p31(C,B).
p553(A,B):-p456(A,C),p553_1(C,B).
p553_1(A,B):-skip1(A,C),p235(C,B).
p554(A,B):-p14(A,C),p554_1(C,B).
p554_1(A,B):-p456(A,C),p31(C,B).
p555(A,B):-p284(A,C),p45(C,B).
p557(A,B):-copy1(A,C),p557_1(C,B).
p557_1(A,B):-p87(A,C),p901(C,B).
p560(A,B):-p471(A,B),not_letter(B).
...
p570_1(A,B):-p580(A,C),mk_lowercase(C,B).
p571(A,B):-p627(A,C),p289(C,B).
p572(A,B):-skip1(A,C),p572_1(C,B).
p572_1(A,B):-p635(A,C),p572_2(C,B).
p572_2(A,B):-p46(A,C),copy1(C,B).
...
p591(A,B):-p14(A,C),p591_1(C,B).
p591_1(A,B):-skip1(A,C),p522(C,B).
p594(A,B):-p241(A,C),p596(C,B).
p600(A,B):-copy1(A,C),p600_1(C,B).
p600_1(A,B):-p104(A,C),p241(C,B).
p601(A,B):-p74(A,C),p601_1(C,B).
p601_1(A,B):-p18(A,C),p1(C,B).
p602(A,B):-p110(A,C),p19(C,B).
p606(A,B):-p43(A,C),p606_1(C,B).
p606_1(A,B):-skip1(A,C),p31(C,B).
...
p626(A,B):-p580(A,C),p626_1(C,B).
p626_1(A,B):-p284(A,C),mk_lowercase(C,B).
p628(A,B):-p43(A,C),p628_1(C,B).
p628_1(A,B):-copy1(A,C),p227(C,B).
p630(A,B):-mk_uppercase(A,C),p630_1(C,B).
p630_1(A,B):-p46(A,C),p188(C,B).
p632(A,B):-p49(A,C),p496(C,B).
p633(A,B):-p115(A,C),p187(C,B).
p648(A,B):-p372(A,C),p648_1(C,B).
p648_1(A,B):-copy1(A,C),p45(C,B).
p649(A,B):-p515(A,C),p104(C,B).
p651(A,B):-copy1(A,C),p651_1(C,B).
p651_1(A,B):-p235(A,C),p207(C,B).
p653(A,B):-copy1(A,C),p134(C,B).
p656(A,B):-p763(A,C),p656_1(C,B).
p656_1(A,B):-p70(A,C),mk_uppercase(C,B).
p657(A,B):-copy1(A,C),p657_1(C,B).
p657_1(A,B):-skip1(A,C),p698(C,B).
...
p688(A,B):-p678(A,C),p688_1(C,B).
p688_1(A,B):-skip1(A,C),p32(C,B).
p690(A,B):-p175(A,C),p267(C,B).
p691(A,B):-skip1(A,C),p691_1(C,B).
p691_1(A,B):-p580(A,C),mk_lowercase(C,B).
p694(A,B):-p49(A,C),p694_1(C,B).
p694_1(A,B):-p580(A,C),mk_lowercase(C,B).
p697(A,B):-p284(A,C),p919(C,B).
p702(A,B):-p279(A,C),p702_1(C,B).
p702_1(A,B):-p31(A,C),p725(C,B).
p703(A,B):-p241(A,C),p284(C,B).
p706(A,B):-p189(A,C),p706_1(C,B).
p706_1(A,B):-skip1(A,C),p49(C,B).
...
p719(A,B):-p241(A,C),p719_1(C,B).
p719_1(A,B):-p988(A,C),copy1(C,B).
...
p780(A,B):-p534(A,C),p780_1(C,B).
p780_1(A,B):-mk_lowercase(A,C),p780_2(C,B).
p780_2(A,B):-skip1(A,C),p31(C,B).
p781(A,B):-p49(A,C),p781_1(C,B).
p781_1(A,B):-p106(A,C),p1(C,B).
p784(A,B):-skip1(A,C),p784_1(C,B).
p784_1(A,B):-p964(A,C),p784_2(C,B).
p784_2(A,B):-p279(A,C),p284(C,B).
...
p814_1(A,B):-p104(A,C),p814_2(C,B).
p814_2(A,B):-p598(A,C),copy1(C,B).
p817(A,B):-copy1(A,C),p381(C,B).
p818(A,B):-skip1(A,C),p818_1(C,B).
p818_1(A,B):-skip1(A,C),p408(C,B).
p823(A,B):-p104(A,C),p589(C,B).
p829(A,B):-p674(A,C),copy1(C,B).
p830(A,B):-p235(A,C),p830_1(C,B).
p830_1(A,B):-p678(A,C),p830_2(C,B).
p830_2(A,B):-skip1(A,C),p31(C,B).
p832(A,B):-p832_1(A,C),p801(C,B).
p832_1(A,B):-p832_2(A,C),p832_2(C,B).
p832_2(A,B):-skip1(A,C),skip1(C,B).
p838(A,B):-skip1(A,C),p617(C,B).
p842(A,B):-p739(A,C),p842_1(C,B).
p842_1(A,B):-skip1(A,C),p49(C,B).
p846(A,B):-p63(A,C),p227(C,B).
p848(A,B):-p373(A,C),p848_1(C,B).
p848_1(A,B):-p496(A,C),p1(C,B).
p850(A,B):-p20(A,C),p850_1(C,B).
p850_1(A,B):-p284(A,C),p46(C,B).
...
p855_1(A,B):-p49(A,C),p617(C,B).
p856(A,B):-p14(A,C),p481(C,B).
p860(A,B):-p919(A,C),p860_1(C,B).
p860_1(A,B):-skip1(A,C),p32(C,B).
...
p927_1(A,B):-p635(A,C),p927_2(C,B).
p927_2(A,B):-p988(A,C),p49(C,B).
p928(A,B):-p284(A,C),p763(C,B).
...
p968(A,B):-p1(A,C),p968_1(C,B).
p968_1(A,B):-skip1(A,C),p481(C,B).
...
p989(A,B):-p988(A,C),p989_1(C,B).
p989_1(A,B):-p284(A,C),p187(C,B).
p990(A,B):-p284(A,C),p990_1(C,B).
p990_1(A,B):-skip1(A,C),p241(C,B).
p991(A,B):-p698(A,C),p241(C,B).
p994(A,B):-p104(A,C),p994_1(C,B).
p994_1(A,B):-skip1(A,C),p603(C,B).
...
p409(A,B):-p296(A,C),p409_1(C,B).
p409_1(A,B):-copy1(A,C),p235(C,B).
p470(A,B):-copy1(A,C),p470_1(C,B).
p470_1(A,B):-p375(A,C),p470_2(C,B).
p470_2(A,B):-mk_uppercase(A,C),p15(C,B).
p532(A,B):-skip1(A,C),p532_1(C,B).
p532_1(A,B):-p919(A,C),p532_2(C,B).
p532_2(A,B):-p46(A,C),p63(C,B).
p579(A,B):-copy1(A,C),p579_1(C,B).
p579_1(A,B):-p534(A,C),p579_2(C,B).
p579_2(A,B):-p563(A,C),copy1(C,B).
p595(A,B):-p101(A,C),p595_1(C,B).
p595_1(A,B):-p46(A,C),copy1(C,B).
p655(A,B):-copy1(A,C),p655_1(C,B).
p655_1(A,B):-p678(A,C),p655_2(C,B).
p655_2(A,B):-p598(A,C),p232(C,B).
p761(A,B):-p709(A,C),p818(C,B).
p913(A,B):-p70(A,C),p350(C,B).
p945(A,B):-mk_uppercase(A,C),p945_1(C,B).
p945_1(A,B):-p584(A,C),p725(C,B).
p945_1(A,B):-skip1(A,C),p945_1(C,B).
...
b113_1(A,B):-p285(A,C),b113_2(C,B).
b113_2(A,B):-skip1(A,C),p596(C,B).
%timeout
%timeout
...
b24_1(A,B):-skip1(A,C),b24_2(C,B).
b24_2(A,B):-p748(A,C),p14(C,B).
%timeout
%timeout
%timeout
%timeout

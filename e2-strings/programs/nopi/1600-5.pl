...
p109(A,B):-p189(A,C),p109_1(C,B).
p109_1(A,B):-p195(A,C),p133(C,B).
...
p120_2(A,B):-p1600(A,C),p542(C,B).
p121(A,B):-p486(A,C),p121_1(C,B).
p121_1(A,B):-p832(A,C),p48(C,B).
p122(A,B):-mk_lowercase(A,C),p122_1(C,B).
p122_1(A,B):-p486(A,C),p81(C,B).
p123(A,B):-p68(A,C),p777(C,B).
p125(A,B):-p6(A,C),p1556(C,B).
p127(A,B):-copy1(A,C),p220(C,B).
p134(A,B):-p15(A,C),p195(C,B).
...
p202_1(A,B):-p8(A,C),p241(C,B).
p203(A,B):-p542(A,C),p367(C,B).
...
p222(A,B):-p241(A,C),p222_1(C,B).
p222_1(A,B):-p105(A,C),p615(C,B).
...
p238_1(A,B):-p1300(A,C),mk_uppercase(C,B).
p246(A,B):-p410(A,C),p246_1(C,B).
p246_1(A,B):-p10(A,C),p246_2(C,B).
p246_2(A,B):-skip1(A,C),p10(C,B).
p249(A,B):-p1600(A,C),p6(C,B).
p253(A,B):-skip1(A,C),p253_1(C,B).
p253_1(A,B):-p458(A,C),p241(C,B).
p255(A,B):-p68(A,C),p367(C,B).
p256(A,B):-p910(A,C),p169(C,B).
p257(A,B):-p80(A,C),mk_uppercase(C,B).
...
p286(A,B):-p548(A,C),p286_1(C,B).
p286_1(A,B):-p148(A,C),mk_uppercase(C,B).
p292(A,B):-copy1(A,C),p292_1(C,B).
p292_1(A,B):-p220(A,C),p68(C,B).
p294(A,B):-copy1(A,C),p294_1(C,B).
p294_1(A,B):-p391(A,C),p105(C,B).
...
p364(A,B):-p698(A,C),mk_uppercase(C,B).
...
p401_1(A,B):-p1368(A,C),p22(C,B).
p405(A,B):-p1141(A,C),p176(C,B).
p409(A,B):-p10(A,C),p409_1(C,B).
p409_1(A,B):-p1147(A,C),p204(C,B).
...
p452(A,B):-p382(A,C),p6(C,B).
p460(A,B):-p410(A,C),p15(C,B).
p464(A,B):-skip1(A,C),p464_1(C,B).
p464_1(A,B):-skip1(A,C),p1224(C,B).
p466(A,B):-p1091(A,C),mk_uppercase(C,B).
p467(A,B):-p19(A,C),p467_1(C,B).
p467_1(A,B):-p593(A,C),p68(C,B).
...
p709(A,B):-p309(A,C),p709_1(C,B).
p709_1(A,B):-skip1(A,C),p10(C,B).
p720(A,B):-p176(A,C),p34(C,B).
p721(A,B):-p17(A,C),mk_uppercase(C,B).
p722(A,B):-mk_lowercase(A,C),p722_1(C,B).
p722_1(A,B):-p169(A,C),p722_2(C,B).
p722_2(A,B):-p220(A,C),p161(C,B).
p723(A,B):-p136(A,C),p804(C,B).
...
p816_1(A,B):-p11(A,C),p367(C,B).
p817(A,B):-skip1(A,C),p17(C,B).
p819(A,B):-skip1(A,C),p819_1(C,B).
p819_1(A,B):-p68(A,C),p1397(C,B).
p821(A,B):-p37(A,C),p22(C,B).
p823(A,B):-skip1(A,C),p823_1(C,B).
p823_1(A,B):-p11(A,C),p823_2(C,B).
p823_2(A,B):-skip1(A,C),p135(C,B).
...
p834_1(A,B):-p176(A,C),p834_2(C,B).
p834_2(A,B):-skip1(A,C),p753(C,B).
...
p891_1(A,B):-p17(A,C),mk_lowercase(C,B).
p892(A,B):-p1556(A,C),copy1(C,B).
p894(A,B):-p1556(A,C),p11(C,B).
...
p917_1(A,B):-p516(A,C),p811(C,B).
p920(A,B):-p34(A,C),p539(C,B).
p921(A,B):-skip1(A,C),p921_1(C,B).
p921_1(A,B):-p954(A,C),p921_2(C,B).
p921_2(A,B):-skip1(A,C),p104(C,B).
...
p949(A,B):-p158(A,C),p949_1(C,B).
p949_1(A,B):-p1102(A,C),copy1(C,B).
...
p1003_1(A,B):-p643(A,C),p81(C,B).
p1004(A,B):-skip1(A,C),p1004_1(C,B).
p1004_1(A,B):-skip1(A,C),p415(C,B).
...
p1060_1(A,B):-skip1(A,C),p1060_2(C,B).
p1060_2(A,B):-p1102(A,C),copy1(C,B).
p1062(A,B):-p1399(A,C),p410(C,B).
...
p1161(A,B):-p19(A,C),p1161_1(C,B).
p1161_1(A,B):-p1474(A,C),mk_lowercase(C,B).
p1164(A,B):-p804(A,C),p240(C,B).
p1165(A,B):-p7(A,C),p375(C,B).
p1166(A,B):-skip1(A,C),p1166_1(C,B).
p1166_1(A,B):-p539(A,C),p990(C,B).
...
p1226(A,B):-p656(A,C),p161(C,B).
p1228(A,B):-mk_uppercase(A,C),p1228_1(C,B).
p1228_1(A,B):-p391(A,C),copy1(C,B).
p1231(A,B):-p11(A,C),p1231_1(C,B).
p1231_1(A,B):-p1102(A,C),copy1(C,B).
p1236(A,B):-mk_lowercase(A,C),p1236_1(C,B).
p1236_1(A,B):-p843(A,C),p1236_2(C,B).
p1236_2(A,B):-skip1(A,C),p10(C,B).
p1240(A,B):-copy1(A,C),p1240_1(C,B).
p1240_1(A,B):-p479(A,C),p241(C,B).
...
p1266_1(A,B):-p7(A,C),p105(C,B).
p1270(A,B):-p19(A,C),p1270_1(C,B).
p1270_1(A,B):-skip1(A,C),p1270_2(C,B).
p1270_2(A,B):-skip1(A,C),p430(C,B).
...
p1277(A,B):-p19(A,C),p1277_1(C,B).
p1277_1(A,B):-skip1(A,C),p586(C,B).
p1278(A,B):-p54(A,C),p1239(C,B).
p1281(A,B):-p6(A,C),p1281_1(C,B).
p1281_1(A,B):-p169(A,C),p1373(C,B).
...
p1305(A,B):-p17(A,C),p1305_1(C,B).
p1305_1(A,B):-p1406(A,C),p480(C,B).
...
p1319_1(A,B):-p10(A,C),p6(C,B).
p1320(A,B):-p1174(A,C),p902(C,B).
...
p1337_1(A,B):-p131(A,C),p1158(C,B).
p1339(A,B):-p15(A,C),p777(C,B).
p1340(A,B):-p643(A,C),p204(C,B).
p1340(A,B):-skip1(A,C),p1340(C,B).
p1341(A,B):-p539(A,C),p1012(C,B).
p1342(A,B):-p81(A,C),p34(C,B).
...
p1380_1(A,B):-p189(A,C),p293(C,B).
p1382(A,B):-p176(A,C),p561(C,B).
p1383(A,B):-p1383_1(A,B),is_uppercase(B).
p1383_1(A,B):-p548(A,C),p293(C,B).
...
p1465_1(A,B):-p176(A,C),p910(C,B).
p1466(A,B):-p1466_1(A,B),is_uppercase(B).
p1466_1(A,B):-p548(A,C),p391(C,B).
...
p1480(A,B):-p902(A,C),mk_uppercase(C,B).
...
p1484_1(A,B):-p6(A,C),p1147(C,B).
p1492(A,B):-p220(A,C),p1492_1(C,B).
p1492_1(A,B):-p6(A,C),mk_lowercase(C,B).
p1493(A,B):-p19(A,C),p1493_1(C,B).
p1493_1(A,B):-p189(A,C),p927(C,B).
p1497(A,B):-p289(A,C),p220(C,B).
p1500(A,B):-p806(A,C),p195(C,B).
p1502(A,B):-p1243(A,C),p1141(C,B).
p1503(A,B):-skip1(A,C),p1503_1(C,B).
p1503_1(A,B):-p105(A,C),p777(C,B).
p1504(A,B):-mk_lowercase(A,C),p1504_1(C,B).
p1504_1(A,B):-skip1(A,C),p1020(C,B).
p1506(A,B):-mk_lowercase(A,C),p1506_1(C,B).
p1506_1(A,B):-skip1(A,C),p1506_2(C,B).
p1506_2(A,B):-p10(A,C),p220(C,B).
p1507(A,B):-p176(A,C),p1102(C,B).
p1510(A,B):-p410(A,C),p1510_1(C,B).
p1510_1(A,B):-p456(A,C),p1510_2(C,B).
p1510_2(A,B):-skip1(A,C),p10(C,B).
...
p1580_1(A,B):-p736(A,C),p104(C,B).
p1584(A,B):-skip1(A,C),p1584_1(C,B).
p1584_1(A,B):-p169(A,C),p1515(C,B).
p1586(A,B):-p548(A,C),p586(C,B).
...
% asserting p1599/2
% depth 4
p14(A,B):-p14_1(A,B),is_space(B).
p14_1(A,B):-p377(A,C),p14_2(C,B).
p14_2(A,B):-p827(A,C),mk_lowercase(C,B).
p40(A,B):-p439(A,C),p40_1(C,B).
p40_1(A,B):-skip1(A,C),p683(C,B).
p65(A,B):-p339(A,C),p481(C,B).
p196(A,B):-copy1(A,C),p196_1(C,B).
p196_1(A,B):-skip1(A,C),p1572(C,B).
p343(A,B):-skip1(A,C),p343_1(C,B).
p343_1(A,B):-p11(A,C),p343_2(C,B).
p343_2(A,B):-p142(A,C),p363(C,B).
p420(A,B):-skip1(A,C),p420_1(C,B).
p420_1(A,B):-p176(A,C),p966(C,B).
p578(A,B):-p204(A,C),p603(C,B).
p854(A,B):-p412(A,C),p854_1(C,B).
p854_1(A,B):-p273(A,C),mk_lowercase(C,B).
p881(A,B):-mk_uppercase(A,C),p603(C,B).
p1155(A,B):-skip1(A,C),p1155_1(C,B).
p1155_1(A,B):-p169(A,C),p1155_2(C,B).
p1155_2(A,B):-p966(A,C),copy1(C,B).
p1432(A,B):-copy1(A,C),p1432_1(C,B).
p1432_1(A,B):-p901(A,C),p241(C,B).
% asserting p14/2
% asserting p40/2
% asserting p65/2
% asserting p196/2
...
b113_1(A,B):-p34(A,C),b113_2(C,B).
b113_2(A,B):-skip1(A,C),p456(C,B).
...
%timeout
%timeout
b224(A,B):-p552(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout

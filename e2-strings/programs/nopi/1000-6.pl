...
p7_1(A,B):-skip1(A,C),p421(C,B).
p8(A,B):-p176(A,C),mk_lowercase(C,B).
p9(A,B):-p12(A,C),p9_1(C,B).
p9_1(A,B):-p71(A,C),p25(C,B).
p18(A,B):-p3(A,C),p53(C,B).
p24(A,B):-skip1(A,C),p545(C,B).
p28(A,B):-p290(A,C),p863(C,B).
p29(A,B):-p29_1(A,B),is_lowercase(B).
p29_1(A,B):-p130(A,C),p12(C,B).
p29_1(A,B):-skip1(A,C),p29_1(C,B).
p31(A,B):-p31_1(A,B),is_uppercase(B).
p31_1(A,B):-p491(A,C),mk_uppercase(C,B).
p31_1(A,B):-skip1(A,C),p31_1(C,B).
p35(A,B):-p459(A,C),p35_1(C,B).
p35_1(A,B):-skip1(A,C),p71(C,B).
p39(A,B):-p95(A,C),p39_1(C,B).
p39_1(A,B):-p124(A,C),p13(C,B).
p42(A,B):-p491(A,C),p700(C,B).
p43(A,B):-p15(A,C),p175(C,B).
p47(A,B):-p523(A,C),p47_1(C,B).
p47_1(A,B):-p416(A,C),p41(C,B).
p48(A,B):-p106(A,C),p124(C,B).
p51(A,B):-skip1(A,C),p51_1(C,B).
p51_1(A,B):-p21(A,C),p705(C,B).
p52(A,B):-p457(A,C),p17(C,B).
p54(A,B):-p101(A,C),p565(C,B).
...
p75(A,B):-p615(A,C),p75_1(C,B).
p75_1(A,B):-skip1(A,C),p33(C,B).
p78(A,B):-p124(A,C),p78_1(C,B).
p78_1(A,B):-p96(A,C),p565(C,B).
p81(A,B):-p124(A,C),p95(C,B).
p82(A,B):-skip1(A,C),p82_1(C,B).
p82_1(A,B):-p680(A,C),p82_2(C,B).
p82_2(A,B):-mk_uppercase(A,C),p565(C,B).
p84(A,B):-skip1(A,C),p84_1(C,B).
p84_1(A,B):-p600(A,C),p84_2(C,B).
p84_2(A,B):-skip1(A,C),p175(C,B).
...
p147_1(A,B):-p891(A,C),p147_2(C,B).
p147_2(A,B):-p3(A,C),p124(C,B).
...
p170_1(A,B):-p71(A,C),p170_2(C,B).
p170_2(A,B):-p260(A,C),p17(C,B).
...
p188(A,B):-p661(A,C),p242(C,B).
p189(A,B):-p492(A,C),p189_1(C,B).
p189_1(A,B):-skip1(A,C),p700(C,B).
p192(A,B):-p420(A,C),p192_1(C,B).
p192_1(A,B):-skip1(A,C),p25(C,B).
p193(A,B):-mk_lowercase(A,C),p193_1(C,B).
p193_1(A,B):-p96(A,C),p41(C,B).
p194(A,B):-p95(A,C),p194_1(C,B).
p194_1(A,B):-p256(A,C),p261(C,B).
p198(A,B):-p65(A,C),p95(C,B).
p200(A,B):-p492(A,C),p405(C,B).
p204(A,B):-mk_lowercase(A,C),p204_1(C,B).
p204_1(A,B):-p700(A,C),p204_2(C,B).
p204_2(A,B):-p891(A,C),p16(C,B).
...
p436_1(A,B):-p260(A,C),mk_uppercase(C,B).
p439(A,B):-p734(A,C),p491(C,B).
p442(A,B):-p3(A,C),p101(C,B).
p443(A,B):-p491(A,C),p996(C,B).
p444(A,B):-p118(A,C),p444_1(C,B).
p444_1(A,B):-skip1(A,C),p863(C,B).
p447(A,B):-copy1(A,C),p106(C,B).
p448(A,B):-p15(A,C),p448_1(C,B).
p448_1(A,B):-p379(A,C),p448_2(C,B).
p448_2(A,B):-skip1(A,C),p175(C,B).
...
p472(A,B):-p95(A,C),p472_1(C,B).
p472_1(A,B):-p242(A,C),p16(C,B).
p474(A,B):-p256(A,C),p25(C,B).
p475(A,B):-p3(A,C),p475_1(C,B).
p475_1(A,B):-p73(A,C),p41(C,B).
p479(A,B):-p256(A,C),p210(C,B).
p481(A,B):-copy1(A,C),p481_1(C,B).
p481_1(A,B):-skip1(A,C),p481_2(C,B).
p481_2(A,B):-p176(A,C),p13(C,B).
p485(A,B):-p173(A,C),p485_1(C,B).
p485_1(A,B):-p700(A,C),p256(C,B).
...
p516(A,B):-p197(A,C),p516_1(C,B).
p516_1(A,B):-skip1(A,C),p760(C,B).
p518(A,B):-copy1(A,C),p518_1(C,B).
p518_1(A,B):-skip1(A,C),p529(C,B).
...
p536(A,B):-p211(A,C),p536_1(C,B).
p536_1(A,B):-p3(A,C),p124(C,B).
p537(A,B):-copy1(A,C),p537_1(C,B).
p537_1(A,B):-p491(A,C),p537_2(C,B).
p537_2(A,B):-mk_uppercase(A,C),p124(C,B).
p542(A,B):-p1(A,C),p974(C,B).
p544(A,B):-p416(A,C),p106(C,B).
p548(A,B):-p15(A,C),p548_1(C,B).
p548_1(A,B):-mk_lowercase(A,C),p734(C,B).
p550(A,B):-p65(A,C),p146(C,B).
p551(A,B):-copy1(A,C),p551_1(C,B).
p551_1(A,B):-p21(A,C),p551_2(C,B).
p551_2(A,B):-skip1(A,C),p294(C,B).
p554(A,B):-skip1(A,C),p554_1(C,B).
p554_1(A,B):-p12(A,C),p175(C,B).
...
p588(A,B):-p838(A,C),p588_1(C,B).
p588_1(A,B):-skip1(A,C),p71(C,B).
p589(A,B):-p523(A,C),p280(C,B).
p590(A,B):-p107(A,C),p661(C,B).
p591(A,B):-p256(A,C),p591_1(C,B).
p591_1(A,B):-p107(A,C),p25(C,B).
...
p616_1(A,B):-p202(A,C),p466(C,B).
p621(A,B):-p290(A,C),p334(C,B).
p623(A,B):-p299(A,C),p118(C,B).
p627(A,B):-p118(A,C),p14(C,B).
p629(A,B):-p25(A,C),p629_1(C,B).
p629_1(A,B):-p3(A,C),p734(C,B).
p630(A,B):-skip1(A,C),p136(C,B).
p631(A,B):-p3(A,C),p631_1(C,B).
p631_1(A,B):-p938(A,C),mk_uppercase(C,B).
p632(A,B):-mk_uppercase(A,C),p632_1(C,B).
p632_1(A,B):-skip1(A,C),p632_2(C,B).
p632_2(A,B):-p891(A,C),p71(C,B).
p633(A,B):-skip1(A,C),p633_1(C,B).
p633_1(A,B):-p71(A,C),p523(C,B).
p634(A,B):-p565(A,C),p290(C,B).
p636(A,B):-p615(A,C),p661(C,B).
p639(A,B):-p260(A,C),p639_1(C,B).
p639_1(A,B):-skip1(A,C),p379(C,B).
p642(A,B):-copy1(A,C),p642_1(C,B).
p642_1(A,B):-p202(A,C),p642_2(C,B).
p642_2(A,B):-p583(A,C),p175(C,B).
p644(A,B):-p95(A,C),p644_1(C,B).
p644_1(A,B):-p242(A,C),p3(C,B).
...
p662_1(A,B):-p25(A,C),p662_2(C,B).
p662_2(A,B):-p3(A,C),p202(C,B).
p665(A,B):-copy1(A,C),p665_1(C,B).
p665_1(A,B):-skip1(A,C),p661(C,B).
p666(A,B):-copy1(A,C),p666_1(C,B).
p666_1(A,B):-skip1(A,C),p429(C,B).
p670(A,B):-copy1(A,C),p670_1(C,B).
p670_1(A,B):-p175(A,C),p670_2(C,B).
p670_2(A,B):-p25(A,C),p146(C,B).
p672(A,B):-p124(A,C),p3(C,B).
p674(A,B):-p95(A,C),p674_1(C,B).
p674_1(A,B):-p175(A,C),p674_2(C,B).
p674_2(A,B):-p25(A,C),p3(C,B).
...
p726_1(A,B):-skip1(A,C),p512(C,B).
p727(A,B):-p117(A,C),p727_1(C,B).
p727_1(A,B):-skip1(A,C),p95(C,B).
...
p749_1(A,B):-p126(A,C),p615(C,B).
p752(A,B):-p13(A,C),p752_1(C,B).
p752_1(A,B):-p3(A,C),p202(C,B).
...
p843_1(A,B):-p398(A,C),copy1(C,B).
p844(A,B):-mk_uppercase(A,C),p106(C,B).
p850(A,B):-p17(A,C),p124(C,B).
p854(A,B):-p95(A,C),p854_1(C,B).
p854_1(A,B):-p583(A,C),p113(C,B).
...
p869_1(A,B):-p807(A,C),p869_2(C,B).
p869_2(A,B):-p256(A,C),p96(C,B).
...
p877_1(A,B):-skip1(A,C),p877_2(C,B).
p877_2(A,B):-skip1(A,C),p863(C,B).
p878(A,B):-skip1(A,C),p661(C,B).
p879(A,B):-p71(A,C),p515(C,B).
p881(A,B):-copy1(A,C),p881_1(C,B).
p881_1(A,B):-p515(A,C),p95(C,B).
...
p984(A,B):-p565(A,C),p984_1(C,B).
p984_1(A,B):-p256(A,C),p25(C,B).
...
p44(A,B):-p3(A,C),p501(C,B).
p637(A,B):-p3(A,C),p501(C,B).
p641(A,B):-p140(A,C),p426(C,B).
p669(A,B):-p175(A,C),p856(C,B).
p694(A,B):-p242(A,C),p364(C,B).
p710(A,B):-p710_1(A,B),is_lowercase(B).
p710_1(A,B):-mk_lowercase(A,C),p101(C,B).
p710_1(A,B):-skip1(A,C),p710_1(C,B).
p802(A,B):-p416(A,C),p314(C,B).
p942(A,B):-p942_1(A,B),not_letter(B).
p942_1(A,B):-p850(A,C),mk_uppercase(C,B).
p942_1(A,B):-skip1(A,C),p942_1(C,B).
p948(A,B):-skip1(A,C),p390(C,B).
% asserting p38/2
% asserting p44/2
% asserting p641/2
% asserting p669/2
...
%timeout
%timeout
b249(A,B):-p515(A,C),b249_1(C,B).
b249_1(A,B):-skip1(A,C),p25(C,B).
b249_1(A,B):-is_number(A),p515(A,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b309(A,B):-p25(A,C),b309_1(C,B).
b309_1(A,B):-skip1(A,C),p467(C,B).
%timeout
%timeout

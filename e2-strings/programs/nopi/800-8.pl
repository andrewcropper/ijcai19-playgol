...
% asserting p793/2
% depth 3
p1(A,B):-p428(A,C),p1_1(C,B).
p1_1(A,B):-p220(A,C),p1_2(C,B).
p1_2(A,B):-p20(A,C),mk_uppercase(C,B).
p6(A,B):-p294(A,C),p301(C,B).
p9(A,B):-p15(A,C),p377(C,B).
p11(A,B):-mk_lowercase(A,C),p11_1(C,B).
p11_1(A,B):-p20(A,C),p42(C,B).
p12(A,B):-p30(A,C),p12_1(C,B).
p12_1(A,B):-skip1(A,C),p716(C,B).
...
p53_1(A,B):-p648(A,C),p4(C,B).
p54(A,B):-mk_lowercase(A,C),p54_1(C,B).
p54_1(A,B):-p277(A,C),mk_uppercase(C,B).
...
p87(A,B):-p294(A,C),p87_1(C,B).
p87_1(A,B):-skip1(A,C),p220(C,B).
p94(A,B):-copy1(A,C),p94_1(C,B).
p94_1(A,B):-p79(A,C),p45(C,B).
...
p102(A,B):-p417(A,C),p102_1(C,B).
p102_1(A,B):-skip1(A,C),p364(C,B).
p103(A,B):-mk_lowercase(A,C),p103_1(C,B).
p103_1(A,B):-skip1(A,C),p343(C,B).
p105(A,B):-p63(A,C),p394(C,B).
p106(A,B):-p66(A,C),p96(C,B).
p109(A,B):-p221(A,C),p482(C,B).
p110(A,B):-skip1(A,C),p110_1(C,B).
p110_1(A,B):-p198(A,C),p493(C,B).
p111(A,B):-skip1(A,C),p111_1(C,B).
p111_1(A,B):-p198(A,C),p716(C,B).
...
p153_1(A,B):-p301(A,C),p4(C,B).
p155(A,B):-p583(A,C),p155_1(C,B).
p155_1(A,B):-p510(A,C),p2(C,B).
p159(A,B):-copy1(A,C),p159_1(C,B).
p159_1(A,B):-p544(A,C),p198(C,B).
p161(A,B):-p16(A,C),p220(C,B).
p164(A,B):-p191(A,C),p2(C,B).
p166(A,B):-mk_lowercase(A,C),p166_1(C,B).
p166_1(A,B):-mk_lowercase(A,C),p137(C,B).
p166_1(A,B):-skip1(A,C),p166_1(C,B).
...
p188_1(A,B):-p512(A,C),p188_2(C,B).
p188_2(A,B):-copy1(A,C),p66(C,B).
...
p212_1(A,B):-skip1(A,C),p212_2(C,B).
p212_2(A,B):-p605(A,C),p68(C,B).
p213(A,B):-p4(A,C),p428(C,B).
p216(A,B):-skip1(A,C),p216_1(C,B).
p216_1(A,B):-skip1(A,C),p216_2(C,B).
p216_2(A,B):-p396(A,C),p198(C,B).
p222(A,B):-p63(A,C),p222_1(C,B).
p222_1(A,B):-skip1(A,C),p786(C,B).
p226(A,B):-p126(A,C),p175(C,B).
p227(A,B):-skip1(A,C),p227_1(C,B).
p227_1(A,B):-p146(A,C),p2(C,B).
...
p340(A,B):-p296(A,C),p340_1(C,B).
p340_1(A,B):-p48(A,C),p79(C,B).
p341(A,B):-copy1(A,C),p341_1(C,B).
p341_1(A,B):-p775(A,C),p341_2(C,B).
p341_2(A,B):-p30(A,C),p493(C,B).
...
p348_1(A,B):-mk_lowercase(A,B),is_lowercase(B).
...
p468(A,B):-p4(A,C),p468_1(C,B).
p468_1(A,B):-p462(A,C),p79(C,B).
p469(A,B):-p4(A,C),p409(C,B).
p470(A,B):-p377(A,C),p42(C,B).
p474(A,B):-p442(A,C),p198(C,B).
p477(A,B):-p394(A,C),p139(C,B).
p480(A,B):-p30(A,C),p480_1(C,B).
p480_1(A,B):-p72(A,C),p482(C,B).
p485(A,B):-p66(A,C),p16(C,B).
p491(A,B):-p96(A,C),p735(C,B).
p494(A,B):-p428(A,C),p494_1(C,B).
p494_1(A,B):-copy1(A,C),p20(C,B).
...
p527(A,B):-p79(A,C),p527_1(C,B).
p527_1(A,B):-skip1(A,C),p710(C,B).
p528(A,B):-skip1(A,C),p528_1(C,B).
p528_1(A,B):-p2(A,C),p428(C,B).
...
p572_1(A,B):-p296(A,C),p313(C,B).
p573(A,B):-copy1(A,C),p573_1(C,B).
p573_1(A,B):-skip1(A,C),p481(C,B).
p574(A,B):-p574_1(A,B),is_uppercase(B).
p574_1(A,B):-p786(A,C),p4(C,B).
p574_1(A,B):-skip1(A,C),p574_1(C,B).
...
p585(A,B):-p417(A,C),p585_1(C,B).
p585_1(A,B):-p42(A,C),p96(C,B).
p586(A,B):-p586_1(A,B),is_space(B).
p586_1(A,B):-p4(A,C),p198(C,B).
p586_1(A,B):-p96(A,C),p586_1(C,B).
p590(A,B):-p96(A,C),p590_1(C,B).
p590_1(A,B):-p628(A,C),p2(C,B).
p595(A,B):-p126(A,C),p595_1(C,B).
p595_1(A,B):-skip1(A,C),p618(C,B).
...
p606_1(A,B):-p294(A,C),p606_2(C,B).
p606_2(A,B):-p126(A,C),mk_lowercase(C,B).
...
p617_1(A,B):-p30(A,C),p617_2(C,B).
p617_2(A,B):-skip1(A,C),p428(C,B).
p619(A,B):-copy1(A,C),p619_1(C,B).
p619_1(A,B):-p277(A,C),p48(C,B).
p621(A,B):-p126(A,C),p621_1(C,B).
p621_1(A,B):-p30(A,C),p16(C,B).
...
p651_1(A,B):-p72(A,C),p301(C,B).
p653(A,B):-p277(A,C),p221(C,B).
p654(A,B):-p336(A,C),p654_1(C,B).
p654_1(A,B):-skip1(A,C),p390(C,B).
p655(A,B):-p42(A,C),p655_1(C,B).
p655_1(A,B):-mk_uppercase(A,C),p655_2(C,B).
p655_2(A,B):-p38(A,C),p198(C,B).
...
p680_1(A,B):-p48(A,C),p482(C,B).
p681(A,B):-p464(A,C),p96(C,B).
p682(A,B):-skip1(A,C),p682_1(C,B).
p682_1(A,B):-p30(A,C),p144(C,B).
...
p698_1(A,B):-p558(A,C),p698_2(C,B).
p698_2(A,B):-mk_lowercase(A,C),p38(C,B).
...
p758_1(A,B):-skip1(A,C),p758_2(C,B).
p758_2(A,B):-p209(A,C),p79(C,B).
p761(A,B):-p4(A,C),p445(C,B).
p766(A,B):-p520(A,C),p30(C,B).
p767(A,B):-copy1(A,C),p481(C,B).
p769(A,B):-p42(A,C),p769_1(C,B).
p769_1(A,B):-p277(A,C),p79(C,B).
p770(A,B):-mk_lowercase(A,C),p770_1(C,B).
p770_1(A,B):-p96(A,C),p101(C,B).
...
p792_1(A,B):-p301(A,C),p390(C,B).
p795(A,B):-skip1(A,C),p795_1(C,B).
p795_1(A,B):-p2(A,C),p795_2(C,B).
p795_2(A,B):-skip1(A,C),p66(C,B).
...
p799_1(A,B):-skip1(A,C),p799_2(C,B).
p799_2(A,B):-p336(A,C),p15(C,B).
...
p261_2(A,B):-p309(A,C),p198(C,B).
p329(A,B):-copy1(A,C),p329_1(C,B).
p329_1(A,B):-skip1(A,C),p329_2(C,B).
p329_2(A,B):-skip1(A,C),p713(C,B).
p501(A,B):-p501_1(A,B),is_uppercase(B).
p501_1(A,B):-p746(A,C),copy1(C,B).
p501_1(A,B):-skip1(A,C),p501_1(C,B).
p504(A,B):-p96(A,C),p504_1(C,B).
p504_1(A,B):-p283(A,C),p504_2(C,B).
p504_2(A,B):-p313(A,C),p126(C,B).
p552(A,B):-p220(A,C),p552_1(C,B).
p552_1(A,B):-p679(A,C),p198(C,B).
p588(A,B):-p588_1(A,B),is_lowercase(B).
p588_1(A,B):-p42(A,C),p588_2(C,B).
p588_2(A,B):-p283(A,C),p364(C,B).
p601(A,B):-p601_1(A,B),not_letter(B).
p601_1(A,B):-p96(A,C),p2(C,B).
p601_1(A,B):-p42(A,C),p601_1(C,B).
p632(A,B):-p33(A,C),p118(C,B).
p632(A,B):-skip1(A,C),p632(C,B).
p665(A,B):-p665_1(A,B),is_lowercase(B).
p665_1(A,B):-p163(A,C),skip1(C,B).
p665_1(A,B):-skip1(A,C),p665_1(C,B).
% asserting p95/2
% asserting p261/2
% asserting p329/2
% asserting p501/2
...
b113_1(A,B):-p198(A,C),b113_2(C,B).
b113_2(A,B):-skip1(A,C),p753(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b224(A,B):-p338(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout

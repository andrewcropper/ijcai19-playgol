...
p6(A,B):-p21(A,C),p6_1(C,B).
p6_1(A,B):-p85(A,C),mk_uppercase(C,B).
p14(A,B):-p16(A,C),p14_1(C,B).
p14_1(A,B):-p109(A,C),mk_uppercase(C,B).
p15(A,B):-skip1(A,C),p132(C,B).
p17(A,B):-skip1(A,C),p17_1(C,B).
p17_1(A,B):-skip1(A,C),p17_2(C,B).
p17_2(A,B):-p23(A,C),p21(C,B).
...
p34_1(A,B):-p21(A,C),p34_2(C,B).
p34_2(A,B):-p132(A,C),mk_lowercase(C,B).
p35(A,B):-p254(A,C),p59(C,B).
p40(A,B):-p5(A,C),p140(C,B).
p45(A,B):-p130(A,C),p369(C,B).
p46(A,B):-p132(A,C),p46_1(C,B).
p46_1(A,B):-skip1(A,C),p21(C,B).
p49(A,B):-p16(A,C),p49_1(C,B).
p49_1(A,B):-skip1(A,C),p4(C,B).
p49_1(A,B):-mk_lowercase(A,C),p49_1(C,B).
p51(A,B):-p59(A,C),p51_1(C,B).
p51_1(A,B):-p353(A,C),mk_uppercase(C,B).
p52(A,B):-p318(A,C),p52_1(C,B).
p52_1(A,B):-p306(A,C),p128(C,B).
p53(A,B):-p169(A,C),p191(C,B).
p55(A,B):-p22(A,C),p55_1(C,B).
p55_1(A,B):-mk_lowercase(A,C),p109(C,B).
p56(A,B):-p92(A,C),p56_1(C,B).
p56_1(A,B):-mk_uppercase(A,C),p68(C,B).
p61(A,B):-p21(A,C),p61_1(C,B).
p61_1(A,B):-skip1(A,C),p22(C,B).
p62(A,B):-p62_1(A,B),is_uppercase(B).
p62_1(A,B):-p156(A,C),mk_uppercase(C,B).
p62_1(A,B):-skip1(A,C),p62_1(C,B).
...
p124(A,B):-p169(A,C),mk_uppercase(C,B).
p124(A,B):-skip1(A,C),p124(C,B).
p126(A,B):-mk_lowercase(A,C),p126_1(C,B).
p126_1(A,B):-p21(A,C),p9(C,B).
...
p154_1(A,B):-mk_uppercase(A,C),p38(C,B).
p155(A,B):-copy1(A,C),p155_1(C,B).
p155_1(A,B):-p85(A,C),p150(C,B).
...
p167(A,B):-p167_1(A,B),not_number(B).
p167_1(A,B):-copy1(A,C),p167_2(C,B).
p167_2(A,B):-mk_uppercase(A,C),p37(C,B).
...
p190(A,B):-p190_1(A,B),is_number(B).
p190_1(A,B):-p16(A,C),p190_2(C,B).
p190_2(A,B):-p91(A,C),p37(C,B).
p195(A,B):-p209(A,C),p150(C,B).
p196(A,B):-p140(A,C),p245(C,B).
p199(A,B):-p37(A,C),p199_1(C,B).
p199_1(A,B):-skip1(A,C),p199_2(C,B).
p199_2(A,B):-is_lowercase(A),p156(A,B).
...
p225(A,B):-p225_1(A,B),not_empty(B).
p225_1(A,B):-p143(A,C),p37(C,B).
p226(A,B):-copy1(A,C),p226_1(C,B).
p226_1(A,B):-p37(A,C),p226_2(C,B).
p226_2(A,B):-is_number(A),p169(A,B).
p227(A,B):-p39(A,C),p227_1(C,B).
p227_1(A,B):-p9(A,C),p130(C,B).
p229(A,B):-copy1(A,C),p385(C,B).
p246(A,B):-p156(A,C),p246_1(C,B).
p246_1(A,B):-mk_uppercase(A,C),p84(C,B).
p248(A,B):-skip1(A,C),p248_1(C,B).
p248_1(A,B):-p91(A,C),p21(C,B).
p260(A,B):-p23(A,C),p260_1(C,B).
p260_1(A,B):-p142(A,C),p169(C,B).
p261(A,B):-p43(A,C),p261_1(C,B).
p261_1(A,B):-p142(A,C),mk_uppercase(C,B).
p272(A,B):-p18(A,C),p272_1(C,B).
p272_1(A,B):-p169(A,C),p272_2(C,B).
p272_2(A,B):-skip1(A,C),p21(C,B).
p275(A,B):-p150(A,C),p251(C,B).
p284(A,B):-p254(A,C),p297(C,B).
p286(A,B):-p142(A,C),p286_1(C,B).
p286_1(A,B):-p9(A,C),p9(C,B).
p287(A,B):-p254(A,C),p287_1(C,B).
p287_1(A,B):-p16(A,C),p287_2(C,B).
p287_2(A,B):-skip1(A,C),p130(C,B).
p289(A,B):-p289_1(A,B),not_empty(B).
p289_1(A,B):-copy1(A,C),p289_2(C,B).
p289_2(A,B):-p309(A,C),p37(C,B).
p293(A,B):-p95(A,C),p26(C,B).
p294(A,B):-p16(A,C),p294_1(C,B).
p294_1(A,B):-skip1(A,C),p385(C,B).
p300(A,B):-p68(A,C),p300_1(C,B).
p300_1(A,B):-p245(A,C),p84(C,B).
p311(A,B):-copy1(A,C),p311_1(C,B).
p311_1(A,B):-p156(A,C),p311_2(C,B).
p311_2(A,B):-mk_uppercase(A,C),p271(C,B).
p312(A,B):-copy1(A,C),p312_1(C,B).
p312_1(A,B):-skip1(A,C),p209(C,B).
p313(A,B):-skip1(A,C),p313_1(C,B).
p313_1(A,B):-p21(A,C),p313_2(C,B).
p313_2(A,B):-skip1(A,C),p304(C,B).
p316(A,B):-p59(A,C),p150(C,B).
p317(A,B):-p317_1(A,B),is_uppercase(B).
p317_1(A,B):-p37(A,C),p150(C,B).
p319(A,B):-copy1(A,C),p319_1(C,B).
p319_1(A,B):-p9(A,C),p271(C,B).
...
p329_1(A,B):-p150(A,C),p385(C,B).
p330(A,B):-skip1(A,C),p330_1(C,B).
p330_1(A,B):-p169(A,C),p128(C,B).
p332(A,B):-mk_lowercase(A,C),p332_1(C,B).
p332_1(A,B):-skip1(A,C),p332_2(C,B).
p332_2(A,B):-skip1(A,C),p21(C,B).
p333(A,B):-p209(A,C),p333_1(C,B).
p333_1(A,B):-p128(A,C),p16(C,B).
...
p366_1(A,B):-p37(A,C),p366_2(C,B).
p366_2(A,B):-skip1(A,C),mk_lowercase(C,B).
...
p375_1(A,B):-p132(A,C),p375_2(C,B).
p375_2(A,B):-p169(A,C),mk_uppercase(C,B).
...
p397(A,B):-p156(A,C),p397_1(C,B).
p397_1(A,B):-p68(A,C),mk_uppercase(C,B).
...
p3_1(A,B):-p21(A,C),p332(C,B).
p110(A,B):-p332(A,B),is_lowercase(B).
p110(A,B):-skip1(A,C),p110(C,B).
p327(A,B):-skip1(A,C),p327_1(C,B).
p327_1(A,B):-p312(A,C),p238(C,B).
p367(A,B):-p156(A,C),p367_1(C,B).
p367_1(A,B):-p130(A,C),p367_2(C,B).
p367_2(A,B):-mk_lowercase(A,C),p181(C,B).
% asserting p3/2
% asserting p110/2
% asserting p327/2
% asserting p367/2
...
b27(A,B):-mk_lowercase(A,C),p39(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b113(A,B):-p181(A,C),b113_1(C,B).
b113_1(A,B):-p194(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout

...
p224_1(A,B):-p20(A,C),p224_2(C,B).
p224_2(A,B):-p258(A,C),p27(C,B).
...
p250_1(A,B):-skip1(A,C),p399(C,B).
p252(A,B):-p107(A,C),p252_1(C,B).
p252_1(A,B):-skip1(A,C),p381(C,B).
...
p388_1(A,B):-p22(A,C),p187(C,B).
p389(A,B):-mk_uppercase(A,C),p29(C,B).
p390(A,B):-p134(A,C),p86(C,B).
p392(A,B):-p1585(A,C),p392_1(C,B).
p392_1(A,B):-skip1(A,C),p689(C,B).
p402(A,B):-p74(A,C),p402_1(C,B).
p402_1(A,B):-copy1(A,C),p185(C,B).
...
p453(A,B):-p61(A,C),p453_1(C,B).
p453_1(A,B):-p828(A,C),p229(C,B).
...
p533(A,B):-p1424(A,C),p972(C,B).
p533(A,B):-skip1(A,C),p533(C,B).
p540(A,B):-skip1(A,C),p540_1(C,B).
p540_1(A,B):-skip1(A,C),p629(C,B).
p542(A,B):-p51(A,C),p258(C,B).
p545(A,B):-p229(A,C),p545_1(C,B).
p545_1(A,B):-p1215(A,C),p272(C,B).
...
p561(A,B):-p107(A,C),p561_1(C,B).
p561_1(A,B):-skip1(A,C),p1216(C,B).
p562(A,B):-copy1(A,C),p562_1(C,B).
p562_1(A,B):-p51(A,C),p860(C,B).
p563(A,B):-copy1(A,C),p563_1(C,B).
p563_1(A,B):-p925(A,C),p187(C,B).
p566(A,B):-p84(A,C),p344(C,B).
...
p647_1(A,B):-p665(A,C),p101(C,B).
p648(A,B):-p1812(A,C),p112(C,B).
p650(A,B):-p381(A,C),p174(C,B).
...
p656_1(A,B):-p22(A,C),p187(C,B).
p657(A,B):-p22(A,C),p657_1(C,B).
p657_1(A,B):-p456(A,C),mk_uppercase(C,B).
...
p850_1(A,B):-p134(A,C),p29(C,B).
p852(A,B):-p229(A,C),p145(C,B).
p856(A,B):-p5(A,C),p752(C,B).
p857(A,B):-p174(A,C),p229(C,B).
...
p871_1(A,B):-p134(A,C),p871_2(C,B).
p871_2(A,B):-skip1(A,C),p664(C,B).
p873(A,B):-p20(A,C),p873_1(C,B).
p873_1(A,B):-skip1(A,C),p1072(C,B).
...
p991_1(A,B):-p89(A,C),p22(C,B).
p992(A,B):-p95(A,C),p20(C,B).
...
p1084(A,B):-p101(A,C),p1084_1(C,B).
p1084_1(A,B):-skip1(A,C),p1109(C,B).
...
p1186(A,B):-p344(A,C),p972(C,B).
p1188(A,B):-p134(A,C),p1671(C,B).
p1189(A,B):-copy1(A,C),p1189_1(C,B).
p1189_1(A,B):-skip1(A,C),p326(C,B).
p1191(A,B):-copy1(A,C),p1191_1(C,B).
p1191_1(A,B):-skip1(A,C),p1191_2(C,B).
p1191_2(A,B):-p187(A,C),p51(C,B).
...
p1209(A,B):-p107(A,C),p174(C,B).
p1214(A,B):-copy1(A,C),p415(C,B).
p1218(A,B):-p420(A,C),p624(C,B).
p1224(A,B):-p67(A,C),p1224_1(C,B).
p1224_1(A,B):-skip1(A,C),p925(C,B).
...
p1262(A,B):-p629(A,C),p728(C,B).
p1265(A,B):-p20(A,C),p187(C,B).
p1268(A,B):-p104(A,C),p1268_1(C,B).
p1268_1(A,B):-p112(A,C),p20(C,B).
p1270(A,B):-p1140(A,C),p1270_1(C,B).
p1270_1(A,B):-p311(A,C),p32(C,B).
p1271(A,B):-p1512(A,C),p1791(C,B).
p1274(A,B):-p603(A,C),p1427(C,B).
p1275(A,B):-p925(A,C),p1275_1(C,B).
p1275_1(A,B):-p27(A,C),p1476(C,B).
p1278(A,B):-p22(A,C),p1278_1(C,B).
p1278_1(A,B):-skip1(A,C),p1251(C,B).
...
p1345(A,B):-p590(A,C),mk_lowercase(C,B).
p1348(A,B):-p1476(A,C),p1348_1(C,B).
p1348_1(A,B):-p27(A,C),p925(C,B).
p1355(A,B):-p381(A,C),p1499(C,B).
p1360(A,B):-p30(A,C),p101(C,B).
p1364(A,B):-mk_uppercase(A,C),p1364_1(C,B).
p1364_1(A,B):-p37(A,C),p20(C,B).
p1366(A,B):-p866(A,C),p578(C,B).
p1370(A,B):-p107(A,C),p1370_1(C,B).
p1370_1(A,B):-skip1(A,C),p266(C,B).
p1373(A,B):-p134(A,C),p1501(C,B).
p1374(A,B):-p1236(A,C),p20(C,B).
...
p1444(A,B):-p860(A,C),p69(C,B).
p1447(A,B):-mk_uppercase(A,C),p1447_1(C,B).
p1447_1(A,B):-skip1(A,C),p84(C,B).
...
p1458_1(A,B):-skip1(A,C),p629(C,B).
...
p1469(A,B):-p311(A,C),p134(C,B).
p1470(A,B):-mk_uppercase(A,C),p86(C,B).
p1471(A,B):-p408(A,C),p420(C,B).
p1472(A,B):-p229(A,C),p174(C,B).
p1474(A,B):-p1474_1(A,B),is_lowercase(B).
p1474_1(A,B):-p381(A,C),p685(C,B).
p1477(A,B):-skip1(A,C),p1477_1(C,B).
p1477_1(A,B):-p22(A,C),p55(C,B).
...
p1532_1(A,B):-p113(A,C),p185(C,B).
p1535(A,B):-p185(A,C),p100(C,B).
p1540(A,B):-p970(A,C),p66(C,B).
p1541(A,B):-p970(A,C),p86(C,B).
p1542(A,B):-p113(A,C),p266(C,B).
p1544(A,B):-p193(A,C),p107(C,B).
p1547(A,B):-p311(A,C),p165(C,B).
p1548(A,B):-copy1(A,C),p1097(C,B).
p1549(A,B):-p22(A,C),p86(C,B).
p1562(A,B):-skip1(A,C),p1562_1(C,B).
p1562_1(A,B):-p5(A,C),p1562_2(C,B).
p1562_2(A,B):-p232(A,C),p13(C,B).
p1564(A,B):-skip1(A,C),p1564_1(C,B).
p1564_1(A,B):-p134(A,C),p95(C,B).
p1566(A,B):-p700(A,C),p185(C,B).
p1571(A,B):-p1571_1(A,B),is_lowercase(B).
p1571_1(A,B):-not_letter(A),p174(A,B).
p1571_1(A,B):-skip1(A,C),p1571_1(C,B).
p1573(A,B):-skip1(A,C),p340(C,B).
p1574(A,B):-p689(A,C),p225(C,B).
p1575(A,B):-p627(A,C),p61(C,B).
...
p1583(A,B):-p1663(A,C),p1583_1(C,B).
p1583_1(A,B):-p134(A,C),p32(C,B).
p1589(A,B):-p66(A,C),p1054(C,B).
p1590(A,B):-p970(A,C),p556(C,B).
p1593(A,B):-p828(A,C),p802(C,B).
p1595(A,B):-mk_lowercase(A,C),p1595_1(C,B).
p1595_1(A,B):-p394(A,C),p134(C,B).
p1599(A,B):-p20(A,C),p1599_1(C,B).
p1599_1(A,B):-p32(A,C),p925(C,B).
p1603(A,B):-skip1(A,C),p1603_1(C,B).
p1603_1(A,B):-p61(A,C),p86(C,B).
p1605(A,B):-skip1(A,C),p1605_1(C,B).
p1605_1(A,B):-p27(A,C),p780(C,B).
p1606(A,B):-p381(A,C),p1606_1(C,B).
p1606_1(A,B):-p828(A,C),p229(C,B).
...
p1623(A,B):-p51(A,C),p1623_1(C,B).
p1623_1(A,B):-p112(A,C),p61(C,B).
...
p1689(A,B):-p193(A,C),p828(C,B).
p1690(A,B):-skip1(A,C),p1097(C,B).
p1691(A,B):-p22(A,C),p29(C,B).
p1692(A,B):-p101(A,C),p1692_1(C,B).
p1692_1(A,B):-p664(A,C),p144(C,B).
...
p1720_1(A,B):-p51(A,C),p961(C,B).
p1721(A,B):-p394(A,C),p265(C,B).
p1724(A,B):-copy1(A,C),p1724_1(C,B).
p1724_1(A,B):-p32(A,C),p415(C,B).
p1725(A,B):-p134(A,C),p1725_1(C,B).
p1725_1(A,B):-skip1(A,C),p851(C,B).
...
p1739_1(A,B):-p5(A,C),p536(C,B).
p1743(A,B):-skip1(A,C),p1743_1(C,B).
p1743_1(A,B):-p61(A,C),p1185(C,B).
p1745(A,B):-p525(A,C),p20(C,B).
p1745(A,B):-p229(A,C),p1745(C,B).
p1746(A,B):-skip1(A,C),p1746_1(C,B).
p1746_1(A,B):-skip1(A,C),p1746_2(C,B).
p1746_2(A,B):-skip1(A,C),p1107(C,B).
...
p1870(A,B):-p578(A,C),p1870_1(C,B).
p1870_1(A,B):-skip1(A,C),p536(C,B).
p1871(A,B):-mk_uppercase(A,C),p1871_1(C,B).
p1871_1(A,B):-p925(A,C),p1087(C,B).
...
p1913(A,B):-p1107(A,C),p210(C,B).
p1915(A,B):-skip1(A,C),p1915_1(C,B).
p1915_1(A,B):-p381(A,C),p846(C,B).
p1916(A,B):-p22(A,C),p75(C,B).
p1917(A,B):-p53(A,C),p1917_1(C,B).
p1917_1(A,B):-skip1(A,C),p340(C,B).
p1920(A,B):-p67(A,C),p319(C,B).
p1923(A,B):-copy1(A,C),p428(C,B).
p1926(A,B):-p1663(A,C),p1926_1(C,B).
p1926_1(A,B):-p61(A,C),p1424(C,B).
p1927(A,B):-p5(A,C),p866(C,B).
p1931(A,B):-mk_lowercase(A,C),p1931_1(C,B).
p1931_1(A,B):-p925(A,C),p102(C,B).
p1933(A,B):-copy1(A,C),p872(C,B).
p1934(A,B):-p20(A,C),p860(C,B).
p1935(A,B):-p200(A,C),p415(C,B).
p1936(A,B):-skip1(A,C),p1936_1(C,B).
p1936_1(A,B):-skip1(A,C),p629(C,B).
...
p1964_1(A,B):-p134(A,C),p59(C,B).
p1967(A,B):-p1107(A,C),p59(C,B).
p1968(A,B):-p752(A,C),p232(C,B).
p1978(A,B):-p5(A,C),p1978_1(C,B).
p1978_1(A,B):-skip1(A,C),p1504(C,B).
...
p942(A,B):-p20(A,C),p1769(C,B).
p1053(A,B):-p1053_1(A,B),is_lowercase(B).
p1053_1(A,B):-copy1(A,C),p1053_2(C,B).
p1053_2(A,B):-p1242(A,C),skip1(C,B).
p1089(A,B):-copy1(A,C),p1089_1(C,B).
p1089_1(A,B):-skip1(A,C),p1089_2(C,B).
p1089_2(A,B):-skip1(A,C),p1772(C,B).
p1324(A,B):-copy1(A,C),p1324_1(C,B).
p1324_1(A,B):-skip1(A,C),p1324_2(C,B).
p1324_2(A,B):-skip1(A,C),p603(C,B).
p1744(A,B):-skip1(A,C),p1744_1(C,B).
p1744_1(A,B):-p5(A,C),p1744_2(C,B).
p1744_2(A,B):-skip1(A,C),p540(C,B).
p1821(A,B):-skip1(A,C),p1821_1(C,B).
p1821_1(A,B):-p27(A,C),p709(C,B).
p1974(A,B):-mk_uppercase(A,C),p1974_1(C,B).
p1974_1(A,B):-p1909(A,C),p210(C,B).
% asserting p703/2
% asserting p942/2
% asserting p1053/2
% asserting p1089/2
...
b81(A,B):-p185(A,B),is_uppercase(B).

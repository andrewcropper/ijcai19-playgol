...
p5(A,B):-p176(A,C),p366(C,B).
p8(A,B):-mk_uppercase(A,C),p8_1(C,B).
p8_1(A,B):-p239(A,C),copy1(C,B).
...
p27(A,B):-p21(A,C),p27_1(C,B).
p27_1(A,B):-p186(A,C),p80(C,B).
p29(A,B):-p176(A,C),p119(C,B).
...
p52_1(A,B):-p378(A,C),p52_2(C,B).
p52_2(A,B):-copy1(A,C),p119(C,B).
p61(A,B):-p25(A,C),p61_1(C,B).
p61_1(A,B):-p302(A,C),p158(C,B).
p62(A,B):-p6(A,C),p62_1(C,B).
p62_1(A,B):-skip1(A,C),p9(C,B).
p64(A,B):-mk_lowercase(A,C),p64_1(C,B).
p64_1(A,B):-p85(A,C),mk_uppercase(C,B).
p65(A,B):-mk_lowercase(A,C),p65_1(C,B).
p65_1(A,B):-p139(A,C),p65_2(C,B).
p65_2(A,B):-p210(A,C),p176(C,B).
p68(A,B):-p139(A,C),p233(C,B).
p70(A,B):-p166(A,C),p70_1(C,B).
p70_1(A,B):-skip1(A,C),p25(C,B).
...
p144(A,B):-p176(A,C),p272(C,B).
p152(A,B):-p85(A,C),mk_uppercase(C,B).
p155(A,B):-skip1(A,C),p155_1(C,B).
p155_1(A,B):-p302(A,C),p31(C,B).
p161(A,B):-mk_uppercase(A,C),p161_1(C,B).
p161_1(A,B):-p234(A,C),p161_2(C,B).
p161_2(A,B):-p35(A,C),p139(C,B).
p164(A,B):-p234(A,C),p164_1(C,B).
p164_1(A,B):-skip1(A,C),p25(C,B).
p167(A,B):-p60(A,C),p186(C,B).
p170(A,B):-p330(A,C),p139(C,B).
...
p282_1(A,B):-p210(A,C),p282_2(C,B).
p282_2(A,B):-p85(A,C),p257(C,B).
...
p46_2(A,B):-p158(A,C),p25(C,B).
p238(A,B):-skip1(A,C),p238_1(C,B).
p238_1(A,B):-p80(A,C),p238_2(C,B).
p238_2(A,B):-p128(A,C),p257(C,B).
% asserting p46/2
% asserting p238/2
%timeout
%timeout
...
%timeout
%timeout
b81(A,B):-p128(A,B),is_uppercase(B).

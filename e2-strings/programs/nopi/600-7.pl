...
p58_1(A,B):-p35(A,C),p359(C,B).
p59(A,B):-p588(A,C),p16(C,B).
p60(A,B):-p479(A,C),p60_1(C,B).
p60_1(A,B):-copy1(A,C),p1(C,B).
...
p184_1(A,B):-p253(A,C),p52(C,B).
p189(A,B):-p16(A,C),p336(C,B).
p191(A,B):-p554(A,C),p191_1(C,B).
p191_1(A,B):-p11(A,C),mk_lowercase(C,B).
...
p200_1(A,B):-p99(A,C),p190(C,B).
p201(A,B):-p43(A,C),p201_1(C,B).
p201_1(A,B):-mk_uppercase(A,C),p35(C,B).
...
p219_1(A,B):-p16(A,C),p219_2(C,B).
p219_2(A,B):-skip1(A,C),p110(C,B).
...
p255_1(A,B):-mk_uppercase(A,C),p255_1(C,B).
...
p330(A,B):-p401(A,C),p330_1(C,B).
p330_1(A,B):-mk_uppercase(A,C),p387(C,B).
...
p340_1(A,B):-p16(A,C),p322(C,B).
p342(A,B):-p253(A,C),p43(C,B).
p343(A,B):-p16(A,C),p343_1(C,B).
p343_1(A,B):-p387(A,C),p581(C,B).
p345(A,B):-p52(A,C),p253(C,B).
p349(A,B):-p268(A,C),p52(C,B).
...
p438_1(A,B):-skip1(A,C),p79(C,B).
p439(A,B):-p554(A,C),p52(C,B).
p443(A,B):-copy1(A,C),p443_1(C,B).
p443_1(A,B):-p479(A,C),p71(C,B).
...
p515(A,B):-p253(A,C),p515_1(C,B).
p515_1(A,B):-skip1(A,C),p515_2(C,B).
p515_2(A,B):-p19(A,C),p192(C,B).
...
p529_1(A,B):-skip1(A,C),p74(C,B).
p543(A,B):-p16(A,C),p543_1(C,B).
p543_1(A,B):-p320(A,C),p21(C,B).
...
p556_1(A,B):-p35(A,C),p319(C,B).
p560(A,B):-mk_lowercase(A,C),p10(C,B).
p564(A,B):-p35(A,C),p464(C,B).
p566(A,B):-p11(A,C),p566_1(C,B).
p566_1(A,B):-p479(A,C),copy1(C,B).
p568(A,B):-p178(A,C),p440(C,B).
p572(A,B):-p319(A,C),p572_1(C,B).
p572_1(A,B):-p253(A,C),p73(C,B).
p573(A,B):-p422(A,C),p573_1(C,B).
p573_1(A,B):-p392(A,C),mk_uppercase(C,B).
...
p594_1(A,B):-p186(A,C),p594_2(C,B).
p594_2(A,B):-skip1(A,C),p208(C,B).
...
p34(A,B):-p495(A,C),mk_lowercase(C,B).
p48(A,B):-p178(A,C),p48_1(C,B).
p48_1(A,B):-p244(A,C),p48_2(C,B).
p48_2(A,B):-mk_uppercase(A,C),mk_uppercase(C,B).
p82(A,B):-copy1(A,C),p82_1(C,B).
p82_1(A,B):-copy1(A,C),p548(C,B).
p82_1(A,B):-mk_uppercase(A,C),p82_1(C,B).
p118(A,B):-skip1(A,C),p118_1(C,B).
p118_1(A,B):-p422(A,C),p118_2(C,B).
p118_2(A,B):-p478(A,C),mk_lowercase(C,B).
...
b48_2(A,B):-p26(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout
%timeout

...
p5_1(A,B):-skip1(A,C),p5_2(C,B).
p5_2(A,B):-p592(A,C),p47(C,B).
p6(A,B):-p148(A,C),p32(C,B).
p8(A,B):-p174(A,C),p228(C,B).
p9(A,B):-p1539(A,C),p218(C,B).
...
p74_2(A,B):-p279(A,C),mk_lowercase(C,B).
p84(A,B):-copy1(A,C),p84_1(C,B).
p84_1(A,B):-p279(A,C),p33(C,B).
p84_1(A,B):-p220(A,C),p84_1(C,B).
p85(A,B):-p668(A,C),p80(C,B).
p86(A,B):-p315(A,C),p65(C,B).
p87(A,B):-p148(A,C),p51(C,B).
p88(A,B):-mk_lowercase(A,C),p88_1(C,B).
p88_1(A,B):-p231(A,C),p660(C,B).
p91(A,B):-p794(A,C),p989(C,B).
...
p216(A,B):-p281(A,C),p66(C,B).
p222(A,B):-p33(A,C),p222_1(C,B).
p222_1(A,B):-p1124(A,C),p182(C,B).
p224(A,B):-p51(A,C),p224_1(C,B).
p224_1(A,B):-skip1(A,C),p33(C,B).
p232(A,B):-skip1(A,C),p232_1(C,B).
p232_1(A,B):-p94(A,C),p232_2(C,B).
p232_2(A,B):-p279(A,C),p95(C,B).
p235(A,B):-copy1(A,C),p235_1(C,B).
p235_1(A,B):-p182(A,C),p235_2(C,B).
p235_2(A,B):-p794(A,C),p794(C,B).
...
p321(A,B):-p1409(A,C),p557(C,B).
p322(A,B):-p148(A,C),p322_1(C,B).
p322_1(A,B):-skip1(A,C),p143(C,B).
...
p410(A,B):-p33(A,C),p410_1(C,B).
p410_1(A,B):-p455(A,C),p337(C,B).
...
p419_1(A,B):-mk_uppercase(A,C),p419_2(C,B).
p419_2(A,B):-p1310(A,C),mk_uppercase(C,B).
p420(A,B):-p139(A,C),p1(C,B).
p422(A,B):-p143(A,C),p422_1(C,B).
p422_1(A,B):-skip1(A,C),p926(C,B).
...
p426(A,B):-p20(A,C),p45(C,B).
p428(A,B):-p791(A,C),p93(C,B).
...
p500(A,B):-p143(A,C),p500_1(C,B).
p500_1(A,B):-p67(A,C),p47(C,B).
p501(A,B):-p1022(A,C),p35(C,B).
p502(A,B):-copy1(A,C),p502_1(C,B).
p502_1(A,B):-p1500(A,C),p33(C,B).
p505(A,B):-p33(A,C),p288(C,B).
p510(A,B):-skip1(A,C),p510_1(C,B).
p510_1(A,B):-p572(A,C),p510_2(C,B).
p510_2(A,B):-p143(A,C),p95(C,B).
...
p553(A,B):-p80(A,C),p65(C,B).
p555(A,B):-p1092(A,C),p794(C,B).
p556(A,B):-p95(A,C),p556_1(C,B).
p556_1(A,B):-p7(A,C),p427(C,B).
p558(A,B):-p151(A,C),p337(C,B).
...
p568(A,B):-p1080(A,C),p612(C,B).
p575(A,B):-p32(A,C),p493(C,B).
p576(A,B):-skip1(A,C),p117(C,B).
p578(A,B):-p592(A,C),p95(C,B).
...
p650_1(A,B):-p45(A,C),p680(C,B).
p661(A,B):-p72(A,C),p66(C,B).
p666(A,B):-p124(A,C),p174(C,B).
p667(A,B):-p80(A,C),p751(C,B).
p670(A,B):-p143(A,C),p670_1(C,B).
p670_1(A,B):-p1511(A,C),p220(C,B).
...
p685(A,B):-p35(A,C),p685_1(C,B).
p685_1(A,B):-p143(A,C),p95(C,B).
p690(A,B):-p148(A,C),p690_1(C,B).
p690_1(A,B):-p7(A,C),p151(C,B).
p692(A,B):-skip1(A,C),p692_1(C,B).
p692_1(A,B):-p33(A,C),p692_2(C,B).
p692_2(A,B):-p1(A,C),p94(C,B).
p693(A,B):-skip1(A,C),p693_1(C,B).
p693_1(A,B):-p46(A,C),p693_2(C,B).
p693_2(A,B):-p535(A,C),copy1(C,B).
...
p706_1(A,B):-p33(A,C),p1(C,B).
p711(A,B):-skip1(A,C),p1092(C,B).
p712(A,B):-p143(A,C),p1092(C,B).
p714(A,B):-skip1(A,C),p714_1(C,B).
p714_1(A,B):-p33(A,C),p1013(C,B).
p716(A,B):-p95(A,C),p716_1(C,B).
p716_1(A,B):-p66(A,C),p95(C,B).
p721(A,B):-skip1(A,C),p721_1(C,B).
p721_1(A,B):-p78(A,C),p721_2(C,B).
p721_2(A,B):-p621(A,C),p95(C,B).
p724(A,B):-p143(A,C),p680(C,B).
p728(A,B):-p89(A,C),p728_1(C,B).
p728_1(A,B):-mk_lowercase(A,C),p80(C,B).
p729(A,B):-p218(A,C),p729_1(C,B).
p729_1(A,B):-p751(A,C),p819(C,B).
p730(A,B):-p725(A,C),p52(C,B).
p731(A,B):-mk_lowercase(A,C),p731_1(C,B).
p731_1(A,B):-p1092(A,C),p17(C,B).
p732(A,B):-p600(A,C),p316(C,B).
p734(A,B):-p337(A,C),p72(C,B).
p737(A,B):-mk_lowercase(A,C),p737_1(C,B).
p737_1(A,B):-p218(A,C),p737_2(C,B).
p737_2(A,B):-p94(A,C),p93(C,B).
p738(A,B):-p143(A,C),p738_1(C,B).
p738_1(A,B):-p69(A,C),copy1(C,B).
p740(A,B):-p33(A,C),p740_1(C,B).
p740_1(A,B):-p124(A,C),p202(C,B).
p743(A,B):-copy1(A,C),p743_1(C,B).
p743_1(A,B):-p519(A,C),p220(C,B).
p744(A,B):-skip1(A,C),p744_1(C,B).
p744_1(A,B):-p1215(A,C),p744_2(C,B).
p744_2(A,B):-p218(A,C),p283(C,B).
p746(A,B):-skip1(A,C),p746_1(C,B).
p746_1(A,B):-p276(A,C),p174(C,B).
p747(A,B):-copy1(A,C),p1(C,B).
p748(A,B):-copy1(A,C),p748_1(C,B).
p748_1(A,B):-p151(A,C),p137(C,B).
p750(A,B):-p1511(A,C),p95(C,B).
p754(A,B):-p80(A,C),p68(C,B).
p757(A,B):-copy1(A,C),p757_1(C,B).
p757_1(A,B):-p1500(A,C),mk_lowercase(C,B).
...
p853(A,B):-p46(A,C),p853_1(C,B).
p853_1(A,B):-skip1(A,C),p94(C,B).
p855(A,B):-p788(A,C),p855_1(C,B).
p855_1(A,B):-p89(A,C),p364(C,B).
p856(A,B):-p33(A,C),p856_1(C,B).
p856_1(A,B):-p94(A,C),p709(C,B).
p858(A,B):-p17(A,C),p788(C,B).
p862(A,B):-copy1(A,C),p862_1(C,B).
p862_1(A,B):-skip1(A,C),p32(C,B).
p866(A,B):-mk_uppercase(A,C),p866_1(C,B).
p866_1(A,B):-p279(A,C),p866_2(C,B).
p866_2(A,B):-mk_uppercase(A,C),p557(C,B).
p871(A,B):-skip1(A,C),p871_1(C,B).
p871_1(A,B):-p95(A,C),p751(C,B).
p877(A,B):-p218(A,C),p877_1(C,B).
p877_1(A,B):-p66(A,C),p93(C,B).
p885(A,B):-copy1(A,C),p885_1(C,B).
p885_1(A,B):-skip1(A,C),p1106(C,B).
p891(A,B):-p95(A,C),p891_1(C,B).
p891_1(A,B):-skip1(A,C),p332(C,B).
...
p902_1(A,B):-p364(A,C),p961(C,B).
p903(A,B):-copy1(A,C),p903_1(C,B).
p903_1(A,B):-p94(A,C),p32(C,B).
p906(A,B):-p1409(A,C),p906_1(C,B).
p906_1(A,B):-p621(A,C),p95(C,B).
p908(A,B):-p47(A,C),p908_1(C,B).
p908_1(A,B):-p46(A,C),p95(C,B).
p910(A,B):-p315(A,C),p910_1(C,B).
p910_1(A,B):-skip1(A,C),p680(C,B).
p911(A,B):-p1462(A,C),p17(C,B).
p912(A,B):-p148(A,C),p912_1(C,B).
p912_1(A,B):-p94(A,C),p634(C,B).
p916(A,B):-p93(A,C),p634(C,B).
p922(A,B):-p236(A,C),p922_1(C,B).
p922_1(A,B):-p45(A,C),p21(C,B).
p925(A,B):-p535(A,C),p925_1(C,B).
p925_1(A,B):-p1409(A,C),p364(C,B).
p928(A,B):-copy1(A,C),p928_1(C,B).
p928_1(A,B):-p315(A,C),p725(C,B).
...
p938(A,B):-p332(A,C),p938_1(C,B).
p938_1(A,B):-p68(A,C),mk_lowercase(C,B).
p942(A,B):-p718(A,C),p660(C,B).
p944(A,B):-p95(A,C),p751(C,B).
p945(A,B):-p93(A,C),p945_1(C,B).
p945_1(A,B):-p364(A,C),p95(C,B).
...
p986(A,B):-p95(A,C),p986_1(C,B).
p986_1(A,B):-p305(A,C),p47(C,B).
p987(A,B):-p14(A,C),p987_1(C,B).
p987_1(A,B):-mk_lowercase(A,C),p65(C,B).
p991(A,B):-p80(A,C),p926(C,B).
p1001(A,B):-p444(A,C),p1001_1(C,B).
p1001_1(A,B):-skip1(A,C),p47(C,B).
p1005(A,B):-p1092(A,C),p1005_1(C,B).
p1005_1(A,B):-p1307(A,C),mk_lowercase(C,B).
p1009(A,B):-p819(A,C),p1009_1(C,B).
p1009_1(A,B):-is_uppercase(A),p680(A,B).
p1009_1(A,B):-skip1(A,C),p1009_1(C,B).
...
p1140(A,B):-p33(A,C),p1140_1(C,B).
p1140_1(A,B):-p1533(A,C),p95(C,B).
...
p1202(A,B):-p315(A,C),p1202_1(C,B).
p1202_1(A,B):-p1420(A,C),p95(C,B).
...
p1220(A,B):-p32(A,C),p220(C,B).
p1224(A,B):-p151(A,C),p1224_1(C,B).
p1224_1(A,B):-p182(A,C),p66(C,B).
p1225(A,B):-p1006(A,C),p1225_1(C,B).
p1225_1(A,B):-skip1(A,C),p220(C,B).
p1226(A,B):-copy1(A,C),p811(C,B).
p1229(A,B):-copy1(A,C),p1229_1(C,B).
p1229_1(A,B):-p94(A,C),p1229_2(C,B).
p1229_2(A,B):-skip1(A,C),p32(C,B).
...
p1362(A,B):-p32(A,C),p1362_1(C,B).
p1362_1(A,B):-p279(A,C),p33(C,B).
...
p1376_1(A,B):-p315(A,C),p767(C,B).
p1377(A,B):-p1409(A,C),p557(C,B).
p1379(A,B):-p236(A,C),p35(C,B).
p1382(A,B):-p438(A,C),mk_lowercase(C,B).
p1383(A,B):-p337(A,C),p1022(C,B).
p1385(A,B):-p143(A,C),p1385_1(C,B).
p1385_1(A,B):-p148(A,C),p337(C,B).
...
p201_1(A,B):-p279(A,C),p315(C,B).
p548(A,B):-p95(A,C),p531(C,B).
p825(A,B):-p825_1(A,B),is_lowercase(B).
p825_1(A,B):-p505(A,C),mk_lowercase(C,B).
p1115(A,B):-skip1(A,C),p1115_1(C,B).
p1115_1(A,B):-p15(A,C),p1115_2(C,B).
p1115_2(A,B):-skip1(A,C),p89(C,B).
p1189(A,B):-p706(A,C),mk_lowercase(C,B).
p1337(A,B):-p315(A,C),p1337_1(C,B).
p1337_1(A,B):-skip1(A,C),p1337_2(C,B).
p1337_2(A,B):-p600(A,C),p33(C,B).
...
b249_1(A,B):-p251(A,C),p95(C,B).
b23(A,B):-b23_1(A,B),is_empty(B).
b23_1(A,B):-p94(A,C),skip1(C,B).
...
%timeout
%timeout
b238(A,B):-p368(A,C),b238_1(C,B).
b238_1(A,B):-mk_lowercase(A,C),b238_1(C,B).
b238_1(A,B):-is_space(A),skip1(A,B).
%timeout
%timeout
b224(A,B):-p1(A,C),p794(C,B).
b224(A,B):-p600(A,C),mk_uppercase(C,B).
%timeout
%timeout
%timeout

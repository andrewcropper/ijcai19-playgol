...
p20(A,B):-p732(A,C),p275(C,B).
p22(A,B):-skip1(A,C),p22_1(C,B).
p22_1(A,B):-skip1(A,C),p947(C,B).
p28(A,B):-p25(A,C),p42(C,B).
...
p66_1(A,B):-p858(A,C),mk_uppercase(C,B).
p67(A,B):-p594(A,C),p394(C,B).
...
p150(A,B):-p25(A,C),p150_1(C,B).
p150_1(A,B):-p804(A,C),copy1(C,B).
p152(A,B):-p1044(A,C),p275(C,B).
p157(A,B):-p1257(A,C),p206(C,B).
p160(A,B):-copy1(A,C),p160_1(C,B).
p160_1(A,B):-skip1(A,C),p160_2(C,B).
p160_2(A,B):-p186(A,C),p206(C,B).
p162(A,B):-p534(A,C),p1707(C,B).
...
p248_1(A,B):-mk_lowercase(A,C),p248_2(C,B).
...
p311_1(A,B):-p59(A,C),p311_2(C,B).
p311_2(A,B):-skip1(A,C),p745(C,B).
p315(A,B):-copy1(A,C),p315_1(C,B).
p315_1(A,B):-p1457(A,C),p361(C,B).
p319(A,B):-skip1(A,C),p24(C,B).
p323(A,B):-p926(A,C),p573(C,B).
...
p336_1(A,B):-p59(A,C),p347(C,B).
p337(A,B):-p165(A,C),p27(C,B).
...
p382_1(A,B):-p1786(A,C),p59(C,B).
p386(A,B):-p59(A,C),p386_1(C,B).
p386_1(A,B):-p988(A,C),p94(C,B).
p389(A,B):-mk_lowercase(A,C),p389_1(C,B).
p389_1(A,B):-p201(A,C),p389_2(C,B).
p389_2(A,B):-skip1(A,C),p253(C,B).
p393(A,B):-p230(A,C),p393_1(C,B).
p393_1(A,B):-skip1(A,C),p131(C,B).
p396(A,B):-p24(A,C),p59(C,B).
...
p412(A,B):-p745(A,C),p412_1(C,B).
p412_1(A,B):-p435(A,C),p206(C,B).
p413(A,B):-copy1(A,C),p1854(C,B).
p414(A,B):-p24(A,C),p354(C,B).
p417(A,B):-p31(A,C),p417_1(C,B).
p417_1(A,B):-p402(A,C),mk_lowercase(C,B).
...
p459(A,B):-p478(A,C),p206(C,B).
p462(A,B):-p321(A,C),p341(C,B).
p463(A,B):-copy1(A,C),p463_1(C,B).
p463_1(A,B):-p361(A,C),p463_2(C,B).
p463_2(A,B):-p125(A,C),p31(C,B).
p465(A,B):-p31(A,C),p1402(C,B).
p467(A,B):-copy1(A,C),p131(C,B).
p468(A,B):-p288(A,C),p24(C,B).
p472(A,B):-mk_uppercase(A,C),p472_1(C,B).
p472_1(A,B):-p494(A,C),p916(C,B).
p475(A,B):-p222(A,C),p275(C,B).
p477(A,B):-skip1(A,C),p477_1(C,B).
p477_1(A,B):-p426(A,C),p31(C,B).
p480(A,B):-skip1(A,C),p480_1(C,B).
p480_1(A,B):-p230(A,C),p480_2(C,B).
p480_2(A,B):-skip1(A,C),p24(C,B).
p486(A,B):-p230(A,C),p92(C,B).
...
p501(A,B):-p395(A,C),p501_1(C,B).
p501_1(A,B):-skip1(A,C),p478(C,B).
...
p643(A,B):-p1469(A,C),p42(C,B).
p645(A,B):-p1972(A,C),p745(C,B).
p650(A,B):-p732(A,C),p768(C,B).
p651(A,B):-p1799(A,C),p59(C,B).
p653(A,B):-mk_lowercase(A,C),p1044(C,B).
p654(A,B):-mk_uppercase(A,C),p654_1(C,B).
p654_1(A,B):-p1026(A,C),p15(C,B).
...
p672(A,B):-p768(A,C),p672_1(C,B).
p672_1(A,B):-p332(A,C),p31(C,B).
p677(A,B):-p789(A,C),p805(C,B).
p680(A,B):-p165(A,C),p644(C,B).
p681(A,B):-skip1(A,C),p681_1(C,B).
p681_1(A,B):-skip1(A,C),p1240(C,B).
p683(A,B):-p1009(A,C),p288(C,B).
...
p711(A,B):-p15(A,C),p711_1(C,B).
p711_1(A,B):-p191(A,C),p230(C,B).
p713(A,B):-p17(A,C),p1718(C,B).
p717(A,B):-p25(A,C),p717_1(C,B).
p717_1(A,B):-p394(A,C),p717_2(C,B).
p717_2(A,B):-skip1(A,C),p768(C,B).
p718(A,B):-mk_lowercase(A,C),p718_1(C,B).
p718_1(A,B):-skip1(A,C),p426(C,B).
...
p818(A,B):-p218(A,C),p818_1(C,B).
p818_1(A,B):-copy1(A,C),p297(C,B).
...
p834(A,B):-p15(A,C),p834_1(C,B).
p834_1(A,B):-p793(A,C),copy1(C,B).
...
p886_1(A,B):-p361(A,C),p10(C,B).
p887(A,B):-p54(A,C),p887_1(C,B).
p887_1(A,B):-p316(A,C),p24(C,B).
p888(A,B):-p347(A,C),p149(C,B).
p890(A,B):-p230(A,C),p890_1(C,B).
p890_1(A,B):-p125(A,C),p59(C,B).
...
p900(A,B):-p805(A,C),p900_1(C,B).
p900_1(A,B):-mk_lowercase(A,C),p729(C,B).
p908(A,B):-skip1(A,C),p908_1(C,B).
p908_1(A,B):-p31(A,C),p24(C,B).
p910(A,B):-p1355(A,C),p25(C,B).
p911(A,B):-p808(A,C),p49(C,B).
p912(A,B):-p406(A,C),p1629(C,B).
p920(A,B):-copy1(A,C),p1786(C,B).
p923(A,B):-p736(A,C),p1961(C,B).
p924(A,B):-skip1(A,C),p924_1(C,B).
p924_1(A,B):-p54(A,C),p924_2(C,B).
p924_2(A,B):-skip1(A,C),p30(C,B).
p927(A,B):-p31(A,C),p332(C,B).
p928(A,B):-p74(A,C),p928_1(C,B).
p928_1(A,B):-p395(A,C),p1718(C,B).
p932(A,B):-p1854(A,C),p805(C,B).
p934(A,B):-p54(A,C),p934_1(C,B).
p934_1(A,B):-p201(A,C),p76(C,B).
p935(A,B):-skip1(A,C),p935_1(C,B).
p935_1(A,B):-p31(A,C),p1873(C,B).
p937(A,B):-p120(A,C),mk_uppercase(C,B).
p939(A,B):-p4(A,C),p1009(C,B).
p946(A,B):-p732(A,C),p768(C,B).
...
p976_1(A,B):-p59(A,C),p1402(C,B).
p977(A,B):-p59(A,C),p977_1(C,B).
p977_1(A,B):-p804(A,C),copy1(C,B).
p978(A,B):-p161(A,C),mk_lowercase(C,B).
p981(A,B):-p1355(A,C),p31(C,B).
...
p1006_1(A,B):-p339(A,C),mk_uppercase(C,B).
...
p1058_1(A,B):-p478(A,C),p31(C,B).
p1061(A,B):-p768(A,C),p1179(C,B).
...
p1089(A,B):-p1624(A,C),p4(C,B).
p1091(A,B):-copy1(A,C),p1091_1(C,B).
p1091_1(A,B):-p149(A,C),p1898(C,B).
p1092(A,B):-skip1(A,C),p1092_1(C,B).
p1092_1(A,B):-p76(A,C),p94(C,B).
p1092_1(A,B):-p54(A,C),p1092_1(C,B).
...
p1098(A,B):-p1527(A,C),p54(C,B).
p1100(A,B):-copy1(A,C),p1179(C,B).
p1101(A,B):-p430(A,C),p206(C,B).
...
p1113(A,B):-p4(A,C),p1113_1(C,B).
p1113_1(A,B):-p49(A,C),p149(C,B).
...
p1131(A,B):-p394(A,C),p1131_1(C,B).
p1131_1(A,B):-skip1(A,C),p269(C,B).
p1134(A,B):-mk_uppercase(A,C),p1134_1(C,B).
p1134_1(A,B):-p120(A,C),p76(C,B).
...
p1148_1(A,B):-p1642(A,C),mk_lowercase(C,B).
p1154(A,B):-p30(A,C),p328(C,B).
p1155(A,B):-p1293(A,C),p768(C,B).
p1158(A,B):-mk_uppercase(A,C),p1158_1(C,B).
p1158_1(A,B):-skip1(A,C),p768(C,B).
...
p1165(A,B):-p201(A,C),p4(C,B).
p1165(A,B):-skip1(A,C),p1165(C,B).
p1168(A,B):-copy1(A,C),p1168_1(C,B).
p1168_1(A,B):-skip1(A,C),p120(C,B).
...
p1233_1(A,B):-skip1(A,C),p1233_2(C,B).
p1233_2(A,B):-skip1(A,C),p1240(C,B).
...
p1250(A,B):-p385(A,C),p1250_1(C,B).
p1250_1(A,B):-p200(A,C),p144(C,B).
...
p1283(A,B):-p76(A,C),p1283_1(C,B).
p1283_1(A,B):-p149(A,C),p201(C,B).
p1285(A,B):-p59(A,C),p1285_1(C,B).
p1285_1(A,B):-p696(A,C),p406(C,B).
p1286(A,B):-p1(A,C),p1286_1(C,B).
p1286_1(A,B):-skip1(A,C),p1179(C,B).
p1287(A,B):-p327(A,C),p25(C,B).
p1289(A,B):-p893(A,C),p144(C,B).
p1291(A,B):-p328(A,C),p1379(C,B).
p1296(A,B):-p321(A,C),p1296_1(C,B).
p1296_1(A,B):-p1718(A,C),p627(C,B).
p1300(A,B):-p10(A,C),p553(C,B).
p1302(A,B):-skip1(A,C),p1302_1(C,B).
p1302_1(A,B):-p31(A,C),p4(C,B).
p1304(A,B):-copy1(A,C),p1304_1(C,B).
p1304_1(A,B):-p327(A,C),p59(C,B).
p1307(A,B):-p94(A,C),p1031(C,B).
p1309(A,B):-p1553(A,C),mk_lowercase(C,B).
p1312(A,B):-p275(A,C),p594(C,B).
p1316(A,B):-p1179(A,C),p4(C,B).
p1322(A,B):-copy1(A,C),p1019(C,B).
p1326(A,B):-p406(A,C),p1326_1(C,B).
p1326_1(A,B):-p361(A,C),p1806(C,B).
...
p1401_1(A,B):-p1325(A,C),p25(C,B).
p1405(A,B):-p149(A,C),p1405_1(C,B).
p1405_1(A,B):-p827(A,C),copy1(C,B).
...
p1592(A,B):-p25(A,C),p403(C,B).
p1594(A,B):-p54(A,C),p1594_1(C,B).
p1594_1(A,B):-p4(A,C),p1594_2(C,B).
p1594_2(A,B):-mk_lowercase(A,C),p54(C,B).
p1598(A,B):-copy1(A,C),p1598_1(C,B).
p1598_1(A,B):-skip1(A,C),p167(C,B).
p1600(A,B):-p926(A,C),p1873(C,B).
p1601(A,B):-p595(A,C),p4(C,B).
p1607(A,B):-p165(A,C),p328(C,B).
...
p1734(A,B):-p916(A,C),p201(C,B).
p1737(A,B):-p59(A,C),p1737_1(C,B).
p1737_1(A,B):-p200(A,C),p4(C,B).
...
p1741_1(A,B):-p94(A,C),p627(C,B).
p1744(A,B):-copy1(A,C),p1744_1(C,B).
p1744_1(A,B):-p59(A,C),p1556(C,B).
p1745(A,B):-p361(A,C),p595(C,B).
p1751(A,B):-p732(A,C),p328(C,B).
p1752(A,B):-p1(A,C),p1752_1(C,B).
p1752_1(A,B):-p59(A,C),p259(C,B).
p1754(A,B):-skip1(A,C),p1754_1(C,B).
p1754_1(A,B):-p804(A,C),copy1(C,B).
p1757(A,B):-skip1(A,C),p1757_1(C,B).
p1757_1(A,B):-p31(A,C),p1757_2(C,B).
p1757_2(A,B):-p316(A,C),p25(C,B).
p1759(A,B):-mk_uppercase(A,C),p745(C,B).
p1763(A,B):-p916(A,C),p54(C,B).
p1767(A,B):-p470(A,C),p1(C,B).
p1770(A,B):-p435(A,C),p1770_1(C,B).
p1770_1(A,B):-p24(A,C),p550(C,B).
p1771(A,B):-p406(A,C),p1771_1(C,B).
p1771_1(A,B):-p494(A,C),p395(C,B).
p1774(A,B):-mk_uppercase(A,C),p1774_1(C,B).
p1774_1(A,B):-p696(A,C),p70(C,B).
...
p1833(A,B):-p395(A,C),p1833_1(C,B).
p1833_1(A,B):-copy1(A,C),p732(C,B).
p1836(A,B):-copy1(A,C),p321(C,B).
p1841(A,B):-skip1(A,C),p1841_1(C,B).
p1841_1(A,B):-p1644(A,C),p76(C,B).
p1843(A,B):-copy1(A,C),p471(C,B).
p1847(A,B):-p1000(A,C),p59(C,B).
p1849(A,B):-p94(A,C),p1849_1(C,B).
p1849_1(A,B):-p361(A,C),p1849_2(C,B).
p1849_2(A,B):-mk_lowercase(A,C),p54(C,B).
...
p1911(A,B):-p889(A,C),copy1(C,B).
p1912(A,B):-p339(A,C),p627(C,B).
p1915(A,B):-p222(A,C),p768(C,B).
...
p1927_1(A,B):-p361(A,C),p1630(C,B).
...
p1975(A,B):-p627(A,C),p1975_1(C,B).
p1975_1(A,B):-p1865(A,C),p394(C,B).
...
p1984_1(A,B):-p402(A,C),p361(C,B).
p1988(A,B):-p230(A,C),p768(C,B).
p1991(A,B):-p55(A,C),p1991_1(C,B).
p1991_1(A,B):-p893(A,C),p494(C,B).
...
% asserting p1998/2
% depth 4
p112(A,B):-p927(A,C),p112_1(C,B).
p112_1(A,B):-skip1(A,C),p12(C,B).
p232(A,B):-skip1(A,C),p232_1(C,B).
p232_1(A,B):-p31(A,C),p232_2(C,B).
p232_2(A,B):-skip1(A,C),p52(C,B).
p287(A,B):-p553(A,C),p287_1(C,B).
p287_1(A,B):-p515(A,C),mk_uppercase(C,B).
...
p974_1(A,B):-p1916(A,C),mk_lowercase(C,B).
p1035(A,B):-p1199(A,C),p1(C,B).
p1292(A,B):-p230(A,C),p1292_1(C,B).
p1292_1(A,B):-skip1(A,C),p52(C,B).
p1299(A,B):-skip1(A,C),p1299_1(C,B).
p1299_1(A,B):-p149(A,C),p1299_2(C,B).
p1299_2(A,B):-p303(A,C),p1718(C,B).
p1399(A,B):-p430(A,C),p1399_1(C,B).
p1399_1(A,B):-skip1(A,C),p52(C,B).
p1651(A,B):-copy1(A,C),p1105(C,B).
p1721(A,B):-p31(A,C),p581(C,B).
p1831(A,B):-p1277(A,C),p76(C,B).
p1840(A,B):-skip1(A,C),p1840_1(C,B).
p1840_1(A,B):-p31(A,C),p1840_2(C,B).
p1840_2(A,B):-skip1(A,C),p24(C,B).
% asserting p112/2
% asserting p232/2
% asserting p287/2
% asserting p689/2
...
%timeout
%timeout
b78(A,B):-p1031(A,B),is_uppercase(B).
b78(A,B):-p31(A,C),b78(C,B).
%timeout
%timeout
%timeout
%timeout
...
b132_1(A,B):-p206(A,C),p1640(C,B).
b132_1(A,B):-p70(A,C),p60(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
b81(A,B):-p24(A,B),is_uppercase(B).
...
b249_1(A,B):-p70(A,C),b249_2(C,B).
b249_2(A,B):-skip1(A,C),p230(C,B).

...
b62_2(A,B):-p100_1(A,C),b62_3(C,B).
b62_3(A,B):-p100(A,C),b62_4(C,B).
b62_4(A,B):-drop_ball(A,C),move_right(C,B).
%timeout
...
b72_4(A,B):-move_left(A,C),p100_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b107_3(A,B):-drop_ball(A,C),p100_1(C,B).
...
b133_2(A,B):-p100_1(A,C),drop_ball(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b280(A,B):-move_forwards(A,C),p100_1(C,B).
%timeout
%timeout
%timeout
%timeout
...
b357_1(A,B):-move_left(A,C),p100_1(C,B).
%timeout
%timeout
%timeout
...
b535_2(A,B):-p100_1(A,C),b535_3(C,B).
...
b546_3(A,B):-drop_ball(A,C),p100_1(C,B).
b546_3(A,B):-p100(A,C),grab_ball(C,B).
b551(A,B):-p100(A,B).
%timeout
%timeout
...
b634_3(A,B):-p100_1(A,C),drop_ball(C,B).
%timeout
%timeout
%timeout
%timeout
...
%timeout
%timeout
b675(A,B):-p100(A,C),b675_1(C,B).
b675_1(A,B):-grab_ball(A,C),b675_2(C,B).
b675_2(A,B):-move_right(A,C),b675_3(C,B).
b675_3(A,B):-move_backwards(A,C),b675_4(C,B).
b675_4(A,B):-drop_ball(A,C),p100_1(C,B).
%timeout
b673(A,B):-b673_1(A,C),b673_1(C,B).
b673_1(A,B):-b673_2(A,C),b673_2(C,B).
b673_1(A,B):-b673_2(A,C),grab_ball(C,B).
b673_2(A,B):-p100_1(A,C),drop_ball(C,B).
...
%timeout
%timeout
b764(A,B):-b764_1(A,C),b764_1(C,B).
b764_1(A,B):-b764_2(A,C),move_right(C,B).
b764_2(A,B):-move_right(A,C),move_forwards(C,B).
b764_2(A,B):-p100_1(A,C),drop_ball(C,B).
%timeout
%timeout
%timeout
%timeout
...
b871_1(A,B):-move_left(A,C),p100_1(C,B).
%timeout
%timeout
%timeout
%timeout

...
p10_1(A,B):-p402(A,C),p10_2(C,B).
p10_2(A,B):-p1222(A,C),p1576(C,B).
p11(A,B):-p1685(A,C),p11_1(C,B).
p11_1(A,B):-move_forwards(A,C),p11_2(C,B).
p11_2(A,B):-p216(A,C),p69(C,B).
p12(A,B):-p465(A,C),p12_1(C,B).
p12_1(A,B):-p1023(A,C),p12_2(C,B).
p12_2(A,B):-p7(A,C),p1411(C,B).
p15(A,B):-p1685(A,C),p15_1(C,B).
p15_1(A,B):-p1411(A,C),p7(C,B).
p16(A,B):-move_left(A,C),p16_1(C,B).
p16_1(A,B):-p1108(A,C),p16_2(C,B).
p16_2(A,B):-p1685(A,C),p1411(C,B).
p17(A,B):-move_left(A,C),p17_1(C,B).
p17_1(A,B):-p465(A,C),p17_2(C,B).
p17_2(A,B):-drop_ball(A,C),p1264(C,B).
p19(A,B):-move_left(A,C),p19_1(C,B).
p19_1(A,B):-p1667(A,C),p19_2(C,B).
p19_2(A,B):-p227(A,C),p216(C,B).
p27(A,B):-p1714(A,C),p27_1(C,B).
p27_1(A,B):-p1137(A,C),p27_2(C,B).
p27_2(A,B):-p1605(A,C),p227(C,B).
p28(A,B):-p1120(A,C),p28_1(C,B).
p28_1(A,B):-p1023(A,C),p28_2(C,B).
p28_2(A,B):-p216(A,C),p1399(C,B).
p29(A,B):-p1291(A,C),p29_1(C,B).
p29_1(A,B):-p23(A,C),p29_2(C,B).
p29_2(A,B):-drop_ball(A,C),p1100(C,B).
p31(A,B):-p1665(A,C),p31_1(C,B).
p31_1(A,B):-p23(A,C),p31_2(C,B).
p31_2(A,B):-drop_ball(A,C),p580(C,B).
p32(A,B):-p1667(A,C),p32_1(C,B).
p32_1(A,B):-p227(A,C),p32_2(C,B).
p32_2(A,B):-drop_ball(A,C),p692(C,B).
p33(A,B):-p1665(A,C),p33_1(C,B).
p33_1(A,B):-p1376(A,C),p33_2(C,B).
p33_2(A,B):-p191(A,C),move_backwards(C,B).
p36(A,B):-p1871(A,C),p36_1(C,B).
p36_1(A,B):-p1865(A,C),p36_2(C,B).
p36_2(A,B):-p1222(A,C),p402(C,B).
...
p41_2(A,B):-move_forwards(A,C),p1605(C,B).
...
p46(A,B):-p580(A,C),p46_1(C,B).
p46_1(A,B):-p1376(A,C),p46_2(C,B).
...
p52(A,B):-p276(A,C),p52_1(C,B).
p52_1(A,B):-p23(A,C),p52_2(C,B).
p52_2(A,B):-p563(A,C),p1411(C,B).
p55(A,B):-p1667(A,C),p55_1(C,B).
p55_1(A,B):-move_backwards(A,C),p55_2(C,B).
p55_2(A,B):-p1411(A,C),move_backwards(C,B).
p60(A,B):-p1667(A,C),p60_1(C,B).
p60_1(A,B):-p1544(A,C),p60_2(C,B).
p60_2(A,B):-p1605(A,C),p1576(C,B).
...
p76(A,B):-p1685(A,C),p76_1(C,B).
p76_1(A,B):-p1665(A,C),p76_2(C,B).
p76_2(A,B):-p1605(A,C),p882(C,B).
...
p88(A,B):-p1208(A,C),p88_1(C,B).
p88_1(A,B):-p1685(A,C),p88_2(C,B).
p88_2(A,B):-p1222(A,C),p30(C,B).
p92(A,B):-p568(A,C),p92_1(C,B).
p92_1(A,B):-p1665(A,C),p92_2(C,B).
p92_2(A,B):-p1605(A,C),p465(C,B).
p94(A,B):-p1667(A,C),p94_1(C,B).
p94_1(A,B):-move_backwards(A,C),p94_2(C,B).
p94_2(A,B):-p1222(A,C),p367(C,B).
...
p101(A,B):-p276(A,C),p101_1(C,B).
p101_1(A,B):-p1949(A,C),p101_2(C,B).
p101_2(A,B):-p367(A,C),p216(C,B).
p102(A,B):-move_left(A,C),p102_1(C,B).
p102_1(A,B):-p1667(A,C),p102_2(C,B).
p102_2(A,B):-p563(A,C),p1222(C,B).
p104(A,B):-p1483(A,C),p104_1(C,B).
p104_1(A,B):-p1949(A,C),p1411(C,B).
p105(A,B):-p1714(A,C),p105_1(C,B).
p105_1(A,B):-p7(A,C),p105_2(C,B).
p105_2(A,B):-drop_ball(A,C),p882(C,B).
p106(A,B):-p1391(A,C),p106_1(C,B).
p106_1(A,B):-grab_ball(A,C),p106_2(C,B).
p106_2(A,B):-p1544(A,C),p1605(C,B).
...
p122_1(A,B):-p1264(A,C),p122_2(C,B).
p122_2(A,B):-drop_ball(A,C),p465(C,B).
p123(A,B):-move_left(A,C),p123_1(C,B).
p123_1(A,B):-p30(A,C),p123_2(C,B).
p123_2(A,B):-p23(A,C),p613(C,B).
...
p139(A,B):-p563(A,C),p139_1(C,B).
p139_1(A,B):-p568(A,C),p367(C,B).
p142(A,B):-p1667(A,C),p142_1(C,B).
p142_1(A,B):-p1108(A,C),p142_2(C,B).
p142_2(A,B):-drop_ball(A,C),p1291(C,B).
p145(A,B):-move_right(A,C),p145_1(C,B).
p145_1(A,B):-p1714(A,C),p145_2(C,B).
p145_2(A,B):-p1605(A,C),move_forwards(C,B).
p147(A,B):-p1871(A,C),p147_1(C,B).
p147_1(A,B):-p1949(A,C),p147_2(C,B).
p147_2(A,B):-p1605(A,C),p580(C,B).
p148(A,B):-p1685(A,C),p148_1(C,B).
p148_1(A,B):-move_backwards(A,C),p148_2(C,B).
p148_2(A,B):-p1411(A,C),p465(C,B).
p152(A,B):-p651(A,C),p152_1(C,B).
p152_1(A,B):-p1376(A,C),p152_2(C,B).
...
p157(A,B):-p794(A,C),p157_1(C,B).
p157_1(A,B):-p1865(A,C),p157_2(C,B).
p157_2(A,B):-p191(A,C),p1445(C,B).
...
p167_1(A,B):-p1685(A,C),p167_2(C,B).
p167_2(A,B):-p1853(A,C),p1222(C,B).
p174(A,B):-p30(A,C),p174_1(C,B).
p174_1(A,B):-p1667(A,C),p174_2(C,B).
p174_2(A,B):-p1713(A,C),drop_ball(C,B).
p177(A,B):-p465(A,C),p177_1(C,B).
p177_1(A,B):-p23(A,C),p1605(C,B).
p185(A,B):-p1665(A,C),p185_1(C,B).
p185_1(A,B):-p1376(A,C),p185_2(C,B).
p185_2(A,B):-p1605(A,C),p1483(C,B).
...
p190(A,B):-p1949(A,C),p190_1(C,B).
p190_1(A,B):-p367(A,C),p190_2(C,B).
...
p203(A,B):-p1544(A,C),p203_1(C,B).
p203_1(A,B):-p1376(A,C),p1222(C,B).
...
p207(A,B):-p692(A,C),p207_1(C,B).
p207_1(A,B):-p1577(A,C),p207_2(C,B).
p207_2(A,B):-p1871(A,C),p1605(C,B).
p209(A,B):-move_left(A,C),p209_1(C,B).
p209_1(A,B):-p1411(A,C),p613(C,B).
p210(A,B):-p1871(A,C),p210_1(C,B).
p210_1(A,B):-p1949(A,C),p210_2(C,B).
p210_2(A,B):-p1605(A,C),p1576(C,B).
p212(A,B):-move_left(A,C),p212_1(C,B).
p212_1(A,B):-grab_ball(A,C),p212_2(C,B).
p212_2(A,B):-move_backwards(A,C),p1411(C,B).
p218(A,B):-p465(A,C),p218_1(C,B).
p218_1(A,B):-p1685(A,C),p218_2(C,B).
p218_2(A,B):-p1222(A,C),p1091(C,B).
p219(A,B):-p465(A,C),p219_1(C,B).
...
p232(A,B):-p1577(A,C),p232_1(C,B).
p232_1(A,B):-move_backwards(A,C),p232_2(C,B).
p232_2(A,B):-p191(A,C),move_backwards(C,B).
p233(A,B):-p276(A,C),p233_1(C,B).
p233_1(A,B):-p1865(A,C),p233_2(C,B).
p233_2(A,B):-p216(A,C),p227(C,B).
p235(A,B):-p1120(A,C),p235_1(C,B).
p235_1(A,B):-p23(A,C),p235_2(C,B).
p235_2(A,B):-drop_ball(A,C),p882(C,B).
p236(A,B):-p503(A,C),p236_1(C,B).
p236_1(A,B):-grab_ball(A,C),p236_2(C,B).
p236_2(A,B):-p30(A,C),p1411(C,B).
p241(A,B):-p1576(A,C),p241_1(C,B).
p241_1(A,B):-p1976(A,C),p241_2(C,B).
p241_2(A,B):-p1264(A,C),p1222(C,B).
...
p282_1(A,B):-p1713(A,C),p282_2(C,B).
p282_2(A,B):-p1376(A,C),drop_ball(C,B).
p284(A,B):-p1577(A,C),p284_1(C,B).
p284_1(A,B):-p465(A,C),p284_2(C,B).
p284_2(A,B):-p1411(A,C),p882(C,B).
...
p294_1(A,B):-p465(A,C),p294_2(C,B).
p294_2(A,B):-drop_ball(A,C),p1264(C,B).
p296(A,B):-move_left(A,C),p296_1(C,B).
p296_1(A,B):-grab_ball(A,C),p296_2(C,B).
p296_2(A,B):-p1411(A,C),p1544(C,B).
p298(A,B):-p1550(A,C),p298_1(C,B).
p298_1(A,B):-p1976(A,C),p298_2(C,B).
...
p315(A,B):-p1871(A,C),p315_1(C,B).
p315_1(A,B):-p1865(A,C),p1411(C,B).
...
p323(A,B):-p1100(A,C),p323_1(C,B).
p323_1(A,B):-p1411(A,C),p1576(C,B).
...
p332_2(A,B):-p1100(A,C),p1411(C,B).
...
p336(A,B):-p1714(A,C),p336_1(C,B).
p336_1(A,B):-p1871(A,C),p336_2(C,B).
p336_2(A,B):-p1222(A,C),p276(C,B).
p338(A,B):-p1499(A,C),p338_1(C,B).
p338_1(A,B):-p568(A,C),p338_2(C,B).
p338_2(A,B):-p191(A,C),p22(C,B).
p340(A,B):-move_left(A,C),p340_1(C,B).
p340_1(A,B):-p1976(A,C),p340_2(C,B).
p340_2(A,B):-p1208(A,C),p1411(C,B).
...
p346(A,B):-p1483(A,C),p346_1(C,B).
p346_1(A,B):-p1667(A,C),p346_2(C,B).
p346_2(A,B):-p613(A,C),drop_ball(C,B).
...
p356(A,B):-p1445(A,C),p356_1(C,B).
p356_1(A,B):-p1376(A,C),p1605(C,B).
...
p369(A,B):-move_backwards(A,C),p369_1(C,B).
p369_1(A,B):-p1376(A,C),p369_2(C,B).
...
p379(A,B):-p1499(A,C),p379_1(C,B).
p379_1(A,B):-p1667(A,C),p379_2(C,B).
...
p398_1(A,B):-p1667(A,C),p398_2(C,B).
p398_2(A,B):-move_backwards(A,C),p1544(C,B).
...
p404_1(A,B):-p1714(A,C),p404_2(C,B).
p404_2(A,B):-p651(A,C),p1222(C,B).
...
p413_1(A,B):-move_forwards(A,C),p413_2(C,B).
p413_2(A,B):-p1411(A,C),p1445(C,B).
...
p423(A,B):-p310(A,C),p423_1(C,B).
p423_1(A,B):-p1976(A,C),p423_2(C,B).
...
p428_2(A,B):-p1100(A,C),p1411(C,B).
p433(A,B):-p22(A,C),p433_1(C,B).
p433_1(A,B):-p1667(A,C),p433_2(C,B).
p433_2(A,B):-p1483(A,C),p191(C,B).
...
p444(A,B):-p1208(A,C),p444_1(C,B).
p444_1(A,B):-p1685(A,C),p444_2(C,B).
...
p455(A,B):-p1713(A,C),p455_1(C,B).
p455_1(A,B):-p1023(A,C),p455_2(C,B).
p455_2(A,B):-drop_ball(A,C),p1576(C,B).
...
p466_1(A,B):-p227(A,C),p466_2(C,B).
p466_2(A,B):-p1222(A,C),p1713(C,B).
...
p471_1(A,B):-p465(A,C),p471_2(C,B).
p471_2(A,B):-p1865(A,C),p1411(C,B).
p472(A,B):-p465(A,C),p472_1(C,B).
...
p478(A,B):-p1399(A,C),p478_1(C,B).
p478_1(A,B):-p1023(A,C),p478_2(C,B).
p478_2(A,B):-p1222(A,C),p1853(C,B).
p479(A,B):-p402(A,C),p479_1(C,B).
p479_1(A,B):-p568(A,C),p479_2(C,B).
...
p486(A,B):-p1100(A,C),p486_1(C,B).
p486_1(A,B):-p1376(A,C),p486_2(C,B).
p486_2(A,B):-p1605(A,C),p1576(C,B).
p490(A,B):-p310(A,C),p490_1(C,B).
p490_1(A,B):-p1577(A,C),p490_2(C,B).
...
p499(A,B):-p1376(A,C),p499_1(C,B).
p499_1(A,B):-p613(A,C),p499_2(C,B).
p499_2(A,B):-drop_ball(A,C),p465(C,B).
p502(A,B):-p1137(A,C),p502_1(C,B).
p502_1(A,B):-p1023(A,C),p502_2(C,B).
p502_2(A,B):-drop_ball(A,C),p692(C,B).
...
p507(A,B):-p794(A,C),p507_1(C,B).
p507_1(A,B):-drop_ball(A,C),move_right(C,B).
p508(A,B):-p1577(A,C),p508_1(C,B).
p508_1(A,B):-p1576(A,C),p508_2(C,B).
p508_2(A,B):-drop_ball(A,C),p227(C,B).
p509(A,B):-move_left(A,C),p509_1(C,B).
p509_1(A,B):-p1714(A,C),p509_2(C,B).
p509_2(A,B):-p1605(A,C),p30(C,B).
p510(A,B):-p1667(A,C),p510_1(C,B).
p510_1(A,B):-p1483(A,C),p510_2(C,B).
p510_2(A,B):-p1222(A,C),p7(C,B).
p511(A,B):-p1714(A,C),p511_1(C,B).
p511_1(A,B):-p1871(A,C),p511_2(C,B).
...
p530(A,B):-p1483(A,C),p530_1(C,B).
p530_1(A,B):-p1667(A,C),p530_2(C,B).
p530_2(A,B):-move_right(A,C),p191(C,B).
p531(A,B):-move_left(A,C),p531_1(C,B).
p531_1(A,B):-p1667(A,C),p531_2(C,B).
p531_2(A,B):-p1100(A,C),drop_ball(C,B).
p532(A,B):-p1093(A,C),p532_1(C,B).
p532_1(A,B):-p1667(A,C),p532_2(C,B).
p532_2(A,B):-p216(A,C),p1100(C,B).
p534(A,B):-p1399(A,C),p534_1(C,B).
p534_1(A,B):-p1376(A,C),p534_2(C,B).
...
p543(A,B):-p563(A,C),p543_1(C,B).
p543_1(A,B):-p23(A,C),p543_2(C,B).
p543_2(A,B):-p1411(A,C),p1576(C,B).
...
p554_2(A,B):-p1576(A,C),p1411(C,B).
p558(A,B):-p1871(A,C),p558_1(C,B).
p558_1(A,B):-p1714(A,C),p1605(C,B).
...
p570_2(A,B):-p216(A,C),p1665(C,B).
p576(A,B):-p1714(A,C),p576_1(C,B).
p576_1(A,B):-p1208(A,C),p576_2(C,B).
...
p581(A,B):-p7(A,C),p581_1(C,B).
p581_1(A,B):-p1714(A,C),p581_2(C,B).
p581_2(A,B):-p1411(A,C),p367(C,B).
p582(A,B):-p1949(A,C),p582_1(C,B).
p582_1(A,B):-p1665(A,C),p582_2(C,B).
p582_2(A,B):-p1605(A,C),move_left(C,B).
...
p602_2(A,B):-move_backwards(A,C),p191(C,B).
p603(A,B):-p1100(A,C),p603_1(C,B).
p603_1(A,B):-p1376(A,C),p603_2(C,B).
...
p612(A,B):-p1949(A,C),p612_1(C,B).
p612_1(A,B):-move_forwards(A,C),p1605(C,B).
p614(A,B):-p1667(A,C),p614_1(C,B).
p614_1(A,B):-p1208(A,C),p614_2(C,B).
p614_2(A,B):-drop_ball(A,C),p402(C,B).
p615(A,B):-move_right(A,C),p615_1(C,B).
p615_1(A,B):-p1714(A,C),p615_2(C,B).
...
p632(A,B):-p1264(A,C),p632_1(C,B).
p632_1(A,B):-p23(A,C),p632_2(C,B).
p632_2(A,B):-drop_ball(A,C),p402(C,B).
p633(A,B):-move_left(A,C),p633_1(C,B).
p633_1(A,B):-p1685(A,C),p633_2(C,B).
p633_2(A,B):-p1291(A,C),p1222(C,B).
p635(A,B):-p1949(A,C),p635_1(C,B).
p635_1(A,B):-p22(A,C),p635_2(C,B).
p635_2(A,B):-drop_ball(A,C),move_left(C,B).
p636(A,B):-p692(A,C),p636_1(C,B).
p636_1(A,B):-p1667(A,C),p636_2(C,B).
p636_2(A,B):-p1093(A,C),p1222(C,B).
...
p657(A,B):-p1544(A,C),p657_1(C,B).
p657_1(A,B):-p1376(A,C),p657_2(C,B).
p657_2(A,B):-p1605(A,C),p1871(C,B).
p659(A,B):-p1544(A,C),p659_1(C,B).
p659_1(A,B):-p23(A,C),p659_2(C,B).
p659_2(A,B):-p1605(A,C),p1264(C,B).
p662(A,B):-p1949(A,C),p662_1(C,B).
p662_1(A,B):-move_forwards(A,C),p662_2(C,B).
p662_2(A,B):-p1605(A,C),p503(C,B).
...
p667(A,B):-p882(A,C),p667_1(C,B).
p667_1(A,B):-p568(A,C),p667_2(C,B).
...
p671(A,B):-p568(A,C),p671_1(C,B).
p671_1(A,B):-move_backwards(A,C),p671_2(C,B).
p671_2(A,B):-p1411(A,C),p465(C,B).
p679(A,B):-move_right(A,C),p679_1(C,B).
p679_1(A,B):-grab_ball(A,C),p679_2(C,B).
p679_2(A,B):-p1411(A,C),move_backwards(C,B).
p684(A,B):-p465(A,C),p684_1(C,B).
p684_1(A,B):-p1714(A,C),p1605(C,B).
p687(A,B):-p367(A,C),p687_1(C,B).
p687_1(A,B):-p1714(A,C),p687_2(C,B).
p687_2(A,B):-p1483(A,C),p227(C,B).
p688(A,B):-p1667(A,C),p688_1(C,B).
p688_1(A,B):-p30(A,C),p688_2(C,B).
p688_2(A,B):-p1222(A,C),p22(C,B).
...
p698_1(A,B):-p1576(A,C),p698_2(C,B).
p698_2(A,B):-drop_ball(A,C),p1544(C,B).
...
p705(A,B):-p367(A,C),p705_1(C,B).
p705_1(A,B):-p1023(A,C),p705_2(C,B).
p705_2(A,B):-drop_ball(A,C),p22(C,B).
...
p709_1(A,B):-p1714(A,C),p709_2(C,B).
...
p723_1(A,B):-p1023(A,C),p723_2(C,B).
p723_2(A,B):-p1411(A,C),p794(C,B).
p726(A,B):-p1544(A,C),p726_1(C,B).
p726_1(A,B):-p1685(A,C),p726_2(C,B).
p726_2(A,B):-p1399(A,C),p216(C,B).
...
p753_2(A,B):-p1483(A,C),p216(C,B).
p755(A,B):-grab_ball(A,C),p755_1(C,B).
p755_1(A,B):-p465(A,C),p755_2(C,B).
p755_2(A,B):-p1411(A,C),p1576(C,B).
p758(A,B):-p1871(A,C),p758_1(C,B).
p758_1(A,B):-p1685(A,C),p758_2(C,B).
p758_2(A,B):-p1605(A,C),p276(C,B).
...
p771_2(A,B):-p22(A,C),p1411(C,B).
p772(A,B):-p568(A,C),p772_1(C,B).
p772_1(A,B):-p580(A,C),p772_2(C,B).
p772_2(A,B):-p1605(A,C),move_left(C,B).
p775(A,B):-p1291(A,C),p775_1(C,B).
p775_1(A,B):-p1376(A,C),p775_2(C,B).
p775_2(A,B):-p1222(A,C),p30(C,B).
p777(A,B):-p1665(A,C),p777_1(C,B).
p777_1(A,B):-p1376(A,C),p777_2(C,B).
p777_2(A,B):-p1222(A,C),p1544(C,B).
p778(A,B):-p1544(A,C),p778_1(C,B).
p778_1(A,B):-p1376(A,C),p778_2(C,B).
p778_2(A,B):-p1411(A,C),p613(C,B).
p781(A,B):-p1871(A,C),p781_1(C,B).
p781_1(A,B):-grab_ball(A,C),p781_2(C,B).
p781_2(A,B):-p1222(A,C),p276(C,B).
p783(A,B):-p7(A,C),p783_1(C,B).
p783_1(A,B):-p1714(A,C),p783_2(C,B).
p783_2(A,B):-p69(A,C),p1222(C,B).
p785(A,B):-p1871(A,C),p785_1(C,B).
p785_1(A,B):-p1949(A,C),p785_2(C,B).
p785_2(A,B):-p1100(A,C),p1605(C,B).
...
p792(A,B):-p1483(A,C),p792_1(C,B).
p792_1(A,B):-p1667(A,C),p792_2(C,B).
p792_2(A,B):-p882(A,C),p1222(C,B).
...
p804(A,B):-p1685(A,C),p804_1(C,B).
p804_1(A,B):-p1264(A,C),p804_2(C,B).
...
p807(A,B):-p227(A,C),p807_1(C,B).
p807_1(A,B):-p1376(A,C),p807_2(C,B).
p807_2(A,B):-p276(A,C),p1605(C,B).
...
p815(A,B):-p465(A,C),p815_1(C,B).
p815_1(A,B):-p1949(A,C),p815_2(C,B).
...
p829(A,B):-p1949(A,C),p829_1(C,B).
p829_1(A,B):-move_left(A,C),p829_2(C,B).
p829_2(A,B):-p216(A,C),p1544(C,B).
p830(A,B):-p568(A,C),p830_1(C,B).
p830_1(A,B):-p1483(A,C),p1605(C,B).
p832(A,B):-p1865(A,C),p1411(C,B).
p835(A,B):-p1023(A,C),p835_1(C,B).
p835_1(A,B):-p1576(A,C),p835_2(C,B).
p835_2(A,B):-p216(A,C),p580(C,B).
p838(A,B):-p23(A,C),p838_1(C,B).
p838_1(A,B):-move_forwards(A,C),p1411(C,B).
p839(A,B):-p503(A,C),p839_1(C,B).
p839_1(A,B):-p1714(A,C),p839_2(C,B).
p839_2(A,B):-p1093(A,C),p1605(C,B).
...
p847(A,B):-p30(A,C),p847_1(C,B).
p847_1(A,B):-p1023(A,C),p847_2(C,B).
p847_2(A,B):-move_left(A,C),p216(C,B).
...
p856_1(A,B):-p1137(A,C),p856_2(C,B).
p856_2(A,B):-p1605(A,C),move_forwards(C,B).
p857(A,B):-move_right(A,C),p857_1(C,B).
p857_1(A,B):-p1667(A,C),p857_2(C,B).
p857_2(A,B):-drop_ball(A,C),p465(C,B).
p858(A,B):-move_forwards(A,C),p858_1(C,B).
p858_1(A,B):-p1376(A,C),p858_2(C,B).
p858_2(A,B):-p69(A,C),p191(C,B).
p861(A,B):-p227(A,C),p861_1(C,B).
p861_1(A,B):-p1865(A,C),p861_2(C,B).
p861_2(A,B):-p1222(A,C),p1091(C,B).
p864(A,B):-p465(A,C),p864_1(C,B).
p864_1(A,B):-p1865(A,C),p864_2(C,B).
p864_2(A,B):-p1222(A,C),p613(C,B).
p868(A,B):-move_right(A,C),p868_1(C,B).
p868_1(A,B):-p1667(A,C),p868_2(C,B).
p868_2(A,B):-drop_ball(A,C),p1544(C,B).
p870(A,B):-p23(A,C),p870_1(C,B).
p870_1(A,B):-p1208(A,C),p870_2(C,B).
p870_2(A,B):-drop_ball(A,C),p1713(C,B).
p873(A,B):-p7(A,C),p873_1(C,B).
p873_1(A,B):-p1685(A,C),p873_2(C,B).
p873_2(A,B):-p465(A,C),p1605(C,B).
...
p885(A,B):-p563(A,C),p885_1(C,B).
p885_1(A,B):-grab_ball(A,C),p885_2(C,B).
p885_2(A,B):-p1411(A,C),move_backwards(C,B).
p891(A,B):-p1667(A,C),p891_1(C,B).
p891_1(A,B):-p30(A,C),p891_2(C,B).
p891_2(A,B):-drop_ball(A,C),p692(C,B).
p893(A,B):-p794(A,C),p893_1(C,B).
p893_1(A,B):-p1685(A,C),p893_2(C,B).
p893_2(A,B):-drop_ball(A,C),p1445(C,B).
p894(A,B):-p1871(A,C),p894_1(C,B).
p894_1(A,B):-p1222(A,C),p563(C,B).
p895(A,B):-move_left(A,C),p895_1(C,B).
p895_1(A,B):-p1067(A,C),p895_2(C,B).
p895_2(A,B):-p1685(A,C),p1605(C,B).
...
p902_1(A,B):-p1544(A,C),p902_2(C,B).
p902_2(A,B):-p1411(A,C),p613(C,B).
p903(A,B):-p465(A,C),p903_1(C,B).
p903_1(A,B):-p1023(A,C),p1137(C,B).
p904(A,B):-p503(A,C),p904_1(C,B).
p904_1(A,B):-p1685(A,C),p904_2(C,B).
p904_2(A,B):-drop_ball(A,C),p1483(C,B).
p910(A,B):-p1685(A,C),p910_1(C,B).
p910_1(A,B):-p22(A,C),p910_2(C,B).
p910_2(A,B):-p191(A,C),p882(C,B).
p912(A,B):-p1667(A,C),p912_1(C,B).
p912_1(A,B):-move_backwards(A,C),p912_2(C,B).
p912_2(A,B):-p1222(A,C),p1264(C,B).
p915(A,B):-p1871(A,C),p915_1(C,B).
p915_1(A,B):-p1685(A,C),p915_2(C,B).
p915_2(A,B):-p1605(A,C),p1713(C,B).
...
p924(A,B):-p568(A,C),p924_1(C,B).
p924_1(A,B):-p1871(A,C),p924_2(C,B).
p924_2(A,B):-p1411(A,C),p1713(C,B).
...
p936_1(A,B):-p227(A,C),p936_2(C,B).
p936_2(A,B):-drop_ball(A,C),p1137(C,B).
...
p949(A,B):-move_backwards(A,C),p949_1(C,B).
p949_1(A,B):-p1376(A,C),p949_2(C,B).
p949_2(A,B):-p1605(A,C),p1499(C,B).
p955(A,B):-p367(A,C),p955_1(C,B).
p955_1(A,B):-p1976(A,C),p955_2(C,B).
p955_2(A,B):-p367(A,C),p1605(C,B).
p956(A,B):-move_backwards(A,C),p956_1(C,B).
p956_1(A,B):-p1376(A,C),p956_2(C,B).
...
p964(A,B):-p367(A,C),p964_1(C,B).
p964_1(A,B):-p1577(A,C),p964_2(C,B).
p964_2(A,B):-p227(A,C),p216(C,B).
...
p978(A,B):-p1949(A,C),p978_1(C,B).
p978_1(A,B):-move_right(A,C),p978_2(C,B).
...
p983_1(A,B):-p1067(A,C),p983_2(C,B).
p983_2(A,B):-drop_ball(A,C),p1120(C,B).
...
p988_2(A,B):-p227(A,C),p216(C,B).
p989(A,B):-move_backwards(A,C),p989_1(C,B).
p989_1(A,B):-p1023(A,C),p989_2(C,B).
p989_2(A,B):-move_right(A,C),p1222(C,B).
p990(A,B):-move_forwards(A,C),p990_1(C,B).
p990_1(A,B):-p1023(A,C),p990_2(C,B).
p990_2(A,B):-drop_ball(A,C),p692(C,B).
p994(A,B):-p1067(A,C),p994_1(C,B).
p994_1(A,B):-p1949(A,C),p994_2(C,B).
p994_2(A,B):-p882(A,C),p216(C,B).
p999(A,B):-p882(A,C),p999_1(C,B).
p999_1(A,B):-p1667(A,C),p999_2(C,B).
...
p1003(A,B):-move_right(A,C),p1003_1(C,B).
p1003_1(A,B):-p1714(A,C),p1003_2(C,B).
p1003_2(A,B):-move_left(A,C),drop_ball(C,B).
p1004(A,B):-p1714(A,C),p1004_1(C,B).
p1004_1(A,B):-p1483(A,C),p216(C,B).
p1005(A,B):-move_forwards(A,C),p1005_1(C,B).
p1005_1(A,B):-p1685(A,C),p1005_2(C,B).
p1005_2(A,B):-p1222(A,C),p1576(C,B).
p1006(A,B):-p1577(A,C),p1006_1(C,B).
p1006_1(A,B):-p1108(A,C),p1006_2(C,B).
p1006_2(A,B):-p1411(A,C),p1291(C,B).
p1007(A,B):-move_right(A,C),p1007_1(C,B).
p1007_1(A,B):-drop_ball(A,C),p227(C,B).
p1015(A,B):-p227(A,C),p1015_1(C,B).
p1015_1(A,B):-p1376(A,C),p1015_2(C,B).
...
p1024(A,B):-p1713(A,C),p1024_1(C,B).
p1024_1(A,B):-p1376(A,C),p1024_2(C,B).
p1024_2(A,B):-drop_ball(A,C),move_left(C,B).
p1025(A,B):-p1577(A,C),p1025_1(C,B).
p1025_1(A,B):-p1067(A,C),drop_ball(C,B).
p1030(A,B):-p692(A,C),p1030_1(C,B).
p1030_1(A,B):-p1685(A,C),p1030_2(C,B).
p1030_2(A,B):-p1605(A,C),p563(C,B).
p1031(A,B):-move_backwards(A,C),p1031_1(C,B).
p1031_1(A,B):-p1376(A,C),p1031_2(C,B).
p1031_2(A,B):-drop_ball(A,C),p276(C,B).
p1032(A,B):-p310(A,C),p1032_1(C,B).
p1032_1(A,B):-p1976(A,C),p1032_2(C,B).
p1032_2(A,B):-move_forwards(A,C),p1605(C,B).
p1033(A,B):-move_backwards(A,C),p1033_1(C,B).
p1033_1(A,B):-p1376(A,C),p1033_2(C,B).
...
p1039(A,B):-grab_ball(A,C),p1039_1(C,B).
p1039_1(A,B):-move_forwards(A,C),p1039_2(C,B).
p1039_2(A,B):-drop_ball(A,C),p69(C,B).
p1040(A,B):-move_left(A,C),p1040_1(C,B).
p1040_1(A,B):-p1685(A,C),p1040_2(C,B).
p1040_2(A,B):-p1222(A,C),p580(C,B).
p1041(A,B):-p1667(A,C),p1041_1(C,B).
p1041_1(A,B):-p30(A,C),p1041_2(C,B).
p1041_2(A,B):-p1222(A,C),p1483(C,B).
p1043(A,B):-p1391(A,C),p1043_1(C,B).
p1043_1(A,B):-p1685(A,C),p1043_2(C,B).
p1043_2(A,B):-p1222(A,C),p1093(C,B).
p1046(A,B):-p1976(A,C),p1046_1(C,B).
p1046_1(A,B):-p367(A,C),p1046_2(C,B).
p1046_2(A,B):-drop_ball(A,C),p1713(C,B).
p1048(A,B):-p1499(A,C),p1048_1(C,B).
p1048_1(A,B):-p1667(A,C),p1048_2(C,B).
p1048_2(A,B):-p216(A,C),p69(C,B).
p1049(A,B):-grab_ball(A,C),p1049_1(C,B).
p1049_1(A,B):-p1871(A,C),p1049_2(C,B).
p1049_2(A,B):-p1222(A,C),p613(C,B).
p1050(A,B):-p1108(A,C),p1050_1(C,B).
p1050_1(A,B):-p1023(A,C),p1050_2(C,B).
p1050_2(A,B):-p1605(A,C),move_right(C,B).
...
p1065(A,B):-p1667(A,C),p1065_1(C,B).
p1065_1(A,B):-move_backwards(A,C),p1065_2(C,B).
p1065_2(A,B):-p1411(A,C),move_right(C,B).
p1068(A,B):-p1976(A,C),p1068_1(C,B).
p1068_1(A,B):-p22(A,C),p1068_2(C,B).
p1068_2(A,B):-drop_ball(A,C),move_left(C,B).
p1070(A,B):-p1713(A,C),p1070_1(C,B).
p1070_1(A,B):-p1023(A,C),p1070_2(C,B).
p1070_2(A,B):-p1222(A,C),p1576(C,B).
...
p1075(A,B):-p1093(A,C),p1075_1(C,B).
p1075_1(A,B):-p1667(A,C),p1075_2(C,B).
p1075_2(A,B):-drop_ball(A,C),move_left(C,B).
...
p1082(A,B):-move_left(A,C),p1082_1(C,B).
p1082_1(A,B):-p692(A,C),p1082_2(C,B).
p1082_2(A,B):-p191(A,C),move_backwards(C,B).
...
p1089(A,B):-p1871(A,C),p1089_1(C,B).
p1089_1(A,B):-p1865(A,C),p1089_2(C,B).
p1089_2(A,B):-p1411(A,C),p613(C,B).
p1097(A,B):-p882(A,C),p1097_1(C,B).
p1097_1(A,B):-p568(A,C),p1097_2(C,B).
...
p1107(A,B):-p1576(A,C),p1107_1(C,B).
p1107_1(A,B):-p1976(A,C),p1107_2(C,B).
p1107_2(A,B):-p613(A,C),drop_ball(C,B).
...
p1115(A,B):-p1976(A,C),p1115_1(C,B).
p1115_1(A,B):-move_right(A,C),p1115_2(C,B).
p1115_2(A,B):-p216(A,C),p69(C,B).
p1116(A,B):-p465(A,C),p1116_1(C,B).
p1116_1(A,B):-p1023(A,C),p1116_2(C,B).
p1116_2(A,B):-move_right(A,C),p1605(C,B).
...
p1122_1(A,B):-p1577(A,C),p1122_2(C,B).
p1122_2(A,B):-p1399(A,C),p1411(C,B).
p1123(A,B):-p1208(A,C),p1123_1(C,B).
p1123_1(A,B):-p1714(A,C),p1123_2(C,B).
p1123_2(A,B):-p1605(A,C),p1399(C,B).
p1129(A,B):-p1100(A,C),p1129_1(C,B).
p1129_1(A,B):-p23(A,C),p1129_2(C,B).
p1129_2(A,B):-p613(A,C),drop_ball(C,B).
...
p1133(A,B):-p1976(A,C),p1133_1(C,B).
p1133_1(A,B):-move_forwards(A,C),p1133_2(C,B).
p1133_2(A,B):-p1222(A,C),p367(C,B).
...
p1141_1(A,B):-move_right(A,C),p1141_2(C,B).
p1141_2(A,B):-p1605(A,C),p1483(C,B).
p1143(A,B):-p1949(A,C),p1143_1(C,B).
p1143_1(A,B):-p227(A,C),p1143_2(C,B).
p1143_2(A,B):-drop_ball(A,C),p692(C,B).
p1146(A,B):-p1871(A,C),p1146_1(C,B).
p1146_1(A,B):-p1685(A,C),p1146_2(C,B).
p1146_2(A,B):-drop_ball(A,C),p1483(C,B).
...
p1171(A,B):-p69(A,C),p1171_1(C,B).
p1171_1(A,B):-p1091(A,C),p1667(C,B).
p1172(A,B):-p227(A,C),p1172_1(C,B).
p1172_1(A,B):-p1865(A,C),p1172_2(C,B).
...
p1176(A,B):-p1976(A,C),p1176_1(C,B).
p1176_1(A,B):-p22(A,C),p1176_2(C,B).
p1176_2(A,B):-p1605(A,C),p30(C,B).
p1177(A,B):-p1685(A,C),p1177_1(C,B).
p1177_1(A,B):-p7(A,C),p1177_2(C,B).
p1177_2(A,B):-p1605(A,C),p69(C,B).
p1185(A,B):-p276(A,C),p1185_1(C,B).
p1185_1(A,B):-p1949(A,C),p1185_2(C,B).
p1185_2(A,B):-p882(A,C),p216(C,B).
...
p1202_2(A,B):-p367(A,C),p1222(C,B).
p1204(A,B):-move_left(A,C),p1204_1(C,B).
p1204_1(A,B):-p1108(A,C),p1204_2(C,B).
p1204_2(A,B):-p1685(A,C),p216(C,B).
p1206(A,B):-p1208(A,C),p1206_1(C,B).
p1206_1(A,B):-p1577(A,C),p1206_2(C,B).
...
p1215(A,B):-p651(A,C),p1215_1(C,B).
p1215_1(A,B):-p1667(A,C),p1215_2(C,B).
p1215_2(A,B):-p216(A,C),p1208(C,B).
p1216(A,B):-p276(A,C),p1216_1(C,B).
p1216_1(A,B):-p1667(A,C),p1216_2(C,B).
...
p1227(A,B):-p1208(A,C),p1227_1(C,B).
p1227_1(A,B):-p1577(A,C),p1227_2(C,B).
p1227_2(A,B):-p1605(A,C),p227(C,B).
p1228(A,B):-move_forwards(A,C),p1228_1(C,B).
p1228_1(A,B):-p1714(A,C),p1100(C,B).
p1231(A,B):-p1871(A,C),p1231_1(C,B).
p1231_1(A,B):-p1023(A,C),p1231_2(C,B).
p1231_2(A,B):-drop_ball(A,C),p1137(C,B).
p1232(A,B):-p227(A,C),p1232_1(C,B).
p1232_1(A,B):-p1667(A,C),p1232_2(C,B).
p1232_2(A,B):-p1411(A,C),p794(C,B).
p1235(A,B):-p568(A,C),p1235_1(C,B).
p1235_1(A,B):-p227(A,C),p1235_2(C,B).
p1235_2(A,B):-p1411(A,C),p1576(C,B).
p1237(A,B):-p227(A,C),p1237_1(C,B).
p1237_1(A,B):-p1667(A,C),p1237_2(C,B).
p1237_2(A,B):-drop_ball(A,C),move_forwards(C,B).
...
p1246(A,B):-p1853(A,C),p1246_1(C,B).
p1246_1(A,B):-p23(A,C),p1246_2(C,B).
p1246_2(A,B):-drop_ball(A,C),p310(C,B).
p1247(A,B):-move_left(A,C),p1247_1(C,B).
p1247_1(A,B):-p1577(A,C),p1247_2(C,B).
p1247_2(A,B):-p1605(A,C),p1208(C,B).
...
p1253(A,B):-p1714(A,C),p1253_1(C,B).
p1253_1(A,B):-move_left(A,C),p1253_2(C,B).
p1253_2(A,B):-p1411(A,C),p367(C,B).
...
p1283(A,B):-p1871(A,C),p1283_1(C,B).
p1283_1(A,B):-p1685(A,C),p1283_2(C,B).
p1283_2(A,B):-drop_ball(A,C),p613(C,B).
p1287(A,B):-p1665(A,C),p1287_1(C,B).
p1287_1(A,B):-p1865(A,C),p1287_2(C,B).
p1287_2(A,B):-p1411(A,C),p1871(C,B).
p1290(A,B):-p563(A,C),p1290_1(C,B).
p1290_1(A,B):-p1667(A,C),p1290_2(C,B).
p1290_2(A,B):-drop_ball(A,C),p7(C,B).
p1293(A,B):-p1667(A,C),p1293_1(C,B).
p1293_1(A,B):-p367(A,C),p1293_2(C,B).
p1293_2(A,B):-p1605(A,C),p1399(C,B).
...
p1306_1(A,B):-p1667(A,C),p1306_2(C,B).
p1306_2(A,B):-p216(A,C),move_left(C,B).
p1307(A,B):-p1023(A,C),p1307_1(C,B).
p1307_1(A,B):-p1222(A,C),move_left(C,B).
p1308(A,B):-p1544(A,C),p1308_1(C,B).
p1308_1(A,B):-p1667(A,C),p1308_2(C,B).
p1308_2(A,B):-drop_ball(A,C),p1391(C,B).
p1309(A,B):-p882(A,C),p1309_1(C,B).
p1309_1(A,B):-p1376(A,C),p1309_2(C,B).
p1309_2(A,B):-drop_ball(A,C),p402(C,B).
p1310(A,B):-p1208(A,C),p1310_1(C,B).
p1310_1(A,B):-p1376(A,C),p1310_2(C,B).
p1310_2(A,B):-p580(A,C),p1222(C,B).
p1314(A,B):-move_forwards(A,C),p1314_1(C,B).
p1314_1(A,B):-p1685(A,C),p1314_2(C,B).
p1314_2(A,B):-p216(A,C),p1483(C,B).
p1316(A,B):-p1576(A,C),p1316_1(C,B).
p1316_1(A,B):-p1976(A,C),p1316_2(C,B).
p1316_2(A,B):-p1411(A,C),p367(C,B).
...
p1345(A,B):-p1499(A,C),p1345_1(C,B).
p1345_1(A,B):-p1667(A,C),p1345_2(C,B).
...
p1347(A,B):-p1871(A,C),p1347_1(C,B).
p1347_1(A,B):-grab_ball(A,C),p1222(C,B).
p1350(A,B):-p1871(A,C),p1350_1(C,B).
p1350_1(A,B):-p1023(A,C),p1350_2(C,B).
p1350_2(A,B):-p216(A,C),p1871(C,B).
p1351(A,B):-p1100(A,C),p1351_1(C,B).
p1351_1(A,B):-p1376(A,C),p1351_2(C,B).
p1351_2(A,B):-drop_ball(A,C),p580(C,B).
p1352(A,B):-p1865(A,C),p1352_1(C,B).
p1352_1(A,B):-p1576(A,C),p1411(C,B).
...
p1360(A,B):-p651(A,C),p1360_1(C,B).
p1360_1(A,B):-p568(A,C),p1360_2(C,B).
...
p1369(A,B):-p1391(A,C),p1369_1(C,B).
p1369_1(A,B):-p1865(A,C),p1369_2(C,B).
p1369_2(A,B):-drop_ball(A,C),p1665(C,B).
p1371(A,B):-p1665(A,C),p1371_1(C,B).
p1371_1(A,B):-p1976(A,C),p1371_2(C,B).
p1371_2(A,B):-p882(A,C),p216(C,B).
p1372(A,B):-p503(A,C),p1372_1(C,B).
p1372_1(A,B):-p1865(A,C),p1372_2(C,B).
p1372_2(A,B):-p1411(A,C),p1093(C,B).
p1380(A,B):-p1067(A,C),p1380_1(C,B).
p1380_1(A,B):-p1685(A,C),p1380_2(C,B).
p1380_2(A,B):-p1411(A,C),move_backwards(C,B).
p1382(A,B):-p1399(A,C),p1382_1(C,B).
p1382_1(A,B):-p1023(A,C),p1382_2(C,B).
p1382_2(A,B):-p1605(A,C),p1871(C,B).
p1388(A,B):-p1714(A,C),p1388_1(C,B).
p1388_1(A,B):-p30(A,C),p1388_2(C,B).
p1388_2(A,B):-drop_ball(A,C),p1576(C,B).
...
p1401(A,B):-p692(A,C),p1401_1(C,B).
p1401_1(A,B):-p1667(A,C),p1067(C,B).
p1402(A,B):-p1685(A,C),p1402_1(C,B).
p1402_1(A,B):-move_left(A,C),p1402_2(C,B).
p1402_2(A,B):-p1411(A,C),p367(C,B).
p1404(A,B):-p1949(A,C),p1404_1(C,B).
p1404_1(A,B):-move_right(A,C),p1404_2(C,B).
p1404_2(A,B):-drop_ball(A,C),p1576(C,B).
p1406(A,B):-p568(A,C),p1406_1(C,B).
p1406_1(A,B):-p1665(A,C),p1605(C,B).
p1408(A,B):-p1577(A,C),p1408_1(C,B).
p1408_1(A,B):-p30(A,C),p1408_2(C,B).
p1408_2(A,B):-p1222(A,C),p1576(C,B).
p1409(A,B):-p580(A,C),p1409_1(C,B).
p1409_1(A,B):-p1376(A,C),p1409_2(C,B).
p1409_2(A,B):-p1222(A,C),p1544(C,B).
p1410(A,B):-p1291(A,C),p1410_1(C,B).
p1410_1(A,B):-p568(A,C),p1410_2(C,B).
p1410_2(A,B):-p227(A,C),p1222(C,B).
...
p1426(A,B):-p882(A,C),p1426_1(C,B).
p1426_1(A,B):-p1376(A,C),p1426_2(C,B).
...
p1438(A,B):-move_right(A,C),p1438_1(C,B).
p1438_1(A,B):-p1667(A,C),p1438_2(C,B).
p1438_2(A,B):-p216(A,C),p227(C,B).
...
p1443(A,B):-p1499(A,C),p1443_1(C,B).
p1443_1(A,B):-p1376(A,C),p1443_2(C,B).
...
p1450(A,B):-p23(A,C),p1450_1(C,B).
p1450_1(A,B):-move_forwards(A,C),p1411(C,B).
p1451(A,B):-p1714(A,C),p1451_1(C,B).
p1451_1(A,B):-p563(A,C),p1451_2(C,B).
p1451_2(A,B):-drop_ball(A,C),p69(C,B).
...
p1457(A,B):-p1391(A,C),p1457_1(C,B).
p1457_1(A,B):-p1949(A,C),p1457_2(C,B).
...
p1463(A,B):-p563(A,C),p1463_1(C,B).
p1463_1(A,B):-p1949(A,C),p1222(C,B).
...
p1480_1(A,B):-p1685(A,C),p1480_2(C,B).
p1480_2(A,B):-p1264(A,C),drop_ball(C,B).
...
p1486_1(A,B):-p1544(A,C),p1486_2(C,B).
p1486_2(A,B):-p1376(A,C),p1605(C,B).
p1489(A,B):-p1685(A,C),p1489_1(C,B).
p1489_1(A,B):-p310(A,C),p1489_2(C,B).
p1489_2(A,B):-p1411(A,C),p1093(C,B).
p1490(A,B):-p1023(A,C),p1490_1(C,B).
p1490_1(A,B):-p1576(A,C),p1490_2(C,B).
p1490_2(A,B):-p1222(A,C),p1399(C,B).
...
p1498_1(A,B):-p227(A,C),p1498_2(C,B).
p1498_2(A,B):-p1222(A,C),p1713(C,B).
...
p1505_2(A,B):-p465(A,C),p1411(C,B).
p1509(A,B):-p1713(A,C),p1509_1(C,B).
p1509_1(A,B):-p1023(A,C),p1509_2(C,B).
...
p1520(A,B):-move_left(A,C),p1520_1(C,B).
p1520_1(A,B):-p1577(A,C),p1520_2(C,B).
p1520_2(A,B):-p1411(A,C),p1576(C,B).
p1522(A,B):-move_forwards(A,C),p1522_1(C,B).
p1522_1(A,B):-p1023(A,C),p1522_2(C,B).
p1522_2(A,B):-p1411(A,C),p794(C,B).
p1523(A,B):-p227(A,C),p1523_1(C,B).
p1523_1(A,B):-p1667(A,C),p1523_2(C,B).
p1523_2(A,B):-p1411(A,C),p794(C,B).
p1525(A,B):-p882(A,C),p1525_1(C,B).
p1525_1(A,B):-p23(A,C),p1525_2(C,B).
p1525_2(A,B):-p191(A,C),p22(C,B).
p1530(A,B):-p1685(A,C),p1530_1(C,B).
p1530_1(A,B):-p69(A,C),p1530_2(C,B).
p1530_2(A,B):-drop_ball(A,C),p1576(C,B).
...
p1538_1(A,B):-p1100(A,C),p1538_2(C,B).
p1538_2(A,B):-p1411(A,C),p1576(C,B).
...
p1546(A,B):-p1871(A,C),p1546_1(C,B).
p1546_1(A,B):-p1685(A,C),p1546_2(C,B).
p1546_2(A,B):-p1411(A,C),p692(C,B).
p1557(A,B):-p1685(A,C),p1557_1(C,B).
p1557_1(A,B):-p7(A,C),p1557_2(C,B).
p1557_2(A,B):-drop_ball(A,C),p1544(C,B).
p1561(A,B):-p1714(A,C),p1561_1(C,B).
p1561_1(A,B):-p276(A,C),p1222(C,B).
p1564(A,B):-p1949(A,C),p1564_1(C,B).
p1564_1(A,B):-p1067(A,C),p1564_2(C,B).
p1564_2(A,B):-p1411(A,C),p613(C,B).
p1570(A,B):-move_backwards(A,C),p1570_1(C,B).
p1570_1(A,B):-p1949(A,C),p1570_2(C,B).
p1570_2(A,B):-p367(A,C),p191(C,B).
p1572(A,B):-p613(A,C),p1572_1(C,B).
p1572_1(A,B):-p1023(A,C),p1572_2(C,B).
p1572_2(A,B):-drop_ball(A,C),p7(C,B).
p1574(A,B):-p1714(A,C),p1574_1(C,B).
p1574_1(A,B):-move_left(A,C),p1574_2(C,B).
p1574_2(A,B):-p1411(A,C),move_right(C,B).
p1578(A,B):-move_left(A,C),p1578_1(C,B).
p1578_1(A,B):-p1667(A,C),p1578_2(C,B).
p1578_2(A,B):-p402(A,C),p1222(C,B).
p1579(A,B):-move_left(A,C),p1579_1(C,B).
p1579_1(A,B):-p1577(A,C),p1579_2(C,B).
p1579_2(A,B):-p1544(A,C),p1222(C,B).
p1581(A,B):-p1576(A,C),p1581_1(C,B).
p1581_1(A,B):-p568(A,C),p1581_2(C,B).
p1581_2(A,B):-p1411(A,C),p69(C,B).
p1584(A,B):-p227(A,C),p1584_1(C,B).
p1584_1(A,B):-p1376(A,C),p1584_2(C,B).
p1584_2(A,B):-p882(A,C),p1605(C,B).
p1585(A,B):-p1023(A,C),p1585_1(C,B).
p1585_1(A,B):-p1871(A,C),p1585_2(C,B).
p1585_2(A,B):-p216(A,C),move_forwards(C,B).
p1586(A,B):-p563(A,C),p1586_1(C,B).
p1586_1(A,B):-p1667(A,C),p1586_2(C,B).
p1586_2(A,B):-p216(A,C),p227(C,B).
p1588(A,B):-move_left(A,C),p1588_1(C,B).
p1588_1(A,B):-p1411(A,C),p503(C,B).
p1589(A,B):-p1291(A,C),p1589_1(C,B).
p1589_1(A,B):-p1667(A,C),p1589_2(C,B).
p1589_2(A,B):-p216(A,C),p1067(C,B).
p1591(A,B):-move_left(A,C),p1591_1(C,B).
p1591_1(A,B):-p1023(A,C),p1591_2(C,B).
p1591_2(A,B):-p1411(A,C),move_right(C,B).
p1595(A,B):-p1976(A,C),p1595_1(C,B).
p1595_1(A,B):-p563(A,C),p1595_2(C,B).
p1595_2(A,B):-p1605(A,C),p692(C,B).
p1598(A,B):-p563(A,C),p1598_1(C,B).
p1598_1(A,B):-p1949(A,C),p1598_2(C,B).
p1598_2(A,B):-p1605(A,C),p1208(C,B).
p1599(A,B):-grab_ball(A,C),p1599_1(C,B).
p1599_1(A,B):-p1093(A,C),p1599_2(C,B).
p1599_2(A,B):-p1222(A,C),p1576(C,B).
p1601(A,B):-p1499(A,C),p1601_1(C,B).
p1601_1(A,B):-p1667(A,C),p1601_2(C,B).
...
p1604(A,B):-p1544(A,C),p1604_1(C,B).
p1604_1(A,B):-p1411(A,C),move_forwards(C,B).
...
p1613_1(A,B):-p1023(A,C),p1613_2(C,B).
p1613_2(A,B):-p1576(A,C),p1605(C,B).
...
p1627_2(A,B):-p1120(A,C),p1222(C,B).
p1628(A,B):-p1667(A,C),p1628_1(C,B).
p1628_1(A,B):-move_right(A,C),p1628_2(C,B).
p1628_2(A,B):-p216(A,C),p1544(C,B).
...
p1634(A,B):-move_left(A,C),p1634_1(C,B).
p1634_1(A,B):-p651(A,C),p1634_2(C,B).
p1634_2(A,B):-p1376(A,C),p1605(C,B).
p1635(A,B):-p402(A,C),p1635_1(C,B).
p1635_1(A,B):-p1865(A,C),p1635_2(C,B).
p1635_2(A,B):-p1222(A,C),p563(C,B).
p1636(A,B):-p1871(A,C),p1636_1(C,B).
p1636_1(A,B):-grab_ball(A,C),p1636_2(C,B).
p1636_2(A,B):-p1605(A,C),p1871(C,B).
p1638(A,B):-p1577(A,C),p1638_1(C,B).
p1638_1(A,B):-p310(A,C),p1638_2(C,B).
p1638_2(A,B):-drop_ball(A,C),p563(C,B).
p1639(A,B):-p1714(A,C),p1639_1(C,B).
p1639_1(A,B):-p1483(A,C),p1639_2(C,B).
p1639_2(A,B):-p1605(A,C),p310(C,B).
...
p1649_1(A,B):-p1120(A,C),p1222(C,B).
p1652(A,B):-p1949(A,C),p1652_1(C,B).
p1652_1(A,B):-p1713(A,C),p1652_2(C,B).
p1652_2(A,B):-drop_ball(A,C),p465(C,B).
...
p1655_1(A,B):-p1208(A,C),p1655_2(C,B).
p1655_2(A,B):-drop_ball(A,C),move_right(C,B).
...
p1674_2(A,B):-p1093(A,C),p1222(C,B).
...
p1684(A,B):-move_right(A,C),p1684_1(C,B).
p1684_1(A,B):-p1714(A,C),p1684_2(C,B).
p1684_2(A,B):-p465(A,C),p216(C,B).
p1688(A,B):-p568(A,C),p1688_1(C,B).
p1688_1(A,B):-p1665(A,C),p1688_2(C,B).
p1688_2(A,B):-p1605(A,C),p1871(C,B).
...
p1694_2(A,B):-p1665(A,C),p1222(C,B).
...
p1702(A,B):-move_right(A,C),p1702_1(C,B).
p1702_1(A,B):-p1714(A,C),p1702_2(C,B).
...
p1708(A,B):-p1577(A,C),p1708_1(C,B).
p1708_1(A,B):-move_left(A,C),p1708_2(C,B).
p1708_2(A,B):-p1222(A,C),p1091(C,B).
p1709(A,B):-p651(A,C),p1709_1(C,B).
p1709_1(A,B):-p1667(A,C),p1709_2(C,B).
...
p1726_1(A,B):-p23(A,C),p1726_2(C,B).
p1726_2(A,B):-p613(A,C),drop_ball(C,B).
p1730(A,B):-p1871(A,C),p1730_1(C,B).
p1730_1(A,B):-p1667(A,C),move_backwards(C,B).
p1734(A,B):-p1871(A,C),p1734_1(C,B).
p1734_1(A,B):-p1865(A,C),p1734_2(C,B).
p1734_2(A,B):-p1222(A,C),p613(C,B).
p1735(A,B):-p568(A,C),p1735_1(C,B).
p1735_1(A,B):-p227(A,C),p1735_2(C,B).
p1735_2(A,B):-drop_ball(A,C),p1871(C,B).
p1739(A,B):-move_left(A,C),p1739_1(C,B).
p1739_1(A,B):-p568(A,C),p1739_2(C,B).
p1739_2(A,B):-drop_ball(A,C),p1576(C,B).
p1742(A,B):-p1665(A,C),p1742_1(C,B).
p1742_1(A,B):-p1865(A,C),p1742_2(C,B).
p1742_2(A,B):-p1576(A,C),p1411(C,B).
...
p1746_2(A,B):-p1665(A,C),p1222(C,B).
p1747(A,B):-p1499(A,C),p1747_1(C,B).
p1747_1(A,B):-p1667(A,C),p1747_2(C,B).
...
p1752(A,B):-move_backwards(A,C),p1752_1(C,B).
p1752_1(A,B):-p1376(A,C),p1752_2(C,B).
...
p1756(A,B):-p1577(A,C),p1756_1(C,B).
p1756_1(A,B):-p69(A,C),p1756_2(C,B).
p1756_2(A,B):-p1222(A,C),p7(C,B).
...
p1764_1(A,B):-p1208(A,C),p1764_2(C,B).
...
p1773(A,B):-p1685(A,C),p1773_1(C,B).
p1773_1(A,B):-p1544(A,C),p1773_2(C,B).
p1773_2(A,B):-drop_ball(A,C),p1853(C,B).
p1774(A,B):-p1871(A,C),p1774_1(C,B).
p1774_1(A,B):-p1949(A,C),p1774_2(C,B).
p1774_2(A,B):-p1222(A,C),p276(C,B).
p1778(A,B):-p1023(A,C),p1778_1(C,B).
p1778_1(A,B):-p1208(A,C),p1778_2(C,B).
p1778_2(A,B):-p216(A,C),p1703(C,B).
...
p1783_1(A,B):-p1023(A,C),p1783_2(C,B).
p1783_2(A,B):-drop_ball(A,C),move_forwards(C,B).
p1784(A,B):-move_forwards(A,C),p1784_1(C,B).
p1784_1(A,B):-p1023(A,C),p1784_2(C,B).
p1784_2(A,B):-p1411(A,C),p692(C,B).
p1789(A,B):-p1871(A,C),p1789_1(C,B).
p1789_1(A,B):-p1667(A,C),p1789_2(C,B).
p1789_2(A,B):-p1713(A,C),p191(C,B).
p1793(A,B):-p465(A,C),p1793_1(C,B).
p1793_1(A,B):-p1949(A,C),p1793_2(C,B).
p1793_2(A,B):-p1411(A,C),p1713(C,B).
p1795(A,B):-move_left(A,C),p1795_1(C,B).
p1795_1(A,B):-grab_ball(A,C),p1795_2(C,B).
p1795_2(A,B):-p580(A,C),p1222(C,B).
...
p1806(A,B):-p651(A,C),p1806_1(C,B).
p1806_1(A,B):-p1667(A,C),p1806_2(C,B).
p1806_2(A,B):-p216(A,C),p1871(C,B).
p1811(A,B):-p1376(A,C),p1811_1(C,B).
p1811_1(A,B):-p1665(A,C),p1811_2(C,B).
p1811_2(A,B):-drop_ball(A,C),p69(C,B).
...
p1824(A,B):-p1208(A,C),p1824_1(C,B).
p1824_1(A,B):-p1865(A,C),p1824_2(C,B).
...
p1829_2(A,B):-p402(A,C),p1411(C,B).
p1837(A,B):-p1483(A,C),p1837_1(C,B).
p1837_1(A,B):-p23(A,C),p1837_2(C,B).
p1837_2(A,B):-p1222(A,C),p1713(C,B).
p1838(A,B):-move_right(A,C),p1838_1(C,B).
p1838_1(A,B):-p1714(A,C),p1838_2(C,B).
p1838_2(A,B):-p1544(A,C),p1605(C,B).
p1840(A,B):-p580(A,C),p1840_1(C,B).
p1840_1(A,B):-p1685(A,C),p1840_2(C,B).
p1840_2(A,B):-drop_ball(A,C),p367(C,B).
p1842(A,B):-move_right(A,C),p1842_1(C,B).
p1842_1(A,B):-p1714(A,C),p1842_2(C,B).
p1842_2(A,B):-p1605(A,C),p310(C,B).
p1843(A,B):-p651(A,C),p1843_1(C,B).
p1843_1(A,B):-p1376(A,C),p1843_2(C,B).
...
p1848_1(A,B):-p227(A,C),p1848_2(C,B).
p1848_2(A,B):-drop_ball(A,C),p367(C,B).
p1849(A,B):-p1685(A,C),p1849_1(C,B).
p1849_1(A,B):-p22(A,C),p1849_2(C,B).
p1849_2(A,B):-p191(A,C),p882(C,B).
...
p1858_2(A,B):-p1483(A,C),p216(C,B).
p1860(A,B):-p1208(A,C),p1860_1(C,B).
p1860_1(A,B):-p1376(A,C),p1860_2(C,B).
p1860_2(A,B):-p651(A,C),p1222(C,B).
p1863(A,B):-p1685(A,C),p1863_1(C,B).
p1863_1(A,B):-p216(A,C),move_right(C,B).
p1866(A,B):-grab_ball(A,C),p1866_1(C,B).
p1866_1(A,B):-move_right(A,C),p1866_2(C,B).
p1866_2(A,B):-p1445(A,C),p1411(C,B).
p1867(A,B):-p1949(A,C),p1867_1(C,B).
p1867_1(A,B):-move_right(A,C),p1867_2(C,B).
...
p1877_1(A,B):-p1264(A,C),p1222(C,B).
p1883(A,B):-p1685(A,C),p1883_1(C,B).
p1883_1(A,B):-p1137(A,C),p1883_2(C,B).
p1883_2(A,B):-p1605(A,C),p227(C,B).
p1885(A,B):-move_right(A,C),p1885_1(C,B).
p1885_1(A,B):-p1667(A,C),p1885_2(C,B).
p1885_2(A,B):-drop_ball(A,C),p1445(C,B).
...
p1902(A,B):-p227(A,C),p1902_1(C,B).
p1902_1(A,B):-p1667(A,C),p1902_2(C,B).
p1902_2(A,B):-p1411(A,C),p7(C,B).
p1903(A,B):-p30(A,C),p1903_1(C,B).
p1903_1(A,B):-p1865(A,C),p1903_2(C,B).
p1903_2(A,B):-p216(A,C),p227(C,B).
p1904(A,B):-p1023(A,C),p1904_1(C,B).
p1904_1(A,B):-move_right(A,C),p1904_2(C,B).
p1904_2(A,B):-drop_ball(A,C),p465(C,B).
...
p1918(A,B):-p1871(A,C),p1918_1(C,B).
p1918_1(A,B):-p1714(A,C),p1918_2(C,B).
p1918_2(A,B):-p216(A,C),p1665(C,B).
...
p1926(A,B):-p651(A,C),p1926_1(C,B).
p1926_1(A,B):-p1376(A,C),p1926_2(C,B).
p1926_2(A,B):-p1222(A,C),p30(C,B).
p1927(A,B):-p1391(A,C),p1927_1(C,B).
p1927_1(A,B):-p1949(A,C),p1927_2(C,B).
...
p1933(A,B):-p1291(A,C),p1933_1(C,B).
p1933_1(A,B):-p1376(A,C),p1933_2(C,B).
p1933_2(A,B):-p1605(A,C),p69(C,B).
p1935(A,B):-p1093(A,C),p1935_1(C,B).
p1935_1(A,B):-p1376(A,C),p1935_2(C,B).
...
p1938(A,B):-p1483(A,C),p1938_1(C,B).
p1938_1(A,B):-p1667(A,C),p1938_2(C,B).
p1938_2(A,B):-p563(A,C),p191(C,B).
p1940(A,B):-p1714(A,C),p1940_1(C,B).
p1940_1(A,B):-move_backwards(A,C),p1940_2(C,B).
p1940_2(A,B):-p1411(A,C),move_right(C,B).
p1943(A,B):-move_left(A,C),p1943_1(C,B).
p1943_1(A,B):-p23(A,C),p1943_2(C,B).
p1943_2(A,B):-p7(A,C),p1411(C,B).
p1946(A,B):-move_left(A,C),p1946_1(C,B).
p1946_1(A,B):-p22(A,C),p1946_2(C,B).
p1946_2(A,B):-p1023(A,C),p1222(C,B).
...
p1956(A,B):-p465(A,C),p1956_1(C,B).
p1956_1(A,B):-p1949(A,C),p1956_2(C,B).
p1956_2(A,B):-p1411(A,C),p1483(C,B).
p1957(A,B):-p1665(A,C),p1957_1(C,B).
p1957_1(A,B):-p1577(A,C),p1957_2(C,B).
p1957_2(A,B):-move_forwards(A,C),p1222(C,B).
p1959(A,B):-move_right(A,C),p1959_1(C,B).
p1959_1(A,B):-p1667(A,C),p1959_2(C,B).
p1959_2(A,B):-drop_ball(A,C),p580(C,B).
...
p1966_1(A,B):-p402(A,C),p1222(C,B).
p1970(A,B):-p227(A,C),p1970_1(C,B).
p1970_1(A,B):-p1685(A,C),p1970_2(C,B).
p1970_2(A,B):-drop_ball(A,C),p1713(C,B).
p1972(A,B):-p465(A,C),p1972_1(C,B).
p1972_1(A,B):-p1685(A,C),p1972_2(C,B).
p1972_2(A,B):-drop_ball(A,C),p563(C,B).
p1973(A,B):-move_backwards(A,C),p1973_1(C,B).
p1973_1(A,B):-p1577(A,C),move_backwards(C,B).
p1975(A,B):-p1208(A,C),p1975_1(C,B).
p1975_1(A,B):-p1685(A,C),p1975_2(C,B).
...
p1983(A,B):-p1577(A,C),p1983_1(C,B).
p1983_1(A,B):-move_forwards(A,C),p1605(C,B).
...
p1995(A,B):-p1291(A,C),p1995_1(C,B).
p1995_1(A,B):-p568(A,C),p1995_2(C,B).
...
b0(A,B):-p276(A,C),p292(C,B).
b8(A,B):-p1291(A,C),p1388(C,B).
b6(A,B):-p1576(A,C),p1429(C,B).
b5(A,B):-p1196(A,C),p1919(C,B).
b16(A,B):-p1605(A,C),p418(C,B).
b1(A,B):-move_left(A,C),b1_1(C,B).
b1_1(A,B):-p1399(A,C),p1804(C,B).
b3(A,B):-move_right(A,C),b3_1(C,B).
b3_1(A,B):-p492(A,C),p1244(C,B).
...
b24(A,B):-p1538(A,C),p1871(C,B).
b26(A,B):-p194(A,C),p651(C,B).
b21(A,B):-move_forwards(A,C),b21_1(C,B).
b21_1(A,B):-p875(A,C),p367(C,B).
b28(A,B):-p1753(A,C),move_forwards(C,B).
b29(A,B):-p1702(A,C),p502(C,B).
b27(A,B):-move_left(A,C),b27_1(C,B).
b27_1(A,B):-p187(A,C),p465(C,B).
b25(A,B):-move_left(A,C),b25_1(C,B).
b25_1(A,B):-p1722(A,C),p30(C,B).
b32(A,B):-p1143(A,C),p484(C,B).
b18(A,B):-p367(A,C),b18_1(C,B).
b18_1(A,B):-p1306(A,C),p1019(C,B).
b20(A,B):-p1208(A,C),b20_1(C,B).
b20_1(A,B):-p1938(A,C),p1408(C,B).
b36(A,B):-p563(A,C),p10(C,B).
b33(A,B):-move_backwards(A,C),b33_1(C,B).
b33_1(A,B):-p219(A,C),p1576(C,B).
b23(A,B):-p367(A,C),b23_1(C,B).
b23_1(A,B):-p980(A,C),p850(C,B).
b17(A,B):-p1871(A,C),b17_1(C,B).
b17_1(A,B):-p1143(A,C),p367(C,B).
b11(A,B):-p1871(A,C),b11_1(C,B).
b11_1(A,B):-p1235(A,C),p1399(C,B).
b41(A,B):-p30(A,B).
b39(A,B):-move_left(A,C),b39_1(C,B).
b39_1(A,B):-p30(A,C),p910(C,B).
b42(A,B):-p882(A,C),p1072(C,B).
b44(A,B):-p1720(A,B).
b43(A,B):-p794(A,C),p679(C,B).
b46(A,B):-p227(A,C),p893(C,B).
b15(A,B):-p1483(A,C),b15_1(C,B).
b15_1(A,B):-p810(A,C),p402(C,B).
b37(A,B):-move_right(A,C),b37_1(C,B).
b37_1(A,B):-p703(A,C),p465(C,B).
b30(A,B):-p367(A,C),b30_1(C,B).
b30_1(A,B):-p524(A,C),p465(C,B).
...
b34_1(A,B):-p33(A,C),p402(C,B).
b45(A,B):-move_forwards(A,C),b45_1(C,B).
b45_1(A,B):-p393(A,C),move_left(C,B).
b38(A,B):-p367(A,C),b38_1(C,B).
b38_1(A,B):-p1455(A,C),p261(C,B).
b47(A,B):-p563(A,C),b47_1(C,B).
b47_1(A,B):-p1117(A,C),p1399(C,B).
b55(A,B):-p1093(A,C),p1082(C,B).
b53(A,B):-move_forwards(A,C),b53_1(C,B).
b53_1(A,B):-p524(A,C),p1871(C,B).
b9(A,B):-p22(A,C),b9_1(C,B).
b9_1(A,B):-p1216(A,C),p1483(C,B).
b49(A,B):-p30(A,C),b49_1(C,B).
b49_1(A,B):-p599(A,C),p135(C,B).
b58(A,B):-p458(A,C),p502(C,B).
b50(A,B):-move_backwards(A,C),b50_1(C,B).
b50_1(A,B):-p139(A,C),p788(C,B).
b40(A,B):-p30(A,C),b40_1(C,B).
b40_1(A,B):-p344(A,C),p69(C,B).
b57(A,B):-move_left(A,C),b57_1(C,B).
b57_1(A,B):-p1460(A,C),p1713(C,B).
b35(A,B):-p1665(A,C),b35_1(C,B).
b35_1(A,B):-p427(A,C),p524(C,B).
b63(A,B):-p1108(A,C),p1265(C,B).
b56(A,B):-move_right(A,C),b56_1(C,B).
b56_1(A,B):-p212(A,C),p1416(C,B).
b13(A,B):-p783(A,C),b13_1(C,B).
b13_1(A,B):-p753(A,C),p1264(C,B).
b67(A,B):-p939(A,C),p580(C,B).
b7(A,B):-p351(A,C),b7_1(C,B).
b7_1(A,B):-p1194(A,C),p1483(C,B).
b70(A,B):-p477(A,C),p613(C,B).
b71(A,B):-move_forwards(A,C),p328(C,B).
b72(A,B):-move_backwards(A,C),p1720(C,B).
b14(A,B):-p1391(A,C),b14_1(C,B).
b14_1(A,B):-p1530(A,C),p367(C,B).
b60(A,B):-p1871(A,C),b60_1(C,B).
b60_1(A,B):-p1481(A,C),p402(C,B).
b75(A,B):-p1067(A,C),p1215(C,B).
b62(A,B):-p1067(A,C),b62_1(C,B).
b62_1(A,B):-p190(A,C),p1752(C,B).
b76(A,B):-p1645(A,C),p703(C,B).
b52(A,B):-p580(A,C),b52_1(C,B).
b52_1(A,B):-p1051(A,C),p651(C,B).
b78(A,B):-p276(A,C),p1961(C,B).
b79(A,B):-p367(A,C),p894(C,B).
b77(A,B):-p1774(A,C),p248(C,B).
b81(A,B):-p613(A,C),p36(C,B).
b83(A,B):-p1091(A,B).
b73(A,B):-p30(A,C),b73_1(C,B).
b73_1(A,B):-p853(A,C),p1853(C,B).
b68(A,B):-p1714(A,C),b68_1(C,B).
b68_1(A,B):-p850(A,C),p310(C,B).
b84(A,B):-move_backwards(A,C),b84_1(C,B).
b84_1(A,B):-p455(A,C),p1108(C,B).
b87(A,B):-move_left(A,C),p1694(C,B).
b65(A,B):-p563(A,C),b65_1(C,B).
b65_1(A,B):-p330(A,C),p227(C,B).
b85(A,B):-move_right(A,C),b85_1(C,B).
b85_1(A,B):-p225(A,C),p1074(C,B).
b69(A,B):-p212(A,C),b69_1(C,B).
b69_1(A,B):-p1416(A,C),p1279(C,B).
b86(A,B):-move_left(A,C),b86_1(C,B).
b86_1(A,B):-p1308(A,C),p1093(C,B).
b19(A,B):-p94(A,C),b19_1(C,B).
b19_1(A,B):-p835(A,C),p1072(C,B).
b80(A,B):-p1483(A,C),b80_1(C,B).
b80_1(A,B):-p203(A,C),p427(C,B).
b64(A,B):-p1228(A,C),b64_1(C,B).
b64_1(A,B):-p648(A,C),p1208(C,B).
b89(A,B):-move_right(A,C),b89_1(C,B).
b89_1(A,B):-p1041(A,C),p1208(C,B).
b95(A,B):-p36(A,C),p934(C,B).
b97(A,B):-p563(A,B).
b74(A,B):-p1208(A,C),b74_1(C,B).
b74_1(A,B):-p1510(A,C),p613(C,B).
b92(A,B):-move_left(A,C),b92_1(C,B).
b92_1(A,B):-p828(A,C),p1451(C,B).
b100(A,B):-p227(A,C),p543(C,B).
b88(A,B):-move_right(A,C),b88_1(C,B).
b88_1(A,B):-p582(A,C),p692(C,B).
b59(A,B):-p310(A,C),b59_1(C,B).
b59_1(A,B):-p1252(A,C),p550(C,B).
b96(A,B):-move_left(A,C),b96_1(C,B).
b96_1(A,B):-p332(A,C),move_backwards(C,B).
b102(A,B):-p1264(A,C),p187(C,B).
b101(A,B):-p1416(A,C),p1291(C,B).
b93(A,B):-move_backwards(A,C),b93_1(C,B).
b93_1(A,B):-p1067(A,C),p1309(C,B).
b61(A,B):-p903(A,C),b61_1(C,B).
b61_1(A,B):-p1544(A,C),p350(C,B).
b105(A,B):-p828(A,C),p1137(C,B).
b91(A,B):-p367(A,C),b91_1(C,B).
b91_1(A,B):-p590(A,C),move_forwards(C,B).
b108(A,B):-move_left(A,C),b108_1(C,B).
b108_1(A,B):-p1040(A,C),p1264(C,B).
b107(A,B):-move_forwards(A,C),b107_1(C,B).
b107_1(A,B):-p52(A,C),p367(C,B).
b111(A,B):-move_left(A,C),b111_1(C,B).
b111_1(A,B):-p1949(A,C),p1665(C,B).
b112(A,B):-p1162(A,C),p651(C,B).
b113(A,B):-p1080(A,C),p1703(C,B).
b115(A,B):-p576(A,C),p1483(C,B).
b94(A,B):-p1665(A,C),b94_1(C,B).
b94_1(A,B):-p1546(A,C),move_right(C,B).
b116(A,B):-move_left(A,C),b116_1(C,B).
b116_1(A,B):-p1605(A,C),p1207(C,B).
b118(A,B):-p471(A,C),p882(C,B).
b119(A,B):-p795(A,C),move_backwards(C,B).
b103(A,B):-p563(A,C),b103_1(C,B).
b103_1(A,B):-p610(A,C),p1483(C,B).
b121(A,B):-move_backwards(A,C),p748(C,B).
b104(A,B):-p310(A,C),b104_1(C,B).
b104_1(A,B):-p979(A,C),p69(C,B).
b98(A,B):-p1093(A,C),b98_1(C,B).
b98_1(A,B):-p1388(A,C),p1175(C,B).
b117(A,B):-p30(A,C),b117_1(C,B).
b117_1(A,B):-p665(A,C),p882(C,B).
b123(A,B):-move_left(A,C),b123_1(C,B).
b123_1(A,B):-p227(A,C),p1402(C,B).
b126(A,B):-p1162(A,C),p884(C,B).
b109(A,B):-p503(A,C),b109_1(C,B).
b109_1(A,B):-p1685(A,C),p257(C,B).
b125(A,B):-move_left(A,C),b125_1(C,B).
b125_1(A,B):-p63(A,C),p1665(C,B).
b127(A,B):-p1120(A,C),p1253(C,B).
b129(A,B):-move_forwards(A,C),p1943(C,B).
b130(A,B):-p576(A,C),p1703(C,B).
...
b133(A,B):-p769(A,C),p427(C,B).
b122(A,B):-p1208(A,C),b122_1(C,B).
b122_1(A,B):-p236(A,C),p1120(C,B).
b114(A,B):-p1067(A,C),b114_1(C,B).
b114_1(A,B):-p246(A,C),move_forwards(C,B).
b137(A,B):-move_left(A,C),b137_1(C,B).
b137_1(A,B):-p1171(A,C),p1108(C,B).
b138(A,B):-move_left(A,C),b138_1(C,B).
b138_1(A,B):-p1811(A,C),p1871(C,B).
b99(A,B):-p1399(A,C),b99_1(C,B).
b99_1(A,B):-p92(A,C),move_forwards(C,B).
b139(A,B):-move_backwards(A,C),b139_1(C,B).
b139_1(A,B):-p1411(A,C),p465(C,B).
b142(A,B):-move_right(A,C),p1902(C,B).
b136(A,B):-p367(A,C),b136_1(C,B).
b136_1(A,B):-p223(A,C),p1208(C,B).
b143(A,B):-p1713(A,C),p509(C,B).
b120(A,B):-p1871(A,C),b120_1(C,B).
b120_1(A,B):-p1903(A,C),p1091(C,B).
b145(A,B):-p406(A,C),p367(C,B).
b144(A,B):-p378(A,C),p540(C,B).
b128(A,B):-p1208(A,C),b128_1(C,B).
b128_1(A,B):-p699(A,C),p1247(C,B).
b148(A,B):-p1100(A,C),p72(C,B).
b149(A,B):-move_backwards(A,C),b149_1(C,B).
b149_1(A,B):-p1067(A,C),p1749(C,B).
b141(A,B):-p367(A,C),b141_1(C,B).
b141_1(A,B):-p1700(A,C),p310(C,B).
b106(A,B):-p1713(A,C),b106_1(C,B).
b106_1(A,B):-p1464(A,C),p69(C,B).
b153(A,B):-p1143(A,C),p1783(C,B).
b154(A,B):-move_right(A,C),p1120(C,B).
b155(A,B):-p370(A,C),p626(C,B).
b132(A,B):-p212(A,C),b132_1(C,B).
b132_1(A,B):-p1208(A,C),p1143(C,B).
b156(A,B):-p959(A,C),p310(C,B).
b157(A,B):-move_left(A,C),p378(C,B).
b151(A,B):-p30(A,C),b151_1(C,B).
b151_1(A,B):-p804(A,C),p1853(C,B).
b152(A,B):-p30(A,C),b152_1(C,B).
b152_1(A,B):-p820(A,C),p692(C,B).
b146(A,B):-p563(A,C),b146_1(C,B).
b146_1(A,B):-p1017(A,C),p402(C,B).
b160(A,B):-move_left(A,C),b160_1(C,B).
b160_1(A,B):-p1486(A,C),p990(C,B).
b163(A,B):-p976(A,B).
b140(A,B):-p1714(A,C),b140_1(C,B).
b140_1(A,B):-move_backwards(A,C),p350(C,B).
b164(A,B):-p402(A,C),p576(C,B).
b161(A,B):-move_left(A,C),b161_1(C,B).
b161_1(A,B):-p770(A,C),p1208(C,B).
b135(A,B):-p1040(A,C),b135_1(C,B).
b135_1(A,B):-p614(A,C),move_right(C,B).
b167(A,B):-p1510(A,C),p1031(C,B).
b162(A,B):-move_left(A,C),b162_1(C,B).
b162_1(A,B):-p504(A,C),p1576(C,B).
b150(A,B):-p1100(A,C),b150_1(C,B).
b150_1(A,B):-p1860(A,C),p1137(C,B).
b165(A,B):-move_forwards(A,C),b165_1(C,B).
b165_1(A,B):-p216(A,C),p1283(C,B).
b172(A,B):-p30(A,C),p1667(C,B).
b166(A,B):-p30(A,C),b166_1(C,B).
b166_1(A,B):-p856(A,C),p1544(C,B).
b174(A,B):-move_right(A,C),b174_1(C,B).
b174_1(A,B):-p28(A,C),p1871(C,B).
b175(A,B):-move_left(A,C),b175_1(C,B).
b175_1(A,B):-p1538(A,C),p1613(C,B).
b176(A,B):-p111(A,C),p563(C,B).
b159(A,B):-p1100(A,C),b159_1(C,B).
b159_1(A,B):-p788(A,C),p1713(C,B).
b177(A,B):-p957(A,C),p657(C,B).
b171(A,B):-p1871(A,C),b171_1(C,B).
b171_1(A,B):-grab_ball(A,C),p289(C,B).
b178(A,B):-move_left(A,C),b178_1(C,B).
b178_1(A,B):-p1388(A,C),p1990(C,B).
b169(A,B):-p692(A,C),b169_1(C,B).
b169_1(A,B):-p1579(A,C),p30(C,B).
b180(A,B):-p580(A,C),p1639(C,B).
b183(A,B):-p839(A,B).
b179(A,B):-move_backwards(A,C),b179_1(C,B).
b179_1(A,B):-p546(A,C),p1074(C,B).
b185(A,B):-p465(A,B).
b173(A,B):-p1100(A,C),b173_1(C,B).
b173_1(A,B):-p441(A,C),p1576(C,B).
...
b66_2(A,B):-p612(A,C),p343(C,B).
b170(A,B):-p1499(A,C),b170_1(C,B).
b170_1(A,B):-p1667(A,C),p1082(C,B).
b158(A,B):-p123(A,C),b158_1(C,B).
b158_1(A,B):-p1665(A,C),p269(C,B).
b181(A,B):-p1067(A,C),b181_1(C,B).
b181_1(A,B):-p806(A,C),move_backwards(C,B).
b192(A,B):-p1208(A,C),p264(C,B).
b194(A,B):-p330(A,C),p30(C,B).
b193(A,B):-move_backwards(A,C),b193_1(C,B).
b193_1(A,B):-p1055(A,C),p353(C,B).
b195(A,B):-p1399(A,C),p705(C,B).
b186(A,B):-p69(A,C),b186_1(C,B).
b186_1(A,B):-p1025(A,C),p1137(C,B).
b191(A,B):-p30(A,C),b191_1(C,B).
b191_1(A,B):-p839(A,C),p1871(C,B).
b197(A,B):-move_forwards(A,C),b197_1(C,B).
b197_1(A,B):-p153(A,C),p563(C,B).
b187(A,B):-p1483(A,C),b187_1(C,B).
b187_1(A,B):-p92(A,C),p1445(C,B).
b198(A,B):-p1483(A,C),b198_1(C,B).
b198_1(A,B):-p1557(A,C),p503(C,B).
b196(A,B):-p1871(A,C),b196_1(C,B).
b196_1(A,B):-p611(A,C),p563(C,B).
b190(A,B):-p1665(A,C),b190_1(C,B).
b190_1(A,B):-p1489(A,C),p1067(C,B).
b203(A,B):-p899(A,C),p1120(C,B).
b204(A,B):-p1483(A,C),p1283(C,B).
b202(A,B):-move_left(A,C),b202_1(C,B).
b202_1(A,B):-p667(A,C),move_backwards(C,B).
b201(A,B):-p1208(A,C),b201_1(C,B).
b201_1(A,B):-p884(A,C),p749(C,B).
b208(A,B):-p276(A,C),p1943(C,B).
b207(A,B):-p1368(A,C),p1037(C,B).
b209(A,B):-p1088(A,C),p1439(C,B).
b200(A,B):-p1665(A,C),b200_1(C,B).
b200_1(A,B):-p1948(A,C),p1309(C,B).
b212(A,B):-move_right(A,C),b212_1(C,B).
b212_1(A,B):-p484(A,C),p1351(C,B).
b189(A,B):-p882(A,C),b189_1(C,B).
b189_1(A,B):-p73(A,C),p1546(C,B).
b211(A,B):-p30(A,C),b211_1(C,B).
b211_1(A,B):-p1196(A,C),p1576(C,B).
...
b147_1(A,B):-p1544(A,C),b147_2(C,B).
b147_2(A,B):-p1111(A,C),p883(C,B).
b217(A,B):-move_left(A,C),b217_1(C,B).
b217_1(A,B):-p12(A,C),p1100(C,B).
b216(A,B):-move_left(A,C),b216_1(C,B).
b216_1(A,B):-p1751(A,C),p1146(C,B).
b220(A,B):-p765(A,C),p1931(C,B).
b221(A,B):-p46(A,C),p7(C,B).
b222(A,B):-p554(A,C),p402(C,B).
b218(A,B):-move_left(A,C),b218_1(C,B).
b218_1(A,B):-p1838(A,C),p23(C,B).
b224(A,B):-move_right(A,C),p232(C,B).
b184(A,B):-p705(A,C),b184_1(C,B).
b184_1(A,B):-p1068(A,C),p1108(C,B).
b225(A,B):-p1726(A,C),p1399(C,B).
b226(A,B):-p80(A,C),move_left(C,B).
b213(A,B):-p315(A,C),b213_1(C,B).
b213_1(A,B):-p972(A,C),p1871(C,B).
b228(A,B):-move_backwards(A,C),b228_1(C,B).
b228_1(A,B):-p657(A,C),p227(C,B).
b230(A,B):-p1075(A,C),move_forwards(C,B).
b227(A,B):-p30(A,C),b227_1(C,B).
b227_1(A,B):-p1730(A,C),p269(C,B).
b205(A,B):-p1703(A,C),b205_1(C,B).
b205_1(A,B):-p1876(A,C),p662(C,B).
b219(A,B):-p69(A,C),b219_1(C,B).
b219_1(A,B):-p804(A,C),p882(C,B).
b231(A,B):-move_forwards(A,C),b231_1(C,B).
b231_1(A,B):-p1846(A,C),p1512(C,B).
b229(A,B):-p367(A,C),b229_1(C,B).
b229_1(A,B):-p199(A,C),p1399(C,B).
b236(A,B):-p1561(A,C),p1270(C,B).
b237(A,B):-move_left(A,C),p1739(C,B).
b238(A,B):-p69(A,C),p1453(C,B).
b239(A,B):-move_forwards(A,C),b239_1(C,B).
b239_1(A,B):-p1201(A,C),p367(C,B).
b240(A,B):-p490(A,C),p402(C,B).
b233(A,B):-move_backwards(A,C),b233_1(C,B).
b233_1(A,B):-p695(A,C),p346(C,B).
b234(A,B):-move_backwards(A,C),b234_1(C,B).
b234_1(A,B):-p1253(A,C),p692(C,B).
b243(A,B):-move_left(A,C),b243_1(C,B).
b243_1(A,B):-p1463(A,C),p1445(C,B).
b244(A,B):-p1137(A,B).
b242(A,B):-p367(A,C),b242_1(C,B).
b242_1(A,B):-p1735(A,C),p453(C,B).
b168(A,B):-move_left(A,C),b168_1(C,B).
b168_1(A,B):-p465(A,C),b168_2(C,B).
b168_2(A,B):-p1444(A,C),p7(C,B).
b246(A,B):-move_left(A,C),b246_1(C,B).
b246_1(A,B):-p1075(A,C),p580(C,B).
b223(A,B):-p7(A,C),b223_1(C,B).
b223_1(A,B):-p737(A,C),p1696(C,B).
b249(A,B):-p1175(A,C),move_left(C,B).
b210(A,B):-p926(A,C),b210_1(C,B).
b210_1(A,B):-p1162(A,C),p1499(C,B).
b241(A,B):-p1399(A,C),b241_1(C,B).
b241_1(A,B):-p810(A,C),p402(C,B).
b247(A,B):-p30(A,C),b247_1(C,B).
b247_1(A,B):-p32(A,C),p1544(C,B).
b252(A,B):-p1667(A,C),drop_ball(C,B).
b251(A,B):-p30(A,C),b251_1(C,B).
b251_1(A,B):-p903(A,C),p1067(C,B).
b254(A,B):-p1150(A,C),p708(C,B).
b248(A,B):-move_forwards(A,C),b248_1(C,B).
b248_1(A,B):-p404(A,C),p1853(C,B).
b257(A,B):-p1208(A,C),p354(C,B).
b256(A,B):-move_left(A,C),b256_1(C,B).
b256_1(A,B):-p1561(A,C),p705(C,B).
b110(A,B):-move_forwards(A,C),b110_1(C,B).
b110_1(A,B):-p423(A,C),b110_2(C,B).
b110_2(A,B):-p828(A,C),p227(C,B).
b253(A,B):-move_backwards(A,C),b253_1(C,B).
b253_1(A,B):-p939(A,C),p235(C,B).
b232(A,B):-p1264(A,C),b232_1(C,B).
b232_1(A,B):-p1015(A,C),p348(C,B).
b260(A,B):-move_right(A,C),b260_1(C,B).
b260_1(A,B):-p1141(A,C),p1208(C,B).
b245(A,B):-p783(A,C),b245_1(C,B).
b245_1(A,B):-p929(A,C),p477(C,B).
b264(A,B):-p499(A,C),p1410(C,B).
b265(A,B):-move_left(A,C),p990(C,B).
b266(A,B):-move_left(A,C),p22(C,B).
b263(A,B):-p563(A,C),b263_1(C,B).
b263_1(A,B):-p671(A,C),move_forwards(C,B).
b54(A,B):-move_left(A,C),b54_1(C,B).
b54_1(A,B):-p7(A,C),b54_2(C,B).
b54_2(A,B):-p477(A,C),p1871(C,B).
b261(A,B):-p428(A,C),b261_1(C,B).
b261_1(A,B):-move_backwards(A,C),p1856(C,B).
b270(A,B):-p1208(A,C),p1540(C,B).
b259(A,B):-p1399(A,C),b259_1(C,B).
b259_1(A,B):-p610(A,C),p1445(C,B).
b262(A,B):-p568(A,C),b262_1(C,B).
b262_1(A,B):-p186(A,C),p367(C,B).
b273(A,B):-p1015(A,C),p1399(C,B).
b271(A,B):-p367(A,C),b271_1(C,B).
b271_1(A,B):-p718(A,C),p1017(C,B).
...
b267(A,B):-p1091(A,C),b267_1(C,B).
b267_1(A,B):-p1328(A,C),p699(C,B).
b268(A,B):-p1713(A,C),b268_1(C,B).
b268_1(A,B):-p847(A,C),p330(C,B).
b279(A,B):-move_left(A,C),b279_1(C,B).
b279_1(A,B):-p1460(A,C),p1270(C,B).
b278(A,B):-move_right(A,C),b278_1(C,B).
b278_1(A,B):-p427(A,C),move_left(C,B).
b280(A,B):-p1293(A,C),p1445(C,B).
b282(A,B):-p95(A,C),p1208(C,B).
b269(A,B):-p1093(A,C),b269_1(C,B).
b269_1(A,B):-p1464(A,C),p1445(C,B).
b285(A,B):-move_left(A,C),p1982(C,B).
b286(A,B):-move_right(A,C),b286_1(C,B).
b286_1(A,B):-p1780(A,C),move_backwards(C,B).
b284(A,B):-p30(A,C),b284_1(C,B).
b284_1(A,B):-p1067(A,C),p1498(C,B).
b287(A,B):-move_right(A,C),p1845(C,B).
b289(A,B):-p1544(A,C),p988(C,B).
b274(A,B):-p1713(A,C),b274_1(C,B).
b274_1(A,B):-p516(A,C),p828(C,B).
b291(A,B):-p916(A,C),p1665(C,B).
b288(A,B):-p1067(A,C),b288_1(C,B).
b288_1(A,B):-p458(A,C),p1756(C,B).
b293(A,B):-grab_ball(A,C),p1093(C,B).
b283(A,B):-p22(A,C),b283_1(C,B).
b283_1(A,B):-p55(A,C),p1576(C,B).
b292(A,B):-p1208(A,C),b292_1(C,B).
b292_1(A,B):-p671(A,C),p422(C,B).
b272(A,B):-p292(A,C),b272_1(C,B).
b272_1(A,B):-p1652(A,C),p22(C,B).
b297(A,B):-p69(A,C),p857(C,B).
b294(A,B):-p1483(A,C),b294_1(C,B).
b294_1(A,B):-p343(A,C),p1703(C,B).
b299(A,B):-p1091(A,C),p332(C,B).
b300(A,B):-p1115(A,C),p1137(C,B).
b296(A,B):-move_forwards(A,C),b296_1(C,B).
b296_1(A,B):-p734(A,C),p276(C,B).
b82(A,B):-p1483(A,C),b82_1(C,B).
b82_1(A,B):-p684(A,C),b82_2(C,B).
b82_2(A,B):-p758(A,C),p1898(C,B).
b302(A,B):-p563(A,C),p1845(C,B).
b304(A,B):-move_forwards(A,C),b304_1(C,B).
b304_1(A,B):-p902(A,C),p503(C,B).
b305(A,B):-p7(A,C),p1316(C,B).
b298(A,B):-p402(A,C),b298_1(C,B).
b298_1(A,B):-p514(A,C),p1576(C,B).
b306(A,B):-move_left(A,C),b306_1(C,B).
b306_1(A,B):-p1277(A,C),p1871(C,B).
b308(A,B):-p1613(A,C),p36(C,B).
b307(A,B):-move_left(A,C),b307_1(C,B).
b307_1(A,B):-p30(A,C),p329(C,B).
b309(A,B):-move_left(A,C),b309_1(C,B).
b309_1(A,B):-p1100(A,C),p469(C,B).
b303(A,B):-p276(A,C),b303_1(C,B).
b303_1(A,B):-p1589(A,C),p1713(C,B).
b312(A,B):-p1713(A,B).
b310(A,B):-move_right(A,C),b310_1(C,B).
b310_1(A,B):-p123(A,C),p191(C,B).
...
b313_1(A,B):-p531(A,C),p1291(C,B).
b317(A,B):-p246(A,C),p402(C,B).
b319(A,B):-p1649(A,C),move_right(C,B).
b318(A,B):-move_left(A,C),b318_1(C,B).
b318_1(A,B):-p517(A,C),p590(C,B).
b90(A,B):-move_left(A,C),b90_1(C,B).
b90_1(A,B):-p1023(A,C),b90_2(C,B).
b90_2(A,B):-p507(A,C),p1499(C,B).
b301(A,B):-p613(A,C),b301_1(C,B).
b301_1(A,B):-p330(A,C),p1100(C,B).
b320(A,B):-move_backwards(A,C),b320_1(C,B).
b320_1(A,B):-p772(A,C),p692(C,B).
b324(A,B):-p465(A,C),p659(C,B).
b325(A,B):-p563(A,C),p813(C,B).
b322(A,B):-move_backwards(A,C),b322_1(C,B).
b322_1(A,B):-p1087(A,C),p1628(C,B).
b31(A,B):-move_right(A,C),b31_1(C,B).
b31_1(A,B):-p1478(A,C),b31_2(C,B).
b31_2(A,B):-p1247(A,C),move_forwards(C,B).
b327(A,B):-move_left(A,C),b327_1(C,B).
b327_1(A,B):-p783(A,C),p1853(C,B).
b326(A,B):-move_forwards(A,C),b326_1(C,B).
b326_1(A,B):-p219(A,C),p1041(C,B).
b329(A,B):-p367(A,C),p466(C,B).
b321(A,B):-p1871(A,C),b321_1(C,B).
b321_1(A,B):-p875(A,C),move_forwards(C,B).
b315(A,B):-p310(A,C),b315_1(C,B).
b315_1(A,B):-p1749(A,C),p1956(C,B).
b331(A,B):-p1713(A,C),p1848(C,B).
b328(A,B):-move_left(A,C),b328_1(C,B).
b328_1(A,B):-p614(A,C),p367(C,B).
b332(A,B):-p1134(A,C),p367(C,B).
b323(A,B):-p563(A,C),b323_1(C,B).
b323_1(A,B):-p1820(A,C),p1466(C,B).
b337(A,B):-p1665(A,C),p1150(C,B).
b333(A,B):-move_right(A,C),b333_1(C,B).
b333_1(A,B):-p477(A,C),p1900(C,B).
b338(A,B):-p1550(A,C),p1371(C,B).
...
b342_1(A,B):-p122(A,C),p632(C,B).
b339(A,B):-p367(A,C),b339_1(C,B).
b339_1(A,B):-p232(A,C),move_backwards(C,B).
b344(A,B):-p580(A,C),p1411(C,B).
b281(A,B):-move_left(A,C),b281_1(C,B).
b281_1(A,B):-p692(A,C),b281_2(C,B).
b281_2(A,B):-p1003(A,C),p465(C,B).
b343(A,B):-p1483(A,C),b343_1(C,B).
b343_1(A,B):-p852(A,C),p1519(C,B).
b347(A,B):-p1399(A,C),p1520(C,B).
b348(A,B):-p1399(A,C),p630(C,B).
b345(A,B):-move_forwards(A,C),b345_1(C,B).
b345_1(A,B):-p868(A,C),p367(C,B).
b335(A,B):-p692(A,C),b335_1(C,B).
b335_1(A,B):-p732(A,C),p698(C,B).
b351(A,B):-p568(A,C),p257(C,B).
b352(A,B):-move_left(A,C),b352_1(C,B).
b352_1(A,B):-p418(A,C),p1100(C,B).
b353(A,B):-p1703(A,C),p370(C,B).
b350(A,B):-move_right(A,C),b350_1(C,B).
b350_1(A,B):-p1519(A,C),p351(C,B).
b334(A,B):-p613(A,C),b334_1(C,B).
b334_1(A,B):-p1789(A,C),p30(C,B).
b356(A,B):-move_left(A,C),p1550(C,B).
b349(A,B):-p1208(A,C),b349_1(C,B).
b349_1(A,B):-p1603(A,C),p1749(C,B).
b358(A,B):-p1208(A,C),p442(C,B).
b346(A,B):-p402(A,C),b346_1(C,B).
b346_1(A,B):-p1510(A,C),p1100(C,B).
b359(A,B):-move_left(A,C),b359_1(C,B).
b359_1(A,B):-p1601(A,C),p1189(C,B).
b340(A,B):-p428(A,C),b340_1(C,B).
b340_1(A,B):-p1416(A,C),move_left(C,B).
...
b378_1(A,B):-p1570(A,C),p22(C,B).
b380(A,B):-move_left(A,C),b380_1(C,B).
b380_1(A,B):-p1460(A,C),p1919(C,B).
b384(A,B):-p1208(A,C),p630(C,B).
b383(A,B):-move_left(A,C),b383_1(C,B).
b383_1(A,B):-p264(A,C),p1943(C,B).
b385(A,B):-move_left(A,C),b385_1(C,B).
b385_1(A,B):-p568(A,C),p788(C,B).
b386(A,B):-p1208(A,C),b386_1(C,B).
b386_1(A,B):-p503(A,C),p626(C,B).
b355(A,B):-p111(A,C),b355_1(C,B).
b355_1(A,B):-p1652(A,C),p1544(C,B).
b390(A,B):-p1665(A,C),p47(C,B).
b381(A,B):-p563(A,C),b381_1(C,B).
b381_1(A,B):-p582(A,C),p1399(C,B).
b388(A,B):-move_right(A,C),b388_1(C,B).
b388_1(A,B):-p442(A,C),p930(C,B).
b391(A,B):-p804(A,C),p882(C,B).
b392(A,B):-p351(A,C),p1068(C,B).
b393(A,B):-p465(A,C),p1797(C,B).
b396(A,B):-move_forwards(A,C),p1211(C,B).
b394(A,B):-p106(A,C),p310(C,B).
b372(A,B):-p1391(A,C),b372_1(C,B).
b372_1(A,B):-p1530(A,C),p1871(C,B).
b389(A,B):-p1949(A,C),b389_1(C,B).
b389_1(A,B):-p17(A,C),p1956(C,B).
b397(A,B):-p1483(A,C),b397_1(C,B).
b397_1(A,B):-p223(A,C),p1093(C,B).
b400(A,B):-move_backwards(A,C),b400_1(C,B).
b400_1(A,B):-p972(A,C),p1100(C,B).
b401(A,B):-p882(A,C),p264(C,B).
b395(A,B):-p1714(A,C),b395_1(C,B).
b395_1(A,B):-p465(A,C),p663(C,B).
b387(A,B):-p69(A,C),b387_1(C,B).
b387_1(A,B):-p617(A,C),p1135(C,B).
b405(A,B):-p1391(A,C),p104(C,B).
b406(A,B):-p74(A,C),p1439(C,B).
b407(A,B):-p276(A,C),p630(C,B).
b399(A,B):-p30(A,C),b399_1(C,B).
b399_1(A,B):-p499(A,C),p1445(C,B).
b404(A,B):-move_forwards(A,C),b404_1(C,B).
b404_1(A,B):-p1252(A,C),p402(C,B).
b410(A,B):-move_forwards(A,C),p1253(C,B).
b409(A,B):-p1576(A,C),p696(C,B).
b403(A,B):-p1483(A,C),b403_1(C,B).
b403_1(A,B):-p236(A,C),p1576(C,B).
b411(A,B):-move_left(A,C),b411_1(C,B).
b411_1(A,B):-p30(A,C),p441(C,B).
b414(A,B):-p755(A,C),p1198(C,B).
b413(A,B):-p326(A,C),p651(C,B).
b416(A,B):-p692(A,C),p1175(C,B).
b382(A,B):-p1460(A,C),b382_1(C,B).
b382_1(A,B):-p131(A,C),p1574(C,B).
b418(A,B):-p1100(A,C),p795(C,B).
b419(A,B):-p1093(A,B).
b420(A,B):-p1067(A,C),p1572(C,B).
b412(A,B):-move_backwards(A,C),b412_1(C,B).
b412_1(A,B):-p929(A,C),p1463(C,B).
b417(A,B):-move_left(A,C),b417_1(C,B).
b417_1(A,B):-p1399(A,C),p1025(C,B).
b422(A,B):-move_left(A,C),b422_1(C,B).
b422_1(A,B):-p22(A,C),p828(C,B).
b421(A,B):-move_left(A,C),b421_1(C,B).
b421_1(A,B):-p145(A,C),p835(C,B).
b408(A,B):-p1576(A,C),b408_1(C,B).
b408_1(A,B):-p1695(A,C),p1264(C,B).
b426(A,B):-p1237(A,C),p330(C,B).
b427(A,B):-move_left(A,C),p1227(C,B).
b402(A,B):-p1100(A,C),b402_1(C,B).
b402_1(A,B):-p806(A,C),p30(C,B).
b415(A,B):-p563(A,C),b415_1(C,B).
b415_1(A,B):-p407(A,C),move_backwards(C,B).
b428(A,B):-move_forwards(A,C),b428_1(C,B).
b428_1(A,B):-p1726(A,C),p1208(C,B).
b431(A,B):-move_left(A,C),p22(C,B).
b430(A,B):-move_left(A,C),b430_1(C,B).
b430_1(A,B):-p32(A,C),p1172(C,B).
b433(A,B):-p1578(A,C),p633(C,B).
b434(A,B):-p1316(A,C),p1208(C,B).
b424(A,B):-p563(A,C),b424_1(C,B).
b424_1(A,B):-p1858(A,C),p1499(C,B).
b425(A,B):-p1876(A,C),b425_1(C,B).
b425_1(A,B):-p227(A,C),p1520(C,B).
b423(A,B):-p580(A,C),b423_1(C,B).
b423_1(A,B):-p1252(A,C),p477(C,B).
b429(A,B):-p563(A,C),b429_1(C,B).
b429_1(A,B):-p1584(A,C),p1483(C,B).
b435(A,B):-p1208(A,C),b435_1(C,B).
b435_1(A,B):-p102(A,C),p1982(C,B).
b437(A,B):-move_right(A,C),b437_1(C,B).
b437_1(A,B):-p1570(A,C),p692(C,B).
b439(A,B):-move_backwards(A,C),b439_1(C,B).
b439_1(A,B):-p1143(A,C),move_backwards(C,B).
b432(A,B):-p310(A,C),b432_1(C,B).
b432_1(A,B):-p158(A,C),p370(C,B).
b443(A,B):-move_left(A,C),b443_1(C,B).
b443_1(A,B):-p1576(A,C),p1051(C,B).
b438(A,B):-p227(A,C),b438_1(C,B).
b438_1(A,B):-p772(A,C),move_left(C,B).
b440(A,B):-p1208(A,C),b440_1(C,B).
b440_1(A,B):-p413(A,C),p534(C,B).
b441(A,B):-p1665(A,C),b441_1(C,B).
b441_1(A,B):-p687(A,C),p883(C,B).
b446(A,B):-move_backwards(A,C),b446_1(C,B).
b446_1(A,B):-p1863(A,C),p1291(C,B).
b448(A,B):-move_right(A,C),p978(C,B).
b449(A,B):-p456(A,C),p503(C,B).
b445(A,B):-p1576(A,C),b445_1(C,B).
b445_1(A,B):-p614(A,C),p1871(C,B).
b450(A,B):-move_forwards(A,C),b450_1(C,B).
b450_1(A,B):-p1520(A,C),p651(C,B).
b452(A,B):-move_left(A,C),p377(C,B).
b447(A,B):-p465(A,C),b447_1(C,B).
b447_1(A,B):-p492(A,C),p1159(C,B).
b453(A,B):-p104(A,C),p692(C,B).
b250(A,B):-move_right(A,C),b250_1(C,B).
b250_1(A,B):-p926(A,C),b250_2(C,B).
b250_2(A,B):-p1464(A,C),p882(C,B).
b456(A,B):-p783(A,C),p882(C,B).
b457(A,B):-p1654(A,C),move_backwards(C,B).
b454(A,B):-p1665(A,C),b454_1(C,B).
b454_1(A,B):-p590(A,C),p959(C,B).
b455(A,B):-p1665(A,C),b455_1(C,B).
b455_1(A,B):-p1607(A,C),p1483(C,B).
b460(A,B):-p1120(A,C),p55(C,B).
b461(A,B):-p1371(A,C),move_forwards(C,B).
b462(A,B):-move_backwards(A,B).
b458(A,B):-p367(A,C),b458_1(C,B).
b458_1(A,B):-p145(A,C),p1745(C,B).
b464(A,B):-move_forwards(A,C),p1938(C,B).
b463(A,B):-p1966(A,C),p1264(C,B).
b465(A,B):-move_left(A,C),b465_1(C,B).
b465_1(A,B):-p1211(A,C),p443(C,B).
b451(A,B):-p1665(A,C),b451_1(C,B).
b451_1(A,B):-p610(A,C),p1665(C,B).
b468(A,B):-p957(A,C),p657(C,B).
b469(A,B):-p882(A,C),p1055(C,B).
b459(A,B):-p1576(A,C),b459_1(C,B).
b459_1(A,B):-p1025(A,C),p1141(C,B).
b470(A,B):-p367(A,C),b470_1(C,B).
b470_1(A,B):-p428(A,C),p1208(C,B).
b471(A,B):-move_left(A,C),b471_1(C,B).
b471_1(A,B):-p916(A,C),move_forwards(C,B).
b473(A,B):-p735(A,C),p1176(C,B).
b474(A,B):-p980(A,C),p17(C,B).
b475(A,B):-p613(A,C),p1143(C,B).
b476(A,B):-move_right(A,C),b476_1(C,B).
b476_1(A,B):-p1162(A,C),p1483(C,B).
b472(A,B):-p367(A,C),b472_1(C,B).
b472_1(A,B):-p1228(A,C),p1576(C,B).
...
b481_1(A,B):-p1336(A,C),p1093(C,B).
b482(A,B):-p210(A,C),move_left(C,B).
b483(A,B):-move_right(A,C),b483_1(C,B).
b483_1(A,B):-p830(A,C),move_left(C,B).
b290(A,B):-move_right(A,C),b290_1(C,B).
b290_1(A,B):-p1388(A,C),b290_2(C,B).
b290_2(A,B):-p1279(A,C),p563(C,B).
b477(A,B):-p1576(A,C),b477_1(C,B).
b477_1(A,B):-p910(A,C),p30(C,B).
b486(A,B):-p984(A,C),p1576(C,B).
b484(A,B):-p30(A,C),b484_1(C,B).
b484_1(A,B):-p610(A,C),p30(C,B).
b487(A,B):-move_right(A,C),b487_1(C,B).
b487_1(A,B):-p749(A,C),p1057(C,B).
b489(A,B):-move_left(A,C),b489_1(C,B).
b489_1(A,B):-p633(A,C),p1120(C,B).
b490(A,B):-move_left(A,C),b490_1(C,B).
b490_1(A,B):-p524(A,C),p367(C,B).
b491(A,B):-move_right(A,C),p23(C,B).
b485(A,B):-p580(A,C),b485_1(C,B).
b485_1(A,B):-p1628(A,C),p692(C,B).
b488(A,B):-p546(A,C),b488_1(C,B).
b488_1(A,B):-p830(A,C),move_backwards(C,B).
b235(A,B):-p367(A,C),b235_1(C,B).
b235_1(A,B):-p1228(A,C),b235_2(C,B).
b235_2(A,B):-p788(A,C),move_right(C,B).
b495(A,B):-p466(A,C),p882(C,B).
b493(A,B):-p1665(A,C),b493_1(C,B).
b493_1(A,B):-p807(A,C),p465(C,B).
b214(A,B):-p1714(A,C),b214_1(C,B).
b214_1(A,B):-p1483(A,C),b214_2(C,B).
b214_2(A,B):-p648(A,C),p1208(C,B).
b497(A,B):-move_left(A,C),b497_1(C,B).
b497_1(A,B):-p599(A,C),p135(C,B).
b498(A,B):-move_left(A,C),b498_1(C,B).
b498_1(A,B):-p696(A,C),p1483(C,B).
b500(A,B):-move_left(A,C),p43(C,B).
b494(A,B):-p367(A,C),b494_1(C,B).
b494_1(A,B):-p1816(A,C),p651(C,B).
b442(A,B):-move_left(A,C),b442_1(C,B).
b442_1(A,B):-p1766(A,C),b442_2(C,B).
b442_2(A,B):-p503(A,C),p945(C,B).
b467(A,B):-move_left(A,C),b467_1(C,B).
b467_1(A,B):-p1576(A,C),b467_2(C,B).
b467_2(A,B):-p1789(A,C),move_left(C,B).
b502(A,B):-move_left(A,C),b502_1(C,B).
b502_1(A,B):-p1544(A,C),p1624(C,B).
b492(A,B):-p1399(A,C),b492_1(C,B).
b492_1(A,B):-p1722(A,C),p30(C,B).
b506(A,B):-move_left(A,C),p1652(C,B).
b501(A,B):-move_right(A,C),b501_1(C,B).
b501_1(A,B):-p1486(A,C),p1949(C,B).
b504(A,B):-move_forwards(A,C),b504_1(C,B).
b504_1(A,B):-p323(A,C),p651(C,B).
b503(A,B):-move_right(A,C),b503_1(C,B).
b503_1(A,B):-p156(A,C),move_forwards(C,B).
b496(A,B):-p69(A,C),b496_1(C,B).
b496_1(A,B):-p873(A,C),p402(C,B).
b511(A,B):-move_backwards(A,C),p292(C,B).
b512(A,B):-p1399(A,B).
...
b516_1(A,B):-p30(A,C),p939(C,B).
b515(A,B):-move_forwards(A,C),b515_1(C,B).
b515_1(A,B):-p1003(A,C),move_backwards(C,B).
b507(A,B):-p1665(A,C),b507_1(C,B).
b507_1(A,B):-p1489(A,C),p67(C,B).
b518(A,B):-p420(A,C),p563(C,B).
b510(A,B):-p30(A,C),b510_1(C,B).
b510_1(A,B):-p770(A,C),p1093(C,B).
b499(A,B):-p402(A,C),b499_1(C,B).
b499_1(A,B):-p477(A,C),p1576(C,B).
b505(A,B):-p402(A,C),b505_1(C,B).
b505_1(A,B):-p988(A,C),p580(C,B).
b523(A,B):-p1544(A,C),p1290(C,B).
b521(A,B):-move_left(A,C),b521_1(C,B).
b521_1(A,B):-p783(A,C),p1480(C,B).
b524(A,B):-p1713(A,C),p1517(C,B).
b526(A,B):-p613(A,C),p1913(C,B).
b527(A,B):-p1100(A,C),drop_ball(C,B).
b520(A,B):-p30(A,C),b520_1(C,B).
b520_1(A,B):-p1050(A,C),move_right(C,B).
b517(A,B):-p1576(A,C),b517_1(C,B).
b517_1(A,B):-p32(A,C),p1970(C,B).
b530(A,B):-move_right(A,C),b530_1(C,B).
b530_1(A,B):-p577(A,C),p69(C,B).
b528(A,B):-p1208(A,C),b528_1(C,B).
b528_1(A,B):-p562(A,C),p235(C,B).
b531(A,B):-p1426(A,C),p1483(C,B).
b508(A,B):-p207(A,C),b508_1(C,B).
b508_1(A,B):-p582(A,C),move_forwards(C,B).
b534(A,B):-p1208(A,C),p695(C,B).
b535(A,B):-p1907(A,C),p367(C,B).
b525(A,B):-p1576(A,C),b525_1(C,B).
b525_1(A,B):-p1129(A,C),p1093(C,B).
b532(A,B):-p1665(A,C),b532_1(C,B).
b532_1(A,B):-p1439(A,C),p1546(C,B).
b538(A,B):-p1576(A,C),p284(C,B).
b539(A,B):-p1439(A,C),p1947(C,B).
b522(A,B):-p1100(A,C),b522_1(C,B).
b522_1(A,B):-p610(A,C),p1665(C,B).
b536(A,B):-p1665(A,C),b536_1(C,B).
b536_1(A,B):-p1080(A,C),p1137(C,B).
b542(A,B):-p1108(A,C),p1423(C,B).
b543(A,B):-move_left(A,C),b543_1(C,B).
b543_1(A,B):-p245(A,C),p276(C,B).
b544(A,B):-move_forwards(A,C),p1460(C,B).
b545(A,B):-p558(A,C),p828(C,B).
b519(A,B):-p1611(A,C),b519_1(C,B).
b519_1(A,B):-drop_ball(A,C),p367(C,B).
b540(A,B):-p310(A,C),b540_1(C,B).
b540_1(A,B):-p1700(A,C),p7(C,B).
b529(A,B):-p131(A,C),b529_1(C,B).
b529_1(A,B):-p1057(A,C),p1100(C,B).
b541(A,B):-p563(A,C),b541_1(C,B).
b541_1(A,B):-p1960(A,C),p1088(C,B).
b549(A,B):-move_forwards(A,C),b549_1(C,B).
b549_1(A,B):-p67(A,C),p1578(C,B).
b550(A,B):-move_forwards(A,C),b550_1(C,B).
b550_1(A,B):-p1756(A,C),p69(C,B).
b546(A,B):-p1208(A,C),b546_1(C,B).
b546_1(A,B):-p1579(A,C),p1919(C,B).
b547(A,B):-p1576(A,C),b547_1(C,B).
b547_1(A,B):-p870(A,C),move_backwards(C,B).
b554(A,B):-move_forwards(A,C),b554_1(C,B).
b554_1(A,B):-p747(A,C),p1208(C,B).
b555(A,B):-move_backwards(A,C),p1439(C,B).
b553(A,B):-p367(A,C),b553_1(C,B).
b553_1(A,B):-p615(A,C),p1108(C,B).
b557(A,B):-p276(A,C),p1629(C,B).
b548(A,B):-p503(A,C),b548_1(C,B).
b548_1(A,B):-p1480(A,C),p1039(C,B).
b559(A,B):-p894(A,C),move_backwards(C,B).
b558(A,B):-move_left(A,C),b558_1(C,B).
b558_1(A,B):-p190(A,C),p1871(C,B).
b560(A,B):-move_backwards(A,C),b560_1(C,B).
b560_1(A,B):-p1464(A,C),p328(C,B).
b258(A,B):-move_forwards(A,C),b258_1(C,B).
b258_1(A,B):-p330(A,C),b258_2(C,B).
b258_2(A,B):-p46(A,C),p1713(C,B).
b537(A,B):-p532(A,C),b537_1(C,B).
b537_1(A,B):-p85(A,C),move_left(C,B).
b564(A,B):-move_forwards(A,C),p1232(C,B).
b563(A,B):-p1466(A,C),p897(C,B).
b556(A,B):-p1208(A,C),b556_1(C,B).
b556_1(A,B):-p1025(A,C),p1713(C,B).
b567(A,B):-p69(A,C),p1098(C,B).
b568(A,B):-move_left(A,C),p30(C,B).
b566(A,B):-p1905(A,C),p503(C,B).
...
b572(A,B):-p1189(A,C),p1120(C,B).
b569(A,B):-move_right(A,C),b569_1(C,B).
b569_1(A,B):-p236(A,C),p1665(C,B).
b574(A,B):-move_left(A,C),p428(C,B).
b561(A,B):-p30(A,C),b561_1(C,B).
b561_1(A,B):-p49(A,C),p1483(C,B).
b571(A,B):-move_left(A,C),b571_1(C,B).
b571_1(A,B):-p363(A,C),p402(C,B).
...
b551(A,B):-p370(A,C),b551_1(C,B).
b551_1(A,B):-p580(A,C),p344(C,B).
b575(A,B):-p367(A,C),b575_1(C,B).
b575_1(A,B):-p466(A,C),p1576(C,B).
...
b577(A,B):-p1714(A,C),b577_1(C,B).
b577_1(A,B):-p850(A,C),p30(C,B).
b581(A,B):-p1483(A,C),b581_1(C,B).
b581_1(A,B):-p828(A,C),move_backwards(C,B).
b582(A,B):-p1483(A,C),b582_1(C,B).
b582_1(A,B):-p60(A,C),p1445(C,B).
b589(A,B):-p630(A,C),p1759(C,B).
b199(A,B):-p30(A,C),b199_1(C,B).
b199_1(A,B):-p1584(A,C),b199_2(C,B).
b199_2(A,B):-p418(A,C),p1108(C,B).
b594(A,B):-p1100(A,B).
b593(A,B):-p1227(A,C),move_right(C,B).
b595(A,B):-p976(A,C),p1277(C,B).
b573(A,B):-p1665(A,C),b573_1(C,B).
b573_1(A,B):-p354(A,C),p956(C,B).
b590(A,B):-move_left(A,C),b590_1(C,B).
b590_1(A,B):-grab_ball(A,C),p367(C,B).
b597(A,B):-p1265(A,C),p613(C,B).
b598(A,B):-p405(A,C),p465(C,B).
b599(A,B):-p1544(A,C),p1460(C,B).
b295(A,B):-move_right(A,C),b295_1(C,B).
b295_1(A,B):-p1707(A,C),b295_2(C,B).
b295_2(A,B):-p31(A,C),p1665(C,B).
b592(A,B):-p30(A,C),b592_1(C,B).
b592_1(A,B):-p684(A,C),p976(C,B).
b603(A,B):-p509(A,C),p1940(C,B).
b602(A,B):-move_forwards(A,C),b602_1(C,B).
b602_1(A,B):-p602(A,C),p613(C,B).
b605(A,B):-move_left(A,C),b605_1(C,B).
b605_1(A,B):-p540(A,C),p7(C,B).
b591(A,B):-p1576(A,C),b591_1(C,B).
b591_1(A,B):-p1162(A,C),p1208(C,B).
b608(A,B):-p1093(A,B).
b444(A,B):-move_left(A,C),b444_1(C,B).
b444_1(A,B):-p30(A,C),b444_2(C,B).
b444_2(A,B):-p27(A,C),move_right(C,B).
b607(A,B):-p1960(A,C),p1177(C,B).
b609(A,B):-move_left(A,C),b609_1(C,B).
b609_1(A,B):-p1627(A,C),p74(C,B).
b604(A,B):-p465(A,C),b604_1(C,B).
b604_1(A,B):-p1723(A,C),p770(C,B).
b610(A,B):-move_right(A,C),b610_1(C,B).
b610_1(A,B):-p1714(A,C),p850(C,B).
b614(A,B):-p613(A,C),p1242(C,B).
b615(A,B):-p408(A,C),p1330(C,B).
b616(A,B):-p1067(A,C),p679(C,B).
b612(A,B):-p30(A,C),b612_1(C,B).
b612_1(A,B):-p227(A,C),p1037(C,B).
...
b606(A,B):-p1391(A,C),b606_1(C,B).
b606_1(A,B):-p1829(A,C),p1576(C,B).
b398(A,B):-move_right(A,C),b398_1(C,B).
b398_1(A,B):-p1003(A,C),b398_2(C,B).
b398_2(A,B):-p524(A,C),p580(C,B).
b624(A,B):-move_backwards(A,C),b624_1(C,B).
b624_1(A,B):-p477(A,C),p1665(C,B).
b533(A,B):-move_left(A,C),b533_1(C,B).
b533_1(A,B):-p692(A,C),b533_2(C,B).
b533_2(A,B):-p60(A,C),p1100(C,B).
b620(A,B):-p7(A,C),b620_1(C,B).
b620_1(A,B):-p1003(A,C),p1100(C,B).
b625(A,B):-p1067(A,C),b625_1(C,B).
b625_1(A,B):-p27(A,C),move_right(C,B).
b629(A,B):-move_backwards(A,C),b629_1(C,B).
b629_1(A,B):-p1141(A,C),p517(C,B).
b626(A,B):-p1138(A,C),b626_1(C,B).
b626_1(A,B):-p23(A,C),p257(C,B).
b632(A,B):-p1208(A,B).
b630(A,B):-move_left(A,C),b630_1(C,B).
b630_1(A,B):-p787(A,C),move_forwards(C,B).
b634(A,B):-p310(A,C),p623(C,B).
b631(A,B):-move_right(A,C),b631_1(C,B).
b631_1(A,B):-p378(A,C),p650(C,B).
b622(A,B):-p1137(A,C),b622_1(C,B).
b622_1(A,B):-p1039(A,C),p1100(C,B).
b633(A,B):-move_left(A,C),b633_1(C,B).
b633_1(A,B):-p369(A,C),p22(C,B).
b638(A,B):-p312(A,B).
b639(A,B):-p1949(A,C),p323(C,B).
b636(A,B):-move_left(A,C),b636_1(C,B).
b636_1(A,B):-p1714(A,C),p1411(C,B).
b641(A,B):-p1208(A,C),p63(C,B).
b611(A,B):-p632(A,C),b611_1(C,B).
b611_1(A,B):-p692(A,C),p930(C,B).
b640(A,B):-p1546(A,C),move_left(C,B).
b643(A,B):-p1123(A,C),p353(C,B).
b644(A,B):-p1037(A,C),move_right(C,B).
b637(A,B):-move_right(A,C),b637_1(C,B).
b637_1(A,B):-p1946(A,C),p1208(C,B).
b647(A,B):-p227(A,C),p135(C,B).
b648(A,B):-p852(A,C),p402(C,B).
b635(A,B):-move_forwards(A,C),b635_1(C,B).
b635_1(A,B):-p1330(A,C),p738(C,B).
b642(A,B):-move_forwards(A,C),b642_1(C,B).
b642_1(A,B):-p1025(A,C),p1713(C,B).
b649(A,B):-move_left(A,C),b649_1(C,B).
b649_1(A,B):-p550(A,C),move_backwards(C,B).
b646(A,B):-p367(A,C),b646_1(C,B).
b646_1(A,B):-p568(A,C),p402(C,B).
b651(A,B):-move_right(A,C),b651_1(C,B).
b651_1(A,B):-p1323(A,C),p1007(C,B).
b653(A,B):-p203(A,C),p1713(C,B).
b628(A,B):-p882(A,C),b628_1(C,B).
b628_1(A,B):-p1039(A,C),move_backwards(C,B).
b645(A,B):-p1714(A,C),b645_1(C,B).
b645_1(A,B):-p1871(A,C),p289(C,B).
b652(A,B):-move_forwards(A,C),b652_1(C,B).
b652_1(A,B):-p427(A,C),p1576(C,B).
b654(A,B):-move_left(A,C),b654_1(C,B).
b654_1(A,B):-p417(A,C),p1399(C,B).
...
b658_1(A,B):-p16(A,C),p882(C,B).
b659(A,B):-move_forwards(A,C),b659_1(C,B).
b659_1(A,B):-p1920(A,C),p465(C,B).
b663(A,B):-move_left(A,C),p328(C,B).
b655(A,B):-p30(A,C),b655_1(C,B).
b655_1(A,B):-p1789(A,C),p1576(C,B).
b664(A,B):-p972(A,C),p1480(C,B).
b666(A,B):-p1576(A,C),p1048(C,B).
b667(A,B):-move_left(A,B).
b661(A,B):-move_left(A,C),b661_1(C,B).
b661_1(A,B):-p29(A,C),p1935(C,B).
b665(A,B):-move_right(A,C),b665_1(C,B).
b665_1(A,B):-p1478(A,C),p1093(C,B).
b668(A,B):-move_left(A,C),b668_1(C,B).
b668_1(A,B):-p1989(A,C),p651(C,B).
b669(A,B):-p1483(A,C),b669_1(C,B).
b669_1(A,B):-p1581(A,C),p1670(C,B).
b656(A,B):-p1120(A,C),b656_1(C,B).
b656_1(A,B):-p884(A,C),p1399(C,B).
b671(A,B):-p563(A,C),b671_1(C,B).
b671_1(A,B):-p94(A,C),p122(C,B).
b673(A,B):-move_left(A,C),b673_1(C,B).
b673_1(A,B):-p548(A,C),p1853(C,B).
b670(A,B):-p1291(A,C),b670_1(C,B).
b670_1(A,B):-p1455(A,C),p1224(C,B).
b650(A,B):-p248(A,C),b650_1(C,B).
b650_1(A,B):-p1123(A,C),p276(C,B).
b677(A,B):-p830(A,C),p1264(C,B).
b678(A,B):-move_right(A,C),p1860(C,B).
b679(A,B):-p402(A,C),p509(C,B).
b674(A,B):-p1576(A,C),b674_1(C,B).
b674_1(A,B):-p1940(A,C),p827(C,B).
b680(A,B):-p615(A,C),p1483(C,B).
b672(A,B):-p7(A,C),b672_1(C,B).
b672_1(A,B):-p32(A,C),p1172(C,B).
b683(A,B):-move_left(A,C),b683_1(C,B).
b683_1(A,B):-p921(A,C),p612(C,B).
b684(A,B):-p1369(A,C),p45(C,B).
b685(A,B):-p503(A,C),p789(C,B).
b686(A,B):-p1108(A,B).
b682(A,B):-p30(A,C),b682_1(C,B).
b682_1(A,B):-p666(A,C),p1483(C,B).
b688(A,B):-p1216(A,C),move_left(C,B).
b689(A,B):-p744(A,C),p1330(C,B).
b676(A,B):-p1120(A,C),b676_1(C,B).
b676_1(A,B):-p830(A,C),p465(C,B).
b681(A,B):-p1399(A,C),b681_1(C,B).
b681_1(A,B):-p1943(A,C),p367(C,B).
b692(A,B):-move_left(A,C),b692_1(C,B).
b692_1(A,B):-p665(A,C),move_backwards(C,B).
b690(A,B):-p60(A,C),b690_1(C,B).
b690_1(A,B):-p69(A,C),p1049(C,B).
b691(A,B):-p69(A,C),b691_1(C,B).
b691_1(A,B):-p1408(A,C),p1399(C,B).
b695(A,B):-move_forwards(A,C),b695_1(C,B).
b695_1(A,B):-p502(A,C),move_left(C,B).
b696(A,B):-p30(A,C),b696_1(C,B).
b696_1(A,B):-p1489(A,C),p67(C,B).
b697(A,B):-p885(A,C),p310(C,B).
b694(A,B):-p7(A,C),b694_1(C,B).
b694_1(A,B):-p1865(A,C),p698(C,B).
b699(A,B):-p530(A,C),p1093(C,B).
b698(A,B):-move_left(A,C),b698_1(C,B).
b698_1(A,B):-p7(A,C),p1734(C,B).
b701(A,B):-p1544(A,C),p1851(C,B).
b700(A,B):-p1576(A,C),b700_1(C,B).
b700_1(A,B):-p1022(A,C),p936(C,B).
b552(A,B):-move_right(A,C),b552_1(C,B).
b552_1(A,B):-p783(A,C),b552_2(C,B).
b552_2(A,B):-p1931(A,C),p770(C,B).
b704(A,B):-p603(A,C),p1228(C,B).
b702(A,B):-p1208(A,C),b702_1(C,B).
b702_1(A,B):-p546(A,C),p1418(C,B).
b706(A,B):-p1201(A,C),p1137(C,B).
b466(A,B):-p367(A,C),b466_1(C,B).
b466_1(A,B):-p462(A,C),b466_2(C,B).
b466_2(A,B):-p69(A,C),drop_ball(C,B).
b708(A,B):-p1576(A,C),p95(C,B).
b600(A,B):-move_left(A,C),b600_1(C,B).
b600_1(A,B):-p370(A,C),b600_2(C,B).
b600_2(A,B):-p1883(A,C),p1248(C,B).
b703(A,B):-p1550(A,C),b703_1(C,B).
b703_1(A,B):-p517(A,C),p1983(C,B).
b584(A,B):-move_left(A,C),b584_1(C,B).
b584_1(A,B):-p41(A,C),b584_2(C,B).
b584_2(A,B):-p610(A,C),p580(C,B).
b705(A,B):-p576(A,C),b705_1(C,B).
b705_1(A,B):-p1871(A,C),p1510(C,B).
...
b715_1(A,B):-p346(A,C),p1208(C,B).
b709(A,B):-p671(A,C),b709_1(C,B).
b709_1(A,B):-p153(A,C),move_backwards(C,B).
b717(A,B):-p912(A,B).
b718(A,B):-p95(A,C),p1483(C,B).
b710(A,B):-p1237(A,C),b710_1(C,B).
b710_1(A,B):-p582(A,C),p1399(C,B).
...
b722_1(A,B):-p8(A,C),p402(C,B).
b723(A,B):-p1075(A,C),p563(C,B).
b716(A,B):-p1483(A,C),b716_1(C,B).
b716_1(A,B):-p350(A,C),p69(C,B).
b712(A,B):-p7(A,C),b712_1(C,B).
b712_1(A,B):-p853(A,C),p310(C,B).
b725(A,B):-move_backwards(A,C),b725_1(C,B).
b725_1(A,B):-p207(A,C),p1445(C,B).
b728(A,B):-p359(A,C),p1871(C,B).
b726(A,B):-move_left(A,C),b726_1(C,B).
b726_1(A,B):-p227(A,C),p1460(C,B).
b729(A,B):-p346(A,C),p1483(C,B).
b731(A,B):-p1049(A,C),p63(C,B).
b719(A,B):-p310(A,C),b719_1(C,B).
b719_1(A,B):-p1759(A,C),p1513(C,B).
b733(A,B):-p1871(A,B).
b596(A,B):-move_left(A,C),b596_1(C,B).
b596_1(A,B):-p1323(A,C),b596_2(C,B).
b596_2(A,B):-p698(A,C),p1703(C,B).
b727(A,B):-p1208(A,C),b727_1(C,B).
b727_1(A,B):-p726(A,C),p580(C,B).
b736(A,B):-move_right(A,C),b736_1(C,B).
b736_1(A,B):-p418(A,C),p1093(C,B).
b734(A,B):-move_backwards(A,C),b734_1(C,B).
b734_1(A,B):-p1402(A,C),p1665(C,B).
b732(A,B):-p563(A,C),b732_1(C,B).
b732_1(A,B):-p687(A,C),p1093(C,B).
b739(A,B):-move_right(A,C),p1141(C,B).
b740(A,B):-p1483(A,C),p1227(C,B).
b741(A,B):-p30(A,C),p343(C,B).
b742(A,B):-p367(A,B).
b743(A,B):-p835(A,C),p558(C,B).
b744(A,B):-p367(A,C),p829(C,B).
b735(A,B):-p692(A,C),b735_1(C,B).
b735_1(A,B):-p1848(A,C),move_right(C,B).
b627(A,B):-move_right(A,C),b627_1(C,B).
b627_1(A,B):-p1876(A,C),b627_2(C,B).
b627_2(A,B):-p870(A,C),p276(C,B).
b746(A,B):-p1517(A,C),p1399(C,B).
b687(A,B):-move_left(A,C),b687_1(C,B).
b687_1(A,B):-p22(A,C),b687_2(C,B).
b687_2(A,B):-p1789(A,C),p1665(C,B).
...
b737(A,B):-p1483(A,C),b737_1(C,B).
b737_1(A,B):-p1695(A,C),p1388(C,B).
b756(A,B):-p718(A,C),p1665(C,B).
b748(A,B):-p69(A,C),b748_1(C,B).
b748_1(A,B):-p1865(A,C),p1576(C,B).
b758(A,B):-p1463(A,C),p276(C,B).
b759(A,B):-p1222(A,C),p1825(C,B).
b751(A,B):-p367(A,C),b751_1(C,B).
b751_1(A,B):-p1603(A,C),p1439(C,B).
b757(A,B):-move_right(A,C),b757_1(C,B).
b757_1(A,B):-p1685(A,C),p452(C,B).
b730(A,B):-p732(A,C),b730_1(C,B).
b730_1(A,B):-p209(A,C),p1483(C,B).
b761(A,B):-move_left(A,C),b761_1(C,B).
b761_1(A,B):-p145(A,C),p6(C,B).
b764(A,B):-p1455(A,C),p1544(C,B).
b766(A,B):-p1208(A,C),p41(C,B).
b765(A,B):-p490(A,C),p1713(C,B).
b768(A,B):-p1399(A,C),p897(C,B).
b753(A,B):-p563(A,C),b753_1(C,B).
b753_1(A,B):-p1677(A,C),p507(C,B).
b770(A,B):-move_right(A,C),b770_1(C,B).
b770_1(A,B):-p783(A,C),p563(C,B).
b763(A,B):-p1871(A,C),b763_1(C,B).
b763_1(A,B):-p805(A,C),p1702(C,B).
b771(A,B):-move_left(A,C),b771_1(C,B).
b771_1(A,B):-p1739(A,C),p1871(C,B).
b767(A,B):-p367(A,C),b767_1(C,B).
b767_1(A,B):-p264(A,C),p1751(C,B).
b754(A,B):-p69(A,C),b754_1(C,B).
b754_1(A,B):-p127(A,C),move_forwards(C,B).
b773(A,B):-move_left(A,C),b773_1(C,B).
b773_1(A,B):-p1352(A,C),p959(C,B).
b776(A,B):-p1211(A,C),p912(C,B).
b760(A,B):-p22(A,C),b760_1(C,B).
b760_1(A,B):-p427(A,C),p884(C,B).
b762(A,B):-p1544(A,C),b762_1(C,B).
b762_1(A,B):-p1489(A,C),p1391(C,B).
b778(A,B):-move_left(A,C),b778_1(C,B).
b778_1(A,B):-p1756(A,C),p465(C,B).
b777(A,B):-move_right(A,C),b777_1(C,B).
b777_1(A,B):-p1645(A,C),p703(C,B).
b780(A,B):-move_backwards(A,C),b780_1(C,B).
b780_1(A,B):-p1579(A,C),p1093(C,B).
b782(A,B):-move_forwards(A,C),p1134(C,B).
b769(A,B):-p1100(A,C),b769_1(C,B).
b769_1(A,B):-p806(A,C),p1665(C,B).
b784(A,B):-p1654(A,C),p1703(C,B).
b755(A,B):-p632(A,C),b755_1(C,B).
b755_1(A,B):-p794(A,C),p722(C,B).
b786(A,B):-move_left(A,C),b786_1(C,B).
b786_1(A,B):-p55(A,C),p1033(C,B).
b787(A,B):-p85(A,C),p1137(C,B).
b785(A,B):-move_forwards(A,C),b785_1(C,B).
b785_1(A,B):-p405(A,C),move_forwards(C,B).
b788(A,B):-move_left(A,C),b788_1(C,B).
b788_1(A,B):-p1457(A,C),p882(C,B).
b790(A,B):-move_left(A,C),p22(C,B).
b774(A,B):-p1399(A,C),b774_1(C,B).
b774_1(A,B):-p418(A,C),p1665(C,B).
b779(A,B):-p1544(A,C),b779_1(C,B).
b779_1(A,B):-p1235(A,C),p882(C,B).
b789(A,B):-p367(A,C),b789_1(C,B).
b789_1(A,B):-p1194(A,C),p1416(C,B).
b794(A,B):-move_left(A,C),p1641(C,B).
b783(A,B):-p310(A,C),b783_1(C,B).
b783_1(A,B):-p212(A,C),p1665(C,B).
b707(A,B):-move_left(A,C),b707_1(C,B).
b707_1(A,B):-p7(A,C),b707_2(C,B).
b707_2(A,B):-p1828(A,C),p402(C,B).
b797(A,B):-p1211(A,C),p912(C,B).
b791(A,B):-p1208(A,C),b791_1(C,B).
b791_1(A,B):-p1726(A,C),p30(C,B).
b781(A,B):-p1093(A,C),b781_1(C,B).
b781_1(A,B):-p737(A,C),move_right(C,B).
b798(A,B):-move_backwards(A,C),b798_1(C,B).
b798_1(A,B):-p345(A,C),p244(C,B).
b800(A,B):-move_forwards(A,C),b800_1(C,B).
b800_1(A,B):-p696(A,C),p1031(C,B).
b796(A,B):-p310(A,C),b796_1(C,B).
b796_1(A,B):-p1938(A,C),p402(C,B).
b792(A,B):-p1483(A,C),b792_1(C,B).
b792_1(A,B):-p870(A,C),p1871(C,B).
b804(A,B):-move_left(A,C),p420(C,B).
b802(A,B):-move_right(A,C),b802_1(C,B).
b802_1(A,B):-p477(A,C),p367(C,B).
b805(A,B):-p413(A,C),p1399(C,B).
b807(A,B):-p1665(A,C),p1520(C,B).
b808(A,B):-p402(A,C),p1845(C,B).
b809(A,B):-p580(A,C),p115(C,B).
b810(A,B):-move_right(A,C),p1607(C,B).
b803(A,B):-p1483(A,C),b803_1(C,B).
b803_1(A,B):-p1970(A,C),p1576(C,B).
b799(A,B):-p1665(A,C),b799_1(C,B).
b799_1(A,B):-p1584(A,C),p227(C,B).
b812(A,B):-p1550(A,C),p959(C,B).
b793(A,B):-p1399(A,C),b793_1(C,B).
b793_1(A,B):-p1262(A,C),p1510(C,B).
b815(A,B):-grab_ball(A,C),b815_1(C,B).
b815_1(A,B):-p1018(A,C),p1067(C,B).
b816(A,B):-p613(A,C),p1202(C,B).
b806(A,B):-p563(A,C),b806_1(C,B).
b806_1(A,B):-p1262(A,C),p351(C,B).
b801(A,B):-p1371(A,C),b801_1(C,B).
b801_1(A,B):-move_forwards(A,C),p1162(C,B).
b813(A,B):-p580(A,C),b813_1(C,B).
b813_1(A,B):-p810(A,C),p367(C,B).
b820(A,B):-move_left(A,C),b820_1(C,B).
b820_1(A,B):-p1695(A,C),move_backwards(C,B).
b821(A,B):-p692(A,C),p1931(C,B).
b817(A,B):-p1871(A,C),b817_1(C,B).
b817_1(A,B):-p740(A,C),p1544(C,B).
b823(A,B):-p227(A,C),p581(C,B).
b824(A,B):-p30(A,B).
b822(A,B):-move_right(A,C),b822_1(C,B).
b822_1(A,B):-p336(A,C),p92(C,B).
b825(A,B):-move_right(A,C),b825_1(C,B).
b825_1(A,B):-p884(A,C),p30(C,B).
b827(A,B):-p69(A,C),p599(C,B).
b811(A,B):-p1677(A,C),b811_1(C,B).
b811_1(A,B):-p698(A,C),p563(C,B).
b829(A,B):-p402(A,C),p95(C,B).
b826(A,B):-move_right(A,C),b826_1(C,B).
b826_1(A,B):-p594(A,C),p1576(C,B).
b831(A,B):-p1120(A,C),p603(C,B).
b832(A,B):-move_left(A,C),b832_1(C,B).
b832_1(A,B):-p466(A,C),p1100(C,B).
b828(A,B):-move_backwards(A,C),b828_1(C,B).
b828_1(A,B):-p1863(A,C),p930(C,B).
b745(A,B):-move_left(A,C),b745_1(C,B).
b745_1(A,B):-p7(A,C),b745_2(C,B).
b745_2(A,B):-p492(A,C),p1159(C,B).
b834(A,B):-move_left(A,C),b834_1(C,B).
b834_1(A,B):-p292(A,C),p978(C,B).
b833(A,B):-p30(A,C),b833_1(C,B).
b833_1(A,B):-p456(A,C),p868(C,B).
b837(A,B):-p1399(A,C),p190(C,B).
b830(A,B):-p563(A,C),b830_1(C,B).
b830_1(A,B):-p647(A,C),p1399(C,B).
b838(A,B):-p1574(A,C),p69(C,B).
b840(A,B):-p795(A,C),p36(C,B).
b835(A,B):-p1483(A,C),b835_1(C,B).
b835_1(A,B):-p827(A,C),p1308(C,B).
b819(A,B):-p1264(A,C),b819_1(C,B).
b819_1(A,B):-p1789(A,C),p7(C,B).
b839(A,B):-move_forwards(A,C),b839_1(C,B).
b839_1(A,B):-p960(A,C),p824(C,B).
b843(A,B):-p445(A,C),p1399(C,B).
b845(A,B):-move_left(A,C),p692(C,B).
b836(A,B):-p563(A,C),b836_1(C,B).
b836_1(A,B):-p85(A,C),p563(C,B).
b775(A,B):-move_left(A,C),b775_1(C,B).
b775_1(A,B):-p7(A,C),b775_2(C,B).
b775_2(A,B):-p1828(A,C),p563(C,B).
%timeout
b846(A,B):-move_left(A,C),b846_1(C,B).
b846_1(A,B):-p1392(A,C),p613(C,B).
b842(A,B):-p30(A,C),b842_1(C,B).
b842_1(A,B):-p1464(A,C),p580(C,B).
b848(A,B):-move_right(A,C),b848_1(C,B).
b848_1(A,B):-p1510(A,C),p443(C,B).
b849(A,B):-move_left(A,C),b849_1(C,B).
b849_1(A,B):-p1100(A,C),p632(C,B).
b850(A,B):-move_left(A,C),b850_1(C,B).
b850_1(A,B):-p343(A,C),p882(C,B).
b814(A,B):-p612(A,C),b814_1(C,B).
b814_1(A,B):-p610(A,C),p1544(C,B).
b852(A,B):-p1856(A,C),p30(C,B).
b856(A,B):-p562(A,C),p1510(C,B).
b857(A,B):-p6(A,C),p329(C,B).
b855(A,B):-move_left(A,C),b855_1(C,B).
b855_1(A,B):-p7(A,C),p453(C,B).
b859(A,B):-p580(A,C),p1691(C,B).
b851(A,B):-move_forwards(A,C),b851_1(C,B).
b851_1(A,B):-p650(A,C),p310(C,B).
b860(A,B):-move_left(A,C),b860_1(C,B).
b860_1(A,B):-p972(A,C),move_backwards(C,B).
b862(A,B):-p1350(A,C),p1277(C,B).
b858(A,B):-move_backwards(A,C),b858_1(C,B).
b858_1(A,B):-p385(A,C),p857(C,B).
b863(A,B):-p1120(A,C),p1306(C,B).
b861(A,B):-move_backwards(A,C),b861_1(C,B).
b861_1(A,B):-p122(A,C),p1576(C,B).
b853(A,B):-p563(A,C),b853_1(C,B).
b853_1(A,B):-p1005(A,C),p69(C,B).
b795(A,B):-move_left(A,C),b795_1(C,B).
b795_1(A,B):-p465(A,C),b795_2(C,B).
b795_2(A,B):-p568(A,C),p251(C,B).
b868(A,B):-p1399(A,C),p1460(C,B).
b866(A,B):-grab_ball(A,C),b866_1(C,B).
b866_1(A,B):-p1984(A,C),p853(C,B).
b869(A,B):-p1584(A,C),move_left(C,B).
b864(A,B):-p30(A,C),b864_1(C,B).
b864_1(A,B):-p618(A,C),move_backwards(C,B).
b870(A,B):-move_backwards(A,C),b870_1(C,B).
b870_1(A,B):-p1067(A,C),p1451(C,B).
b865(A,B):-p310(A,C),b865_1(C,B).
b865_1(A,B):-p1235(A,C),p442(C,B).
b871(A,B):-move_left(A,C),b871_1(C,B).
b871_1(A,B):-p1632(A,C),p1797(C,B).
b873(A,B):-move_right(A,C),b873_1(C,B).
b873_1(A,B):-p455(A,C),p1067(C,B).
...
b875_1(A,B):-p30(A,C),p894(C,B).
b854(A,B):-p692(A,C),b854_1(C,B).
b854_1(A,B):-p524(A,C),move_backwards(C,B).
b874(A,B):-move_left(A,C),b874_1(C,B).
b874_1(A,B):-p122(A,C),p692(C,B).
b882(A,B):-p1279(A,C),p1713(C,B).
b841(A,B):-p1002(A,C),b841_1(C,B).
b841_1(A,B):-p353(A,C),p1208(C,B).
b884(A,B):-p30(A,C),p594(C,B).
b872(A,B):-p310(A,C),b872_1(C,B).
b872_1(A,B):-p60(A,C),p1100(C,B).
b886(A,B):-move_left(A,C),b886_1(C,B).
b886_1(A,B):-p1067(A,C),p1287(C,B).
b883(A,B):-p367(A,C),b883_1(C,B).
b883_1(A,B):-p1439(A,C),p1283(C,B).
b888(A,B):-p794(A,C),p1087(C,B).
b885(A,B):-p1483(A,C),b885_1(C,B).
b885_1(A,B):-p63(A,C),p1665(C,B).
b889(A,B):-move_right(A,C),b889_1(C,B).
b889_1(A,B):-p1201(A,C),p194(C,B).
b881(A,B):-p1665(A,C),b881_1(C,B).
b881_1(A,B):-p926(A,C),p43(C,B).
b892(A,B):-p276(A,C),p94(C,B).
b890(A,B):-move_forwards(A,C),b890_1(C,B).
b890_1(A,B):-p671(A,C),p532(C,B).
b877(A,B):-p1137(A,C),b877_1(C,B).
b877_1(A,B):-p1789(A,C),p1483(C,B).
...
b894(A,B):-p1483(A,C),b894_1(C,B).
b894_1(A,B):-p810(A,C),p1100(C,B).
b893(A,B):-p1665(A,C),b893_1(C,B).
b893_1(A,B):-p1197(A,C),move_backwards(C,B).
b901(A,B):-p1108(A,C),p1196(C,B).
b898(A,B):-p1100(A,C),b898_1(C,B).
b898_1(A,B):-p1003(A,C),p580(C,B).
b880(A,B):-p695(A,C),b880_1(C,B).
b880_1(A,B):-p530(A,C),p1722(C,B).
b904(A,B):-move_left(A,C),b904_1(C,B).
b904_1(A,B):-p1306(A,C),p427(C,B).
b900(A,B):-p1576(A,C),b900_1(C,B).
b900_1(A,B):-p1478(A,C),p1853(C,B).
...
b906_1(A,B):-p1639(A,C),move_left(C,B).
b909(A,B):-p1100(A,C),p508(C,B).
b908(A,B):-p980(A,C),p850(C,B).
b902(A,B):-p882(A,C),b902_1(C,B).
b902_1(A,B):-p1607(A,C),p310(C,B).
b912(A,B):-p984(A,C),p1751(C,B).
b910(A,B):-move_right(A,C),b910_1(C,B).
b910_1(A,B):-p1611(A,C),p1411(C,B).
b903(A,B):-p22(A,C),b903_1(C,B).
b903_1(A,B):-p1770(A,C),p1189(C,B).
b915(A,B):-p749(A,C),p1451(C,B).
b916(A,B):-move_left(A,C),b916_1(C,B).
b916_1(A,B):-p1108(A,C),p476(C,B).
b917(A,B):-move_left(A,C),b917_1(C,B).
b917_1(A,B):-p30(A,C),p1975(C,B).
b914(A,B):-p367(A,C),b914_1(C,B).
b914_1(A,B):-p1051(A,C),p1665(C,B).
b911(A,B):-p563(A,C),b911_1(C,B).
b911_1(A,B):-p199(A,C),p1137(C,B).
b920(A,B):-p1665(A,C),p1074(C,B).
b899(A,B):-p1838(A,C),b899_1(C,B).
b899_1(A,B):-p875(A,C),move_left(C,B).
...
b918_1(A,B):-p1040(A,C),p1137(C,B).
%timeout
b926(A,B):-p453(A,C),p1770(C,B).
b925(A,B):-move_left(A,C),b925_1(C,B).
b925_1(A,B):-p884(A,C),p1483(C,B).
b928(A,B):-p1920(A,C),p30(C,B).
b921(A,B):-move_right(A,C),b921_1(C,B).
b921_1(A,B):-p135(A,C),p219(C,B).
b924(A,B):-move_forwards(A,C),b924_1(C,B).
b924_1(A,B):-p1605(A,C),p1404(C,B).
b927(A,B):-p30(A,C),b927_1(C,B).
b927_1(A,B):-p910(A,C),p1120(C,B).
...
b935_1(A,B):-p257(A,C),p1995(C,B).
b938(A,B):-p580(A,C),p1684(C,B).
b931(A,B):-p22(A,C),b931_1(C,B).
b931_1(A,B):-p404(A,C),p613(C,B).
b929(A,B):-p1667(A,C),b929_1(C,B).
b929_1(A,B):-p1871(A,C),p1604(C,B).
b939(A,B):-p227(A,C),b939_1(C,B).
b939_1(A,B):-p1667(A,C),p1550(C,B).
b942(A,B):-move_left(A,C),b942_1(C,B).
b942_1(A,B):-p765(A,C),p356(C,B).
b941(A,B):-move_backwards(A,C),b941_1(C,B).
b941_1(A,B):-p1429(A,C),p187(C,B).
b944(A,B):-p1652(A,C),p692(C,B).
b937(A,B):-p1237(A,C),b937_1(C,B).
b937_1(A,B):-p582(A,C),p30(C,B).
b946(A,B):-p1100(A,C),p360(C,B).
b772(A,B):-move_left(A,C),b772_1(C,B).
b772_1(A,B):-p1742(A,C),b772_2(C,B).
b772_2(A,B):-p1296(A,C),p69(C,B).
b940(A,B):-p563(A,C),b940_1(C,B).
b940_1(A,B):-p469(A,C),p1399(C,B).
b949(A,B):-p1483(A,C),p364(C,B).
b947(A,B):-move_right(A,C),b947_1(C,B).
b947_1(A,B):-p1022(A,C),p367(C,B).
b951(A,B):-p929(A,C),p1463(C,B).
b952(A,B):-p1170(A,C),p626(C,B).
b950(A,B):-p30(A,C),b950_1(C,B).
b950_1(A,B):-p1464(A,C),p402(C,B).
b943(A,B):-p227(A,C),b943_1(C,B).
b943_1(A,B):-p1235(A,C),p1483(C,B).
b948(A,B):-p1208(A,C),b948_1(C,B).
b948_1(A,B):-p1838(A,C),p1734(C,B).
b956(A,B):-p465(A,B).
b932(A,B):-p1264(A,C),b932_1(C,B).
b932_1(A,B):-p1584(A,C),move_left(C,B).
b957(A,B):-move_forwards(A,C),b957_1(C,B).
b957_1(A,B):-p740(A,C),move_forwards(C,B).
b959(A,B):-move_right(A,C),p1402(C,B).
b958(A,B):-move_left(A,C),b958_1(C,B).
b958_1(A,B):-p1336(A,C),move_forwards(C,B).
b961(A,B):-p30(A,C),p1131(C,B).
b962(A,B):-move_left(A,C),p22(C,B).
b954(A,B):-p1665(A,C),b954_1(C,B).
b954_1(A,B):-p1070(A,C),p1345(C,B).
b945(A,B):-p1876(A,C),b945_1(C,B).
b945_1(A,B):-p1483(A,C),p1419(C,B).
b965(A,B):-p666(A,B).
b964(A,B):-p1804(A,C),move_left(C,B).
b960(A,B):-move_left(A,C),b960_1(C,B).
b960_1(A,B):-p359(A,C),p1713(C,B).
b968(A,B):-p7(A,C),p225(C,B).
b969(A,B):-p30(A,C),p142(C,B).
b966(A,B):-move_left(A,C),b966_1(C,B).
b966_1(A,B):-p972(A,C),p356(C,B).
b971(A,B):-p787(A,C),move_right(C,B).
b963(A,B):-move_forwards(A,C),b963_1(C,B).
b963_1(A,B):-p590(A,C),p1416(C,B).
b970(A,B):-move_left(A,C),b970_1(C,B).
b970_1(A,B):-p1851(A,C),p630(C,B).
b955(A,B):-p1576(A,C),b955_1(C,B).
b955_1(A,B):-p1444(A,C),p1100(C,B).
b974(A,B):-p127(A,C),p1137(C,B).
b976(A,B):-p1100(A,C),p490(C,B).
b977(A,B):-p1561(A,C),p613(C,B).
b953(A,B):-p22(A,C),b953_1(C,B).
b953_1(A,B):-p1259(A,C),p1137(C,B).
b818(A,B):-move_left(A,C),b818_1(C,B).
b818_1(A,B):-p1055(A,C),b818_2(C,B).
b818_2(A,B):-p353(A,C),move_backwards(C,B).
b972(A,B):-p794(A,C),b972_1(C,B).
b972_1(A,B):-p1564(A,C),p815(C,B).
b981(A,B):-p1665(A,C),p420(C,B).
b979(A,B):-p310(A,C),b979_1(C,B).
b979_1(A,B):-p1491(A,C),move_backwards(C,B).
b973(A,B):-p613(A,C),b973_1(C,B).
b973_1(A,B):-p477(A,C),p692(C,B).
b983(A,B):-p1927(A,C),p1463(C,B).
b982(A,B):-move_right(A,C),b982_1(C,B).
b982_1(A,B):-p1237(A,C),p418(C,B).
b844(A,B):-move_right(A,C),b844_1(C,B).
b844_1(A,B):-p204(A,C),b844_2(C,B).
b844_2(A,B):-p186(A,C),p1576(C,B).
b967(A,B):-p687(A,C),b967_1(C,B).
b967_1(A,B):-p507(A,C),p651(C,B).
b988(A,B):-p1871(A,B).
b989(A,B):-p8(A,C),p1483(C,B).
b980(A,B):-p1576(A,C),b980_1(C,B).
b980_1(A,B):-p1138(A,C),p838(C,B).
b975(A,B):-p177(A,C),b975_1(C,B).
b975_1(A,B):-p828(A,C),p402(C,B).
b991(A,B):-move_right(A,C),b991_1(C,B).
b991_1(A,B):-p753(A,C),move_left(C,B).
b985(A,B):-p227(A,C),b985_1(C,B).
b985_1(A,B):-p453(A,C),p218(C,B).
b990(A,B):-move_right(A,C),b990_1(C,B).
b990_1(A,B):-p36(A,C),p1455(C,B).
b978(A,B):-p1399(A,C),b978_1(C,B).
b978_1(A,B):-p783(A,C),p1931(C,B).
b993(A,B):-move_forwards(A,C),b993_1(C,B).
b993_1(A,B):-p1883(A,C),p1100(C,B).
b994(A,B):-move_forwards(A,C),b994_1(C,B).
b994_1(A,B):-p1751(A,C),p1784(C,B).
b996(A,B):-move_right(A,C),b996_1(C,B).
b996_1(A,B):-p783(A,C),p1982(C,B).
b998(A,B):-p630(A,C),p613(C,B).
b999(A,B):-p19(A,C),p1264(C,B).
b995(A,B):-p69(A,C),b995_1(C,B).
b995_1(A,B):-p870(A,C),p1208(C,B).
b986(A,B):-p22(A,C),b986_1(C,B).
b986_1(A,B):-p1371(A,C),p870(C,B).
b913(A,B):-move_left(A,C),b913_1(C,B).
b913_1(A,B):-p7(A,C),b913_2(C,B).
b913_2(A,B):-p732(A,C),p1588(C,B).
b887(A,B):-move_left(A,C),b887_1(C,B).
b887_1(A,B):-p1670(A,C),b887_2(C,B).
b887_2(A,B):-p662(A,C),p1483(C,B).
b601(A,B):-p367(A,C),b601_1(C,B).
b601_1(A,B):-p1838(A,C),b601_2(C,B).
b601_2(A,B):-p875(A,C),p276(C,B).
b987(A,B):-p41(A,C),b987_1(C,B).
b987_1(A,B):-p978(A,C),p794(C,B).
b997(A,B):-p1533(A,C),b997_1(C,B).
b997_1(A,B):-p1739(A,C),p1399(C,B).
b992(A,B):-move_left(A,C),b992_1(C,B).
b992_1(A,B):-p1579(A,C),b992_2(C,B).
b992_2(A,B):-p367(A,C),p1623(C,B).
b847(A,B):-move_left(A,C),b847_1(C,B).
b847_1(A,B):-p1813(A,C),b847_2(C,B).
b847_2(A,B):-p614(A,C),p580(C,B).
b675(A,B):-p1483(A,C),b675_1(C,B).
b675_1(A,B):-p407(A,C),b675_2(C,B).
b675_2(A,B):-p1208(A,C),p1345(C,B).
b693(A,B):-p503(A,C),b693_1(C,B).
b693_1(A,B):-p1756(A,C),b693_2(C,B).
b693_2(A,B):-p411(A,C),p1391(C,B).
b879(A,B):-p1576(A,C),b879_1(C,B).
b879_1(A,B):-p1228(A,C),b879_2(C,B).
b879_2(A,B):-p1208(A,C),p1604(C,B).
b984(A,B):-move_left(A,C),b984_1(C,B).
b984_1(A,B):-p532(A,C),b984_2(C,B).
b984_2(A,B):-p85(A,C),move_left(C,B).
% num solved 998
true.

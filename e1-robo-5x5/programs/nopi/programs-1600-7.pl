...
p2_1(A,B):-p500(A,C),p2_2(C,B).
p2_2(A,B):-p1428(A,C),p1075(C,B).
p3(A,B):-p244(A,C),p3_1(C,B).
p3_1(A,B):-p184(A,C),p3_2(C,B).
p3_2(A,B):-p1428(A,C),p1356(C,B).
p4(A,B):-p1424(A,C),p4_1(C,B).
p4_1(A,B):-p987(A,C),p4_2(C,B).
...
p16(A,B):-p231(A,C),p16_1(C,B).
p16_1(A,B):-p987(A,C),p16_2(C,B).
p16_2(A,B):-p506(A,C),p95(C,B).
...
p22(A,B):-p713(A,C),p22_1(C,B).
p22_1(A,B):-p1365(A,C),p22_2(C,B).
p22_2(A,B):-p1428(A,C),p810(C,B).
...
p34_1(A,B):-drop_ball(A,C),p34_2(C,B).
p34_2(A,B):-move_forwards(A,C),p499(C,B).
p38(A,B):-p368(A,C),p38_1(C,B).
p38_1(A,B):-p244(A,C),p1428(C,B).
p43(A,B):-p379(A,C),p43_1(C,B).
p43_1(A,B):-p368(A,C),p43_2(C,B).
p43_2(A,B):-p1428(A,C),p278(C,B).
p44(A,B):-move_backwards(A,C),p44_1(C,B).
p44_1(A,B):-p379(A,C),p44_2(C,B).
...
p47_1(A,B):-move_left(A,C),p47_2(C,B).
p47_2(A,B):-p1428(A,C),p810(C,B).
p48(A,B):-p1249(A,C),p48_1(C,B).
p48_1(A,B):-p379(A,C),p48_2(C,B).
p48_2(A,B):-p1428(A,C),p627(C,B).
p49(A,B):-p1378(A,C),p49_1(C,B).
p49_1(A,B):-p379(A,C),p49_2(C,B).
...
p54_1(A,B):-p987(A,C),p54_2(C,B).
p54_2(A,B):-p368(A,C),p1428(C,B).
p55(A,B):-move_backwards(A,C),p55_1(C,B).
p55_1(A,B):-p379(A,C),p55_2(C,B).
...
p69_1(A,B):-move_right(A,C),p69_2(C,B).
p69_2(A,B):-p95(A,C),p457(C,B).
...
p88(A,B):-p810(A,C),p88_1(C,B).
p88_1(A,B):-p1584(A,C),p231(C,B).
...
p112(A,B):-p540(A,C),p112_1(C,B).
p112_1(A,B):-p987(A,C),p112_2(C,B).
p112_2(A,B):-p67(A,C),p360(C,B).
p113(A,B):-p1584(A,C),p113_1(C,B).
p113_1(A,B):-p1428(A,C),p1378(C,B).
p116(A,B):-p524(A,C),p116_1(C,B).
p116_1(A,B):-p1584(A,C),p116_2(C,B).
p116_2(A,B):-p1428(A,C),move_backwards(C,B).
p118(A,B):-p1584(A,C),p118_1(C,B).
p118_1(A,B):-drop_ball(A,C),move_forwards(C,B).
...
p123_1(A,B):-drop_ball(A,C),p123_2(C,B).
p123_2(A,B):-move_forwards(A,C),p627(C,B).
p126(A,B):-p68(A,C),p126_1(C,B).
p126_1(A,B):-p1584(A,C),p126_2(C,B).
p126_2(A,B):-p506(A,C),p602(C,B).
p129(A,B):-p244(A,C),p129_1(C,B).
p129_1(A,B):-p368(A,C),p129_2(C,B).
p129_2(A,B):-p67(A,C),move_left(C,B).
p138(A,B):-p368(A,C),p138_1(C,B).
p138_1(A,B):-p244(A,C),p138_2(C,B).
p138_2(A,B):-p84(A,C),p713(C,B).
p147(A,B):-p651(A,C),p147_1(C,B).
p147_1(A,B):-p1584(A,C),p147_2(C,B).
p147_2(A,B):-p1428(A,C),p627(C,B).
p148(A,B):-p713(A,C),p148_1(C,B).
p148_1(A,B):-p987(A,C),p148_2(C,B).
p148_2(A,B):-p67(A,C),p368(C,B).
p150(A,B):-p810(A,C),p150_1(C,B).
p150_1(A,B):-p379(A,C),p150_2(C,B).
...
p157_1(A,B):-p244(A,C),p157_2(C,B).
p157_2(A,B):-p67(A,C),p710(C,B).
p159(A,B):-p810(A,C),p159_1(C,B).
p159_1(A,B):-p1584(A,C),p159_2(C,B).
...
p167(A,B):-p360(A,C),p167_1(C,B).
p167_1(A,B):-p244(A,C),p167_2(C,B).
...
p176(A,B):-p379(A,C),p176_1(C,B).
p176_1(A,B):-p184(A,C),p176_2(C,B).
p176_2(A,B):-drop_ball(A,C),p506(C,B).
p180(A,B):-p1356(A,C),p180_1(C,B).
p180_1(A,B):-grab_ball(A,C),p180_2(C,B).
p180_2(A,B):-p95(A,C),p713(C,B).
...
p193(A,B):-p1075(A,C),p193_1(C,B).
p193_1(A,B):-p987(A,C),p67(C,B).
p195(A,B):-p457(A,C),p195_1(C,B).
p195_1(A,B):-p1584(A,C),p195_2(C,B).
p195_2(A,B):-move_backwards(A,C),drop_ball(C,B).
p196(A,B):-p1090(A,C),p196_1(C,B).
p196_1(A,B):-p1584(A,C),p196_2(C,B).
p196_2(A,B):-p1428(A,C),move_backwards(C,B).
p197(A,B):-p499(A,C),p197_1(C,B).
p197_1(A,B):-drop_ball(A,C),p500(C,B).
p200(A,B):-p368(A,C),p200_1(C,B).
p200_1(A,B):-p67(A,C),p1356(C,B).
...
p233(A,B):-p524(A,C),p233_1(C,B).
p233_1(A,B):-p1584(A,C),p233_2(C,B).
p233_2(A,B):-p84(A,C),p1090(C,B).
p234(A,B):-p1332(A,C),p234_1(C,B).
p234_1(A,B):-p244(A,C),p234_2(C,B).
p234_2(A,B):-p896(A,C),p602(C,B).
p242(A,B):-p379(A,C),p242_1(C,B).
p242_1(A,B):-p211(A,C),p242_2(C,B).
p242_2(A,B):-p84(A,C),move_right(C,B).
...
p248(A,B):-move_right(A,C),p248_1(C,B).
p248_1(A,B):-p231(A,C),p248_2(C,B).
p248_2(A,B):-p987(A,C),p211(C,B).
...
p256(A,B):-p896(A,C),p256_1(C,B).
p256_1(A,B):-p244(A,C),p256_2(C,B).
p256_2(A,B):-p627(A,C),p95(C,B).
p259(A,B):-p244(A,C),p259_1(C,B).
p259_1(A,B):-p1356(A,C),p259_2(C,B).
p259_2(A,B):-p95(A,C),p506(C,B).
...
p277_2(A,B):-p360(A,C),p602(C,B).
p282(A,B):-p368(A,C),p282_1(C,B).
p282_1(A,B):-p244(A,C),p282_2(C,B).
p282_2(A,B):-p1428(A,C),p896(C,B).
p285(A,B):-p244(A,C),p285_1(C,B).
p285_1(A,B):-drop_ball(A,C),p710(C,B).
p287(A,B):-p1424(A,C),p287_1(C,B).
p287_1(A,B):-p987(A,C),p287_2(C,B).
p287_2(A,B):-drop_ball(A,C),move_forwards(C,B).
...
p290_2(A,B):-p543(A,C),p602(C,B).
p291(A,B):-p231(A,C),p291_1(C,B).
p291_1(A,B):-p1365(A,C),p291_2(C,B).
p291_2(A,B):-p1062(A,C),p84(C,B).
p295(A,B):-p987(A,C),p295_1(C,B).
p295_1(A,B):-p543(A,C),p295_2(C,B).
p295_2(A,B):-p84(A,C),p810(C,B).
p299(A,B):-p500(A,C),p299_1(C,B).
p299_1(A,B):-p244(A,C),p299_2(C,B).
p299_2(A,B):-drop_ball(A,C),p1378(C,B).
p302(A,B):-p1075(A,C),p302_1(C,B).
p302_1(A,B):-p244(A,C),p302_2(C,B).
...
p323(A,B):-grab_ball(A,C),p323_1(C,B).
p323_1(A,B):-p713(A,C),p323_2(C,B).
p323_2(A,B):-drop_ball(A,C),p896(C,B).
...
p359_1(A,B):-p95(A,C),p359_2(C,B).
p359_2(A,B):-move_backwards(A,C),p457(C,B).
p362(A,B):-p184(A,C),p362_1(C,B).
p362_1(A,B):-grab_ball(A,C),p362_2(C,B).
p362_2(A,B):-p1428(A,C),move_left(C,B).
p363(A,B):-p524(A,C),p363_1(C,B).
p363_1(A,B):-p987(A,C),p363_2(C,B).
p363_2(A,B):-p84(A,C),move_right(C,B).
...
p374(A,B):-p379(A,C),p374_1(C,B).
p374_1(A,B):-move_forwards(A,C),p374_2(C,B).
p374_2(A,B):-p84(A,C),move_backwards(C,B).
p378(A,B):-p543(A,C),p378_1(C,B).
p378_1(A,B):-p1584(A,C),p378_2(C,B).
p378_2(A,B):-p1090(A,C),p1428(C,B).
...
p388(A,B):-p1378(A,C),p388_1(C,B).
p388_1(A,B):-p987(A,C),p388_2(C,B).
p388_2(A,B):-p84(A,C),p1090(C,B).
p393(A,B):-p379(A,C),p713(C,B).
p396(A,B):-p499(A,C),p396_1(C,B).
p396_1(A,B):-p1365(A,C),p396_2(C,B).
p396_2(A,B):-p95(A,C),p457(C,B).
...
p402(A,B):-p713(A,C),p402_1(C,B).
p402_1(A,B):-grab_ball(A,C),p402_2(C,B).
p402_2(A,B):-p810(A,C),p1428(C,B).
...
p411(A,B):-p360(A,C),p411_1(C,B).
p411_1(A,B):-p95(A,C),p506(C,B).
p415(A,B):-p896(A,C),p415_1(C,B).
p415_1(A,B):-p244(A,C),p415_2(C,B).
...
p428(A,B):-p1356(A,C),p428_1(C,B).
p428_1(A,B):-p244(A,C),p428_2(C,B).
...
p436_1(A,B):-p244(A,C),p436_2(C,B).
p436_2(A,B):-p710(A,C),p84(C,B).
...
p444(A,B):-p1378(A,C),p444_1(C,B).
p444_1(A,B):-p987(A,C),p444_2(C,B).
...
p453_1(A,B):-p1584(A,C),p453_2(C,B).
p453_2(A,B):-p1332(A,C),p1428(C,B).
p460(A,B):-p896(A,C),p460_1(C,B).
p460_1(A,B):-grab_ball(A,C),p460_2(C,B).
p460_2(A,B):-p1332(A,C),p84(C,B).
p463(A,B):-p1424(A,C),p463_1(C,B).
p463_1(A,B):-p987(A,C),p463_2(C,B).
p463_2(A,B):-p67(A,C),p949(C,B).
p467(A,B):-p1075(A,C),p467_1(C,B).
p467_1(A,B):-p1365(A,C),p467_2(C,B).
p467_2(A,B):-p95(A,C),p500(C,B).
...
p480_2(A,B):-p1378(A,C),p84(C,B).
p482(A,B):-p1378(A,C),p482_1(C,B).
p482_1(A,B):-p987(A,C),p482_2(C,B).
p482_2(A,B):-p84(A,C),p360(C,B).
p484(A,B):-p1090(A,C),p484_1(C,B).
p484_1(A,B):-p987(A,C),p484_2(C,B).
p484_2(A,B):-p602(A,C),p101(C,B).
p486(A,B):-p651(A,C),p486_1(C,B).
p486_1(A,B):-p379(A,C),p486_2(C,B).
...
p504(A,B):-move_backwards(A,C),p504_1(C,B).
p504_1(A,B):-grab_ball(A,C),p504_2(C,B).
p504_2(A,B):-p543(A,C),drop_ball(C,B).
...
p517(A,B):-p1075(A,C),p517_1(C,B).
p517_1(A,B):-p379(A,C),p517_2(C,B).
p517_2(A,B):-p95(A,C),p1526(C,B).
p520(A,B):-p211(A,C),p520_1(C,B).
p520_1(A,B):-p244(A,C),p520_2(C,B).
p520_2(A,B):-p506(A,C),p67(C,B).
p523(A,B):-p949(A,C),p523_1(C,B).
p523_1(A,B):-p379(A,C),p523_2(C,B).
p523_2(A,B):-p1428(A,C),p1090(C,B).
p526(A,B):-p713(A,C),p526_1(C,B).
p526_1(A,B):-p244(A,C),p526_2(C,B).
p526_2(A,B):-p1356(A,C),p95(C,B).
p528(A,B):-p1075(A,C),p528_1(C,B).
p528_1(A,B):-p987(A,C),p528_2(C,B).
p528_2(A,B):-p602(A,C),p360(C,B).
p529(A,B):-p543(A,C),p529_1(C,B).
p529_1(A,B):-p1584(A,C),p95(C,B).
...
p547(A,B):-p101(A,C),p547_1(C,B).
p547_1(A,B):-p1584(A,C),p547_2(C,B).
...
p554(A,B):-p713(A,C),p554_1(C,B).
p554_1(A,B):-p1584(A,C),p554_2(C,B).
...
p559(A,B):-p244(A,C),p559_1(C,B).
p559_1(A,B):-p67(A,C),p710(C,B).
p560(A,B):-p810(A,C),p560_1(C,B).
p560_1(A,B):-grab_ball(A,C),p949(C,B).
p561(A,B):-p1424(A,C),p561_1(C,B).
p561_1(A,B):-p244(A,C),p561_2(C,B).
...
p564_1(A,B):-p896(A,C),p564_2(C,B).
p564_2(A,B):-p987(A,C),drop_ball(C,B).
p567(A,B):-p244(A,C),p567_1(C,B).
p567_1(A,B):-p184(A,C),p567_2(C,B).
p567_2(A,B):-p67(A,C),move_right(C,B).
p574(A,B):-p1062(A,C),p574_1(C,B).
p574_1(A,B):-p987(A,C),p574_2(C,B).
p574_2(A,B):-drop_ball(A,C),p278(C,B).
p575(A,B):-p1365(A,C),p575_1(C,B).
p575_1(A,B):-p84(A,C),p575_2(C,B).
p575_2(A,B):-move_right(A,C),p499(C,B).
...
p577_1(A,B):-p95(A,C),p360(C,B).
p580(A,B):-p1584(A,C),p580_1(C,B).
p580_1(A,B):-p84(A,C),p457(C,B).
p581(A,B):-p1062(A,C),p581_1(C,B).
p581_1(A,B):-p987(A,C),p581_2(C,B).
...
p595(A,B):-p1356(A,C),p595_1(C,B).
p595_1(A,B):-p244(A,C),p595_2(C,B).
...
p601_2(A,B):-p360(A,C),p602(C,B).
p603(A,B):-p368(A,C),p603_1(C,B).
p603_1(A,B):-grab_ball(A,C),p603_2(C,B).
p603_2(A,B):-p1075(A,C),p1428(C,B).
...
p609(A,B):-p1424(A,C),p609_1(C,B).
p609_1(A,B):-p379(A,C),p609_2(C,B).
p609_2(A,B):-drop_ball(A,C),p627(C,B).
p614(A,B):-p1062(A,C),p614_1(C,B).
p614_1(A,B):-p379(A,C),p614_2(C,B).
p614_2(A,B):-p84(A,C),p710(C,B).
...
p665_2(A,B):-p1075(A,C),p1428(C,B).
p667(A,B):-p1090(A,C),p667_1(C,B).
p667_1(A,B):-p1584(A,C),p667_2(C,B).
p667_2(A,B):-p1428(A,C),p949(C,B).
p669(A,B):-p211(A,C),p669_1(C,B).
p669_1(A,B):-grab_ball(A,C),p669_2(C,B).
p669_2(A,B):-p84(A,C),p713(C,B).
...
p695(A,B):-p987(A,C),p695_1(C,B).
p695_1(A,B):-p101(A,C),p695_2(C,B).
p695_2(A,B):-p602(A,C),p1526(C,B).
p701(A,B):-p1062(A,C),p701_1(C,B).
p701_1(A,B):-p987(A,C),p701_2(C,B).
p701_2(A,B):-p602(A,C),p506(C,B).
p704(A,B):-p710(A,C),p704_1(C,B).
p704_1(A,B):-p379(A,C),p704_2(C,B).
p704_2(A,B):-p67(A,C),p810(C,B).
p705(A,B):-move_left(A,C),p705_1(C,B).
p705_1(A,B):-p1584(A,C),p705_2(C,B).
p705_2(A,B):-p1424(A,C),p84(C,B).
p709(A,B):-p244(A,C),p709_1(C,B).
p709_1(A,B):-p184(A,C),p709_2(C,B).
p709_2(A,B):-p95(A,C),move_forwards(C,B).
...
p720_1(A,B):-p1428(A,C),p1075(C,B).
p721(A,B):-p810(A,C),p721_1(C,B).
p721_1(A,B):-p379(A,C),p721_2(C,B).
p721_2(A,B):-p1526(A,C),p67(C,B).
...
p738(A,B):-p710(A,C),p738_1(C,B).
p738_1(A,B):-p1365(A,C),p1428(C,B).
...
p746_2(A,B):-p810(A,C),p84(C,B).
p751(A,B):-p244(A,C),p751_1(C,B).
p751_1(A,B):-p1424(A,C),p751_2(C,B).
p751_2(A,B):-p84(A,C),p810(C,B).
p757(A,B):-move_right(A,C),p757_1(C,B).
p757_1(A,B):-p499(A,C),grab_ball(C,B).
...
p771(A,B):-p949(A,C),p771_1(C,B).
p771_1(A,B):-p987(A,C),p771_2(C,B).
...
p786(A,B):-p1356(A,C),p786_1(C,B).
p786_1(A,B):-p244(A,C),p786_2(C,B).
p786_2(A,B):-p84(A,C),move_forwards(C,B).
p787(A,B):-p713(A,C),p787_1(C,B).
p787_1(A,B):-p379(A,C),p787_2(C,B).
p787_2(A,B):-p67(A,C),move_forwards(C,B).
p788(A,B):-p1424(A,C),p788_1(C,B).
p788_1(A,B):-p244(A,C),p788_2(C,B).
p788_2(A,B):-p506(A,C),p67(C,B).
...
p792(A,B):-move_backwards(A,C),p792_1(C,B).
p792_1(A,B):-p602(A,C),p1526(C,B).
...
p812(A,B):-p810(A,C),p812_1(C,B).
p812_1(A,B):-p379(A,C),p812_2(C,B).
p812_2(A,B):-p651(A,C),p95(C,B).
p813(A,B):-grab_ball(A,C),p813_1(C,B).
p813_1(A,B):-p524(A,C),p813_2(C,B).
p813_2(A,B):-p84(A,C),p949(C,B).
...
p827_1(A,B):-p987(A,C),p827_2(C,B).
p827_2(A,B):-p67(A,C),p499(C,B).
p828(A,B):-move_backwards(A,C),p828_1(C,B).
p828_1(A,B):-p1584(A,C),p828_2(C,B).
p828_2(A,B):-p1428(A,C),p1356(C,B).
p831(A,B):-p368(A,C),p831_1(C,B).
p831_1(A,B):-grab_ball(A,C),p831_2(C,B).
p831_2(A,B):-p68(A,C),p1428(C,B).
p833(A,B):-p651(A,C),p833_1(C,B).
p833_1(A,B):-p1584(A,C),p95(C,B).
...
p847_1(A,B):-p713(A,C),p847_2(C,B).
p847_2(A,B):-p67(A,C),p360(C,B).
p849(A,B):-p949(A,C),p849_1(C,B).
p849_1(A,B):-p379(A,C),p849_2(C,B).
...
p856(A,B):-p1526(A,C),p856_1(C,B).
p856_1(A,B):-grab_ball(A,C),p856_2(C,B).
p856_2(A,B):-p1090(A,C),drop_ball(C,B).
...
p865_2(A,B):-p1428(A,C),move_left(C,B).
...
p877_1(A,B):-p68(A,C),p877_2(C,B).
p877_2(A,B):-p84(A,C),p713(C,B).
...
p893(A,B):-p1075(A,C),p893_1(C,B).
p893_1(A,B):-p244(A,C),p893_2(C,B).
...
p907(A,B):-move_backwards(A,C),p907_1(C,B).
p907_1(A,B):-p949(A,C),p907_2(C,B).
p907_2(A,B):-p987(A,C),p67(C,B).
p909(A,B):-p627(A,C),p909_1(C,B).
p909_1(A,B):-p987(A,C),p909_2(C,B).
p909_2(A,B):-p602(A,C),p810(C,B).
p910(A,B):-grab_ball(A,C),p910_1(C,B).
p910_1(A,B):-p360(A,C),p910_2(C,B).
p910_2(A,B):-drop_ball(A,C),p360(C,B).
p914(A,B):-move_forwards(A,C),p914_1(C,B).
p914_1(A,B):-grab_ball(A,C),p914_2(C,B).
p914_2(A,B):-p67(A,C),p368(C,B).
p918(A,B):-p457(A,C),p918_1(C,B).
p918_1(A,B):-p1526(A,C),drop_ball(C,B).
p922(A,B):-p244(A,C),p922_1(C,B).
p922_1(A,B):-p1090(A,C),p922_2(C,B).
...
p928(A,B):-p987(A,C),p928_1(C,B).
p928_1(A,B):-move_right(A,C),p928_2(C,B).
p928_2(A,B):-p67(A,C),p368(C,B).
p931(A,B):-move_forwards(A,C),p931_1(C,B).
p931_1(A,B):-grab_ball(A,C),p931_2(C,B).
p931_2(A,B):-p95(A,C),p1107(C,B).
...
p939_1(A,B):-move_forwards(A,C),p939_2(C,B).
p939_2(A,B):-drop_ball(A,C),p540(C,B).
p940(A,B):-p713(A,C),p940_1(C,B).
p940_1(A,B):-p244(A,C),p940_2(C,B).
p940_2(A,B):-p506(A,C),p67(C,B).
p943(A,B):-p1356(A,C),p943_1(C,B).
p943_1(A,B):-p1365(A,C),p943_2(C,B).
p943_2(A,B):-p67(A,C),p1075(C,B).
p944(A,B):-p710(A,C),p944_1(C,B).
p944_1(A,B):-p987(A,C),p944_2(C,B).
p944_2(A,B):-p602(A,C),p810(C,B).
p946(A,B):-p1584(A,C),p946_1(C,B).
p946_1(A,B):-p360(A,C),p946_2(C,B).
p946_2(A,B):-p1428(A,C),p627(C,B).
p954(A,B):-move_left(A,C),p954_1(C,B).
p954_1(A,B):-p602(A,C),p954_2(C,B).
p954_2(A,B):-p500(A,C),p506(C,B).
p956(A,B):-p987(A,C),p956_1(C,B).
p956_1(A,B):-p184(A,C),p956_2(C,B).
p956_2(A,B):-drop_ball(A,C),p360(C,B).
p960(A,B):-p360(A,C),p960_1(C,B).
p960_1(A,B):-p244(A,C),p960_2(C,B).
p960_2(A,B):-p84(A,C),p101(C,B).
p961(A,B):-move_backwards(A,C),p961_1(C,B).
p961_1(A,B):-p987(A,C),p961_2(C,B).
...
p973_2(A,B):-move_left(A,C),p506(C,B).
...
p986_1(A,B):-p244(A,C),p986_2(C,B).
p986_2(A,B):-move_forwards(A,C),p368(C,B).
...
p1026_1(A,B):-p524(A,C),p1026_2(C,B).
p1026_2(A,B):-drop_ball(A,C),p651(C,B).
...
p1037(A,B):-p360(A,C),p1037_1(C,B).
p1037_1(A,B):-p244(A,C),p1037_2(C,B).
p1037_2(A,B):-p627(A,C),p67(C,B).
...
p1050_2(A,B):-p278(A,C),p95(C,B).
p1051(A,B):-p896(A,C),p1051_1(C,B).
p1051_1(A,B):-p244(A,C),p1051_2(C,B).
p1051_2(A,B):-p506(A,C),p67(C,B).
...
p1059(A,B):-p896(A,C),p1059_1(C,B).
p1059_1(A,B):-p987(A,C),p1059_2(C,B).
...
p1067_1(A,B):-p101(A,C),p1067_2(C,B).
p1067_2(A,B):-p67(A,C),p368(C,B).
p1068(A,B):-p244(A,C),p1068_1(C,B).
p1068_1(A,B):-p627(A,C),p1068_2(C,B).
p1068_2(A,B):-p67(A,C),p368(C,B).
p1069(A,B):-move_left(A,C),p1069_1(C,B).
p1069_1(A,B):-p379(A,C),p1069_2(C,B).
p1069_2(A,B):-drop_ball(A,C),move_forwards(C,B).
...
p1077_1(A,B):-p379(A,C),p1077_2(C,B).
p1077_2(A,B):-drop_ball(A,C),move_forwards(C,B).
p1079(A,B):-p1356(A,C),p1079_1(C,B).
p1079_1(A,B):-p244(A,C),p1079_2(C,B).
p1079_2(A,B):-p1428(A,C),p810(C,B).
p1080(A,B):-grab_ball(A,C),p1080_1(C,B).
p1080_1(A,B):-p360(A,C),p67(C,B).
p1086(A,B):-p1090(A,C),p1086_1(C,B).
p1086_1(A,B):-p987(A,C),p1086_2(C,B).
p1086_2(A,B):-p67(A,C),move_right(C,B).
p1089(A,B):-move_backwards(A,C),p1089_1(C,B).
p1089_1(A,B):-p1584(A,C),p1089_2(C,B).
p1089_2(A,B):-p84(A,C),p651(C,B).
p1091(A,B):-p651(A,C),p1091_1(C,B).
p1091_1(A,B):-p67(A,C),p540(C,B).
p1098(A,B):-grab_ball(A,C),p1098_1(C,B).
p1098_1(A,B):-p543(A,C),p84(C,B).
...
p1109(A,B):-p810(A,C),p1109_1(C,B).
p1109_1(A,B):-p379(A,C),p1109_2(C,B).
p1109_2(A,B):-drop_ball(A,C),p500(C,B).
p1111(A,B):-p651(A,C),p1584(C,B).
p1112(A,B):-p713(A,C),p1112_1(C,B).
p1112_1(A,B):-p1365(A,C),p1112_2(C,B).
p1112_2(A,B):-p84(A,C),p627(C,B).
p1118(A,B):-p1424(A,C),p1118_1(C,B).
p1118_1(A,B):-p379(A,C),p1118_2(C,B).
p1118_2(A,B):-p67(A,C),p710(C,B).
...
p1129(A,B):-p360(A,C),p1129_1(C,B).
p1129_1(A,B):-p244(A,C),p1129_2(C,B).
...
p1137(A,B):-p524(A,C),p1137_1(C,B).
p1137_1(A,B):-p244(A,C),p1137_2(C,B).
p1137_2(A,B):-move_forwards(A,C),p67(C,B).
...
p1149(A,B):-p1062(A,C),p1149_1(C,B).
p1149_1(A,B):-p379(A,C),p1149_2(C,B).
...
p1163_2(A,B):-move_backwards(A,C),p84(C,B).
p1165(A,B):-p1526(A,C),p1165_1(C,B).
p1165_1(A,B):-p244(A,C),p1165_2(C,B).
p1165_2(A,B):-p184(A,C),p602(C,B).
...
p1182_2(A,B):-p524(A,C),p84(C,B).
p1183(A,B):-move_forwards(A,C),p1183_1(C,B).
p1183_1(A,B):-p244(A,C),p1183_2(C,B).
p1183_2(A,B):-p1434(A,C),p84(C,B).
...
p1208(A,B):-p1434(A,C),p1208_1(C,B).
p1208_1(A,B):-p1584(A,C),p1208_2(C,B).
...
p1217_1(A,B):-p379(A,C),p1217_2(C,B).
p1217_2(A,B):-p67(A,C),move_left(C,B).
p1220(A,B):-p810(A,C),p1220_1(C,B).
p1220_1(A,B):-p1584(A,C),p1220_2(C,B).
...
p1237(A,B):-p710(A,C),p1237_1(C,B).
p1237_1(A,B):-p379(A,C),p1237_2(C,B).
...
p1247(A,B):-p1424(A,C),p1247_1(C,B).
p1247_1(A,B):-p987(A,C),p1247_2(C,B).
...
p1261(A,B):-p379(A,C),p1261_1(C,B).
p1261_1(A,B):-p1356(A,C),p1261_2(C,B).
p1261_2(A,B):-p95(A,C),p1090(C,B).
p1262(A,B):-p1332(A,C),p1262_1(C,B).
p1262_1(A,B):-p987(A,C),p1262_2(C,B).
p1262_2(A,B):-drop_ball(A,C),p1090(C,B).
...
p1270(A,B):-p500(A,C),p1270_1(C,B).
p1270_1(A,B):-p244(A,C),p1270_2(C,B).
p1270_2(A,B):-drop_ball(A,C),p184(C,B).
p1271(A,B):-p1584(A,C),p1271_1(C,B).
p1271_1(A,B):-p500(A,C),p95(C,B).
...
p1284_1(A,B):-p101(A,C),p1284_2(C,B).
p1284_2(A,B):-p95(A,C),p457(C,B).
p1289(A,B):-p1062(A,C),p1289_1(C,B).
p1289_1(A,B):-p987(A,C),p1289_2(C,B).
p1289_2(A,B):-drop_ball(A,C),p1378(C,B).
p1290(A,B):-p1365(A,C),p1290_1(C,B).
p1290_1(A,B):-p360(A,C),p1290_2(C,B).
p1290_2(A,B):-p1428(A,C),p1075(C,B).
p1292(A,B):-move_left(A,C),p1292_1(C,B).
p1292_1(A,B):-p1378(A,C),p1292_2(C,B).
p1292_2(A,B):-p987(A,C),p1428(C,B).
p1297(A,B):-p521(A,C),p1297_1(C,B).
p1297_1(A,B):-p244(A,C),p1297_2(C,B).
p1297_2(A,B):-p1428(A,C),move_left(C,B).
...
p1315_2(A,B):-p95(A,C),p506(C,B).
p1317(A,B):-p101(A,C),p1317_1(C,B).
p1317_1(A,B):-p987(A,C),p1317_2(C,B).
p1317_2(A,B):-p360(A,C),p602(C,B).
p1318(A,B):-p710(A,C),p1318_1(C,B).
p1318_1(A,B):-p1584(A,C),p1318_2(C,B).
...
p1329(A,B):-p987(A,C),p1329_1(C,B).
p1329_1(A,B):-p540(A,C),p1329_2(C,B).
p1329_2(A,B):-p602(A,C),p506(C,B).
...
p1334(A,B):-p1378(A,C),p1334_1(C,B).
p1334_1(A,B):-p987(A,C),p1334_2(C,B).
p1334_2(A,B):-p67(A,C),p500(C,B).
p1337(A,B):-move_forwards(A,C),p1337_1(C,B).
p1337_1(A,B):-p987(A,C),p1337_2(C,B).
p1337_2(A,B):-drop_ball(A,C),move_forwards(C,B).
...
p1344(A,B):-p360(A,C),p1344_1(C,B).
p1344_1(A,B):-p987(A,C),p1344_2(C,B).
p1344_2(A,B):-p360(A,C),p67(C,B).
p1351(A,B):-p68(A,C),p1351_1(C,B).
p1351_1(A,B):-grab_ball(A,C),p1351_2(C,B).
p1351_2(A,B):-p84(A,C),move_right(C,B).
...
p1360(A,B):-p524(A,C),p1360_1(C,B).
p1360_1(A,B):-p1584(A,C),p1360_2(C,B).
...
p1371(A,B):-p1434(A,C),p1371_1(C,B).
p1371_1(A,B):-grab_ball(A,C),p1371_2(C,B).
p1371_2(A,B):-p1062(A,C),p84(C,B).
...
p1417(A,B):-p368(A,C),p1417_1(C,B).
p1417_1(A,B):-p244(A,C),p1417_2(C,B).
...
p1423_1(A,B):-p379(A,C),p1423_2(C,B).
p1423_2(A,B):-move_backwards(A,C),p1428(C,B).
...
p1427(A,B):-p810(A,C),p1427_1(C,B).
p1427_1(A,B):-p379(A,C),p1427_2(C,B).
...
p1454_2(A,B):-p543(A,C),p602(C,B).
p1457(A,B):-p1090(A,C),p1457_1(C,B).
p1457_1(A,B):-p987(A,C),p1457_2(C,B).
p1457_2(A,B):-drop_ball(A,C),p524(C,B).
p1460(A,B):-p810(A,C),p1460_1(C,B).
p1460_1(A,B):-p67(A,C),p360(C,B).
p1461(A,B):-p1434(A,C),p1461_1(C,B).
p1461_1(A,B):-p1584(A,C),p1461_2(C,B).
p1461_2(A,B):-drop_ball(A,C),move_right(C,B).
p1462(A,B):-move_forwards(A,C),p1462_1(C,B).
p1462_1(A,B):-p379(A,C),p1462_2(C,B).
p1462_2(A,B):-p1424(A,C),p84(C,B).
p1466(A,B):-p713(A,C),p1466_1(C,B).
p1466_1(A,B):-p987(A,C),p1466_2(C,B).
p1466_2(A,B):-p368(A,C),p1428(C,B).
p1467(A,B):-p627(A,C),p1467_1(C,B).
p1467_1(A,B):-p244(A,C),p1467_2(C,B).
...
p1488(A,B):-move_left(A,C),p1488_1(C,B).
p1488_1(A,B):-p987(A,C),p1488_2(C,B).
p1488_2(A,B):-p231(A,C),drop_ball(C,B).
...
p1493_2(A,B):-p1356(A,C),p602(C,B).
...
p1499(A,B):-p1062(A,C),p1499_1(C,B).
p1499_1(A,B):-p379(A,C),p1499_2(C,B).
...
p1509(A,B):-p651(A,C),p1509_1(C,B).
p1509_1(A,B):-p987(A,C),p1509_2(C,B).
p1509_2(A,B):-p67(A,C),p524(C,B).
p1511(A,B):-p1378(A,C),p1511_1(C,B).
p1511_1(A,B):-p244(A,C),p1511_2(C,B).
p1511_2(A,B):-p627(A,C),p95(C,B).
p1514(A,B):-move_right(A,C),p1514_1(C,B).
p1514_1(A,B):-p987(A,C),p1514_2(C,B).
p1514_2(A,B):-p1378(A,C),p84(C,B).
p1515(A,B):-p713(A,C),p1515_1(C,B).
p1515_1(A,B):-p1365(A,C),p1075(C,B).
p1516(A,B):-p713(A,C),p1516_1(C,B).
p1516_1(A,B):-p1584(A,C),p1516_2(C,B).
...
p1522(A,B):-p651(A,C),p1522_1(C,B).
p1522_1(A,B):-p1584(A,C),p1522_2(C,B).
p1522_2(A,B):-p1075(A,C),drop_ball(C,B).
p1523(A,B):-p360(A,C),p1523_1(C,B).
p1523_1(A,B):-p244(A,C),p1523_2(C,B).
p1523_2(A,B):-p67(A,C),p710(C,B).
...
p1534(A,B):-p521(A,C),p1534_1(C,B).
p1534_1(A,B):-p67(A,C),p1534_2(C,B).
p1534_2(A,B):-move_right(A,C),p1356(C,B).
...
p1541_1(A,B):-p987(A,C),p1541_2(C,B).
...
p1576(A,B):-p1424(A,C),p1576_1(C,B).
p1576_1(A,B):-p244(A,C),p1576_2(C,B).
p1576_2(A,B):-p84(A,C),p68(C,B).
p1577(A,B):-p368(A,C),p1577_1(C,B).
p1577_1(A,B):-p84(A,C),move_right(C,B).
...
p1581_1(A,B):-p949(A,C),p1581_2(C,B).
p1581_2(A,B):-p1428(A,C),p506(C,B).
...
b4(A,B):-p379(A,C),p1356(C,B).
b16(A,B):-move_forwards(A,C),p1440(C,B).
b8(A,B):-p810(A,C),p1047(C,B).
b0(A,B):-p710(A,C),p287(C,B).
b7(A,B):-p627(A,C),p442(C,B).
b15(A,B):-p446(A,C),p1424(C,B).
b12(A,B):-p180(A,C),p506(C,B).
...
b19_1(A,B):-p786(A,C),p1332(C,B).
b26(A,B):-p148(A,C),p524(C,B).
b10(A,B):-move_backwards(A,C),b10_1(C,B).
b10_1(A,B):-p1341(A,C),p101(C,B).
b27(A,B):-p1017(A,C),move_left(C,B).
b21(A,B):-move_forwards(A,C),b21_1(C,B).
b21_1(A,B):-p868(A,C),p661(C,B).
b25(A,B):-move_left(A,C),b25_1(C,B).
b25_1(A,B):-p1111(A,C),p720(C,B).
b14(A,B):-move_backwards(A,C),b14_1(C,B).
b14_1(A,B):-p538(A,C),p954(C,B).
b24(A,B):-move_left(A,C),b24_1(C,B).
b24_1(A,B):-p265(A,C),p360(C,B).
b34(A,B):-p1425(A,C),p1075(C,B).
b33(A,B):-move_left(A,C),b33_1(C,B).
b33_1(A,B):-p710(A,C),p1109(C,B).
b30(A,B):-move_left(A,C),b30_1(C,B).
b30_1(A,B):-p166(A,C),move_backwards(C,B).
b36(A,B):-p521(A,C),p661(C,B).
b9(A,B):-p360(A,C),b9_1(C,B).
b9_1(A,B):-p852(A,C),p973(C,B).
b32(A,B):-p184(A,C),b32_1(C,B).
b32_1(A,B):-p4(A,C),p478(C,B).
b1(A,B):-p499(A,C),b1_1(C,B).
b1_1(A,B):-p195(A,C),p360(C,B).
b41(A,B):-p1090(A,B).
b40(A,B):-p398(A,C),p1090(C,B).
...
b46(A,B):-move_left(A,C),p329(C,B).
b44(A,B):-p1090(A,C),p1343(C,B).
b48(A,B):-p1434(A,C),p1165(C,B).
b39(A,B):-move_backwards(A,C),b39_1(C,B).
b39_1(A,B):-p363(A,C),p810(C,B).
b11(A,B):-p368(A,C),b11_1(C,B).
b11_1(A,B):-p974(A,C),p499(C,B).
b28(A,B):-p810(A,C),b28_1(C,B).
b28_1(A,B):-p1425(A,C),p928(C,B).
b49(A,B):-move_left(A,C),b49_1(C,B).
b49_1(A,B):-p557(A,C),p521(C,B).
b45(A,B):-move_left(A,C),b45_1(C,B).
b45_1(A,B):-p1317(A,C),p1488(C,B).
b42(A,B):-move_forwards(A,C),b42_1(C,B).
b42_1(A,B):-p285(A,C),p651(C,B).
b53(A,B):-p1496(A,C),p362(C,B).
b54(A,B):-p1330(A,C),p187(C,B).
b50(A,B):-move_right(A,C),b50_1(C,B).
b50_1(A,B):-p815(A,C),move_right(C,B).
...
b56_1(A,B):-p1523(A,C),p869(C,B).
b3(A,B):-p627(A,C),b3_1(C,B).
b3_1(A,B):-p1065(A,C),p1595(C,B).
b59(A,B):-p1224(A,C),move_forwards(C,B).
b55(A,B):-move_right(A,C),b55_1(C,B).
b55_1(A,B):-p1440(A,C),p368(C,B).
b63(A,B):-p494(A,C),p1378(C,B).
b18(A,B):-p38(A,C),b18_1(C,B).
b18_1(A,B):-move_forwards(A,C),p574(C,B).
b17(A,B):-p1378(A,C),b17_1(C,B).
b17_1(A,B):-p1224(A,C),p500(C,B).
b67(A,B):-grab_ball(A,C),b67_1(C,B).
b67_1(A,B):-p524(A,C),p1440(C,B).
...
b29_1(A,B):-p446(A,C),p506(C,B).
b71(A,B):-move_left(A,C),p1343(C,B).
b72(A,B):-p524(A,C),p1343(C,B).
b60(A,B):-p1107(A,C),b60_1(C,B).
b60_1(A,B):-p208(A,C),p674(C,B).
b74(A,B):-p360(A,C),p147(C,B).
b70(A,B):-move_backwards(A,C),b70_1(C,B).
b70_1(A,B):-p1466(A,C),p521(C,B).
...
b79(A,B):-drop_ball(A,C),p828(C,B).
b80(A,B):-move_left(A,C),b80_1(C,B).
b80_1(A,B):-p986(A,C),drop_ball(C,B).
b81(A,B):-move_left(A,C),p1317(C,B).
b77(A,B):-p184(A,C),b77_1(C,B).
b77_1(A,B):-p344(A,C),p500(C,B).
b83(A,B):-move_right(A,C),p1332(C,B).
b78(A,B):-p1090(A,C),b78_1(C,B).
b78_1(A,B):-p1145(A,C),p1107(C,B).
b84(A,B):-p1090(A,C),b84_1(C,B).
b84_1(A,B):-p59(A,C),p500(C,B).
b76(A,B):-p1246(A,C),b76_1(C,B).
b76_1(A,B):-p101(A,C),p868(C,B).
b87(A,B):-p499(A,C),p592(C,B).
b88(A,B):-move_right(A,C),b88_1(C,B).
b88_1(A,B):-p504(A,C),p1107(C,B).
b89(A,B):-p914(A,C),p810(C,B).
b85(A,B):-p1511(A,C),b85_1(C,B).
b85_1(A,B):-p1344(A,C),p751(C,B).
b90(A,B):-p184(A,C),b90_1(C,B).
b90_1(A,B):-p363(A,C),p1434(C,B).
b92(A,B):-move_left(A,C),b92_1(C,B).
b92_1(A,B):-p475(A,C),p710(C,B).
...
b62_1(A,B):-p1249(A,C),b62_2(C,B).
b62_2(A,B):-p1183(A,C),move_right(C,B).
b52(A,B):-move_right(A,C),b52_1(C,B).
b52_1(A,B):-p231(A,C),b52_2(C,B).
b52_2(A,B):-p1466(A,C),p367(C,B).
b31(A,B):-move_left(A,C),b31_1(C,B).
b31_1(A,B):-p231(A,C),b31_2(C,B).
b31_2(A,B):-p987(A,C),p973(C,B).
b101(A,B):-p949(A,C),p870(C,B).
b102(A,B):-p53(A,C),p360(C,B).
b100(A,B):-p231(A,C),b100_1(C,B).
b100_1(A,B):-p1357(A,C),move_forwards(C,B).
b104(A,B):-p500(A,C),b104_1(C,B).
b104_1(A,B):-p1575(A,C),p831(C,B).
b35(A,B):-move_left(A,C),b35_1(C,B).
b35_1(A,B):-p225(A,C),b35_2(C,B).
b35_2(A,B):-p1466(A,C),move_right(C,B).
b107(A,B):-move_right(A,C),b107_1(C,B).
b107_1(A,B):-p451(A,C),p1356(C,B).
b106(A,B):-p521(A,C),b106_1(C,B).
b106_1(A,B):-p526(A,C),p810(C,B).
b109(A,B):-p1163(A,C),p271(C,B).
b47(A,B):-move_right(A,C),b47_1(C,B).
b47_1(A,B):-p266(A,C),b47_2(C,B).
b47_2(A,B):-p1102(A,C),p521(C,B).
b111(A,B):-p524(A,C),p1226(C,B).
b112(A,B):-move_left(A,C),b112_1(C,B).
b112_1(A,B):-p1048(A,C),p1332(C,B).
b113(A,B):-p1375(A,C),p44(C,B).
b103(A,B):-p287(A,C),b103_1(C,B).
b103_1(A,B):-p868(A,C),p540(C,B).
b115(A,B):-p1356(A,C),p667(C,B).
b116(A,B):-move_right(A,C),b116_1(C,B).
b116_1(A,B):-p67(A,C),p278(C,B).
b114(A,B):-p499(A,C),b114_1(C,B).
b114_1(A,B):-p751(A,C),p627(C,B).
b118(A,B):-p338(A,C),p457(C,B).
b119(A,B):-p1069(A,C),p504(C,B).
b108(A,B):-p208(A,C),b108_1(C,B).
b108_1(A,B):-p1516(A,C),p521(C,B).
b117(A,B):-p101(A,C),b117_1(C,B).
b117_1(A,B):-p47(A,C),move_right(C,B).
b120(A,B):-p713(A,C),b120_1(C,B).
b120_1(A,B):-p254(A,C),p329(C,B).
b98(A,B):-move_left(A,C),b98_1(C,B).
b98_1(A,B):-p1047(A,C),b98_2(C,B).
b98_2(A,B):-p1370(A,C),p1265(C,B).
b121(A,B):-p500(A,C),b121_1(C,B).
b121_1(A,B):-drop_ball(A,C),p1062(C,B).
b125(A,B):-move_backwards(A,C),b125_1(C,B).
b125_1(A,B):-p907(A,C),p1377(C,B).
b123(A,B):-p231(A,C),b123_1(C,B).
b123_1(A,B):-p494(A,C),p710(C,B).
b126(A,B):-p211(A,C),b126_1(C,B).
b126_1(A,B):-p154(A,C),p278(C,B).
b127(A,B):-p651(A,C),b127_1(C,B).
b127_1(A,B):-p1315(A,C),p521(C,B).
b129(A,B):-p960(A,C),p1356(C,B).
b130(A,B):-p1055(A,C),p726(C,B).
b61(A,B):-move_backwards(A,C),b61_1(C,B).
b61_1(A,B):-p558(A,C),b61_2(C,B).
b61_2(A,B):-move_right(A,C),p278(C,B).
b131(A,B):-p713(A,C),b131_1(C,B).
b131_1(A,B):-p436(A,C),p987(C,B).
b132(A,B):-p810(A,C),b132_1(C,B).
b132_1(A,B):-p1584(A,C),p207(C,B).
b133(A,B):-move_left(A,C),b133_1(C,B).
b133_1(A,B):-p1317(A,C),move_forwards(C,B).
...
b110_1(A,B):-p1249(A,C),b110_2(C,B).
b110_2(A,B):-p892(A,C),p299(C,B).
b139(A,B):-p67(A,C),p1062(C,B).
b138(A,B):-p810(A,C),b138_1(C,B).
b138_1(A,B):-p1148(A,C),p1378(C,B).
b136(A,B):-p1434(A,C),b136_1(C,B).
b136_1(A,B):-p946(A,C),p499(C,B).
b142(A,B):-move_left(A,C),b142_1(C,B).
b142_1(A,B):-p357(A,C),p521(C,B).
b143(A,B):-p358(A,C),p1375(C,B).
b144(A,B):-p713(A,C),b144_1(C,B).
b144_1(A,B):-p645(A,C),p1090(C,B).
b141(A,B):-p440(A,C),b141_1(C,B).
b141_1(A,B):-p1246(A,C),move_forwards(C,B).
...
b58_2(A,B):-p973(A,C),move_right(C,B).
b148(A,B):-move_backwards(A,C),b148_1(C,B).
b148_1(A,B):-p1404(A,C),p184(C,B).
b145(A,B):-p1424(A,C),b145_1(C,B).
b145_1(A,B):-p416(A,C),p1356(C,B).
b147(A,B):-p630(A,C),b147_1(C,B).
b147_1(A,B):-p1304(A,C),move_right(C,B).
b124(A,B):-move_left(A,C),b124_1(C,B).
b124_1(A,B):-p1378(A,C),b124_2(C,B).
b124_2(A,B):-p287(A,C),p169(C,B).
b151(A,B):-p713(A,C),b151_1(C,B).
b151_1(A,B):-p318(A,C),p1476(C,B).
b153(A,B):-p944(A,C),p607(C,B).
b154(A,B):-p500(A,C),p278(C,B).
b150(A,B):-p540(A,C),b150_1(C,B).
b150_1(A,B):-p440(A,C),p627(C,B).
b69(A,B):-p184(A,C),b69_1(C,B).
b69_1(A,B):-p349(A,C),b69_2(C,B).
b69_2(A,B):-p607(A,C),p506(C,B).
b157(A,B):-p4(A,C),p1356(C,B).
b152(A,B):-p710(A,C),b152_1(C,B).
b152_1(A,B):-p129(A,C),p506(C,B).
b155(A,B):-p184(A,C),b155_1(C,B).
b155_1(A,B):-p436(A,C),move_forwards(C,B).
b160(A,B):-p211(A,C),b160_1(C,B).
b160_1(A,B):-p877(A,C),p176(C,B).
b156(A,B):-p499(A,C),b156_1(C,B).
b156_1(A,B):-p409(A,C),p896(C,B).
b22(A,B):-move_backwards(A,C),b22_1(C,B).
b22_1(A,B):-p402(A,C),b22_2(C,B).
b22_2(A,B):-p278(A,C),p506(C,B).
b159(A,B):-p211(A,C),b159_1(C,B).
b159_1(A,B):-p1428(A,C),p543(C,B).
b161(A,B):-move_forwards(A,C),b161_1(C,B).
b161_1(A,B):-p1180(A,C),p695(C,B).
b158(A,B):-p231(A,C),b158_1(C,B).
b158_1(A,B):-p428(A,C),p1579(C,B).
b164(A,B):-p506(A,C),p291(C,B).
b166(A,B):-p1434(A,C),p625(C,B).
b168(A,B):-move_left(A,C),b168_1(C,B).
b168_1(A,B):-p1436(A,C),p521(C,B).
b105(A,B):-move_right(A,C),b105_1(C,B).
b105_1(A,B):-p557(A,C),b105_2(C,B).
b105_2(A,B):-move_forwards(A,C),p627(C,B).
b170(A,B):-move_right(A,C),b170_1(C,B).
b170_1(A,B):-p601(A,C),p595(C,B).
b167(A,B):-p500(A,C),b167_1(C,B).
b167_1(A,B):-p1290(A,C),p500(C,B).
b172(A,B):-p157(A,C),p987(C,B).
b162(A,B):-p68(A,C),b162_1(C,B).
b162_1(A,B):-p1570(A,C),p857(C,B).
b163(A,B):-p1356(A,C),b163_1(C,B).
b163_1(A,B):-p16(A,C),p711(C,B).
b175(A,B):-p841(A,C),p500(C,B).
b176(A,B):-move_forwards(A,C),p1566(C,B).
b174(A,B):-move_forwards(A,C),b174_1(C,B).
b174_1(A,B):-p789(A,C),p1249(C,B).
b177(A,B):-move_right(A,C),b177_1(C,B).
b177_1(A,B):-p451(A,C),p499(C,B).
b165(A,B):-p84(A,C),b165_1(C,B).
b165_1(A,B):-p956(A,C),p651(C,B).
b178(A,B):-move_left(A,C),b178_1(C,B).
b178_1(A,B):-p61(A,C),p27(C,B).
b179(A,B):-p521(A,C),b179_1(C,B).
b179_1(A,B):-p1182(A,C),p810(C,B).
b181(A,B):-p1090(A,C),b181_1(C,B).
b181_1(A,B):-p202(A,C),p500(C,B).
b183(A,B):-move_right(A,C),p192(C,B).
b182(A,B):-move_right(A,C),b182_1(C,B).
b182_1(A,B):-p180(A,C),p360(C,B).
b185(A,B):-p540(A,B).
b171(A,B):-p896(A,C),b171_1(C,B).
b171_1(A,B):-p1432(A,C),p487(C,B).
b82(A,B):-p810(A,C),b82_1(C,B).
b82_1(A,B):-p460(A,C),b82_2(C,B).
b82_2(A,B):-p1380(A,C),p1424(C,B).
b188(A,B):-p68(A,C),p593(C,B).
b180(A,B):-p713(A,C),b180_1(C,B).
b180_1(A,B):-p403(A,C),p1356(C,B).
b149(A,B):-move_left(A,C),b149_1(C,B).
b149_1(A,B):-p630(A,C),b149_2(C,B).
b149_2(A,B):-move_forwards(A,C),p278(C,B).
b187(A,B):-move_backwards(A,C),b187_1(C,B).
b187_1(A,B):-p1069(A,C),p1007(C,B).
b192(A,B):-move_forwards(A,C),p791(C,B).
b193(A,B):-p710(A,C),b193_1(C,B).
b193_1(A,B):-p761(A,C),p524(C,B).
b190(A,B):-p713(A,C),b190_1(C,B).
b190_1(A,B):-p1341(A,C),p810(C,B).
b186(A,B):-p225(A,C),b186_1(C,B).
b186_1(A,B):-p101(A,C),p494(C,B).
b195(A,B):-move_right(A,C),b195_1(C,B).
b195_1(A,B):-p771(A,C),p1356(C,B).
b197(A,B):-p1018(A,C),p973(C,B).
b184(A,B):-p436(A,C),b184_1(C,B).
b184_1(A,B):-p295(A,C),p1526(C,B).
b128(A,B):-move_right(A,C),b128_1(C,B).
b128_1(A,B):-p204(A,C),b128_2(C,B).
b128_2(A,B):-drop_ball(A,C),p847(C,B).
b200(A,B):-move_left(A,C),b200_1(C,B).
b200_1(A,B):-p10(A,C),move_forwards(C,B).
b191(A,B):-p1424(A,C),b191_1(C,B).
b191_1(A,B):-p192(A,C),p184(C,B).
b202(A,B):-p1356(A,C),p1182(C,B).
b189(A,B):-p126(A,C),b189_1(C,B).
b189_1(A,B):-p1100(A,C),p1356(C,B).
b201(A,B):-p184(A,C),b201_1(C,B).
b201_1(A,B):-p1380(A,C),p895(C,B).
b204(A,B):-move_left(A,C),b204_1(C,B).
b204_1(A,B):-p1360(A,C),move_left(C,B).
b203(A,B):-p360(A,C),b203_1(C,B).
b203_1(A,B):-p761(A,C),move_backwards(C,B).
b196(A,B):-p208(A,C),b196_1(C,B).
b196_1(A,B):-p1572(A,C),p68(C,B).
b194(A,B):-p244(A,C),b194_1(C,B).
b194_1(A,B):-p1440(A,C),move_forwards(C,B).
b208(A,B):-p710(A,C),p318(C,B).
b209(A,B):-p381(A,C),move_forwards(C,B).
b86(A,B):-p184(A,C),b86_1(C,B).
b86_1(A,B):-p90(A,C),b86_2(C,B).
b86_2(A,B):-p661(A,C),p651(C,B).
b207(A,B):-move_right(A,C),b207_1(C,B).
b207_1(A,B):-p440(A,C),p543(C,B).
b122(A,B):-p184(A,C),b122_1(C,B).
b122_1(A,B):-p1526(A,C),b122_2(C,B).
b122_2(A,B):-p576(A,C),p651(C,B).
b212(A,B):-move_backwards(A,C),b212_1(C,B).
b212_1(A,B):-p363(A,C),p101(C,B).
b213(A,B):-p1090(A,C),b213_1(C,B).
b213_1(A,B):-p1488(A,C),p896(C,B).
b216(A,B):-p405(A,C),move_forwards(C,B).
b210(A,B):-p810(A,C),b210_1(C,B).
b210_1(A,B):-p964(A,C),p863(C,B).
b217(A,B):-p231(A,C),p1436(C,B).
b211(A,B):-p101(A,C),b211_1(C,B).
b211_1(A,B):-p248(A,C),p973(C,B).
...
b219(A,B):-p1090(A,C),b219_1(C,B).
b219_1(A,B):-p380(A,C),p1523(C,B).
...
b223(A,B):-p360(A,C),b223_1(C,B).
b223_1(A,B):-p761(A,C),p1332(C,B).
b226(A,B):-p810(A,C),b226_1(C,B).
b226_1(A,B):-p1217(A,C),p592(C,B).
b230(A,B):-p500(A,C),b230_1(C,B).
b230_1(A,B):-p1182(A,C),p1356(C,B).
b228(A,B):-p1062(A,C),b228_1(C,B).
b228_1(A,B):-p344(A,C),p499(C,B).
b231(A,B):-p896(A,C),b231_1(C,B).
b231_1(A,B):-p661(A,C),p1332(C,B).
b229(A,B):-p1148(A,C),b229_1(C,B).
b229_1(A,B):-p813(A,C),p506(C,B).
b236(A,B):-p1501(A,C),p278(C,B).
b169(A,B):-move_right(A,C),b169_1(C,B).
b169_1(A,B):-p538(A,C),b169_2(C,B).
b169_2(A,B):-p1378(A,C),p84(C,B).
b237(A,B):-p360(A,C),b237_1(C,B).
b237_1(A,B):-p1427(A,C),p1107(C,B).
b239(A,B):-p593(A,B).
b240(A,B):-p1401(A,C),p528(C,B).
b233(A,B):-p101(A,C),b233_1(C,B).
b233_1(A,B):-p1099(A,C),drop_ball(C,B).
b242(A,B):-move_left(A,C),b242_1(C,B).
b242_1(A,B):-p333(A,C),p497(C,B).
b235(A,B):-p1107(A,C),b235_1(C,B).
b235_1(A,B):-p1341(A,C),p1090(C,B).
b244(A,B):-p1356(A,C),p278(C,B).
b243(A,B):-p402(A,C),move_backwards(C,B).
b234(A,B):-p1090(A,C),b234_1(C,B).
b234_1(A,B):-p176(A,C),p627(C,B).
b246(A,B):-p101(A,C),p1427(C,B).
b247(A,B):-p949(A,C),p1065(C,B).
b248(A,B):-p265(A,C),p404(C,B).
b238(A,B):-p68(A,C),b238_1(C,B).
b238_1(A,B):-p47(A,C),p1526(C,B).
b140(A,B):-move_left(A,C),b140_1(C,B).
b140_1(A,B):-p956(A,C),b140_2(C,B).
b140_2(A,B):-p862(A,C),p651(C,B).
b252(A,B):-move_right(A,C),b252_1(C,B).
b252_1(A,B):-p1499(A,C),move_right(C,B).
b251(A,B):-p1090(A,C),b251_1(C,B).
b251_1(A,B):-p1546(A,C),p184(C,B).
b245(A,B):-p360(A,C),b245_1(C,B).
b245_1(A,B):-p1128(A,C),move_left(C,B).
b253(A,B):-move_left(A,C),b253_1(C,B).
b253_1(A,B):-p436(A,C),p651(C,B).
b99(A,B):-p184(A,C),b99_1(C,B).
b99_1(A,B):-p1259(A,C),b99_2(C,B).
b99_2(A,B):-p751(A,C),p1107(C,B).
b255(A,B):-move_right(A,C),b255_1(C,B).
b255_1(A,B):-p302(A,C),p299(C,B).
b257(A,B):-move_left(A,C),b257_1(C,B).
b257_1(A,B):-p896(A,C),p1561(C,B).
b250(A,B):-p278(A,C),b250_1(C,B).
b250_1(A,B):-p1547(A,C),p1428(C,B).
b260(A,B):-p683(A,C),p184(C,B).
b249(A,B):-p739(A,C),b249_1(C,B).
b249_1(A,B):-p54(A,C),p710(C,B).
b198(A,B):-move_left(A,C),b198_1(C,B).
b198_1(A,B):-p10(A,C),b198_2(C,B).
b198_2(A,B):-p1148(A,C),p211(C,B).
b254(A,B):-p810(A,C),b254_1(C,B).
b254_1(A,B):-p526(A,C),move_backwards(C,B).
b264(A,B):-p1163(A,C),p1356(C,B).
b265(A,B):-p665(A,C),p1107(C,B).
b266(A,B):-move_right(A,C),p506(C,B).
b267(A,B):-p627(A,C),p217(C,B).
b262(A,B):-p713(A,C),b262_1(C,B).
b262_1(A,B):-p1148(A,C),p323(C,B).
b259(A,B):-p204(A,C),b259_1(C,B).
b259_1(A,B):-p1062(A,C),p720(C,B).
...
b263(A,B):-p627(A,C),b263_1(C,B).
b263_1(A,B):-p350(A,C),p1062(C,B).
b273(A,B):-p1249(A,C),p1538(C,B).
b271(A,B):-move_right(A,C),b271_1(C,B).
b271_1(A,B):-p1341(A,C),move_left(C,B).
b275(A,B):-move_right(A,C),b275_1(C,B).
b275_1(A,B):-p242(A,C),p627(C,B).
b272(A,B):-grab_ball(A,C),b272_1(C,B).
b272_1(A,B):-move_forwards(A,C),p973(C,B).
b276(A,B):-move_right(A,C),b276_1(C,B).
b276_1(A,B):-p1434(A,C),p89(C,B).
...
b274(A,B):-p1090(A,C),b274_1(C,B).
b274_1(A,B):-p852(A,C),p1577(C,B).
b280(A,B):-move_left(A,C),b280_1(C,B).
b280_1(A,B):-p264(A,C),p1090(C,B).
...
b285_1(A,B):-p592(A,C),move_left(C,B).
b287(A,B):-move_left(A,C),b287_1(C,B).
b287_1(A,B):-p1086(A,C),p1062(C,B).
b241(A,B):-move_left(A,C),b241_1(C,B).
b241_1(A,B):-p1356(A,C),b241_2(C,B).
b241_2(A,B):-p446(A,C),p1424(C,B).
b289(A,B):-move_backwards(A,C),b289_1(C,B).
b289_1(A,B):-p1547(A,C),p67(C,B).
b286(A,B):-p609(A,C),b286_1(C,B).
b286_1(A,B):-p1075(A,C),p440(C,B).
b65(A,B):-p360(A,C),b65_1(C,B).
b65_1(A,B):-p409(A,C),b65_2(C,B).
b65_2(A,B):-p868(A,C),p540(C,B).
b292(A,B):-p1356(A,C),p19(C,B).
b293(A,B):-move_forwards(A,C),b293_1(C,B).
b293_1(A,B):-p244(A,C),p543(C,B).
b173(A,B):-move_forwards(A,C),b173_1(C,B).
b173_1(A,B):-p907(A,C),b173_2(C,B).
b173_2(A,B):-p1090(A,C),p1304(C,B).
b294(A,B):-p231(A,C),b294_1(C,B).
b294_1(A,B):-p374(A,C),p278(C,B).
...
b298(A,B):-p713(A,C),b298_1(C,B).
b298_1(A,B):-p1026(A,C),p415(C,B).
b299(A,B):-p590(A,B).
b295(A,B):-p1526(A,C),b295_1(C,B).
b295_1(A,B):-p1175(A,C),p627(C,B).
b300(A,B):-move_backwards(A,C),b300_1(C,B).
b300_1(A,B):-p343(A,C),p651(C,B).
b302(A,B):-p1086(A,C),p1062(C,B).
b281(A,B):-move_left(A,C),b281_1(C,B).
b281_1(A,B):-p1198(A,C),b281_2(C,B).
b281_2(A,B):-p1163(A,C),p271(C,B).
b297(A,B):-p1356(A,C),b297_1(C,B).
b297_1(A,B):-p1137(A,C),p949(C,B).
b305(A,B):-p627(A,C),p771(C,B).
b301(A,B):-move_left(A,C),b301_1(C,B).
b301_1(A,B):-p1155(A,C),p1579(C,B).
b306(A,B):-move_left(A,C),b306_1(C,B).
b306_1(A,B):-p4(A,C),p358(C,B).
b308(A,B):-p184(A,C),p277(C,B).
b303(A,B):-p101(A,C),b303_1(C,B).
b303_1(A,B):-p788(A,C),p810(C,B).
b307(A,B):-p1090(A,C),b307_1(C,B).
b307_1(A,B):-p10(A,C),p368(C,B).
b310(A,B):-move_left(A,C),b310_1(C,B).
b310_1(A,B):-p217(A,C),move_left(C,B).
b312(A,B):-p651(A,B).
b311(A,B):-move_left(A,C),b311_1(C,B).
b311_1(A,B):-p1137(A,C),p506(C,B).
b313(A,B):-p1485(A,C),move_backwards(C,B).
b315(A,B):-p506(A,C),p290(C,B).
b309(A,B):-p211(A,C),b309_1(C,B).
b309_1(A,B):-p1098(A,C),p787(C,B).
b317(A,B):-p661(A,C),p1576(C,B).
b318(A,B):-p576(A,C),p1049(C,B).
b316(A,B):-move_backwards(A,C),b316_1(C,B).
b316_1(A,B):-p1279(A,C),p360(C,B).
b319(A,B):-move_forwards(A,C),b319_1(C,B).
b319_1(A,B):-p1475(A,C),p1069(C,B).
b314(A,B):-p500(A,C),b314_1(C,B).
b314_1(A,B):-p515(A,C),p500(C,B).
b288(A,B):-move_left(A,C),b288_1(C,B).
b288_1(A,B):-p416(A,C),b288_2(C,B).
b288_2(A,B):-p847(A,C),p627(C,B).
b261(A,B):-move_right(A,C),b261_1(C,B).
b261_1(A,B):-p1356(A,C),b261_2(C,B).
b261_2(A,B):-p1026(A,C),p540(C,B).
b323(A,B):-p521(A,C),b323_1(C,B).
b323_1(A,B):-p420(A,C),p368(C,B).
b325(A,B):-move_forwards(A,C),p928(C,B).
b326(A,B):-p540(A,C),p55(C,B).
b320(A,B):-p543(A,C),b320_1(C,B).
b320_1(A,B):-p1399(A,C),p817(C,B).
b256(A,B):-move_left(A,C),b256_1(C,B).
b256_1(A,B):-p1127(A,C),b256_2(C,B).
b256_2(A,B):-p350(A,C),p627(C,B).
b329(A,B):-p500(A,C),p740(C,B).
b328(A,B):-move_forwards(A,C),b328_1(C,B).
b328_1(A,B):-p362(A,C),p521(C,B).
...
b321(A,B):-p1308(A,C),b321_1(C,B).
b321_1(A,B):-p84(A,C),p1107(C,B).
b73(A,B):-p810(A,C),b73_1(C,B).
b73_1(A,B):-p193(A,C),b73_2(C,B).
b73_2(A,B):-p492(A,C),move_forwards(C,B).
b336(A,B):-p949(A,C),b336_1(C,B).
b336_1(A,B):-p1068(A,C),p521(C,B).
b333(A,B):-p1332(A,C),b333_1(C,B).
b333_1(A,B):-p1055(A,C),p506(C,B).
b337(A,B):-p810(A,C),p1351(C,B).
b338(A,B):-move_forwards(A,C),b338_1(C,B).
b338_1(A,B):-p416(A,C),move_forwards(C,B).
b340(A,B):-p360(A,C),b340_1(C,B).
b340_1(A,B):-p247(A,C),p1356(C,B).
b291(A,B):-move_left(A,C),b291_1(C,B).
b291_1(A,B):-p987(A,C),b291_2(C,B).
b291_2(A,B):-p1492(A,C),p231(C,B).
b270(A,B):-move_right(A,C),b270_1(C,B).
b270_1(A,B):-p1570(A,C),b270_2(C,B).
b270_2(A,B):-p67(A,C),p713(C,B).
b341(A,B):-move_left(A,C),b341_1(C,B).
b341_1(A,B):-p577(A,C),p1357(C,B).
b344(A,B):-move_right(A,C),b344_1(C,B).
b344_1(A,B):-p857(A,C),p1332(C,B).
b345(A,B):-move_right(A,C),b345_1(C,B).
b345_1(A,B):-p1163(A,C),p713(C,B).
b342(A,B):-p810(A,C),b342_1(C,B).
b342_1(A,B):-p475(A,C),move_backwards(C,B).
b205(A,B):-p500(A,C),b205_1(C,B).
b205_1(A,B):-p278(A,C),b205_2(C,B).
b205_2(A,B):-p1102(A,C),p184(C,B).
b347(A,B):-p497(A,C),p357(C,B).
b343(A,B):-p291(A,C),b343_1(C,B).
b343_1(A,B):-p892(A,C),p1378(C,B).
b348(A,B):-move_forwards(A,C),b348_1(C,B).
b348_1(A,B):-p1163(A,C),move_backwards(C,B).
b346(A,B):-p457(A,C),b346_1(C,B).
b346_1(A,B):-p196(A,C),p184(C,B).
b350(A,B):-move_right(A,C),b350_1(C,B).
b350_1(A,B):-p1475(A,C),p1069(C,B).
b353(A,B):-p409(A,C),p184(C,B).
b354(A,B):-p1417(A,C),p710(C,B).
b349(A,B):-p368(A,C),b349_1(C,B).
b349_1(A,B):-p350(A,C),p1360(C,B).
b356(A,B):-move_left(A,C),p1526(C,B).
b351(A,B):-p1356(A,C),b351_1(C,B).
b351_1(A,B):-p1183(A,C),p271(C,B).
b358(A,B):-p540(A,C),p1086(C,B).
b352(A,B):-p557(A,C),b352_1(C,B).
b352_1(A,B):-p512(A,C),p211(C,B).
b359(A,B):-p231(A,C),b359_1(C,B).
b359_1(A,B):-p892(A,C),p710(C,B).
b361(A,B):-p360(A,C),p739(C,B).
b362(A,B):-move_backwards(A,C),b362_1(C,B).
b362_1(A,B):-p847(A,C),p368(C,B).
b258(A,B):-move_forwards(A,C),b258_1(C,B).
b258_1(A,B):-p169(A,C),b258_2(C,B).
b258_2(A,B):-p627(A,C),p1457(C,B).
b357(A,B):-p1193(A,C),b357_1(C,B).
b357_1(A,B):-move_forwards(A,C),p250(C,B).
b364(A,B):-p1090(A,C),b364_1(C,B).
b364_1(A,B):-p887(A,C),p1584(C,B).
b335(A,B):-move_left(A,C),b335_1(C,B).
b335_1(A,B):-p333(A,C),b335_2(C,B).
b335_2(A,B):-p871(A,C),p1062(C,B).
...
b366_1(A,B):-p1127(A,C),p593(C,B).
b369(A,B):-p521(A,C),b369_1(C,B).
b369_1(A,B):-p1334(A,C),p368(C,B).
b371(A,B):-move_right(A,B).
b322(A,B):-move_left(A,C),b322_1(C,B).
b322_1(A,B):-p193(A,C),b322_2(C,B).
b322_2(A,B):-p398(A,C),move_backwards(C,B).
b373(A,B):-p1424(A,C),p109(C,B).
b368(A,B):-p543(A,C),b368_1(C,B).
b368_1(A,B):-p1399(A,C),p1538(C,B).
b375(A,B):-move_left(A,B).
b376(A,B):-p843(A,C),move_forwards(C,B).
b377(A,B):-move_left(A,C),b377_1(C,B).
b377_1(A,B):-p129(A,C),p651(C,B).
b378(A,B):-p184(A,C),b378_1(C,B).
b378_1(A,B):-p363(A,C),p889(C,B).
...
b304_1(A,B):-p841(A,C),b304_2(C,B).
b304_2(A,B):-p1541(A,C),p1526(C,B).
b383(A,B):-move_left(A,C),b383_1(C,B).
b383_1(A,B):-p1572(A,C),p1181(C,B).
b339(A,B):-move_right(A,C),b339_1(C,B).
b339_1(A,B):-p278(A,C),b339_2(C,B).
b339_2(A,B):-p1518(A,C),p1090(C,B).
b385(A,B):-p360(A,C),b385_1(C,B).
b385_1(A,B):-p1055(A,C),p101(C,B).
b384(A,B):-p500(A,C),b384_1(C,B).
b384_1(A,B):-p1163(A,C),move_backwards(C,B).
b386(A,B):-p1356(A,C),b386_1(C,B).
b386_1(A,B):-p289(A,C),move_left(C,B).
b388(A,B):-move_backwards(A,C),p577(C,B).
b389(A,B):-p1090(A,C),b389_1(C,B).
b389_1(A,B):-p61(A,C),p277(C,B).
b387(A,B):-p543(A,C),b387_1(C,B).
b387_1(A,B):-p259(A,C),p651(C,B).
b390(A,B):-move_right(A,C),b390_1(C,B).
b390_1(A,B):-p907(A,C),p285(C,B).
b392(A,B):-p892(A,B).
b391(A,B):-p1434(A,C),p1425(C,B).
b199(A,B):-p184(A,C),b199_1(C,B).
b199_1(A,B):-p90(A,C),b199_2(C,B).
b199_2(A,B):-p1579(A,C),move_left(C,B).
b393(A,B):-move_left(A,C),b393_1(C,B).
b393_1(A,B):-p1428(A,C),p1062(C,B).
...
b397_1(A,B):-p710(A,C),p946(C,B).
b399(A,B):-p360(A,C),b399_1(C,B).
b399_1(A,B):-p398(A,C),p1090(C,B).
...
b363_1(A,B):-p1118(A,C),b363_2(C,B).
b363_2(A,B):-p695(A,C),p627(C,B).
...
b370_1(A,B):-p524(A,C),b370_2(C,B).
b370_2(A,B):-p1436(A,C),p1380(C,B).
b435(A,B):-move_backwards(A,C),b435_1(C,B).
b435_1(A,B):-p1439(A,C),p184(C,B).
b374(A,B):-move_left(A,C),b374_1(C,B).
b374_1(A,B):-p440(A,C),b374_2(C,B).
b374_2(A,B):-p524(A,C),p323(C,B).
b426(A,B):-p540(A,C),b426_1(C,B).
b426_1(A,B):-p169(A,C),p521(C,B).
b424(A,B):-p1332(A,C),b424_1(C,B).
b424_1(A,B):-p438(A,C),p1404(C,B).
b440(A,B):-move_left(A,C),b440_1(C,B).
b440_1(A,B):-p1580(A,C),p356(C,B).
b439(A,B):-p949(A,C),b439_1(C,B).
b439_1(A,B):-p266(A,C),p350(C,B).
b429(A,B):-p710(A,C),b429_1(C,B).
b429_1(A,B):-p711(A,C),p713(C,B).
b437(A,B):-p713(A,C),b437_1(C,B).
b437_1(A,B):-p285(A,C),p1526(C,B).
b444(A,B):-p101(A,C),p625(C,B).
b394(A,B):-move_left(A,C),b394_1(C,B).
b394_1(A,B):-p1373(A,C),b394_2(C,B).
b394_2(A,B):-p1090(A,C),p1369(C,B).
b443(A,B):-p184(A,C),b443_1(C,B).
b443_1(A,B):-p1270(A,C),p401(C,B).
b447(A,B):-p359(A,C),p949(C,B).
b448(A,B):-move_left(A,C),b448_1(C,B).
b448_1(A,B):-p1297(A,C),p55(C,B).
b446(A,B):-p1090(A,C),b446_1(C,B).
b446_1(A,B):-p1548(A,C),move_forwards(C,B).
b450(A,B):-p521(A,C),p153(C,B).
b442(A,B):-p1378(A,C),b442_1(C,B).
b442_1(A,B):-p580(A,C),p540(C,B).
b445(A,B):-p506(A,C),b445_1(C,B).
b445_1(A,B):-p1143(A,C),p540(C,B).
b452(A,B):-p68(A,C),p180(C,B).
b453(A,B):-p1334(A,C),move_forwards(C,B).
b455(A,B):-move_backwards(A,C),b455_1(C,B).
b455_1(A,B):-p329(A,C),p1062(C,B).
b382(A,B):-move_right(A,C),b382_1(C,B).
b382_1(A,B):-p442(A,C),b382_2(C,B).
b382_2(A,B):-p55(A,C),p457(C,B).
...
b454(A,B):-p1047(A,C),b454_1(C,B).
b454_1(A,B):-p116(A,C),p841(C,B).
...
b461(A,B):-p68(A,C),b461_1(C,B).
b461_1(A,B):-p416(A,C),p1356(C,B).
b460(A,B):-p457(A,C),b460_1(C,B).
b460_1(A,B):-p1399(A,C),p521(C,B).
b381(A,B):-move_right(A,C),b381_1(C,B).
b381_1(A,B):-p592(A,C),b381_2(C,B).
b381_2(A,B):-p592(A,C),p368(C,B).
b468(A,B):-p68(A,C),b468_1(C,B).
b468_1(A,B):-p167(A,C),p711(C,B).
b470(A,B):-move_right(A,C),b470_1(C,B).
b470_1(A,B):-p1356(A,C),p265(C,B).
b469(A,B):-p1332(A,C),b469_1(C,B).
b469_1(A,B):-p90(A,C),p1526(C,B).
b472(A,B):-p1356(A,C),b472_1(C,B).
b472_1(A,B):-p987(A,C),p184(C,B).
b474(A,B):-p184(A,C),p28(C,B).
b475(A,B):-p543(A,C),p1224(C,B).
b476(A,B):-p363(A,C),move_left(C,B).
b477(A,B):-move_right(A,C),b477_1(C,B).
b477_1(A,B):-p815(A,C),move_backwards(C,B).
...
b438_1(A,B):-p1476(A,C),b438_2(C,B).
b438_2(A,B):-p1075(A,C),p711(C,B).
b483(A,B):-p1337(A,C),p922(C,B).
b482(A,B):-move_left(A,C),b482_1(C,B).
b482_1(A,B):-p357(A,C),p368(C,B).
b471(A,B):-p1427(A,C),b471_1(C,B).
b471_1(A,B):-p360(A,C),p595(C,B).
b486(A,B):-p1059(A,C),p278(C,B).
b484(A,B):-p810(A,C),b484_1(C,B).
b484_1(A,B):-p318(A,C),p1289(C,B).
b487(A,B):-p360(A,C),b487_1(C,B).
b487_1(A,B):-p1523(A,C),p1538(C,B).
b330(A,B):-p713(A,C),b330_1(C,B).
b330_1(A,B):-p16(A,C),b330_2(C,B).
b330_2(A,B):-p180(A,C),p651(C,B).
b490(A,B):-p1249(A,C),p147(C,B).
b491(A,B):-move_left(A,C),b491_1(C,B).
b491_1(A,B):-p1297(A,C),p1584(C,B).
b488(A,B):-p521(A,C),b488_1(C,B).
b488_1(A,B):-p925(A,C),p150(C,B).
b489(A,B):-p101(A,C),b489_1(C,B).
b489_1(A,B):-p798(A,C),p521(C,B).
b494(A,B):-p506(A,C),p674(C,B).
b495(A,B):-p740(A,C),p101(C,B).
b467(A,B):-move_left(A,C),b467_1(C,B).
b467_1(A,B):-p1439(A,C),b467_2(C,B).
b467_2(A,B):-p285(A,C),p896(C,B).
b492(A,B):-p500(A,C),b492_1(C,B).
b492_1(A,B):-p1584(A,C),p720(C,B).
b493(A,B):-p184(A,C),b493_1(C,B).
b493_1(A,B):-p504(A,C),p323(C,B).
b498(A,B):-p362(A,C),move_backwards(C,B).
b485(A,B):-p592(A,C),b485_1(C,B).
b485_1(A,B):-p500(A,C),p1054(C,B).
b497(A,B):-move_forwards(A,C),b497_1(C,B).
b497_1(A,B):-p866(A,C),p651(C,B).
b501(A,B):-p1090(A,C),p515(C,B).
b502(A,B):-p1075(A,C),p323(C,B).
b504(A,B):-p95(A,C),p153(C,B).
b503(A,B):-p1357(A,C),p101(C,B).
b449(A,B):-move_left(A,C),b449_1(C,B).
b449_1(A,B):-p1163(A,C),b449_2(C,B).
b449_2(A,B):-p928(A,C),move_left(C,B).
b507(A,B):-p68(A,C),p980(C,B).
b505(A,B):-move_right(A,C),b505_1(C,B).
b505_1(A,B):-p529(A,C),p627(C,B).
b499(A,B):-p68(A,C),b499_1(C,B).
b499_1(A,B):-p54(A,C),move_forwards(C,B).
b496(A,B):-p1332(A,C),b496_1(C,B).
b496_1(A,B):-p403(A,C),p1341(C,B).
b509(A,B):-p810(A,C),b509_1(C,B).
b509_1(A,B):-p625(A,C),p810(C,B).
b512(A,B):-p368(A,B).
b508(A,B):-p278(A,C),b508_1(C,B).
b508_1(A,B):-p506(A,C),p847(C,B).
b511(A,B):-p1075(A,C),p1337(C,B).
b500(A,B):-p810(A,C),b500_1(C,B).
b500_1(A,B):-p3(A,C),move_right(C,B).
b516(A,B):-p1378(A,C),p1380(C,B).
b513(A,B):-move_left(A,C),b513_1(C,B).
b513_1(A,B):-p1100(A,C),p368(C,B).
b506(A,B):-p543(A,C),b506_1(C,B).
b506_1(A,B):-p460(A,C),p368(C,B).
b517(A,B):-p360(A,C),b517_1(C,B).
b517_1(A,B):-p854(A,C),move_right(C,B).
b518(A,B):-move_backwards(A,C),b518_1(C,B).
b518_1(A,B):-p1069(A,C),p285(C,B).
b515(A,B):-p360(A,C),b515_1(C,B).
b515_1(A,B):-p209(A,C),move_left(C,B).
b514(A,B):-p500(A,C),b514_1(C,B).
b514_1(A,B):-p551(A,C),p524(C,B).
b510(A,B):-p1090(A,C),b510_1(C,B).
b510_1(A,B):-p204(A,C),p1490(C,B).
b521(A,B):-move_backwards(A,C),b521_1(C,B).
b521_1(A,B):-p538(A,C),drop_ball(C,B).
b522(A,B):-move_left(A,C),b522_1(C,B).
b522_1(A,B):-p90(A,C),p374(C,B).
b525(A,B):-p138(A,C),p278(C,B).
b527(A,B):-drop_ball(A,C),p1264(C,B).
...
b530_1(A,B):-p1461(A,C),p896(C,B).
b519(A,B):-p713(A,C),b519_1(C,B).
b519_1(A,B):-p126(A,C),p1100(C,B).
b532(A,B):-move_left(A,C),b532_1(C,B).
b532_1(A,B):-p1429(A,C),p360(C,B).
b520(A,B):-p1249(A,C),b520_1(C,B).
b520_1(A,B):-p1086(A,C),p1566(C,B).
b531(A,B):-move_forwards(A,C),b531_1(C,B).
b531_1(A,B):-p1270(A,C),p184(C,B).
b535(A,B):-move_left(A,C),b535_1(C,B).
b535_1(A,B):-p712(A,C),move_forwards(C,B).
b534(A,B):-move_forwards(A,C),b534_1(C,B).
b534_1(A,B):-p80(A,C),p1516(C,B).
b536(A,B):-move_right(A,C),b536_1(C,B).
b536_1(A,B):-p601(A,C),p264(C,B).
b538(A,B):-move_forwards(A,C),b538_1(C,B).
b538_1(A,B):-p1411(A,C),p1332(C,B).
b539(A,B):-move_backwards(A,C),b539_1(C,B).
b539_1(A,B):-p1462(A,C),p487(C,B).
b523(A,B):-p116(A,C),b523_1(C,B).
b523_1(A,B):-p1069(A,C),p492(C,B).
b537(A,B):-p101(A,C),b537_1(C,B).
b537_1(A,B):-p786(A,C),p949(C,B).
b542(A,B):-p500(A,C),p196(C,B).
b543(A,B):-p523(A,C),p1062(C,B).
b544(A,B):-p1530(A,C),p129(C,B).
b545(A,B):-move_left(A,C),b545_1(C,B).
b545_1(A,B):-p1109(A,C),p1493(C,B).
b546(A,B):-move_left(A,C),b546_1(C,B).
b546_1(A,B):-p247(A,C),p101(C,B).
b547(A,B):-p890(A,C),p651(C,B).
b541(A,B):-p1090(A,C),b541_1(C,B).
b541_1(A,B):-p1317(A,C),p1079(C,B).
b548(A,B):-p184(A,C),b548_1(C,B).
b548_1(A,B):-p374(A,C),p713(C,B).
b550(A,B):-p521(A,C),b550_1(C,B).
b550_1(A,B):-p607(A,C),p713(C,B).
b549(A,B):-p368(A,C),b549_1(C,B).
b549_1(A,B):-p446(A,C),p360(C,B).
b551(A,B):-move_right(A,C),b551_1(C,B).
b551_1(A,B):-p589(A,C),move_left(C,B).
...
b555_1(A,B):-p987(A,C),p67(C,B).
b556(A,B):-p247(A,C),b556_1(C,B).
b556_1(A,B):-p1062(A,C),p147(C,B).
b557(A,B):-move_left(A,C),p1007(C,B).
b558(A,B):-p810(A,C),p1098(C,B).
b554(A,B):-p343(A,C),b554_1(C,B).
b554_1(A,B):-p1007(A,C),p500(C,B).
b559(A,B):-move_backwards(A,C),b559_1(C,B).
b559_1(A,B):-p411(A,C),p713(C,B).
b528(A,B):-move_left(A,C),b528_1(C,B).
b528_1(A,B):-p210(A,C),b528_2(C,B).
b528_2(A,B):-p416(A,C),p1089(C,B).
b560(A,B):-p810(A,C),b560_1(C,B).
b560_1(A,B):-p363(A,C),p1496(C,B).
b561(A,B):-p521(A,C),b561_1(C,B).
b561_1(A,B):-p1292(A,C),p1356(C,B).
b473(A,B):-move_backwards(A,C),b473_1(C,B).
b473_1(A,B):-p254(A,C),b473_2(C,B).
b473_2(A,B):-p1380(A,C),p651(C,B).
b360(A,B):-p184(A,C),b360_1(C,B).
b360_1(A,B):-p1208(A,C),b360_2(C,B).
b360_2(A,B):-p159(A,C),p627(C,B).
...
b578(A,B):-p211(A,C),b578_1(C,B).
b578_1(A,B):-p409(A,C),p360(C,B).
b579(A,B):-p543(A,C),b579_1(C,B).
b579_1(A,B):-p526(A,C),p101(C,B).
b576(A,B):-p506(A,C),b576_1(C,B).
b576_1(A,B):-p1518(A,C),p713(C,B).
b583(A,B):-p521(A,C),b583_1(C,B).
b583_1(A,B):-p828(A,C),p675(C,B).
b587(A,B):-move_backwards(A,C),p192(C,B).
b585(A,B):-move_backwards(A,C),b585_1(C,B).
b585_1(A,B):-p815(A,C),p1401(C,B).
b529(A,B):-move_left(A,C),b529_1(C,B).
b529_1(A,B):-p160(A,C),b529_2(C,B).
b529_2(A,B):-p1183(A,C),p949(C,B).
b590(A,B):-p360(A,C),p244(C,B).
b591(A,B):-move_left(A,C),b591_1(C,B).
b591_1(A,B):-p896(A,C),p122(C,B).
b592(A,B):-p558(A,C),p711(C,B).
b593(A,B):-p725(A,C),p651(C,B).
b594(A,B):-p1062(A,B).
b232(A,B):-p521(A,C),b232_1(C,B).
b232_1(A,B):-p446(A,C),b232_2(C,B).
b232_2(A,B):-p1098(A,C),p1107(C,B).
b595(A,B):-p1377(A,C),move_right(C,B).
b589(A,B):-p713(A,C),b589_1(C,B).
b589_1(A,B):-p1561(A,C),p1356(C,B).
b588(A,B):-p1090(A,C),b588_1(C,B).
b588_1(A,B):-p2(A,C),p500(C,B).
b597(A,B):-move_backwards(A,C),b597_1(C,B).
b597_1(A,B):-p1542(A,C),p1360(C,B).
b584(A,B):-p282(A,C),b584_1(C,B).
b584_1(A,B):-p544(A,C),p521(C,B).
b599(A,B):-move_backwards(A,C),b599_1(C,B).
b599_1(A,B):-p1065(A,C),move_forwards(C,B).
b602(A,B):-move_left(A,C),b602_1(C,B).
b602_1(A,B):-p1495(A,C),p1424(C,B).
...
b533_1(A,B):-p1399(A,C),b533_2(C,B).
b533_2(A,B):-move_right(A,C),p914(C,B).
b601(A,B):-p101(A,C),b601_1(C,B).
b601_1(A,B):-p420(A,C),p1182(C,B).
...
b598(A,B):-p157(A,C),b598_1(C,B).
b598_1(A,B):-p500(A,C),p1557(C,B).
b615(A,B):-move_left(A,C),b615_1(C,B).
b615_1(A,B):-p1542(A,C),p521(C,B).
...
b621_1(A,B):-p1135(A,C),p278(C,B).
b617(A,B):-p810(A,C),b617_1(C,B).
b617_1(A,B):-p576(A,C),p500(C,B).
b624(A,B):-p184(A,C),b624_1(C,B).
b624_1(A,B):-p154(A,C),p101(C,B).
b625(A,B):-move_left(A,C),p625(C,B).
b623(A,B):-p1155(A,C),b623_1(C,B).
b623_1(A,B):-p360(A,C),p869(C,B).
b596(A,B):-move_left(A,C),b596_1(C,B).
b596_1(A,B):-p1547(A,C),b596_2(C,B).
b596_2(A,B):-p1428(A,C),p68(C,B).
b628(A,B):-move_left(A,C),b628_1(C,B).
b628_1(A,B):-p22(A,C),p1090(C,B).
b432(A,B):-p500(A,C),b432_1(C,B).
b432_1(A,B):-p352(A,C),b432_2(C,B).
b432_2(A,B):-p446(A,C),p368(C,B).
b630(A,B):-p949(A,C),p366(C,B).
b622(A,B):-move_right(A,C),b622_1(C,B).
b622_1(A,B):-p333(A,C),b622_2(C,B).
b622_2(A,B):-p374(A,C),p710(C,B).
b632(A,B):-p360(A,B).
b355(A,B):-p1090(A,C),b355_1(C,B).
b355_1(A,B):-p1069(A,C),b355_2(C,B).
b355_2(A,B):-p877(A,C),p1249(C,B).
b634(A,B):-p329(A,C),p1356(C,B).
b635(A,B):-p1429(A,C),p810(C,B).
b631(A,B):-p457(A,C),b631_1(C,B).
b631_1(A,B):-p288(A,C),p457(C,B).
b637(A,B):-p843(A,C),p506(C,B).
b636(A,B):-move_left(A,C),b636_1(C,B).
b636_1(A,B):-p1255(A,C),p1181(C,B).
...
b633(A,B):-p368(A,C),b633_1(C,B).
b633_1(A,B):-p1098(A,C),p1357(C,B).
b640(A,B):-move_backwards(A,C),b640_1(C,B).
b640_1(A,B):-grab_ball(A,C),p200(C,B).
b643(A,B):-move_backwards(A,C),b643_1(C,B).
b643_1(A,B):-p1526(A,C),p1457(C,B).
b629(A,B):-p504(A,C),b629_1(C,B).
b629_1(A,B):-p1098(A,C),p184(C,B).
b644(A,B):-move_forwards(A,C),b644_1(C,B).
b644_1(A,B):-p670(A,C),p547(C,B).
b646(A,B):-p500(A,C),p393(C,B).
b641(A,B):-p907(A,C),b641_1(C,B).
b641_1(A,B):-p1377(A,C),p360(C,B).
b642(A,B):-p1411(A,C),b642_1(C,B).
b642_1(A,B):-p208(A,C),p457(C,B).
b334(A,B):-p521(A,C),b334_1(C,B).
b334_1(A,B):-p1436(A,C),b334_2(C,B).
b334_2(A,B):-p1538(A,C),p710(C,B).
b648(A,B):-move_backwards(A,C),b648_1(C,B).
b648_1(A,B):-p10(A,C),p506(C,B).
b650(A,B):-p711(A,C),p1424(C,B).
b651(A,B):-p521(A,C),p667(C,B).
b649(A,B):-move_left(A,C),b649_1(C,B).
b649_1(A,B):-p160(A,C),p506(C,B).
b653(A,B):-move_left(A,C),b653_1(C,B).
b653_1(A,B):-p443(A,C),p506(C,B).
b647(A,B):-p1062(A,C),b647_1(C,B).
b647_1(A,B):-p1089(A,C),p500(C,B).
b654(A,B):-move_right(A,C),b654_1(C,B).
b654_1(A,B):-p1028(A,C),p1356(C,B).
b656(A,B):-p500(A,C),b656_1(C,B).
b656_1(A,B):-p478(A,C),p368(C,B).
b657(A,B):-p101(A,C),b657_1(C,B).
b657_1(A,B):-p16(A,C),p503(C,B).
b652(A,B):-p54(A,C),b652_1(C,B).
b652_1(A,B):-p1109(A,C),p360(C,B).
b660(A,B):-p211(A,C),p548(C,B).
b658(A,B):-p368(A,C),b658_1(C,B).
b658_1(A,B):-p1284(A,C),p360(C,B).
b659(A,B):-p368(A,C),b659_1(C,B).
b659_1(A,B):-p1423(A,C),p705(C,B).
b663(A,B):-p1062(A,C),p1343(C,B).
b664(A,B):-p581(A,C),p446(C,B).
b661(A,B):-p521(A,C),b661_1(C,B).
b661_1(A,B):-p601(A,C),p1079(C,B).
b666(A,B):-p1424(A,C),p1079(C,B).
b667(A,B):-move_left(A,B).
b665(A,B):-move_backwards(A,C),b665_1(C,B).
b665_1(A,B):-p1050(A,C),move_right(C,B).
b662(A,B):-p1356(A,C),b662_1(C,B).
b662_1(A,B):-p278(A,C),p329(C,B).
b668(A,B):-move_left(A,C),b668_1(C,B).
b668_1(A,B):-p53(A,C),move_backwards(C,B).
b604(A,B):-p184(A,C),b604_1(C,B).
b604_1(A,B):-p1378(A,C),b604_2(C,B).
b604_2(A,B):-p1377(A,C),p184(C,B).
b669(A,B):-p360(A,C),b669_1(C,B).
b669_1(A,B):-p1067(A,C),p101(C,B).
b670(A,B):-p713(A,C),b670_1(C,B).
b670_1(A,B):-p1065(A,C),p810(C,B).
b673(A,B):-move_right(A,C),b673_1(C,B).
b673_1(A,B):-p67(A,C),p101(C,B).
b671(A,B):-p987(A,C),b671_1(C,B).
b671_1(A,B):-p1091(A,C),move_backwards(C,B).
b674(A,B):-p420(A,C),b674_1(C,B).
b674_1(A,B):-p68(A,C),p78(C,B).
b677(A,B):-p777(A,C),p1356(C,B).
b678(A,B):-move_left(A,C),p420(C,B).
b679(A,B):-p559(A,C),move_right(C,B).
b680(A,B):-move_forwards(A,C),p961(C,B).
b676(A,B):-p506(A,C),b676_1(C,B).
b676_1(A,B):-p1111(A,C),p1091(C,B).
b682(A,B):-p1090(A,C),p709(C,B).
b683(A,B):-p486(A,B).
b681(A,B):-p499(A,C),b681_1(C,B).
b681_1(A,B):-p318(A,C),p500(C,B).
b685(A,B):-move_left(A,C),p362(C,B).
b686(A,B):-move_right(A,C),p499(C,B).
b684(A,B):-move_right(A,C),b684_1(C,B).
b684_1(A,B):-p1107(A,C),p1457(C,B).
b688(A,B):-p480(A,C),p817(C,B).
b687(A,B):-p368(A,C),b687_1(C,B).
b687_1(A,B):-p1462(A,C),p295(C,B).
b690(A,B):-p150(A,C),p1581(C,B).
b689(A,B):-p713(A,C),b689_1(C,B).
b689_1(A,B):-p897(A,C),p1429(C,B).
b692(A,B):-move_right(A,C),b692_1(C,B).
b692_1(A,B):-p843(A,C),p187(C,B).
...
b586(A,B):-p184(A,C),b586_1(C,B).
b586_1(A,B):-p231(A,C),b586_2(C,B).
b586_2(A,B):-p892(A,C),p500(C,B).
b697(A,B):-p148(A,C),p713(C,B).
b698(A,B):-p956(A,C),p627(C,B).
b699(A,B):-move_right(A,C),b699_1(C,B).
b699_1(A,B):-p630(A,C),p1079(C,B).
b696(A,B):-p521(A,C),b696_1(C,B).
b696_1(A,B):-p231(A,C),p980(C,B).
b672(A,B):-move_left(A,C),b672_1(C,B).
b672_1(A,B):-p1356(A,C),b672_2(C,B).
b672_2(A,B):-p1429(A,C),p521(C,B).
b701(A,B):-p184(A,C),b701_1(C,B).
b701_1(A,B):-p344(A,C),p360(C,B).
...
b705(A,B):-p1271(A,C),p334(C,B).
b706(A,B):-move_left(A,C),b706_1(C,B).
b706_1(A,B):-p1595(A,C),p506(C,B).
b707(A,B):-p1198(A,C),p949(C,B).
b708(A,B):-p335(A,C),p543(C,B).
b645(A,B):-move_left(A,C),b645_1(C,B).
b645_1(A,B):-p869(A,C),b645_2(C,B).
b645_2(A,B):-p1075(A,C),p487(C,B).
b466(A,B):-p627(A,C),b466_1(C,B).
b466_1(A,B):-p333(A,C),b466_2(C,B).
b466_2(A,B):-p854(A,C),p184(C,B).
b711(A,B):-move_left(A,C),b711_1(C,B).
b711_1(A,B):-p812(A,C),p251(C,B).
b710(A,B):-p416(A,C),b710_1(C,B).
b710_1(A,B):-p847(A,C),p184(C,B).
b709(A,B):-p379(A,C),b709_1(C,B).
b709_1(A,B):-p857(A,C),move_left(C,B).
b693(A,B):-move_left(A,C),b693_1(C,B).
b693_1(A,B):-p1198(A,C),b693_2(C,B).
b693_2(A,B):-p440(A,C),p360(C,B).
b713(A,B):-p1090(A,C),b713_1(C,B).
b713_1(A,B):-p925(A,C),p506(C,B).
b714(A,B):-p343(A,C),b714_1(C,B).
b714_1(A,B):-p80(A,C),p810(C,B).
b717(A,B):-move_backwards(A,C),p78(C,B).
b718(A,B):-p27(A,C),p1378(C,B).
b716(A,B):-p499(A,C),b716_1(C,B).
b716_1(A,B):-p1428(A,C),p1434(C,B).
b720(A,B):-p78(A,B).
b721(A,B):-p1393(A,C),p506(C,B).
b719(A,B):-p360(A,C),b719_1(C,B).
b719_1(A,B):-p1259(A,C),p1377(C,B).
b655(A,B):-move_forwards(A,C),b655_1(C,B).
b655_1(A,B):-p1546(A,C),b655_2(C,B).
b655_2(A,B):-move_forwards(A,C),p1091(C,B).
b722(A,B):-p810(A,C),b722_1(C,B).
b722_1(A,B):-p862(A,C),p1062(C,B).
b725(A,B):-move_right(A,C),b725_1(C,B).
b725_1(A,B):-p333(A,C),p521(C,B).
b726(A,B):-move_backwards(A,C),b726_1(C,B).
b726_1(A,B):-p1100(A,C),p184(C,B).
b724(A,B):-p278(A,C),b724_1(C,B).
b724_1(A,B):-p118(A,C),p196(C,B).
b728(A,B):-move_left(A,C),b728_1(C,B).
b728_1(A,B):-p1543(A,C),p704(C,B).
b723(A,B):-p47(A,C),b723_1(C,B).
b723_1(A,B):-p1356(A,C),p1181(C,B).
b729(A,B):-move_forwards(A,C),b729_1(C,B).
b729_1(A,B):-p907(A,C),p398(C,B).
b731(A,B):-move_backwards(A,C),b731_1(C,B).
b731_1(A,B):-p118(A,C),p1356(C,B).
b727(A,B):-p949(A,C),b727_1(C,B).
b727_1(A,B):-p746(A,C),p980(C,B).
b733(A,B):-p184(A,B).
b734(A,B):-p1332(A,C),p1220(C,B).
b436(A,B):-p627(A,C),b436_1(C,B).
b436_1(A,B):-p1315(A,C),b436_2(C,B).
b436_2(A,B):-p196(A,C),p1424(C,B).
b730(A,B):-p349(A,C),b730_1(C,B).
b730_1(A,B):-p607(A,C),p101(C,B).
b732(A,B):-p543(A,C),b732_1(C,B).
b732_1(A,B):-p538(A,C),p1090(C,B).
b738(A,B):-p101(A,C),b738_1(C,B).
b738_1(A,B):-p1466(A,C),p740(C,B).
b626(A,B):-p231(A,C),b626_1(C,B).
b626_1(A,B):-p625(A,C),b626_2(C,B).
b626_2(A,B):-p896(A,C),p1517(C,B).
b740(A,B):-p928(A,C),p524(C,B).
b737(A,B):-p150(A,C),b737_1(C,B).
b737_1(A,B):-move_right(A,C),p701(C,B).
b742(A,B):-p500(A,B).
b743(A,B):-move_left(A,C),p940(C,B).
b700(A,B):-move_right(A,C),b700_1(C,B).
b700_1(A,B):-p438(A,C),b700_2(C,B).
b700_2(A,B):-p1402(A,C),p1356(C,B).
b744(A,B):-move_forwards(A,C),b744_1(C,B).
b744_1(A,B):-p862(A,C),p1062(C,B).
b746(A,B):-move_backwards(A,C),b746_1(C,B).
b746_1(A,B):-p1017(A,C),p1356(C,B).
b741(A,B):-p1378(A,C),b741_1(C,B).
b741_1(A,B):-p544(A,C),p506(C,B).
b748(A,B):-move_right(A,C),b748_1(C,B).
b748_1(A,B):-p1332(A,C),p986(C,B).
b745(A,B):-p500(A,C),b745_1(C,B).
b745_1(A,B):-p1128(A,C),p710(C,B).
b750(A,B):-p1107(A,C),p670(C,B).
b749(A,B):-move_right(A,C),b749_1(C,B).
b749_1(A,B):-p564(A,C),p1269(C,B).
b751(A,B):-move_left(A,C),b751_1(C,B).
b751_1(A,B):-p896(A,C),p964(C,B).
...
b754_1(A,B):-p1182(A,C),p540(C,B).
b756(A,B):-move_right(A,C),b756_1(C,B).
b756_1(A,B):-p277(A,C),p810(C,B).
b755(A,B):-p500(A,C),b755_1(C,B).
b755_1(A,B):-p1551(A,C),p1062(C,B).
b758(A,B):-p4(A,C),p101(C,B).
b759(A,B):-move_right(A,C),b759_1(C,B).
b759_1(A,B):-p411(A,C),p627(C,B).
b703(A,B):-move_forwards(A,C),b703_1(C,B).
b703_1(A,B):-p1148(A,C),b703_2(C,B).
b703_2(A,B):-p1424(A,C),p1069(C,B).
b735(A,B):-move_left(A,C),b735_1(C,B).
b735_1(A,B):-p506(A,C),b735_2(C,B).
b735_2(A,B):-p1100(A,C),move_right(C,B).
b715(A,B):-move_left(A,C),b715_1(C,B).
b715_1(A,B):-p434(A,C),b715_2(C,B).
b715_2(A,B):-p184(A,C),p592(C,B).
b757(A,B):-p278(A,C),b757_1(C,B).
b757_1(A,B):-p1054(A,C),p1062(C,B).
b764(A,B):-p350(A,C),p1378(C,B).
b753(A,B):-p746(A,C),b753_1(C,B).
b753_1(A,B):-p1410(A,C),p557(C,B).
b766(A,B):-p1499(A,C),p500(C,B).
b765(A,B):-move_forwards(A,C),b765_1(C,B).
b765_1(A,B):-p265(A,C),p1377(C,B).
b760(A,B):-p278(A,C),b760_1(C,B).
b760_1(A,B):-p946(A,C),move_backwards(C,B).
b763(A,B):-p211(A,C),b763_1(C,B).
b763_1(A,B):-p1098(A,C),p1380(C,B).
b769(A,B):-move_left(A,C),b769_1(C,B).
b769_1(A,B):-p370(A,C),p627(C,B).
b768(A,B):-move_left(A,C),b768_1(C,B).
b768_1(A,B):-p160(A,C),p500(C,B).
b771(A,B):-p1036(A,C),p1495(C,B).
b767(A,B):-move_forwards(A,C),b767_1(C,B).
b767_1(A,B):-p53(A,C),p1439(C,B).
b774(A,B):-p138(A,C),p1261(C,B).
b775(A,B):-p1198(A,C),p368(C,B).
b776(A,B):-move_forwards(A,C),b776_1(C,B).
b776_1(A,B):-p914(A,C),p457(C,B).
b761(A,B):-p1332(A,C),b761_1(C,B).
b761_1(A,B):-p1439(A,C),p896(C,B).
b772(A,B):-p500(A,C),b772_1(C,B).
b772_1(A,B):-p217(A,C),p543(C,B).
b779(A,B):-p710(A,C),p974(C,B).
b613(A,B):-p211(A,C),b613_1(C,B).
b613_1(A,B):-p451(A,C),b613_2(C,B).
b613_2(A,B):-p1149(A,C),p521(C,B).
b780(A,B):-move_right(A,C),b780_1(C,B).
b780_1(A,B):-p554(A,C),p1541(C,B).
b781(A,B):-p713(A,C),b781_1(C,B).
b781_1(A,B):-p16(A,C),p278(C,B).
b783(A,B):-move_right(A,C),p352(C,B).
b784(A,B):-p101(A,C),p590(C,B).
b773(A,B):-p949(A,C),b773_1(C,B).
b773_1(A,B):-p1517(A,C),p521(C,B).
...
b788(A,B):-p184(A,C),b788_1(C,B).
b788_1(A,B):-p98(A,C),p500(C,B).
b778(A,B):-p843(A,C),b778_1(C,B).
b778_1(A,B):-p358(A,C),p368(C,B).
b790(A,B):-move_right(A,C),p506(C,B).
b791(A,B):-p710(A,C),p868(C,B).
b789(A,B):-move_backwards(A,C),b789_1(C,B).
b789_1(A,B):-p1514(A,C),p869(C,B).
b793(A,B):-move_left(A,C),p38(C,B).
b782(A,B):-p440(A,C),b782_1(C,B).
b782_1(A,B):-p1588(A,C),p360(C,B).
b785(A,B):-p68(A,C),b785_1(C,B).
b785_1(A,B):-p1439(A,C),move_forwards(C,B).
b796(A,B):-p499(A,C),p891(C,B).
b739(A,B):-move_left(A,C),b739_1(C,B).
b739_1(A,B):-p68(A,C),b739_2(C,B).
b739_2(A,B):-p1462(A,C),move_forwards(C,B).
b736(A,B):-move_left(A,C),b736_1(C,B).
b736_1(A,B):-p1551(A,C),b736_2(C,B).
b736_2(A,B):-p1098(A,C),p1434(C,B).
b797(A,B):-move_forwards(A,C),b797_1(C,B).
b797_1(A,B):-p914(A,C),p457(C,B).
b798(A,B):-p713(A,C),b798_1(C,B).
b798_1(A,B):-p231(A,C),p123(C,B).
b800(A,B):-move_left(A,C),b800_1(C,B).
b800_1(A,B):-p1079(A,C),p713(C,B).
b795(A,B):-p211(A,C),b795_1(C,B).
b795_1(A,B):-p777(A,C),p1090(C,B).
b792(A,B):-p810(A,C),b792_1(C,B).
b792_1(A,B):-p863(A,C),p1543(C,B).
b802(A,B):-p360(A,C),b802_1(C,B).
b802_1(A,B):-p154(A,C),p627(C,B).
b805(A,B):-p3(A,C),p524(C,B).
b803(A,B):-p710(A,C),b803_1(C,B).
b803_1(A,B):-p1360(A,C),move_forwards(C,B).
b807(A,B):-move_right(A,C),b807_1(C,B).
b807_1(A,B):-p148(A,C),p651(C,B).
b794(A,B):-p1075(A,C),b794_1(C,B).
b794_1(A,B):-p1579(A,C),p543(C,B).
b809(A,B):-p1424(A,C),p1237(C,B).
b804(A,B):-p368(A,C),b804_1(C,B).
b804_1(A,B):-p1098(A,C),p1062(C,B).
b810(A,B):-p713(A,C),p180(C,B).
b801(A,B):-p302(A,C),b801_1(C,B).
b801_1(A,B):-p1270(A,C),p521(C,B).
b812(A,B):-p506(A,C),p849(C,B).
b808(A,B):-move_backwards(A,C),b808_1(C,B).
b808_1(A,B):-p193(A,C),p810(C,B).
b815(A,B):-p847(A,C),p540(C,B).
b799(A,B):-p1378(A,C),b799_1(C,B).
b799_1(A,B):-p711(A,C),p1090(C,B).
b816(A,B):-move_right(A,C),b816_1(C,B).
b816_1(A,B):-p1569(A,C),p184(C,B).
b811(A,B):-p810(A,C),b811_1(C,B).
b811_1(A,B):-p529(A,C),p251(C,B).
b813(A,B):-p101(A,C),b813_1(C,B).
b813_1(A,B):-p453(A,C),p1109(C,B).
b820(A,B):-p841(A,C),p1424(C,B).
b821(A,B):-move_right(A,C),p597(C,B).
b814(A,B):-p500(A,C),b814_1(C,B).
b814_1(A,B):-p482(A,C),p1574(C,B).
b823(A,B):-p627(A,C),p771(C,B).
b824(A,B):-p1090(A,B).
b822(A,B):-move_left(A,C),b822_1(C,B).
b822_1(A,B):-p358(A,C),p949(C,B).
b826(A,B):-move_right(A,C),b826_1(C,B).
b826_1(A,B):-p1069(A,C),p80(C,B).
b825(A,B):-move_forwards(A,C),b825_1(C,B).
b825_1(A,B):-p402(A,C),p367(C,B).
%timeout
b828(A,B):-move_left(A,C),b828_1(C,B).
b828_1(A,B):-p1208(A,C),p532(C,B).
b819(A,B):-p1356(A,C),b819_1(C,B).
b819_1(A,B):-p1183(A,C),p1356(C,B).
b831(A,B):-p1259(A,C),p868(C,B).
b832(A,B):-p1598(A,C),p896(C,B).
b829(A,B):-p713(A,C),b829_1(C,B).
b829_1(A,B):-p1434(A,C),p362(C,B).
b834(A,B):-p1129(A,C),p1270(C,B).
b818(A,B):-p710(A,C),b818_1(C,B).
b818_1(A,B):-p863(A,C),p184(C,B).
b836(A,B):-move_forwards(A,C),b836_1(C,B).
b836_1(A,B):-p1262(A,C),p360(C,B).
b837(A,B):-move_forwards(A,C),b837_1(C,B).
b837_1(A,B):-p1308(A,C),p1428(C,B).
b830(A,B):-p68(A,C),b830_1(C,B).
b830_1(A,B):-p1271(A,C),p176(C,B).
b839(A,B):-p810(A,C),p786(C,B).
b827(A,B):-p7(A,C),b827_1(C,B).
b827_1(A,B):-p1428(A,C),move_left(C,B).
b835(A,B):-p540(A,C),b835_1(C,B).
b835_1(A,B):-p504(A,C),p1107(C,B).
b840(A,B):-move_forwards(A,C),b840_1(C,B).
b840_1(A,B):-p627(A,C),p630(C,B).
b843(A,B):-p1107(A,C),p852(C,B).
b841(A,B):-move_forwards(A,C),b841_1(C,B).
b841_1(A,B):-p16(A,C),move_left(C,B).
b845(A,B):-move_left(A,C),p506(C,B).
b838(A,B):-p360(A,C),b838_1(C,B).
b838_1(A,B):-p673(A,C),p1062(C,B).
b842(A,B):-p810(A,C),b842_1(C,B).
b842_1(A,B):-p788(A,C),p196(C,B).
b770(A,B):-move_right(A,C),b770_1(C,B).
b770_1(A,B):-p506(A,C),b770_2(C,B).
b770_2(A,B):-p590(A,C),p1476(C,B).
b848(A,B):-p500(A,C),b848_1(C,B).
b848_1(A,B):-p1542(A,C),p710(C,B).
b849(A,B):-move_left(A,C),b849_1(C,B).
b849_1(A,B):-p862(A,C),move_backwards(C,B).
b847(A,B):-p521(A,C),b847_1(C,B).
b847_1(A,B):-p863(A,C),move_right(C,B).
b846(A,B):-p368(A,C),b846_1(C,B).
b846_1(A,B):-p475(A,C),p368(C,B).
b844(A,B):-p302(A,C),b844_1(C,B).
b844_1(A,B):-p360(A,C),p742(C,B).
b852(A,B):-move_left(A,C),b852_1(C,B).
b852_1(A,B):-p1026(A,C),p256(C,B).
b855(A,B):-p627(A,C),p1357(C,B).
b856(A,B):-p710(A,C),p1225(C,B).
b857(A,B):-p1378(A,C),p187(C,B).
b853(A,B):-p500(A,C),b853_1(C,B).
b853_1(A,B):-p266(A,C),p360(C,B).
b859(A,B):-p287(A,C),p667(C,B).
b854(A,B):-p360(A,C),b854_1(C,B).
b854_1(A,B):-p438(A,C),p443(C,B).
b712(A,B):-move_forwards(A,C),b712_1(C,B).
b712_1(A,B):-p683(A,C),b712_2(C,B).
b712_2(A,B):-move_forwards(A,C),p499(C,B).
b850(A,B):-p1075(A,C),b850_1(C,B).
b850_1(A,B):-p374(A,C),p500(C,B).
b851(A,B):-p101(A,C),b851_1(C,B).
b851_1(A,B):-p61(A,C),p278(C,B).
b858(A,B):-p543(A,C),b858_1(C,B).
b858_1(A,B):-p589(A,C),p540(C,B).
b862(A,B):-move_backwards(A,C),b862_1(C,B).
b862_1(A,B):-p171(A,C),p521(C,B).
b863(A,B):-p18(A,C),p627(C,B).
b860(A,B):-p949(A,C),b860_1(C,B).
b860_1(A,B):-p787(A,C),p528(C,B).
b861(A,B):-p1090(A,C),b861_1(C,B).
b861_1(A,B):-p1068(A,C),move_left(C,B).
b864(A,B):-move_backwards(A,C),b864_1(C,B).
b864_1(A,B):-p1462(A,C),p540(C,B).
b870(A,B):-p211(A,C),p344(C,B).
b868(A,B):-move_forwards(A,C),b868_1(C,B).
b868_1(A,B):-p265(A,C),move_left(C,B).
b865(A,B):-p856(A,C),b865_1(C,B).
b865_1(A,B):-move_backwards(A,C),p1100(C,B).
b872(A,B):-p506(A,C),b872_1(C,B).
b872_1(A,B):-p630(A,C),p914(C,B).
b867(A,B):-p225(A,C),b867_1(C,B).
b867_1(A,B):-p29(A,C),p651(C,B).
b873(A,B):-p713(A,C),b873_1(C,B).
b873_1(A,B):-p59(A,C),p1090(C,B).
b871(A,B):-p543(A,C),b871_1(C,B).
b871_1(A,B):-p256(A,C),p374(C,B).
b876(A,B):-p651(A,C),p1518(C,B).
b875(A,B):-move_backwards(A,C),b875_1(C,B).
b875_1(A,B):-p524(A,C),p197(C,B).
b874(A,B):-p810(A,C),b874_1(C,B).
b874_1(A,B):-p1068(A,C),p360(C,B).
b880(A,B):-move_forwards(A,C),b880_1(C,B).
b880_1(A,B):-p761(A,C),p1090(C,B).
b881(A,B):-p101(A,C),p401(C,B).
b806(A,B):-move_left(A,C),b806_1(C,B).
b806_1(A,B):-p287(A,C),b806_2(C,B).
b806_2(A,B):-p1068(A,C),p627(C,B).
b878(A,B):-p211(A,C),b878_1(C,B).
b878_1(A,B):-p1208(A,C),p1356(C,B).
b877(A,B):-p72(A,C),b877_1(C,B).
b877_1(A,B):-p868(A,C),p211(C,B).
b885(A,B):-move_left(A,C),b885_1(C,B).
b885_1(A,B):-p1569(A,C),p357(C,B).
b886(A,B):-p1062(A,C),p528(C,B).
b884(A,B):-p360(A,C),b884_1(C,B).
b884_1(A,B):-p751(A,C),move_right(C,B).
b888(A,B):-move_left(A,C),p1423(C,B).
b777(A,B):-move_right(A,C),b777_1(C,B).
b777_1(A,B):-p1246(A,C),b777_2(C,B).
b777_2(A,B):-p101(A,C),p868(C,B).
b890(A,B):-move_right(A,C),b890_1(C,B).
b890_1(A,B):-p1148(A,C),p184(C,B).
b882(A,B):-p116(A,C),b882_1(C,B).
b882_1(A,B):-p440(A,C),p278(C,B).
b892(A,B):-p193(A,C),move_forwards(C,B).
b887(A,B):-p1062(A,C),b887_1(C,B).
b887_1(A,B):-p72(A,C),p499(C,B).
b894(A,B):-p446(A,C),p1062(C,B).
b895(A,B):-move_left(A,C),b895_1(C,B).
b895_1(A,B):-p231(A,C),p1561(C,B).
...
b896_1(A,B):-p1317(A,C),p118(C,B).
b898(A,B):-p184(A,C),b898_1(C,B).
b898_1(A,B):-p1595(A,C),p1143(C,B).
b897(A,B):-p500(A,C),b897_1(C,B).
b897_1(A,B):-p506(A,C),p577(C,B).
b901(A,B):-p910(A,B).
b902(A,B):-move_right(A,C),b902_1(C,B).
b902_1(A,B):-p1516(A,C),p949(C,B).
b903(A,B):-move_right(A,C),b903_1(C,B).
b903_1(A,B):-p374(A,C),move_left(C,B).
b900(A,B):-p184(A,C),b900_1(C,B).
b900_1(A,B):-p475(A,C),p500(C,B).
b905(A,B):-p506(A,C),b905_1(C,B).
b905_1(A,B):-p1111(A,C),p1062(C,B).
b906(A,B):-p487(A,C),p949(C,B).
b907(A,B):-p1075(A,C),p265(C,B).
b908(A,B):-p360(A,C),p847(C,B).
b909(A,B):-move_forwards(A,C),p1028(C,B).
b817(A,B):-move_backwards(A,C),b817_1(C,B).
b817_1(A,B):-p949(A,C),b817_2(C,B).
b817_2(A,B):-p1517(A,C),p231(C,B).
b911(A,B):-p360(A,C),b911_1(C,B).
b911_1(A,B):-p987(A,C),p1534(C,B).
b912(A,B):-p368(A,C),p264(C,B).
b866(A,B):-move_left(A,C),b866_1(C,B).
b866_1(A,B):-p609(A,C),b866_2(C,B).
b866_2(A,B):-p907(A,C),p1068(C,B).
%timeout
b915(A,B):-move_backwards(A,C),b915_1(C,B).
b915_1(A,B):-p219(A,C),move_backwards(C,B).
b916(A,B):-move_left(A,C),b916_1(C,B).
b916_1(A,B):-p828(A,C),p627(C,B).
b833(A,B):-move_backwards(A,C),b833_1(C,B).
b833_1(A,B):-p446(A,C),b833_2(C,B).
b833_2(A,B):-p1062(A,C),p355(C,B).
b913(A,B):-p247(A,C),b913_1(C,B).
b913_1(A,B):-p403(A,C),p1356(C,B).
b919(A,B):-move_forwards(A,C),p10(C,B).
b920(A,B):-p295(A,B).
b921(A,B):-move_forwards(A,C),p925(C,B).
b922(A,B):-move_left(A,C),b922_1(C,B).
b922_1(A,B):-p62(A,C),p1332(C,B).
b918(A,B):-move_backwards(A,C),b918_1(C,B).
b918_1(A,B):-p1581(A,C),p651(C,B).
b924(A,B):-move_left(A,C),b924_1(C,B).
b924_1(A,B):-p973(A,C),p713(C,B).
b925(A,B):-p159(A,C),p1090(C,B).
b926(A,B):-p627(A,C),p3(C,B).
b883(A,B):-move_left(A,C),b883_1(C,B).
b883_1(A,B):-p333(A,C),b883_2(C,B).
b883_2(A,B):-p497(A,C),move_right(C,B).
b917(A,B):-p524(A,C),b917_1(C,B).
b917_1(A,B):-p1284(A,C),p506(C,B).
...
b943_1(A,B):-p1454(A,C),p118(C,B).
b935(A,B):-p500(A,C),b935_1(C,B).
b935_1(A,B):-p1440(A,C),p1526(C,B).
b944(A,B):-p1068(A,C),p360(C,B).
b946(A,B):-move_backwards(A,C),b946_1(C,B).
b946_1(A,B):-p38(A,C),p740(C,B).
b947(A,B):-p101(A,C),p1410(C,B).
b948(A,B):-move_forwards(A,C),b948_1(C,B).
b948_1(A,B):-p1255(A,C),p576(C,B).
b949(A,B):-move_forwards(A,C),p515(C,B).
b950(A,B):-p231(A,C),b950_1(C,B).
b950_1(A,B):-p1516(A,C),p138(C,B).
...
b904_1(A,B):-p210(A,C),b904_2(C,B).
b904_2(A,B):-p558(A,C),p1356(C,B).
b954(A,B):-p1424(A,C),p59(C,B).
%timeout
b956(A,B):-p540(A,B).
b957(A,B):-p810(A,C),p1517(C,B).
b958(A,B):-p184(A,C),p366(C,B).
b955(A,B):-p305(A,C),b955_1(C,B).
b955_1(A,B):-p254(A,C),p1378(C,B).
b953(A,B):-p1411(A,C),b953_1(C,B).
b953_1(A,B):-p616(A,C),p1107(C,B).
b961(A,B):-move_right(A,C),b961_1(C,B).
b961_1(A,B):-p831(A,C),p933(C,B).
b962(A,B):-move_right(A,C),p506(C,B).
b910(A,B):-move_right(A,C),b910_1(C,B).
b910_1(A,B):-p1434(A,C),b910_2(C,B).
b910_2(A,B):-p1581(A,C),p1049(C,B).
b899(A,B):-move_left(A,C),b899_1(C,B).
b899_1(A,B):-p356(A,C),b899_2(C,B).
b899_2(A,B):-p420(A,C),p368(C,B).
b964(A,B):-move_right(A,C),b964_1(C,B).
b964_1(A,B):-p247(A,C),p335(C,B).
b966(A,B):-p101(A,C),p202(C,B).
b959(A,B):-p101(A,C),b959_1(C,B).
b959_1(A,B):-p925(A,C),p740(C,B).
b968(A,B):-p90(A,B).
b967(A,B):-move_forwards(A,C),b967_1(C,B).
b967_1(A,B):-p980(A,C),p524(C,B).
b963(A,B):-p278(A,C),b963_1(C,B).
b963_1(A,B):-p656(A,C),p540(C,B).
b965(A,B):-p710(A,C),b965_1(C,B).
b965_1(A,B):-p980(A,C),p360(C,B).
b971(A,B):-move_left(A,C),b971_1(C,B).
b971_1(A,B):-p27(A,C),p360(C,B).
b914(A,B):-move_left(A,C),b914_1(C,B).
b914_1(A,B):-p287(A,C),b914_2(C,B).
b914_2(A,B):-p1090(A,C),p946(C,B).
b970(A,B):-p500(A,C),b970_1(C,B).
b970_1(A,B):-p460(A,C),move_backwards(C,B).
b969(A,B):-p810(A,C),b969_1(C,B).
b969_1(A,B):-p1089(A,C),p713(C,B).
b976(A,B):-p1435(A,B).
b977(A,B):-move_forwards(A,C),p576(C,B).
b945(A,B):-move_left(A,C),b945_1(C,B).
b945_1(A,B):-p538(A,C),b945_2(C,B).
b945_2(A,B):-p200(A,C),p101(C,B).
b972(A,B):-p1356(A,C),b972_1(C,B).
b972_1(A,B):-p656(A,C),p1090(C,B).
b973(A,B):-p521(A,C),b973_1(C,B).
b973_1(A,B):-p1466(A,C),p1356(C,B).
b981(A,B):-p1098(A,C),p1062(C,B).
b975(A,B):-p810(A,C),b975_1(C,B).
b975_1(A,B):-p1225(A,C),p1090(C,B).
b983(A,B):-move_forwards(A,C),b983_1(C,B).
b983_1(A,B):-p78(A,C),p949(C,B).
b982(A,B):-p184(A,C),b982_1(C,B).
b982_1(A,B):-p1377(A,C),p388(C,B).
b985(A,B):-p1370(A,C),p580(C,B).
b980(A,B):-p949(A,C),b980_1(C,B).
b980_1(A,B):-p1025(A,C),p933(C,B).
b974(A,B):-p543(A,C),b974_1(C,B).
b974_1(A,B):-p1373(A,C),p122(C,B).
b988(A,B):-p184(A,B).
b978(A,B):-p1107(A,C),b978_1(C,B).
b978_1(A,B):-p554(A,C),p651(C,B).
b990(A,B):-p521(A,C),p675(C,B).
b979(A,B):-p1399(A,C),b979_1(C,B).
b979_1(A,B):-p271(A,C),p68(C,B).
...
b984(A,B):-p713(A,C),b984_1(C,B).
b984_1(A,B):-p786(A,C),p949(C,B).
b994(A,B):-p360(A,C),b994_1(C,B).
b994_1(A,B):-p244(A,C),p1534(C,B).
b931(A,B):-move_forwards(A,C),b931_1(C,B).
b931_1(A,B):-p1530(A,C),b931_2(C,B).
b931_2(A,B):-p1424(A,C),p19(C,B).
b997(A,B):-p1270(A,C),p506(C,B).
b998(A,B):-p265(A,C),p475(C,B).
b987(A,B):-p1062(A,C),b987_1(C,B).
b987_1(A,B):-p817(A,C),move_left(C,B).
b991(A,B):-p543(A,C),b991_1(C,B).
b991_1(A,B):-p1255(A,C),p910(C,B).
b993(A,B):-p1365(A,C),b993_1(C,B).
b993_1(A,B):-p101(A,C),p582(C,B).
b999(A,B):-p360(A,C),b999_1(C,B).
b999_1(A,B):-p701(A,C),p651(C,B).
b996(A,B):-p1530(A,C),b996_1(C,B).
b996_1(A,B):-p810(A,C),p403(C,B).
%timeout
b869(A,B):-move_backwards(A,C),b869_1(C,B).
b869_1(A,B):-p949(A,C),b869_2(C,B).
b869_2(A,B):-p711(A,C),move_right(C,B).
b762(A,B):-p231(A,C),b762_1(C,B).
b762_1(A,B):-p681(A,C),b762_2(C,B).
b762_2(A,B):-move_right(A,C),p1107(C,B).
b675(A,B):-p540(A,C),b675_1(C,B).
b675_1(A,B):-p1118(A,C),b675_2(C,B).
b675_2(A,B):-p817(A,C),p949(C,B).
b879(A,B):-p1356(A,C),b879_1(C,B).
b879_1(A,B):-p1473(A,C),b879_2(C,B).
b879_2(A,B):-p713(A,C),p1476(C,B).
b986(A,B):-move_right(A,C),b986_1(C,B).
b986_1(A,B):-p398(A,C),b986_2(C,B).
b986_2(A,B):-move_right(A,C),p946(C,B).
b960(A,B):-p184(A,C),b960_1(C,B).
b960_1(A,B):-p856(A,C),b960_2(C,B).
b960_2(A,B):-move_forwards(A,C),p616(C,B).
b891(A,B):-p1356(A,C),b891_1(C,B).
b891_1(A,B):-p202(A,C),b891_2(C,B).
b891_2(A,B):-p521(A,C),p506(C,B).
b995(A,B):-p1090(A,C),b995_1(C,B).
b995_1(A,B):-p1375(A,C),b995_2(C,B).
b995_2(A,B):-p946(A,C),p360(C,B).
b940(A,B):-p500(A,C),b940_1(C,B).
b940_1(A,B):-p1098(A,C),b940_2(C,B).
b940_2(A,B):-p787(A,C),p368(C,B).
% num solved 996
true.

...
% asserting p1879/2
% depth 3
p0(A,B):-p492(A,C),p0_1(C,B).
p0_1(A,B):-p922(A,C),p0_2(C,B).
p0_2(A,B):-p258(A,C),move_forwards(C,B).
p1(A,B):-p1388(A,C),p1_1(C,B).
p1_1(A,B):-p1020(A,C),p1_2(C,B).
p1_2(A,B):-p409(A,C),p780(C,B).
p2(A,B):-move_forwards(A,C),p2_1(C,B).
...
p5(A,B):-p1388(A,C),p5_1(C,B).
p5_1(A,B):-p1020(A,C),p5_2(C,B).
p5_2(A,B):-p409(A,C),p255(C,B).
p6(A,B):-p922(A,C),p6_1(C,B).
p6_1(A,B):-p975(A,C),p662(C,B).
p8(A,B):-grab_ball(A,C),p8_1(C,B).
p8_1(A,B):-move_forwards(A,C),p8_2(C,B).
p8_2(A,B):-p662(A,C),p838(C,B).
p10(A,B):-p1555(A,C),p10_1(C,B).
p10_1(A,B):-p1753(A,C),p10_2(C,B).
p10_2(A,B):-move_backwards(A,C),p512(C,B).
...
p16_2(A,B):-p409(A,C),p492(C,B).
p17(A,B):-p1224(A,C),p17_1(C,B).
p17_1(A,B):-p1100(A,C),p17_2(C,B).
p17_2(A,B):-p1459(A,C),p112(C,B).
p19(A,B):-move_forwards(A,C),p19_1(C,B).
p19_1(A,B):-p1564(A,C),p19_2(C,B).
p19_2(A,B):-p662(A,C),p510(C,B).
p23(A,B):-p1020(A,C),p23_1(C,B).
p23_1(A,B):-p975(A,C),p23_2(C,B).
p23_2(A,B):-p1459(A,C),p516(C,B).
p24(A,B):-p975(A,C),p24_1(C,B).
p24_1(A,B):-p1753(A,C),p24_2(C,B).
...
p54(A,B):-p975(A,C),p54_1(C,B).
p54_1(A,B):-p985(A,C),p54_2(C,B).
p54_2(A,B):-p868(A,C),p1370(C,B).
p56(A,B):-p922(A,C),p56_1(C,B).
p56_1(A,B):-move_forwards(A,C),p56_2(C,B).
p56_2(A,B):-p258(A,C),p1388(C,B).
p57(A,B):-move_forwards(A,C),p57_1(C,B).
p57_1(A,B):-grab_ball(A,C),p57_2(C,B).
p57_2(A,B):-p1459(A,C),p1195(C,B).
p58(A,B):-p1020(A,C),p58_1(C,B).
p58_1(A,B):-p1740(A,C),p58_2(C,B).
p58_2(A,B):-drop_ball(A,C),p838(C,B).
p59(A,B):-p1753(A,C),p59_1(C,B).
p59_1(A,B):-move_forwards(A,C),p59_2(C,B).
p59_2(A,B):-p512(A,C),p947(C,B).
p63(A,B):-p985(A,C),p63_1(C,B).
p63_1(A,B):-p1388(A,C),p63_2(C,B).
p63_2(A,B):-p662(A,C),p1116(C,B).
p66(A,B):-p975(A,C),p66_1(C,B).
p66_1(A,B):-p1753(A,C),p66_2(C,B).
...
p93(A,B):-p484(A,C),p93_1(C,B).
p93_1(A,B):-p1020(A,C),p93_2(C,B).
p93_2(A,B):-p255(A,C),p1459(C,B).
p94(A,B):-p1224(A,C),p94_1(C,B).
p94_1(A,B):-p947(A,C),p94_2(C,B).
p94_2(A,B):-p258(A,C),p1333(C,B).
p95(A,B):-p235(A,C),p95_1(C,B).
p95_1(A,B):-p512(A,C),p516(C,B).
...
p98_1(A,B):-p1600(A,C),p98_2(C,B).
p98_2(A,B):-p512(A,C),p780(C,B).
...
p111(A,B):-p1020(A,C),p111_1(C,B).
p111_1(A,B):-p1600(A,C),p258(C,B).
...
p120_1(A,B):-p1100(A,C),p120_2(C,B).
p120_2(A,B):-p258(A,C),p1333(C,B).
p121(A,B):-move_backwards(A,C),p121_1(C,B).
p121_1(A,B):-p1020(A,C),drop_ball(C,B).
p125(A,B):-p922(A,C),p125_1(C,B).
p125_1(A,B):-p1600(A,C),p125_2(C,B).
p125_2(A,B):-p1459(A,C),p947(C,B).
p128(A,B):-p1224(A,C),p128_1(C,B).
p128_1(A,B):-p510(A,C),p128_2(C,B).
p128_2(A,B):-p1459(A,C),p736(C,B).
p130(A,B):-p1049(A,C),p130_1(C,B).
p130_1(A,B):-p555(A,C),p130_2(C,B).
...
p134_1(A,B):-p1753(A,C),p134_2(C,B).
p134_2(A,B):-p293(A,C),p662(C,B).
...
p141_1(A,B):-p985(A,C),p141_2(C,B).
p141_2(A,B):-drop_ball(A,C),p369(C,B).
p144(A,B):-move_right(A,C),p144_1(C,B).
p144_1(A,B):-p895(A,C),p144_2(C,B).
p144_2(A,B):-p512(A,C),p1333(C,B).
p148(A,B):-move_left(A,C),p148_1(C,B).
p148_1(A,B):-p1370(A,C),p1600(C,B).
...
p155(A,B):-p664(A,C),p155_1(C,B).
p155_1(A,B):-p895(A,C),p155_2(C,B).
p155_2(A,B):-move_backwards(A,C),p1459(C,B).
p156(A,B):-p484(A,C),p156_1(C,B).
p156_1(A,B):-grab_ball(A,C),p156_2(C,B).
p156_2(A,B):-p258(A,C),p664(C,B).
...
p170_1(A,B):-p492(A,C),p170_2(C,B).
p170_2(A,B):-p409(A,C),p1600(C,B).
...
p193(A,B):-p369(A,C),p193_1(C,B).
p193_1(A,B):-p1459(A,C),p115(C,B).
p194(A,B):-p985(A,C),p194_1(C,B).
p194_1(A,B):-move_backwards(A,C),p194_2(C,B).
p194_2(A,B):-p258(A,C),move_forwards(C,B).
p195(A,B):-p664(A,C),p195_1(C,B).
p195_1(A,B):-p922(A,C),p195_2(C,B).
p195_2(A,B):-move_right(A,C),p1459(C,B).
p197(A,B):-p985(A,C),p197_1(C,B).
p197_1(A,B):-p975(A,C),p197_2(C,B).
p197_2(A,B):-p1459(A,C),p947(C,B).
p198(A,B):-move_forwards(A,C),p198_1(C,B).
p198_1(A,B):-p1564(A,C),p198_2(C,B).
p198_2(A,B):-p1116(A,C),p258(C,B).
p201(A,B):-p1564(A,C),p201_1(C,B).
p201_1(A,B):-p1459(A,C),p1833(C,B).
p207(A,B):-p555(A,C),p207_1(C,B).
p207_1(A,B):-p1100(A,C),p207_2(C,B).
p207_2(A,B):-p1522(A,C),p1600(C,B).
...
p220(A,B):-p1116(A,C),p220_1(C,B).
p220_1(A,B):-p1020(A,C),p220_2(C,B).
...
p227_2(A,B):-p780(A,C),p1459(C,B).
p228(A,B):-p293(A,C),p228_1(C,B).
p228_1(A,B):-p895(A,C),p228_2(C,B).
...
p230(A,B):-p834(A,C),p230_1(C,B).
p230_1(A,B):-p895(A,C),p230_2(C,B).
p230_2(A,B):-p1459(A,C),p1116(C,B).
p232(A,B):-p985(A,C),p232_1(C,B).
p232_1(A,B):-p1667(A,C),p1459(C,B).
p234(A,B):-p922(A,C),p234_1(C,B).
p234_1(A,B):-p975(A,C),p234_2(C,B).
p234_2(A,B):-p1522(A,C),p7(C,B).
...
p245(A,B):-p484(A,C),p245_1(C,B).
p245_1(A,B):-p985(A,C),p245_2(C,B).
p245_2(A,B):-p1459(A,C),move_right(C,B).
p246(A,B):-p985(A,C),p246_1(C,B).
p246_1(A,B):-p484(A,C),p246_2(C,B).
p246_2(A,B):-p1388(A,C),p1370(C,B).
...
p253_2(A,B):-p409(A,C),p1195(C,B).
p254(A,B):-move_right(A,C),p254_1(C,B).
p254_1(A,B):-grab_ball(A,C),p254_2(C,B).
p254_2(A,B):-p838(A,C),p258(C,B).
p256(A,B):-p1020(A,C),p256_1(C,B).
p256_1(A,B):-p834(A,C),p256_2(C,B).
p256_2(A,B):-p258(A,C),p1555(C,B).
...
p262(A,B):-p484(A,C),p262_1(C,B).
p262_1(A,B):-p1753(A,C),p262_2(C,B).
p262_2(A,B):-p1370(A,C),p1600(C,B).
...
p280(A,B):-p1388(A,C),p280_1(C,B).
p280_1(A,B):-p409(A,C),p1116(C,B).
p285(A,B):-p1224(A,C),p285_1(C,B).
p285_1(A,B):-p112(A,C),p662(C,B).
p286(A,B):-move_backwards(A,C),p286_1(C,B).
p286_1(A,B):-p1753(A,C),p286_2(C,B).
p286_2(A,B):-p1749(A,C),drop_ball(C,B).
...
p292_2(A,B):-p258(A,C),p1116(C,B).
p295(A,B):-grab_ball(A,C),p295_1(C,B).
p295_1(A,B):-p235(A,C),p1459(C,B).
p296(A,B):-p484(A,C),p296_1(C,B).
p296_1(A,B):-p1020(A,C),p296_2(C,B).
p296_2(A,B):-move_backwards(A,C),p1459(C,B).
...
p301(A,B):-p975(A,C),p301_1(C,B).
p301_1(A,B):-p555(A,C),p301_2(C,B).
p301_2(A,B):-p1459(A,C),move_right(C,B).
p303(A,B):-p975(A,C),p303_1(C,B).
p303_1(A,B):-p1753(A,C),p303_2(C,B).
p303_2(A,B):-p258(A,C),p1749(C,B).
p304(A,B):-p1564(A,C),p304_1(C,B).
p304_1(A,B):-p492(A,C),p304_2(C,B).
p304_2(A,B):-p512(A,C),p1116(C,B).
...
p318_2(A,B):-p1600(A,C),p1522(C,B).
...
p348(A,B):-p1116(A,C),p348_1(C,B).
p348_1(A,B):-p1020(A,C),p348_2(C,B).
p348_2(A,B):-p258(A,C),p510(C,B).
p350(A,B):-p975(A,C),p350_1(C,B).
p350_1(A,B):-p1564(A,C),p350_2(C,B).
...
p358_1(A,B):-p1020(A,C),p112(C,B).
p362(A,B):-p1224(A,C),p362_1(C,B).
p362_1(A,B):-p115(A,C),p362_2(C,B).
p362_2(A,B):-p512(A,C),p838(C,B).
p363(A,B):-p736(A,C),p363_1(C,B).
p363_1(A,B):-p1564(A,C),p363_2(C,B).
p363_2(A,B):-p1459(A,C),p293(C,B).
p364(A,B):-p235(A,C),p364_1(C,B).
p364_1(A,B):-p985(A,C),p364_2(C,B).
p364_2(A,B):-p258(A,C),p947(C,B).
p368(A,B):-p293(A,C),p368_1(C,B).
p368_1(A,B):-p895(A,C),p368_2(C,B).
p368_2(A,B):-p369(A,C),drop_ball(C,B).
p372(A,B):-p975(A,C),p372_1(C,B).
p372_1(A,B):-p1020(A,C),p372_2(C,B).
...
p380(A,B):-p947(A,C),p380_1(C,B).
p380_1(A,B):-p985(A,C),p380_2(C,B).
p380_2(A,B):-drop_ball(A,C),move_left(C,B).
p381(A,B):-p1333(A,C),p381_1(C,B).
p381_1(A,B):-p922(A,C),move_forwards(C,B).
...
p413(A,B):-p834(A,C),p413_1(C,B).
p413_1(A,B):-p922(A,C),p413_2(C,B).
p413_2(A,B):-p1749(A,C),p662(C,B).
p414(A,B):-p369(A,C),p414_1(C,B).
p414_1(A,B):-p555(A,C),p414_2(C,B).
p414_2(A,B):-move_backwards(A,C),p512(C,B).
p415(A,B):-move_left(A,C),p415_1(C,B).
p415_1(A,B):-p112(A,C),p985(C,B).
...
p425(A,B):-p1369(A,C),p425_1(C,B).
p425_1(A,B):-p985(A,C),p425_2(C,B).
p425_2(A,B):-p664(A,C),p1459(C,B).
p426(A,B):-p834(A,C),p426_1(C,B).
p426_1(A,B):-p922(A,C),p426_2(C,B).
p426_2(A,B):-p258(A,C),p838(C,B).
p428(A,B):-p492(A,C),p428_1(C,B).
p428_1(A,B):-p1564(A,C),p428_2(C,B).
p428_2(A,B):-p1600(A,C),drop_ball(C,B).
p429(A,B):-p112(A,C),p429_1(C,B).
p429_1(A,B):-p1753(A,C),p429_2(C,B).
p429_2(A,B):-p258(A,C),p975(C,B).
p430(A,B):-p1224(A,C),p430_1(C,B).
p430_1(A,B):-move_left(A,C),p430_2(C,B).
p430_2(A,B):-p258(A,C),p1833(C,B).
p434(A,B):-p593(A,C),p434_1(C,B).
p434_1(A,B):-p895(A,C),p434_2(C,B).
...
p441(A,B):-p516(A,C),p441_1(C,B).
p441_1(A,B):-p922(A,C),p593(C,B).
p443(A,B):-p555(A,C),p443_1(C,B).
p443_1(A,B):-p293(A,C),p443_2(C,B).
p443_2(A,B):-p258(A,C),move_backwards(C,B).
p444(A,B):-p1224(A,C),p444_1(C,B).
p444_1(A,B):-move_left(A,C),p444_2(C,B).
p444_2(A,B):-p1459(A,C),move_forwards(C,B).
p448(A,B):-move_forwards(A,C),p448_1(C,B).
p448_1(A,B):-grab_ball(A,C),p448_2(C,B).
p448_2(A,B):-move_forwards(A,C),p409(C,B).
p449(A,B):-p1224(A,C),p449_1(C,B).
p449_1(A,B):-p293(A,C),p449_2(C,B).
p449_2(A,B):-p258(A,C),p1740(C,B).
...
p458_1(A,B):-p115(A,C),p458_2(C,B).
p458_2(A,B):-drop_ball(A,C),move_backwards(C,B).
p460(A,B):-p985(A,C),p460_1(C,B).
p460_1(A,B):-p1369(A,C),p460_2(C,B).
p460_2(A,B):-p1522(A,C),move_forwards(C,B).
p461(A,B):-p115(A,C),p461_1(C,B).
p461_1(A,B):-grab_ball(A,C),p461_2(C,B).
p461_2(A,B):-p258(A,C),p838(C,B).
...
p477_1(A,B):-p1195(A,C),p477_2(C,B).
p477_2(A,B):-p409(A,C),p947(C,B).
p481(A,B):-p975(A,C),p481_1(C,B).
p481_1(A,B):-p1753(A,C),p481_2(C,B).
...
p505_2(A,B):-p868(A,C),drop_ball(C,B).
...
p511(A,B):-p1116(A,C),p511_1(C,B).
p511_1(A,B):-p922(A,C),p511_2(C,B).
p511_2(A,B):-p115(A,C),drop_ball(C,B).
p513(A,B):-p1564(A,C),p513_1(C,B).
p513_1(A,B):-p258(A,C),p834(C,B).
p514(A,B):-p1049(A,C),p514_1(C,B).
p514_1(A,B):-p555(A,C),p514_2(C,B).
...
p527_1(A,B):-p484(A,C),p527_2(C,B).
p527_2(A,B):-drop_ball(A,C),p1100(C,B).
...
p536(A,B):-p1388(A,C),p536_1(C,B).
p536_1(A,B):-p1564(A,C),p536_2(C,B).
p536_2(A,B):-drop_ball(A,C),move_backwards(C,B).
p537(A,B):-p985(A,C),p537_1(C,B).
p537_1(A,B):-p868(A,C),p537_2(C,B).
p537_2(A,B):-p1459(A,C),p7(C,B).
p539(A,B):-move_left(A,C),p539_1(C,B).
p539_1(A,B):-p1753(A,C),p539_2(C,B).
p539_2(A,B):-p1459(A,C),p1333(C,B).
p542(A,B):-p985(A,C),p542_1(C,B).
p542_1(A,B):-move_forwards(A,C),p542_2(C,B).
p542_2(A,B):-p512(A,C),p868(C,B).
p546(A,B):-p838(A,C),p546_1(C,B).
p546_1(A,B):-grab_ball(A,C),p546_2(C,B).
p546_2(A,B):-p1459(A,C),p369(C,B).
p550(A,B):-move_right(A,C),p550_1(C,B).
p550_1(A,B):-p555(A,C),p550_2(C,B).
p550_2(A,B):-p512(A,C),p235(C,B).
p552(A,B):-move_left(A,C),p552_1(C,B).
p552_1(A,B):-p985(A,C),p552_2(C,B).
p552_2(A,B):-p834(A,C),p258(C,B).
p553(A,B):-move_left(A,C),p553_1(C,B).
p553_1(A,B):-p1224(A,C),p553_2(C,B).
p553_2(A,B):-p1459(A,C),p516(C,B).
p554(A,B):-p1564(A,C),p554_1(C,B).
p554_1(A,B):-move_backwards(A,C),p554_2(C,B).
...
p560(A,B):-p1224(A,C),p560_1(C,B).
p560_1(A,B):-p492(A,C),p560_2(C,B).
p560_2(A,B):-p409(A,C),p975(C,B).
...
p572_1(A,B):-p1753(A,C),p572_2(C,B).
p572_2(A,B):-p1388(A,C),p1459(C,B).
p574(A,B):-move_left(A,C),p574_1(C,B).
p574_1(A,B):-p1100(A,C),p574_2(C,B).
p574_2(A,B):-p258(A,C),p664(C,B).
...
p581_2(A,B):-p258(A,C),p1116(C,B).
p582(A,B):-p1020(A,C),p582_1(C,B).
p582_1(A,B):-p293(A,C),p582_2(C,B).
p582_2(A,B):-p258(A,C),p1833(C,B).
...
p587_1(A,B):-p868(A,C),p587_2(C,B).
p587_2(A,B):-drop_ball(A,C),p1740(C,B).
p588(A,B):-p1020(A,C),p588_1(C,B).
p588_1(A,B):-p7(A,C),p588_2(C,B).
p588_2(A,B):-p1459(A,C),p369(C,B).
p589(A,B):-p985(A,C),p589_1(C,B).
p589_1(A,B):-p492(A,C),p589_2(C,B).
p589_2(A,B):-drop_ball(A,C),move_left(C,B).
p590(A,B):-p510(A,C),p590_1(C,B).
p590_1(A,B):-p922(A,C),p590_2(C,B).
p590_2(A,B):-drop_ball(A,C),p293(C,B).
p591(A,B):-move_forwards(A,C),p591_1(C,B).
p591_1(A,B):-p1753(A,C),p591_2(C,B).
p591_2(A,B):-p838(A,C),p258(C,B).
...
p609_1(A,B):-p1740(A,C),p609_2(C,B).
p609_2(A,B):-p258(A,C),p1749(C,B).
...
p631_1(A,B):-p1740(A,C),p631_2(C,B).
p631_2(A,B):-drop_ball(A,C),p516(C,B).
...
p649_1(A,B):-p1020(A,C),p649_2(C,B).
p649_2(A,B):-p409(A,C),p975(C,B).
p650(A,B):-p1224(A,C),p650_1(C,B).
p650_1(A,B):-p736(A,C),p650_2(C,B).
p650_2(A,B):-p1370(A,C),p1600(C,B).
p652(A,B):-p1116(A,C),p652_1(C,B).
p652_1(A,B):-p1753(A,C),p652_2(C,B).
p652_2(A,B):-p258(A,C),p1600(C,B).
...
p657(A,B):-p1195(A,C),p657_1(C,B).
p657_1(A,B):-p922(A,C),p657_2(C,B).
...
p666_1(A,B):-p369(A,C),p666_2(C,B).
p666_2(A,B):-drop_ball(A,C),p516(C,B).
...
p676_2(A,B):-p1388(A,C),p1459(C,B).
p677(A,B):-p985(A,C),p677_1(C,B).
p677_1(A,B):-p838(A,C),p677_2(C,B).
p677_2(A,B):-p1459(A,C),move_right(C,B).
...
p684(A,B):-p516(A,C),p684_1(C,B).
p684_1(A,B):-p1753(A,C),p684_2(C,B).
p684_2(A,B):-p1555(A,C),drop_ball(C,B).
p687(A,B):-move_backwards(A,C),p687_1(C,B).
p687_1(A,B):-grab_ball(A,C),p687_2(C,B).
p687_2(A,B):-p1369(A,C),p1522(C,B).
...
p693_1(A,B):-p838(A,C),p693_2(C,B).
p693_2(A,B):-p1459(A,C),p7(C,B).
p695(A,B):-move_backwards(A,C),p695_1(C,B).
p695_1(A,B):-p555(A,C),p695_2(C,B).
p695_2(A,B):-p112(A,C),p258(C,B).
p696(A,B):-move_left(A,C),p696_1(C,B).
p696_1(A,B):-p1749(A,C),p696_2(C,B).
p696_2(A,B):-p1020(A,C),p409(C,B).
...
p704(A,B):-p975(A,C),p704_1(C,B).
p704_1(A,B):-p1753(A,C),p704_2(C,B).
...
p711_1(A,B):-p492(A,C),p711_2(C,B).
p711_2(A,B):-p258(A,C),p664(C,B).
p712(A,B):-p555(A,C),p712_1(C,B).
p712_1(A,B):-move_left(A,C),p712_2(C,B).
p712_2(A,B):-p409(A,C),p1555(C,B).
p715(A,B):-p1224(A,C),p715_1(C,B).
p715_1(A,B):-move_forwards(A,C),p715_2(C,B).
p715_2(A,B):-p512(A,C),p780(C,B).
p718(A,B):-move_right(A,C),p718_1(C,B).
p718_1(A,B):-p1020(A,C),p718_2(C,B).
p718_2(A,B):-p1459(A,C),p369(C,B).
p720(A,B):-p895(A,C),p720_1(C,B).
p720_1(A,B):-p258(A,C),p947(C,B).
p721(A,B):-p985(A,C),p721_1(C,B).
p721_1(A,B):-p258(A,C),p369(C,B).
p726(A,B):-p1564(A,C),p726_1(C,B).
p726_1(A,B):-p834(A,C),p726_2(C,B).
p726_2(A,B):-p1459(A,C),p1667(C,B).
...
p741(A,B):-p555(A,C),p741_1(C,B).
p741_1(A,B):-p834(A,C),p741_2(C,B).
p741_2(A,B):-p512(A,C),p293(C,B).
...
p754(A,B):-p780(A,C),p754_1(C,B).
p754_1(A,B):-p1753(A,C),p754_2(C,B).
p754_2(A,B):-p369(A,C),p512(C,B).
...
p762(A,B):-p780(A,C),p762_1(C,B).
p762_1(A,B):-p985(A,C),p762_2(C,B).
p762_2(A,B):-move_backwards(A,C),drop_ball(C,B).
...
p769(A,B):-p1116(A,C),p769_1(C,B).
p769_1(A,B):-grab_ball(A,C),p769_2(C,B).
p769_2(A,B):-p1333(A,C),p258(C,B).
...
p772(A,B):-p947(A,C),p772_1(C,B).
p772_1(A,B):-p985(A,C),p772_2(C,B).
p772_2(A,B):-p662(A,C),p1749(C,B).
p775(A,B):-p664(A,C),p775_1(C,B).
p775_1(A,B):-p555(A,C),p775_2(C,B).
p775_2(A,B):-p409(A,C),p369(C,B).
...
p782(A,B):-p1555(A,C),p782_1(C,B).
p782_1(A,B):-p1564(A,C),p782_2(C,B).
...
p793_2(A,B):-p834(A,C),p1459(C,B).
p794(A,B):-p985(A,C),p794_1(C,B).
p794_1(A,B):-p235(A,C),p794_2(C,B).
p794_2(A,B):-p512(A,C),p947(C,B).
...
p806(A,B):-p868(A,C),p806_1(C,B).
p806_1(A,B):-p1753(A,C),p806_2(C,B).
p806_2(A,B):-p1459(A,C),p947(C,B).
p807(A,B):-p922(A,C),p807_1(C,B).
p807_1(A,B):-p1459(A,C),p1749(C,B).
p809(A,B):-p484(A,C),p809_1(C,B).
p809_1(A,B):-p1564(A,C),p809_2(C,B).
p809_2(A,B):-p258(A,C),move_backwards(C,B).
p811(A,B):-p492(A,C),p811_1(C,B).
p811_1(A,B):-p922(A,C),p811_2(C,B).
p811_2(A,B):-p258(A,C),p834(C,B).
p822(A,B):-p555(A,C),p822_1(C,B).
p822_1(A,B):-p115(A,C),p822_2(C,B).
p822_2(A,B):-drop_ball(A,C),p516(C,B).
p823(A,B):-p1049(A,C),p823_1(C,B).
p823_1(A,B):-p1564(A,C),p823_2(C,B).
p823_2(A,B):-p512(A,C),p492(C,B).
p824(A,B):-p7(A,C),p824_1(C,B).
p824_1(A,B):-p1020(A,C),p1749(C,B).
p833(A,B):-p975(A,C),p833_1(C,B).
p833_1(A,B):-p985(A,C),p833_2(C,B).
p833_2(A,B):-p1195(A,C),p1459(C,B).
p837(A,B):-p1564(A,C),p837_1(C,B).
p837_1(A,B):-move_right(A,C),p837_2(C,B).
p837_2(A,B):-drop_ball(A,C),p1195(C,B).
...
p852(A,B):-p975(A,C),p852_1(C,B).
p852_1(A,B):-p1564(A,C),p852_2(C,B).
p852_2(A,B):-p662(A,C),move_forwards(C,B).
p857(A,B):-p1049(A,C),p857_1(C,B).
p857_1(A,B):-drop_ball(A,C),p1600(C,B).
p858(A,B):-p1564(A,C),p858_1(C,B).
p858_1(A,B):-p112(A,C),p858_2(C,B).
p858_2(A,B):-p409(A,C),p1869(C,B).
...
p877(A,B):-p975(A,C),p877_1(C,B).
p877_1(A,B):-p1753(A,C),p877_2(C,B).
p877_2(A,B):-p258(A,C),p369(C,B).
p880(A,B):-p1753(A,C),p880_1(C,B).
p880_1(A,B):-p492(A,C),p880_2(C,B).
p880_2(A,B):-p258(A,C),p975(C,B).
p882(A,B):-move_left(A,C),p882_1(C,B).
p882_1(A,B):-p985(A,C),p882_2(C,B).
p882_2(A,B):-p662(A,C),p975(C,B).
p887(A,B):-move_forwards(A,C),p887_1(C,B).
p887_1(A,B):-p1753(A,C),drop_ball(C,B).
p888(A,B):-move_forwards(A,C),p888_1(C,B).
p888_1(A,B):-grab_ball(A,C),p888_2(C,B).
p888_2(A,B):-p975(A,C),p1370(C,B).
p893(A,B):-p1555(A,C),p893_1(C,B).
p893_1(A,B):-p1753(A,C),p893_2(C,B).
p893_2(A,B):-drop_ball(A,C),p593(C,B).
...
p903(A,B):-p922(A,C),p903_1(C,B).
p903_1(A,B):-drop_ball(A,C),p780(C,B).
p904(A,B):-move_forwards(A,C),p904_1(C,B).
p904_1(A,B):-p985(A,C),p904_2(C,B).
p904_2(A,B):-drop_ball(A,C),p1869(C,B).
p905(A,B):-p922(A,C),p905_1(C,B).
p905_1(A,B):-p1559(A,C),p905_2(C,B).
p905_2(A,B):-drop_ball(A,C),p112(C,B).
p908(A,B):-p1116(A,C),p908_1(C,B).
p908_1(A,B):-p1020(A,C),p908_2(C,B).
p908_2(A,B):-p409(A,C),p1833(C,B).
p909(A,B):-p293(A,C),p909_1(C,B).
p909_1(A,B):-p985(A,C),p909_2(C,B).
p909_2(A,B):-p1522(A,C),p1195(C,B).
...
p914_1(A,B):-p922(A,C),p914_2(C,B).
...
p925_1(A,B):-p1740(A,C),p1370(C,B).
p928(A,B):-grab_ball(A,C),p928_1(C,B).
p928_1(A,B):-p492(A,C),p928_2(C,B).
p928_2(A,B):-p258(A,C),p1740(C,B).
...
p938(A,B):-p834(A,C),p938_1(C,B).
p938_1(A,B):-p922(A,C),p938_2(C,B).
p938_2(A,B):-p1749(A,C),p1522(C,B).
p942(A,B):-p1224(A,C),p942_1(C,B).
p942_1(A,B):-p736(A,C),p942_2(C,B).
p942_2(A,B):-p512(A,C),p834(C,B).
p945(A,B):-p895(A,C),p945_1(C,B).
p945_1(A,B):-p1116(A,C),p945_2(C,B).
p945_2(A,B):-p1459(A,C),p947(C,B).
...
p950_1(A,B):-p922(A,C),p950_2(C,B).
p950_2(A,B):-p258(A,C),p1116(C,B).
...
p958(A,B):-p1116(A,C),p958_1(C,B).
p958_1(A,B):-p985(A,C),p958_2(C,B).
p958_2(A,B):-p1388(A,C),p1459(C,B).
...
p971_1(A,B):-p1564(A,C),p971_2(C,B).
p971_2(A,B):-p1522(A,C),p255(C,B).
...
p977_1(A,B):-p369(A,C),p977_2(C,B).
p977_2(A,B):-p258(A,C),p1749(C,B).
p978(A,B):-p834(A,C),p978_1(C,B).
p978_1(A,B):-p922(A,C),p978_2(C,B).
p978_2(A,B):-move_forwards(A,C),p258(C,B).
p979(A,B):-p492(A,C),p979_1(C,B).
p979_1(A,B):-p1753(A,C),p979_2(C,B).
p979_2(A,B):-p512(A,C),p593(C,B).
p980(A,B):-p293(A,C),p980_1(C,B).
p980_1(A,B):-p895(A,C),p980_2(C,B).
...
p984_1(A,B):-p985(A,C),p984_2(C,B).
...
p991_2(A,B):-p1459(A,C),p1749(C,B).
p993(A,B):-move_forwards(A,C),p993_1(C,B).
p993_1(A,B):-p985(A,C),p993_2(C,B).
...
p1026(A,B):-move_forwards(A,C),p1026_1(C,B).
p1026_1(A,B):-p1370(A,C),move_backwards(C,B).
p1029(A,B):-move_left(A,C),p1029_1(C,B).
p1029_1(A,B):-p555(A,C),p1029_2(C,B).
p1029_2(A,B):-p293(A,C),p409(C,B).
p1030(A,B):-p1369(A,C),p1030_1(C,B).
p1030_1(A,B):-p1753(A,C),p1030_2(C,B).
p1030_2(A,B):-p512(A,C),p1388(C,B).
p1032(A,B):-p1564(A,C),p1032_1(C,B).
p1032_1(A,B):-p1833(A,C),p1032_2(C,B).
p1032_2(A,B):-drop_ball(A,C),p1559(C,B).
...
p1048_1(A,B):-p922(A,C),p1048_2(C,B).
...
p1060_2(A,B):-p1100(A,C),p1522(C,B).
p1063(A,B):-p922(A,C),p1063_1(C,B).
p1063_1(A,B):-p293(A,C),p1063_2(C,B).
p1063_2(A,B):-drop_ball(A,C),p112(C,B).
p1065(A,B):-p510(A,C),p1065_1(C,B).
p1065_1(A,B):-p1564(A,C),p1065_2(C,B).
...
p1093(A,B):-p1600(A,C),p1093_1(C,B).
p1093_1(A,B):-p922(A,C),p1093_2(C,B).
p1093_2(A,B):-p662(A,C),p947(C,B).
p1096(A,B):-p895(A,C),p1096_1(C,B).
p1096_1(A,B):-move_backwards(A,C),p1096_2(C,B).
p1096_2(A,B):-p258(A,C),p1116(C,B).
p1101(A,B):-p985(A,C),p369(C,B).
p1103(A,B):-p369(A,C),p1103_1(C,B).
p1103_1(A,B):-p555(A,C),p1103_2(C,B).
p1103_2(A,B):-p492(A,C),p409(C,B).
p1107(A,B):-p838(A,C),p1107_1(C,B).
p1107_1(A,B):-p922(A,C),p1107_2(C,B).
p1107_2(A,B):-p510(A,C),p512(C,B).
...
p1119_2(A,B):-p409(A,C),p369(C,B).
p1121(A,B):-move_backwards(A,C),p1121_1(C,B).
p1121_1(A,B):-p922(A,C),p1121_2(C,B).
...
p1125_2(A,B):-p512(A,C),p492(C,B).
p1127(A,B):-p895(A,C),p1127_1(C,B).
p1127_1(A,B):-move_left(A,C),p1127_2(C,B).
p1127_2(A,B):-p1459(A,C),p510(C,B).
p1131(A,B):-p1564(A,C),p1131_1(C,B).
p1131_1(A,B):-p1116(A,C),p1131_2(C,B).
p1131_2(A,B):-p258(A,C),p664(C,B).
p1132(A,B):-p1020(A,C),p1132_1(C,B).
p1132_1(A,B):-p1388(A,C),p409(C,B).
p1133(A,B):-move_forwards(A,C),p1133_1(C,B).
...
p1146(A,B):-p868(A,C),p1146_1(C,B).
p1146_1(A,B):-p985(A,C),p1146_2(C,B).
p1146_2(A,B):-p409(A,C),p369(C,B).
...
p1164_1(A,B):-p922(A,C),p1164_2(C,B).
p1164_2(A,B):-drop_ball(A,C),p664(C,B).
...
p1168_2(A,B):-move_backwards(A,C),p512(C,B).
...
p1183(A,B):-p369(A,C),p1183_1(C,B).
p1183_1(A,B):-p555(A,C),p1183_2(C,B).
p1183_2(A,B):-move_forwards(A,C),p258(C,B).
p1184(A,B):-p736(A,C),p1184_1(C,B).
p1184_1(A,B):-p1564(A,C),p1184_2(C,B).
p1184_2(A,B):-p1600(A,C),p1459(C,B).
...
p1192(A,B):-p1224(A,C),p1192_1(C,B).
p1192_1(A,B):-p255(A,C),p1192_2(C,B).
p1192_2(A,B):-p512(A,C),p736(C,B).
...
p1205(A,B):-move_forwards(A,C),p1205_1(C,B).
p1205_1(A,B):-grab_ball(A,C),p1205_2(C,B).
p1205_2(A,B):-p1459(A,C),move_left(C,B).
p1206(A,B):-p947(A,C),p1206_1(C,B).
p1206_1(A,B):-grab_ball(A,C),p1206_2(C,B).
p1206_2(A,B):-p662(A,C),p7(C,B).
p1208(A,B):-p922(A,C),p1208_1(C,B).
p1208_1(A,B):-p492(A,C),p1208_2(C,B).
p1208_2(A,B):-p409(A,C),p112(C,B).
p1211(A,B):-move_backwards(A,C),p1211_1(C,B).
p1211_1(A,B):-p895(A,C),p1211_2(C,B).
p1211_2(A,B):-p975(A,C),p1459(C,B).
p1218(A,B):-p510(A,C),p1218_1(C,B).
p1218_1(A,B):-p1224(A,C),p1218_2(C,B).
p1218_2(A,B):-p1559(A,C),p1459(C,B).
...
p1225_2(A,B):-p1749(A,C),p258(C,B).
...
p1236(A,B):-p1116(A,C),p1236_1(C,B).
p1236_1(A,B):-p1020(A,C),p1236_2(C,B).
p1236_2(A,B):-p258(A,C),p834(C,B).
p1237(A,B):-p922(A,C),p1237_1(C,B).
p1237_1(A,B):-p293(A,C),p1237_2(C,B).
p1237_2(A,B):-p258(A,C),p1388(C,B).
p1243(A,B):-p1100(A,C),p1243_1(C,B).
p1243_1(A,B):-p1753(A,C),p1243_2(C,B).
p1243_2(A,B):-p947(A,C),p258(C,B).
p1245(A,B):-p1116(A,C),p1245_1(C,B).
p1245_1(A,B):-p1753(A,C),p1245_2(C,B).
p1245_2(A,B):-drop_ball(A,C),move_forwards(C,B).
p1246(A,B):-p985(A,C),p1246_1(C,B).
p1246_1(A,B):-p664(A,C),p1246_2(C,B).
p1246_2(A,B):-p1522(A,C),p1600(C,B).
p1250(A,B):-p664(A,C),p1250_1(C,B).
p1250_1(A,B):-p1564(A,C),p484(C,B).
p1254(A,B):-p369(A,C),p1254_1(C,B).
p1254_1(A,B):-p1564(A,C),p1254_2(C,B).
p1254_2(A,B):-p975(A,C),p1370(C,B).
...
p1263(A,B):-p1749(A,C),p1263_1(C,B).
p1263_1(A,B):-p1753(A,C),p115(C,B).
...
p1267_1(A,B):-p1116(A,C),p1267_2(C,B).
p1267_2(A,B):-p258(A,C),p516(C,B).
...
p1278(A,B):-p975(A,C),p1278_1(C,B).
p1278_1(A,B):-grab_ball(A,C),p1278_2(C,B).
p1278_2(A,B):-p258(A,C),p1749(C,B).
...
p1282(A,B):-move_right(A,C),p1282_1(C,B).
p1282_1(A,B):-p1020(A,C),p1282_2(C,B).
p1282_2(A,B):-p409(A,C),p369(C,B).
...
p1299(A,B):-p1224(A,C),p1299_1(C,B).
p1299_1(A,B):-p293(A,C),p1299_2(C,B).
p1299_2(A,B):-p1459(A,C),p510(C,B).
...
p1310(A,B):-p975(A,C),p1310_1(C,B).
p1310_1(A,B):-p985(A,C),p1310_2(C,B).
...
p1314(A,B):-p975(A,C),p1314_1(C,B).
p1314_1(A,B):-p985(A,C),p1522(C,B).
p1315(A,B):-p1600(A,C),p1315_1(C,B).
p1315_1(A,B):-p1753(A,C),p1315_2(C,B).
p1315_2(A,B):-p838(A,C),p258(C,B).
p1316(A,B):-p7(A,C),p1316_1(C,B).
p1316_1(A,B):-p1020(A,C),p1316_2(C,B).
p1316_2(A,B):-p293(A,C),p512(C,B).
p1318(A,B):-p510(A,C),p1318_1(C,B).
p1318_1(A,B):-p1224(A,C),p1318_2(C,B).
p1318_2(A,B):-p258(A,C),p947(C,B).
p1319(A,B):-move_backwards(A,C),p1319_1(C,B).
p1319_1(A,B):-p555(A,C),p1369(C,B).
p1321(A,B):-p1564(A,C),p1321_1(C,B).
p1321_1(A,B):-p255(A,C),p1321_2(C,B).
p1321_2(A,B):-drop_ball(A,C),p1559(C,B).
p1322(A,B):-p293(A,C),p1322_1(C,B).
p1322_1(A,B):-p1753(A,C),p1322_2(C,B).
p1322_2(A,B):-move_forwards(A,C),p1459(C,B).
p1340(A,B):-p975(A,C),p1340_1(C,B).
p1340_1(A,B):-p985(A,C),p1340_2(C,B).
...
p1365(A,B):-p922(A,C),p1365_1(C,B).
p1365_1(A,B):-p510(A,C),p1365_2(C,B).
p1365_2(A,B):-drop_ball(A,C),p838(C,B).
p1366(A,B):-move_right(A,C),p1366_1(C,B).
p1366_1(A,B):-grab_ball(A,C),p1366_2(C,B).
p1366_2(A,B):-p1388(A,C),p1459(C,B).
p1372(A,B):-p492(A,C),p1372_1(C,B).
p1372_1(A,B):-p1753(A,C),p1372_2(C,B).
p1372_2(A,B):-p1388(A,C),p512(C,B).
p1373(A,B):-move_forwards(A,C),p1373_1(C,B).
p1373_1(A,B):-p985(A,C),p1373_2(C,B).
p1373_2(A,B):-p512(A,C),p1559(C,B).
p1376(A,B):-p922(A,C),p1376_1(C,B).
p1376_1(A,B):-move_left(A,C),p1376_2(C,B).
p1376_2(A,B):-p258(A,C),move_right(C,B).
p1379(A,B):-p662(A,C),p1379_1(C,B).
p1379_1(A,B):-p593(A,C),p1555(C,B).
p1380(A,B):-p593(A,C),p1380_1(C,B).
p1380_1(A,B):-p1753(A,C),p662(C,B).
p1381(A,B):-move_left(A,C),p1381_1(C,B).
p1381_1(A,B):-p112(A,C),p985(C,B).
p1385(A,B):-p975(A,C),p1385_1(C,B).
p1385_1(A,B):-p922(A,C),p1385_2(C,B).
p1385_2(A,B):-move_right(A,C),p1522(C,B).
p1386(A,B):-p1369(A,C),p1386_1(C,B).
p1386_1(A,B):-p985(A,C),p1386_2(C,B).
p1386_2(A,B):-p1333(A,C),p1370(C,B).
p1389(A,B):-p664(A,C),p1389_1(C,B).
p1389_1(A,B):-p1564(A,C),p1389_2(C,B).
p1389_2(A,B):-drop_ball(A,C),p1100(C,B).
p1390(A,B):-p1833(A,C),p1390_1(C,B).
p1390_1(A,B):-grab_ball(A,C),p1390_2(C,B).
p1390_2(A,B):-p1459(A,C),p115(C,B).
...
p1400(A,B):-p1116(A,C),p1400_1(C,B).
p1400_1(A,B):-p1753(A,C),p1400_2(C,B).
p1400_2(A,B):-p1459(A,C),p492(C,B).
p1404(A,B):-grab_ball(A,C),p1404_1(C,B).
p1404_1(A,B):-p834(A,C),p1459(C,B).
...
p1409_1(A,B):-p1100(A,C),p1409_2(C,B).
p1409_2(A,B):-p258(A,C),move_left(C,B).
p1414(A,B):-move_right(A,C),p1414_1(C,B).
p1414_1(A,B):-p1753(A,C),p1414_2(C,B).
p1414_2(A,B):-p293(A,C),p512(C,B).
...
p1431(A,B):-move_backwards(A,C),p1431_1(C,B).
p1431_1(A,B):-p985(A,C),p1431_2(C,B).
p1431_2(A,B):-p838(A,C),p258(C,B).
p1432(A,B):-move_right(A,C),p1432_1(C,B).
p1432_1(A,B):-p555(A,C),p1432_2(C,B).
p1432_2(A,B):-p1600(A,C),p1370(C,B).
p1436(A,B):-move_left(A,C),p1436_1(C,B).
p1436_1(A,B):-p1564(A,C),p1436_2(C,B).
p1436_2(A,B):-p512(A,C),p516(C,B).
p1439(A,B):-p1333(A,C),p1439_1(C,B).
p1439_1(A,B):-p922(A,C),p510(C,B).
...
p1449(A,B):-p255(A,C),p1449_1(C,B).
p1449_1(A,B):-p1224(A,C),p1449_2(C,B).
p1449_2(A,B):-p484(A,C),p258(C,B).
p1450(A,B):-p1753(A,C),p1450_1(C,B).
p1450_1(A,B):-p1555(A,C),p1450_2(C,B).
p1450_2(A,B):-drop_ball(A,C),p1049(C,B).
...
p1469(A,B):-p293(A,C),p1469_1(C,B).
p1469_1(A,B):-p895(A,C),p1469_2(C,B).
p1469_2(A,B):-p512(A,C),p1195(C,B).
p1470(A,B):-p1564(A,C),p1470_1(C,B).
p1470_1(A,B):-p492(A,C),p1470_2(C,B).
p1470_2(A,B):-p258(A,C),p1600(C,B).
...
p1472_2(A,B):-p1600(A,C),p1522(C,B).
p1476(A,B):-p1224(A,C),p1476_1(C,B).
p1476_1(A,B):-p780(A,C),p1476_2(C,B).
p1476_2(A,B):-p258(A,C),p369(C,B).
p1480(A,B):-p838(A,C),p1480_1(C,B).
p1480_1(A,B):-p1564(A,C),p1480_2(C,B).
p1480_2(A,B):-p1370(A,C),p1600(C,B).
...
p1486(A,B):-p1195(A,C),p1486_1(C,B).
p1486_1(A,B):-p922(A,C),p1486_2(C,B).
...
p1524(A,B):-p1749(A,C),p1524_1(C,B).
p1524_1(A,B):-p1753(A,C),p1524_2(C,B).
p1524_2(A,B):-p662(A,C),p947(C,B).
p1526(A,B):-p985(A,C),p1526_1(C,B).
p1526_1(A,B):-p492(A,C),p1526_2(C,B).
p1526_2(A,B):-p258(A,C),move_right(C,B).
p1530(A,B):-p780(A,C),p1530_1(C,B).
p1530_1(A,B):-p1753(A,C),p1530_2(C,B).
p1530_2(A,B):-p975(A,C),p512(C,B).
...
p1543(A,B):-grab_ball(A,C),p1543_1(C,B).
p1543_1(A,B):-p510(A,C),p1543_2(C,B).
p1543_2(A,B):-p1522(A,C),p510(C,B).
...
p1550(A,B):-move_right(A,C),p1550_1(C,B).
p1550_1(A,B):-p555(A,C),p1550_2(C,B).
p1550_2(A,B):-p512(A,C),p369(C,B).
p1551(A,B):-p975(A,C),p1551_1(C,B).
p1551_1(A,B):-p1564(A,C),p1551_2(C,B).
p1551_2(A,B):-p258(A,C),p780(C,B).
p1557(A,B):-move_left(A,C),p1557_1(C,B).
p1557_1(A,B):-p1100(A,C),p1557_2(C,B).
p1557_2(A,B):-p1224(A,C),p112(C,B).
p1558(A,B):-move_backwards(A,C),p1558_1(C,B).
p1558_1(A,B):-p985(A,C),p593(C,B).
...
p1571(A,B):-p975(A,C),p1571_1(C,B).
p1571_1(A,B):-p1564(A,C),p1571_2(C,B).
p1571_2(A,B):-p512(A,C),p492(C,B).
p1572(A,B):-p922(A,C),p1572_1(C,B).
p1572_1(A,B):-p293(A,C),p1572_2(C,B).
p1572_2(A,B):-p1522(A,C),p664(C,B).
p1573(A,B):-move_backwards(A,C),p1573_1(C,B).
p1573_1(A,B):-p895(A,C),p512(C,B).
p1578(A,B):-p492(A,C),p1578_1(C,B).
p1578_1(A,B):-p1753(A,C),p1578_2(C,B).
p1578_2(A,B):-move_right(A,C),p1522(C,B).
p1580(A,B):-move_right(A,C),p1580_1(C,B).
p1580_1(A,B):-p1564(A,C),p1580_2(C,B).
p1580_2(A,B):-p1459(A,C),p510(C,B).
p1581(A,B):-p895(A,C),p1581_1(C,B).
p1581_1(A,B):-p947(A,C),p662(C,B).
p1582(A,B):-move_right(A,C),p1582_1(C,B).
p1582_1(A,B):-p555(A,C),p1582_2(C,B).
p1582_2(A,B):-p662(A,C),move_forwards(C,B).
p1583(A,B):-p510(A,C),p1583_1(C,B).
p1583_1(A,B):-p1224(A,C),p1583_2(C,B).
p1583_2(A,B):-p258(A,C),p834(C,B).
p1587(A,B):-p1600(A,C),p1587_1(C,B).
p1587_1(A,B):-p1753(A,C),p1587_2(C,B).
p1587_2(A,B):-p1459(A,C),p1749(C,B).
p1594(A,B):-p492(A,C),p1594_1(C,B).
p1594_1(A,B):-drop_ball(A,C),p1833(C,B).
p1605(A,B):-p492(A,C),p1605_1(C,B).
p1605_1(A,B):-p895(A,C),p1605_2(C,B).
p1605_2(A,B):-p1600(A,C),p1522(C,B).
...
p1607_2(A,B):-p834(A,C),p1459(C,B).
p1608(A,B):-p235(A,C),p1608_1(C,B).
p1608_1(A,B):-p1224(A,C),p1608_2(C,B).
p1608_2(A,B):-p1116(A,C),p409(C,B).
p1610(A,B):-p235(A,C),p1610_1(C,B).
p1610_1(A,B):-p922(A,C),p1610_2(C,B).
p1610_2(A,B):-p1740(A,C),p1522(C,B).
p1613(A,B):-p492(A,C),p1613_1(C,B).
p1613_1(A,B):-p555(A,C),p1613_2(C,B).
p1613_2(A,B):-p1459(A,C),p293(C,B).
p1615(A,B):-p1564(A,C),p1615_1(C,B).
p1615_1(A,B):-p1100(A,C),p1615_2(C,B).
p1615_2(A,B):-p258(A,C),move_right(C,B).
p1618(A,B):-p369(A,C),p1618_1(C,B).
p1618_1(A,B):-grab_ball(A,C),p1618_2(C,B).
p1618_2(A,B):-p1459(A,C),p293(C,B).
p1625(A,B):-p1116(A,C),p1625_1(C,B).
p1625_1(A,B):-p1564(A,C),p1625_2(C,B).
...
p1638_1(A,B):-p975(A,C),p1638_2(C,B).
p1638_2(A,B):-p1459(A,C),p1749(C,B).
...
p1647_1(A,B):-p1369(A,C),p1647_2(C,B).
p1647_2(A,B):-drop_ball(A,C),p112(C,B).
...
p1657(A,B):-p1369(A,C),p1657_1(C,B).
p1657_1(A,B):-p1224(A,C),p1657_2(C,B).
...
p1674_1(A,B):-p1020(A,C),p1674_2(C,B).
p1674_2(A,B):-move_backwards(A,C),p1459(C,B).
...
p1680(A,B):-p484(A,C),p1680_1(C,B).
p1680_1(A,B):-p1753(A,C),p1680_2(C,B).
p1680_2(A,B):-p1459(A,C),p492(C,B).
p1681(A,B):-move_backwards(A,C),p1681_1(C,B).
p1681_1(A,B):-p1753(A,C),move_left(C,B).
...
p1686_1(A,B):-p258(A,C),p1116(C,B).
...
p1692(A,B):-p1224(A,C),p1692_1(C,B).
p1692_1(A,B):-p510(A,C),p1692_2(C,B).
p1692_2(A,B):-p258(A,C),p838(C,B).
p1693(A,B):-p1833(A,C),p1693_1(C,B).
p1693_1(A,B):-p1753(A,C),p1693_2(C,B).
p1693_2(A,B):-p258(A,C),p1116(C,B).
p1701(A,B):-p1020(A,C),p1701_1(C,B).
p1701_1(A,B):-p1600(A,C),p1522(C,B).
...
p1718(A,B):-p1564(A,C),p1718_1(C,B).
p1718_1(A,B):-p369(A,C),p1718_2(C,B).
p1718_2(A,B):-drop_ball(A,C),p516(C,B).
p1720(A,B):-p555(A,C),p1720_1(C,B).
p1720_1(A,B):-p593(A,C),p1720_2(C,B).
p1720_2(A,B):-p258(A,C),p780(C,B).
p1727(A,B):-p922(A,C),p1727_1(C,B).
p1727_1(A,B):-move_left(A,C),p1727_2(C,B).
p1727_2(A,B):-p258(A,C),p115(C,B).
p1733(A,B):-p1369(A,C),p1733_1(C,B).
p1733_1(A,B):-p985(A,C),move_right(C,B).
p1736(A,B):-p1116(A,C),p1736_1(C,B).
p1736_1(A,B):-p1753(A,C),p1736_2(C,B).
p1736_2(A,B):-p512(A,C),move_forwards(C,B).
p1737(A,B):-p1753(A,C),p1737_1(C,B).
p1737_1(A,B):-p1459(A,C),p780(C,B).
p1739(A,B):-p1020(A,C),p1739_1(C,B).
p1739_1(A,B):-move_right(A,C),p1739_2(C,B).
p1739_2(A,B):-p512(A,C),move_forwards(C,B).
...
p1747_1(A,B):-p736(A,C),p1747_2(C,B).
p1747_2(A,B):-p409(A,C),p975(C,B).
...
p1755_2(A,B):-p1369(A,C),p258(C,B).
p1763(A,B):-move_forwards(A,C),p1763_1(C,B).
p1763_1(A,B):-p985(A,C),p1763_2(C,B).
p1763_2(A,B):-drop_ball(A,C),p115(C,B).
p1765(A,B):-p1600(A,C),p1765_1(C,B).
p1765_1(A,B):-p1753(A,C),p1765_2(C,B).
p1765_2(A,B):-p115(A,C),p1370(C,B).
p1770(A,B):-move_left(A,C),p1770_1(C,B).
p1770_1(A,B):-p1753(A,C),p1770_2(C,B).
p1770_2(A,B):-drop_ball(A,C),p838(C,B).
p1771(A,B):-p895(A,C),p1771_1(C,B).
p1771_1(A,B):-p1555(A,C),p1771_2(C,B).
p1771_2(A,B):-drop_ball(A,C),p1049(C,B).
p1773(A,B):-move_left(A,C),p1773_1(C,B).
p1773_1(A,B):-p985(A,C),p1773_2(C,B).
p1773_2(A,B):-p258(A,C),move_right(C,B).
p1778(A,B):-p1388(A,C),p1778_1(C,B).
p1778_1(A,B):-p922(A,C),p1778_2(C,B).
p1778_2(A,B):-drop_ball(A,C),move_forwards(C,B).
p1781(A,B):-move_right(A,C),p1781_1(C,B).
p1781_1(A,B):-p895(A,C),p1781_2(C,B).
p1781_2(A,B):-p512(A,C),p947(C,B).
...
p1786(A,B):-p484(A,C),p1786_1(C,B).
p1786_1(A,B):-p1753(A,C),p1786_2(C,B).
p1786_2(A,B):-p258(A,C),p838(C,B).
p1789(A,B):-move_backwards(A,C),p1789_1(C,B).
p1789_1(A,B):-p985(A,C),p1789_2(C,B).
p1789_2(A,B):-p664(A,C),drop_ball(C,B).
...
p1797(A,B):-p947(A,C),p1797_1(C,B).
...
p1801_1(A,B):-move_forwards(A,C),p1801_2(C,B).
p1801_2(A,B):-drop_ball(A,C),p516(C,B).
p1802(A,B):-move_right(A,C),p1802_1(C,B).
p1802_1(A,B):-p1116(A,C),p1802_2(C,B).
p1802_2(A,B):-p1459(A,C),p115(C,B).
p1803(A,B):-p922(A,C),move_right(C,B).
p1804(A,B):-grab_ball(A,C),p1804_1(C,B).
p1804_1(A,B):-p947(A,C),p1804_2(C,B).
p1804_2(A,B):-p1459(A,C),p115(C,B).
...
p1811_1(A,B):-p1020(A,C),p1811_2(C,B).
p1811_2(A,B):-p834(A,C),p1459(C,B).
p1814(A,B):-p510(A,C),p1814_1(C,B).
p1814_1(A,B):-p1753(A,C),p1814_2(C,B).
p1814_2(A,B):-p258(A,C),p484(C,B).
p1815(A,B):-p922(A,C),p1815_1(C,B).
p1815_1(A,B):-p255(A,C),p1815_2(C,B).
p1815_2(A,B):-p1522(A,C),p1116(C,B).
p1816(A,B):-p1116(A,C),p1816_1(C,B).
p1816_1(A,B):-p1564(A,C),p1816_2(C,B).
p1816_2(A,B):-p662(A,C),p780(C,B).
...
p1824(A,B):-move_left(A,C),p1824_1(C,B).
p1824_1(A,B):-grab_ball(A,C),p112(C,B).
p1828(A,B):-p736(A,C),p1828_1(C,B).
p1828_1(A,B):-p1564(A,C),p1828_2(C,B).
p1828_2(A,B):-p1833(A,C),p662(C,B).
p1829(A,B):-grab_ball(A,C),p1829_1(C,B).
p1829_1(A,B):-p780(A,C),p1829_2(C,B).
p1829_2(A,B):-p662(A,C),p112(C,B).
p1830(A,B):-grab_ball(A,C),p1830_1(C,B).
p1830_1(A,B):-p1833(A,C),p1830_2(C,B).
p1830_2(A,B):-p1459(A,C),p115(C,B).
...
p1837(A,B):-p1564(A,C),p1837_1(C,B).
p1837_1(A,B):-p293(A,C),p1522(C,B).
p1839(A,B):-p1116(A,C),p1839_1(C,B).
p1839_1(A,B):-p1564(A,C),p1839_2(C,B).
p1839_2(A,B):-p662(A,C),p1388(C,B).
p1842(A,B):-p112(A,C),p1842_1(C,B).
p1842_1(A,B):-p258(A,C),p780(C,B).
p1844(A,B):-move_forwards(A,C),p1844_1(C,B).
p1844_1(A,B):-p985(A,C),p1844_2(C,B).
p1844_2(A,B):-p512(A,C),move_forwards(C,B).
p1845(A,B):-move_forwards(A,C),p868(C,B).
p1847(A,B):-move_backwards(A,C),p1847_1(C,B).
p1847_1(A,B):-p555(A,C),p1847_2(C,B).
p1847_2(A,B):-p1100(A,C),p258(C,B).
...
p1855(A,B):-p975(A,C),p1855_1(C,B).
...
p1862(A,B):-p1564(A,C),p1862_1(C,B).
p1862_1(A,B):-move_right(A,C),p1862_2(C,B).
p1862_2(A,B):-p1100(A,C),drop_ball(C,B).
p1864(A,B):-p838(A,C),p1864_1(C,B).
p1864_1(A,B):-p1753(A,C),p1864_2(C,B).
p1864_2(A,B):-p258(A,C),p115(C,B).
p1867(A,B):-move_forwards(A,C),p1867_1(C,B).
p1867_1(A,B):-p985(A,C),p1867_2(C,B).
p1867_2(A,B):-p512(A,C),p1195(C,B).
p1873(A,B):-p1020(A,C),p1873_1(C,B).
p1873_1(A,B):-p780(A,C),p1873_2(C,B).
p1873_2(A,B):-p409(A,C),p369(C,B).
...
p1883_1(A,B):-p1753(A,C),p1883_2(C,B).
p1883_2(A,B):-move_forwards(A,C),p512(C,B).
p1884(A,B):-move_backwards(A,C),p1884_1(C,B).
p1884_1(A,B):-p922(A,C),p1884_2(C,B).
p1884_2(A,B):-move_left(A,C),p1459(C,B).
p1885(A,B):-p834(A,C),p1885_1(C,B).
p1885_1(A,B):-p922(A,C),p1885_2(C,B).
p1885_2(A,B):-p1600(A,C),p1522(C,B).
p1886(A,B):-p1100(A,C),p1886_1(C,B).
p1886_1(A,B):-p1224(A,C),p1886_2(C,B).
...
p1890_2(A,B):-p1370(A,C),p780(C,B).
p1892(A,B):-p975(A,C),p1892_1(C,B).
p1892_1(A,B):-p1020(A,C),p1892_2(C,B).
p1892_2(A,B):-p258(A,C),p369(C,B).
p1896(A,B):-p1749(A,C),p1896_1(C,B).
p1896_1(A,B):-p1564(A,C),p1896_2(C,B).
p1896_2(A,B):-drop_ball(A,C),p975(C,B).
p1900(A,B):-p369(A,C),p1900_1(C,B).
p1900_1(A,B):-p922(A,C),p1900_2(C,B).
p1900_2(A,B):-p510(A,C),p1522(C,B).
p1901(A,B):-p1564(A,C),p1901_1(C,B).
p1901_1(A,B):-move_right(A,C),p1901_2(C,B).
p1901_2(A,B):-p1459(A,C),p1388(C,B).
p1903(A,B):-p1564(A,C),p1903_1(C,B).
p1903_1(A,B):-move_right(A,C),p1903_2(C,B).
p1903_2(A,B):-drop_ball(A,C),p1049(C,B).
...
p1907(A,B):-move_forwards(A,C),p1907_1(C,B).
p1907_1(A,B):-grab_ball(A,C),p1907_2(C,B).
p1907_2(A,B):-p1459(A,C),p838(C,B).
p1909(A,B):-p1116(A,C),p1909_1(C,B).
p1909_1(A,B):-p1753(A,C),p1909_2(C,B).
p1909_2(A,B):-p409(A,C),move_right(C,B).
p1910(A,B):-p293(A,C),p1910_1(C,B).
p1910_1(A,B):-grab_ball(A,C),p1910_2(C,B).
p1910_2(A,B):-p1869(A,C),p512(C,B).
p1913(A,B):-p112(A,C),p1913_1(C,B).
p1913_1(A,B):-p1224(A,C),p1913_2(C,B).
p1913_2(A,B):-p662(A,C),p484(C,B).
p1915(A,B):-p664(A,C),p1915_1(C,B).
p1915_1(A,B):-p922(A,C),p1915_2(C,B).
p1915_2(A,B):-p1459(A,C),move_backwards(C,B).
p1918(A,B):-grab_ball(A,C),p1918_1(C,B).
p1918_1(A,B):-p975(A,C),p1918_2(C,B).
p1918_2(A,B):-p258(A,C),p516(C,B).
p1919(A,B):-p293(A,C),p1919_1(C,B).
p1919_1(A,B):-grab_ball(A,C),p1919_2(C,B).
p1919_2(A,B):-p258(A,C),p1116(C,B).
p1920(A,B):-p555(A,C),p1920_1(C,B).
p1920_1(A,B):-p593(A,C),drop_ball(C,B).
p1921(A,B):-p947(A,C),p1921_1(C,B).
p1921_1(A,B):-grab_ball(A,C),p1921_2(C,B).
p1921_2(A,B):-p512(A,C),p780(C,B).
p1922(A,B):-p838(A,C),p1922_1(C,B).
p1922_1(A,B):-p1753(A,C),p1922_2(C,B).
...
p1924(A,B):-p985(A,C),p1924_1(C,B).
p1924_1(A,B):-drop_ball(A,C),p492(C,B).
...
p1932(A,B):-p1224(A,C),p1932_1(C,B).
p1932_1(A,B):-p293(A,C),p1932_2(C,B).
p1932_2(A,B):-p512(A,C),p1116(C,B).
p1937(A,B):-move_right(A,C),p1937_1(C,B).
p1937_1(A,B):-grab_ball(A,C),p1937_2(C,B).
p1937_2(A,B):-p293(A,C),p516(C,B).
p1940(A,B):-p1369(A,C),p1940_1(C,B).
p1940_1(A,B):-p1753(A,C),p1940_2(C,B).
p1940_2(A,B):-drop_ball(A,C),p975(C,B).
...
p1948(A,B):-p975(A,C),p1948_1(C,B).
p1948_1(A,B):-grab_ball(A,C),p1948_2(C,B).
p1948_2(A,B):-p1459(A,C),p369(C,B).
p1952(A,B):-move_forwards(A,C),p1952_1(C,B).
p1952_1(A,B):-p1753(A,C),p1952_2(C,B).
...
p1961(A,B):-p985(A,C),p1961_1(C,B).
p1961_1(A,B):-p115(A,C),p1961_2(C,B).
p1961_2(A,B):-p512(A,C),p1333(C,B).
...
p1980(A,B):-p1753(A,C),p1980_1(C,B).
p1980_1(A,B):-move_forwards(A,C),p1980_2(C,B).
p1980_2(A,B):-p662(A,C),p112(C,B).
p1983(A,B):-p895(A,C),p1983_1(C,B).
p1983_1(A,B):-p975(A,C),p1983_2(C,B).
p1983_2(A,B):-p512(A,C),p975(C,B).
...
b5(A,B):-p339(A,C),p629(C,B).
b9(A,B):-p1749(A,C),p554(C,B).
b2(A,B):-p1042(A,C),p1026(C,B).
b3(A,B):-p834(A,C),p1511(C,B).
b17(A,B):-move_left(A,C),p1833(C,B).
b16(A,B):-p159(A,C),move_forwards(C,B).
b18(A,B):-p1587(A,C),move_left(C,B).
b19(A,B):-p765(A,C),p975(C,B).
b20(A,B):-p947(A,C),p789(C,B).
b22(A,B):-p1955(A,C),move_left(C,B).
b14(A,B):-move_backwards(A,C),b14_1(C,B).
b14_1(A,B):-p8(A,C),p593(C,B).
b0(A,B):-move_forwards(A,C),b0_1(C,B).
b0_1(A,B):-p1765(A,C),p293(C,B).
b24(A,B):-p481(A,C),p369(C,B).
b26(A,B):-p772(A,C),p564(C,B).
b27(A,B):-move_backwards(A,C),p627(C,B).
b21(A,B):-move_backwards(A,C),b21_1(C,B).
b21_1(A,B):-p1693(A,C),p979(C,B).
b12(A,B):-move_backwards(A,C),b12_1(C,B).
b12_1(A,B):-p430(A,C),p975(C,B).
b4(A,B):-p516(A,C),b4_1(C,B).
b4_1(A,B):-p645(A,C),p1116(C,B).
b25(A,B):-move_right(A,C),b25_1(C,B).
b25_1(A,B):-p1692(A,C),move_right(C,B).
b30(A,B):-move_left(A,C),b30_1(C,B).
b30_1(A,B):-p487(A,C),p443(C,B).
b33(A,B):-p863(A,C),move_forwards(C,B).
b34(A,B):-move_right(A,C),p780(C,B).
b23(A,B):-p293(A,C),b23_1(C,B).
b23_1(A,B):-p1385(A,C),move_right(C,B).
b7(A,B):-p975(A,C),b7_1(C,B).
b7_1(A,B):-p1449(A,C),p1369(C,B).
b31(A,B):-move_forwards(A,C),b31_1(C,B).
b31_1(A,B):-p325(A,C),p75(C,B).
b36(A,B):-move_left(A,C),b36_1(C,B).
b36_1(A,B):-p373(A,C),p1333(C,B).
b39(A,B):-p947(A,C),p1955(C,B).
b29(A,B):-p293(A,C),b29_1(C,B).
b29_1(A,B):-p646(A,C),p838(C,B).
b40(A,B):-move_left(A,C),b40_1(C,B).
b40_1(A,B):-p583(A,C),p115(C,B).
b42(A,B):-p1749(A,C),p1937(C,B).
b41(A,B):-move_left(A,C),b41_1(C,B).
b41_1(A,B):-p918(A,C),p1749(C,B).
b38(A,B):-move_right(A,C),b38_1(C,B).
b38_1(A,B):-p887(A,C),p40(C,B).
b15(A,B):-p1116(A,C),b15_1(C,B).
b15_1(A,B):-p67(A,C),p492(C,B).
b8(A,B):-p1753(A,C),b8_1(C,B).
b8_1(A,B):-p293(A,C),p36(C,B).
b37(A,B):-p1020(A,C),b37_1(C,B).
b37_1(A,B):-move_backwards(A,C),p1594(C,B).
b47(A,B):-move_backwards(A,C),b47_1(C,B).
b47_1(A,B):-p1191(A,C),p1921(C,B).
b46(A,B):-p593(A,C),b46_1(C,B).
b46_1(A,B):-p229(A,C),p1749(C,B).
b49(A,B):-p523(A,C),p1313(C,B).
b51(A,B):-p1749(A,B).
b50(A,B):-p1710(A,C),p510(C,B).
b45(A,B):-p1559(A,C),b45_1(C,B).
b45_1(A,B):-p54(A,C),p255(C,B).
b35(A,B):-p1356(A,C),b35_1(C,B).
b35_1(A,B):-p1063(A,C),move_left(C,B).
b54(A,B):-p337(A,C),p1550(C,B).
b48(A,B):-p168(A,C),b48_1(C,B).
b48_1(A,B):-p975(A,C),p708(C,B).
b53(A,B):-p1833(A,C),b53_1(C,B).
b53_1(A,B):-p1029(A,C),p235(C,B).
b57(A,B):-p293(A,C),b57_1(C,B).
b57_1(A,B):-p1309(A,C),p1205(C,B).
b59(A,B):-move_left(A,C),b59_1(C,B).
b59_1(A,B):-p112(A,C),p1418(C,B).
b60(A,B):-p1369(A,B).
b58(A,B):-p583(A,C),b58_1(C,B).
b58_1(A,B):-p1869(A,C),p526(C,B).
b62(A,B):-p664(A,C),b62_1(C,B).
b62_1(A,B):-p1605(A,C),move_backwards(C,B).
b63(A,B):-p1749(A,C),p392(C,B).
b64(A,B):-p838(A,B).
b61(A,B):-p736(A,C),b61_1(C,B).
b61_1(A,B):-p729(A,C),p982(C,B).
b66(A,B):-move_left(A,C),b66_1(C,B).
b66_1(A,B):-p893(A,C),p516(C,B).
b65(A,B):-move_backwards(A,C),b65_1(C,B).
b65_1(A,B):-p868(A,C),p212(C,B).
b67(A,B):-p492(A,C),b67_1(C,B).
b67_1(A,B):-p1681(A,C),p507(C,B).
b68(A,B):-p293(A,C),b68_1(C,B).
b68_1(A,B):-p1322(A,C),move_forwards(C,B).
b70(A,B):-p235(A,B).
b32(A,B):-move_left(A,C),b32_1(C,B).
b32_1(A,B):-p492(A,C),b32_2(C,B).
b32_2(A,B):-p237(A,C),p494(C,B).
b69(A,B):-p516(A,C),b69_1(C,B).
b69_1(A,B):-p1618(A,C),p842(C,B).
b73(A,B):-p293(A,C),b73_1(C,B).
b73_1(A,B):-p559(A,C),p1100(C,B).
b72(A,B):-p31(A,C),b72_1(C,B).
b72_1(A,B):-p1346(A,C),p325(C,B).
b74(A,B):-move_right(A,C),b74_1(C,B).
b74_1(A,B):-p1116(A,C),p1966(C,B).
b75(A,B):-p1049(A,C),p1226(C,B).
b77(A,B):-move_forwards(A,C),p1910(C,B).
b76(A,B):-p292(A,C),p1280(C,B).
b78(A,B):-p1749(A,C),p852(C,B).
b79(A,B):-p569(A,C),p369(C,B).
b81(A,B):-move_left(A,C),b81_1(C,B).
b81_1(A,B):-p492(A,C),p627(C,B).
b82(A,B):-p115(A,C),b82_1(C,B).
b82_1(A,B):-p1060(A,C),p593(C,B).
b83(A,B):-move_right(A,C),b83_1(C,B).
b83_1(A,B):-p1482(A,C),p369(C,B).
b43(A,B):-move_left(A,C),b43_1(C,B).
b43_1(A,B):-p1333(A,C),b43_2(C,B).
b43_2(A,B):-p631(A,C),p736(C,B).
b85(A,B):-p369(A,C),b85_1(C,B).
b85_1(A,B):-p756(A,C),p1503(C,B).
b84(A,B):-p664(A,C),b84_1(C,B).
b84_1(A,B):-p996(A,C),p1369(C,B).
b86(A,B):-move_right(A,C),b86_1(C,B).
b86_1(A,B):-p649(A,C),p975(C,B).
b80(A,B):-p372(A,C),b80_1(C,B).
b80_1(A,B):-p1321(A,C),p369(C,B).
b87(A,B):-p975(A,C),b87_1(C,B).
b87_1(A,B):-p1376(A,C),move_forwards(C,B).
b90(A,B):-p1369(A,C),p1133(C,B).
b89(A,B):-move_left(A,C),b89_1(C,B).
b89_1(A,B):-p1920(A,C),p524(C,B).
b92(A,B):-p1582(A,C),p947(C,B).
b91(A,B):-move_left(A,C),b91_1(C,B).
b91_1(A,B):-p1748(A,C),p293(C,B).
b88(A,B):-p838(A,C),b88_1(C,B).
b88_1(A,B):-p1989(A,C),p136(C,B).
b44(A,B):-move_left(A,C),b44_1(C,B).
b44_1(A,B):-p229(A,C),b44_2(C,B).
b44_2(A,B):-p1392(A,C),p947(C,B).
b96(A,B):-move_forwards(A,C),p561(C,B).
b95(A,B):-p513(A,C),p369(C,B).
b55(A,B):-move_left(A,C),b55_1(C,B).
b55_1(A,B):-p1736(A,C),b55_2(C,B).
b55_2(A,B):-p595(A,C),p87(C,B).
b99(A,B):-p868(A,C),p356(C,B).
b94(A,B):-p293(A,C),b94_1(C,B).
b94_1(A,B):-p224(A,C),p834(C,B).
b93(A,B):-p293(A,C),b93_1(C,B).
b93_1(A,B):-p1918(A,C),p975(C,B).
b102(A,B):-p115(A,C),b102_1(C,B).
b102_1(A,B):-p1043(A,C),p838(C,B).
b103(A,B):-move_forwards(A,C),p271(C,B).
b97(A,B):-p975(A,C),b97_1(C,B).
b97_1(A,B):-p425(A,C),move_left(C,B).
b105(A,B):-p780(A,C),p295(C,B).
b52(A,B):-move_left(A,C),b52_1(C,B).
b52_1(A,B):-p903(A,C),b52_2(C,B).
b52_2(A,B):-p56(A,C),p1749(C,B).
b106(A,B):-p484(A,C),p833(C,B).
b107(A,B):-p780(A,C),p1901(C,B).
b104(A,B):-move_right(A,C),b104_1(C,B).
b104_1(A,B):-p1116(A,C),p1056(C,B).
b108(A,B):-move_left(A,C),b108_1(C,B).
b108_1(A,B):-p633(A,C),p1600(C,B).
b111(A,B):-move_right(A,C),b111_1(C,B).
b111_1(A,B):-p110(A,C),p19(C,B).
b112(A,B):-p902(A,C),p516(C,B).
b100(A,B):-p1555(A,C),b100_1(C,B).
b100_1(A,B):-p837(A,C),move_backwards(C,B).
b113(A,B):-p492(A,C),p546(C,B).
b109(A,B):-move_backwards(A,C),b109_1(C,B).
b109_1(A,B):-p1208(A,C),p1667(C,B).
b115(A,B):-move_left(A,C),b115_1(C,B).
b115_1(A,B):-p1365(A,C),move_left(C,B).
b117(A,B):-p763(A,C),p1369(C,B).
...
b118_1(A,B):-p1093(A,C),p111(C,B).
b120(A,B):-p235(A,B).
b116(A,B):-p293(A,C),b116_1(C,B).
b116_1(A,B):-p10(A,C),p369(C,B).
b114(A,B):-p293(A,C),b114_1(C,B).
b114_1(A,B):-p207(A,C),p975(C,B).
...
b126_1(A,B):-p895(A,C),p36(C,B).
b127(A,B):-p1369(A,C),p6(C,B).
b124(A,B):-p664(A,C),b124_1(C,B).
b124_1(A,B):-p167(A,C),move_right(C,B).
b129(A,B):-p484(A,C),b129_1(C,B).
b129_1(A,B):-p105(A,C),p562(C,B).
b28(A,B):-move_forwards(A,C),b28_1(C,B).
b28_1(A,B):-p318(A,C),b28_2(C,B).
b28_2(A,B):-p1100(A,C),p500(C,B).
b130(A,B):-move_forwards(A,C),b130_1(C,B).
b130_1(A,B):-p1243(A,C),p975(C,B).
b131(A,B):-move_left(A,C),b131_1(C,B).
b131_1(A,B):-p706(A,C),p1833(C,B).
b133(A,B):-p593(A,B).
b119(A,B):-p1833(A,C),b119_1(C,B).
b119_1(A,B):-p787(A,C),p1100(C,B).
b135(A,B):-p293(A,B).
b134(A,B):-p736(A,C),b134_1(C,B).
b134_1(A,B):-p1119(A,C),p77(C,B).
b137(A,B):-move_right(A,B).
b132(A,B):-p516(A,C),b132_1(C,B).
b132_1(A,B):-p1972(A,C),p271(C,B).
...
b136(A,B):-p593(A,C),b136_1(C,B).
b136_1(A,B):-p437(A,C),p372(C,B).
b128(A,B):-p218(A,C),b128_1(C,B).
b128_1(A,B):-p1177(A,C),p219(C,B).
b143(A,B):-p834(A,C),p849(C,B).
b142(A,B):-move_backwards(A,C),b142_1(C,B).
b142_1(A,B):-p1376(A,C),p492(C,B).
b145(A,B):-p242(A,C),p305(C,B).
b146(A,B):-p115(A,C),p589(C,B).
b144(A,B):-move_forwards(A,C),b144_1(C,B).
b144_1(A,B):-p1679(A,C),move_backwards(C,B).
b13(A,B):-move_backwards(A,C),b13_1(C,B).
b13_1(A,B):-p330(A,C),b13_2(C,B).
b13_2(A,B):-p579(A,C),p293(C,B).
b140(A,B):-p975(A,C),b140_1(C,B).
b140_1(A,B):-p1060(A,C),p834(C,B).
b148(A,B):-p115(A,C),b148_1(C,B).
b148_1(A,B):-p966(A,C),p559(C,B).
b151(A,B):-p144(A,C),p1600(C,B).
b152(A,B):-move_left(A,C),b152_1(C,B).
b152_1(A,B):-p242(A,C),p112(C,B).
b153(A,B):-p139(A,C),p492(C,B).
b154(A,B):-p325(A,C),p736(C,B).
b155(A,B):-p1582(A,C),p950(C,B).
b150(A,B):-p293(A,C),b150_1(C,B).
b150_1(A,B):-p1918(A,C),p1333(C,B).
b156(A,B):-p115(A,C),b156_1(C,B).
b156_1(A,B):-p1765(A,C),p1116(C,B).
b158(A,B):-p487(A,C),p822(C,B).
b147(A,B):-p290(A,C),b147_1(C,B).
b147_1(A,B):-p115(A,C),p484(C,B).
b159(A,B):-p780(A,C),b159_1(C,B).
b159_1(A,B):-p705(A,C),p115(C,B).
b160(A,B):-p780(A,C),b160_1(C,B).
b160_1(A,B):-p1952(A,C),p115(C,B).
b157(A,B):-p516(A,C),b157_1(C,B).
b157_1(A,B):-p1494(A,C),p975(C,B).
b163(A,B):-move_backwards(A,C),b163_1(C,B).
b163_1(A,B):-p845(A,C),p574(C,B).
b164(A,B):-p492(A,C),b164_1(C,B).
b164_1(A,B):-p1201(A,C),p560(C,B).
b165(A,B):-move_forwards(A,C),b165_1(C,B).
b165_1(A,B):-p1191(A,C),p255(C,B).
b166(A,B):-p293(A,C),b166_1(C,B).
b166_1(A,B):-p1450(A,C),p782(C,B).
b167(A,B):-p787(A,C),p593(C,B).
b162(A,B):-p1266(A,C),b162_1(C,B).
b162_1(A,B):-p1842(A,C),move_backwards(C,B).
b169(A,B):-move_left(A,C),b169_1(C,B).
b169_1(A,B):-p351(A,C),p369(C,B).
b170(A,B):-move_forwards(A,C),b170_1(C,B).
b170_1(A,B):-p484(A,C),p1154(C,B).
b168(A,B):-p115(A,C),b168_1(C,B).
b168_1(A,B):-p1237(A,C),p1749(C,B).
b161(A,B):-move_left(A,C),b161_1(C,B).
b161_1(A,B):-p1530(A,C),b161_2(C,B).
b161_2(A,B):-p780(A,C),p1806(C,B).
b101(A,B):-move_right(A,C),b101_1(C,B).
b101_1(A,B):-p1557(A,C),b101_2(C,B).
b101_2(A,B):-p136(A,C),move_left(C,B).
b174(A,B):-move_left(A,C),b174_1(C,B).
b174_1(A,B):-p768(A,C),p219(C,B).
b141(A,B):-move_left(A,C),b141_1(C,B).
b141_1(A,B):-p1740(A,C),b141_2(C,B).
b141_2(A,B):-p572(A,C),p7(C,B).
b171(A,B):-p838(A,C),b171_1(C,B).
b171_1(A,B):-p128(A,C),move_backwards(C,B).
b176(A,B):-move_left(A,C),b176_1(C,B).
b176_1(A,B):-p505(A,C),p975(C,B).
b178(A,B):-p1154(A,C),p780(C,B).
b177(A,B):-p1808(A,C),p484(C,B).
b175(A,B):-p369(A,C),b175_1(C,B).
b175_1(A,B):-p621(A,C),p461(C,B).
b181(A,B):-move_backwards(A,C),b181_1(C,B).
b181_1(A,B):-p905(A,C),p293(C,B).
b180(A,B):-p593(A,C),b180_1(C,B).
b180_1(A,B):-p996(A,C),p834(C,B).
b183(A,B):-p492(A,C),b183_1(C,B).
b183_1(A,B):-p487(A,C),p734(C,B).
b182(A,B):-p255(A,C),b182_1(C,B).
b182_1(A,B):-p1521(A,C),p975(C,B).
...
b121_1(A,B):-p7(A,C),b121_2(C,B).
b121_2(A,B):-p1796(A,C),move_backwards(C,B).
b189(A,B):-move_forwards(A,C),b189_1(C,B).
b189_1(A,B):-p1578(A,C),p255(C,B).
b190(A,B):-p1139(A,C),p484(C,B).
b191(A,B):-move_forwards(A,C),p720(C,B).
b186(A,B):-p1557(A,C),b186_1(C,B).
b186_1(A,B):-p1369(A,C),p609(C,B).
b188(A,B):-p1369(A,C),b188_1(C,B).
b188_1(A,B):-p1837(A,C),p1116(C,B).
b193(A,B):-move_backwards(A,C),b193_1(C,B).
b193_1(A,B):-p506(A,C),p975(C,B).
b192(A,B):-p975(A,C),b192_1(C,B).
b192_1(A,B):-p845(A,C),p662(C,B).
b194(A,B):-p492(A,C),b194_1(C,B).
b194_1(A,B):-p1792(A,C),move_forwards(C,B).
b196(A,B):-move_forwards(A,C),b196_1(C,B).
b196_1(A,B):-p515(A,C),p1116(C,B).
b198(A,B):-move_right(A,C),b198_1(C,B).
b198_1(A,B):-p1803(A,C),p587(C,B).
b195(A,B):-p492(A,C),b195_1(C,B).
b195_1(A,B):-p1137(A,C),move_forwards(C,B).
b200(A,B):-p523(A,C),p356(C,B).
b179(A,B):-move_left(A,C),b179_1(C,B).
b179_1(A,B):-p330(A,C),b179_2(C,B).
b179_2(A,B):-p195(A,C),p1559(C,B).
b202(A,B):-p664(A,C),p454(C,B).
b203(A,B):-move_forwards(A,C),b203_1(C,B).
b203_1(A,B):-p1254(A,C),p492(C,B).
b199(A,B):-p1600(A,C),b199_1(C,B).
b199_1(A,B):-p1356(A,C),p1996(C,B).
b205(A,B):-p293(A,C),p1716(C,B).
b204(A,B):-p1578(A,C),move_right(C,B).
b206(A,B):-move_right(A,C),b206_1(C,B).
b206_1(A,B):-p1246(A,C),p516(C,B).
b208(A,B):-move_left(A,C),b208_1(C,B).
b208_1(A,B):-p492(A,C),p932(C,B).
b209(A,B):-move_right(A,C),b209_1(C,B).
b209_1(A,B):-p572(A,C),p780(C,B).
b210(A,B):-p851(A,C),p1600(C,B).
b211(A,B):-move_left(A,C),b211_1(C,B).
b211_1(A,B):-p802(A,C),p947(C,B).
b212(A,B):-p1100(A,C),p1511(C,B).
b213(A,B):-p1224(A,C),p1459(C,B).
b214(A,B):-p1388(A,C),p982(C,B).
b215(A,B):-p1749(A,C),p998(C,B).
b207(A,B):-p492(A,C),b207_1(C,B).
b207_1(A,B):-p10(A,C),p255(C,B).
b216(A,B):-p24(A,C),p325(C,B).
b217(A,B):-p572(A,C),p1749(C,B).
b218(A,B):-move_forwards(A,C),b218_1(C,B).
b218_1(A,B):-p1742(A,C),p516(C,B).
b219(A,B):-p845(A,C),b219_1(C,B).
b219_1(A,B):-p925(A,C),p492(C,B).
b221(A,B):-move_left(A,C),b221_1(C,B).
b221_1(A,B):-p1907(A,C),p1516(C,B).
b222(A,B):-p1388(A,C),p656(C,B).
b223(A,B):-move_left(A,C),p780(C,B).
b224(A,B):-move_backwards(A,C),b224_1(C,B).
b224_1(A,B):-p194(A,C),p838(C,B).
b225(A,B):-p115(A,C),b225_1(C,B).
b225_1(A,B):-p212(A,C),p559(C,B).
b226(A,B):-move_right(A,C),b226_1(C,B).
b226_1(A,B):-p676(A,C),p1164(C,B).
b173(A,B):-move_right(A,C),b173_1(C,B).
b173_1(A,B):-p1116(A,C),b173_2(C,B).
b173_2(A,B):-p290(A,C),p1333(C,B).
b227(A,B):-p985(A,C),b227_1(C,B).
b227_1(A,B):-move_forwards(A,C),p136(C,B).
b229(A,B):-p834(A,C),p756(C,B).
b228(A,B):-p1333(A,C),b228_1(C,B).
b228_1(A,B):-p1873(A,C),move_forwards(C,B).
b230(A,B):-p1618(A,C),p559(C,B).
b220(A,B):-move_left(A,C),b220_1(C,B).
b220_1(A,B):-p780(A,C),b220_2(C,B).
b220_2(A,B):-p1158(A,C),p510(C,B).
b233(A,B):-move_forwards(A,C),b233_1(C,B).
b233_1(A,B):-p351(A,C),move_right(C,B).
b231(A,B):-p947(A,C),b231_1(C,B).
b231_1(A,B):-p632(A,C),move_forwards(C,B).
b235(A,B):-p1784(A,C),move_forwards(C,B).
b236(A,B):-p115(A,C),p1517(C,B).
b237(A,B):-p235(A,C),p368(C,B).
b238(A,B):-move_left(A,C),b238_1(C,B).
b238_1(A,B):-p1607(A,C),move_right(C,B).
b172(A,B):-move_right(A,C),b172_1(C,B).
b172_1(A,B):-p834(A,C),b172_2(C,B).
b172_2(A,B):-p1638(A,C),p736(C,B).
b240(A,B):-p115(A,C),p1789(C,B).
b232(A,B):-p1100(A,C),b232_1(C,B).
b232_1(A,B):-p241(A,C),p613(C,B).
b242(A,B):-p1388(A,C),p1365(C,B).
b239(A,B):-move_left(A,C),b239_1(C,B).
b239_1(A,B):-p1232(A,C),p1395(C,B).
b243(A,B):-p23(A,C),p947(C,B).
b244(A,B):-p1887(A,C),p369(C,B).
b245(A,B):-p1881(A,C),p736(C,B).
b246(A,B):-p1646(A,C),p112(C,B).
b247(A,B):-p1565(A,C),p975(C,B).
b234(A,B):-p255(A,C),b234_1(C,B).
b234_1(A,B):-p31(A,C),move_forwards(C,B).
b249(A,B):-move_left(A,C),b249_1(C,B).
b249_1(A,B):-p996(A,C),p293(C,B).
b248(A,B):-move_right(A,C),b248_1(C,B).
b248_1(A,B):-p1318(A,C),p1388(C,B).
b251(A,B):-p298(A,C),p1740(C,B).
b252(A,B):-move_left(A,C),b252_1(C,B).
b252_1(A,B):-p780(A,C),p461(C,B).
b253(A,B):-move_left(A,C),b253_1(C,B).
b253_1(A,B):-p1333(A,C),p1083(C,B).
b254(A,B):-move_right(A,C),b254_1(C,B).
b254_1(A,B):-p393(A,C),p1789(C,B).
b255(A,B):-move_forwards(A,C),b255_1(C,B).
b255_1(A,B):-p1219(A,C),move_right(C,B).
b257(A,B):-p1743(A,C),move_backwards(C,B).
b241(A,B):-p838(A,C),b241_1(C,B).
b241_1(A,B):-p1060(A,C),p115(C,B).
b197(A,B):-move_right(A,C),b197_1(C,B).
b197_1(A,B):-p1158(A,C),b197_2(C,B).
b197_2(A,B):-p1254(A,C),p293(C,B).
b260(A,B):-move_backwards(A,C),p765(C,B).
b250(A,B):-p1100(A,C),b250_1(C,B).
b250_1(A,B):-p57(A,C),p1390(C,B).
b261(A,B):-p536(A,C),p1205(C,B).
b259(A,B):-p115(A,C),b259_1(C,B).
b259_1(A,B):-p1657(A,C),p1667(C,B).
b263(A,B):-move_right(A,C),b263_1(C,B).
b263_1(A,B):-p1211(A,C),p492(C,B).
b264(A,B):-move_left(A,C),b264_1(C,B).
b264_1(A,B):-p985(A,C),p1628(C,B).
b266(A,B):-p838(A,C),p1570(C,B).
b262(A,B):-p664(A,C),b262_1(C,B).
b262_1(A,B):-p1055(A,C),p255(C,B).
b268(A,B):-p705(A,C),p295(C,B).
b256(A,B):-p1116(A,C),b256_1(C,B).
b256_1(A,B):-p1797(A,C),move_forwards(C,B).
b258(A,B):-p583(A,C),b258_1(C,B).
b258_1(A,B):-p780(A,C),p1294(C,B).
b271(A,B):-p1116(A,C),p1797(C,B).
b265(A,B):-p115(A,C),b265_1(C,B).
b265_1(A,B):-p1226(A,C),p1905(C,B).
b269(A,B):-move_forwards(A,C),b269_1(C,B).
b269_1(A,B):-p305(A,C),p1077(C,B).
b267(A,B):-move_backwards(A,C),b267_1(C,B).
b267_1(A,B):-p1618(A,C),p245(C,B).
b275(A,B):-p510(A,C),grab_ball(C,B).
b276(A,B):-p1369(A,C),p1996(C,B).
b274(A,B):-move_right(A,C),b274_1(C,B).
b274_1(A,B):-p1690(A,C),p393(C,B).
b277(A,B):-move_left(A,C),b277_1(C,B).
b277_1(A,B):-p454(A,C),p115(C,B).
b278(A,B):-move_left(A,C),b278_1(C,B).
b278_1(A,B):-p1255(A,C),p458(C,B).
b272(A,B):-p1020(A,C),b272_1(C,B).
b272_1(A,B):-p857(A,C),p1388(C,B).
b280(A,B):-p599(A,C),p1667(C,B).
b282(A,B):-move_left(A,C),p1369(C,B).
b283(A,B):-p880(A,C),p246(C,B).
b270(A,B):-p235(A,C),b270_1(C,B).
b270_1(A,B):-p1186(A,C),p1644(C,B).
...
b273(A,B):-p1100(A,C),b273_1(C,B).
b273_1(A,B):-p1385(A,C),p152(C,B).
b289(A,B):-move_left(A,C),b289_1(C,B).
b289_1(A,B):-p972(A,C),p664(C,B).
b291(A,B):-move_right(A,C),b291_1(C,B).
b291_1(A,B):-p1100(A,C),p1797(C,B).
b292(A,B):-move_forwards(A,C),b292_1(C,B).
b292_1(A,B):-p1564(A,C),drop_ball(C,B).
b279(A,B):-p510(A,C),b279_1(C,B).
b279_1(A,B):-p666(A,C),p1600(C,B).
b287(A,B):-p481(A,C),b287_1(C,B).
b287_1(A,B):-p423(A,C),move_backwards(C,B).
b295(A,B):-p717(A,B).
b281(A,B):-p152(A,C),b281_1(C,B).
b281_1(A,B):-p904(A,C),p1555(C,B).
b297(A,B):-move_right(A,C),p301(C,B).
b298(A,B):-move_right(A,C),b298_1(C,B).
b298_1(A,B):-p560(A,C),p1600(C,B).
b294(A,B):-p1749(A,C),b294_1(C,B).
b294_1(A,B):-p1243(A,C),p704(C,B).
b300(A,B):-move_left(A,C),p1388(C,B).
b301(A,B):-p255(A,C),p1118(C,B).
b299(A,B):-move_left(A,C),b299_1(C,B).
b299_1(A,B):-p1740(A,C),p903(C,B).
b303(A,B):-p212(A,C),p1388(C,B).
b293(A,B):-p1564(A,C),b293_1(C,B).
b293_1(A,B):-p136(A,C),p1940(C,B).
b304(A,B):-p115(A,C),b304_1(C,B).
b304_1(A,B):-p852(A,C),p834(C,B).
b302(A,B):-p1369(A,C),b302_1(C,B).
b302_1(A,B):-p984(A,C),p789(C,B).
b307(A,B):-move_left(A,C),b307_1(C,B).
b307_1(A,B):-p186(A,C),p1932(C,B).
b306(A,B):-p293(A,C),b306_1(C,B).
b306_1(A,B):-p1881(A,C),p838(C,B).
b296(A,B):-p35(A,C),b296_1(C,B).
b296_1(A,B):-p1254(A,C),p1869(C,B).
b310(A,B):-p593(A,C),p1278(C,B).
b308(A,B):-p664(A,C),b308_1(C,B).
b308_1(A,B):-p1071(A,C),p1559(C,B).
b309(A,B):-p664(A,C),b309_1(C,B).
b309_1(A,B):-p1390(A,C),p516(C,B).
b313(A,B):-p115(A,C),b313_1(C,B).
b313_1(A,B):-p16(A,C),p125(C,B).
b314(A,B):-move_left(A,C),p1100(C,B).
b312(A,B):-p1555(A,C),b312_1(C,B).
b312_1(A,B):-p710(A,C),p152(C,B).
b316(A,B):-move_left(A,C),b316_1(C,B).
b316_1(A,B):-p1926(A,C),p838(C,B).
b311(A,B):-p1600(A,C),b311_1(C,B).
b311_1(A,B):-p905(A,C),p510(C,B).
b318(A,B):-move_backwards(A,B).
b317(A,B):-p975(A,C),b317_1(C,B).
b317_1(A,B):-p133(A,C),move_forwards(C,B).
b319(A,B):-move_right(A,C),b319_1(C,B).
b319_1(A,B):-p1101(A,C),p258(C,B).
b315(A,B):-p510(A,C),b315_1(C,B).
b315_1(A,B):-p219(A,C),p780(C,B).
b322(A,B):-p664(A,C),p482(C,B).
b201(A,B):-p115(A,C),b201_1(C,B).
b201_1(A,B):-p133(A,C),b201_2(C,B).
b201_2(A,B):-p1116(A,C),p1642(C,B).
b320(A,B):-p1600(A,C),b320_1(C,B).
b320_1(A,B):-p52(A,C),p838(C,B).
b324(A,B):-move_backwards(A,C),b324_1(C,B).
b324_1(A,B):-p782(A,C),p1615(C,B).
b323(A,B):-p492(A,C),b323_1(C,B).
b323_1(A,B):-p1032(A,C),move_left(C,B).
b326(A,B):-move_right(A,C),b326_1(C,B).
b326_1(A,B):-p242(A,C),p235(C,B).
b328(A,B):-p510(A,C),p1648(C,B).
b329(A,B):-p1164(A,C),p845(C,B).
b290(A,B):-move_left(A,C),b290_1(C,B).
b290_1(A,B):-p583(A,C),b290_2(C,B).
b290_2(A,B):-p492(A,C),p1294(C,B).
b331(A,B):-move_left(A,C),b331_1(C,B).
b331_1(A,B):-p1183(A,C),p1600(C,B).
b332(A,B):-move_forwards(A,C),b332_1(C,B).
b332_1(A,B):-p922(A,C),p1195(C,B).
b330(A,B):-p115(A,C),b330_1(C,B).
b330_1(A,B):-p1873(A,C),p1833(C,B).
b334(A,B):-p593(A,C),p809(C,B).
b327(A,B):-p7(A,C),b327_1(C,B).
b327_1(A,B):-p1739(A,C),move_right(C,B).
b333(A,B):-p293(A,C),b333_1(C,B).
b333_1(A,B):-p319(A,C),p496(C,B).
b335(A,B):-move_backwards(A,C),b335_1(C,B).
b335_1(A,B):-p1646(A,C),p834(C,B).
b321(A,B):-p218(A,C),b321_1(C,B).
b321_1(A,B):-p975(A,C),p1918(C,B).
b339(A,B):-p115(A,C),p195(C,B).
b340(A,B):-p956(A,B).
b341(A,B):-p838(A,C),p373(C,B).
b337(A,B):-p664(A,C),b337_1(C,B).
b337_1(A,B):-p242(A,C),p1048(C,B).
b342(A,B):-p293(A,C),b342_1(C,B).
b342_1(A,B):-p516(A,C),p234(C,B).
b336(A,B):-p1740(A,C),b336_1(C,B).
b336_1(A,B):-p905(A,C),p664(C,B).
b345(A,B):-move_backwards(A,C),b345_1(C,B).
b345_1(A,B):-p1716(A,C),p115(C,B).
...
b347_1(A,B):-p1972(A,C),p492(C,B).
b350(A,B):-move_left(A,C),b350_1(C,B).
b350_1(A,B):-p676(A,C),p484(C,B).
b305(A,B):-move_right(A,C),b305_1(C,B).
b305_1(A,B):-p1243(A,C),b305_2(C,B).
b305_2(A,B):-p303(A,C),move_right(C,B).
b344(A,B):-p1116(A,C),b344_1(C,B).
b344_1(A,B):-p693(A,C),move_left(C,B).
b353(A,B):-p492(A,C),b353_1(C,B).
b353_1(A,B):-p1829(A,C),move_backwards(C,B).
b354(A,B):-p834(A,C),p239(C,B).
...
b362_1(A,B):-p768(A,C),p593(C,B).
b363(A,B):-p7(A,C),b363_1(C,B).
b363_1(A,B):-p1739(A,C),p1309(C,B).
b364(A,B):-move_right(A,C),b364_1(C,B).
b364_1(A,B):-p242(A,C),p975(C,B).
b351(A,B):-p1773(A,C),b351_1(C,B).
b351_1(A,B):-p1844(A,C),p613(C,B).
...
b366_1(A,B):-p1837(A,C),move_forwards(C,B).
b361(A,B):-p1600(A,C),b361_1(C,B).
b361_1(A,B):-p677(A,C),p1369(C,B).
b369(A,B):-p780(A,C),b369_1(C,B).
b369_1(A,B):-p276(A,C),p834(C,B).
b371(A,B):-move_forwards(A,C),b371_1(C,B).
b371_1(A,B):-p1243(A,C),p115(C,B).
b372(A,B):-move_forwards(A,C),p706(C,B).
b373(A,B):-p922(A,C),p664(C,B).
b374(A,B):-p780(A,C),p729(C,B).
b338(A,B):-move_left(A,C),b338_1(C,B).
b338_1(A,B):-p484(A,C),b338_2(C,B).
b338_2(A,B):-p1755(A,C),p1555(C,B).
b370(A,B):-p516(A,C),b370_1(C,B).
b370_1(A,B):-p1356(A,C),p1063(C,B).
b376(A,B):-move_left(A,C),b376_1(C,B).
b376_1(A,B):-p434(A,C),p1100(C,B).
b325(A,B):-move_right(A,C),b325_1(C,B).
b325_1(A,B):-p1555(A,C),b325_2(C,B).
b325_2(A,B):-p687(A,C),p1740(C,B).
b379(A,B):-p1463(A,C),p734(C,B).
b377(A,B):-move_right(A,C),b377_1(C,B).
b377_1(A,B):-p133(A,C),p510(C,B).
b381(A,B):-p1049(A,C),b381_1(C,B).
b381_1(A,B):-p793(A,C),p1388(C,B).
b378(A,B):-p1544(A,C),b378_1(C,B).
b378_1(A,B):-p484(A,C),p935(C,B).
b380(A,B):-p516(A,C),b380_1(C,B).
b380_1(A,B):-p1036(A,C),p1581(C,B).
b382(A,B):-p492(A,C),b382_1(C,B).
b382_1(A,B):-p1168(A,C),p593(C,B).
b384(A,B):-p235(A,C),b384_1(C,B).
b384_1(A,B):-p242(A,C),p1555(C,B).
b385(A,B):-p369(A,C),b385_1(C,B).
b385_1(A,B):-p729(A,C),p235(C,B).
b386(A,B):-move_backwards(A,C),b386_1(C,B).
b386_1(A,B):-p765(A,C),p736(C,B).
b388(A,B):-move_backwards(A,C),b388_1(C,B).
b388_1(A,B):-p272(A,C),p537(C,B).
b387(A,B):-p1116(A,C),b387_1(C,B).
b387_1(A,B):-p1060(A,C),p834(C,B).
b389(A,B):-p780(A,C),b389_1(C,B).
b389_1(A,B):-p325(A,C),p838(C,B).
b391(A,B):-p1024(A,C),p295(C,B).
b392(A,B):-move_right(A,C),b392_1(C,B).
b392_1(A,B):-p715(A,C),p492(C,B).
b393(A,B):-move_right(A,C),b393_1(C,B).
b393_1(A,B):-p195(A,C),p838(C,B).
%timeout
b394(A,B):-p25(A,C),p271(C,B).
b395(A,B):-move_forwards(A,C),b395_1(C,B).
b395_1(A,B):-p506(A,C),p303(C,B).
b397(A,B):-p607(A,C),p293(C,B).
b398(A,B):-p593(A,C),p1012(C,B).
b399(A,B):-p293(A,C),p1352(C,B).
b357(A,B):-move_left(A,C),b357_1(C,B).
b357_1(A,B):-p1100(A,C),b357_2(C,B).
b357_2(A,B):-p1185(A,C),p148(C,B).
b390(A,B):-p1333(A,C),b390_1(C,B).
b390_1(A,B):-p956(A,C),p1551(C,B).
b396(A,B):-p838(A,C),b396_1(C,B).
b396_1(A,B):-p1727(A,C),p966(C,B).
b403(A,B):-move_right(A,C),p561(C,B).
b404(A,B):-p1369(A,C),p633(C,B).
%timeout
b405(A,B):-grab_ball(A,C),b405_1(C,B).
b405_1(A,B):-p1515(A,C),move_forwards(C,B).
b400(A,B):-p780(A,C),b400_1(C,B).
b400_1(A,B):-p765(A,C),p950(C,B).
b408(A,B):-p834(A,C),p559(C,B).
b407(A,B):-p79(A,C),p1093(C,B).
b410(A,B):-p834(A,C),p96(C,B).
b402(A,B):-p293(A,C),b402_1(C,B).
b402_1(A,B):-p1184(A,C),p369(C,B).
b411(A,B):-p293(A,C),p1530(C,B).
b409(A,B):-move_left(A,C),b409_1(C,B).
b409_1(A,B):-p1607(A,C),p1749(C,B).
b414(A,B):-move_left(A,C),b414_1(C,B).
b414_1(A,B):-p1333(A,C),p1273(C,B).
b406(A,B):-p593(A,C),b406_1(C,B).
b406_1(A,B):-p710(A,C),p834(C,B).
b375(A,B):-move_left(A,C),b375_1(C,B).
b375_1(A,B):-p112(A,C),b375_2(C,B).
b375_2(A,B):-p687(A,C),p838(C,B).
b417(A,B):-p787(A,C),p293(C,B).
b418(A,B):-move_right(A,C),p950(C,B).
b415(A,B):-grab_ball(A,C),b415_1(C,B).
b415_1(A,B):-p120(A,C),p7(C,B).
b343(A,B):-move_right(A,C),b343_1(C,B).
b343_1(A,B):-p59(A,C),b343_2(C,B).
b343_2(A,B):-p553(A,C),move_left(C,B).
b412(A,B):-p593(A,C),b412_1(C,B).
b412_1(A,B):-p1259(A,C),p112(C,B).
b401(A,B):-p1322(A,C),b401_1(C,B).
b401_1(A,B):-p633(A,C),move_backwards(C,B).
b419(A,B):-p7(A,C),b419_1(C,B).
b419_1(A,B):-p1743(A,C),p1195(C,B).
b420(A,B):-p664(A,C),b420_1(C,B).
b420_1(A,B):-p6(A,C),p1376(C,B).
b423(A,B):-p115(A,C),b423_1(C,B).
b423_1(A,B):-p295(A,C),p510(C,B).
b424(A,B):-move_forwards(A,C),b424_1(C,B).
b424_1(A,B):-p40(A,C),p780(C,B).
b426(A,B):-p1195(A,C),p1543(C,B).
b428(A,B):-p833(A,C),p991(C,B).
b425(A,B):-move_left(A,C),b425_1(C,B).
b425_1(A,B):-p1802(A,C),p1979(C,B).
b430(A,B):-p1555(A,B).
b431(A,B):-move_backwards(A,C),b431_1(C,B).
b431_1(A,B):-p595(A,C),p947(C,B).
b432(A,B):-p235(A,C),p561(C,B).
b427(A,B):-p369(A,C),b427_1(C,B).
b427_1(A,B):-p568(A,C),p1100(C,B).
b433(A,B):-move_left(A,C),b433_1(C,B).
b433_1(A,B):-p770(A,C),p255(C,B).
b435(A,B):-p115(A,C),b435_1(C,B).
b435_1(A,B):-p1310(A,C),p440(C,B).
b436(A,B):-p369(A,B).
b434(A,B):-p780(A,C),b434_1(C,B).
b434_1(A,B):-p1606(A,C),p516(C,B).
b421(A,B):-p646(A,C),b421_1(C,B).
b421_1(A,B):-p633(A,C),move_backwards(C,B).
b439(A,B):-p586(A,C),move_right(C,B).
b437(A,B):-move_forwards(A,C),b437_1(C,B).
b437_1(A,B):-p506(A,C),p1100(C,B).
b440(A,B):-p1220(A,C),p838(C,B).
b441(A,B):-p43(A,C),p144(C,B).
b416(A,B):-p902(A,C),b416_1(C,B).
b416_1(A,B):-p170(A,C),p369(C,B).
b444(A,B):-p227(A,C),p838(C,B).
b438(A,B):-p1369(A,C),b438_1(C,B).
b438_1(A,B):-p1910(A,C),p1833(C,B).
b383(A,B):-move_left(A,C),b383_1(C,B).
b383_1(A,B):-p492(A,C),b383_2(C,B).
b383_2(A,B):-p1494(A,C),p484(C,B).
b446(A,B):-p293(A,C),b446_1(C,B).
b446_1(A,B):-p1164(A,C),p1340(C,B).
b442(A,B):-p593(A,C),b442_1(C,B).
b442_1(A,B):-p991(A,C),p838(C,B).
b448(A,B):-p1600(A,C),p986(C,B).
b450(A,B):-p666(A,C),p1388(C,B).
b451(A,B):-p293(A,C),p1267(C,B).
b447(A,B):-p369(A,C),b447_1(C,B).
b447_1(A,B):-p1024(A,C),move_left(C,B).
%timeout
b454(A,B):-move_backwards(A,C),b454_1(C,B).
b454_1(A,B):-p1765(A,C),p838(C,B).
b453(A,B):-p581(A,C),b453_1(C,B).
b453_1(A,B):-p1100(A,C),p98(C,B).
b452(A,B):-p25(A,C),b452_1(C,B).
b452_1(A,B):-p510(A,C),p1470(C,B).
b456(A,B):-move_left(A,C),b456_1(C,B).
b456_1(A,B):-p779(A,C),p1511(C,B).
b458(A,B):-p507(A,C),move_backwards(C,B).
b459(A,B):-p115(A,C),b459_1(C,B).
b459_1(A,B):-p356(A,C),p115(C,B).
b457(A,B):-p369(A,C),b457_1(C,B).
b457_1(A,B):-p259(A,C),p1026(C,B).
b461(A,B):-p1100(A,C),p1205(C,B).
b455(A,B):-p368(A,C),b455_1(C,B).
b455_1(A,B):-p1570(A,C),p7(C,B).
b460(A,B):-p369(A,C),b460_1(C,B).
b460_1(A,B):-p1718(A,C),p664(C,B).
b464(A,B):-move_right(A,C),p510(C,B).
b462(A,B):-move_left(A,C),b462_1(C,B).
b462_1(A,B):-p57(A,C),p115(C,B).
b465(A,B):-p780(A,C),b465_1(C,B).
b465_1(A,B):-p505(A,C),move_right(C,B).
b467(A,B):-p271(A,C),p902(C,B).
b468(A,B):-p1277(A,C),p3(C,B).
b463(A,B):-p235(A,C),b463_1(C,B).
b463_1(A,B):-p168(A,C),move_right(C,B).
...
b472_1(A,B):-p1266(A,C),p1522(C,B).
b413(A,B):-move_left(A,C),b413_1(C,B).
b413_1(A,B):-p780(A,C),b413_2(C,B).
b413_2(A,B):-p984(A,C),p789(C,B).
b474(A,B):-p975(A,B).
b475(A,B):-p293(A,C),b475_1(C,B).
b475_1(A,B):-p1470(A,C),p1770(C,B).
b476(A,B):-p492(A,C),p1390(C,B).
b477(A,B):-p290(A,C),p1749(C,B).
b473(A,B):-p780(A,C),b473_1(C,B).
b473_1(A,B):-p292(A,C),p979(C,B).
b478(A,B):-move_forwards(A,C),b478_1(C,B).
b478_1(A,B):-p922(A,C),p280(C,B).
b466(A,B):-p922(A,C),b466_1(C,B).
b466_1(A,B):-p1116(A,C),p258(C,B).
b480(A,B):-move_left(A,C),b480_1(C,B).
b480_1(A,B):-p996(A,C),p293(C,B).
b479(A,B):-move_left(A,C),b479_1(C,B).
b479_1(A,B):-p1571(A,C),p293(C,B).
b481(A,B):-move_left(A,C),b481_1(C,B).
b481_1(A,B):-p736(A,C),p1909(C,B).
b483(A,B):-move_left(A,C),b483_1(C,B).
b483_1(A,B):-p515(A,C),p1118(C,B).
b485(A,B):-p679(A,C),p293(C,B).
b486(A,B):-p1470(A,C),p235(C,B).
b482(A,B):-p868(A,C),b482_1(C,B).
b482_1(A,B):-p552(A,C),p834(C,B).
b484(A,B):-p593(A,C),b484_1(C,B).
b484_1(A,B):-p254(A,C),move_backwards(C,B).
...
b489(A,B):-p780(A,C),b489_1(C,B).
b489_1(A,B):-p155(A,C),p1948(C,B).
b493(A,B):-move_left(A,C),b493_1(C,B).
b493_1(A,B):-p967(A,C),p947(C,B).
b443(A,B):-move_left(A,C),b443_1(C,B).
b443_1(A,B):-p255(A,C),b443_2(C,B).
b443_2(A,B):-p63(A,C),p484(C,B).
b494(A,B):-move_backwards(A,C),b494_1(C,B).
b494_1(A,B):-p851(A,C),p1100(C,B).
b496(A,B):-move_forwards(A,C),p726(C,B).
b497(A,B):-move_left(A,C),b497_1(C,B).
b497_1(A,B):-p1740(A,C),p1168(C,B).
b487(A,B):-p481(A,C),b487_1(C,B).
b487_1(A,B):-p423(A,C),move_left(C,B).
b498(A,B):-p133(A,C),p735(C,B).
b500(A,B):-p430(A,C),move_backwards(C,B).
b499(A,B):-move_left(A,C),b499_1(C,B).
b499_1(A,B):-p364(A,C),p293(C,B).
b502(A,B):-move_forwards(A,C),b502_1(C,B).
b502_1(A,B):-p1309(A,C),p950(C,B).
b501(A,B):-p838(A,C),b501_1(C,B).
b501_1(A,B):-p553(A,C),p782(C,B).
b504(A,B):-p1388(A,C),p1133(C,B).
b505(A,B):-p93(A,C),p264(C,B).
b506(A,B):-move_forwards(A,C),b506_1(C,B).
b506_1(A,B):-p430(A,C),move_backwards(C,B).
b495(A,B):-p348(A,C),b495_1(C,B).
b495_1(A,B):-p690(A,C),p1388(C,B).
b503(A,B):-p779(A,C),b503_1(C,B).
b503_1(A,B):-move_right(A,C),p1852(C,B).
b509(A,B):-p168(A,C),p1350(C,B).
b508(A,B):-move_backwards(A,C),b508_1(C,B).
b508_1(A,B):-p811(A,C),p1833(C,B).
b510(A,B):-p572(A,C),p510(C,B).
b511(A,B):-move_right(A,C),b511_1(C,B).
b511_1(A,B):-p1352(A,C),p1833(C,B).
b513(A,B):-move_backwards(A,C),b513_1(C,B).
b513_1(A,B):-p28(A,C),p1681(C,B).
b514(A,B):-p369(A,C),p1684(C,B).
b507(A,B):-p1555(A,C),b507_1(C,B).
b507_1(A,B):-p1470(A,C),p1466(C,B).
b516(A,B):-p975(A,C),b516_1(C,B).
b516_1(A,B):-p1158(A,C),p788(C,B).
b469(A,B):-move_left(A,C),b469_1(C,B).
b469_1(A,B):-p318(A,C),b469_2(C,B).
b469_2(A,B):-p1280(A,C),p780(C,B).
b517(A,B):-p1116(A,C),b517_1(C,B).
b517_1(A,B):-p1395(A,C),p838(C,B).
b519(A,B):-p369(A,C),p1795(C,B).
b520(A,B):-p1506(A,C),p1226(C,B).
b518(A,B):-p1333(A,C),b518_1(C,B).
b518_1(A,B):-p1267(A,C),p1388(C,B).
b522(A,B):-move_left(A,C),b522_1(C,B).
b522_1(A,B):-p1837(A,C),move_forwards(C,B).
b521(A,B):-p115(A,C),b521_1(C,B).
b521_1(A,B):-p1564(A,C),p136(C,B).
b524(A,B):-p1333(A,C),p1267(C,B).
b525(A,B):-move_right(A,C),b525_1(C,B).
b525_1(A,B):-p128(A,C),p1555(C,B).
b523(A,B):-p293(A,C),b523_1(C,B).
b523_1(A,B):-p98(A,C),p235(C,B).
b527(A,B):-move_left(A,C),b527_1(C,B).
b527_1(A,B):-p272(A,C),p232(C,B).
b528(A,B):-move_backwards(A,C),p1139(C,B).
b529(A,B):-p780(A,C),p1673(C,B).
b526(A,B):-move_left(A,C),b526_1(C,B).
b526_1(A,B):-p1887(A,C),p293(C,B).
b531(A,B):-p736(A,C),p1763(C,B).
b532(A,B):-p1100(A,C),p19(C,B).
b533(A,B):-p492(A,C),p1245(C,B).
b534(A,B):-move_right(A,C),b534_1(C,B).
b534_1(A,B):-p195(A,C),p369(C,B).
b535(A,B):-p513(A,C),p838(C,B).
b536(A,B):-move_left(A,C),b536_1(C,B).
b536_1(A,B):-p399(A,C),p1195(C,B).
b537(A,B):-move_right(A,C),b537_1(C,B).
b537_1(A,B):-p834(A,C),p1907(C,B).
b530(A,B):-p31(A,C),b530_1(C,B).
b530_1(A,B):-p1116(A,C),p1024(C,B).
b538(A,B):-move_right(A,C),b538_1(C,B).
b538_1(A,B):-p1226(A,C),p1116(C,B).
b539(A,B):-move_left(A,C),b539_1(C,B).
b539_1(A,B):-p430(A,C),p115(C,B).
b368(A,B):-p115(A,C),b368_1(C,B).
b368_1(A,B):-p922(A,C),b368_2(C,B).
b368_2(A,B):-p1343(A,C),p484(C,B).
b540(A,B):-p1133(A,C),p975(C,B).
b541(A,B):-move_right(A,C),b541_1(C,B).
b541_1(A,B):-p134(A,C),p807(C,B).
b544(A,B):-p492(A,C),b544_1(C,B).
b544_1(A,B):-p619(A,C),p664(C,B).
b545(A,B):-p780(A,C),b545_1(C,B).
b545_1(A,B):-p1100(A,C),p500(C,B).
b449(A,B):-move_forwards(A,C),b449_1(C,B).
b449_1(A,B):-p887(A,C),b449_2(C,B).
b449_2(A,B):-p1077(A,C),p460(C,B).
b542(A,B):-p838(A,C),b542_1(C,B).
b542_1(A,B):-p428(A,C),p947(C,B).
b422(A,B):-move_forwards(A,C),b422_1(C,B).
b422_1(A,B):-p922(A,C),b422_2(C,B).
b422_2(A,B):-p838(A,C),p1409(C,B).
b548(A,B):-p822(A,C),p1896(C,B).
b550(A,B):-p1966(A,C),p492(C,B).
b543(A,B):-p1273(A,C),b543_1(C,B).
b543_1(A,B):-p364(A,C),p975(C,B).
b552(A,B):-p510(A,C),p1181(C,B).
b547(A,B):-p293(A,C),b547_1(C,B).
b547_1(A,B):-p335(A,C),move_left(C,B).
b554(A,B):-move_right(A,C),p325(C,B).
b555(A,B):-move_right(A,C),b555_1(C,B).
b555_1(A,B):-p1049(A,C),p799(C,B).
b551(A,B):-p369(A,C),b551_1(C,B).
b551_1(A,B):-p1220(A,C),move_backwards(C,B).
b556(A,B):-move_forwards(A,C),b556_1(C,B).
b556_1(A,B):-p1404(A,C),p1667(C,B).
b557(A,B):-move_forwards(A,C),b557_1(C,B).
b557_1(A,B):-p1797(A,C),p947(C,B).
b553(A,B):-p516(A,C),b553_1(C,B).
b553_1(A,B):-p1925(A,C),p323(C,B).
b558(A,B):-move_forwards(A,C),b558_1(C,B).
b558_1(A,B):-p1801(A,C),p593(C,B).
b559(A,B):-move_right(A,C),b559_1(C,B).
b559_1(A,B):-p1116(A,C),p139(C,B).
b561(A,B):-p1905(A,C),p293(C,B).
b546(A,B):-p582(A,C),b546_1(C,B).
b546_1(A,B):-p1904(A,C),p235(C,B).
b549(A,B):-p947(A,C),b549_1(C,B).
b549_1(A,B):-p1024(A,C),move_backwards(C,B).
b565(A,B):-move_backwards(A,C),p696(C,B).
b566(A,B):-p224(A,C),move_right(C,B).
b567(A,B):-move_backwards(A,C),p1137(C,B).
b568(A,B):-p834(A,C),p529(C,B).
b562(A,B):-move_forwards(A,C),b562_1(C,B).
b562_1(A,B):-p1296(A,C),move_left(C,B).
b560(A,B):-p115(A,C),b560_1(C,B).
b560_1(A,B):-p1802(A,C),p1195(C,B).
b570(A,B):-grab_ball(A,C),b570_1(C,B).
b570_1(A,B):-p136(A,C),move_backwards(C,B).
b564(A,B):-p1388(A,C),b564_1(C,B).
b564_1(A,B):-p139(A,C),p1195(C,B).
b563(A,B):-p593(A,C),b563_1(C,B).
b563_1(A,B):-p1638(A,C),move_right(C,B).
b492(A,B):-move_forwards(A,C),b492_1(C,B).
b492_1(A,B):-p656(A,C),b492_2(C,B).
b492_2(A,B):-p1667(A,C),p1594(C,B).
b573(A,B):-move_left(A,C),b573_1(C,B).
b573_1(A,B):-p229(A,C),p369(C,B).
b575(A,B):-move_right(A,C),b575_1(C,B).
b575_1(A,B):-p1164(A,C),p947(C,B).
b577(A,B):-p144(A,C),move_left(C,B).
b572(A,B):-move_backwards(A,C),b572_1(C,B).
b572_1(A,B):-p1587(A,C),p979(C,B).
b574(A,B):-p293(A,C),b574_1(C,B).
b574_1(A,B):-p121(A,C),p1830(C,B).
b580(A,B):-p1633(A,C),p1909(C,B).
b581(A,B):-p529(A,C),p487(C,B).
b582(A,B):-p717(A,B).
b576(A,B):-p115(A,C),b576_1(C,B).
b576_1(A,B):-p1395(A,C),p838(C,B).
b512(A,B):-move_left(A,C),b512_1(C,B).
b512_1(A,B):-p1833(A,C),b512_2(C,B).
b512_2(A,B):-p880(A,C),p1749(C,B).
b583(A,B):-move_backwards(A,C),b583_1(C,B).
b583_1(A,B):-p1506(A,C),p484(C,B).
b584(A,B):-move_right(A,C),b584_1(C,B).
b584_1(A,B):-p1133(A,C),p593(C,B).
b578(A,B):-p369(A,C),b578_1(C,B).
b578_1(A,B):-p1570(A,C),p1816(C,B).
b569(A,B):-p1667(A,C),b569_1(C,B).
b569_1(A,B):-p1164(A,C),p112(C,B).
b586(A,B):-move_forwards(A,C),b586_1(C,B).
b586_1(A,B):-p1220(A,C),p1781(C,B).
b590(A,B):-p664(A,C),p1571(C,B).
b588(A,B):-move_forwards(A,C),b588_1(C,B).
b588_1(A,B):-p318(A,C),p1100(C,B).
b579(A,B):-p780(A,C),b579_1(C,B).
b579_1(A,B):-p1263(A,C),p857(C,B).
b585(A,B):-p7(A,C),b585_1(C,B).
b585_1(A,B):-p942(A,C),p947(C,B).
...
b594_1(A,B):-p1885(A,C),move_right(C,B).
b587(A,B):-p510(A,C),b587_1(C,B).
b587_1(A,B):-p1470(A,C),p1667(C,B).
...
b602(A,B):-p242(A,C),p956(C,B).
b603(A,B):-p1446(A,C),p350(C,B).
b600(A,B):-move_left(A,C),b600_1(C,B).
b600_1(A,B):-p253(A,C),p1600(C,B).
b606(A,B):-p1904(A,C),move_backwards(C,B).
b591(A,B):-p510(A,C),b591_1(C,B).
b591_1(A,B):-p1509(A,C),p975(C,B).
b604(A,B):-move_right(A,C),b604_1(C,B).
b604_1(A,B):-p128(A,C),p369(C,B).
...
b612(A,B):-p492(A,C),p1526(C,B).
b611(A,B):-move_left(A,C),b611_1(C,B).
b611_1(A,B):-p1093(A,C),p58(C,B).
...
b615_1(A,B):-p458(A,C),p229(C,B).
b616(A,B):-move_forwards(A,C),b616_1(C,B).
b616_1(A,B):-p1530(A,C),p516(C,B).
b618(A,B):-move_left(A,C),b618_1(C,B).
b618_1(A,B):-p1388(A,C),p224(C,B).
b619(A,B):-p305(A,C),move_forwards(C,B).
b620(A,B):-p1100(A,C),p1118(C,B).
b597(A,B):-p192(A,C),b597_1(C,B).
b597_1(A,B):-p254(A,C),p481(C,B).
b617(A,B):-p7(A,C),b617_1(C,B).
b617_1(A,B):-p1184(A,C),p1388(C,B).
b623(A,B):-move_left(A,C),p1395(C,B).
b624(A,B):-move_right(A,C),p564(C,B).
b622(A,B):-move_backwards(A,C),b622_1(C,B).
b622_1(A,B):-p662(A,C),p842(C,B).
b625(A,B):-move_right(A,C),b625_1(C,B).
b625_1(A,B):-p1100(A,C),p1352(C,B).
b627(A,B):-move_left(A,C),b627_1(C,B).
b627_1(A,B):-p399(A,C),p736(C,B).
b626(A,B):-p1195(A,C),b626_1(C,B).
b626_1(A,B):-p1220(A,C),p593(C,B).
b621(A,B):-p1346(A,C),b621_1(C,B).
b621_1(A,B):-p996(A,C),p369(C,B).
b571(A,B):-move_left(A,C),b571_1(C,B).
b571_1(A,B):-p1740(A,C),b571_2(C,B).
b571_2(A,B):-p710(A,C),p492(C,B).
b631(A,B):-p293(A,C),b631_1(C,B).
b631_1(A,B):-p1265(A,C),p1963(C,B).
b632(A,B):-p780(A,B).
b633(A,B):-move_left(A,C),b633_1(C,B).
b633_1(A,B):-p286(A,C),p477(C,B).
b515(A,B):-move_right(A,C),b515_1(C,B).
b515_1(A,B):-p796(A,C),b515_2(C,B).
b515_2(A,B):-p1582(A,C),p1100(C,B).
b589(A,B):-move_left(A,C),b589_1(C,B).
b589_1(A,B):-p1100(A,C),b589_2(C,B).
b589_2(A,B):-p1184(A,C),p780(C,B).
b635(A,B):-p492(A,C),b635_1(C,B).
b635_1(A,B):-p1280(A,C),p325(C,B).
b636(A,B):-move_left(A,C),b636_1(C,B).
b636_1(A,B):-p995(A,C),p1299(C,B).
b637(A,B):-p382(A,C),p437(C,B).
b638(A,B):-p595(A,C),p1116(C,B).
b639(A,B):-move_left(A,C),b639_1(C,B).
b639_1(A,B):-p1266(A,C),p510(C,B).
b641(A,B):-p1560(A,C),p1600(C,B).
b642(A,B):-p492(A,C),b642_1(C,B).
b642_1(A,B):-p584(A,C),p1749(C,B).
b640(A,B):-p736(A,C),b640_1(C,B).
b640_1(A,B):-p120(A,C),p1600(C,B).
b643(A,B):-p1121(A,C),b643_1(C,B).
b643_1(A,B):-p369(A,C),p613(C,B).
b645(A,B):-p510(A,C),p768(C,B).
b646(A,B):-p1656(A,C),p1369(C,B).
b644(A,B):-p484(A,C),b644_1(C,B).
b644_1(A,B):-p852(A,C),p168(C,B).
b647(A,B):-p293(A,C),b647_1(C,B).
b647_1(A,B):-p511(A,C),p1600(C,B).
b649(A,B):-p1055(A,C),p834(C,B).
b648(A,B):-move_right(A,C),b648_1(C,B).
b648_1(A,B):-p285(A,C),p1267(C,B).
b651(A,B):-move_left(A,C),p1530(C,B).
b652(A,B):-move_left(A,C),b652_1(C,B).
b652_1(A,B):-p1808(A,C),p1600(C,B).
b653(A,B):-move_backwards(A,C),b653_1(C,B).
b653_1(A,B):-p1310(A,C),p139(C,B).
b630(A,B):-move_left(A,C),b630_1(C,B).
b630_1(A,B):-p1559(A,C),b630_2(C,B).
b630_2(A,B):-p356(A,C),p510(C,B).
b655(A,B):-move_left(A,C),b655_1(C,B).
b655_1(A,B):-p646(A,C),p838(C,B).
b654(A,B):-p115(A,C),b654_1(C,B).
b654_1(A,B):-p304(A,C),move_right(C,B).
b657(A,B):-p1749(A,C),p1353(C,B).
b656(A,B):-move_right(A,C),b656_1(C,B).
b656_1(A,B):-p1043(A,C),p1100(C,B).
b658(A,B):-move_backwards(A,C),b658_1(C,B).
b658_1(A,B):-p656(A,C),p972(C,B).
b660(A,B):-p1600(A,C),p1152(C,B).
b661(A,B):-p749(A,C),p492(C,B).
b614(A,B):-move_right(A,C),b614_1(C,B).
b614_1(A,B):-p1158(A,C),b614_2(C,B).
b614_2(A,B):-p1254(A,C),p492(C,B).
b610(A,B):-move_right(A,C),b610_1(C,B).
b610_1(A,B):-p1093(A,C),b610_2(C,B).
b610_2(A,B):-p1739(A,C),p1049(C,B).
b664(A,B):-p1049(A,C),b664_1(C,B).
b664_1(A,B):-p1926(A,C),p1833(C,B).
b665(A,B):-move_backwards(A,B).
b666(A,B):-p1869(A,C),p958(C,B).
b667(A,B):-p801(A,C),move_forwards(C,B).
b668(A,B):-p35(A,C),p293(C,B).
b628(A,B):-move_left(A,C),b628_1(C,B).
b628_1(A,B):-p1315(A,C),b628_2(C,B).
b628_2(A,B):-p681(A,C),p510(C,B).
b670(A,B):-p115(A,C),b670_1(C,B).
b670_1(A,B):-p1366(A,C),p780(C,B).
b671(A,B):-move_right(A,C),b671_1(C,B).
b671_1(A,B):-p133(A,C),p1116(C,B).
b672(A,B):-move_left(A,C),p1369(C,B).
b669(A,B):-p975(A,C),b669_1(C,B).
b669_1(A,B):-p1642(A,C),p112(C,B).
b673(A,B):-p293(A,C),b673_1(C,B).
b673_1(A,B):-p1300(A,C),p834(C,B).
b674(A,B):-move_right(A,C),p1093(C,B).
b675(A,B):-p536(A,C),p975(C,B).
b677(A,B):-p293(A,C),b677_1(C,B).
b677_1(A,B):-p1646(A,C),p593(C,B).
b676(A,B):-p780(A,C),b676_1(C,B).
b676_1(A,B):-p1952(A,C),p1388(C,B).
b679(A,B):-p193(A,C),p115(C,B).
b678(A,B):-move_left(A,C),b678_1(C,B).
b678_1(A,B):-p454(A,C),p293(C,B).
b680(A,B):-p986(A,C),p664(C,B).
b681(A,B):-move_left(A,C),b681_1(C,B).
b681_1(A,B):-p1300(A,C),p834(C,B).
b682(A,B):-p593(A,C),b682_1(C,B).
b682_1(A,B):-p1647(A,C),p736(C,B).
b650(A,B):-move_left(A,C),b650_1(C,B).
b650_1(A,B):-p1559(A,C),b650_2(C,B).
b650_2(A,B):-p1267(A,C),p1833(C,B).
b683(A,B):-p1388(A,C),b683_1(C,B).
b683_1(A,B):-p1277(A,C),p17(C,B).
b686(A,B):-move_left(A,C),b686_1(C,B).
b686_1(A,B):-p255(A,C),p1471(C,B).
b684(A,B):-p265(A,C),b684_1(C,B).
b684_1(A,B):-move_right(A,C),p1100(C,B).
b688(A,B):-move_left(A,C),b688_1(C,B).
b688_1(A,B):-p1690(A,C),p1918(C,B).
b659(A,B):-move_left(A,C),b659_1(C,B).
b659_1(A,B):-p562(A,C),b659_2(C,B).
b659_2(A,B):-p975(A,C),p1642(C,B).
b687(A,B):-p834(A,C),b687_1(C,B).
b687_1(A,B):-p851(A,C),p593(C,B).
b662(A,B):-move_left(A,C),b662_1(C,B).
b662_1(A,B):-p335(A,C),b662_2(C,B).
b662_2(A,B):-p515(A,C),p293(C,B).
b690(A,B):-move_left(A,C),b690_1(C,B).
b690_1(A,B):-p1164(A,C),p369(C,B).
b691(A,B):-move_left(A,C),b691_1(C,B).
b691_1(A,B):-p492(A,C),p1674(C,B).
b693(A,B):-p1618(A,C),p293(C,B).
b692(A,B):-move_left(A,C),b692_1(C,B).
b692_1(A,B):-p705(A,C),p649(C,B).
b696(A,B):-move_right(A,C),b696_1(C,B).
b696_1(A,B):-p139(A,C),p1667(C,B).
b697(A,B):-p514(A,C),p140(C,B).
b698(A,B):-p1773(A,B).
b694(A,B):-move_forwards(A,C),b694_1(C,B).
b694_1(A,B):-p148(A,C),p707(C,B).
b699(A,B):-move_right(A,C),b699_1(C,B).
b699_1(A,B):-p513(A,C),p229(C,B).
b700(A,B):-move_left(A,C),b700_1(C,B).
b700_1(A,B):-p1243(A,C),p1979(C,B).
b702(A,B):-move_left(A,C),p77(C,B).
b695(A,B):-p492(A,C),b695_1(C,B).
b695_1(A,B):-p1587(A,C),p510(C,B).
b704(A,B):-move_forwards(A,C),p219(C,B).
b703(A,B):-p560(A,C),p492(C,B).
b706(A,B):-p115(A,C),p837(C,B).
b701(A,B):-move_left(A,C),b701_1(C,B).
b701_1(A,B):-p484(A,C),p918(C,B).
b707(A,B):-move_left(A,C),b707_1(C,B).
b707_1(A,B):-p276(A,C),p982(C,B).
b709(A,B):-p632(A,C),move_left(C,B).
b429(A,B):-p780(A,C),b429_1(C,B).
b429_1(A,B):-p318(A,C),b429_2(C,B).
b429_2(A,B):-p979(A,C),p293(C,B).
b710(A,B):-move_left(A,C),b710_1(C,B).
b710_1(A,B):-p1920(A,C),p1972(C,B).
b689(A,B):-p629(A,C),b689_1(C,B).
b689_1(A,B):-p1333(A,C),p458(C,B).
b712(A,B):-move_backwards(A,C),b712_1(C,B).
b712_1(A,B):-p1299(A,C),p1710(C,B).
b714(A,B):-move_right(A,C),b714_1(C,B).
b714_1(A,B):-p1164(A,C),p1333(C,B).
b713(A,B):-p293(A,C),b713_1(C,B).
b713_1(A,B):-p1049(A,C),p769(C,B).
b716(A,B):-p704(A,B).
b717(A,B):-p1020(A,C),move_right(C,B).
b663(A,B):-move_left(A,C),b663_1(C,B).
b663_1(A,B):-p1100(A,C),b663_2(C,B).
b663_2(A,B):-p1395(A,C),p112(C,B).
b711(A,B):-p664(A,C),b711_1(C,B).
b711_1(A,B):-p1013(A,C),p1388(C,B).
b720(A,B):-move_left(A,C),b720_1(C,B).
b720_1(A,B):-p1740(A,C),p133(C,B).
b719(A,B):-move_forwards(A,C),b719_1(C,B).
b719_1(A,B):-p710(A,C),p947(C,B).
b715(A,B):-p492(A,C),b715_1(C,B).
b715_1(A,B):-p1358(A,C),p369(C,B).
b705(A,B):-p286(A,C),b705_1(C,B).
b705_1(A,B):-p115(A,C),p63(C,B).
b724(A,B):-p1116(A,B).
b723(A,B):-move_right(A,C),b723_1(C,B).
b723_1(A,B):-p510(A,C),p295(C,B).
b708(A,B):-p838(A,C),b708_1(C,B).
b708_1(A,B):-p232(A,C),p271(C,B).
b727(A,B):-move_backwards(A,C),p1310(C,B).
b726(A,B):-move_right(A,C),b726_1(C,B).
b726_1(A,B):-p1265(A,C),p834(C,B).
b629(A,B):-p293(A,C),b629_1(C,B).
b629_1(A,B):-p1167(A,C),b629_2(C,B).
b629_2(A,B):-p1594(A,C),p1559(C,B).
b722(A,B):-move_backwards(A,C),b722_1(C,B).
b722_1(A,B):-p262(A,C),p1195(C,B).
b728(A,B):-move_left(A,C),b728_1(C,B).
b728_1(A,B):-p57(A,C),p271(C,B).
b732(A,B):-p1224(A,C),p1459(C,B).
b733(A,B):-move_left(A,C),p286(C,B).
b734(A,B):-p293(A,C),b734_1(C,B).
b734_1(A,B):-p1211(A,C),p492(C,B).
b735(A,B):-p1168(A,C),p523(C,B).
b736(A,B):-p515(A,C),p1559(C,B).
b731(A,B):-p593(A,C),b731_1(C,B).
b731_1(A,B):-p572(A,C),p255(C,B).
b738(A,B):-move_backwards(A,B).
b721(A,B):-p1195(A,C),b721_1(C,B).
b721_1(A,B):-p1656(A,C),p1833(C,B).
b739(A,B):-move_forwards(A,C),b739_1(C,B).
b739_1(A,B):-p484(A,C),p562(C,B).
b730(A,B):-p664(A,C),b730_1(C,B).
b730_1(A,B):-p1300(A,C),p1740(C,B).
b742(A,B):-move_right(A,C),p487(C,B).
b718(A,B):-p1822(A,C),b718_1(C,B).
b718_1(A,B):-p947(A,C),p571(C,B).
...
b740_1(A,B):-p787(A,C),p1833(C,B).
b744(A,B):-move_left(A,C),b744_1(C,B).
b744_1(A,B):-p586(A,C),move_backwards(C,B).
b729(A,B):-p834(A,C),b729_1(C,B).
b729_1(A,B):-p218(A,C),p838(C,B).
b725(A,B):-p1365(A,C),b725_1(C,B).
b725_1(A,B):-p1431(A,C),p1388(C,B).
...
b747_1(A,B):-p1797(A,C),p947(C,B).
b746(A,B):-move_forwards(A,C),b746_1(C,B).
b746_1(A,B):-p1784(A,C),p510(C,B).
b755(A,B):-p1555(A,C),p618(C,B).
b756(A,B):-p1133(A,C),move_right(C,B).
b748(A,B):-p293(A,C),b748_1(C,B).
b748_1(A,B):-p1277(A,C),p1600(C,B).
b759(A,B):-p1667(A,C),p1245(C,B).
...
b760_1(A,B):-p448(A,C),p1432(C,B).
b743(A,B):-p975(A,C),b743_1(C,B).
b743_1(A,B):-p1727(A,C),p1749(C,B).
b763(A,B):-move_right(A,C),b763_1(C,B).
b763_1(A,B):-p632(A,C),p492(C,B).
b764(A,B):-p369(A,C),b764_1(C,B).
b764_1(A,B):-p1352(A,C),p1667(C,B).
b752(A,B):-p975(A,C),b752_1(C,B).
b752_1(A,B):-p1093(A,C),p1739(C,B).
b767(A,B):-p1463(A,C),move_backwards(C,B).
b768(A,B):-p666(A,C),p736(C,B).
b769(A,B):-p947(A,C),p1915(C,B).
b770(A,B):-p293(A,C),p932(C,B).
b754(A,B):-p922(A,C),b754_1(C,B).
b754_1(A,B):-p1343(A,C),p947(C,B).
b762(A,B):-p664(A,C),b762_1(C,B).
b762_1(A,B):-p1277(A,C),p715(C,B).
b773(A,B):-p514(A,C),p1486(C,B).
b774(A,B):-p1797(A,C),p1333(C,B).
b757(A,B):-p838(A,C),b757_1(C,B).
b757_1(A,B):-p1267(A,C),p1833(C,B).
b775(A,B):-p1710(A,C),p510(C,B).
b777(A,B):-p1146(A,C),p715(C,B).
b776(A,B):-move_left(A,C),b776_1(C,B).
b776_1(A,B):-p1369(A,C),p1564(C,B).
b771(A,B):-p115(A,C),b771_1(C,B).
b771_1(A,B):-p1342(A,C),move_forwards(C,B).
b780(A,B):-p115(A,C),b780_1(C,B).
b780_1(A,B):-p1530(A,C),p736(C,B).
b772(A,B):-p593(A,C),b772_1(C,B).
b772_1(A,B):-p1739(A,C),p726(C,B).
b782(A,B):-move_forwards(A,C),b782_1(C,B).
b782_1(A,B):-p1450(A,C),p484(C,B).
b783(A,B):-p293(A,C),b783_1(C,B).
b783_1(A,B):-p510(A,C),p918(C,B).
b784(A,B):-move_forwards(A,C),p1277(C,B).
b778(A,B):-p975(A,C),b778_1(C,B).
b778_1(A,B):-p618(A,C),p484(C,B).
b786(A,B):-p736(A,C),p1004(C,B).
b787(A,B):-move_right(A,C),b787_1(C,B).
b787_1(A,B):-p1133(A,C),p219(C,B).
b788(A,B):-p523(A,C),p1925(C,B).
b785(A,B):-p593(A,C),b785_1(C,B).
b785_1(A,B):-p6(A,C),p262(C,B).
b779(A,B):-p16(A,C),b779_1(C,B).
b779_1(A,B):-p842(A,C),p1369(C,B).
b791(A,B):-move_right(A,C),p1686(C,B).
b792(A,B):-p492(A,C),b792_1(C,B).
b792_1(A,B):-p368(A,C),p96(C,B).
b789(A,B):-p255(A,C),b789_1(C,B).
b789_1(A,B):-p591(A,C),p1704(C,B).
b794(A,B):-move_left(A,C),b794_1(C,B).
b794_1(A,B):-p1979(A,C),p271(C,B).
%timeout
b685(A,B):-move_right(A,C),b685_1(C,B).
b685_1(A,B):-p780(A,C),b685_2(C,B).
b685_2(A,B):-p978(A,C),p484(C,B).
b790(A,B):-p922(A,C),b790_1(C,B).
b790_1(A,B):-p516(A,C),p1802(C,B).
b797(A,B):-p1322(A,C),p838(C,B).
b799(A,B):-p293(A,B).
b793(A,B):-p1116(A,C),b793_1(C,B).
b793_1(A,B):-p443(A,C),move_left(C,B).
b798(A,B):-p1195(A,C),b798_1(C,B).
b798_1(A,B):-p63(A,C),p593(C,B).
b800(A,B):-p293(A,C),b800_1(C,B).
b800_1(A,B):-p1966(A,C),p1116(C,B).
b801(A,B):-p947(A,C),p392(C,B).
b795(A,B):-p684(A,C),b795_1(C,B).
b795_1(A,B):-p711(A,C),p1600(C,B).
b737(A,B):-move_left(A,C),b737_1(C,B).
b737_1(A,B):-p255(A,C),b737_2(C,B).
b737_2(A,B):-p1237(A,C),p1784(C,B).
b806(A,B):-p293(A,C),p877(C,B).
b807(A,B):-p1077(A,C),p834(C,B).
b802(A,B):-p593(A,C),b802_1(C,B).
b802_1(A,B):-p1211(A,C),move_left(C,B).
b809(A,B):-p695(A,B).
b810(A,B):-move_left(A,C),b810_1(C,B).
b810_1(A,B):-p1559(A,C),p526(C,B).
b811(A,B):-move_forwards(A,C),b811_1(C,B).
b811_1(A,B):-p978(A,C),p593(C,B).
b812(A,B):-move_forwards(A,C),b812_1(C,B).
b812_1(A,B):-p1755(A,C),p1555(C,B).
b813(A,B):-move_right(A,C),b813_1(C,B).
b813_1(A,B):-p1900(A,C),move_left(C,B).
b796(A,B):-p194(A,C),b796_1(C,B).
b796_1(A,B):-p1318(A,C),p1333(C,B).
b815(A,B):-p1869(A,C),p1921(C,B).
b805(A,B):-p838(A,C),b805_1(C,B).
b805_1(A,B):-p348(A,C),p1873(C,B).
...
b817_1(A,B):-p1963(A,C),p1388(C,B).
b819(A,B):-move_left(A,C),b819_1(C,B).
b819_1(A,B):-p245(A,C),p947(C,B).
b820(A,B):-move_left(A,C),b820_1(C,B).
b820_1(A,B):-p794(A,C),move_backwards(C,B).
b822(A,B):-p947(A,C),p94(C,B).
b821(A,B):-move_forwards(A,C),b821_1(C,B).
b821_1(A,B):-p1524(A,C),p513(C,B).
b814(A,B):-p1116(A,C),b814_1(C,B).
b814_1(A,B):-p687(A,C),move_backwards(C,B).
...
b808(A,B):-p599(A,C),b808_1(C,B).
b808_1(A,B):-p1096(A,C),p255(C,B).
b828(A,B):-move_forwards(A,C),b828_1(C,B).
b828_1(A,B):-p955(A,C),p618(C,B).
b765(A,B):-move_left(A,C),b765_1(C,B).
b765_1(A,B):-p492(A,C),b765_2(C,B).
b765_2(A,B):-p505(A,C),p1116(C,B).
b827(A,B):-p510(A,C),b827_1(C,B).
b827_1(A,B):-p228(A,C),p712(C,B).
b831(A,B):-move_forwards(A,C),p1904(C,B).
b832(A,B):-move_left(A,C),p1358(C,B).
b833(A,B):-p720(A,C),p293(C,B).
b830(A,B):-move_backwards(A,C),b830_1(C,B).
b830_1(A,B):-p266(A,C),p1388(C,B).
b824(A,B):-p484(A,C),b824_1(C,B).
b824_1(A,B):-p1910(A,C),p1369(C,B).
b826(A,B):-p664(A,C),b826_1(C,B).
b826_1(A,B):-p318(A,C),p979(C,B).
b835(A,B):-move_right(A,C),b835_1(C,B).
b835_1(A,B):-p1792(A,C),p947(C,B).
b836(A,B):-move_left(A,C),b836_1(C,B).
b836_1(A,B):-p492(A,C),p1803(C,B).
b839(A,B):-p704(A,C),p1749(C,B).
b838(A,B):-move_right(A,C),b838_1(C,B).
b838_1(A,B):-p677(A,C),p852(C,B).
b829(A,B):-p1753(A,C),b829_1(C,B).
b829_1(A,B):-p1369(A,C),p494(C,B).
b842(A,B):-p235(A,C),p515(C,B).
b840(A,B):-p115(A,C),b840_1(C,B).
b840_1(A,B):-p444(A,C),p1373(C,B).
b843(A,B):-move_left(A,C),b843_1(C,B).
b843_1(A,B):-p794(A,C),p947(C,B).
b844(A,B):-move_forwards(A,C),b844_1(C,B).
b844_1(A,B):-p276(A,C),p1833(C,B).
b846(A,B):-move_right(A,C),p834(C,B).
...
b851(A,B):-p166(A,C),p664(C,B).
b852(A,B):-p1237(A,C),p293(C,B).
b850(A,B):-move_backwards(A,C),b850_1(C,B).
b850_1(A,B):-p173(A,C),p1667(C,B).
b837(A,B):-p765(A,C),b837_1(C,B).
b837_1(A,B):-p852(A,C),p950(C,B).
...
b857_1(A,B):-p754(A,C),p492(C,B).
b858(A,B):-move_left(A,C),b858_1(C,B).
b858_1(A,B):-p373(A,C),p115(C,B).
b859(A,B):-p1600(A,C),p77(C,B).
b849(A,B):-p1414(A,C),b849_1(C,B).
b849_1(A,B):-p424(A,C),p492(C,B).
b861(A,B):-move_forwards(A,C),p1704(C,B).
b803(A,B):-move_left(A,C),b803_1(C,B).
b803_1(A,B):-p1100(A,C),b803_2(C,B).
b803_2(A,B):-p1450(A,C),move_right(C,B).
b860(A,B):-p975(A,C),b860_1(C,B).
b860_1(A,B):-p52(A,C),p115(C,B).
b864(A,B):-p115(A,C),p1773(C,B).
b855(A,B):-p1869(A,C),b855_1(C,B).
b855_1(A,B):-p1789(A,C),p1830(C,B).
b866(A,B):-p293(A,C),p510(C,B).
b867(A,B):-move_right(A,C),p780(C,B).
b854(A,B):-p276(A,C),b854_1(C,B).
b854_1(A,B):-move_forwards(A,C),p271(C,B).
b865(A,B):-p593(A,C),b865_1(C,B).
b865_1(A,B):-p168(A,C),move_forwards(C,B).
b870(A,B):-p762(A,C),move_left(C,B).
b869(A,B):-p492(A,C),b869_1(C,B).
b869_1(A,B):-p1763(A,C),p1450(C,B).
b872(A,B):-p1340(A,C),p946(C,B).
b871(A,B):-p593(A,C),b871_1(C,B).
b871_1(A,B):-p443(A,C),p772(C,B).
b874(A,B):-move_left(A,C),p255(C,B).
b875(A,B):-p1406(A,C),p77(C,B).
b876(A,B):-p484(A,C),b876_1(C,B).
b876_1(A,B):-p961(A,C),p780(C,B).
b877(A,B):-move_right(A,C),p950(C,B).
b873(A,B):-p655(A,C),b873_1(C,B).
b873_1(A,B):-p1873(A,C),p293(C,B).
b879(A,B):-p780(A,C),p1804(C,B).
b878(A,B):-move_left(A,C),b878_1(C,B).
b878_1(A,B):-p1573(A,C),p975(C,B).
b880(A,B):-move_left(A,C),b880_1(C,B).
b880_1(A,B):-p1283(A,C),move_right(C,B).
b781(A,B):-move_right(A,C),b781_1(C,B).
b781_1(A,B):-p834(A,C),b781_2(C,B).
b781_2(A,B):-p31(A,C),p1116(C,B).
b883(A,B):-move_left(A,C),b883_1(C,B).
b883_1(A,B):-p1667(A,C),p863(C,B).
b834(A,B):-move_right(A,C),b834_1(C,B).
b834_1(A,B):-p1167(A,C),b834_2(C,B).
b834_2(A,B):-move_backwards(A,C),p280(C,B).
b884(A,B):-p293(A,C),b884_1(C,B).
b884_1(A,B):-p1093(A,C),p1818(C,B).
b881(A,B):-p975(A,C),b881_1(C,B).
b881_1(A,B):-p298(A,C),p7(C,B).
b886(A,B):-move_left(A,C),b886_1(C,B).
b886_1(A,B):-p735(A,C),p293(C,B).
b887(A,B):-move_right(A,C),b887_1(C,B).
b887_1(A,B):-p721(A,C),p838(C,B).
b889(A,B):-p1555(A,B).
b890(A,B):-p975(A,C),p1782(C,B).
b891(A,B):-p224(A,C),p975(C,B).
b892(A,B):-p1333(A,B).
b885(A,B):-p1869(A,C),b885_1(C,B).
b885_1(A,B):-p1013(A,C),p1195(C,B).
b882(A,B):-p1600(A,C),b882_1(C,B).
b882_1(A,B):-p1376(A,C),p887(C,B).
b888(A,B):-p293(A,C),b888_1(C,B).
b888_1(A,B):-p729(A,C),p736(C,B).
b894(A,B):-move_left(A,C),b894_1(C,B).
b894_1(A,B):-p963(A,C),p736(C,B).
b896(A,B):-move_right(A,C),b896_1(C,B).
b896_1(A,B):-p121(A,C),p1804(C,B).
b895(A,B):-p293(A,C),b895_1(C,B).
b895_1(A,B):-p705(A,C),p1600(C,B).
b899(A,B):-move_forwards(A,C),b899_1(C,B).
b899_1(A,B):-p300(A,C),p736(C,B).
b897(A,B):-p834(A,C),b897_1(C,B).
b897_1(A,B):-p1829(A,C),p975(C,B).
b901(A,B):-move_left(A,C),p24(C,B).
b893(A,B):-p1740(A,C),b893_1(C,B).
b893_1(A,B):-p1003(A,C),p664(C,B).
b903(A,B):-move_backwards(A,C),p888(C,B).
b902(A,B):-move_forwards(A,C),b902_1(C,B).
b902_1(A,B):-p1133(A,C),p947(C,B).
b900(A,B):-p664(A,C),b900_1(C,B).
b900_1(A,B):-p1032(A,C),p492(C,B).
b905(A,B):-move_left(A,C),b905_1(C,B).
b905_1(A,B):-p1816(A,C),p115(C,B).
b634(A,B):-p593(A,C),b634_1(C,B).
b634_1(A,B):-p212(A,C),b634_2(C,B).
b634_2(A,B):-p369(A,C),p477(C,B).
b906(A,B):-p369(A,C),b906_1(C,B).
b906_1(A,B):-p79(A,C),p1093(C,B).
b862(A,B):-move_left(A,C),b862_1(C,B).
b862_1(A,B):-p112(A,C),b862_2(C,B).
b862_2(A,B):-p726(A,C),p593(C,B).
b909(A,B):-p115(A,C),b909_1(C,B).
b909_1(A,B):-p514(A,C),p708(C,B).
b908(A,B):-move_backwards(A,C),b908_1(C,B).
b908_1(A,B):-p914(A,C),p593(C,B).
b911(A,B):-move_left(A,C),b911_1(C,B).
b911_1(A,B):-p780(A,C),p1727(C,B).
b913(A,B):-p492(A,C),drop_ball(C,B).
b914(A,B):-move_right(A,C),p1801(C,B).
b907(A,B):-p736(A,C),b907_1(C,B).
b907_1(A,B):-p1071(A,C),p492(C,B).
b910(A,B):-p593(A,C),b910_1(C,B).
b910_1(A,B):-p1385(A,C),p622(C,B).
b916(A,B):-p1821(A,C),p822(C,B).
b917(A,B):-p664(A,C),p1570(C,B).
b918(A,B):-p290(A,C),p1684(C,B).
b920(A,B):-p1559(A,C),p413(C,B).
b921(A,B):-p293(A,C),p1352(C,B).
b912(A,B):-p115(A,C),b912_1(C,B).
b912_1(A,B):-p667(A,C),p662(C,B).
b919(A,B):-move_backwards(A,C),b919_1(C,B).
b919_1(A,B):-p627(A,C),p1100(C,B).
b924(A,B):-move_left(A,C),b924_1(C,B).
b924_1(A,B):-p662(A,C),p834(C,B).
b915(A,B):-move_backwards(A,C),b915_1(C,B).
b915_1(A,B):-p1545(A,C),move_right(C,B).
b926(A,B):-p682(A,B).
...
b928_1(A,B):-p297(A,C),p588(C,B).
b927(A,B):-move_right(A,C),b927_1(C,B).
b927_1(A,B):-p632(A,C),move_backwards(C,B).
b923(A,B):-p369(A,C),b923_1(C,B).
b923_1(A,B):-p1755(A,C),p1116(C,B).
b932(A,B):-p834(A,C),p218(C,B).
b929(A,B):-p293(A,C),b929_1(C,B).
b929_1(A,B):-p1524(A,C),p910(C,B).
b933(A,B):-move_left(A,C),b933_1(C,B).
b933_1(A,B):-p1100(A,C),p1342(C,B).
b931(A,B):-p369(A,C),b931_1(C,B).
b931_1(A,B):-p348(A,C),p513(C,B).
b936(A,B):-move_left(A,C),p242(C,B).
b937(A,B):-p997(A,C),p1869(C,B).
b930(A,B):-p593(A,C),b930_1(C,B).
b930_1(A,B):-p922(A,C),p1522(C,B).
b934(A,B):-move_right(A,C),b934_1(C,B).
b934_1(A,B):-p918(A,C),p1333(C,B).
b938(A,B):-move_left(A,C),b938_1(C,B).
b938_1(A,B):-p1667(A,C),p1948(C,B).
b935(A,B):-p664(A,C),b935_1(C,B).
b935_1(A,B):-p232(A,C),p271(C,B).
b940(A,B):-p780(A,C),b940_1(C,B).
b940_1(A,B):-p140(A,C),p1778(C,B).
b943(A,B):-p947(A,C),p290(C,B).
b941(A,B):-p293(A,C),b941_1(C,B).
b941_1(A,B):-p219(A,C),p484(C,B).
b945(A,B):-p593(A,B).
b946(A,B):-p780(A,C),p1205(C,B).
b944(A,B):-move_right(A,C),b944_1(C,B).
b944_1(A,B):-p295(A,C),p1100(C,B).
b939(A,B):-p1020(A,C),b939_1(C,B).
b939_1(A,B):-p136(A,C),p516(C,B).
b804(A,B):-move_right(A,C),b804_1(C,B).
b804_1(A,B):-grab_ball(A,C),b804_2(C,B).
b804_2(A,B):-p603(A,C),p838(C,B).
b942(A,B):-p1559(A,C),b942_1(C,B).
b942_1(A,B):-p1158(A,C),p834(C,B).
b949(A,B):-p1195(A,C),b949_1(C,B).
b949_1(A,B):-p434(A,C),p1388(C,B).
b950(A,B):-p780(A,C),b950_1(C,B).
b950_1(A,B):-p498(A,C),p1628(C,B).
b951(A,B):-move_left(A,C),b951_1(C,B).
b951_1(A,B):-p1127(A,C),p1747(C,B).
b954(A,B):-p458(A,C),p736(C,B).
b947(A,B):-p1369(A,C),b947_1(C,B).
b947_1(A,B):-p1607(A,C),p1948(C,B).
b955(A,B):-p1183(A,C),p877(C,B).
b957(A,B):-p1195(A,C),p1907(C,B).
b948(A,B):-p947(A,C),b948_1(C,B).
b948_1(A,B):-p298(A,C),p7(C,B).
b953(A,B):-p369(A,C),b953_1(C,B).
b953_1(A,B):-p212(A,C),p1237(C,B).
b958(A,B):-move_left(A,C),b958_1(C,B).
b958_1(A,B):-p1844(A,C),p1718(C,B).
b961(A,B):-p1803(A,C),drop_ball(C,B).
b959(A,B):-move_right(A,C),b959_1(C,B).
b959_1(A,B):-p780(A,C),p1139(C,B).
b963(A,B):-p1026(A,C),p613(C,B).
b964(A,B):-p1220(A,C),p947(C,B).
b952(A,B):-p975(A,C),b952_1(C,B).
b952_1(A,B):-p561(A,C),p1195(C,B).
b966(A,B):-p562(A,C),p1925(C,B).
b967(A,B):-move_right(A,C),b967_1(C,B).
b967_1(A,B):-p721(A,C),p1388(C,B).
b962(A,B):-p664(A,C),b962_1(C,B).
b962_1(A,B):-p301(A,C),p1195(C,B).
b968(A,B):-move_left(A,C),b968_1(C,B).
b968_1(A,B):-p192(A,C),move_right(C,B).
b970(A,B):-p1116(A,B).
b960(A,B):-p593(A,C),b960_1(C,B).
b960_1(A,B):-p414(A,C),p664(C,B).
b971(A,B):-move_right(A,C),b971_1(C,B).
b971_1(A,B):-p684(A,C),move_right(C,B).
b969(A,B):-move_right(A,C),b969_1(C,B).
b969_1(A,B):-p1277(A,C),p1692(C,B).
b956(A,B):-p947(A,C),b956_1(C,B).
b956_1(A,B):-p1862(A,C),p1388(C,B).
b975(A,B):-p1369(A,C),p1294(C,B).
b973(A,B):-move_backwards(A,C),b973_1(C,B).
b973_1(A,B):-p985(A,C),p587(C,B).
b977(A,B):-p115(A,C),p1821(C,B).
b978(A,B):-p975(A,C),p1486(C,B).
b979(A,B):-p1925(A,C),p369(C,B).
b972(A,B):-p664(A,C),b972_1(C,B).
b972_1(A,B):-p1524(A,C),p947(C,B).
b976(A,B):-p780(A,C),b976_1(C,B).
b976_1(A,B):-p946(A,C),move_right(C,B).
b981(A,B):-move_forwards(A,C),b981_1(C,B).
b981_1(A,B):-p978(A,C),p115(C,B).
b983(A,B):-move_right(A,C),p708(C,B).
b965(A,B):-p838(A,C),b965_1(C,B).
b965_1(A,B):-p1060(A,C),p152(C,B).
b984(A,B):-p242(A,C),p350(C,B).
b986(A,B):-p293(A,C),p539(C,B).
b982(A,B):-p369(A,C),b982_1(C,B).
b982_1(A,B):-p1(A,C),p1600(C,B).
b987(A,B):-p115(A,C),b987_1(C,B).
b987_1(A,B):-p443(A,C),p380(C,B).
b974(A,B):-p1218(A,C),b974_1(C,B).
b974_1(A,B):-p510(A,C),p325(C,B).
b898(A,B):-move_right(A,C),b898_1(C,B).
b898_1(A,B):-p710(A,C),b898_2(C,B).
b898_2(A,B):-p979(A,C),move_right(C,B).
b991(A,B):-move_left(A,C),b991_1(C,B).
b991_1(A,B):-p1833(A,C),p711(C,B).
b989(A,B):-p975(A,C),b989_1(C,B).
b989_1(A,B):-p1918(A,C),p115(C,B).
b904(A,B):-move_left(A,C),b904_1(C,B).
b904_1(A,B):-p1356(A,C),b904_2(C,B).
b904_2(A,B):-p1532(A,C),p1749(C,B).
b985(A,B):-p1557(A,C),b985_1(C,B).
b985_1(A,B):-p1370(A,C),move_right(C,B).
b993(A,B):-move_left(A,C),b993_1(C,B).
b993_1(A,B):-p787(A,C),p1100(C,B).
b994(A,B):-move_right(A,C),b994_1(C,B).
b994_1(A,B):-p1657(A,C),p780(C,B).
b997(A,B):-p255(A,C),p1139(C,B).
b996(A,B):-move_left(A,C),b996_1(C,B).
b996_1(A,B):-p1530(A,C),move_forwards(C,B).
b990(A,B):-p593(A,C),b990_1(C,B).
b990_1(A,B):-p625(A,C),p947(C,B).
b988(A,B):-p702(A,C),b988_1(C,B).
b988_1(A,B):-p1692(A,C),p1369(C,B).
b998(A,B):-move_backwards(A,C),b998_1(C,B).
b998_1(A,B):-p1873(A,C),p94(C,B).
b999(A,B):-p593(A,C),b999_1(C,B).
b999_1(A,B):-p17(A,C),p115(C,B).
b992(A,B):-p613(A,C),b992_1(C,B).
b992_1(A,B):-p684(A,C),p780(C,B).
b995(A,B):-p947(A,C),b995_1(C,B).
b995_1(A,B):-p1647(A,C),p1869(C,B).
b980(A,B):-move_left(A,C),b980_1(C,B).
b980_1(A,B):-p1557(A,C),b980_2(C,B).
b980_2(A,B):-p148(A,C),p780(C,B).
b766(A,B):-p593(A,C),b766_1(C,B).
b766_1(A,B):-p348(A,C),b766_2(C,B).
b766_2(A,B):-p595(A,C),p87(C,B).
b863(A,B):-p593(A,C),b863_1(C,B).
b863_1(A,B):-p1356(A,C),b863_2(C,B).
b863_2(A,B):-p1532(A,C),p1749(C,B).
b868(A,B):-p593(A,C),b868_1(C,B).
b868_1(A,B):-p368(A,C),b868_2(C,B).
b868_2(A,B):-p1972(A,C),p1369(C,B).
% num solved 995
true.

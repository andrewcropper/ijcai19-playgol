...
% asserting p1998_1/2
% asserting p1998/2
b7(A,B):-p135_1(A,C),p5_1(C,B).
b2(A,B):-p83(A,C),p126_2(C,B).
b9(A,B):-p1368(A,C),p569(C,B).
b11(A,B):-p114(A,C),p652_1(C,B).
b10(A,B):-p800_1(A,C),p1819(C,B).
b0(A,B):-p1399(A,C),p1839_1(C,B).
b15(A,B):-p194_1(A,B).
b16(A,B):-p1129(A,C),p1533(C,B).
b4(A,B):-p755(A,C),p615(C,B).
b14(A,B):-move_left(A,C),b14_1(C,B).
b14_1(A,B):-p1072(A,C),p627(C,B).
b3(A,B):-move_right(A,C),b3_1(C,B).
b3_1(A,B):-p1277(A,C),move_left(C,B).
b20(A,B):-p1567(A,B).
b19(A,B):-p366(A,C),p1440(C,B).
b22(A,B):-move_right(A,C),p1774_1(C,B).
b1(A,B):-move_backwards(A,C),b1_1(C,B).
b1_1(A,B):-p1166(A,C),p869(C,B).
b18(A,B):-move_left(A,C),b18_1(C,B).
b18_1(A,B):-p543(A,C),p366(C,B).
b13(A,B):-move_forwards(A,C),b13_1(C,B).
b13_1(A,B):-p1293(A,C),p1931(C,B).
b26(A,B):-move_left(A,C),p1767_1(C,B).
b5(A,B):-move_forwards(A,C),b5_1(C,B).
b5_1(A,B):-p277_1(A,C),p980_1(C,B).
b6(A,B):-p880(A,C),b6_1(C,B).
b6_1(A,B):-p1229(A,C),p395(C,B).
b21(A,B):-move_right(A,C),b21_1(C,B).
b21_1(A,B):-p668(A,C),p1133_1(C,B).
b29(A,B):-p257(A,C),p332_2(C,B).
b17(A,B):-p880(A,C),b17_1(C,B).
b17_1(A,B):-p1533(A,C),p1028(C,B).
b24(A,B):-move_backwards(A,C),b24_1(C,B).
b24_1(A,B):-p887(A,C),p1144(C,B).
b30(A,B):-p1683(A,C),p1624(C,B).
b31(A,B):-p1409(A,C),p800_1(C,B).
b27(A,B):-move_forwards(A,C),b27_1(C,B).
b27_1(A,B):-p1269(A,C),p634(C,B).
b25(A,B):-move_backwards(A,C),b25_1(C,B).
b25_1(A,B):-p765(A,C),p334_2(C,B).
b34(A,B):-move_left(A,C),b34_1(C,B).
b34_1(A,B):-p1211(A,C),p621(C,B).
b35(A,B):-move_left(A,C),b35_1(C,B).
b35_1(A,B):-p1629(A,C),p395(C,B).
b36(A,B):-p1443(A,C),p555(C,B).
b40(A,B):-move_left(A,C),p1129(C,B).
b37(A,B):-p1348(A,C),p614(C,B).
b38(A,B):-p54(A,C),p1246_2(C,B).
b42(A,B):-p52_1(A,C),p1096(C,B).
b41(A,B):-p389_1(A,C),p621(C,B).
b44(A,B):-p320(A,C),move_forwards(C,B).
b46(A,B):-p249(A,C),p1728_1(C,B).
b45(A,B):-p138(A,C),p1483_1(C,B).
b48(A,B):-p577(A,C),p166_2(C,B).
b32(A,B):-move_forwards(A,C),b32_1(C,B).
b32_1(A,B):-p1277_1(A,C),p332_2(C,B).
b8(A,B):-p1348(A,C),b8_1(C,B).
b8_1(A,B):-p155(A,C),p958_2(C,B).
b50(A,B):-p1274(A,C),p38_1(C,B).
b52(A,B):-grab_ball(A,C),p1671(C,B).
b53(A,B):-p231_1(A,C),p1736_1(C,B).
b39(A,B):-move_left(A,C),b39_1(C,B).
b39_1(A,B):-p184(A,C),p1659(C,B).
b49(A,B):-move_right(A,C),b49_1(C,B).
b49_1(A,B):-p1559(A,C),p1337_1(C,B).
...
b43_1(A,B):-p211(A,C),p669_2(C,B).
b55(A,B):-move_left(A,C),b55_1(C,B).
b55_1(A,B):-p541(A,C),p1659(C,B).
b33(A,B):-p880(A,C),b33_1(C,B).
b33_1(A,B):-p508(A,C),p1077_2(C,B).
b12(A,B):-p800_1(A,C),b12_1(C,B).
b12_1(A,B):-p1273_1(A,C),p140_1(C,B).
b47(A,B):-move_right(A,C),b47_1(C,B).
b47_1(A,B):-p765_1(A,C),p937_1(C,B).
b65(A,B):-move_left(A,C),p557(C,B).
b64(A,B):-p100_1(A,C),p206(C,B).
...
b62_1(A,B):-p35_1(A,C),p960_1(C,B).
b70(A,B):-p1990(A,C),p499_2(C,B).
b60(A,B):-move_right(A,C),b60_1(C,B).
b60_1(A,B):-p928(A,C),p1776_1(C,B).
b73(A,B):-p640(A,C),p731_1(C,B).
b63(A,B):-move_left(A,C),b63_1(C,B).
b63_1(A,B):-p1878(A,C),p395(C,B).
b74(A,B):-p135_1(A,C),p1308(C,B).
b72(A,B):-p1521(A,C),p807_2(C,B).
b77(A,B):-p1584_1(A,B).
b69(A,B):-move_right(A,C),b69_1(C,B).
b69_1(A,B):-p764(A,C),p1211(C,B).
b58(A,B):-p1129(A,C),b58_1(C,B).
b58_1(A,B):-p49(A,C),p1246_1(C,B).
b79(A,B):-p366(A,C),p597(C,B).
b80(A,B):-p1015(A,C),p898(C,B).
b66(A,B):-move_forwards(A,C),b66_1(C,B).
b66_1(A,B):-p49_1(A,C),p349_1(C,B).
b83(A,B):-p230_1(A,C),p1450_1(C,B).
b71(A,B):-p249(A,C),b71_1(C,B).
b71_1(A,B):-p155_1(A,C),p120_2(C,B).
b82(A,B):-move_backwards(A,C),b82_1(C,B).
b82_1(A,B):-p1113(A,C),p1774_1(C,B).
b51(A,B):-p395(A,C),b51_1(C,B).
b51_1(A,B):-p604_1(A,C),p540(C,B).
b75(A,B):-move_right(A,C),b75_1(C,B).
b75_1(A,B):-p1273(A,C),p1268_1(C,B).
b86(A,B):-p58(A,C),p880(C,B).
b88(A,B):-p231_1(A,C),p1767_1(C,B).
b67(A,B):-p880(A,C),b67_1(C,B).
b67_1(A,B):-p387(A,C),move_left(C,B).
b91(A,B):-move_left(A,C),p545(C,B).
b90(A,B):-p1341(A,C),p1701(C,B).
b92(A,B):-p508(A,C),p206_2(C,B).
b89(A,B):-move_left(A,C),b89_1(C,B).
b89_1(A,B):-p54_1(A,C),p504_2(C,B).
b76(A,B):-move_left(A,C),b76_1(C,B).
b76_1(A,B):-p1464(A,C),p667_1(C,B).
b93(A,B):-p274(A,C),p1559(C,B).
b97(A,B):-p1274(A,C),p1377_1(C,B).
b98(A,B):-move_backwards(A,C),p595(C,B).
b96(A,B):-p216_1(A,C),p1624(C,B).
b99(A,B):-p1761(A,C),p1931(C,B).
b95(A,B):-move_right(A,C),b95_1(C,B).
b95_1(A,B):-p957(A,C),p395(C,B).
b100(A,B):-p1420(A,C),p114(C,B).
b102(A,B):-p741(A,C),p187_1(C,B).
b94(A,B):-move_left(A,C),b94_1(C,B).
b94_1(A,B):-p1705(A,C),p114(C,B).
b104(A,B):-p1170(A,C),p667(C,B).
b105(A,B):-p1734(A,C),p114(C,B).
b78(A,B):-p431(A,C),b78_1(C,B).
b78_1(A,B):-p700(A,C),p111(C,B).
b107(A,B):-p1443(A,C),p321(C,B).
b85(A,B):-p249(A,C),b85_1(C,B).
b85_1(A,B):-p107(A,C),p190_2(C,B).
b110(A,B):-p887(A,C),p1996(C,B).
b111(A,B):-p503(A,C),p1129(C,B).
b61(A,B):-p431(A,C),b61_1(C,B).
b61_1(A,B):-p518_1(A,C),p800_1(C,B).
b113(A,B):-p840_1(A,B).
b108(A,B):-move_right(A,C),b108_1(C,B).
b108_1(A,B):-p251(A,C),p1559(C,B).
b101(A,B):-move_backwards(A,C),b101_1(C,B).
b101_1(A,B):-p1277(A,C),p1333_1(C,B).
b114(A,B):-p35(A,C),p880(C,B).
b116(A,B):-p286(A,C),p210(C,B).
b117(A,B):-p200(A,C),p832(C,B).
b119(A,B):-p1437(A,B).
b115(A,B):-move_left(A,C),b115_1(C,B).
b115_1(A,B):-p40_1(A,C),p1697(C,B).
b118(A,B):-move_backwards(A,C),b118_1(C,B).
b118_1(A,B):-p710(A,C),p1823_1(C,B).
b121(A,B):-move_left(A,C),b121_1(C,B).
b121_1(A,B):-p1129(A,C),p12(C,B).
b106(A,B):-p257(A,C),b106_1(C,B).
b106_1(A,B):-p1399(A,C),p297_1(C,B).
b109(A,B):-p880(A,C),b109_1(C,B).
b109_1(A,B):-p1796(A,C),p1368(C,B).
b125(A,B):-p1144(A,B).
b126(A,B):-p82(A,C),move_left(C,B).
b124(A,B):-move_left(A,C),b124_1(C,B).
b124_1(A,B):-p862(A,C),p621(C,B).
b128(A,B):-p627(A,B).
b87(A,B):-p1559(A,C),b87_1(C,B).
b87_1(A,B):-p1141(A,C),p140(C,B).
b127(A,B):-p593(A,C),p1075_2(C,B).
b123(A,B):-move_left(A,C),b123_1(C,B).
b123_1(A,B):-p12_1(A,C),p366(C,B).
b132(A,B):-move_forwards(A,C),p142_1(C,B).
b130(A,B):-p1274(A,C),grab_ball(C,B).
b129(A,B):-p1343(A,C),p1262(C,B).
b134(A,B):-p627(A,C),p1363_1(C,B).
b136(A,B):-grab_ball(A,C),p663_2(C,B).
b135(A,B):-p272(A,C),p426_1(C,B).
...
b122(A,B):-p249(A,C),b122_1(C,B).
b122_1(A,B):-p107_1(A,C),p582(C,B).
b143(A,B):-p1154(A,C),p1559(C,B).
b144(A,B):-p1277(A,C),p1397_2(C,B).
b103(A,B):-p135_1(A,C),b103_1(C,B).
b103_1(A,B):-p508_1(A,C),p544_2(C,B).
b146(A,B):-p640(A,C),p1858_1(C,B).
b148(A,B):-p135_1(A,B).
b140(A,B):-move_left(A,C),b140_1(C,B).
b140_1(A,B):-p508_1(A,C),p10_2(C,B).
b138(A,B):-p249(A,C),b138_1(C,B).
b138_1(A,B):-p1299(A,C),p1359_1(C,B).
b147(A,B):-p535(A,C),p1309(C,B).
b150(A,B):-p640(A,C),p39_1(C,B).
b153(A,B):-move_right(A,C),p1124(C,B).
b137(A,B):-move_right(A,C),b137_1(C,B).
b137_1(A,B):-p1277(A,C),p558_2(C,B).
b151(A,B):-p114(A,C),p49_1(C,B).
b152(A,B):-p138(A,C),p1823_1(C,B).
b157(A,B):-p135_1(A,C),p1218(C,B).
b145(A,B):-move_left(A,C),b145_1(C,B).
b145_1(A,B):-p525(A,C),p102(C,B).
b81(A,B):-p107(A,C),b81_1(C,B).
b81_1(A,B):-p781(A,C),p651_2(C,B).
b159(A,B):-p765(A,C),p1368(C,B).
b161(A,B):-p114(A,C),p446(C,B).
b154(A,B):-move_left(A,C),b154_1(C,B).
b154_1(A,B):-p556_1(A,C),p231_1(C,B).
b163(A,B):-p1538(A,B).
b164(A,B):-p593(A,C),p332_2(C,B).
b149(A,B):-move_left(A,C),b149_1(C,B).
b149_1(A,B):-p350(A,C),p1144(C,B).
b133(A,B):-p880(A,C),b133_1(C,B).
b133_1(A,B):-p1837(A,C),p230(C,B).
b160(A,B):-move_right(A,C),b160_1(C,B).
b160_1(A,B):-p329(A,C),p1155(C,B).
b168(A,B):-p426_1(A,C),p485(C,B).
b169(A,B):-move_forwards(A,C),p1767_1(C,B).
b155(A,B):-move_forwards(A,C),b155_1(C,B).
b155_1(A,B):-p387(A,C),p1368(C,B).
b171(A,B):-p1144(A,C),p457_1(C,B).
b172(A,B):-p520(A,C),p173_1(C,B).
...
b156_1(A,B):-p1842_1(A,C),p249(C,B).
b175(A,B):-p880(A,C),p481(C,B).
b176(A,B):-p711(A,C),p446(C,B).
b120(A,B):-p1144(A,C),b120_1(C,B).
b120_1(A,B):-p179(A,C),p623(C,B).
...
b84(A,B):-p906(A,C),b84_1(C,B).
b84_1(A,B):-p581_1(A,C),p345_1(C,B).
b182(A,B):-p249(A,C),p571_1(C,B).
b184(A,B):-p1129(A,C),p495(C,B).
b174(A,B):-move_left(A,C),b174_1(C,B).
b174_1(A,B):-p253(A,C),p1262_1(C,B).
b185(A,B):-p334(A,C),p557_1(C,B).
b180(A,B):-move_left(A,C),b180_1(C,B).
b180_1(A,B):-p45(A,C),p1163(C,B).
b158(A,B):-p621(A,C),b158_1(C,B).
b158_1(A,B):-grab_ball(A,C),p1239_2(C,B).
b178(A,B):-move_forwards(A,C),b178_1(C,B).
b178_1(A,B):-p496_1(A,C),p1173_1(C,B).
b186(A,B):-move_forwards(A,C),b186_1(C,B).
b186_1(A,B):-p1483(A,C),p1147_1(C,B).
b167(A,B):-move_backwards(A,C),b167_1(C,B).
b167_1(A,B):-p508_1(A,C),p90_2(C,B).
b192(A,B):-grab_ball(A,C),p795_1(C,B).
...
b181_1(A,B):-p1277(A,C),p527_2(C,B).
b188(A,B):-move_right(A,C),b188_1(C,B).
b188_1(A,B):-p622(A,C),p569(C,B).
...
b187(A,B):-p640(A,C),b187_1(C,B).
b187_1(A,B):-p155(A,C),p1373_2(C,B).
b215(A,B):-p230_1(A,C),p457_1(C,B).
b208(A,B):-p249(A,C),b208_1(C,B).
b208_1(A,B):-p49(A,C),p1701_2(C,B).
b216(A,B):-p271_1(A,C),p1838_1(C,B).
b213(A,B):-p249(A,C),b213_1(C,B).
b213_1(A,B):-p166(A,C),p1616(C,B).
b219(A,B):-p295(A,C),p45_2(C,B).
b218(A,B):-move_left(A,C),b218_1(C,B).
b218_1(A,B):-p1066(A,C),p800(C,B).
b177(A,B):-p391(A,C),b177_1(C,B).
b177_1(A,B):-p1348(A,C),p640(C,B).
b217(A,B):-move_right(A,C),b217_1(C,B).
b217_1(A,B):-p277(A,C),p605(C,B).
b223(A,B):-p0(A,C),move_forwards(C,B).
b212(A,B):-p114(A,C),b212_1(C,B).
b212_1(A,B):-p52_1(A,C),p1931(C,B).
b211(A,B):-p1129(A,C),b211_1(C,B).
b211_1(A,B):-p295_1(A,C),p527_2(C,B).
b214(A,B):-p249(A,C),b214_1(C,B).
b214_1(A,B):-p1209(A,C),p466(C,B).
b224(A,B):-move_left(A,C),b224_1(C,B).
b224_1(A,B):-p129(A,C),p1729_1(C,B).
b222(A,B):-move_forwards(A,C),b222_1(C,B).
b222_1(A,B):-p928(A,C),p255_1(C,B).
b228(A,B):-p724(A,C),p1871(C,B).
b230(A,B):-p52_1(A,C),p688_1(C,B).
b225(A,B):-move_forwards(A,C),b225_1(C,B).
b225_1(A,B):-p656(A,C),p73_2(C,B).
b226(A,B):-move_backwards(A,C),b226_1(C,B).
b226_1(A,B):-p622(A,C),p955_1(C,B).
b231(A,B):-p48_1(A,C),p741(C,B).
b232(A,B):-p431(A,C),p89(C,B).
b220(A,B):-p621(A,C),b220_1(C,B).
b220_1(A,B):-p1830(A,C),p1666(C,B).
b236(A,B):-p366(A,C),p467(C,B).
b235(A,B):-p35(A,C),p1147(C,B).
b229(A,B):-move_backwards(A,C),b229_1(C,B).
b229_1(A,B):-p539(A,C),p1368(C,B).
b238(A,B):-p431(A,C),p48(C,B).
b209(A,B):-p431(A,C),b209_1(C,B).
b209_1(A,B):-p525(A,C),p426_1(C,B).
b239(A,B):-p934(A,C),p1590_2(C,B).
b242(A,B):-p85(A,B).
b241(A,B):-p52_1(A,C),p1743_1(C,B).
b243(A,B):-p495(A,C),p266(C,B).
b245(A,B):-p266(A,B).
b244(A,B):-p984(A,C),p1198_1(C,B).
b246(A,B):-p1277(A,C),p1063_2(C,B).
b247(A,B):-p991(A,C),p1761_1(C,B).
b249(A,B):-move_backwards(A,C),p784_2(C,B).
b205(A,B):-p1368(A,C),b205_1(C,B).
b205_1(A,B):-p155_1(A,C),p234_1(C,B).
b240(A,B):-move_right(A,C),b240_1(C,B).
b240_1(A,B):-p295_1(A,C),p636_1(C,B).
b221(A,B):-p114(A,C),b221_1(C,B).
b221_1(A,B):-p51_1(A,C),p395(C,B).
b253(A,B):-p264(A,B).
b252(A,B):-p89(A,C),p1173_1(C,B).
b254(A,B):-p426_1(A,C),p1837(C,B).
...
b259(A,B):-p700(A,C),p869(C,B).
b258(A,B):-move_left(A,C),b258_1(C,B).
b258_1(A,B):-p286_1(A,C),p1209(C,B).
b262(A,B):-p800(A,C),p420_1(C,B).
b237(A,B):-p138(A,C),b237_1(C,B).
b237_1(A,B):-p295(A,C),p2_1(C,B).
b264(A,B):-p1044(A,C),p114(C,B).
b265(A,B):-p35(A,C),p219_1(C,B).
b263(A,B):-move_left(A,C),b263_1(C,B).
b263_1(A,B):-p1449(A,C),p658_1(C,B).
...
b227(A,B):-p1197_1(A,C),b227_1(C,B).
b227_1(A,B):-p251(A,C),p1465(C,B).
b260(A,B):-p135_1(A,C),b260_1(C,B).
b260_1(A,B):-p273(A,C),p920(C,B).
...
b276(A,B):-p677_1(A,B).
b268(A,B):-p395(A,C),b268_1(C,B).
b268_1(A,B):-p386(A,C),p920(C,B).
b271(A,B):-move_left(A,C),b271_1(C,B).
b271_1(A,B):-p155(A,C),p10_2(C,B).
b279(A,B):-p1348(A,C),p129_1(C,B).
b280(A,B):-p271(A,C),p741(C,B).
b281(A,B):-p935(A,C),p257(C,B).
b282(A,B):-move_backwards(A,C),p1831(C,B).
b203(A,B):-p1454(A,C),b203_1(C,B).
b203_1(A,B):-p599(A,C),p499_2(C,B).
b277(A,B):-move_right(A,C),b277_1(C,B).
b277_1(A,B):-p81(A,C),p869(C,B).
b284(A,B):-p152(A,C),p95(C,B).
b285(A,B):-p421(A,C),p432(C,B).
b274(A,B):-move_backwards(A,C),b274_1(C,B).
b274_1(A,B):-p1796_1(A,C),p1379(C,B).
b255(A,B):-p135(A,C),b255_1(C,B).
b255_1(A,B):-p1713_1(A,C),p114(C,B).
b288(A,B):-p1686(A,C),p1683_1(C,B).
b283(A,B):-move_left(A,C),b283_1(C,B).
b283_1(A,B):-p765(A,C),p1360_2(C,B).
...
b291_1(A,B):-p1272(A,C),p426_1(C,B).
b289(A,B):-move_right(A,C),b289_1(C,B).
b289_1(A,B):-p1178(A,C),p621(C,B).
b272(A,B):-p114(A,C),b272_1(C,B).
b272_1(A,B):-p710(A,C),p334_1(C,B).
b294(A,B):-p1616(A,C),p670_1(C,B).
b278(A,B):-p1348(A,C),b278_1(C,B).
b278_1(A,B):-p1685(A,C),p634(C,B).
b295(A,B):-p35(A,C),p38_1(C,B).
b298(A,B):-p35(A,C),p659_1(C,B).
b299(A,B):-p230_1(A,C),p1813(C,B).
b300(A,B):-p295(A,C),p1039_2(C,B).
...
b297_1(A,B):-p396_1(A,C),p114(C,B).
b305(A,B):-p1559(A,C),p1438_1(C,B).
b306(A,B):-p1348(A,C),p428(C,B).
b275(A,B):-p869(A,C),b275_1(C,B).
b275_1(A,B):-p1721(A,C),p1129(C,B).
b307(A,B):-move_left(A,C),p461(C,B).
b257(A,B):-p1197(A,C),b257_1(C,B).
b257_1(A,B):-p1449(A,C),p543_1(C,B).
b304(A,B):-p1277(A,C),p770_2(C,B).
b311(A,B):-p249(A,C),p1219(C,B).
b312(A,B):-p1341(A,B).
...
b313(A,B):-p448_1(A,C),p1218_1(C,B).
b316(A,B):-p146(A,C),p1829_1(C,B).
b301(A,B):-move_backwards(A,C),b301_1(C,B).
b301_1(A,B):-p334(A,C),p658_1(C,B).
b308(A,B):-move_left(A,C),b308_1(C,B).
b308_1(A,B):-p1054(A,C),p1147_1(C,B).
b293(A,B):-p395(A,C),b293_1(C,B).
b293_1(A,B):-p1082(A,C),p257(C,B).
b317(A,B):-move_forwards(A,C),b317_1(C,B).
b317_1(A,B):-p1641(A,C),p1368(C,B).
b320(A,B):-move_right(A,C),b320_1(C,B).
b320_1(A,B):-p1341(A,C),p1902_1(C,B).
b324(A,B):-p230_1(A,C),p775_1(C,B).
b269(A,B):-p1144(A,C),b269_1(C,B).
b269_1(A,B):-p326(A,C),p114(C,B).
b323(A,B):-p508(A,C),p387_2(C,B).
b318(A,B):-move_left(A,C),b318_1(C,B).
b318_1(A,B):-p31(A,C),p1616(C,B).
b325(A,B):-p211(A,C),p246_2(C,B).
b326(A,B):-p1871(A,C),p1922(C,B).
b330(A,B):-p395(A,B).
b319(A,B):-move_right(A,C),b319_1(C,B).
b319_1(A,B):-p49_1(A,C),p1589(C,B).
b332(A,B):-p1194(A,C),p166(C,B).
b333(A,B):-p466_1(A,B).
b334(A,B):-p135_1(A,C),p518_1(C,B).
b331(A,B):-move_right(A,C),b331_1(C,B).
b331_1(A,B):-p231_1(A,C),p1570_1(C,B).
b322(A,B):-move_right(A,C),b322_1(C,B).
b322_1(A,B):-p1433_1(A,C),p586_2(C,B).
b327(A,B):-p928_1(A,C),p614_1(C,B).
b336(A,B):-p1479(A,C),p834_1(C,B).
b338(A,B):-p230_1(A,C),p1733_1(C,B).
b335(A,B):-move_left(A,C),b335_1(C,B).
b335_1(A,B):-p1686(A,C),p544_1(C,B).
b340(A,B):-p119_1(A,C),p257(C,B).
b341(A,B):-p984(A,C),p917_2(C,B).
b321(A,B):-p621(A,C),b321_1(C,B).
b321_1(A,B):-p35(A,C),p627(C,B).
b343(A,B):-p1348(A,C),p1748(C,B).
b342(A,B):-p800_1(A,C),p90_1(C,B).
b346(A,B):-p526(A,C),p1931(C,B).
b328(A,B):-move_forwards(A,C),b328_1(C,B).
b328_1(A,B):-p166_1(A,C),move_left(C,B).
b337(A,B):-move_right(A,C),b337_1(C,B).
b337_1(A,B):-p1277(A,C),p1230_1(C,B).
b349(A,B):-move_right(A,C),p971(C,B).
b348(A,B):-move_right(A,C),b348_1(C,B).
b348_1(A,B):-p83(A,C),p942_2(C,B).
b339(A,B):-move_left(A,C),b339_1(C,B).
b339_1(A,B):-p1878_1(A,C),p554(C,B).
b352(A,B):-p174(A,C),p1211_2(C,B).
b347(A,B):-p395(A,C),b347_1(C,B).
b347_1(A,B):-p1779(A,C),p741(C,B).
b354(A,B):-move_right(A,C),b354_1(C,B).
b354_1(A,B):-p887(A,C),p230(C,B).
b344(A,B):-p1129(A,C),b344_1(C,B).
b344_1(A,B):-p1463(A,C),p640(C,B).
b355(A,B):-p197_1(A,C),move_left(C,B).
b353(A,B):-move_forwards(A,C),b353_1(C,B).
b353_1(A,B):-p656_1(A,C),p544_2(C,B).
b350(A,B):-p1348(A,C),b350_1(C,B).
b350_1(A,B):-p238(A,C),p1170(C,B).
b358(A,B):-p230_1(A,C),p74_1(C,B).
b360(A,B):-p391(A,C),p135_1(C,B).
b329(A,B):-p1197_1(A,C),b329_1(C,B).
b329_1(A,B):-p53_1(A,C),p1129(C,B).
b361(A,B):-p50_1(A,C),p1736(C,B).
b356(A,B):-move_right(A,C),b356_1(C,B).
b356_1(A,B):-p146(A,C),p1147(C,B).
b364(A,B):-p257(A,C),p1332_1(C,B).
b365(A,B):-p114(A,B).
b362(A,B):-move_left(A,C),b362_1(C,B).
b362_1(A,B):-p314(A,C),p869(C,B).
b345(A,B):-p1562(A,C),b345_1(C,B).
b345_1(A,B):-p5_1(A,C),p634(C,B).
b367(A,B):-move_left(A,C),b367_1(C,B).
b367_1(A,B):-p383(A,C),p206(C,B).
b359(A,B):-move_backwards(A,C),b359_1(C,B).
b359_1(A,B):-p700(A,C),p627(C,B).
b369(A,B):-p277(A,C),p266(C,B).
b366(A,B):-move_right(A,C),b366_1(C,B).
b366_1(A,B):-p668(A,C),p129_1(C,B).
b372(A,B):-p946(A,C),p426_1(C,B).
b368(A,B):-move_backwards(A,C),b368_1(C,B).
b368_1(A,B):-p764(A,C),p554(C,B).
b374(A,B):-p934(A,C),p100_2(C,B).
b375(A,B):-p1559(A,C),p775(C,B).
b371(A,B):-move_left(A,C),b371_1(C,B).
b371_1(A,B):-p559(A,C),p634(C,B).
b363(A,B):-p880(A,C),b363_1(C,B).
b363_1(A,B):-p1667(A,C),p532(C,B).
b378(A,B):-move_right(A,C),p277_1(C,B).
b379(A,B):-p1054_1(A,C),p1666(C,B).
b380(A,B):-p83(A,C),p1208_2(C,B).
b373(A,B):-move_backwards(A,C),b373_1(C,B).
b373_1(A,B):-p52_1(A,C),p517_1(C,B).
b370(A,B):-move_right(A,C),b370_1(C,B).
b370_1(A,B):-p142_1(A,C),p230(C,B).
b383(A,B):-move_backwards(A,C),p739(C,B).
b384(A,B):-move_right(A,C),p1082(C,B).
b382(A,B):-p395(A,C),p938_2(C,B).
b381(A,B):-p396_1(A,C),p1147_1(C,B).
b387(A,B):-move_right(A,C),p559_1(C,B).
b385(A,B):-p138(A,C),p599(C,B).
b389(A,B):-p1134(A,C),p45(C,B).
b386(A,B):-p1420(A,C),p1931(C,B).
b388(A,B):-move_forwards(A,C),b388_1(C,B).
b388_1(A,B):-p673(A,C),p1274(C,B).
b377(A,B):-move_right(A,C),b377_1(C,B).
b377_1(A,B):-p1460(A,C),move_backwards(C,B).
b393(A,B):-p1348(A,C),p40_1(C,B).
b394(A,B):-p114(A,C),p1533(C,B).
b357(A,B):-p231_1(A,C),b357_1(C,B).
b357_1(A,B):-p294_1(A,C),p1147_1(C,B).
b392(A,B):-move_backwards(A,C),b392_1(C,B).
b392_1(A,B):-p833(A,C),p342(C,B).
b391(A,B):-move_forwards(A,C),b391_1(C,B).
b391_1(A,B):-p253(A,C),p1823_1(C,B).
b397(A,B):-p991(A,C),p1517_1(C,B).
b398(A,B):-p607(A,C),p621(C,B).
b400(A,B):-p1987(A,B).
b401(A,B):-p266(A,C),p1521(C,B).
b399(A,B):-move_left(A,C),b399_1(C,B).
b399_1(A,B):-p759(A,C),move_backwards(C,B).
b403(A,B):-p886(A,C),p1173_1(C,B).
b402(A,B):-p765(A,C),p1754_2(C,B).
b405(A,B):-p395(A,C),p39_1(C,B).
b404(A,B):-p409(A,C),p544_1(C,B).
b407(A,B):-p1368(A,B).
b406(A,B):-p366(A,C),p809(C,B).
b395(A,B):-move_backwards(A,C),b395_1(C,B).
b395_1(A,B):-p754_1(A,C),p1758(C,B).
b396(A,B):-p249(A,C),b396_1(C,B).
b396_1(A,B):-p603(A,C),p166(C,B).
b411(A,B):-p406(A,C),p499_2(C,B).
b410(A,B):-move_forwards(A,C),b410_1(C,B).
b410_1(A,B):-p1384(A,C),p1440(C,B).
b351(A,B):-p1898(A,C),b351_1(C,B).
b351_1(A,B):-p1449(A,C),p1692_1(C,B).
b412(A,B):-p206(A,C),p1477(C,B).
b414(A,B):-p230_1(A,C),p1590(C,B).
b415(A,B):-p621(A,C),p1499_1(C,B).
b417(A,B):-move_forwards(A,C),p1066(C,B).
b409(A,B):-move_right(A,C),b409_1(C,B).
b409_1(A,B):-p1302_1(A,C),p1348(C,B).
b413(A,B):-move_backwards(A,C),b413_1(C,B).
b413_1(A,B):-p80(A,C),p1274(C,B).
b420(A,B):-p508(A,C),p56_1(C,B).
b376(A,B):-p230_1(A,C),b376_1(C,B).
b376_1(A,B):-p1093_1(A,C),p800_1(C,B).
b422(A,B):-p984(A,C),p1504_2(C,B).
b418(A,B):-move_right(A,C),b418_1(C,B).
b418_1(A,B):-p1336(A,C),p644_2(C,B).
b408(A,B):-p366(A,C),b408_1(C,B).
b408_1(A,B):-p508(A,C),p544_2(C,B).
b419(A,B):-move_right(A,C),b419_1(C,B).
b419_1(A,B):-p86(A,C),p1197(C,B).
b390(A,B):-p1559(A,C),b390_1(C,B).
b390_1(A,B):-p1072(A,C),p514(C,B).
b421(A,B):-move_forwards(A,C),b421_1(C,B).
b421_1(A,B):-p984_1(A,C),p624_2(C,B).
b427(A,B):-move_forwards(A,C),b427_1(C,B).
b427_1(A,B):-p107_1(A,C),p651_1(C,B).
b429(A,B):-p1701_2(A,B).
b430(A,B):-p114(A,C),p1221(C,B).
b431(A,B):-move_forwards(A,C),p978_1(C,B).
b432(A,B):-p621(A,C),p421(C,B).
b433(A,B):-p1559(A,C),p1072_1(C,B).
b423(A,B):-p1559(A,C),b423_1(C,B).
b423_1(A,B):-p174(A,C),p1526_2(C,B).
b426(A,B):-p249(A,C),b426_1(C,B).
b426_1(A,B):-p49_1(A,C),p52_2(C,B).
b436(A,B):-p621(A,C),p761_1(C,B).
b435(A,B):-p230_1(A,C),p1796(C,B).
b438(A,B):-p208(A,C),p1147_1(C,B).
b428(A,B):-p395(A,C),b428_1(C,B).
b428_1(A,B):-p820(A,C),p1147_1(C,B).
b440(A,B):-p271(A,C),p627(C,B).
b441(A,B):-p378(A,C),p621(C,B).
b442(A,B):-p1348(A,C),p1481(C,B).
b437(A,B):-move_right(A,C),b437_1(C,B).
b437_1(A,B):-p251_1(A,C),p521_1(C,B).
b444(A,B):-p807(A,C),p800(C,B).
b434(A,B):-move_backwards(A,C),b434_1(C,B).
b434_1(A,B):-p851(A,C),p140(C,B).
b439(A,B):-p880(A,C),b439_1(C,B).
b439_1(A,B):-p1653(A,C),p800(C,B).
b445(A,B):-move_left(A,C),b445_1(C,B).
b445_1(A,B):-p1129(A,C),p864_1(C,B).
b448(A,B):-p535(A,C),p366(C,B).
b447(A,B):-move_right(A,C),b447_1(C,B).
b447_1(A,B):-p277(A,C),p123_2(C,B).
b450(A,B):-p293_1(A,C),p1120_1(C,B).
b451(A,B):-move_left(A,C),p627(C,B).
b416(A,B):-p426(A,C),b416_1(C,B).
b416_1(A,B):-p765_1(A,C),p479_2(C,B).
b425(A,B):-p135_1(A,C),b425_1(C,B).
b425_1(A,B):-p1844(A,C),move_right(C,B).
b424(A,B):-p1147(A,C),b424_1(C,B).
b424_1(A,B):-p295(A,C),p1784_1(C,B).
b454(A,B):-move_left(A,C),b454_1(C,B).
b454_1(A,B):-p54(A,C),p1397_2(C,B).
b456(A,B):-p54_1(A,C),p446_2(C,B).
b457(A,B):-p431(A,C),p1230(C,B).
b458(A,B):-move_right(A,C),p716_1(C,B).
b449(A,B):-p249(A,C),b449_1(C,B).
b449_1(A,B):-p1521_1(A,C),p1471_1(C,B).
b459(A,B):-p249(A,C),b459_1(C,B).
b459_1(A,B):-p240(A,C),p230(C,B).
b461(A,B):-p811_1(A,B).
b453(A,B):-p880(A,C),b453_1(C,B).
b453_1(A,B):-p1261(A,C),p426(C,B).
b463(A,B):-move_right(A,C),p327(C,B).
b464(A,B):-p1268(A,C),p1767(C,B).
b465(A,B):-p43_2(A,B).
b460(A,B):-move_right(A,C),b460_1(C,B).
b460_1(A,B):-p971(A,C),p1197(C,B).
b455(A,B):-p395(A,C),b455_1(C,B).
b455_1(A,B):-p984_2(A,C),p1359_2(C,B).
b468(A,B):-p432(A,C),p1564(C,B).
b469(A,B):-p1274(A,C),p1249_1(C,B).
...
b462_1(A,B):-p984(A,C),p1575_2(C,B).
b452(A,B):-p499_2(A,C),b452_1(C,B).
b452_1(A,B):-p251(A,C),p1197_1(C,B).
b470(A,B):-move_right(A,C),b470_1(C,B).
b470_1(A,B):-p634(A,C),p1359_1(C,B).
b443(A,B):-p1147(A,C),b443_1(C,B).
b443_1(A,B):-p1272_1(A,C),p431(C,B).
b476(A,B):-move_right(A,C),p420_1(C,B).
b475(A,B):-p408(A,C),p958(C,B).
b473(A,B):-move_right(A,C),b473_1(C,B).
b473_1(A,B):-p1256(A,C),move_backwards(C,B).
b471(A,B):-move_backwards(A,C),b471_1(C,B).
b471_1(A,B):-p51(A,C),move_forwards(C,B).
b480(A,B):-p1147_1(A,C),p1701(C,B).
b481(A,B):-p659(A,C),p1531(C,B).
b482(A,B):-p880(A,C),p1638(C,B).
b467(A,B):-p395(A,C),b467_1(C,B).
b467_1(A,B):-p35(A,C),p536_1(C,B).
b484(A,B):-p593(A,C),p56_1(C,B).
...
b489(A,B):-p266(A,C),p984_2(C,B).
b491(A,B):-move_left(A,C),p634(C,B).
b490(A,B):-p266(A,C),p688(C,B).
b492(A,B):-p1207(A,C),p1823_1(C,B).
b494(A,B):-p249(A,C),p1360_1(C,B).
b472(A,B):-p1129(A,C),b472_1(C,B).
b472_1(A,B):-p295(A,C),p1218_2(C,B).
b483(A,B):-p395(A,C),b483_1(C,B).
b483_1(A,B):-p1302(A,C),p1144(C,B).
b497(A,B):-p257(A,B).
b474(A,B):-p1144(A,C),b474_1(C,B).
b474_1(A,B):-p155(A,C),p1858_2(C,B).
b498(A,B):-move_right(A,C),p869(C,B).
b500(A,B):-p538_1(A,C),p1358(C,B).
b501(A,B):-move_forwards(A,C),p921(C,B).
b488(A,B):-p230(A,C),b488_1(C,B).
b488_1(A,B):-p1277(A,C),p1920_1(C,B).
b477(A,B):-p395(A,C),b477_1(C,B).
b477_1(A,B):-p142(A,C),p1348(C,B).
b503(A,B):-p1443(A,C),p249(C,B).
b493(A,B):-p395(A,C),b493_1(C,B).
b493_1(A,B):-p1960(A,C),p1423(C,B).
b496(A,B):-p249(A,C),b496_1(C,B).
b496_1(A,B):-p277(A,C),p142_2(C,B).
b499(A,B):-p395(A,C),b499_1(C,B).
b499_1(A,B):-p1629(A,C),p741(C,B).
b502(A,B):-move_right(A,C),b502_1(C,B).
b502_1(A,B):-p303(A,C),p395(C,B).
b509(A,B):-p230_1(A,C),p1545(C,B).
b510(A,B):-p249(A,C),p264(C,B).
b508(A,B):-move_left(A,C),b508_1(C,B).
b508_1(A,B):-grab_ball(A,C),p1754_2(C,B).
b504(A,B):-move_forwards(A,C),b504_1(C,B).
b504_1(A,B):-p293(A,C),p739_1(C,B).
b513(A,B):-p545(A,C),p311_1(C,B).
...
b512_1(A,B):-p1753(A,C),p1292_1(C,B).
b517(A,B):-p1129(A,C),p227_1(C,B).
b511(A,B):-move_left(A,C),b511_1(C,B).
b511_1(A,B):-p1272(A,C),p138(C,B).
b505(A,B):-p135_1(A,C),b505_1(C,B).
b505_1(A,B):-p54(A,C),p925_2(C,B).
b507(A,B):-move_backwards(A,C),b507_1(C,B).
b507_1(A,B):-p1039(A,C),move_right(C,B).
b519(A,B):-p520(A,C),p759_1(C,B).
b522(A,B):-p880(A,C),p81_1(C,B).
...
b514_1(A,B):-p531(A,C),p294(C,B).
b526(A,B):-p1356(A,C),p1368(C,B).
b527(A,B):-p800_1(A,B).
b525(A,B):-move_forwards(A,C),b525_1(C,B).
b525_1(A,B):-p886(A,C),p1536_1(C,B).
b524(A,B):-move_forwards(A,C),b524_1(C,B).
b524_1(A,B):-p293(A,C),p856_1(C,B).
b520(A,B):-p249(A,C),b520_1(C,B).
b520_1(A,B):-p53_1(A,C),p1559(C,B).
b531(A,B):-p194(A,C),p249(C,B).
b532(A,B):-p1094(A,C),p1624(C,B).
b529(A,B):-move_backwards(A,C),b529_1(C,B).
b529_1(A,B):-p540(A,C),p426(C,B).
b533(A,B):-p604_1(A,C),p1343(C,B).
b534(A,B):-p253_1(A,C),move_forwards(C,B).
b530(A,B):-move_left(A,C),b530_1(C,B).
b530_1(A,B):-p1921(A,C),p114(C,B).
b537(A,B):-p1437(A,C),p586_2(C,B).
b536(A,B):-move_right(A,C),b536_1(C,B).
b536_1(A,B):-p1277_1(A,C),p504_2(C,B).
b538(A,B):-move_forwards(A,C),b538_1(C,B).
b538_1(A,B):-p58(A,C),p869(C,B).
b540(A,B):-move_left(A,C),move_backwards(C,B).
b541(A,B):-p504_2(A,B).
b495(A,B):-p251(A,C),b495_1(C,B).
b495_1(A,B):-p1094_1(A,C),p814(C,B).
b543(A,B):-move_backwards(A,C),p499_2(C,B).
b542(A,B):-move_left(A,C),b542_1(C,B).
b542_1(A,B):-p607(A,C),p580(C,B).
b545(A,B):-p1691(A,C),p800_1(C,B).
b535(A,B):-p257(A,C),b535_1(C,B).
b535_1(A,B):-p700(A,C),p266(C,B).
b516(A,B):-p1274(A,C),b516_1(C,B).
b516_1(A,B):-p155(A,C),p744_2(C,B).
b544(A,B):-move_right(A,C),b544_1(C,B).
b544_1(A,B):-p633(A,C),p231_1(C,B).
b549(A,B):-p1477(A,C),p18(C,B).
b539(A,B):-p1348(A,C),b539_1(C,B).
b539_1(A,B):-p1302(A,C),p741(C,B).
b551(A,B):-p1713_1(A,B).
b552(A,B):-move_left(A,C),b552_1(C,B).
b552_1(A,B):-p448(A,C),p1178_2(C,B).
b548(A,B):-move_left(A,C),b548_1(C,B).
b548_1(A,B):-p298(A,C),p1610(C,B).
b550(A,B):-move_left(A,C),b550_1(C,B).
b550_1(A,B):-p656(A,C),p321_2(C,B).
...
b557(A,B):-p277(A,C),p569_1(C,B).
b555(A,B):-move_left(A,C),b555_1(C,B).
b555_1(A,B):-p298(A,C),p1129(C,B).
b528(A,B):-p1931(A,C),b528_1(C,B).
b528_1(A,B):-p1433_1(A,C),p1709_2(C,B).
b558(A,B):-move_backwards(A,C),b558_1(C,B).
b558_1(A,B):-p58(A,C),p426(C,B).
b562(A,B):-p456(A,C),p1705(C,B).
b559(A,B):-p249(A,C),b559_1(C,B).
b559_1(A,B):-p277(A,C),p349_1(C,B).
b564(A,B):-p1129(A,C),p1300(C,B).
b565(A,B):-p230(A,B).
b560(A,B):-move_left(A,C),b560_1(C,B).
b560_1(A,B):-p508(A,C),p1230_1(C,B).
b566(A,B):-p1070(A,C),p1155(C,B).
b563(A,B):-p448_1(A,C),p1207_2(C,B).
b569(A,B):-p266(A,C),p1521_1(C,B).
b568(A,B):-move_left(A,C),b568_1(C,B).
b568_1(A,B):-move_backwards(A,C),p670_1(C,B).
b571(A,B):-p1931(A,C),p1264(C,B).
b572(A,B):-p426(A,B).
b556(A,B):-p135_1(A,C),b556_1(C,B).
b556_1(A,B):-p1277(A,C),p352_2(C,B).
b574(A,B):-p640(A,C),p497_1(C,B).
b573(A,B):-move_right(A,C),b573_1(C,B).
b573_1(A,B):-p541(A,C),p230(C,B).
b576(A,B):-p135_1(A,C),p1273_1(C,B).
b575(A,B):-move_left(A,C),b575_1(C,B).
b575_1(A,B):-p1833(A,C),p206(C,B).
...
b582(A,B):-p1659(A,B).
b581(A,B):-p1072(A,C),p1481(C,B).
b570(A,B):-p880(A,C),b570_1(C,B).
b570_1(A,B):-p984_1(A,C),p124_2(C,B).
b584(A,B):-move_right(A,C),b584_1(C,B).
b584_1(A,B):-p295(A,C),p352_2(C,B).
b586(A,B):-p395(A,C),p1987_1(C,B).
b587(A,B):-move_left(A,C),p1044_1(C,B).
b554(A,B):-p231_1(A,C),b554_1(C,B).
b554_1(A,B):-p1093(A,C),p257(C,B).
b589(A,B):-p1348(A,C),p581(C,B).
b588(A,B):-move_left(A,C),b588_1(C,B).
b588_1(A,B):-p577(A,C),p50_2(C,B).
b591(A,B):-p311_1(A,C),p688(C,B).
b592(A,B):-p249(A,C),p287_1(C,B).
b593(A,B):-p1691(A,C),p230_1(C,B).
b590(A,B):-move_right(A,C),b590_1(C,B).
b590_1(A,B):-p632(A,C),move_backwards(C,B).
b567(A,B):-p114(A,C),b567_1(C,B).
b567_1(A,B):-p717(A,C),p640(C,B).
b583(A,B):-p231_1(A,C),b583_1(C,B).
b583_1(A,B):-p960(A,C),p426(C,B).
b596(A,B):-p249(A,C),b596_1(C,B).
b596_1(A,B):-p272(A,C),p621(C,B).
b594(A,B):-p138(A,C),b594_1(C,B).
b594_1(A,B):-p1845(A,C),p1129(C,B).
b599(A,B):-p230_1(A,C),p1343(C,B).
b600(A,B):-move_right(A,C),p921_1(C,B).
...
b604(A,B):-p1437(A,C),p1984_1(C,B).
b561(A,B):-p545(A,C),b561_1(C,B).
b561_1(A,B):-p1521(A,C),p605(C,B).
b597(A,B):-p880(A,C),b597_1(C,B).
b597_1(A,B):-p1433(A,C),p551(C,B).
b601(A,B):-p230(A,C),b601_1(C,B).
b601_1(A,B):-p1984_1(A,C),p1284(C,B).
b607(A,B):-p249(A,C),b607_1(C,B).
b607_1(A,B):-p35(A,C),p494_1(C,B).
b605(A,B):-p138(A,C),b605_1(C,B).
b605_1(A,B):-p1529_1(A,C),p135_1(C,B).
b610(A,B):-p52_1(A,C),p1227_1(C,B).
b611(A,B):-move_backwards(A,B).
b612(A,B):-p135(A,B).
b613(A,B):-p54(A,C),p846_1(C,B).
b614(A,B):-move_forwards(A,C),b614_1(C,B).
b614_1(A,B):-p623(A,C),p395(C,B).
b609(A,B):-move_forwards(A,C),b609_1(C,B).
b609_1(A,B):-p49(A,C),p1246_1(C,B).
b616(A,B):-p980(A,B).
b617(A,B):-p303(A,C),move_left(C,B).
b618(A,B):-p1368(A,B).
b608(A,B):-p1129(A,C),b608_1(C,B).
b608_1(A,B):-p1277(A,C),p1397_2(C,B).
...
b620_1(A,B):-p577(A,C),p978_2(C,B).
b623(A,B):-p621(A,C),p535(C,B).
b615(A,B):-p621(A,C),b615_1(C,B).
b615_1(A,B):-p1414(A,C),p1457(C,B).
b585(A,B):-p387(A,C),b585_1(C,B).
b585_1(A,B):-p633(A,C),p586(C,B).
b624(A,B):-move_forwards(A,C),b624_1(C,B).
b624_1(A,B):-p1701(A,C),p231_1(C,B).
b626(A,B):-p1147(A,C),p1070_1(C,B).
b627(A,B):-p190(A,C),p395(C,B).
b629(A,B):-p249(A,C),p607_1(C,B).
b628(A,B):-p864(A,C),p294(C,B).
b630(A,B):-p1686(A,C),p144_1(C,B).
b625(A,B):-move_right(A,C),b625_1(C,B).
b625_1(A,B):-p277(A,C),p652_2(C,B).
b632(A,B):-p1681(A,C),p42_1(C,B).
b631(A,B):-p1521_1(A,C),p56_2(C,B).
b635(A,B):-p1129(A,C),p1534_1(C,B).
b633(A,B):-p1645(A,C),p1271(C,B).
b619(A,B):-p627(A,C),b619_1(C,B).
b619_1(A,B):-p1461(A,C),p741(C,B).
b637(A,B):-p528(A,C),p1144(C,B).
b634(A,B):-p395(A,C),b634_1(C,B).
b634_1(A,B):-p1544(A,C),p432(C,B).
b636(A,B):-move_right(A,C),b636_1(C,B).
b636_1(A,B):-p1219(A,C),p366(C,B).
b641(A,B):-p705(A,B).
b639(A,B):-move_forwards(A,C),b639_1(C,B).
b639_1(A,B):-p673(A,C),p880(C,B).
b640(A,B):-p48(A,C),p231_1(C,B).
b642(A,B):-p488(A,C),p414(C,B).
b643(A,B):-p1121(A,C),p1770(C,B).
b645(A,B):-p604_1(A,C),p382(C,B).
b647(A,B):-move_right(A,C),b647_1(C,B).
b647_1(A,B):-p35(A,C),p912_1(C,B).
b648(A,B):-p1480(A,C),p800_1(C,B).
b646(A,B):-p1559(A,C),b646_1(C,B).
b646_1(A,B):-p1711(A,C),p800(C,B).
b650(A,B):-p293(A,C),p892_1(C,B).
b651(A,B):-move_right(A,C),p169(C,B).
b652(A,B):-p54(A,C),p479_1(C,B).
b653(A,B):-move_left(A,C),b653_1(C,B).
b653_1(A,B):-p1521_1(A,C),p521_2(C,B).
b606(A,B):-p1020(A,C),b606_1(C,B).
b606_1(A,B):-p1227(A,C),p1559(C,B).
b654(A,B):-move_right(A,C),b654_1(C,B).
b654_1(A,B):-p1414(A,C),p1626_1(C,B).
...
b657_1(A,B):-p49_1(A,C),p1844_1(C,B).
b659(A,B):-p148(A,C),p138(C,B).
b658(A,B):-move_left(A,C),b658_1(C,B).
b658_1(A,B):-p205(A,C),p230_1(C,B).
b660(A,B):-move_right(A,C),b660_1(C,B).
b660_1(A,B):-p1537_1(A,C),p249(C,B).
b662(A,B):-p644_1(A,C),move_left(C,B).
...
b665_1(A,B):-p277(A,C),p1153_2(C,B).
b666(A,B):-p479(A,C),p1368(C,B).
b667(A,B):-p1009(A,C),p1559(C,B).
b668(A,B):-p1209(A,C),p781(C,B).
b661(A,B):-p395(A,C),b661_1(C,B).
b661_1(A,B):-p1521(A,C),p1133_2(C,B).
b671(A,B):-p1009(A,C),p266(C,B).
b672(A,B):-p135_1(A,C),p942(C,B).
b656(A,B):-p497(A,C),b656_1(C,B).
b656_1(A,B):-p286(A,C),p1487_1(C,B).
b655(A,B):-p266(A,C),b655_1(C,B).
b655_1(A,B):-p236(A,C),p1846(C,B).
b670(A,B):-p249(A,C),b670_1(C,B).
b670_1(A,B):-p49(A,C),p1570_2(C,B).
b675(A,B):-move_left(A,C),b675_1(C,B).
b675_1(A,B):-p308(A,C),p621(C,B).
b677(A,B):-move_left(A,C),p543_1(C,B).
b673(A,B):-move_forwards(A,C),b673_1(C,B).
b673_1(A,B):-p1277(A,C),p1827_2(C,B).
b676(A,B):-p249(A,C),b676_1(C,B).
b676_1(A,B):-p83(A,C),p544_2(C,B).
b521(A,B):-move_right(A,C),b521_1(C,B).
b521_1(A,B):-p627(A,C),b521_2(C,B).
b521_2(A,B):-p1876(A,C),p1709(C,B).
b681(A,B):-p81(A,C),p395(C,B).
b680(A,B):-move_left(A,C),b680_1(C,B).
b680_1(A,B):-p656(A,C),p1027_2(C,B).
b669(A,B):-p880(A,C),b669_1(C,B).
b669_1(A,B):-p765(A,C),p147_1(C,B).
...
b685_1(A,B):-p1521_1(A,C),p784_1(C,B).
b687(A,B):-move_right(A,C),p1425_2(C,B).
b678(A,B):-p1129(A,C),b678_1(C,B).
b678_1(A,B):-p531(A,C),p426(C,B).
b688(A,B):-p577(A,C),p273_2(C,B).
b686(A,B):-move_left(A,C),b686_1(C,B).
b686_1(A,B):-p1525(A,C),p138(C,B).
b690(A,B):-p271_1(A,C),p1695_1(C,B).
b692(A,B):-move_right(A,C),p1107(C,B).
b689(A,B):-move_backwards(A,C),b689_1(C,B).
b689_1(A,B):-p58(A,C),move_backwards(C,B).
b649(A,B):-p1474(A,C),b649_1(C,B).
b649_1(A,B):-p294(A,C),p800(C,B).
b683(A,B):-p869(A,C),b683_1(C,B).
b683_1(A,B):-p295(A,C),p1139_2(C,B).
b691(A,B):-p230(A,C),b691_1(C,B).
b691_1(A,B):-p1166(A,C),p1363_1(C,B).
b697(A,B):-p395(A,C),p974(C,B).
b698(A,B):-p366(A,B).
b693(A,B):-p880(A,C),b693_1(C,B).
b693_1(A,B):-p30(A,C),p1721_1(C,B).
b700(A,B):-move_forwards(A,C),p595_2(C,B).
b701(A,B):-p286(A,C),p521_1(C,B).
b699(A,B):-move_left(A,C),b699_1(C,B).
b699_1(A,B):-p1521(A,C),p0_1(C,B).
b702(A,B):-p1348(A,C),p275_1(C,B).
b703(A,B):-p266(A,C),p615_1(C,B).
b704(A,B):-p114(A,C),p1811_1(C,B).
b705(A,B):-p1739(A,C),p1811(C,B).
b707(A,B):-p8(A,C),p426_1(C,B).
b706(A,B):-move_left(A,C),b706_1(C,B).
b706_1(A,B):-p765(A,C),p669_2(C,B).
b709(A,B):-p395(A,C),p80_1(C,B).
b710(A,B):-p1129(A,C),p206_1(C,B).
b708(A,B):-move_forwards(A,C),b708_1(C,B).
b708_1(A,B):-p61(A,C),p23(C,B).
b695(A,B):-p1559(A,C),b695_1(C,B).
b695_1(A,B):-p381(A,C),p431(C,B).
b711(A,B):-p1645(A,C),p1576(C,B).
b712(A,B):-p765(A,C),p1300_2(C,B).
b713(A,B):-p138(A,C),p1823(C,B).
b714(A,B):-move_left(A,C),b714_1(C,B).
b714_1(A,B):-p893(A,C),p880(C,B).
b717(A,B):-p621(A,C),p1155(C,B).
b715(A,B):-p135(A,C),b715_1(C,B).
b715_1(A,B):-p286_1(A,C),p350(C,B).
b719(A,B):-move_left(A,C),b719_1(C,B).
b719_1(A,B):-p241(A,C),p114(C,B).
b506(A,B):-move_right(A,C),b506_1(C,B).
b506_1(A,B):-p1147(A,C),b506_2(C,B).
b506_2(A,B):-p1521(A,C),p1198_1(C,B).
b696(A,B):-p83(A,C),b696_1(C,B).
b696_1(A,B):-p135_1(A,C),p586_2(C,B).
b720(A,B):-move_left(A,C),b720_1(C,B).
b720_1(A,B):-p1129(A,C),p744_1(C,B).
b679(A,B):-p1274(A,C),b679_1(C,B).
b679_1(A,B):-p1529_1(A,C),p1559(C,B).
b723(A,B):-p1559(A,C),p1363_1(C,B).
b725(A,B):-p1107(A,C),p607(C,B).
b716(A,B):-p249(A,C),b716_1(C,B).
b716_1(A,B):-p1277_1(A,C),p504_2(C,B).
b718(A,B):-p266(A,C),b718_1(C,B).
b718_1(A,B):-p1277(A,C),p527_2(C,B).
b728(A,B):-p1559(A,C),p537_1(C,B).
b729(A,B):-move_left(A,C),b729_1(C,B).
b729_1(A,B):-p956(A,C),p249(C,B).
...
b726(A,B):-p621(A,C),b726_1(C,B).
b726_1(A,B):-p35(A,C),p1377_1(C,B).
b733(A,B):-p1488(A,B).
b734(A,B):-p395(A,C),p955(C,B).
b735(A,B):-p1197_1(A,C),p271_1(C,B).
b736(A,B):-p880(A,C),p1332(C,B).
b694(A,B):-p499_2(A,C),b694_1(C,B).
b694_1(A,B):-p1876(A,C),p658_1(C,B).
b732(A,B):-move_right(A,C),b732_1(C,B).
b732_1(A,B):-p295(A,C),p1373_2(C,B).
b739(A,B):-p1551(A,B).
b730(A,B):-p1129(A,C),b730_1(C,B).
b730_1(A,B):-p49(A,C),p1061_1(C,B).
b737(A,B):-p249(A,C),b737_1(C,B).
b737_1(A,B):-p414(A,C),p1316(C,B).
b740(A,B):-move_left(A,C),b740_1(C,B).
b740_1(A,B):-p295(A,C),p42_2(C,B).
b743(A,B):-p1348(A,C),p792_1(C,B).
b744(A,B):-p1636(A,C),p497_2(C,B).
b742(A,B):-move_forwards(A,C),b742_1(C,B).
b742_1(A,B):-p61_1(A,C),p1780(C,B).
b746(A,B):-p426_1(A,B).
b747(A,B):-move_left(A,C),b747_1(C,B).
b747_1(A,B):-p1250(A,C),move_forwards(C,B).
b738(A,B):-p249(A,C),b738_1(C,B).
b738_1(A,B):-p327(A,C),p1147(C,B).
b748(A,B):-move_forwards(A,C),b748_1(C,B).
b748_1(A,B):-p1496(A,C),p832(C,B).
b750(A,B):-p1559(A,C),p615_1(C,B).
b724(A,B):-p627(A,C),b724_1(C,B).
b724_1(A,B):-p928(A,C),p485_1(C,B).
b722(A,B):-p1197(A,C),b722_1(C,B).
b722_1(A,B):-p570(A,C),p621(C,B).
b753(A,B):-p251_1(A,B).
b751(A,B):-move_backwards(A,C),b751_1(C,B).
b751_1(A,B):-p61_1(A,C),p1423(C,B).
b741(A,B):-p627(A,C),b741_1(C,B).
b741_1(A,B):-p1845(A,C),p1129(C,B).
b752(A,B):-move_left(A,C),b752_1(C,B).
b752_1(A,B):-p277(A,C),p518_2(C,B).
b745(A,B):-p249(A,C),b745_1(C,B).
b745_1(A,B):-p1277(A,C),p1077_2(C,B).
b731(A,B):-p1197_1(A,C),b731_1(C,B).
b731_1(A,B):-p790(A,C),p332(C,B).
b749(A,B):-move_forwards(A,C),b749_1(C,B).
b749_1(A,B):-p1394(A,C),p1140(C,B).
b759(A,B):-p448(A,C),p1178_2(C,B).
b761(A,B):-p914_1(A,B).
b762(A,B):-move_forwards(A,C),p197(C,B).
b756(A,B):-move_left(A,C),b756_1(C,B).
b756_1(A,B):-p764(A,C),p1481(C,B).
b760(A,B):-p841(A,C),p466_1(C,B).
b764(A,B):-p1144(A,C),p206(C,B).
b766(A,B):-p53_1(A,B).
b757(A,B):-move_left(A,C),b757_1(C,B).
b757_1(A,B):-p295(A,C),p670_2(C,B).
b765(A,B):-p1559(A,C),p1072_1(C,B).
b763(A,B):-p765(A,C),p1380_2(C,B).
b755(A,B):-move_right(A,C),b755_1(C,B).
b755_1(A,B):-p384(A,C),p366(C,B).
b769(A,B):-p155_1(A,C),p1634_1(C,B).
...
b773(A,B):-p813(A,C),p741(C,B).
b758(A,B):-move_backwards(A,C),b758_1(C,B).
b758_1(A,B):-p802(A,C),p540(C,B).
b595(A,B):-move_left(A,C),b595_1(C,B).
b595_1(A,B):-p627(A,C),b595_2(C,B).
b595_2(A,B):-p295(A,C),p10_2(C,B).
b778(A,B):-p1980(A,C),p129_2(C,B).
...
b770_1(A,B):-p286_1(A,C),p1040(C,B).
b777(A,B):-p621(A,C),b777_1(C,B).
b777_1(A,B):-p294(A,C),p800(C,B).
b771(A,B):-p621(A,C),b771_1(C,B).
b771_1(A,B):-p1711_1(A,C),p1197(C,B).
b781(A,B):-move_right(A,C),b781_1(C,B).
b781_1(A,B):-p1521_1(A,C),p581_1(C,B).
b784(A,B):-move_left(A,C),b784_1(C,B).
b784_1(A,B):-p1480(A,C),p426(C,B).
b786(A,B):-move_forwards(A,C),p705(C,B).
b787(A,B):-p984_1(A,C),p677_2(C,B).
b768(A,B):-p1348(A,C),b768_1(C,B).
b768_1(A,B):-p545(A,C),p741(C,B).
b785(A,B):-move_left(A,C),b785_1(C,B).
b785_1(A,B):-p508(A,C),p527_2(C,B).
b782(A,B):-move_right(A,C),b782_1(C,B).
b782_1(A,B):-p521_1(A,C),p494(C,B).
b790(A,B):-p1368(A,C),p74_1(C,B).
b791(A,B):-move_forwards(A,C),p466(C,B).
b780(A,B):-p800_1(A,C),b780_1(C,B).
b780_1(A,B):-p52_1(A,C),p1995_1(C,B).
b754(A,B):-p12(A,C),b754_1(C,B).
b754_1(A,B):-p813(A,C),p231_1(C,B).
b795(A,B):-p106(A,C),p378(C,B).
b796(A,B):-p257(A,C),p958_2(C,B).
b797(A,B):-p114(A,C),p659_1(C,B).
b798(A,B):-p1481(A,C),p1603(C,B).
b776(A,B):-p1144(A,C),b776_1(C,B).
b776_1(A,B):-p216(A,C),p395(C,B).
b788(A,B):-p1559(A,C),b788_1(C,B).
b788_1(A,B):-p1861(A,C),p432(C,B).
b799(A,B):-move_right(A,C),b799_1(C,B).
b799_1(A,B):-p35(A,C),p142_1(C,B).
b800(A,B):-p1650(A,C),p832(C,B).
b794(A,B):-p880(A,C),b794_1(C,B).
b794_1(A,B):-p1994(A,C),p1147(C,B).
b801(A,B):-move_right(A,C),b801_1(C,B).
b801_1(A,B):-p1201(A,C),p138(C,B).
b805(A,B):-p508(A,C),p1273_2(C,B).
b806(A,B):-p869(A,C),p140(C,B).
b803(A,B):-move_left(A,C),b803_1(C,B).
b803_1(A,B):-p1278(A,C),p1197_1(C,B).
b783(A,B):-p266(A,C),b783_1(C,B).
b783_1(A,B):-p1904(A,C),p1754(C,B).
b804(A,B):-move_right(A,C),b804_1(C,B).
b804_1(A,B):-p155(A,C),p5_2(C,B).
b807(A,B):-move_left(A,C),b807_1(C,B).
b807_1(A,B):-p934(A,C),p703_1(C,B).
b793(A,B):-p395(A,C),b793_1(C,B).
b793_1(A,B):-p765(A,C),p753_2(C,B).
b809(A,B):-p1660(A,C),p395(C,B).
b811(A,B):-move_forwards(A,C),b811_1(C,B).
b811_1(A,B):-p1859(A,C),p627(C,B).
b792(A,B):-p621(A,C),b792_1(C,B).
b792_1(A,B):-p174_1(A,C),p1014_2(C,B).
b808(A,B):-move_right(A,C),b808_1(C,B).
b808_1(A,B):-p577_1(A,C),p527_2(C,B).
b816(A,B):-p1129(A,C),p1858_1(C,B).
b814(A,B):-move_backwards(A,C),b814_1(C,B).
b814_1(A,B):-p1636(A,C),p286_2(C,B).
b818(A,B):-move_left(A,C),b818_1(C,B).
b818_1(A,B):-p35(A,C),p912_1(C,B).
b802(A,B):-p230_1(A,C),b802_1(C,B).
b802_1(A,B):-p537(A,C),p266(C,B).
b819(A,B):-move_forwards(A,C),b819_1(C,B).
b819_1(A,B):-p1365(A,C),p1931(C,B).
b817(A,B):-move_right(A,C),b817_1(C,B).
b817_1(A,B):-p1194_1(A,C),p741(C,B).
b822(A,B):-p496(A,C),p144_1(C,B).
b823(A,B):-p1324(A,C),p1559(C,B).
b824(A,B):-p189(A,C),p1368(C,B).
b813(A,B):-p230_1(A,C),b813_1(C,B).
b813_1(A,B):-p49(A,C),p321_2(C,B).
b810(A,B):-p432(A,C),b810_1(C,B).
b810_1(A,B):-p644(A,C),move_right(C,B).
b825(A,B):-p920(A,C),p1392_1(C,B).
b828(A,B):-move_backwards(A,C),p595_2(C,B).
b829(A,B):-p1437(A,B).
%timeout
b830(A,B):-p1433(A,C),p1676_2(C,B).
b826(A,B):-move_backwards(A,C),b826_1(C,B).
b826_1(A,B):-p189_1(A,C),p18(C,B).
...
b862(A,B):-p1348(A,C),p1695_1(C,B).
b858(A,B):-move_left(A,C),b858_1(C,B).
b858_1(A,B):-p1487(A,C),p869(C,B).
b864(A,B):-move_left(A,C),p1994_1(C,B).
b863(A,B):-p971(A,C),p741(C,B).
b838(A,B):-p1129(A,C),b838_1(C,B).
b838_1(A,B):-p656(A,C),p453_2(C,B).
b866(A,B):-move_left(A,C),b866_1(C,B).
b866_1(A,B):-p905(A,C),p1348(C,B).
b865(A,B):-move_right(A,C),b865_1(C,B).
b865_1(A,B):-p70(A,C),move_right(C,B).
...
b868_1(A,B):-p535(A,C),p640(C,B).
b873(A,B):-move_left(A,C),p1110_2(C,B).
b869(A,B):-move_backwards(A,C),b869_1(C,B).
b869_1(A,B):-p1197(A,C),p1371(C,B).
b874(A,B):-p876(A,C),p395(C,B).
b872(A,B):-p334_1(A,C),p656_1(C,B).
b875(A,B):-move_left(A,C),b875_1(C,B).
b875_1(A,B):-p1521_1(A,C),p1460_2(C,B).
b878(A,B):-move_forwards(A,C),p1618(C,B).
b879(A,B):-move_right(A,C),b879_1(C,B).
b879_1(A,B):-p1713(A,C),p1931(C,B).
b860(A,B):-p604(A,C),b860_1(C,B).
b860_1(A,B):-p488(A,C),p266(C,B).
b881(A,B):-p114(A,C),p1365_1(C,B).
b880(A,B):-p834(A,C),p230_1(C,B).
b882(A,B):-p1147_1(A,C),p725_1(C,B).
b883(A,B):-move_left(A,C),p1830(C,B).
b885(A,B):-p326(A,C),p880(C,B).
b861(A,B):-p230(A,C),b861_1(C,B).
b861_1(A,B):-p570(A,C),move_right(C,B).
b887(A,B):-p249(A,C),p508_1(C,B).
b841(A,B):-p1271(A,C),b841_1(C,B).
b841_1(A,B):-p1590_1(A,C),p140_1(C,B).
b889(A,B):-p23(A,B).
b890(A,B):-p1616(A,C),p609_1(C,B).
b891(A,B):-p395(A,C),p1878_1(C,B).
b892(A,B):-p249(A,C),p882_1(C,B).
b876(A,B):-p800(A,C),b876_1(C,B).
b876_1(A,B):-p802_1(A,C),p554(C,B).
b894(A,B):-move_forwards(A,C),p150_1(C,B).
b888(A,B):-move_left(A,C),b888_1(C,B).
b888_1(A,B):-p1551(A,C),p688_1(C,B).
b884(A,B):-p621(A,C),b884_1(C,B).
b884_1(A,B):-p1406_1(A,C),p1911(C,B).
b895(A,B):-move_right(A,C),b895_1(C,B).
b895_1(A,B):-p1726(A,C),p746_1(C,B).
b898(A,B):-p1271(A,C),p107_1(C,B).
b886(A,B):-p395(A,C),b886_1(C,B).
b886_1(A,B):-p456_1(A,C),p1230(C,B).
b900(A,B):-p1845(A,C),move_forwards(C,B).
b901(A,B):-move_left(A,C),p1757(C,B).
b896(A,B):-move_backwards(A,C),b896_1(C,B).
b896_1(A,B):-p700(A,C),p138(C,B).
b903(A,B):-p759(A,C),move_forwards(C,B).
b902(A,B):-move_left(A,C),b902_1(C,B).
b902_1(A,B):-p1607_1(A,C),p1787(C,B).
b905(A,B):-p271_1(A,C),p1871_1(C,B).
b906(A,B):-p52_1(A,C),p761_1(C,B).
...
b910(A,B):-p65(A,B).
b899(A,B):-p135_1(A,C),b899_1(C,B).
b899_1(A,B):-p277_1(A,C),p349_1(C,B).
b912(A,B):-move_right(A,C),p994_1(C,B).
b913(A,B):-p1144(A,B).
b907(A,B):-move_forwards(A,C),b907_1(C,B).
b907_1(A,B):-p1420(A,C),move_forwards(C,B).
b911(A,B):-p1129(A,C),b911_1(C,B).
b911_1(A,B):-p448(A,C),p1707_2(C,B).
b893(A,B):-p1048(A,C),b893_1(C,B).
b893_1(A,B):-p549(A,C),p800(C,B).
b917(A,B):-move_right(A,C),b917_1(C,B).
b917_1(A,B):-p508_1(A,C),p582(C,B).
b915(A,B):-p621(A,C),b915_1(C,B).
b915_1(A,B):-p49_1(A,C),p746_1(C,B).
b897(A,B):-p1521(A,C),b897_1(C,B).
b897_1(A,B):-move_forwards(A,C),p1558_1(C,B).
b920(A,B):-p700(A,C),p1559(C,B).
b914(A,B):-p432(A,C),b914_1(C,B).
b914_1(A,B):-p545(A,C),p1487_1(C,B).
b918(A,B):-p1348(A,C),b918_1(C,B).
b918_1(A,B):-p35(A,C),p800_1(C,B).
b923(A,B):-p230(A,C),p74_1(C,B).
...
b925_1(A,B):-p934(A,C),p190_2(C,B).
b928(A,B):-move_forwards(A,C),p107_1(C,B).
b929(A,B):-p197(A,C),p634(C,B).
b921(A,B):-move_left(A,C),b921_1(C,B).
b921_1(A,B):-p174_1(A,C),p10_2(C,B).
b930(A,B):-p295(A,C),p784_2(C,B).
b932(A,B):-p35(A,C),p26_1(C,B).
b931(A,B):-move_left(A,C),b931_1(C,B).
b931_1(A,B):-p686(A,C),p1348(C,B).
b934(A,B):-move_forwards(A,C),p1859(C,B).
b935(A,B):-p187(A,C),p1368(C,B).
b936(A,B):-p1356(A,C),p860(C,B).
b937(A,B):-p593(A,C),p1438_2(C,B).
b916(A,B):-p266(A,C),b916_1(C,B).
b916_1(A,B):-p1299(A,C),p1075_1(C,B).
b938(A,B):-p381(A,C),p800_1(C,B).
b939(A,B):-move_left(A,C),b939_1(C,B).
b939_1(A,B):-p545(A,C),p1538(C,B).
b927(A,B):-p135_1(A,C),b927_1(C,B).
b927_1(A,B):-p1905_1(A,C),p1898(C,B).
b940(A,B):-move_right(A,C),b940_1(C,B).
b940_1(A,B):-p1356(A,C),p1144(C,B).
b919(A,B):-p366(A,C),b919_1(C,B).
b919_1(A,B):-p216(A,C),p624(C,B).
b943(A,B):-p1686(A,C),p144_1(C,B).
b945(A,B):-move_right(A,C),p1988_1(C,B).
b941(A,B):-move_left(A,C),b941_1(C,B).
b941_1(A,B):-p860(A,C),p395(C,B).
b933(A,B):-p114(A,C),b933_1(C,B).
b933_1(A,B):-p448_1(A,C),p479_1(C,B).
b947(A,B):-p1272(A,C),p800_1(C,B).
b949(A,B):-p1758(A,B).
b942(A,B):-move_backwards(A,C),b942_1(C,B).
b942_1(A,B):-p271_1(A,C),p1059_1(C,B).
b944(A,B):-move_left(A,C),b944_1(C,B).
b944_1(A,B):-p832(A,C),p741(C,B).
b952(A,B):-p249(A,C),p55(C,B).
b953(A,B):-move_right(A,C),p1902_1(C,B).
b951(A,B):-p793(A,C),p230_1(C,B).
b955(A,B):-p621(A,C),p1394(C,B).
b956(A,B):-p74_1(A,C),p1380(C,B).
...
b958(A,B):-p380(A,C),p1526(C,B).
b959(A,B):-p280(A,C),move_right(C,B).
b961(A,B):-move_forwards(A,C),p1069(C,B).
b948(A,B):-p1607(A,C),b948_1(C,B).
b948_1(A,B):-p1299(A,C),p1346_1(C,B).
b963(A,B):-move_forwards(A,C),b963_1(C,B).
b963_1(A,B):-p35_1(A,C),p920_1(C,B).
...
b977(A,B):-p249(A,C),p636_1(C,B).
b978(A,B):-p1194(A,C),move_left(C,B).
b979(A,B):-move_backwards(A,C),p1246_2(C,B).
b975(A,B):-move_backwards(A,C),b975_1(C,B).
b975_1(A,B):-p1905(A,C),p967_1(C,B).
b981(A,B):-p395(A,C),p1961_1(C,B).
b982(A,B):-p249(A,C),p83(C,B).
b983(A,B):-p1348(A,B).
b974(A,B):-p880(A,C),b974_1(C,B).
b974_1(A,B):-p35(A,C),p557_1(C,B).
...
b986_1(A,B):-p1624(A,C),p535_1(C,B).
b984(A,B):-move_right(A,C),b984_1(C,B).
b984_1(A,B):-p1036_1(A,C),p432(C,B).
b990(A,B):-move_right(A,C),p1739_1(C,B).
b976(A,B):-p135_1(A,C),b976_1(C,B).
b976_1(A,B):-p420(A,C),move_right(C,B).
b991(A,B):-p21(A,C),p426_1(C,B).
b992(A,B):-move_right(A,C),b992_1(C,B).
b992_1(A,B):-p134(A,C),move_right(C,B).
b989(A,B):-move_backwards(A,C),b989_1(C,B).
b989_1(A,B):-p984_1(A,C),p1987_2(C,B).
b994(A,B):-move_backwards(A,C),b994_1(C,B).
b994_1(A,B):-p1753(A,C),move_backwards(C,B).
b993(A,B):-move_right(A,C),b993_1(C,B).
b993_1(A,B):-p174_1(A,C),p1360_2(C,B).
b996(A,B):-p1636(A,C),p1147_1(C,B).
b995(A,B):-move_left(A,C),b995_1(C,B).
b995_1(A,B):-p1743(A,C),p1897_1(C,B).
b997(A,B):-p545(A,C),p811_1(C,B).
b999(A,B):-p230(A,C),p1517_1(C,B).
b877(A,B):-move_left(A,C),b877_1(C,B).
b877_1(A,B):-p1616(A,C),b877_2(C,B).
b877_2(A,B):-grab_ball(A,C),p1911_1(C,B).
b988(A,B):-p1197_1(A,C),b988_1(C,B).
b988_1(A,B):-p53_1(A,C),p426(C,B).
b998(A,B):-move_forwards(A,C),b998_1(C,B).
b998_1(A,B):-p1796(A,C),p1839_1(C,B).
b684(A,B):-move_backwards(A,C),b684_1(C,B).
b684_1(A,B):-p520(A,C),b684_2(C,B).
b684_2(A,B):-p1208_1(A,C),p257(C,B).
b789(A,B):-move_right(A,C),b789_1(C,B).
b789_1(A,B):-p1341(A,C),b789_2(C,B).
b789_2(A,B):-p12_1(A,C),p135(C,B).
b855(A,B):-move_left(A,C),b855_1(C,B).
b855_1(A,B):-p35(A,C),b855_2(C,B).
b855_2(A,B):-p155_1(A,C),p123_2(C,B).
b820(A,B):-move_left(A,C),b820_1(C,B).
b820_1(A,B):-p295(A,C),b820_2(C,B).
b820_2(A,B):-p627(A,C),p973_2(C,B).
%timeout
% num solved 998
true.

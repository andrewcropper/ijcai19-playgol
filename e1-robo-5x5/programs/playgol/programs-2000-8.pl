...
% asserting p1999_1/2
% asserting p1999/2
b8(A,B):-move_forwards(A,C),p699_1(C,B).
b2(A,B):-p1855(A,C),p1033(C,B).
b3(A,B):-p809(A,C),p1994(C,B).
b9(A,B):-p1184(A,C),p1434_2(C,B).
b0(A,B):-p1184(A,C),p1080_2(C,B).
b1(A,B):-p1911_1(A,C),p622(C,B).
b6(A,B):-p470(A,C),p179(C,B).
b10(A,B):-move_left(A,C),b10_1(C,B).
b10_1(A,B):-p146(A,C),move_backwards(C,B).
b17(A,B):-move_right(A,B).
b15(A,B):-p28(A,C),p1265(C,B).
b13(A,B):-p68(A,C),p64_1(C,B).
b4(A,B):-p63(A,C),b4_1(C,B).
b4_1(A,B):-p1336(A,C),p836(C,B).
b21(A,B):-p1903(A,B).
b22(A,B):-move_forwards(A,C),p105(C,B).
b23(A,B):-p281(A,C),p1625(C,B).
b20(A,B):-move_right(A,C),b20_1(C,B).
b20_1(A,B):-p191(A,C),p74_1(C,B).
b25(A,B):-p1497(A,C),p278(C,B).
b7(A,B):-move_right(A,C),b7_1(C,B).
b7_1(A,B):-p742_1(A,C),p672_1(C,B).
b19(A,B):-move_backwards(A,C),b19_1(C,B).
b19_1(A,B):-p242(A,C),p804(C,B).
b27(A,B):-p720_1(A,C),p449(C,B).
b29(A,B):-p112(A,C),p941_1(C,B).
b11(A,B):-p57(A,C),b11_1(C,B).
b11_1(A,B):-p653(A,C),p1577_1(C,B).
b31(A,B):-move_forwards(A,C),p1687_1(C,B).
b32(A,B):-p63(A,C),p1090_1(C,B).
b12(A,B):-p453(A,C),b12_1(C,B).
b12_1(A,B):-p252(A,C),p1062_1(C,B).
b34(A,B):-p1683(A,C),p1049(C,B).
b35(A,B):-move_forwards(A,C),p1046(C,B).
b26(A,B):-move_forwards(A,C),b26_1(C,B).
b26_1(A,B):-p1082_1(A,C),p117(C,B).
b37(A,B):-p57(A,C),p1699(C,B).
b38(A,B):-p560_1(A,C),p1687_1(C,B).
b30(A,B):-move_right(A,C),b30_1(C,B).
b30_1(A,B):-p1370(A,C),p804(C,B).
b39(A,B):-p1223(A,C),p1108_1(C,B).
b14(A,B):-p57(A,C),b14_1(C,B).
b14_1(A,B):-p960(A,C),p922_1(C,B).
b41(A,B):-p670(A,C),p560(C,B).
b18(A,B):-p213_1(A,C),b18_1(C,B).
b18_1(A,B):-p664_1(A,C),p1033_2(C,B).
b33(A,B):-move_forwards(A,C),b33_1(C,B).
b33_1(A,B):-p1195(A,C),p436_1(C,B).
b16(A,B):-p453(A,C),b16_1(C,B).
b16_1(A,B):-p419(A,C),p1715(C,B).
b45(A,B):-p400(A,C),p1127_2(C,B).
b36(A,B):-move_right(A,C),b36_1(C,B).
b36_1(A,B):-p1102(A,C),p646(C,B).
b40(A,B):-move_right(A,C),b40_1(C,B).
b40_1(A,B):-p400(A,C),p121_2(C,B).
b47(A,B):-p1485(A,C),p436_1(C,B).
b24(A,B):-p560(A,C),b24_1(C,B).
b24_1(A,B):-p170_1(A,C),move_forwards(C,B).
b51(A,B):-move_left(A,C),p606(C,B).
b48(A,B):-p399(A,C),p281(C,B).
b53(A,B):-move_left(A,B).
b54(A,B):-move_left(A,C),p1190(C,B).
b52(A,B):-p1062_1(A,C),p1982_1(C,B).
b56(A,B):-p654(A,B).
b46(A,B):-move_left(A,C),b46_1(C,B).
b46_1(A,B):-p1911_1(A,C),p1067_1(C,B).
b28(A,B):-p64_1(A,C),b28_1(C,B).
b28_1(A,B):-p116(A,C),p576(C,B).
b44(A,B):-move_backwards(A,C),b44_1(C,B).
b44_1(A,B):-p584(A,C),p1557(C,B).
b49(A,B):-move_left(A,C),b49_1(C,B).
b49_1(A,B):-p285(A,C),p289_1(C,B).
b60(A,B):-p392(A,C),p1126(C,B).
b62(A,B):-move_right(A,C),p4(C,B).
b61(A,B):-p285(A,C),p260_2(C,B).
b64(A,B):-p633(A,C),p1722(C,B).
b65(A,B):-p1855(A,B).
b50(A,B):-move_left(A,C),b50_1(C,B).
b50_1(A,B):-p69_1(A,C),p136_1(C,B).
b43(A,B):-p392(A,C),b43_1(C,B).
b43_1(A,B):-p1020(A,C),p428(C,B).
b66(A,B):-p1223(A,C),p1291_1(C,B).
b68(A,B):-move_left(A,C),b68_1(C,B).
b68_1(A,B):-p1598(A,C),p859_1(C,B).
b55(A,B):-p63(A,C),b55_1(C,B).
b55_1(A,B):-p469(A,C),p720_1(C,B).
b71(A,B):-p64_1(A,C),p91_1(C,B).
b72(A,B):-p1317(A,C),p1262_1(C,B).
b73(A,B):-p266(A,C),p1541_1(C,B).
b67(A,B):-move_forwards(A,C),b67_1(C,B).
b67_1(A,B):-p345(A,C),p669(C,B).
b69(A,B):-move_backwards(A,C),b69_1(C,B).
b69_1(A,B):-p1662(A,C),move_forwards(C,B).
b76(A,B):-p622_1(A,C),p1652_1(C,B).
b42(A,B):-p213_1(A,C),b42_1(C,B).
b42_1(A,B):-p255_1(A,C),p1015_1(C,B).
b78(A,B):-p213(A,C),p1213(C,B).
b79(A,B):-p456(A,C),p117(C,B).
b74(A,B):-move_forwards(A,C),b74_1(C,B).
b74_1(A,B):-p1950(A,C),p1304(C,B).
b80(A,B):-p340(A,C),p117_1(C,B).
b77(A,B):-move_forwards(A,C),b77_1(C,B).
b77_1(A,B):-p421(A,C),move_right(C,B).
b83(A,B):-p1643(A,C),move_backwards(C,B).
b84(A,B):-move_left(A,C),b84_1(C,B).
b84_1(A,B):-p1598(A,C),p859_1(C,B).
b70(A,B):-p560_1(A,C),b70_1(C,B).
b70_1(A,B):-p1905_1(A,C),p1280_1(C,B).
b5(A,B):-p442_2(A,C),b5_1(C,B).
b5_1(A,B):-p1503(A,C),p626(C,B).
b86(A,B):-p57(A,C),b86_1(C,B).
b86_1(A,B):-p950(A,C),p1693_1(C,B).
b58(A,B):-p366(A,C),b58_1(C,B).
b58_1(A,B):-p1557(A,C),p886_2(C,B).
b82(A,B):-p63(A,C),b82_1(C,B).
b82_1(A,B):-p329(A,C),p1557(C,B).
b57(A,B):-p619(A,C),b57_1(C,B).
b57_1(A,B):-p1528(A,C),p227_2(C,B).
b85(A,B):-move_backwards(A,C),b85_1(C,B).
b85_1(A,B):-p1530(A,C),p924(C,B).
b90(A,B):-p1092(A,C),p57(C,B).
b93(A,B):-p1061(A,B).
b91(A,B):-p633(A,C),p1569_1(C,B).
b88(A,B):-move_backwards(A,C),b88_1(C,B).
b88_1(A,B):-p838(A,C),p1238(C,B).
b96(A,B):-p179(A,C),p1008(C,B).
b89(A,B):-move_backwards(A,C),b89_1(C,B).
b89_1(A,B):-p1716(A,C),p278(C,B).
b63(A,B):-p560_1(A,C),b63_1(C,B).
b63_1(A,B):-p781(A,C),p378(C,B).
b92(A,B):-move_left(A,C),b92_1(C,B).
b92_1(A,B):-p579_1(A,C),p933(C,B).
...
b98_1(A,B):-p729(A,C),p1476_1(C,B).
b100(A,B):-move_left(A,C),b100_1(C,B).
b100_1(A,B):-p1122(A,C),p1722_1(C,B).
b103(A,B):-p1505(A,C),p1894(C,B).
b101(A,B):-move_left(A,C),b101_1(C,B).
b101_1(A,B):-p1497(A,C),p507(C,B).
b105(A,B):-p1326(A,C),p939_1(C,B).
b107(A,B):-p1395(A,C),p1144(C,B).
b106(A,B):-p269_2(A,C),p701(C,B).
b109(A,B):-move_left(A,B).
b110(A,B):-p912_1(A,B).
b108(A,B):-p453(A,C),p1955(C,B).
b111(A,B):-p57(A,C),p1336_1(C,B).
b112(A,B):-p146(A,C),p117_1(C,B).
b81(A,B):-p213_1(A,C),b81_1(C,B).
b81_1(A,B):-p1270(A,C),p1614_2(C,B).
b115(A,B):-p622(A,C),p1140(C,B).
b114(A,B):-p1409(A,C),p1160(C,B).
b117(A,B):-p1402_2(A,B).
b113(A,B):-p814_1(A,C),p457(C,B).
b118(A,B):-p191(A,C),p1557(C,B).
b116(A,B):-p1029(A,C),p479_2(C,B).
b121(A,B):-p1062_1(A,B).
b102(A,B):-move_forwards(A,C),b102_1(C,B).
b102_1(A,B):-p83_1(A,C),p1652_2(C,B).
b123(A,B):-p428(A,B).
b124(A,B):-p278(A,B).
b122(A,B):-p560_1(A,C),p1843_1(C,B).
b120(A,B):-p309_1(A,C),p795_1(C,B).
b119(A,B):-p255_1(A,C),p939_2(C,B).
b97(A,B):-p57(A,C),b97_1(C,B).
b97_1(A,B):-p1527(A,C),p1661_1(C,B).
b104(A,B):-move_forwards(A,C),b104_1(C,B).
b104_1(A,B):-p1451(A,C),p117_1(C,B).
b130(A,B):-p640(A,C),p1825(C,B).
b87(A,B):-p1144(A,C),b87_1(C,B).
b87_1(A,B):-p421_1(A,C),p56(C,B).
...
b133_1(A,B):-p1817(A,C),p146(C,B).
b136(A,B):-p255(A,C),p208_2(C,B).
b137(A,B):-p912(A,C),p856(C,B).
b129(A,B):-move_forwards(A,C),b129_1(C,B).
b129_1(A,B):-p10_1(A,C),p64_1(C,B).
b139(A,B):-p1392(A,C),p755_2(C,B).
b75(A,B):-p442_2(A,C),b75_1(C,B).
b75_1(A,B):-p526_1(A,C),p287(C,B).
b140(A,B):-p1184(A,C),p1788_1(C,B).
b141(A,B):-p68(A,C),p1336_1(C,B).
b125(A,B):-p57(A,C),b125_1(C,B).
b125_1(A,B):-p819(A,C),p122(C,B).
b142(A,B):-move_left(A,C),b142_1(C,B).
b142_1(A,B):-p556(A,C),p1567_1(C,B).
b146(A,B):-p392(A,C),p284(C,B).
b147(A,B):-p428(A,C),p93_1(C,B).
b148(A,B):-p1166(A,C),p359_1(C,B).
b138(A,B):-move_forwards(A,C),b138_1(C,B).
b138_1(A,B):-p1029_1(A,C),p1167_2(C,B).
b132(A,B):-p57(A,C),b132_1(C,B).
b132_1(A,B):-p820(A,C),p1144(C,B).
b151(A,B):-move_right(A,C),p157(C,B).
b144(A,B):-move_forwards(A,C),b144_1(C,B).
b144_1(A,B):-p1528_1(A,C),p1531_1(C,B).
b152(A,B):-move_left(A,C),b152_1(C,B).
b152_1(A,B):-p285_1(A,C),p1370_2(C,B).
b154(A,B):-p1557(A,B).
b155(A,B):-p1992(A,C),p1578(C,B).
b156(A,B):-p281(A,C),p1604_1(C,B).
b59(A,B):-p227(A,C),b59_1(C,B).
b59_1(A,B):-p350(A,C),p1167_2(C,B).
b158(A,B):-p281(A,C),p253_1(C,B).
b153(A,B):-p63(A,C),b153_1(C,B).
b153_1(A,B):-p400(A,C),p925_2(C,B).
b149(A,B):-p57(A,C),b149_1(C,B).
b149_1(A,B):-p1420(A,C),p1855(C,B).
b161(A,B):-move_left(A,C),b161_1(C,B).
b161_1(A,B):-p1817(A,C),p1393(C,B).
b159(A,B):-p281(A,C),b159_1(C,B).
b159_1(A,B):-p32_1(A,C),p416_2(C,B).
b127(A,B):-p198(A,C),b127_1(C,B).
b127_1(A,B):-p687_1(A,C),p771(C,B).
b162(A,B):-p662(A,C),b162_1(C,B).
b162_1(A,B):-p1420(A,C),p390_1(C,B).
b131(A,B):-p1393(A,C),b131_1(C,B).
b131_1(A,B):-p1905_1(A,C),p1033_2(C,B).
b164(A,B):-move_right(A,C),b164_1(C,B).
b164_1(A,B):-p112(A,C),p1262_1(C,B).
b166(A,B):-p622_1(A,C),p1538(C,B).
b168(A,B):-move_right(A,C),p240(C,B).
b167(A,B):-p1291(A,C),p8(C,B).
b170(A,B):-p622_1(A,C),p927_1(C,B).
b169(A,B):-p960(A,C),p57(C,B).
b171(A,B):-p64_1(A,C),p112_1(C,B).
b172(A,B):-p742(A,C),p1438(C,B).
b174(A,B):-p453(A,C),p730_2(C,B).
b163(A,B):-p117(A,C),b163_1(C,B).
b163_1(A,B):-p1584(A,C),p453(C,B).
b176(A,B):-p1745(A,C),p619(C,B).
b177(A,B):-p100(A,C),p538(C,B).
b178(A,B):-p560_1(A,C),p1977(C,B).
b179(A,B):-p622_1(A,C),p1082_1(C,B).
b175(A,B):-move_left(A,C),b175_1(C,B).
b175_1(A,B):-p1082_1(A,C),p1146(C,B).
b145(A,B):-p633_1(A,C),b145_1(C,B).
b145_1(A,B):-p1682(A,C),p1291_1(C,B).
b182(A,B):-move_forwards(A,C),p1146_1(C,B).
b160(A,B):-p5(A,C),b160_1(C,B).
b160_1(A,B):-p881(A,C),p619(C,B).
b173(A,B):-p622_1(A,C),b173_1(C,B).
b173_1(A,B):-p471(A,C),p213_1(C,B).
b180(A,B):-move_left(A,C),b180_1(C,B).
b180_1(A,B):-p456(A,C),p35(C,B).
b186(A,B):-p653(A,C),p699_2(C,B).
b183(A,B):-move_forwards(A,C),b183_1(C,B).
b183_1(A,B):-p1876(A,C),p170_2(C,B).
b184(A,B):-move_left(A,C),b184_1(C,B).
b184_1(A,B):-p366_1(A,C),p33_2(C,B).
b189(A,B):-move_right(A,C),p56(C,B).
...
b193(A,B):-p101(A,B).
b194(A,B):-move_forwards(A,C),p442_1(C,B).
b190(A,B):-move_right(A,C),b190_1(C,B).
b190_1(A,B):-p1420(A,C),p1107_1(C,B).
b188(A,B):-move_left(A,C),b188_1(C,B).
b188_1(A,B):-p400_1(A,C),p1839_1(C,B).
b197(A,B):-p281(A,C),p977_1(C,B).
b196(A,B):-p179(A,C),p856_1(C,B).
b192(A,B):-move_right(A,C),b192_1(C,B).
b192_1(A,B):-p793(A,C),p117_1(C,B).
b199(A,B):-p83_1(A,C),p23_2(C,B).
b200(A,B):-p428(A,C),p1213_1(C,B).
b201(A,B):-p1549(A,C),p63(C,B).
b191(A,B):-move_right(A,C),b191_1(C,B).
b191_1(A,B):-p805(A,C),p1577(C,B).
b203(A,B):-p63(A,C),b203_1(C,B).
b203_1(A,B):-p1014(A,C),p402_1(C,B).
b205(A,B):-p64_1(A,B).
b195(A,B):-move_forwards(A,C),b195_1(C,B).
b195_1(A,B):-p1905_1(A,C),p1033_2(C,B).
b204(A,B):-move_backwards(A,C),b204_1(C,B).
b204_1(A,B):-p169(A,C),p496(C,B).
b206(A,B):-move_forwards(A,C),b206_1(C,B).
b206_1(A,B):-p419(A,C),p687_1(C,B).
b209(A,B):-p120(A,C),p302(C,B).
b210(A,B):-move_backwards(A,C),p1953_2(C,B).
b202(A,B):-p64_1(A,C),b202_1(C,B).
b202_1(A,B):-p368(A,C),p1315_1(C,B).
b198(A,B):-p392(A,C),b198_1(C,B).
b198_1(A,B):-p255_1(A,C),p212_2(C,B).
b212(A,B):-p26(A,C),p1110(C,B).
b207(A,B):-move_right(A,C),b207_1(C,B).
b207_1(A,B):-p814(A,C),p1309(C,B).
b157(A,B):-p1140(A,C),b157_1(C,B).
b157_1(A,B):-p66_1(A,C),p720_1(C,B).
b165(A,B):-p520(A,C),b165_1(C,B).
b165_1(A,B):-p1965(A,C),p64_1(C,B).
b217(A,B):-move_right(A,C),p1625(C,B).
b218(A,B):-p816(A,C),p905_1(C,B).
b214(A,B):-move_left(A,C),b214_1(C,B).
b214_1(A,B):-p1549(A,C),p560(C,B).
b213(A,B):-move_right(A,C),b213_1(C,B).
b213_1(A,B):-p269_2(A,C),p1485_2(C,B).
b221(A,B):-p446(A,C),p836(C,B).
b219(A,B):-p57(A,C),b219_1(C,B).
b219_1(A,B):-p690_1(A,C),p117_1(C,B).
b223(A,B):-p1326(A,C),p1213_1(C,B).
b224(A,B):-p57(A,C),p233_1(C,B).
b216(A,B):-move_backwards(A,C),b216_1(C,B).
b216_1(A,B):-p653(A,C),p535_2(C,B).
b222(A,B):-move_left(A,C),b222_1(C,B).
b222_1(A,B):-p1416(A,C),p662(C,B).
b227(A,B):-p57(A,B).
b226(A,B):-p1542(A,C),p264(C,B).
b228(A,B):-p1613(A,C),p730_1(C,B).
b230(A,B):-move_right(A,C),p1584(C,B).
b229(A,B):-p1082_1(A,C),p117_1(C,B).
b232(A,B):-move_forwards(A,C),p1107_1(C,B).
b233(A,B):-p918(A,C),p458_1(C,B).
b231(A,B):-move_left(A,C),b231_1(C,B).
b231_1(A,B):-p1567(A,C),p63(C,B).
b235(A,B):-p560_1(A,B).
b236(A,B):-p669(A,C),p698_1(C,B).
b150(A,B):-p1151(A,C),b150_1(C,B).
b150_1(A,B):-p747_1(A,C),p557_1(C,B).
b237(A,B):-p141(A,C),move_right(C,B).
b239(A,B):-p1689_2(A,C),p1388(C,B).
b215(A,B):-p64_1(A,C),b215_1(C,B).
b215_1(A,B):-p368(A,C),p1077_1(C,B).
b225(A,B):-p392(A,C),b225_1(C,B).
b225_1(A,B):-p170_1(A,C),p266(C,B).
b242(A,B):-move_backwards(A,C),p1336_1(C,B).
b208(A,B):-p816(A,C),b208_1(C,B).
b208_1(A,B):-p28(A,C),p1274(C,B).
b243(A,B):-p117_1(A,C),p1394(C,B).
b238(A,B):-p392(A,C),b238_1(C,B).
b238_1(A,B):-p742(A,C),p437(C,B).
b246(A,B):-p191(A,C),p1505(C,B).
b247(A,B):-p1768(A,B).
b245(A,B):-move_right(A,C),b245_1(C,B).
b245_1(A,B):-p610(A,C),p493_2(C,B).
b240(A,B):-p63(A,C),b240_1(C,B).
b240_1(A,B):-p1824(A,C),p836(C,B).
b234(A,B):-move_backwards(A,C),b234_1(C,B).
b234_1(A,B):-p1977(A,C),p64_1(C,B).
b251(A,B):-p622_1(A,C),p1715_1(C,B).
b244(A,B):-move_right(A,C),b244_1(C,B).
b244_1(A,B):-p639_1(A,C),p1259_1(C,B).
b248(A,B):-move_forwards(A,C),b248_1(C,B).
b248_1(A,B):-p1343_1(A,C),p179(C,B).
b252(A,B):-move_right(A,C),b252_1(C,B).
b252_1(A,B):-p908(A,C),p660_2(C,B).
...
b241(A,B):-p392(A,C),b241_1(C,B).
b241_1(A,B):-p19(A,C),p333(C,B).
b256(A,B):-p463_1(A,C),p1692_1(C,B).
b259(A,B):-move_left(A,C),p1951(C,B).
b257(A,B):-p854(A,C),p172_1(C,B).
b260(A,B):-move_left(A,C),b260_1(C,B).
b260_1(A,B):-grab_ball(A,C),p507(C,B).
b220(A,B):-p1557(A,C),b220_1(C,B).
b220_1(A,B):-p327_1(A,C),p59_1(C,B).
b255(A,B):-move_backwards(A,C),b255_1(C,B).
b255_1(A,B):-p1253(A,C),p902(C,B).
b263(A,B):-p424(A,C),p1107_1(C,B).
b265(A,B):-p716(A,C),p1475(C,B).
b266(A,B):-p698_1(A,C),p1285(C,B).
b267(A,B):-p1528(A,C),p633_1(C,B).
b268(A,B):-p865(A,C),p622(C,B).
b264(A,B):-p281(A,C),b264_1(C,B).
b264_1(A,B):-p12(A,C),p278(C,B).
b270(A,B):-p622_1(A,C),p1710(C,B).
b271(A,B):-move_forwards(A,C),b271_1(C,B).
b271_1(A,B):-p255(A,C),p370_2(C,B).
b261(A,B):-p120(A,C),b261_1(C,B).
b261_1(A,B):-p1752(A,C),p0_2(C,B).
...
b273(A,B):-p1654(A,C),p442_2(C,B).
b258(A,B):-p442_2(A,C),b258_1(C,B).
b258_1(A,B):-p526_1(A,C),p287(C,B).
b262(A,B):-p720_1(A,C),b262_1(C,B).
b262_1(A,B):-p747_1(A,C),p886_1(C,B).
b272(A,B):-p453(A,C),b272_1(C,B).
b272_1(A,B):-p70(A,C),p619(C,B).
b278(A,B):-move_left(A,C),b278_1(C,B).
b278_1(A,B):-p1752(A,C),p1325(C,B).
b253(A,B):-p428(A,C),b253_1(C,B).
b253_1(A,B):-p865_1(A,C),p576(C,B).
b280(A,B):-p120(A,C),p1342_1(C,B).
b282(A,B):-p469(A,C),p720(C,B).
b269(A,B):-p1144(A,C),b269_1(C,B).
b269_1(A,B):-p990_1(A,C),p924(C,B).
b277(A,B):-p63(A,C),b277_1(C,B).
b277_1(A,B):-p566(A,C),p391_2(C,B).
b285(A,B):-p755_2(A,C),p451(C,B).
b283(A,B):-move_forwards(A,C),b283_1(C,B).
b283_1(A,B):-p957(A,C),p1833(C,B).
...
b286_1(A,B):-p255(A,C),p492_2(C,B).
b287(A,B):-move_right(A,C),b287_1(C,B).
b287_1(A,B):-p771(A,C),p117(C,B).
b291(A,B):-p57(A,C),p1693_1(C,B).
b292(A,B):-p1951(A,C),p1309_1(C,B).
b290(A,B):-p656(A,C),p117_1(C,B).
b294(A,B):-p854(A,C),p641_1(C,B).
b288(A,B):-move_forwards(A,C),b288_1(C,B).
b288_1(A,B):-p918(A,C),p1038(C,B).
b295(A,B):-p198(A,C),p989(C,B).
b279(A,B):-p392(A,C),b279_1(C,B).
b279_1(A,B):-p1878_1(A,C),p676_2(C,B).
b298(A,B):-move_left(A,C),p343(C,B).
b299(A,B):-p452_1(A,B).
b297(A,B):-p436_1(A,C),p1607_1(C,B).
b300(A,B):-p436_1(A,C),p1036_1(C,B).
b302(A,B):-p392(A,C),p1437_1(C,B).
b303(A,B):-p720_1(A,B).
b304(A,B):-p278(A,C),p1646(C,B).
b305(A,B):-p57(A,B).
b306(A,B):-p392(A,C),p912_1(C,B).
b249(A,B):-p60(A,C),b249_1(C,B).
b249_1(A,B):-p481(A,C),p1326(C,B).
b296(A,B):-move_right(A,C),b296_1(C,B).
b296_1(A,B):-p1138(A,C),p1401(C,B).
b309(A,B):-p392(A,C),p77_1(C,B).
b276(A,B):-p179(A,C),b276_1(C,B).
b276_1(A,B):-p600(A,C),p461(C,B).
b311(A,B):-move_left(A,C),p94(C,B).
b312(A,B):-move_left(A,C),b312_1(C,B).
b312_1(A,B):-grab_ball(A,C),p56_1(C,B).
b284(A,B):-p496(A,C),b284_1(C,B).
b284_1(A,B):-p255_1(A,C),p69_2(C,B).
b289(A,B):-move_backwards(A,C),b289_1(C,B).
b289_1(A,B):-p1942(A,C),p914(C,B).
...
b314_1(A,B):-p350(A,C),p1873_2(C,B).
b320(A,B):-p1062_1(A,C),p881(C,B).
b316(A,B):-move_backwards(A,C),b316_1(C,B).
b316_1(A,B):-p625(A,C),p0(C,B).
b321(A,B):-p884(A,C),p669(C,B).
b323(A,B):-p1347(A,C),p1379_1(C,B).
b293(A,B):-p64_1(A,C),b293_1(C,B).
b293_1(A,B):-p168_1(A,C),p120(C,B).
b325(A,B):-move_backwards(A,C),p470_1(C,B).
b324(A,B):-p129_1(A,C),p1108(C,B).
b326(A,B):-move_left(A,C),b326_1(C,B).
b326_1(A,B):-p1744(A,C),p941_1(C,B).
b328(A,B):-p428(A,C),p1587(C,B).
b319(A,B):-move_backwards(A,C),b319_1(C,B).
b319_1(A,B):-p1006(A,C),p795_1(C,B).
b330(A,B):-move_forwards(A,C),p1259(C,B).
b329(A,B):-p1062_1(A,C),p1715(C,B).
b327(A,B):-move_right(A,C),b327_1(C,B).
b327_1(A,B):-p1975(A,C),p226_1(C,B).
b308(A,B):-move_right(A,C),b308_1(C,B).
b308_1(A,B):-p1439(A,C),p278(C,B).
b315(A,B):-p117_1(A,C),b315_1(C,B).
b315_1(A,B):-p168(A,C),p120(C,B).
b334(A,B):-p1529(A,C),p1029(C,B).
b332(A,B):-move_right(A,C),b332_1(C,B).
b332_1(A,B):-p242(A,C),p1846_2(C,B).
b335(A,B):-p1140(A,C),p656_1(C,B).
b336(A,B):-p168_1(A,C),p1438(C,B).
b338(A,B):-p392(A,C),p383_1(C,B).
b337(A,B):-p1687(A,C),p1265(C,B).
b307(A,B):-p436_1(A,C),b307_1(C,B).
b307_1(A,B):-p400(A,C),p714_1(C,B).
b341(A,B):-p291_1(A,C),p496(C,B).
b333(A,B):-p281(A,C),b333_1(C,B).
b333_1(A,B):-p1752(A,C),p227_2(C,B).
b342(A,B):-move_right(A,C),b342_1(C,B).
b342_1(A,B):-p1132(A,C),p1557(C,B).
b345(A,B):-p392(A,C),p1536(C,B).
b344(A,B):-p63(A,C),b344_1(C,B).
b344_1(A,B):-p32(A,C),p457_2(C,B).
b347(A,B):-p1304(A,B).
b348(A,B):-p1505(A,C),p1394(C,B).
b343(A,B):-p57(A,C),b343_1(C,B).
b343_1(A,B):-p51(A,C),p63(C,B).
b134(A,B):-move_left(A,C),b134_1(C,B).
b134_1(A,B):-p242(A,C),b134_2(C,B).
b134_2(A,B):-p1557(A,C),p1278_2(C,B).
b350(A,B):-p1246(A,C),p1448(C,B).
b339(A,B):-p3(A,C),b339_1(C,B).
b339_1(A,B):-p1985_1(A,C),p351(C,B).
b353(A,B):-p120(A,C),p869_1(C,B).
b354(A,B):-p1354(A,C),p1557(C,B).
b355(A,B):-p669(A,B).
b351(A,B):-p708(A,C),p816(C,B).
b357(A,B):-p117_1(A,C),p1804_1(C,B).
b356(A,B):-p669(A,C),p457(C,B).
b352(A,B):-move_right(A,C),b352_1(C,B).
b352_1(A,B):-p1632(A,C),p1596_1(C,B).
b322(A,B):-p1557(A,C),b322_1(C,B).
b322_1(A,B):-p1905_1(A,C),p1278_2(C,B).
b331(A,B):-p117(A,C),b331_1(C,B).
b331_1(A,B):-p1911_1(A,C),move_backwards(C,B).
b313(A,B):-p442_2(A,C),b313_1(C,B).
b313_1(A,B):-p350(A,C),p1044_2(C,B).
b363(A,B):-move_right(A,C),p253_1(C,B).
b361(A,B):-p649(A,C),p278(C,B).
b360(A,B):-move_left(A,C),b360_1(C,B).
b360_1(A,B):-p212(A,C),p281(C,B).
b366(A,B):-p633_1(A,C),p576(C,B).
b364(A,B):-move_right(A,C),b364_1(C,B).
b364_1(A,B):-p1227(A,C),p1536_2(C,B).
b368(A,B):-p375_1(A,C),p1092_1(C,B).
b369(A,B):-move_left(A,C),p1110_1(C,B).
b358(A,B):-move_left(A,C),b358_1(C,B).
b358_1(A,B):-p707_1(A,C),p656(C,B).
b365(A,B):-move_forwards(A,C),b365_1(C,B).
b365_1(A,B):-p1752(A,C),p552_1(C,B).
b372(A,B):-p3(A,C),p51(C,B).
b370(A,B):-p471_1(A,C),p560_1(C,B).
b373(A,B):-p633_1(A,C),p1574_1(C,B).
b375(A,B):-p535(A,C),p1825(C,B).
b359(A,B):-move_forwards(A,C),b359_1(C,B).
b359_1(A,B):-p168_1(A,C),p1062_1(C,B).
b377(A,B):-p392(A,C),p69(C,B).
b367(A,B):-move_left(A,C),b367_1(C,B).
b367_1(A,B):-p116_1(A,C),move_backwards(C,B).
b376(A,B):-p0_2(A,C),p1825(C,B).
b378(A,B):-p51(A,C),p453(C,B).
b381(A,B):-p179(A,B).
b374(A,B):-move_left(A,C),b374_1(C,B).
b374_1(A,B):-p1889(A,C),p229(C,B).
b380(A,B):-move_left(A,C),b380_1(C,B).
b380_1(A,B):-p157(A,C),p213_1(C,B).
b371(A,B):-move_right(A,C),b371_1(C,B).
b371_1(A,B):-p1905(A,C),p101_2(C,B).
b385(A,B):-move_left(A,C),p1484(C,B).
b386(A,B):-p281(A,C),p10_1(C,B).
b379(A,B):-move_left(A,C),b379_1(C,B).
b379_1(A,B):-p968(A,C),p1008_1(C,B).
b346(A,B):-p417(A,C),b346_1(C,B).
b346_1(A,B):-p328(A,C),p1274(C,B).
b388(A,B):-p865_1(A,C),p1144(C,B).
b389(A,B):-p381(A,C),p507(C,B).
b349(A,B):-p633_1(A,C),b349_1(C,B).
b349_1(A,B):-p1309(A,C),p74_1(C,B).
b390(A,B):-move_left(A,C),b390_1(C,B).
b390_1(A,B):-p255(A,C),p771_2(C,B).
b384(A,B):-move_left(A,C),b384_1(C,B).
b384_1(A,B):-p705_1(A,C),p830_1(C,B).
b383(A,B):-p63(A,C),b383_1(C,B).
b383_1(A,B):-p950(A,C),p1669_1(C,B).
b395(A,B):-p453(A,C),p1283(C,B).
b394(A,B):-p764_1(A,C),p1973(C,B).
b362(A,B):-p392(A,C),b362_1(C,B).
b362_1(A,B):-p255_1(A,C),p1614_2(C,B).
b391(A,B):-move_right(A,C),b391_1(C,B).
b391_1(A,B):-p95_1(A,C),p1710_1(C,B).
b399(A,B):-p83(A,C),p1131_2(C,B).
b398(A,B):-move_left(A,C),b398_1(C,B).
b398_1(A,B):-p419(A,C),p63(C,B).
b387(A,B):-p57(A,C),b387_1(C,B).
b387_1(A,B):-p1752(A,C),p496(C,B).
b400(A,B):-p669(A,C),p1661_1(C,B).
b402(A,B):-p57(A,C),p1092(C,B).
b404(A,B):-p30(A,C),p1082(C,B).
b401(A,B):-p66_1(A,C),p1128_1(C,B).
b403(A,B):-move_left(A,C),b403_1(C,B).
b403_1(A,B):-p211(A,C),p1909(C,B).
b407(A,B):-p117(A,C),p524(C,B).
b408(A,B):-p1062_1(A,C),p1315_1(C,B).
b409(A,B):-p669(A,B).
b410(A,B):-p1158(A,B).
b411(A,B):-p269_2(A,B).
b340(A,B):-p1062_1(A,C),b340_1(C,B).
b340_1(A,B):-p98(A,C),p1144(C,B).
b397(A,B):-p281(A,C),b397_1(C,B).
b397_1(A,B):-p620_1(A,C),p1044_1(C,B).
b414(A,B):-move_left(A,C),p670_1(C,B).
b405(A,B):-move_left(A,C),b405_1(C,B).
b405_1(A,B):-p974(A,C),p391_2(C,B).
b382(A,B):-p179(A,C),b382_1(C,B).
b382_1(A,B):-p285(A,C),p1994_2(C,B).
b416(A,B):-p816(A,C),p1399(C,B).
b392(A,B):-p117_1(A,C),b392_1(C,B).
b392_1(A,B):-p1111_1(A,C),p720(C,B).
b413(A,B):-move_left(A,C),b413_1(C,B).
b413_1(A,B):-p526(A,C),p496(C,B).
b396(A,B):-p117(A,C),b396_1(C,B).
b396_1(A,B):-p854(A,C),p273_1(C,B).
b421(A,B):-p560_1(A,C),p1051_1(C,B).
b419(A,B):-p1080_1(A,C),p745_1(C,B).
b415(A,B):-move_forwards(A,C),b415_1(C,B).
b415_1(A,B):-p1343(A,C),p428(C,B).
b420(A,B):-move_left(A,C),b420_1(C,B).
b420_1(A,B):-p366(A,C),p1039_2(C,B).
b417(A,B):-move_forwards(A,C),b417_1(C,B).
b417_1(A,B):-p548(A,C),p633_1(C,B).
b424(A,B):-p650(A,C),move_right(C,B).
b426(A,B):-p400(A,C),p175_2(C,B).
b422(A,B):-move_left(A,C),b422_1(C,B).
b422_1(A,B):-p96_1(A,C),p1722(C,B).
b429(A,B):-p117(A,C),p1614_1(C,B).
b430(A,B):-p518(A,C),p595_1(C,B).
b431(A,B):-move_backwards(A,C),p641_1(C,B).
b432(A,B):-p83(A,C),p1243(C,B).
b433(A,B):-p112(A,C),p1265_1(C,B).
b418(A,B):-p63(A,C),b418_1(C,B).
b418_1(A,B):-p1291(A,C),p716(C,B).
b435(A,B):-p1498_1(A,B).
b428(A,B):-p63(A,C),b428_1(C,B).
b428_1(A,B):-p973(A,C),p755_2(C,B).
b436(A,B):-p436_1(A,C),p1982_1(C,B).
b423(A,B):-p117_1(A,C),b423_1(C,B).
b423_1(A,B):-p327_1(A,C),p1604_1(C,B).
b437(A,B):-p950(A,C),p804(C,B).
b438(A,B):-p1824(A,C),p28_1(C,B).
b434(A,B):-move_backwards(A,C),b434_1(C,B).
b434_1(A,B):-p170(A,C),p120(C,B).
b441(A,B):-p278(A,C),p1826_1(C,B).
b442(A,B):-p112(A,C),p804(C,B).
b439(A,B):-move_backwards(A,C),b439_1(C,B).
b439_1(A,B):-p329(A,C),p278(C,B).
b425(A,B):-p63(A,C),b425_1(C,B).
b425_1(A,B):-p1140(A,C),p656_1(C,B).
b446(A,B):-p57(A,C),p729(C,B).
b440(A,B):-move_left(A,C),b440_1(C,B).
b440_1(A,B):-p719(A,C),p924_1(C,B).
b448(A,B):-p52_1(A,C),p28_1(C,B).
b449(A,B):-move_forwards(A,C),p77_2(C,B).
b406(A,B):-p64_1(A,C),b406_1(C,B).
b406_1(A,B):-p1002(A,C),p911_2(C,B).
b451(A,B):-p619(A,B).
b412(A,B):-p1326(A,C),b412_1(C,B).
b412_1(A,B):-p1878(A,C),p676_2(C,B).
b450(A,B):-p381(A,C),p281(C,B).
b444(A,B):-p392(A,C),b444_1(C,B).
b444_1(A,B):-p734(A,C),p604_2(C,B).
b447(A,B):-move_left(A,C),b447_1(C,B).
b447_1(A,B):-p1451(A,C),move_left(C,B).
b456(A,B):-p278(A,C),p1151_1(C,B).
b443(A,B):-move_left(A,C),b443_1(C,B).
b443_1(A,B):-p801_1(A,C),p179(C,B).
b427(A,B):-p213_1(A,C),b427_1(C,B).
b427_1(A,B):-p1930(A,C),p804(C,B).
b455(A,B):-move_left(A,C),b455_1(C,B).
b455_1(A,B):-p1251(A,C),p453(C,B).
b460(A,B):-p168(A,C),move_backwards(C,B).
b445(A,B):-p57(A,C),b445_1(C,B).
b445_1(A,B):-p1122(A,C),p1999_1(C,B).
b462(A,B):-move_forwards(A,C),p180_1(C,B).
b463(A,B):-p1380(A,C),p1815_1(C,B).
b459(A,B):-move_right(A,C),b459_1(C,B).
b459_1(A,B):-p1752(A,C),p939_2(C,B).
b464(A,B):-p456(A,C),p662(C,B).
b461(A,B):-move_left(A,C),b461_1(C,B).
b461_1(A,B):-p83(A,C),p962_1(C,B).
b458(A,B):-move_right(A,C),b458_1(C,B).
b458_1(A,B):-p1887(A,C),p496(C,B).
b467(A,B):-p1002(A,C),p1160_1(C,B).
b466(A,B):-move_right(A,C),b466_1(C,B).
b466_1(A,B):-p456(A,C),p1326(C,B).
b457(A,B):-p57(A,C),b457_1(C,B).
b457_1(A,B):-p705(A,C),p1987(C,B).
b471(A,B):-p456(A,C),p95(C,B).
b472(A,B):-p1113_1(A,B).
b468(A,B):-move_right(A,C),b468_1(C,B).
b468_1(A,B):-p1561_1(A,C),p961_2(C,B).
b474(A,B):-p436_1(A,B).
b475(A,B):-p402(A,C),p560(C,B).
b465(A,B):-p496(A,C),b465_1(C,B).
b465_1(A,B):-p242(A,C),p491_2(C,B).
b477(A,B):-p1028(A,C),p1767(C,B).
b453(A,B):-p633_1(A,C),b453_1(C,B).
b453_1(A,B):-p59(A,C),p192(C,B).
b479(A,B):-move_right(A,B).
b469(A,B):-p120(A,C),b469_1(C,B).
b469_1(A,B):-p1246(A,C),p209_1(C,B).
b481(A,B):-p5(A,C),p509(C,B).
b482(A,B):-move_forwards(A,C),p1383_1(C,B).
b476(A,B):-move_backwards(A,C),b476_1(C,B).
b476_1(A,B):-p8_1(A,C),p179(C,B).
b483(A,B):-move_forwards(A,C),b483_1(C,B).
b483_1(A,B):-p255_1(A,C),p235_2(C,B).
b485(A,B):-move_forwards(A,C),p105(C,B).
b484(A,B):-move_left(A,C),b484_1(C,B).
b484_1(A,B):-p747(A,C),p77_1(C,B).
b486(A,B):-move_left(A,C),b486_1(C,B).
b486_1(A,B):-p149(A,C),p63(C,B).
b488(A,B):-p1074(A,C),p362_1(C,B).
b480(A,B):-p213(A,C),b480_1(C,B).
b480_1(A,B):-p1946(A,C),p920_1(C,B).
b487(A,B):-move_left(A,C),b487_1(C,B).
b487_1(A,B):-p1541(A,C),p716(C,B).
b490(A,B):-move_left(A,C),b490_1(C,B).
b490_1(A,B):-p471_1(A,C),p453(C,B).
b492(A,B):-move_backwards(A,C),b492_1(C,B).
b492_1(A,B):-p1344(A,C),p146_1(C,B).
b491(A,B):-move_forwards(A,C),b491_1(C,B).
b491_1(A,B):-p93(A,C),p443(C,B).
b494(A,B):-p281(A,C),p742_1(C,B).
b495(A,B):-p266(A,B).
b452(A,B):-p560_1(A,C),b452_1(C,B).
b452_1(A,B):-p689(A,C),p107(C,B).
b496(A,B):-p619(A,C),p94(C,B).
b489(A,B):-p392(A,C),b489_1(C,B).
b489_1(A,B):-p1113_1(A,C),p1132_1(C,B).
b493(A,B):-move_left(A,C),b493_1(C,B).
b493_1(A,B):-p97(A,C),p1437_1(C,B).
b500(A,B):-p97_1(A,C),p371(C,B).
b498(A,B):-move_forwards(A,C),b498_1(C,B).
b498_1(A,B):-p735(A,C),p836(C,B).
b473(A,B):-p117_1(A,C),b473_1(C,B).
b473_1(A,B):-p1682(A,C),p1380(C,B).
b499(A,B):-move_left(A,C),b499_1(C,B).
b499_1(A,B):-p690_1(A,C),p122(C,B).
b504(A,B):-p57(A,C),p591_1(C,B).
b505(A,B):-p340_1(A,B).
b506(A,B):-p1414(A,C),p1062_1(C,B).
b507(A,B):-p619(A,C),p345(C,B).
b501(A,B):-move_right(A,C),b501_1(C,B).
b501_1(A,B):-p172_1(A,C),p1358(C,B).
b508(A,B):-p21(A,C),p1621_1(C,B).
b510(A,B):-p1062_1(A,C),p1128(C,B).
b497(A,B):-move_right(A,C),b497_1(C,B).
b497_1(A,B):-p856(A,C),p560(C,B).
b503(A,B):-p63(A,C),b503_1(C,B).
b503_1(A,B):-p1006(A,C),p1869(C,B).
b513(A,B):-p117_1(A,B).
b502(A,B):-p57(A,C),b502_1(C,B).
b502_1(A,B):-p285(A,C),p604_2(C,B).
b514(A,B):-p281(A,C),p684_1(C,B).
b509(A,B):-p281(A,C),b509_1(C,B).
b509_1(A,B):-p627(A,C),p1229(C,B).
b515(A,B):-p650(A,C),p57(C,B).
b517(A,B):-p669(A,C),p1342_1(C,B).
b518(A,B):-p804(A,C),p499_1(C,B).
b520(A,B):-p560_1(A,C),p1075_1(C,B).
b521(A,B):-p396(A,C),p1505(C,B).
b511(A,B):-p3(A,C),b511_1(C,B).
b511_1(A,B):-p1613_1(A,C),p1118(C,B).
b519(A,B):-move_forwards(A,C),b519_1(C,B).
b519_1(A,B):-p400(A,C),p421_2(C,B).
b512(A,B):-move_backwards(A,C),b512_1(C,B).
b512_1(A,B):-p1253(A,C),p308_1(C,B).
b516(A,B):-move_left(A,C),b516_1(C,B).
b516_1(A,B):-p116_1(A,C),p117_1(C,B).
b523(A,B):-move_backwards(A,C),b523_1(C,B).
b523_1(A,B):-p625(A,C),p911_2(C,B).
b527(A,B):-p622(A,C),p1491_1(C,B).
b528(A,B):-p1292(A,C),move_left(C,B).
b525(A,B):-p1786_1(A,C),p69(C,B).
b526(A,B):-move_backwards(A,C),b526_1(C,B).
b526_1(A,B):-p1986(A,C),p1325_1(C,B).
...
b530_1(A,B):-p640(A,C),p501_2(C,B).
b533(A,B):-p242(A,C),p97_2(C,B).
b535(A,B):-p392(A,C),b535_1(C,B).
b535_1(A,B):-p1122(A,C),p560(C,B).
b522(A,B):-p496(A,C),b522_1(C,B).
b522_1(A,B):-p1370(A,C),p391_2(C,B).
b537(A,B):-p1144(A,C),p1603(C,B).
b532(A,B):-move_forwards(A,C),b532_1(C,B).
b532_1(A,B):-p56(A,C),p496(C,B).
b536(A,B):-move_left(A,C),b536_1(C,B).
b536_1(A,B):-p527(A,C),p1338_1(C,B).
b538(A,B):-p968(A,C),p26(C,B).
b541(A,B):-p3(A,C),p1292_2(C,B).
b542(A,B):-p366_1(A,C),p212_2(C,B).
b540(A,B):-move_left(A,C),b540_1(C,B).
b540_1(A,B):-p1017(A,C),p57(C,B).
b544(A,B):-p117_1(A,C),p151_1(C,B).
b545(A,B):-p1144(A,C),p253_1(C,B).
b539(A,B):-p57(A,C),b539_1(C,B).
b539_1(A,B):-p1752(A,C),p939_2(C,B).
b547(A,B):-move_left(A,C),b547_1(C,B).
b547_1(A,B):-p537(A,C),p755_2(C,B).
b543(A,B):-p453(A,C),b543_1(C,B).
b543_1(A,B):-p1623(A,C),p5(C,B).
b548(A,B):-p736(A,C),p557(C,B).
b534(A,B):-p213(A,C),b534_1(C,B).
b534_1(A,B):-p255(A,C),p1846_2(C,B).
b549(A,B):-move_left(A,C),b549_1(C,B).
b549_1(A,B):-p100(A,C),p85(C,B).
b550(A,B):-move_right(A,C),b550_1(C,B).
b550_1(A,B):-p1850(A,C),p1689_2(C,B).
b553(A,B):-p1876(A,C),p251_2(C,B).
b554(A,B):-p560_1(A,C),p548_1(C,B).
b551(A,B):-p57(A,C),b551_1(C,B).
b551_1(A,B):-p1604(A,C),p179(C,B).
b524(A,B):-p1448(A,C),b524_1(C,B).
b524_1(A,B):-p1379(A,C),p136_2(C,B).
b557(A,B):-p179(A,B).
b556(A,B):-p1755(A,C),p1274(C,B).
b558(A,B):-p964(A,C),p101_1(C,B).
b552(A,B):-move_backwards(A,C),b552_1(C,B).
b552_1(A,B):-p1426(A,C),p1689_2(C,B).
b561(A,B):-p120(A,C),p1051_1(C,B).
b559(A,B):-p1752(A,C),p1105_1(C,B).
b563(A,B):-p1889(A,C),p654_1(C,B).
b555(A,B):-p63(A,C),b555_1(C,B).
b555_1(A,B):-grab_ball(A,C),p1614_2(C,B).
b562(A,B):-move_forwards(A,C),b562_1(C,B).
b562_1(A,B):-p400(A,C),p1107_2(C,B).
b566(A,B):-p1051(A,C),p1722(C,B).
b564(A,B):-move_right(A,C),b564_1(C,B).
b564_1(A,B):-p285(A,C),p100_2(C,B).
b568(A,B):-p428(A,B).
b560(A,B):-p392(A,C),b560_1(C,B).
b560_1(A,B):-p798_1(A,C),p27_1(C,B).
b570(A,B):-p392(A,C),p897_1(C,B).
b569(A,B):-p622_1(A,C),p444_1(C,B).
b572(A,B):-p63(A,C),p12(C,B).
b546(A,B):-p329(A,C),b546_1(C,B).
b546_1(A,B):-p620_1(A,C),p676_2(C,B).
b574(A,B):-p1505(A,C),p1894(C,B).
b565(A,B):-move_left(A,C),b565_1(C,B).
b565_1(A,B):-p97_1(A,C),p1645(C,B).
b393(A,B):-move_left(A,C),b393_1(C,B).
b393_1(A,B):-p1253(A,C),b393_2(C,B).
b393_2(A,B):-p368_2(A,C),p391_2(C,B).
b573(A,B):-p1985(A,C),p1443_1(C,B).
b577(A,B):-p281(A,C),p1014_1(C,B).
b578(A,B):-p798(A,C),p138_2(C,B).
b576(A,B):-p948(A,C),p23_1(C,B).
b571(A,B):-move_forwards(A,C),b571_1(C,B).
b571_1(A,B):-p448_1(A,C),p1434_2(C,B).
b575(A,B):-move_right(A,C),b575_1(C,B).
b575_1(A,B):-p1006(A,C),p1540_1(C,B).
b579(A,B):-move_forwards(A,C),b579_1(C,B).
b579_1(A,B):-p83_1(A,C),p374_2(C,B).
b583(A,B):-move_right(A,C),b583_1(C,B).
b583_1(A,B):-p960(A,C),p755_2(C,B).
b585(A,B):-p1283(A,C),p631(C,B).
b580(A,B):-move_forwards(A,C),b580_1(C,B).
b580_1(A,B):-p70(A,C),p1505(C,B).
b587(A,B):-move_left(A,C),p1128_1(C,B).
b588(A,B):-p442_2(A,B).
b567(A,B):-p57(A,C),b567_1(C,B).
b567_1(A,B):-p10(A,C),p1973(C,B).
b584(A,B):-move_right(A,C),b584_1(C,B).
b584_1(A,B):-p446(A,C),p436_1(C,B).
b589(A,B):-move_left(A,C),b589_1(C,B).
b589_1(A,B):-p416(A,C),move_right(C,B).
b592(A,B):-p1549(A,C),p1438_1(C,B).
b591(A,B):-move_left(A,C),b591_1(C,B).
b591_1(A,B):-p1061_1(A,C),p479(C,B).
b594(A,B):-p120(A,C),p911_1(C,B).
b593(A,B):-p251(A,C),p496(C,B).
b596(A,B):-p211_1(A,B).
b597(A,B):-p1847(A,C),p920(C,B).
b582(A,B):-p64_1(A,C),b582_1(C,B).
b582_1(A,B):-p203(A,C),p633_1(C,B).
b590(A,B):-p392(A,C),b590_1(C,B).
b590_1(A,B):-p801(A,C),p1505(C,B).
b598(A,B):-move_left(A,C),b598_1(C,B).
b598_1(A,B):-p1356(A,C),p428(C,B).
b586(A,B):-p453(A,C),b586_1(C,B).
b586_1(A,B):-p482(A,C),p1264_1(C,B).
b602(A,B):-move_left(A,C),b602_1(C,B).
b602_1(A,B):-p1231(A,C),p278(C,B).
b603(A,B):-p1867(A,C),p57(C,B).
b600(A,B):-move_left(A,C),b600_1(C,B).
b600_1(A,B):-p865_1(A,C),p26(C,B).
b604(A,B):-move_backwards(A,C),b604_1(C,B).
b604_1(A,B):-p960(A,C),p1127_1(C,B).
b606(A,B):-p1144(A,C),p1973_1(C,B).
b605(A,B):-move_right(A,C),b605_1(C,B).
b605_1(A,B):-p0(A,C),p1752_2(C,B).
b607(A,B):-p63(A,C),b607_1(C,B).
b607_1(A,B):-p242(A,C),p1150_2(C,B).
b609(A,B):-move_forwards(A,C),b609_1(C,B).
b609_1(A,B):-p516_1(A,C),move_right(C,B).
b610(A,B):-p1559(A,C),p669(C,B).
b581(A,B):-p5(A,C),b581_1(C,B).
b581_1(A,B):-p1523(A,C),p281(C,B).
b612(A,B):-p496(A,C),p97_1(C,B).
b211(A,B):-move_left(A,C),b211_1(C,B).
b211_1(A,B):-p1122(A,C),b211_2(C,B).
b211_2(A,B):-p1105(A,C),p417(C,B).
b595(A,B):-p21(A,C),b595_1(C,B).
b595_1(A,B):-p28_1(A,C),p804(C,B).
b613(A,B):-p273_1(A,C),p57(C,B).
b615(A,B):-p720_1(A,C),p141_1(C,B).
b616(A,B):-p496(A,C),p85_1(C,B).
b617(A,B):-p453(A,C),p1811(C,B).
b619(A,B):-p1144(A,C),p1304_1(C,B).
b618(A,B):-p1146(A,C),move_left(C,B).
b608(A,B):-p179(A,C),b608_1(C,B).
b608_1(A,B):-p918(A,C),p436(C,B).
b622(A,B):-move_backwards(A,C),p591_1(C,B).
b623(A,B):-p836(A,B).
b624(A,B):-p1755(A,C),p1326(C,B).
b625(A,B):-move_forwards(A,C),p1942_1(C,B).
b626(A,B):-p116(A,C),p453(C,B).
b611(A,B):-p57(A,C),b611_1(C,B).
b611_1(A,B):-p1804_1(A,C),p1039(C,B).
b627(A,B):-p436_1(A,C),p974(C,B).
b621(A,B):-p496(A,C),b621_1(C,B).
b621_1(A,B):-p400(A,C),p917_2(C,B).
b630(A,B):-p63(A,C),p1529(C,B).
b628(A,B):-move_left(A,C),b628_1(C,B).
b628_1(A,B):-p98(A,C),p1803_1(C,B).
b632(A,B):-p436_1(A,B).
b601(A,B):-p610(A,C),b601_1(C,B).
b601_1(A,B):-p120(A,C),p1390(C,B).
b634(A,B):-p392(A,C),p1146_1(C,B).
b633(A,B):-p1426(A,C),p1825(C,B).
b620(A,B):-p560_1(A,C),b620_1(C,B).
b620_1(A,B):-p1014_1(A,C),p1629(C,B).
b637(A,B):-p428(A,C),p273_1(C,B).
b631(A,B):-move_left(A,C),b631_1(C,B).
b631_1(A,B):-p1184(A,C),p396_2(C,B).
b639(A,B):-p1402(A,C),p1062_1(C,B).
b640(A,B):-p241(A,C),p63(C,B).
b641(A,B):-p633_1(A,C),p227_1(C,B).
b642(A,B):-move_left(A,C),p252_2(C,B).
b643(A,B):-move_forwards(A,C),p1577_1(C,B).
b635(A,B):-move_forwards(A,C),b635_1(C,B).
b635_1(A,B):-p960_1(A,C),p479_1(C,B).
b645(A,B):-p213_1(A,B).
b644(A,B):-p1687(A,C),p1075(C,B).
b647(A,B):-p566_1(A,B).
b636(A,B):-p63(A,C),b636_1(C,B).
b636_1(A,B):-p1270_1(A,C),p1278_2(C,B).
b649(A,B):-p332(A,C),p836(C,B).
b646(A,B):-move_left(A,C),b646_1(C,B).
b646_1(A,B):-p968(A,C),p64_1(C,B).
b651(A,B):-move_right(A,C),p267_1(C,B).
b652(A,B):-move_backwards(A,C),p56_2(C,B).
b650(A,B):-move_left(A,C),b650_1(C,B).
b650_1(A,B):-p146(A,C),p57(C,B).
b614(A,B):-p120(A,C),b614_1(C,B).
b614_1(A,B):-p621_1(A,C),p911_2(C,B).
b655(A,B):-p1557(A,B).
b656(A,B):-p716(A,C),p1014_1(C,B).
b654(A,B):-p627_1(A,C),p910_1(C,B).
b653(A,B):-move_left(A,C),b653_1(C,B).
b653_1(A,B):-p255(A,C),p778_2(C,B).
b657(A,B):-p428(A,C),p914_1(C,B).
b659(A,B):-p281(A,C),p175_2(C,B).
b661(A,B):-move_forwards(A,C),p1102(C,B).
b660(A,B):-p269_2(A,C),p1229(C,B).
b638(A,B):-p633_1(A,C),b638_1(C,B).
b638_1(A,B):-p255(A,C),p370_2(C,B).
b664(A,B):-p705(A,C),p1863_1(C,B).
b665(A,B):-p88_1(A,C),p1722(C,B).
b666(A,B):-p1144(A,C),p600(C,B).
b648(A,B):-p281(A,C),b648_1(C,B).
b648_1(A,B):-p88(A,C),p453(C,B).
...
b629(A,B):-p117(A,C),b629_1(C,B).
b629_1(A,B):-p98(A,C),p1669_1(C,B).
b670(A,B):-move_forwards(A,C),b670_1(C,B).
b670_1(A,B):-p400(A,C),p498_2(C,B).
b671(A,B):-move_right(A,C),b671_1(C,B).
b671_1(A,B):-p535(A,C),p57(C,B).
b673(A,B):-move_left(A,C),p1291_1(C,B).
b668(A,B):-p453(A,C),b668_1(C,B).
b668_1(A,B):-p1370_1(A,C),p278(C,B).
b672(A,B):-p1144(A,C),b672_1(C,B).
b672_1(A,B):-p1122(A,C),p213_1(C,B).
b662(A,B):-p1379_1(A,C),b662_1(C,B).
b662_1(A,B):-p59(A,C),p93(C,B).
b677(A,B):-move_left(A,C),b677_1(C,B).
b677_1(A,B):-p689(A,C),p1687_1(C,B).
b667(A,B):-p278(A,C),b667_1(C,B).
b667_1(A,B):-p116(A,C),p716(C,B).
b675(A,B):-p63(A,C),b675_1(C,B).
b675_1(A,B):-p516(A,C),p120(C,B).
b669(A,B):-move_forwards(A,C),b669_1(C,B).
b669_1(A,B):-p1403_1(A,C),p676_2(C,B).
b678(A,B):-p392(A,C),b678_1(C,B).
b678_1(A,B):-p116(A,C),p1825(C,B).
b682(A,B):-p309_1(A,C),p469(C,B).
b683(A,B):-move_backwards(A,C),b683_1(C,B).
b683_1(A,B):-grab_ball(A,C),p333_2(C,B).
b684(A,B):-p560(A,B).
b685(A,B):-p633(A,C),p1077_1(C,B).
b676(A,B):-p428(A,C),b676_1(C,B).
b676_1(A,B):-p664(A,C),p714_1(C,B).
b686(A,B):-p281(A,C),p1497(C,B).
b687(A,B):-p285_1(A,C),p1084_1(C,B).
b689(A,B):-p266(A,C),p242_1(C,B).
b679(A,B):-p281(A,C),b679_1(C,B).
b679_1(A,B):-p68(A,C),p269_2(C,B).
b674(A,B):-p1274(A,C),b674_1(C,B).
b674_1(A,B):-p664(A,C),p1033_2(C,B).
b691(A,B):-move_left(A,C),b691_1(C,B).
b691_1(A,B):-p168(A,C),p652_1(C,B).
b690(A,B):-p392(A,C),b690_1(C,B).
b690_1(A,B):-p284(A,C),p1439(C,B).
b694(A,B):-p1745(A,C),p117_1(C,B).
b693(A,B):-move_right(A,C),b693_1(C,B).
b693_1(A,B):-p1370_1(A,C),p1125(C,B).
b680(A,B):-p633_1(A,C),b680_1(C,B).
b680_1(A,B):-p1309(A,C),p1228_1(C,B).
b696(A,B):-p1421(A,C),p622_1(C,B).
b698(A,B):-move_right(A,C),b698_1(C,B).
b698_1(A,B):-p1799(A,C),p924(C,B).
b695(A,B):-p63(A,C),b695_1(C,B).
b695_1(A,B):-p1914(A,C),p568_1(C,B).
b700(A,B):-p577(A,C),p804(C,B).
b699(A,B):-p1369_1(A,C),p1379(C,B).
b701(A,B):-p112(A,C),p493_1(C,B).
b702(A,B):-move_forwards(A,C),b702_1(C,B).
b702_1(A,B):-p385(A,C),p26(C,B).
b704(A,B):-p120(A,C),p169(C,B).
b705(A,B):-p1541_1(A,B).
b681(A,B):-p120(A,C),b681_1(C,B).
b681_1(A,B):-p327_1(A,C),p1065_1(C,B).
b703(A,B):-move_forwards(A,C),b703_1(C,B).
b703_1(A,B):-p192(A,C),p836(C,B).
b706(A,B):-move_forwards(A,C),b706_1(C,B).
b706_1(A,B):-p13(A,C),p23_1(C,B).
b709(A,B):-p893(A,B).
b688(A,B):-p1274(A,C),b688_1(C,B).
b688_1(A,B):-p1184_1(A,C),p585(C,B).
b711(A,B):-p816(A,C),p730_1(C,B).
b710(A,B):-p428(A,C),p1587(C,B).
b713(A,B):-move_right(A,C),p1365_2(C,B).
b692(A,B):-p64_1(A,C),b692_1(C,B).
b692_1(A,B):-p255_1(A,C),p4_2(C,B).
b715(A,B):-p315(A,B).
b716(A,B):-p1140(A,C),p1195_1(C,B).
b707(A,B):-p281(A,C),b707_1(C,B).
b707_1(A,B):-p1657(A,C),p213_1(C,B).
b708(A,B):-p63(A,C),b708_1(C,B).
b708_1(A,B):-p1028(A,C),p804(C,B).
b717(A,B):-p960_1(A,C),p649_1(C,B).
...
b719(A,B):-p1751(A,C),p1167_1(C,B).
b718(A,B):-move_left(A,C),b718_1(C,B).
b718_1(A,B):-p1122(A,C),p778_1(C,B).
b722(A,B):-move_left(A,C),b722_1(C,B).
b722_1(A,B):-p1850(A,C),p608_1(C,B).
b725(A,B):-p252_1(A,C),p453(C,B).
b712(A,B):-p392(A,C),b712_1(C,B).
b712_1(A,B):-p664(A,C),p660_2(C,B).
b727(A,B):-p97(A,C),p4_1(C,B).
b724(A,B):-p63(A,C),b724_1(C,B).
b724_1(A,B):-p400(A,C),p1118_1(C,B).
b728(A,B):-p836(A,C),p49_1(C,B).
b730(A,B):-move_right(A,C),p550_1(C,B).
b731(A,B):-move_right(A,C),p1923(C,B).
b732(A,B):-p242(A,C),p1141_2(C,B).
b733(A,B):-p137(A,B).
b723(A,B):-p63(A,C),b723_1(C,B).
b723_1(A,B):-p1930(A,C),p64_1(C,B).
b729(A,B):-p1662_1(A,C),p442_2(C,B).
b734(A,B):-p1825(A,C),p1316(C,B).
b735(A,B):-p1825(A,C),p691(C,B).
b736(A,B):-p213(A,C),p1786_1(C,B).
b739(A,B):-p496(A,C),p105(C,B).
b740(A,B):-p179(A,C),p1292(C,B).
b741(A,B):-p350(A,C),p698_2(C,B).
b726(A,B):-move_backwards(A,C),b726_1(C,B).
b726_1(A,B):-p21_1(A,C),p1067_1(C,B).
b742(A,B):-p633_1(A,C),p977(C,B).
b743(A,B):-p560_1(A,C),p1392_1(C,B).
b744(A,B):-move_forwards(A,C),b744_1(C,B).
b744_1(A,B):-p734(A,C),p1287_1(C,B).
b746(A,B):-p213_1(A,C),p1449(C,B).
b747(A,B):-move_forwards(A,B).
b721(A,B):-p392(A,C),b721_1(C,B).
b721_1(A,B):-p664(A,C),p1279_2(C,B).
b737(A,B):-p1144(A,C),b737_1(C,B).
b737_1(A,B):-p1184(A,C),p552_2(C,B).
b720(A,B):-p633(A,C),b720_1(C,B).
b720_1(A,B):-p411_1(A,C),move_right(C,B).
b745(A,B):-p63(A,C),b745_1(C,B).
b745_1(A,B):-p1319(A,C),p576(C,B).
b752(A,B):-p1695(A,C),p1928_1(C,B).
b753(A,B):-p101(A,C),p830(C,B).
b754(A,B):-p63(A,C),p470_1(C,B).
b755(A,B):-move_left(A,C),p964_2(C,B).
b756(A,B):-move_backwards(A,C),p252(C,B).
b748(A,B):-p392(A,C),b748_1(C,B).
b748_1(A,B):-p170_1(A,C),p1379_1(C,B).
b750(A,B):-p57(A,C),b750_1(C,B).
b750_1(A,B):-p52(A,C),p22_1(C,B).
b758(A,B):-p619(A,C),p226_2(C,B).
b759(A,B):-move_right(A,C),b759_1(C,B).
b759_1(A,B):-p269_2(A,C),p1931_1(C,B).
b761(A,B):-p1326(A,C),p939_1(C,B).
b762(A,B):-p1992(A,C),p391_2(C,B).
b749(A,B):-p281(A,C),b749_1(C,B).
b749_1(A,B):-p1122(A,C),p961_1(C,B).
b764(A,B):-p1393(A,B).
b765(A,B):-p627_1(A,C),p1123_1(C,B).
b738(A,B):-p804(A,C),b738_1(C,B).
b738_1(A,B):-p83_1(A,C),p1325_1(C,B).
b767(A,B):-move_backwards(A,C),b767_1(C,B).
b767_1(A,B):-p620(A,C),p1105(C,B).
b768(A,B):-p117_1(A,C),p846(C,B).
b760(A,B):-move_backwards(A,C),b760_1(C,B).
b760_1(A,B):-p389(A,C),p278(C,B).
b770(A,B):-p392(A,C),p886_2(C,B).
b771(A,B):-p730(A,C),move_forwards(C,B).
b772(A,B):-p1147(A,C),p633_1(C,B).
...
b776(A,B):-move_forwards(A,C),p1238_1(C,B).
b478(A,B):-move_right(A,C),b478_1(C,B).
b478_1(A,B):-p610(A,C),b478_2(C,B).
b478_2(A,B):-p5(A,C),p1278_2(C,B).
b766(A,B):-p57(A,C),b766_1(C,B).
b766_1(A,B):-p1930(A,C),p428(C,B).
b778(A,B):-p146(A,C),p801(C,B).
b763(A,B):-p213_1(A,C),b763_1(C,B).
b763_1(A,B):-p705_1(A,C),p720(C,B).
b781(A,B):-move_left(A,C),b781_1(C,B).
b781_1(A,B):-p366(A,C),p253_2(C,B).
b782(A,B):-p290(A,C),p742_1(C,B).
b783(A,B):-move_forwards(A,C),p1878_1(C,B).
b780(A,B):-move_left(A,C),b780_1(C,B).
b780_1(A,B):-p884(A,C),p1299_1(C,B).
b785(A,B):-move_backwards(A,C),p1327(C,B).
b779(A,B):-move_forwards(A,C),b779_1(C,B).
b779_1(A,B):-p1111(A,C),p1737_1(C,B).
b470(A,B):-move_right(A,C),b470_1(C,B).
b470_1(A,B):-p1847(A,C),b470_2(C,B).
b470_2(A,B):-p920(A,C),p716(C,B).
b788(A,B):-move_left(A,C),p1285(C,B).
b789(A,B):-move_left(A,C),p361_1(C,B).
b787(A,B):-p1078(A,C),p1528_1(C,B).
b790(A,B):-p1270(A,C),p728(C,B).
b786(A,B):-move_left(A,C),b786_1(C,B).
b786_1(A,B):-p1292(A,C),p496(C,B).
b792(A,B):-p1359(A,C),p496(C,B).
b794(A,B):-p1496(A,C),p946_1(C,B).
b795(A,B):-p1122(A,C),p52_1(C,B).
b793(A,B):-p922(A,C),p291(C,B).
b791(A,B):-move_right(A,C),b791_1(C,B).
b791_1(A,B):-p1542(A,C),p574(C,B).
b784(A,B):-p281(A,C),b784_1(C,B).
b784_1(A,B):-p448_1(A,C),p961_2(C,B).
b799(A,B):-p281(A,C),p375_1(C,B).
b798(A,B):-p428(A,C),grab_ball(C,B).
b800(A,B):-move_backwards(A,C),p1604_1(C,B).
b802(A,B):-p63(A,C),p1511_1(C,B).
b773(A,B):-p392(A,C),b773_1(C,B).
b773_1(A,B):-p1231_1(A,C),p1039_1(C,B).
b803(A,B):-move_left(A,C),b803_1(C,B).
b803_1(A,B):-p1080(A,C),p1097_1(C,B).
b797(A,B):-move_left(A,C),b797_1(C,B).
b797_1(A,B):-p400(A,C),p273_2(C,B).
b806(A,B):-p619(A,C),p301(C,B).
b801(A,B):-p1591_1(A,C),p442_2(C,B).
b804(A,B):-move_forwards(A,C),b804_1(C,B).
b804_1(A,B):-p32_1(A,C),p1420_2(C,B).
b807(A,B):-move_left(A,C),b807_1(C,B).
b807_1(A,B):-p664(A,C),p198_2(C,B).
b810(A,B):-p820(A,B).
b811(A,B):-p278(A,C),p378_1(C,B).
b796(A,B):-p392(A,C),b796_1(C,B).
b796_1(A,B):-p255(A,C),p1015_1(C,B).
b809(A,B):-move_left(A,C),b809_1(C,B).
b809_1(A,B):-p211(A,C),p1039_1(C,B).
b808(A,B):-move_right(A,C),b808_1(C,B).
b808_1(A,B):-p1336(A,C),p4_1(C,B).
b813(A,B):-p392(A,C),p934_1(C,B).
b814(A,B):-p392(A,C),p1536_1(C,B).
b812(A,B):-p622_1(A,C),p1529_1(C,B).
b816(A,B):-p1062_1(A,C),p481(C,B).
b817(A,B):-p421(A,C),p179(C,B).
b819(A,B):-p64_1(A,C),p1512(C,B).
b821(A,B):-p1741(A,B).
b822(A,B):-p305(A,B).
b818(A,B):-p107(A,C),move_backwards(C,B).
b824(A,B):-p213(A,C),p211_1(C,B).
b599(A,B):-move_right(A,C),b599_1(C,B).
b599_1(A,B):-p269_2(A,C),b599_2(C,B).
b599_2(A,B):-p7(A,C),p755_2(C,B).
b826(A,B):-p172_1(A,C),p1867_1(C,B).
b825(A,B):-p10(A,C),p619(C,B).
b820(A,B):-move_right(A,C),b820_1(C,B).
b820_1(A,B):-p610(A,C),p1839_1(C,B).
b827(A,B):-p453(A,C),p426_1(C,B).
b828(A,B):-p729_1(A,C),p493(C,B).
b831(A,B):-p1395(A,C),p1220_2(C,B).
b832(A,B):-move_forwards(A,C),p194(C,B).
b833(A,B):-move_left(A,C),p442_2(C,B).
b829(A,B):-move_backwards(A,C),b829_1(C,B).
b829_1(A,B):-p1238(A,C),p1786_1(C,B).
b805(A,B):-p560(A,C),b805_1(C,B).
b805_1(A,B):-p1343(A,C),p278(C,B).
b836(A,B):-move_forwards(A,C),p1443_1(C,B).
b837(A,B):-p1144(A,C),p1527_1(C,B).
b834(A,B):-p691(A,C),p266(C,B).
b835(A,B):-p191(A,C),p1228_1(C,B).
b838(A,B):-p117_1(A,C),p136(C,B).
b840(A,B):-p1140(A,C),p448_1(C,B).
b842(A,B):-p496(A,C),p1552(C,B).
b843(A,B):-p1825(A,B).
b839(A,B):-p1006(A,C),p117_1(C,B).
b751(A,B):-p1549(A,C),b751_1(C,B).
b751_1(A,B):-p64_1(A,C),p206_2(C,B).
b845(A,B):-p1193(A,C),p120(C,B).
b844(A,B):-move_right(A,C),b844_1(C,B).
b844_1(A,B):-p1122(A,C),p939_1(C,B).
b848(A,B):-p453(A,C),p447_1(C,B).
b847(A,B):-move_left(A,C),b847_1(C,B).
b847_1(A,B):-p736(A,C),p557(C,B).
b846(A,B):-p63(A,C),b846_1(C,B).
b846_1(A,B):-p908(A,C),p1289_2(C,B).
b830(A,B):-p428(A,C),b830_1(C,B).
b830_1(A,B):-p1905(A,C),p227_2(C,B).
b852(A,B):-move_backwards(A,C),p729(C,B).
b823(A,B):-p117(A,C),b823_1(C,B).
b823_1(A,B):-p854(A,C),p1477_1(C,B).
b854(A,B):-p1144(A,C),p8_1(C,B).
b850(A,B):-move_right(A,C),b850_1(C,B).
b850_1(A,B):-p610(A,C),p1118_1(C,B).
b815(A,B):-p3(A,C),b815_1(C,B).
b815_1(A,B):-p1029_1(A,C),p1536_2(C,B).
b841(A,B):-p1144(A,C),b841_1(C,B).
b841_1(A,B):-p366(A,C),p257_1(C,B).
b857(A,B):-p600_1(A,C),p961_2(C,B).
b858(A,B):-p660(A,C),p507(C,B).
b860(A,B):-p112_1(A,C),p1604_1(C,B).
b853(A,B):-move_forwards(A,C),b853_1(C,B).
b853_1(A,B):-p83(A,C),p1343_2(C,B).
b862(A,B):-p907(A,B).
b859(A,B):-p1741(A,C),p278(C,B).
b855(A,B):-move_backwards(A,C),b855_1(C,B).
b855_1(A,B):-p385_1(A,C),p1557(C,B).
b865(A,B):-move_forwards(A,C),p390(C,B).
b861(A,B):-move_left(A,C),b861_1(C,B).
b861_1(A,B):-p309(A,C),p278(C,B).
b864(A,B):-p1395(A,C),p213_1(C,B).
b777(A,B):-p640(A,C),b777_1(C,B).
b777_1(A,B):-p26(A,C),p1084_1(C,B).
b863(A,B):-move_right(A,C),b863_1(C,B).
b863_1(A,B):-p116(A,C),p443(C,B).
b869(A,B):-p600(A,C),p765_2(C,B).
b870(A,B):-p1797(A,C),p22_1(C,B).
b871(A,B):-move_right(A,C),p531(C,B).
b872(A,B):-move_right(A,C),p1797(C,B).
b874(A,B):-p911_2(A,B).
b875(A,B):-p22_1(A,B).
b866(A,B):-p63(A,C),b866_1(C,B).
b866_1(A,B):-p1426(A,C),p633_1(C,B).
b876(A,B):-move_left(A,C),b876_1(C,B).
b876_1(A,B):-p32(A,C),p1280_1(C,B).
b877(A,B):-p507(A,C),p253_1(C,B).
b873(A,B):-p455(A,C),p1327(C,B).
b868(A,B):-move_right(A,C),b868_1(C,B).
b868_1(A,B):-p172(A,C),p1358(C,B).
b849(A,B):-p26(A,C),b849_1(C,B).
b849_1(A,B):-p83_1(A,C),p1325(C,B).
b757(A,B):-p227(A,C),b757_1(C,B).
b757_1(A,B):-p350(A,C),p1198_2(C,B).
b879(A,B):-p1584(A,C),p453(C,B).
b878(A,B):-p382(A,C),p417(C,B).
b880(A,B):-p60(A,C),p755_2(C,B).
b884(A,B):-p199_1(A,C),p806(C,B).
...
b867(A,B):-p281(A,C),b867_1(C,B).
b867_1(A,B):-p203(A,C),p442_2(C,B).
b885(A,B):-p57(A,C),b885_1(C,B).
b885_1(A,B):-p626(A,C),p428(C,B).
b888(A,B):-move_left(A,C),b888_1(C,B).
b888_1(A,B):-p1542(A,C),p381_1(C,B).
b891(A,B):-p280(A,C),p1118(C,B).
b889(A,B):-p1356(A,C),p755_2(C,B).
b893(A,B):-p560(A,C),p1542_1(C,B).
b894(A,B):-p1505(A,C),p656(C,B).
b895(A,B):-p151_1(A,C),p920(C,B).
b897(A,B):-move_forwards(A,C),p1693_1(C,B).
b856(A,B):-grab_ball(A,C),b856_1(C,B).
b856_1(A,B):-p498(A,C),p392(C,B).
b899(A,B):-p804(A,B).
b887(A,B):-p281(A,C),b887_1(C,B).
b887_1(A,B):-p447(A,C),p362(C,B).
b901(A,B):-move_forwards(A,C),p273_2(C,B).
b896(A,B):-p112(A,C),p856_1(C,B).
b902(A,B):-p57(A,C),p1619_1(C,B).
b851(A,B):-p633_1(A,C),b851_1(C,B).
b851_1(A,B):-p1554(A,C),p1710_1(C,B).
b905(A,B):-p63(A,C),p309_1(C,B).
b906(A,B):-p308_1(A,B).
b907(A,B):-p1797(A,C),p375_1(C,B).
...
b882(A,B):-p117_1(A,C),b882_1(C,B).
b882_1(A,B):-p170(A,C),p442_2(C,B).
b913(A,B):-p443(A,C),p1058(C,B).
b909(A,B):-move_forwards(A,C),b909_1(C,B).
b909_1(A,B):-p1080(A,C),p961_1(C,B).
b904(A,B):-move_forwards(A,C),b904_1(C,B).
b904_1(A,B):-p1751(A,C),p238_1(C,B).
b900(A,B):-p3(A,C),b900_1(C,B).
b900_1(A,B):-p689(A,C),p179(C,B).
b917(A,B):-p64_1(A,C),p307_1(C,B).
b918(A,B):-p1144(A,C),p540_2(C,B).
b919(A,B):-move_forwards(A,C),p242(C,B).
b920(A,B):-p1379_1(A,B).
b921(A,B):-p507(A,C),p424(C,B).
b914(A,B):-p57(A,C),b914_1(C,B).
b914_1(A,B):-p98_1(A,C),p1265_1(C,B).
b923(A,B):-p266(A,B).
b924(A,B):-p1379(A,C),p1110_1(C,B).
b922(A,B):-move_left(A,C),b922_1(C,B).
b922_1(A,B):-p600(A,C),p51_1(C,B).
b926(A,B):-p622(A,B).
b915(A,B):-move_backwards(A,C),b915_1(C,B).
b915_1(A,B):-p747(A,C),p1669_1(C,B).
b892(A,B):-p26(A,C),b892_1(C,B).
b892_1(A,B):-p1122(A,C),p1185_1(C,B).
b929(A,B):-move_backwards(A,C),p168(C,B).
b928(A,B):-p664(A,C),p927_2(C,B).
b927(A,B):-move_right(A,C),b927_1(C,B).
b927_1(A,B):-p950(A,C),p1389_1(C,B).
b931(A,B):-p1825(A,C),p1089_1(C,B).
b933(A,B):-p1105_1(A,B).
b912(A,B):-p633_1(A,C),b912_1(C,B).
b912_1(A,B):-p1130(A,C),p1379(C,B).
b934(A,B):-p912(A,C),p93(C,B).
b916(A,B):-p392(A,C),b916_1(C,B).
b916_1(A,B):-p516_1(A,C),p278(C,B).
b936(A,B):-p105(A,C),p633_1(C,B).
b937(A,B):-p1621(A,C),move_forwards(C,B).
b939(A,B):-p83(A,C),p56_2(C,B).
b940(A,B):-p21(A,C),p1807(C,B).
b938(A,B):-move_left(A,C),b938_1(C,B).
b938_1(A,B):-p1141(A,C),p29(C,B).
b942(A,B):-p120(A,C),p1046(C,B).
b941(A,B):-p1824(A,C),p101_1(C,B).
b881(A,B):-p428(A,C),b881_1(C,B).
b881_1(A,B):-p798_1(A,C),p235_2(C,B).
b944(A,B):-p1080(A,C),p518_1(C,B).
b943(A,B):-p1029(A,C),p886_2(C,B).
b946(A,B):-p1512(A,C),p496(C,B).
b935(A,B):-move_right(A,C),b935_1(C,B).
b935_1(A,B):-grab_ball(A,C),p1839_1(C,B).
b949(A,B):-p453(A,C),p1999(C,B).
b948(A,B):-p40(A,C),p278(C,B).
b950(A,B):-p951(A,C),p1477(C,B).
b932(A,B):-p453(A,C),b932_1(C,B).
b932_1(A,B):-p327_1(A,C),p1285_1(C,B).
b947(A,B):-move_forwards(A,C),b947_1(C,B).
b947_1(A,B):-p747_1(A,C),p1019(C,B).
b953(A,B):-p97_1(A,C),p687_1(C,B).
b955(A,B):-p1144(A,C),p1420_1(C,B).
b956(A,B):-p1108(A,C),p453(C,B).
b925(A,B):-p560(A,C),b925_1(C,B).
b925_1(A,B):-p1184(A,C),p1098_2(C,B).
b954(A,B):-move_right(A,C),b954_1(C,B).
b954_1(A,B):-p233(A,C),p436_1(C,B).
b958(A,B):-p1274(A,C),p1238(C,B).
b959(A,B):-p4(A,C),p1481(C,B).
b960(A,B):-p1951(A,C),p1289_1(C,B).
b957(A,B):-move_forwards(A,C),b957_1(C,B).
b957_1(A,B):-p421(A,C),p226_1(C,B).
b963(A,B):-p63(A,C),p400_1(C,B).
b962(A,B):-p1621(A,C),p35(C,B).
b964(A,B):-p366_1(A,C),p399_2(C,B).
b951(A,B):-p117_1(A,C),b951_1(C,B).
b951_1(A,B):-p366(A,C),p1019_1(C,B).
b967(A,B):-p1399(A,C),p1824_1(C,B).
b968(A,B):-p716(A,C),p1220_2(C,B).
b969(A,B):-move_forwards(A,C),p1151_1(C,B).
b965(A,B):-move_right(A,C),b965_1(C,B).
b965_1(A,B):-p8(A,C),p57(C,B).
b966(A,B):-move_left(A,C),b966_1(C,B).
b966_1(A,B):-p400(A,C),p690_2(C,B).
b972(A,B):-move_left(A,C),p452_1(C,B).
b890(A,B):-p676_2(A,C),b890_1(C,B).
b890_1(A,B):-p1503(A,C),p622_1(C,B).
b970(A,B):-p1725(A,C),p771_1(C,B).
b945(A,B):-p3(A,C),b945_1(C,B).
b945_1(A,B):-p426(A,C),p436(C,B).
b976(A,B):-p146_2(A,B).
b952(A,B):-p117_1(A,C),b952_1(C,B).
b952_1(A,B):-p641_1(A,C),p1758(C,B).
b978(A,B):-p117(A,B).
b979(A,B):-p1283(A,C),p1940_1(C,B).
b977(A,B):-p809(A,C),p493(C,B).
b980(A,B):-p443(A,C),p1780_1(C,B).
b975(A,B):-move_backwards(A,C),b975_1(C,B).
b975_1(A,B):-p1078(A,C),p1887_1(C,B).
b910(A,B):-p1379_1(A,C),b910_1(C,B).
b910_1(A,B):-p411_1(A,C),p1752_2(C,B).
b984(A,B):-p266(A,C),p771_2(C,B).
b985(A,B):-p284(A,C),p1752_2(C,B).
b986(A,B):-move_right(A,C),p702_1(C,B).
b987(A,B):-p1657_1(A,B).
b974(A,B):-move_backwards(A,C),b974_1(C,B).
b974_1(A,B):-p1878(A,C),p1074(C,B).
b988(A,B):-p333_1(A,C),p5(C,B).
b990(A,B):-p281(A,C),p1552_1(C,B).
b991(A,B):-move_right(A,C),p1092_1(C,B).
b992(A,B):-p633_1(A,B).
b971(A,B):-move_right(A,C),b971_1(C,B).
b971_1(A,B):-p1682(A,C),p911_2(C,B).
b973(A,B):-p453(A,C),b973_1(C,B).
b973_1(A,B):-p1292(A,C),p1485_1(C,B).
b993(A,B):-p908(A,C),p13_1(C,B).
b996(A,B):-p280(A,C),p633_1(C,B).
b994(A,B):-p69_1(A,C),p136_1(C,B).
b998(A,B):-p1147(A,C),p281(C,B).
b999(A,B):-p64_1(A,C),p1359(C,B).
b961(A,B):-p662(A,C),b961_1(C,B).
b961_1(A,B):-p1166_1(A,C),p56_1(C,B).
b997(A,B):-move_backwards(A,C),b997_1(C,B).
b997_1(A,B):-p801(A,C),p720_1(C,B).
b930(A,B):-p560(A,C),b930_1(C,B).
b930_1(A,B):-p400_1(A,C),p138_2(C,B).
b989(A,B):-move_forwards(A,C),b989_1(C,B).
b989_1(A,B):-p180(A,C),p716(C,B).
b981(A,B):-p57(A,C),b981_1(C,B).
b981_1(A,B):-p746(A,C),p436(C,B).
b983(A,B):-p64_1(A,C),b983_1(C,B).
b983_1(A,B):-p960_1(A,C),p390_1(C,B).
b995(A,B):-p117_1(A,C),b995_1(C,B).
b995_1(A,B):-p960(A,C),p417(C,B).
b454(A,B):-move_forwards(A,C),b454_1(C,B).
b454_1(A,B):-p1535(A,C),b454_2(C,B).
b454_2(A,B):-p633(A,C),p479_2(C,B).
b982(A,B):-p1549(A,C),b982_1(C,B).
b982_1(A,B):-p747_2(A,C),p1036_1(C,B).
% num solved 1000
true.
